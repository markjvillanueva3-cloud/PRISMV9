...
See C:/PRISM/CAMX-CODE-REVIEW-PROTOCOL.md for full review checklist.
See C:/PRISM/CAMX-ROADMAP-v22-QUALITY-FIXES.md for quality requirements.
```
...
FILES TO READ FIRST:
  ...
  - List files: ls C:\PRISM\BOX\*.step C:\PRISM\BOX\*.stp

STEPS:
  1. Import 3 STEP files from C:\PRISM\BOX
