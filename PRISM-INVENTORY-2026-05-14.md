...
**Updated:** 2026-05-14T23:47:06.584Z
...
|----------|-------|--------|
| **Engines** | 3236 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 7486 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 3603 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 537 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 698 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 167 | live: `.claude/commands/` |
