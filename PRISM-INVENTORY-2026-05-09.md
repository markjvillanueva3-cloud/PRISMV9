...
**Updated:** 2026-05-09T23:59:01.828Z
...
|----------|-------|--------|
| **Engines** | 3175 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 7339 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 3419 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 454 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 493 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 247 | live: `.claude/commands/` |
| **Slash Commands (user)** | 388 | live: `~/.claude/commands/` |
