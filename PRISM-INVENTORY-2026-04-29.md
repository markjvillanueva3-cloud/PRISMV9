...
**Updated:** 2026-04-29T19:30:30.960Z
**Source:** live scan (43ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3018 | live: `src/engines/*.ts` |
| **Dispatchers** | 95 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 6657 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 3073 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 53 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 418 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 428 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 234 | live: `.claude/commands/` |
