...
**Updated:** 2026-06-09T20:16:01.973Z
**Source:** live scan (122ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3788 | live: `src/engines/*.ts` |
| **Dispatchers** | 108 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10010 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4724 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 904 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2334 | live: `scripts/` + `mcp-server/scripts/` |
