...
**Updated:** 2026-04-18T23:59:14.597Z
...
|----------|-------|--------|
| **Engines** | 2432 | live: `src/engines/*.ts` |
| **Dispatchers** | 89 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 5147 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 25 | live: `src/registries/*.ts` |
| **Tests** | 2276 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 48 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 180 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 328 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 211 | live: `.claude/commands/` |
| **Slash Commands (user)** | 252 | live: `~/.claude/commands/` |
