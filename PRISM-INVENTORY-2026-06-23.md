...
**Updated:** 2026-06-23T23:49:50.361Z
**Source:** live scan (68ms) — via scripts/update-prism-inventory.mjs
...
| **Actions** | 10321 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4995 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 1032 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2993 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 767 | live: `.claude/commands/` |
