...
**Updated:** 2026-06-01T20:04:22.267Z
**Source:** live scan (132ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3767 | live: `src/engines/*.ts` |
| **Dispatchers** | 105 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 9913 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4623 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 865 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2050 | live: `scripts/` + `mcp-server/scripts/` |
