...
1. C:/PRISM/state/shared/SYSTEM-CAPABILITIES.md — EVERYTHING PRISM can do
2. C:/PRISM/state/shared/backend-status.md — what CLI Claude just built
3. C:/PRISM/mcp-server/data/docs/MASTER_INDEX_COMPACT.md — full system map (735 tokens)

## KEY FACTS (always remember)
- 1,245 engines exist in src/engines/ — CHECK ENGINE_DIGEST.md before building anything new
- CadQuery/OpenCascade CAD engine at C:/PRISM/cad-engine/ — CAN generate STEP/STL files
...
- Web frontend: C:/PRISM/mcp-server/web/src/ (React/Vite, 45 pages)
- API routes: C:/PRISM/mcp-server/src/routes/ (51 files)
...
- CLI writes: C:/PRISM/state/shared/backend-status.md (after each unit)
- You write: C:/PRISM/state/shared/frontend-status.md (after each task)
- Shared capabilities: C:/PRISM/state/shared/SYSTEM-CAPABILITIES.md
- Desktop brief: C:/PRISM/state/shared/DESKTOP-CLAUDE-BRIEF.md
