...
**Updated:** 2026-05-27T22:55:55.968Z
**Source:** live scan (361ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3724 | live: `src/engines/*.ts` |
| **Dispatchers** | 105 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 9856 | live: `z.enum` count across dispatchers |
| **Algorithms** | 109 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4567 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 837 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1803 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 317 | live: `.claude/commands/` |
