...
**Updated:** 2026-05-26T23:34:04.489Z
**Source:** live scan (107ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3698 | live: `src/engines/*.ts` |
| **Dispatchers** | 104 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 9737 | live: `z.enum` count across dispatchers |
| **Algorithms** | 82 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4520 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 827 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1623 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 316 | live: `.claude/commands/` |
