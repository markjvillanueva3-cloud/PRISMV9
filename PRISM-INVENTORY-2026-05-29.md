...
**Updated:** 2026-05-29T20:17:28.830Z
**Source:** live scan (87ms) — via scripts/update-prism-inventory.mjs
...
| **Tests** | 4572 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 862 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1858 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 399 | live: `.claude/commands/` |
