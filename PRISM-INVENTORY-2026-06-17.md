...
**Updated:** 2026-06-17T05:02:48.162Z
**Source:** live scan (370ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3807 | live: `src/engines/*.ts` |
| **Dispatchers** | 111 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10255 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4847 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 1004 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2763 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 748 | live: `.claude/commands/` |
