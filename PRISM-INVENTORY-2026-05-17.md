...
**Updated:** 2026-05-17T23:59:37.385Z
**Source:** live scan (40ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3277 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 8194 | live: `z.enum` count across dispatchers |
| **Algorithms** | 61 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 3851 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 627 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 946 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 233 | live: `.claude/commands/` |
| **Slash Commands (user)** | 383 | live: `~/.claude/commands/` |
