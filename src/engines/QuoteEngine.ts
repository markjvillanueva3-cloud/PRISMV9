...
// ============================================================================
// PRICING LOGIC — externalized to ConfigService (ARCH-MS1 U-SHAD06)
// ============================================================================

import { configService } from "../services/ConfigService.js";

const _pricing = configService.getPricingConfig();
const COMPLEXITY_MARKUP: Record<string, number> = _pricing.complexityMarkup;
const URGENCY_MARKUP: Record<string, number> = _pricing.urgencyMarkup;
const QUANTITY_DISCOUNT_BREAKS = _pricing.quantityDiscountBreaks.map(b => ({ min: b.minQty, discount: b.discount }));
