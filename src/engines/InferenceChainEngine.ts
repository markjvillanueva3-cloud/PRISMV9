...
/**
 * Log directory: resolves to H:\prism\state\inference-logs at runtime.
 * esbuild bundles to dist/index.js so import.meta.dirname = H:\prism\mcp-server\dist at runtime.
 * When running via tsx (source), _dirname = H:\prism\mcp-server\src\engines.
 */
function getLogDir(): string {
  // dist/index.js → go up two dirs to reach H:\prism, then state/inference-logs
