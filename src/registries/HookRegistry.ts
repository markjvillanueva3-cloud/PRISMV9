...
export class HookRegistry extends BaseRegistry<Hook> {
  ...
  private initializeBuiltInHooks(): void {
    const builtIns: Hook[] = [
      ...
      // =======================================================================
      // LATHE UI SAFETY HOOKS (LATHE-PRO-MS-2)
      // =======================================================================
      {
        hook_id: "LATHE-UI-SAFETY-001",
        name: "UI Safety Certificate",
        category: "safety",
        description: "Validates all safety checks pass before allowing G-code download from the lathe UI. Blocks download if any safety check fails.",
        timing: "before",
        priority: "critical",
        order: 1,
        event: "lathe.program.download",
        handlers: [
          { handler_id: "h1", type: "function", target: "validateLatheSafetyChecks", enabled: true },
          { handler_id: "h2", type: "function", target: "validateCollisionCheck", enabled: true },
          { handler_id: "h3", type: "function", target: "validateClampingForce", enabled: true }
        ],
        async: false,
        enabled: true,
        status: "active",
        ...
        created: "2026-04-07",
        updated: "2026-04-07",
        tags: ["safety", "lathe", "ui", "download-gate"]
      }
    ];
