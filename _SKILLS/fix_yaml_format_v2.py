...
DESCRIPTIONS = {
    ...
    "prism-ai-deep-learning": "Deep Learning architectures for PRISM Manufacturing Intelligence.",
    ...
    "prism-skill-orchestrator": "Master integration skill defining how all PRISM skills and agents work together.",
}
...
def fix_yaml_format(filepath):
    """Fix file to have YAML frontmatter on line 1, removing ALL other YAML blocks"""
    ...
    # This handles multiple blocks too
    while True:
    ...
    # Also remove any YAML blocks in the middle of content
    content = re.sub(r'\n---\s*\n.*?\n---\s*\n', '\n', content, flags=re.DOTALL)
    
    # Clean up the content
    content = content.strip()
    
    # Build new content with proper YAML on line 1
    new_content = f"""---
name: {skill_name}
description: |
  {description}
...
def main():
    folder = r"C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\_SKILLS\UPLOAD_ALL"
    
    print("=" * 60)
    print("FIXING ALL YAML FORMAT (removing duplicates)")
    print("=" * 60)
    print()
