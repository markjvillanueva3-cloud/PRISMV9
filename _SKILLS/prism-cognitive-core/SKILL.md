# ═══════════════════════════════════════════════════════════════════════════════
# PRISM COGNITIVE CORE v2.0 - LEVEL 0 ALWAYS-ON
# ═══════════════════════════════════════════════════════════════════════════════
# UNIVERSAL ENHANCEMENT: Apply these patterns to EVERYTHING
# Part of Cognitive Enhancement v7.0
# Source: Integrated 11 cognitive skills (~11,000+ lines)
...
type: ALWAYS_ON
description: |
  Level 0 Always-On cognitive enhancement that improves EVERY operation.
  v2.0 EXPANSION: Now embeds 5 original patterns + 5 new cognitive components.
  30 hooks total (15 original + 15 new from Cognitive Enhancement v7.0).
  Apply these patterns automatically without being asked.
activation: AUTOMATIC (every task, every decision, every output)
references:
  # Original L1 Skills
  ...
  - prism-master-equation (L2) - Ω(x) integration (now v2.0)
  # NEW v2.0 Skills (Cognitive Enhancement v7.0)
  - prism-anomaly-detector (L1) - 7 anomaly types → D(x)
  - prism-attention-focus (L1) - Context prioritization → A(x)
  - prism-causal-reasoning (L1) - Cause-effect graphs → K(x)
  - prism-memory-augmentation (L1) - Session continuity → M(x)
  - prism-self-reflection (L1) - Self-assessment → REFL hooks
---

# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 1: THE 5 ORIGINAL COGNITIVE PATTERNS (v1.0)
# ═══════════════════════════════════════════════════════════════════════════════
