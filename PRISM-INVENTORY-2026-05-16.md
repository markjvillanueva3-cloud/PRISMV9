...
**Updated:** 2026-05-16T23:59:00.995Z
**Source:** live scan (93ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3259 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 7702 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 3697 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 609 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 864 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 220 | live: `.claude/commands/` |
| **Slash Commands (user)** | 394 | live: `~/.claude/commands/` |
