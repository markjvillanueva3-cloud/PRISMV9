...
**Updated:** 2026-06-26T20:22:33.751Z
**Source:** live scan (287ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3850 | live: `src/engines/*.ts` |
| **Dispatchers** | 112 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10358 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 28 | live: `src/registries/*.ts` |
| **Tests** | 5147 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 1044 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 3189 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 775 | live: `.claude/commands/` |
