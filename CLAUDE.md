...
- **Engines**: 87 WEDM/EDM engines (`src/engines/WEDM*.ts`, `EDM*.ts`, `WireEDM*.ts`)
...
- **State Files**: 31 WEDM state/index files (`data/state/WEDM_*.json`, incl. WEDM_TRANSFER_REGISTRY v2 with 24 curated mappings)
