...
- **Engines**: 97 WEDM/EDM engines (`src/engines/WEDM*.ts`, `EDM*.ts`, `WireEDM*.ts`)
...
- **State Files**: 32 WEDM state/index files (`data/state/WEDM_*.json`, incl. WEDM_TRANSFER_REGISTRY v2 with 24 curated mappings, WEDM_DRIFT_BASELINE v2 with 10 model heads, WEDM_RL_POLICY v1 LinUCB bandit snapshot)
