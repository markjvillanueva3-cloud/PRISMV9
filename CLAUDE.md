...
- **Engines**: 93 WEDM/EDM engines (`src/engines/WEDM*.ts`, `EDM*.ts`, `WireEDM*.ts`)
...
- **State Files**: 31 WEDM state/index files (`data/state/WEDM_*.json`, incl. WEDM_TRANSFER_REGISTRY v2 with 24 curated mappings, WEDM_DRIFT_BASELINE v2 with 10 model heads)
