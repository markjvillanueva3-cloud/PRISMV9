...
- 2026-06-14 | **[MAIN-FORCE] [WIRE-UNWIRED-PAPA]/U-WIRE-FORMAL (slot:papa): wire FormalVerificationEngine (Z3 SAT/SMT) -> prism_dev (formal_prove/formal_...** | observed-in: 4b144ce6d | fix: see commit | verify: `git -C H:/prism show 4b144ce6d`
- 2026-06-13 | **[MAIN-FORCE] [QUOTING-SYNERGY-MS0]/U-QP-TRAINING-STATUS-UI (slot:charlie): build TrainingStatusPanel (fix 6 orphaned T5 tests) + render $...** | observed-in: 512a11254 | fix: see commit | verify: `git -C H:/prism show 512a11254`
- 2026-06-13 | **[MAIN-FORCE] [AI-SYNERGY-BRIDGE-WIKI]/U-BRIDGE-WIKI-TEST-PIN (slot:bravo): single-corpus refactor + regression-PINNED CAG-hit test (3-of-...** | observed-in: 23692f9ff | fix: see commit | verify: `git -C H:/prism show 23692f9ff`
- 2026-06-13 | **[MAIN-FORCE] [AI-SYNERGY-BRIDGE-WIKI]/U-BRIDGE-WIKI-DENSE-FIX (slot:bravo): thread includeWiki through dense rerank + CAG fingerprint (3-...** | observed-in: 5ab3d8228 | fix: see commit | verify: `git -C H:/prism show 5ab3d8228`
- 2026-06-13 | **[MAIN-FORCE] [PER-SLOT-CLAUDEMD-MS0]/U-PSCM-ASSESS-MAPFIX (slot:alpha): 34-galaxy CLAUDE.md assessment + canonical template; fix 2 slot-g...** | observed-in: e40323355 | fix: see commit | verify: `git -C H:/prism show e40323355`
- 2026-06-13 | **[MAIN-FORCE] [MCP-RELIABILITY]/U-MCP-DUP-TOOL-BOOT-FIX (slot:bravo): fix fleet-wide MCP :3100 boot crash from duplicate tool registration...** | observed-in: 5010a01a8 | fix: see commit | verify: `git -C H:/prism show 5010a01a8`
- 2026-06-13 | **[MAIN-FORCE] [MODEL-ROUTING-MS0]/U-SFLC-NOTE-CORRECT (slot:echo): correct stale CLAUDE.md regression note -- stop-force-loop-continue fin...** | observed-in: 9821bebb8 | fix: see commit | verify: `git -C H:/prism show 9821bebb8`
- 2026-06-11 | **[MAIN] [BOOTSTRAP-SLOT-ENFORCE] [FLEET-INJECTION-BUDGET-AUDIT]/U-FIBA-ZULU-FLEET-COMPACT-ENABLE (slot:alpha): enable hermes/zulu fleet se...** | observed-in: cebb5639b | fix: see commit | verify: `git -C H:/prism show cebb5639b`
- 2026-06-11 | **[MAIN] [BOOTSTRAP-SLOT-ENFORCE] [AI-SYNERGY-AUDIT-MS0]/U-GOAL-LOSS-FN-DETECT-FIX (slot:tango): apply 3-of-3 scrutiny P1s -- lazy-import f...** | observed-in: 3a2e1b6b4 | fix: see commit | verify: `git -C H:/prism show 3a2e1b6b4`
- 2026-06-11 | **[MAIN] [BOOTSTRAP-SLOT-ENFORCE] [FLEET-INJECTION-BUDGET-AUDIT]/U-FIBA-COMPACT-PHANTOM-DOC (slot:alpha): log the compact-phantom false-nud...** | observed-in: 87f90f8bd | fix: see commit | verify: `git -C H:/prism show 87f90f8bd`
- 2026-06-11 | **[MAIN] [BOOTSTRAP-SLOT-ENFORCE] [FLEET-INJECTION-BUDGET-AUDIT]/U-FIBA-COMPACT-PHANTOM-FIX (slot:alpha): stop the constant false /compact ...** | observed-in: 7b8dbde2d | fix: see commit | verify: `git -C H:/prism show 7b8dbde2d`
- 2026-06-11 | **[MAIN] [BOOTSTRAP-SLOT-ENFORCE] [AI-SYNERGY-AUDIT-MS0]/U-AISYN-GNN-HETERO-PREDICT-FIX (slot:alpha): complete the GNN build -- heterophily...** | observed-in: b1f72793f | fix: see commit | verify: `git -C H:/prism show b1f72793f`
- 2026-06-11 | **[MAIN] [BOOTSTRAP-SLOT-ENFORCE] [ZULU-ACCOUNT-CYCLE]/U-5H-COORDINATOR-WIRE (slot:bravo): wire denominator-free 5h-switch gate into accoun...** | observed-in: a5b65b871 | fix: see commit | verify: `git -C H:/prism show a5b65b871`
- 2026-06-11 | **[MAIN] [OBSIDIAN-AI-SYNERGY]/U-OLLAMA-KEEPALIVE-FIX (slot:india): ask-ollama keep_alive 10m -> OLLAMA_KEEP_ALIVE||30m** | observed-in: e5f29a5df | fix: see commit | verify: `git -C H:/prism show e5f29a5df`
- 2026-06-11 | **[MAIN] [BOOTSTRAP-SLOT-ENFORCE] [QUOTING-SYNERGY-MS0]/U-QP-DRIFT-FRESHNESS-PRODUCER-KEYS (slot:charlie): fix T16 -- driftFreshness read t...** | observed-in: bff00a614 | fix: see commit | verify: `git -C H:/prism show bff00a614`
...
Three pipeline artifacts close the audit gap (offload ratio 13.8% → 30% target): `scripts/ollama-docker-health.mjs` CLI probe · `ollama-pipeline-injector.mjs` UserPromptSubmit hook (matches `/forge-audit`, `/rgs`, `/scrutinize`, `/dedup`, `/precompact`, `/deep-search`, `/pdf-learn`, `/close-out-audit`, `/forge-triple` → injects phase→model routing) · `ollama-prewarm-on-pipeline.mjs` (detached `/api/generate` warm-up). **OLLAMA-EXPAND** ships `scripts/ask-ollama.mjs` (modes: viz/summarize/explain/triage/ask; single warm qwen2.5-coder:3b + keep_alive) + `ollama-prism-bridge.mjs` L2 agent-loop (3 read-only tools). **WIKI-OFFLOAD-ADVISORY** (HIGH-ROI-TOKEN-SAVINGS/U-WIKI-OFFLOAD-ADVISORY, slot:golf, 2026-05-20, commit `6853d35257`): `wiki-read-offload-advisory.mjs` PreToolUse:Read hook surfaces `/route-to-obsidian` for wiki entries ≥500 lines; bumps `ollama-offload-stats.json byHook.wiki-read-offload-advisory.suggested`. Knobs: `PRISM_OLLAMA_PIPELINE_INJECT`, `PRISM_OLLAMA_PREWARM_DISABLE`, `PRISM_WIKI_OFFLOAD_{ADVISORY_DISABLE,MIN_LINES,VERBOSE}`. Wiki: [[ollama-pipeline-ms0]] · [[ollama-expand-ms0]] · [[ollama-prism-bridge]]. Memory: [[reference_ollama_pipeline_ms0_2026_05_15]] · [[reference_ollama_expand_ms0]] · [[reference_ollama_prism_bridge_l2]].
