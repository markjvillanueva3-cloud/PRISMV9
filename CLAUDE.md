...
- **Hooks**: 22 WEDM hooks (16 safety + 2 SVI coupling + 2 perception + 2 learning)
- **Playbooks**: 8 workflow playbooks (`data/playbooks/wedm_*.json`)
- **State Files**: 39 WEDM state/index files (`data/state/WEDM_*.json`, incl. WEDM_AUTONOMY_STATE v1 L0 cold-start seed, WEDM_TRANSFER_REGISTRY v2 with 24 curated mappings, WEDM_DRIFT_BASELINE v2 with 10 model heads, WEDM_RL_POLICY v1 LinUCB bandit snapshot)
