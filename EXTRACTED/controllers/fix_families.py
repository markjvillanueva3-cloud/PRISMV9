...
# Load
with open(r'C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\EXTRACTED\controllers\MASTER_ALARM_DATABASE_v2.json', 'r') as f:
    db = json.load(f)
...
# Save
with open(r'C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\EXTRACTED\controllers\MASTER_ALARM_DATABASE_v2.json', 'w') as f:
