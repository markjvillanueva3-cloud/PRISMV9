...
**Updated:** 2026-05-28T19:07:46.864Z
...
| **Actions** | 9861 | live: `z.enum` count across dispatchers |
| **Algorithms** | 109 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4570 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 844 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1822 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 367 | live: `.claude/commands/` |
| **Slash Commands (user)** | 395 | live: `~/.claude/commands/` |
