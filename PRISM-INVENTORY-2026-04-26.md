...
**Updated:** 2026-04-26T23:32:25.125Z
**Source:** live scan (34ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 2392 | live: `src/engines/*.ts` |
| **Dispatchers** | 91 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 5685 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 929 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 53 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 299 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 30 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 58 | live: `.claude/commands/` |
| **Slash Commands (user)** | 292 | live: `~/.claude/commands/` |
