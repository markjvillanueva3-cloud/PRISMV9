...
```
FORMULA_REGISTRY:   H:\prism\data\FORMULA_REGISTRY.json
COEFFICIENT_DB:     H:\prism\data\COEFFICIENT_DATABASE.json
PREDICTION_LOG:     H:\prism\state\learning\PREDICTION_LOG.json
CALIBRATION_STATE:  H:\prism\state\CALIBRATION_STATE.json
```
...
class FormulaRegistry:
    ...
    def __init__(self, registry_path="H:/prism/data/FORMULA_REGISTRY.json"):
...
class CoefficientDatabase:
    ...
    def __init__(self, db_path="H:/prism/data/COEFFICIENT_DATABASE.json"):
...
py -3 H:\prism\scripts\validate_formulas.py

# Trigger calibration for specific formula
py -3 H:\prism\scripts\calibrate_formula.py F-PLAN-002

# View calibration status
py -3 H:\prism\scripts\prism_unified_system_v6.py --formula-status
```
