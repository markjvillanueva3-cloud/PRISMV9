...
### When To Use
- Trigger keywords: "large", "file", "writer", "optimized", "workflow", "writing", "files", "like"
- Quality gate check, anti-regression validation, or release readiness assessment.

### How To Use
1. Load skill: `prism_skill_script→skill_content(id="prism-large-file-writer")`
...
### Examples
**Example 1**: User asks about large
→ Load skill: skill_content("prism-large-file-writer") → Apply relevant knowledge → Provide structured response

**Example 2**: Task requires file guidance
...
Filesystem:write_file({
  path: "C:\\PRISM\\EXTRACTED\\[category]\\filename.js",
  content: `/**
