...
**Updated:** 2026-05-10T23:51:36.135Z
...
|----------|-------|--------|
| **Engines** | 3181 | live: `src/engines/*.ts` |
...
| **Tests** | 3431 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 464 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 532 | live: `scripts/` + `mcp-server/scripts/` |
