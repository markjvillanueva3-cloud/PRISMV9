...
**Updated:** 2026-05-23T22:22:46.500Z
**Source:** live scan (75ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3356 | live: `src/engines/*.ts` |
| **Dispatchers** | 102 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 8682 | live: `z.enum` count across dispatchers |
| **Algorithms** | 64 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4137 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 752 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1340 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 302 | live: `.claude/commands/` |
