...
**Updated:** 2026-05-31T23:55:15.164Z
**Source:** live scan (90ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3766 | live: `src/engines/*.ts` |
...
| **Tests** | 4616 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 865 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1984 | live: `scripts/` + `mcp-server/scripts/` |
