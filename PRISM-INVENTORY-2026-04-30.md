...
**Updated:** 2026-04-30T23:39:19.009Z
**Source:** live scan (30ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3020 | live: `src/engines/*.ts` |
| **Dispatchers** | 95 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 6662 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 3079 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 415 | live: `.claude/hooks/**/*.mjs` |
