...
**Updated:** 2026-06-11T23:24:05.082Z
...
|----------|-------|--------|
| **Engines** | 3790 | live: `src/engines/*.ts` |
| **Dispatchers** | 108 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10046 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4764 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 946 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2500 | live: `scripts/` + `mcp-server/scripts/` |
