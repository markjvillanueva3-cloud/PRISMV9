...
**Updated:** 2026-06-19T20:17:10.696Z
...
|----------|-------|--------|
| **Engines** | 3817 | live: `src/engines/*.ts` |
| **Dispatchers** | 111 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10277 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4901 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 1019 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2858 | live: `scripts/` + `mcp-server/scripts/` |
