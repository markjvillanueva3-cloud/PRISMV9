...
# FANUC
exec(open(r"C:\\PRISM\EXTRACTED\controllers\build_fanuc_complete.py").read())
fanuc_data = FANUC_ALARMS

# HAAS
exec(open(r"C:\\PRISM\EXTRACTED\controllers\build_haas_complete.py").read())
haas_data = HAAS_ALARMS

# SIEMENS
exec(open(r"C:\\PRISM\EXTRACTED\controllers\build_siemens_complete.py").read())
siemens_data = SIEMENS_ALARMS

# MAZAK
exec(open(r"C:\\PRISM\EXTRACTED\controllers\build_mazak_complete.py").read())
mazak_data = MAZAK_ALARMS

# Load existing verified data for other controllers
existing_path = r"C:\\PRISM\EXTRACTED\controllers\MASTER_ALARM_DATABASE_ACCURATE.json"
existing_data = {}
...
output_path = r"C:\\PRISM\EXTRACTED\controllers\MASTER_ALARM_DATABASE_v2.json"
