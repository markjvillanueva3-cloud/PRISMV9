...
window.MACHINE_ENVELOPE_DATABASE = MACHINE_ENVELOPE_DATABASE;
...
// Count total machines - DEFERRED until database is loaded
// (This was causing errors because it ran before MACHINE_DATABASE was assigned)
function countMachinesInDatabase() {
    if (!MACHINE_DATABASE || !MACHINE_DATABASE.machines) return 0;
    return Object.keys(MACHINE_DATABASE.machines).length;
