...
& 'C:\Users\Admin.DIGITALSTORM-PC\AppData\Local\Programs\Python\Python312\python.exe' 'C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\_SCRIPTS\prism_unified_system_v4.py' --intelligent "Your task here"
```
