...
- path: C:\Users\wompu\Box\PRISM REBUILD\EXTRACTED\[category]\[filename].js
...
- path: C:\Users\wompu\Box\PRISM REBUILD\[path]\[filename]
```

### Creating Directories
```
Filesystem:create_directory
- path: C:\Users\wompu\Box\PRISM REBUILD\[new\path]
```
...
1. **Always use full Windows paths:** `C:\Users\wompu\Box\PRISM REBUILD\...`
