...
LEARNING_DIR = PRISM_ROOT / "_LEARNING"
KNOWLEDGE_DIR = PRISM_ROOT / "_KNOWLEDGE"
...
4. LEARN - Every interaction feeds ML pipeline, extract patterns
5. UNCERTAINTY - ALWAYS provide confidence intervals, never bare numbers
6. EXPLAIN - XAI for all, show reasoning chain
