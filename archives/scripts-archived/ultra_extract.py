...
print("ULTRA EXTRACTION - 5MB LIMIT")
print("=" * 60)
...
print("Remaining ultra modules: {}".format(len(remaining)))

output_dir = Path(r'C:\PRISM\extracted_modules\ULTRA')
output_dir.mkdir(exist_ok=True)

def extract_ultra(module_name):
...
for mod in remaining:
    extracted, status = extract_ultra(mod)
    if extracted:
