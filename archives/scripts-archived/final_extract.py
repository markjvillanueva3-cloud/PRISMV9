...
print("FINAL EXTRACTION - 20MB LIMIT")
print("=" * 60)
...
output_dir = Path(r'C:\PRISM\extracted_modules\FINAL')
output_dir.mkdir(exist_ok=True)

def extract_final(module_name):
...
for mod in remaining:
    extracted, status = extract_final(mod)
    if extracted:
