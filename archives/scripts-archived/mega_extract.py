...
print("MEGA MODULE EXTRACTION - 2MB LIMIT")
print("=" * 60)
...
print("Remaining mega modules: {}".format(len(remaining)))

output_dir = Path(r'C:\PRISM\extracted_modules\MEGA')
output_dir.mkdir(exist_ok=True)

def extract_mega(module_name):
...
for mod in remaining:
    extracted, status = extract_mega(mod)
    if extracted:
