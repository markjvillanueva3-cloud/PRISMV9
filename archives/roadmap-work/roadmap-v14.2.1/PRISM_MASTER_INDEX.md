# PRISM MODULAR ROADMAP — MASTER INDEX v14.3
...
### Phase Execution Context (v14.3)

```
DA:  Execution: Claude Code 100% | Sonnet | 1 session
R1:  Execution: Claude Code 80% + MCP 20% | Haiku→Sonnet→Opus | Parallel: MS5+MS6+MS7
R2:  Execution: Hybrid Code+MCP | Sonnet→Opus | Parallel: 5-agent benchmark fan
R3:  Execution: Hybrid Code+MCP | Sonnet→Opus | Background: data campaigns
R4:  Execution: Claude Code 90% | Sonnet | Opus at gate
R5a: Execution: Claude Code 100% | Sonnet | Parallel with R4
R5b: Execution: Hybrid MCP+Code | Sonnet | After R4+R5a
R6:  Execution: Claude Code 80% + MCP 20% | Sonnet→Opus | After R8
R7:  Execution: Hybrid Code+MCP | Haiku→Sonnet→Opus | Background: catalog extraction
R8:  Execution: Claude.ai MCP 80% + Code 20% | Opus→Sonnet
R9:  Execution: Claude Code 90% | Sonnet
R10: Execution: Claude.ai MCP 100% | Opus | Vision-phase
R11: Execution: Claude Code 70% + MCP 30% | Sonnet→Opus
```
