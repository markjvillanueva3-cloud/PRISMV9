...
3. C:/PRISM...\_SKILLS - Development skills (filesystem access)
    ...
    access_map = {
        ...
        "access_priority": {
            ...
            "order": [
                ...
                "3. C:\\C:/PRISM...\\_SKILLS - use Filesystem:read_file"
            ]
        },
        "container_skills": {
            skill: {
...
def sync_missing_skills():
    """Sync skills from C:/PRISM to PRISM consolidated"""
    consolidated_path = PRISM_ROOT / "skills-consolidated"
    rebuild_path = PRISM_REBUILD / "_SKILLS"
