...
│  Example: C:\PRISM REBUILD...\EXTRACTED\materials\steel_1045.json                       │
│                                                                                         │
...
☐ STEP 2: DECOMPOSE - Break into atomic tasks
☐ STEP 3: SPECIFY - Add exact paths, sizes, code outlines
☐ STEP 4: ORDER - Arrange by dependencies
☐ STEP 5: CHECKPOINT - Insert save points every 3-5 tasks
☐ STEP 6: VALIDATE - Review plan completeness
☐ VERIFY: All tasks have paths, outlines, verification criteria
```
...
├─────────────────────────────────────────────────────────────────────────────────────────┤
│ Type:     create                                                                        │
│ Path:     C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\[subpath]\[filename]           │
│ Size:     ~[X] lines, ~[Y]KB                                                            │
│ Time:     [N] minutes                                                                   │
...
T1: Create skill directory (2 min)
    Path: C:\PRISM REBUILD..\_SKILLS\prism-post-processor\
