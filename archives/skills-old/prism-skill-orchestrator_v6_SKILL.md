...
description: |
  Master integration skill defining how all 99 PRISM skills and 64 API agents
  ...
  critical mindset skills. Version 6.0 adds Combination Engine with F-PSI-001.
---

# PRISM Skill Orchestrator v6.0
## Complete Integration: 99 Skills + 64 API Agents + Combination Engine
### Updated: 2026-01-27
...
## Combination Engine (NEW v6.0 - 6 skills)

| Skill | Level | Trigger | API Agents |
|-------|-------|---------|------------|
| prism-combination-engine | L0 | "optimal", "F-PSI-001", "resource selection" | combination_optimizer, proof_generator |
| prism-swarm-coordinator | L1 | "swarm", "multi-agent" | synergy_analyst, test_orchestrator |
| prism-resource-optimizer | L1 | "optimize resources" | resource_auditor, calibration_engineer |
| prism-agent-selector | L1 | "select agent", "F-AGENT-001" | combination_optimizer |
| prism-synergy-calculator | L1 | "synergy", "F-SYNERGY-001" | synergy_analyst |
| prism-claude-code-bridge | L2 | "claude code", "agent sdk" | coordinator |
...
## NEW in v6.0 (8 agents)
```
combination_optimizer, synergy_analyst, proof_generator, resource_auditor,
calibration_engineer, test_orchestrator (NEW)
coordinator (UPGRADED), meta_analyst (UPGRADED), learning_extractor (UPGRADED)
```
