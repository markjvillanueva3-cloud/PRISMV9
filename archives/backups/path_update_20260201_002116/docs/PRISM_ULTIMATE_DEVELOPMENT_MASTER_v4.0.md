...
1. VERIFY Box folder access:
   → Filesystem:list_directory on C:\Users\wompu\Box\PRISM REBUILD\
...
**Location:** `C:\Users\wompu\Box\PRISM REBUILD\EXTRACTED\machines\ENHANCED\`
...
## Box Paths
```
Root:      C:\Users\wompu\Box\PRISM REBUILD\
Build:     _BUILD\
Docs:      _DOCS\
