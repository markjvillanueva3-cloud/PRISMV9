...
**Updated:** 2026-04-27T23:59:55.688Z
**Source:** live scan (35ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3017 | live: `src/engines/*.ts` |
| **Dispatchers** | 95 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 6535 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 3008 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 53 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 378 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 414 | live: `scripts/` + `mcp-server/scripts/` |
