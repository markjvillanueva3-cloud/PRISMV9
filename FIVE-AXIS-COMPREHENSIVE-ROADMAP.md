...
3-LOOP QUALITY PROTOCOL (MANDATORY for EVERY unit — see LATHE roadmap for full detail):
  ...
  ALL 3 LOOPS pass → next unit. /compact every 3 units.
```
...
7. /compact (save 3-loop results + what's next)
