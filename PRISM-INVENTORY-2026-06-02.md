...
**Updated:** 2026-06-02T20:37:32.917Z
**Source:** live scan (9198ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3771 | live: `src/engines/*.ts` |
| **Dispatchers** | 106 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 9947 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4646 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 868 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2079 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 392 | live: `.claude/commands/` |
