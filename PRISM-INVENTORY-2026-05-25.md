...
**Updated:** 2026-05-25T23:59:19.773Z
**Source:** live scan (175ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3629 | live: `src/engines/*.ts` |
| **Dispatchers** | 103 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 9480 | live: `z.enum` count across dispatchers |
| **Algorithms** | 82 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4439 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 821 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1504 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 314 | live: `.claude/commands/` |
