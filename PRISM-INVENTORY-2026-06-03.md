...
**Updated:** 2026-06-03T20:46:46.861Z
...
|----------|-------|--------|
| **Engines** | 3777 | live: `src/engines/*.ts` |
| **Dispatchers** | 106 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 9972 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4670 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 872 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2134 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 393 | live: `.claude/commands/` |
