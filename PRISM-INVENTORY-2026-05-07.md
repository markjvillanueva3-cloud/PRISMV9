...
**Updated:** 2026-05-07T20:56:40.918Z
**Source:** live scan (56ms) — via scripts/update-prism-inventory.mjs
...
| **Actions** | 7229 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 3373 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 433 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 456 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 237 | live: `.claude/commands/` |
| **Slash Commands (user)** | 363 | live: `~/.claude/commands/` |
