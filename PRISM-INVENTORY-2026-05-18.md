...
**Updated:** 2026-05-18T23:52:39.587Z
**Source:** live scan (110ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3284 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 8218 | live: `z.enum` count across dispatchers |
| **Algorithms** | 61 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 3876 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 651 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1017 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 238 | live: `.claude/commands/` |
