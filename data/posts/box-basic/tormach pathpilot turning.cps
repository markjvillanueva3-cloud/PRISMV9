/**
  ...
  Tormach 15L and RapidTurn Lathe post processor configuration.
...
*/
description = "Tormach 15L and RapidTurn Turning (PathPilot)";
longDescription = "Turning post for Tormach 15L or RapidTurn with a PathPilot control. Use Turret 0 for Positional Turret, Turret 1 for QCTP on Front Post, Turret 2 for QCTP on Rear Post, Turret 3 for Gang Tooling on Front Post, Turret 4 for Gang Tooling on Rear Tool Post. Valid RapidTurn Turrets are 0/2/4.";
var model = "15L";
...
properties.maximumSpindleSpeed.value = 3500;
properties.useMultiTools = {
  title      : "Support multiple tools in single pocket",
  description: "Enable if this program uses multiple tools in the same pocket of the turret." +
    "Specify the tool and offset number with the first 2 digits as the pocket number and the second 2 digits as the tool number." +
    "For example, T0713 for tool 13 loaded in pocket 7.",
  group: "preferences",
  type : "boolean",
  value: false,
  scope: "post"
