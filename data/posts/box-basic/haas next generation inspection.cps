/**
  ...
  FORKID {E6FF9D98-F95F-2089-DDE4-CD554650212F}
*/
...
function inspectionValidateInspectionSettings() {
  ...
  if (errorText != "") {
    error(localize("The following properties need to be configured:" + errorText + "\n-Please consult the guide PDF found at https://cam.autodesk.com/hsmposts?p=haas_next_generation_inspection for more information-"));
  }
}
