...
properties = {
  ...
  usePitchForTapping: {
    ...
    description: "Enables the use of pitch and threads per inch instead of feed for tapping cycles. Using G77/78 instead of G74/84",
    group      : "preferences",
    type       : "boolean",
    value      : false,
    scope      : "post"
...
function onOpen() {
  ...
  writeComment("O" + oFormat.format(getProgramNumber()) + conditional(programComment, " " + formatComment(programComment)));
  writeProgramHeader();
