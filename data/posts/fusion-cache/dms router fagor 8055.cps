/**
  ...
  $Revision: 44061 5eafd6995b96bdd70030abecbbb15c8f8136e47b $
  $Date: 2023-04-12 17:37:04 $
...
wcsDefinitions = {
  ...
  wcs          : [
    ...
    {name:"Extended", format:"G159 N", range:[5, 20]}
  ]
};
  ...
  if (insertToolCall || retracted) {
    ...
    if (!machineConfiguration.isHeadConfiguration()) {
      ...
      writeBlock(
        ...
        zOutput.format(initialPosition.z), conditional(!getProperty("fifthAxis"), dOutput.format(lengthOffset))
      );
    } else {
      writeBlock(
        gAbsIncModal.format(90),
