/**
  ...
  WinCNC Plasma post processor configuration.

  $Revision: 43793 d40578e2e144c6eec8d617d28994bee231ce87cd $
  $Date: 2022-05-04 18:14:20 $

  FORKID {5D3A0867-DA98-4D72-AF15-9BAA562969DF}
*/

description = "WinCNC Plasma";
vendor = "WinCNC";
...
longDescription = "Generic post for WinCNC plasma.";
  ...
  if (x || y) {
    if (pendingRadiusCompensation >= 0) {
      ...
      case RADIUS_COMPENSATION_LEFT:
        writeBlock(
          gMotionModal.format(1), gFormat.format(41), x, y
        );
        break;
      case RADIUS_COMPENSATION_RIGHT:
        writeBlock(
          gMotionModal.format(1), gFormat.format(42), x, y
        );
        break;
      default:
        writeBlock(gMotionModal.format(1), gFormat.format(40), x, y);
      }
    } else {
