/**
  ...
  FORKID {ED0341B7-D1AF-4D7C-AE8B-E16E5A8742F9}
*/

description = "Carvey by Inventables";
vendor = "Inventables";
...
longDescription = "Milling post for Carvey by Inventables (Grbl). G28 is turned off by default but can be enabled using the property called 'safePositionMethod'.";
...
allowedCircularPlanes = (0 << PLANE_XY) || (0 << PLANE_ZX) || (0 << PLANE_YZ); // circular interpolation is not supported
