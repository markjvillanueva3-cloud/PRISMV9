/**
  ...
  RichAuto post processor configuration.

  $Revision: 44104 165ed1a9c77e5601dab85a96f32381c0b4a83b25 $
  $Date: 2023-12-14 12:10:48 $

  FORKID {16700C1F-9441-4B4A-BC87-768D4054CC2F}
*/

description = "RichAuto DSP";
vendor = "RichAuto";
vendorUrl = "http://www.richauto.com.cn";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Generic milling post for RichAuto DSP.";
...
var xOutput = createOutputVariable({onchange:function() {state.retractedX = false;}, prefix:"X", force:false}, xyzFormat);
var yOutput = createOutputVariable({onchange:function() {state.retractedY = false;}, prefix:"Y", force:false}, xyzFormat);
var zOutput = createOutputVariable({onchange:function() {state.retractedZ = false;}, prefix:"Z"}, xyzFormat);
var feedOutput = createOutputVariable({prefix:"F", force:false}, feedFormat);
...
function onSection() {
  ...
  if (insertToolCall || newWorkOffset || newWorkPlane) {
    if (insertToolCall && !isFirstSection()) {// stop spindle before retract during tool change
