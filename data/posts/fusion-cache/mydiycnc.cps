...
properties = {
  accelerationTolerance: {
    title      : "Acceleration tolerance",
    description: "User defined tolerance for acceleration on.",
    group      : "preferences",
    type       : "number",
    value      : 0.01,
    scope      : "post"
...
function onOpen() {
  ...
  gFeedModeModal.disable(); // Feed modes are not supported
...
function onSection() {
  ...
  var tolerance = getParameter("operation:tolerance", 0);
  if (getProperty("accelerationTolerance") <= tolerance) {
