/**
  ...
  FlashCut post processor configuration.

  $Revision: 44104 165ed1a9c77e5601dab85a96f32381c0b4a83b25 $
  $Date: 2023-12-14 12:10:48 $

  FORKID {9CCB7B78-33CC-48a1-AF4E-C9EA31C4C3EF}
*/

// For plasma support use: M50 and M51

description = "FlashCut";
vendor = "FlashCut";
...
longDescription = "Generic milling post for FlashCut.";
...
wcsDefinitions = {
  ...
  wcs          : [
    ...
    {name:"Extended", format:"G54.1 P", range:[1, 100]}
  ]
};
