/**
  ...
  Ultimaker Digital Factory post processor configuration.
...
longDescription = "Post for exporting toolpath to the Ultimaker 2+ Connect, and other compatible printers.";
