...
longDescription = "Generic milling post for Bridgeport.";
...
var gFeedModeModal = createOutputVariable({}, gFormat); // modal group 5 // G44-45
...
function onSection() {
  ...
  writeBlock(gAbsIncModal.format(90), gFeedModeModal.format(44), gPlaneModal.format(17));
