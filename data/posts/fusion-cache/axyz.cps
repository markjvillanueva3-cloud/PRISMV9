/**
  ...
  AXYZ post processor configuration.
...
description = "AXYZ";
vendor = "AXYZ International";
vendorUrl = "http://www.axyz.com";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Generic milling post for AXYZ CNCs like Pacer.";
...
properties = {
  ...
  useM06: {
    title      : "Use M6",
    description: "Specifies if M6 should be used for tool changes.",
    group      : "preferences",
    type       : "boolean",
    value      : false,
    scope      : "post"
...
var settings = {
  ...
  comments: {
    permittedCommentChars: " abcdefghijklmnopqrstuvwxyz0123456789.,=_-", // letters are not case sensitive, use option 'outputFormat' below. Set to 'undefined' to allow any characterensitive, use option 'outputFormat' below
