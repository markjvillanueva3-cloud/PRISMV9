...
function onOpen() {
  ...
  if (false) { // note: setup your machine here
    ...
    var cAxis = createAxis({coordinate:1, table:true, axis:[0, 0, 1], range:[-999.999, 999.999], preference:0});
