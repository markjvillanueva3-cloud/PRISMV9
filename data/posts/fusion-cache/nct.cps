...
longDescription = "Generic milling post for NCT.";
...
var settings = {
  ...
  comments: {
    ...
    maximumLineLength    : 18 // the maximum number of characters allowed in a line, set to 0 to disable comment output
  },
