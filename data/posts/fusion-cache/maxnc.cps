/**
  ...
  MAXNC post processor configuration.

  $Revision: 44104 165ed1a9c77e5601dab85a96f32381c0b4a83b25 $
  $Date: 2023-12-14 12:10:48 $

  FORKID {9AACF64B-1017-46DF-8AFD-8060F7A95F40}
*/

description = "MAXNC";
vendor = "Ximotion";
vendorUrl = "https://www.maxnc.net";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Generic post for MAXNC.";
...
function onOpen() {
  ...
  writeBlock(gAbsIncModal.format(90), gCycleModal.format(80), gFormat.format(49), gFormat.format(40), gRetractModal.format(98), gFeedModeModal.format(94));
...
function onDwell(seconds) {
  ...
  var p = clamp(1, seconds * 1000, 99999);
  writeBlock(gFormat.format(4), "P" + milliFormat.format(p));
}
    ...
    for (var i in retract.words) {
      ...
      case "G53":
        ...
        if (retract.retractAxes[2]) {
          writeBlock(gFormat.format(49), "Z" + xyzFormat.format(0), mFormat.format(29));
          break;
        }
