/**
  ...
  $Revision: 44105 591ec7bf9cd3551575f4f76816adde699389c17d $
  $Date: 2023-12-20 20:33:55 $
...
longDescription = "Generic post for STEPCRAFT machines using UCCNC control software. If you are using a fourth axis, make sure to select which axis it is mounted along. If you have an automatic tool changer, enable the property 'Use tool changer'. For laser cutting, set your desired power setting by using property 'Laser power percentage'.";
...
function onPower(power) {
  if (tool.type == TOOL_PLASMA_CUTTER) {
  ...
  } else if (tool.type == TOOL_LASER_CUTTER) {
    ...
    error(localize("Unsupported tool type for jet toolpath, only Laser and Plasma cutters are supported."));
  }
}
