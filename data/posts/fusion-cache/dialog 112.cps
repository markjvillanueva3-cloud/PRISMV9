...
longDescription = "Post for Deckel Dialog 112.";
...
var tappingFeedFormat = createFormat({decimals:(unit == MM ? 2 : 3), forceDecimal:true});
...
function onCircular(clockwise, cx, cy, cz, x, y, z, feed) {
  ...
  if (isFullCircle()) {
    ...
    case PLANE_XY:
      ...
      writeBlock(gAbsIncModal.format(90), p, gMotionModal.format(clockwise ? 2 : 3), iOutput.format(cx - start.x), jOutput.format(cy - start.y), feedOutput.format(feed));
      break;
    case PLANE_ZX:
      ...
      writeBlock(gAbsIncModal.format(90), p, gMotionModal.format(clockwise ? 2 : 3), iOutput.format(cx - start.x), kOutput.format(cz - start.z), feedOutput.format(feed));
      break;
    case PLANE_YZ:
      ...
      writeBlock(gAbsIncModal.format(90), p, gMotionModal.format(clockwise ? 2 : 3), jOutput.format(cy - start.y), kOutput.format(cz - start.z), feedOutput.format(feed));
      break;
    default:
      linearize(tolerance);
    }
    ...
    case PLANE_XY:
      ...
      writeBlock(gAbsIncModal.format(90), p, gMotionModal.format(clockwise ? 2 : 3), xOutput.format(x), yOutput.format(y), zOutput.format(z), iOutput.format(cx - start.x), jOutput.format(cy - start.y), feedOutput.format(feed));
      break;
    case PLANE_ZX:
      var p = gPlaneModal.format(18);
      if (p) {
      ...
      writeBlock(gAbsIncModal.format(90), p, gMotionModal.format(clockwise ? 2 : 3), xOutput.format(x), yOutput.format(y), zOutput.format(z), iOutput.format(cx - start.x), kOutput.format(cz - start.z), feedOutput.format(feed));
      break;
    case PLANE_YZ:
      var p = gPlaneModal.format(19);
      if (p) {
      ...
      writeBlock(gAbsIncModal.format(90), p, gMotionModal.format(clockwise ? 2 : 3), xOutput.format(x), yOutput.format(y), zOutput.format(z), jOutput.format(cy - start.y), kOutput.format(cz - start.z), feedOutput.format(feed));
      break;
    default:
      linearize(tolerance);
    }
