/**
  ...
  APSX SPYDER post processor configuration.

  $Revision: 44104 165ed1a9c77e5601dab85a96f32381c0b4a83b25 $
  $Date: 2023-12-14 12:10:48 $

  FORKID {D2F52A3A-0E7B-4A0A-95B2-F5AC26B9C395}
*/

description = "APSX SPYDER";
vendor = "APSX";
vendorUrl = "https://www.apsx.com";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Generic milling post for APSX SPYDER machines using LinuxCNC.";
...
properties = {
  ...
  useWorkOffsets: {
    ...
    description: "Specifies to output the WCS (eg. G54, G55)",
    group      : "preferences",
    type       : "boolean",
    value      : false,
    scope      : "post"
...
wcsDefinitions = {
  ...
  wcs          : [
    ...
    {name:"Extended", format:"G59.1 P", range:[1, 3]}
  ]
};
...
function onOpen() {
  ...
  if (!getProperty("useG43")) {
    settings.outputToolLengthCompensation = false; // specifies if tool length compensation code should be output (G43)
    settings.outputToolLengthOffset = false; // specifies if tool length offset code should be output (Hxx)
  }
