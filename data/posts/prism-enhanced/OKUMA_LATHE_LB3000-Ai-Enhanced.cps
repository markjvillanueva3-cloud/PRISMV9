/**
  ...
  Okuma LB3000EXII Mill-Turn Post Processor
  Optimized for OSP-P300L Control
  
  $Revision: 44300 LB3000EXII Ultra Enhanced Edition $
  $Date: 2025-12-23 $

  FORKID {D93DAA65-1C09-402E-9871-3280B561D994}
  
  ============================================================================
  LB3000EXII MACHINE SPECIFICATIONS:
  
  - Max turning diameter: 13.78" (350mm)
  - Max turning length: 40.35" (1025mm)  
  - Main spindle: 5000 RPM, 30HP
  - Sub spindle: 5000 RPM (optional)
  - Live tooling: 6000 RPM milling spindle
  - Y-axis stroke: +/- 2.17" (+/- 55mm)
  - C-axis: Full 360° positioning
  - 12-station turret with live tooling
  - Programming: DIAMETER mode, INCHES
  
  ============================================================================
  OSP-P300L CONTROL FEATURES UTILIZED:
  
  Canned Cycles:
  - G85 Roughing cycle with NAT subprogram
  - G86 Finish cycle
  - G71/G33 Threading cycles
  - G84 Tapping cycle
  
  Speed/Feed Control:
  - G96/G97 Constant surface speed
  - SSV (Spindle Speed Variation) M695/M694
  - Variable feedrate control
  
  Cycle Time Optimization:
  - Tool preload (MT= command)
  - Circular tool preload for repeated runs
  - M216/M215 Rapid feed override ignore
  - Optimized retract positioning
  ...
  Advanced Features:
  - G137 Polar interpolation
  - G138 Y-axis mode
  - Spindle synchronization for transfers
  - Collision avoidance system (CAS)
  - Load monitoring (VLMON)
  
  Mill-Turn Features:
  - C-axis contouring
  - Y-axis milling
  - Live tool operations
...
longDescription = "Okuma LB3000EXII mill-turn lathe (OSP-P300L control) with full mill-turn support. Features SSV chatter control, tool preload for faster cycles, Y-axis milling, C-axis contouring, live tooling, and sub-spindle operations. Supports G85/G86 canned turning cycles. Programming in DIAMETER mode and INCHES.";
...
properties = {
  ...
  maximumSpindleSpeed: {
    ...
    description: "Defines the maximum spindle speed allowed (LB3000EXII: 5000 RPM main/sub).",
    group      : "configuration",
    type       : "integer",
    range      : [0, 999999999],
    value      : 5000,
  ...
  useSSV: {
    ...
    description: "Enable SSV to reduce chatter during turning. Outputs M695 (ON) / M694 (OFF).",
    group      : "ssvControl",
    type       : "boolean",
    value      : false,
    scope      : "post"
  ...
  useToolPreload: {
    ...
    description: "Preload next tool while current tool is cutting (MT= command).",
    group      : "cycleTime",
    type       : "boolean",
    value      : true,
    scope      : "post"
  ...
  useCircularToolPreload: {
    ...
    description: "Preload FIRST tool when LAST tool runs for faster repeated cycle starts.",
    group      : "cycleTime",
    type       : "boolean",
    value      : true,
    scope      : "post"
  ...
  useRapidFeedIgnore: {
    ...
    description: "Use M216 to ignore rapid override for maximum positioning speed.",
    group      : "cycleTime",
    type       : "boolean",
    value      : false,
    scope      : "post"
  ...
  useOptimizedRetract: {
    ...
    description: "Use G0 rapid retract instead of G28 for faster positioning.",
    group      : "cycleTime",
    type       : "boolean",
    value      : false,
    scope      : "post"
  ...
  minimizeRPlane: {
    title      : "Minimize R-plane retract",
    description: "Reduce Z-axis retract distance to get closer to part faster.",
    group      : "cycleTimeAdvanced",
    type       : "boolean",
    value      : false,
    scope      : "post"
  ...
  rPlaneReduction: {
    title      : "R-plane reduction (inches)",
    description: "Amount to reduce R-plane retract height when minimizeRPlane is enabled.",
    group      : "cycleTimeAdvanced",
    type       : "number",
    value      : 0.1,
    scope      : "post"
  ...
  useHighSpeedMode: {
    title      : "Use high-speed mode",
    description: "Enable high-speed machining mode for milling operations.",
    group      : "highSpeed",
    type       : "boolean",
    value      : false,
    scope      : "post"
  ...
  highSpeedTolerance: {
    title      : "High-speed tolerance (inches)",
    description: "Path tolerance for high-speed mode.",
    group      : "highSpeed",
    type       : "number",
    value      : 0.0005,
    scope      : "post"
  ...
  // =============== LIVE TOOLING ===============
  maximumLiveSpindleSpeed: {
    title      : "Max live tool speed",
    description: "Maximum speed for live tooling spindle (LB3000EXII: 6000 RPM).",
    group      : "configuration",
    type       : "integer",
    range      : [0, 999999999],
    value      : 6000,
...
///////////////////////////////////////////////////////////////////////////////
//        SSV (SPINDLE SPEED VARIATION) CONTROL - LB3000EXII
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
//        CYCLE TIME OPTIMIZATION FUNCTIONS - LB3000EXII
///////////////////////////////////////////////////////////////////////////////
...
function writeRapidFeedIgnore(enable) {
  ...
  if (enable) {
    writeBlock(rapidIgnoreModal.format(216)); // Rapid override ignored - max speed
  } else {
...
/**
  ...
  Uses MT= command to stage next tool in turret.
*/
...
/**
  Enable high-speed machining mode for milling operations.
*/
function writeHighSpeedMode(enable) {
  ...
  if (enable) {
    var tolerance = getProperty("highSpeedTolerance");
    writeBlock(gFormat.format(8), "P" + spatialFormat.format(tolerance * 1000)); // G8 high-speed mode
    writeComment("HIGH-SPEED MODE ON - TOL " + spatialFormat.format(tolerance));
  } else {
    writeBlock(gFormat.format(9)); // Cancel high-speed mode
  }
}
 ...
 */
  ...
  if (insertToolCall || operationNeedsSafeStart) {
    writeStartBlocks(insertToolCall, function () {
      ...
      // ENHANCED: Tool preload for faster tool changes
      writeToolPreload(tool.number);
      
      // ENHANCED: Enable rapid feed ignore for faster positioning
      if (insertToolCall) {
      ...
      // ENHANCED: Enable high-speed mode for milling operations
      if (!machineState.isTurningOperation) {
...
function onSectionEnd() {
  ...
  // ENHANCED: Cancel high-speed mode
