/**
  ...
  $Revision: 44001 Enhanced for VM30i $
  $Date: 2025-12-22 $
...
//   - Properties:
//     * "Use minimum Z retract between WCS" - Enable/disable
//     * "Minimum Z retract clearance" - Distance above stock (default 1.0)
//     * "Minimum Z retract from WCS zero" - Fixed Z position (0 = use stock+clearance)
//
// COOLANT CODES:
...
longDescription = "Enhanced post for HURCO VM30i with WinMax control. Features: Minimum Z retract between work offsets (saves cycle time), M98 subprogram calls for air through spindle, automatic G05.3 smoothing, safe start blocks, spindle warm-up, and comprehensive coolant options. Supports both ISNC and BNC modes.";
