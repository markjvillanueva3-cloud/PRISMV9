...
const PRISM_HERMLE_MACHINE_DATABASE_ENHANCED = {
    ...
    machines: [
        ...
        // ============================================
        {
            ...
            options: ["Additional magazine (up to 265 tools)", "Pallet changer PW 150/250/320/480", "Rotary storage RS 05", "Robot loading system", "High-pressure coolant 40/80 bar", "Chip conveyor variations", "Probing system"],
            applications: ["Precision mold making", "Medical implants", "Aerospace components", "Tool and die", "Turbine blades", "Complex 5-axis parts"]
        },
        
        {
            ...
            series: "C",
            generation: "U",
            work_envelope: { x: { min: 0, max: 800, unit: "mm" }, y: { min: 0, max: 800, unit: "mm" }, z: { min: 0, max: 550, unit: "mm" }, a_axis: { min: -130, max: 110, unit: "deg" }, c_axis: { min: -360, max: 360, continuous: true }, table_diameter: 420, max_workpiece_diameter: 600, max_workpiece_height: 450, table_load_capacity: 700, table_load_unit: "kg" },
            spindle: { type: "built_in_motor", taper: "HSK-A63", max_rpm: 18000, power_rating: 35, power_s1: 25, torque_max: 175, torque_s1: 105 },
            axis_specs: { x: { travel: 800, rapid_rate: 45000, acceleration: 5, guideway_type: "linear_roller", positioning_accuracy: 0.004, repeatability: 0.002 }, y: { travel: 800, rapid_rate: 45000, acceleration: 5, guideway_type: "linear_roller", positioning_accuracy: 0.004, repeatability: 0.002 }, z: { travel: 550, rapid_rate: 45000, acceleration: 4, guideway_type: "linear_roller", positioning_accuracy: 0.004, repeatability: 0.002 }, a: { travel: { min: -130, max: 110 }, rapid_rate: 40, max_torque: 1000, clamping_torque: 2500, drive_type: "direct_drive", positioning_accuracy: 0.001 }, c: { continuous: true, rapid_rate: 60, max_torque: 650, clamping_torque: 1300, drive_type: "direct_drive", positioning_accuracy: 0.001 } },
            ...
            kinematic_chain: { type: "modified_gantry", structure: "three_point_support", chain: ["mineral_cast_base", "gantry", "crossbeam_Y", "z_ram", "spindle", "table_base_X", "swivel_a", "rotary_c"], moving_masses: { crossbeam_y: { mass: 1600, cog: [0, 400, 900] }, z_ram: { mass: 750, cog: [0, 0, 275] }, table_x: { mass: 1100, cog: [0, 0, 120] } } },
            transformations: { x: { type: "translation", vector: [1, 0, 0], component: "table_base" }, y: { type: "translation", vector: [0, 1, 0], component: "crossbeam" }, z: { type: "translation", vector: [0, 0, 1], component: "z_ram" }, a: { type: "rotation", axis: [1, 0, 0], center: [0, 0, 200], component: "swivel_axis" }, c: { type: "rotation", axis: [0, 0, 1], component: "rotary_table" } },
        ...
        
        {
            ...
            series: "C",
            generation: "U",
            work_envelope: { x: { min: 0, max: 1000, unit: "mm" }, y: { min: 0, max: 1100, unit: "mm" }, z: { min: 0, max: 750, unit: "mm" }, a_axis: { min: -130, max: 110, unit: "deg" }, c_axis: { min: -360, max: 360, continuous: true }, table_diameter: 630, max_workpiece_diameter: 900, max_workpiece_height: 600, table_load_capacity: 2000, table_load_unit: "kg" },
            spindle: { type: "built_in_motor", taper: "HSK-A100", max_rpm: 12000, power_rating: 45, power_s1: 35, torque_max: 400, torque_s1: 280 },
            axis_specs: { x: { travel: 1000, rapid_rate: 40000, acceleration: 4, positioning_accuracy: 0.005, repeatability: 0.003 }, y: { travel: 1100, rapid_rate: 40000, acceleration: 4, positioning_accuracy: 0.005, repeatability: 0.003 }, z: { travel: 750, rapid_rate: 35000, acceleration: 3, positioning_accuracy: 0.005, repeatability: 0.003 }, a: { travel: { min: -130, max: 110 }, rapid_rate: 25, max_torque: 2500, clamping_torque: 6000, drive_type: "direct_drive", positioning_accuracy: 0.001 }, c: { continuous: true, rapid_rate: 35, max_torque: 1600, clamping_torque: 3200, drive_type: "direct_drive", positioning_accuracy: 0.001 } },
            ...
            transformations: { x: { type: "translation", vector: [1, 0, 0], component: "table_base" }, y: { type: "translation", vector: [0, 1, 0], component: "crossbeam" }, z: { type: "translation", vector: [0, 0, 1], component: "z_ram" }, a: { type: "rotation", axis: [1, 0, 0], center: [0, 0, 280], component: "swivel_axis" }, c: { type: "rotation", axis: [0, 0, 1], component: "rotary_table" } }
        },
        
        {
            ...
            series: "C",
            generation: "U",
            work_envelope: { x: { min: 0, max: 450, unit: "mm" }, y: { min: 0, max: 600, unit: "mm" }, z: { min: 0, max: 330, unit: "mm" }, a_axis: { min: -115, max: 110, unit: "deg" }, c_axis: { min: -360, max: 360, continuous: true }, table_diameter: 320, max_workpiece_diameter: 350, table_load_capacity: 300, table_load_unit: "kg" },
            spindle: { type: "built_in_motor", taper: "HSK-A63", max_rpm: 18000, power_rating: 22, torque_max: 110 },
            axis_specs: { x: { travel: 450, rapid_rate: 45000, positioning_accuracy: 0.003 }, y: { travel: 600, rapid_rate: 45000, positioning_accuracy: 0.003 }, z: { travel: 330, rapid_rate: 45000, positioning_accuracy: 0.003 }, a: { travel: { min: -115, max: 110 }, rapid_rate: 50, max_torque: 430, drive_type: "direct_drive", positioning_accuracy: 0.001 }, c: { continuous: true, rapid_rate: 70, max_torque: 280, drive_type: "direct_drive", positioning_accuracy: 0.001 } },
            ...
            transformations: { x: { type: "translation", vector: [1, 0, 0], component: "table_base" }, y: { type: "translation", vector: [0, 1, 0], component: "crossbeam" }, z: { type: "translation", vector: [0, 0, 1], component: "z_ram" }, a: { type: "rotation", axis: [1, 0, 0], center: [0, 0, 140], component: "swivel_axis" }, c: { type: "rotation", axis: [0, 0, 1], component: "rotary_table" } }
        },
        
        {
            ...
            series: "C",
            generation: "U",
            work_envelope: { x: { min: 0, max: 350, unit: "mm" }, y: { min: 0, max: 440, unit: "mm" }, z: { min: 0, max: 330, unit: "mm" }, a_axis: { min: -105, max: 130, unit: "deg" }, c_axis: { min: -360, max: 360, continuous: true }, table_diameter: 150, max_workpiece_diameter: 200, table_load_capacity: 100 },
            spindle: { type: "built_in_motor", taper: "HSK-E40", max_rpm: 42000, power_rating: 10, torque_max: 9 },
            axis_specs: { x: { travel: 350, rapid_rate: 45000, positioning_accuracy: 0.002 }, y: { travel: 440, rapid_rate: 45000, positioning_accuracy: 0.002 }, z: { travel: 330, rapid_rate: 45000, positioning_accuracy: 0.002 }, a: { travel: { min: -105, max: 130 }, rapid_rate: 80, max_torque: 75, drive_type: "direct_drive", positioning_accuracy: 0.001 }, c: { continuous: true, rapid_rate: 120, max_torque: 45, drive_type: "direct_drive", positioning_accuracy: 0.001 } },
            ...
            transformations: { x: { type: "translation", vector: [1, 0, 0], component: "table_base" }, y: { type: "translation", vector: [0, 1, 0], component: "crossbeam" }, z: { type: "translation", vector: [0, 0, 1], component: "z_ram" }, a: { type: "rotation", axis: [1, 0, 0], center: [0, 0, 100], component: "swivel_axis" }, c: { type: "rotation", axis: [0, 0, 1], component: "rotary_table" } }
        },
        
        {
            ...
            series: "C",
            work_envelope: { x: { min: 0, max: 650, unit: "mm" }, y: { min: 0, max: 650, unit: "mm" }, z: { min: 0, max: 500, unit: "mm" }, table_length: 700, table_width: 600, table_load_capacity: 1500, table_load_unit: "kg" },
            spindle: { type: "built_in_motor", taper: "HSK-A63", max_rpm: 18000, power_rating: 29, torque_max: 145 },
            axis_specs: { x: { travel: 650, rapid_rate: 45000, positioning_accuracy: 0.003, repeatability: 0.002 }, y: { travel: 650, rapid_rate: 45000, positioning_accuracy: 0.003, repeatability: 0.002 }, z: { travel: 500, rapid_rate: 45000, positioning_accuracy: 0.003, repeatability: 0.002 } },
            ...
            transformations: { x: { type: "translation", vector: [1, 0, 0], component: "table" }, y: { type: "translation", vector: [0, 1, 0], component: "crossbeam" }, z: { type: "translation", vector: [0, 0, 1], component: "z_ram" } }
        },
        
        {
            ...
            series: "C MT",
            work_envelope: { x: { min: 0, max: 800, unit: "mm" }, y: { min: 0, max: 800, unit: "mm" }, z: { min: 0, max: 550, unit: "mm" }, a_axis: { min: -110, max: 110, unit: "deg" }, c_axis: { min: -360, max: 360, continuous: true, turning_mode: true, turning_rpm: 800 }, table_diameter: 420, max_turning_diameter: 650, table_load_capacity: 600, table_load_unit: "kg" },
            spindle: { type: "built_in_motor", taper: "HSK-T100", max_rpm: 12000, power_rating: 45, torque_max: 353, turning_spindle: true },
            turning_table: { max_rpm: 800, continuous_torque: 800, max_torque: 1200, torque_unit: "Nm", turning_capability: true },
            axis_specs: { x: { travel: 800, rapid_rate: 45000, positioning_accuracy: 0.004 }, y: { travel: 800, rapid_rate: 45000, positioning_accuracy: 0.004 }, z: { travel: 550, rapid_rate: 45000, positioning_accuracy: 0.004 }, a: { travel: { min: -110, max: 110 }, rapid_rate: 40, max_torque: 1000, drive_type: "direct_drive", positioning_accuracy: 0.001 }, c: { continuous: true, rapid_rate: 60, max_torque: 650, turning_rpm_max: 800, drive_type: "direct_drive", positioning_accuracy: 0.001 } },
            ...
            transformations: { x: { type: "translation", vector: [1, 0, 0], component: "table_base" }, y: { type: "translation", vector: [0, 1, 0], component: "crossbeam" }, z: { type: "translation", vector: [0, 0, 1], component: "z_ram" }, a: { type: "rotation", axis: [1, 0, 0], center: [0, 0, 200], component: "swivel_axis" }, c: { type: "rotation", axis: [0, 0, 1], component: "turning_table" } }
        },
        
        {
            ...
            series: "C HS",
            work_envelope: { x: { min: 0, max: 650, unit: "mm" }, y: { min: 0, max: 650, unit: "mm" }, z: { min: 0, max: 500, unit: "mm" }, a_axis: { min: -130, max: 110, unit: "deg" }, c_axis: { min: -360, max: 360, continuous: true }, table_diameter: 320, table_load_capacity: 450, table_load_unit: "kg" },
            spindle: { type: "built_in_motor", taper: "HSK-E50", max_rpm: 42000, power_rating: 16, torque_max: 8, high_speed: true },
            axis_specs: { x: { travel: 650, rapid_rate: 60000, acceleration: 10, motor_type: "linear_motor_option", positioning_accuracy: 0.002 }, y: { travel: 650, rapid_rate: 60000, acceleration: 10, positioning_accuracy: 0.002 }, z: { travel: 500, rapid_rate: 50000, acceleration: 8, positioning_accuracy: 0.002 }, a: { travel: { min: -130, max: 110 }, rapid_rate: 70, max_torque: 700, drive_type: "direct_drive", positioning_accuracy: 0.001 }, c: { continuous: true, rapid_rate: 100, max_torque: 450, drive_type: "direct_drive", positioning_accuracy: 0.001 } },
            ...
            transformations: { x: { type: "translation", vector: [1, 0, 0], component: "table_base" }, y: { type: "translation", vector: [0, 1, 0], component: "crossbeam" }, z: { type: "translation", vector: [0, 0, 1], component: "z_ram" }, a: { type: "rotation", axis: [1, 0, 0], center: [0, 0, 175], component: "swivel_axis" }, c: { type: "rotation", axis: [0, 0, 1], component: "rotary_table" } }
        },
        
        {
            ...
            series: "C RS",
            work_envelope: { x: { min: 0, max: 650, unit: "mm" }, y: { min: 0, max: 650, unit: "mm" }, z: { min: 0, max: 500, unit: "mm" }, a_axis: { min: -130, max: 110, unit: "deg" }, c_axis: { min: -360, max: 360, continuous: true }, table_diameter: 320, table_load_capacity: 450 },
            spindle: { type: "built_in_motor", taper: "HSK-A63", max_rpm: 18000, power_rating: 29, torque_max: 145 },
            axis_specs: { x: { travel: 650, rapid_rate: 45000, positioning_accuracy: 0.003 }, y: { travel: 650, rapid_rate: 45000, positioning_accuracy: 0.003 }, z: { travel: 500, rapid_rate: 45000, positioning_accuracy: 0.003 }, a: { travel: { min: -130, max: 110 }, rapid_rate: 50, drive_type: "direct_drive", positioning_accuracy: 0.001 }, c: { continuous: true, rapid_rate: 70, drive_type: "direct_drive", positioning_accuracy: 0.001 } },
            automation: { type: "RS_05", robot_brand: "FANUC", payload: 12, payload_unit: "kg", pallet_storage: 20, pallet_size: 320, workpiece_max_diameter: 250, workpiece_max_height: 200, workpiece_max_weight: 10 },
    ...
    exportForSimulation: function(machineId) {
        ...
        return { id: machine.id, name: `${machine.manufacturer} ${machine.model}`, type: machine.type, kinematic_chain: machine.kinematic_chain, transformations: machine.transformations, axis_specs: machine.axis_specs, work_envelope: machine.work_envelope, geometry_reference: machine.geometry_reference, bed_construction: machine.bed_construction };
    }
};
