...
export const MACHINE_CATALOG: MachineCatalogItem[] = [
  ...
  },
  {
    ...
    spindleOptions: [
      spindleOption('m460v-5ax-main', '15,000 RPM CAT 40 Big+', 'Primary spindle package for trunnion-style simultaneous 5-axis work with through-spindle coolant support.'),
    ],
    controllerCapabilityOptions: [
      controllerCapabilityOption(
        'okuma-cas',
...
export const TOOL_CATALOG: ToolCatalogItem[] = [
  ...
  },
  {
    ...
    toolpathKeywords: ['finish pass', 'finish', 'profile', 'wall', 'floor', 'contour', 'pencil', 'sweep', 'recovery', 'probe'],
    toolMaterialClass: 'carbide',
    geometryClass: 'square-endmill',
    edgePrep: 'sharp',
    cornerRadiusMm: 0.2,
