...
export const TOOLS: CuttingToolEntry[] = [
  ...
  // Non-ferrous (aluminum/brass/copper) coverage — close the matrix-discovered
  // gap: TiAlN/AlTiN/AlCrN/CVD coatings all auto-reject ISO N. Aluminum
  // production shops need DLC + PCD + uncoated paths for face/slot/pocket/profile.
  { id: "EM-C-12-3-DLC-AL", name: "12mm 3-Flute DLC Aluminum Endmill", type: "endmill", manufacturer: "OSG", substrate: "Carbide", coating: "DLC", diameter: 12, fluteCount: 3, helixAngle: 45, maxDoc: 36, suitedOperations: ["slot_milling", "pocket_milling", "profile_milling", "semi-finishing", "finishing"], suitedMaterials: ["N"], avoidMaterials: ["P", "M", "S", "H"], maxRpm: 28000 },
  { id: "EM-C-10-2-UN-AL", name: "10mm 2-Flute Uncoated Aluminum Endmill", type: "endmill", manufacturer: "Mitsubishi", substrate: "Carbide", coating: "Uncoated", diameter: 10, fluteCount: 2, helixAngle: 45, maxDoc: 30, suitedOperations: ["slot_milling", "pocket_milling", "profile_milling", "finishing"], suitedMaterials: ["N"], avoidMaterials: ["S", "H"], maxRpm: 30000 },
  { id: "FM-C-50-4-PCD-AL", name: "50mm 4-Insert PCD Aluminum Face Mill", type: "face_mill", manufacturer: "Sandvik", substrate: "Carbide", coating: "PCD", diameter: 50, fluteCount: 4, helixAngle: 0, maxDoc: 3, suitedOperations: ["face_milling"], suitedMaterials: ["N"], avoidMaterials: ["P", "M", "K", "S", "H"], maxRpm: 12000 },
  { id: "EM-C-12-4-CER-S", name: "12mm 4-Flute Ceramic Superalloy Endmill", type: "endmill", manufacturer: "Kennametal", substrate: "Ceramic", coating: "AlCrN", diameter: 12, fluteCount: 4, helixAngle: 35, maxDoc: 24, suitedOperations: ["pocket_milling", "profile_milling", "semi-finishing"], suitedMaterials: ["S"], avoidMaterials: ["N"], maxRpm: 18000 },
];
