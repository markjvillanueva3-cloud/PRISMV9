...
const ROUTE_META: Record<string, LoadingMeta> = {
  ...
  '/intelligence': {
    ...
    detail: 'Preparing the prompt lab, internal CLI catalog, automation chains, and agent reasoning posture.',
  },
  '/travelers': {
    title: 'Traveler',
    detail: 'Preparing traveler routing, QR transitions, and the packet-level reasoning lane.',
  },
  '/dispatch': {
    title: 'Dispatch Board',
    detail: 'Preparing machine queues, what-if dispatch controls, and the planning copilot.',
  },
  '/integrations': {
    title: 'Integrations',
