...
import { shiftClockIn, shiftClockOut } from '../../api/client';
    ...
    <div className="rounded-[22px] border border-white/10 bg-white/[0.03] p-5">
      ...
      {showHandoff && (
        <div className="mt-4 rounded-lg border border-amber-300/20 bg-amber-300/[0.06] p-4">
          ...
          <div className="mt-3">
            <label className="block text-xs font-medium text-slate-400">Handoff notes (optional)</label>
            <textarea
              value={handoffNotes}
          ...
          <div className="mt-3 flex gap-3">
            <ActionButton onClick={() => void handleClockOut()} disabled={loading} tone="rose">
