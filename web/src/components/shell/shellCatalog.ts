...
export const NAV_SECTIONS: readonly NavSection[] = [
    ...
    items: [
      { to: '/dashboard', label: 'Dashboard', keywords: ['home', 'command center', 'oee'] },
      {
        ...
        items: [
          ...
          { to: '/ppg', label: 'Post Processor Generator', keywords: ['controller', 'g-code', 'post', 'generate', 'optimize'] },
          { to: '/post-processor', label: 'Post Processor Product', keywords: ['post processor', 'physics', 'pipeline', 'pricing', 'roi'] },
      ...
      { to: '/travelers', label: 'Traveler', keywords: ['traveler', 'routing', 'step tracking', 'qr'] },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/cost-estimator', label: 'Cost Estimator', keywords: ['kienzle', 'cost', 'estimate', 'cycle time', 'per part', 'physics'] },
      ...
      { to: '/dispatch', label: 'Dispatch Board', keywords: ['dispatch', 'queue', 'machine board', 'what-if'], minClearance: 'lead' },
    ],
  },
  {
    key: 'shop-erp',
    ...
    items: [
      ...
      { to: '/purchasing', label: 'Purchasing', keywords: ['suppliers', 'buyers'] },
      { to: '/purchase-orders', label: 'Purchase Orders', keywords: ['po', 'ap'] },
      { to: '/invoices', label: 'Invoices', keywords: ['billing', 'collections'] },
      { to: '/profitability', label: 'Profitability', keywords: ['margin', 'job cost'] },
      { to: '/tooling-cost', label: 'Tooling Cost', keywords: ['consumption', 'reorder'] },
      { to: '/general-ledger', label: 'General Ledger', keywords: ['accounting', 'trial balance'] },
      { to: '/quality', label: 'Quality', keywords: ['ncr', 'spc', 'capa'] },
      { to: '/customers', label: 'Customers', keywords: ['accounts', 'crm'] },
      { to: '/employees', label: 'People', keywords: ['skills', 'roster'], minClearance: 'hr_manager' },
      { to: '/shop-clock', label: 'Shop Clock', keywords: ['operator', 'kiosk'] },
      { to: '/travelers', label: 'Traveler', keywords: ['routing', 'step deck', 'qr scan'] },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/intelligence', label: 'PRISM Intelligence', keywords: ['ai', 'reasoning', 'cli', 'automation', 'chains', 'agents', 'deep learning', 'deep reasoning'] },
...
export const MOBILE_NAV_ITEMS: readonly NavItem[] = [
  ...
  { to: '/job-planner', label: 'Planner' },
  { to: '/safety', label: 'Safety' },
  { to: '/intelligence', label: 'AI' },
