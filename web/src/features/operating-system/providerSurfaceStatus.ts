...
export const OPERATING_SYSTEM_SURFACE_STATUS: Record<ProviderSurfaceId, ProviderSurfaceStatus> = {
  ...
  shopFloor: {
    ...
    label: 'Shop floor',
    mode: 'live-fallback',
    detail: 'Shop-floor registration, task building, and ROI signals use live routes with fallback.',
  },
  deskCounts: {
    id: 'deskCounts',
    label: 'Desk counts',
  ...
  intelligence: {
    ...
    label: 'Intelligence',
    mode: 'live-fallback',
    detail: 'The PRISM intelligence workspace now hydrates model, chain, CLI, and prompt-analysis posture from live operating-system routes with fixture fallback.',
  },
  inventoryOperations: {
