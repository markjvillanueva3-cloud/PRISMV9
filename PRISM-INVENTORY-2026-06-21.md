...
**Updated:** 2026-06-21T22:15:49.444Z
...
|----------|-------|--------|
| **Engines** | 3822 | live: `src/engines/*.ts` |
| **Dispatchers** | 111 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10285 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4937 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 1028 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2899 | live: `scripts/` + `mcp-server/scripts/` |
