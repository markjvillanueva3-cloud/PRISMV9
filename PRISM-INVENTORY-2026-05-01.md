...
**Updated:** 2026-05-01T23:57:34.526Z
...
|----------|-------|--------|
| **Engines** | 3032 | live: `src/engines/*.ts` |
| **Dispatchers** | 95 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 6730 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 3099 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 414 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 430 | live: `scripts/` + `mcp-server/scripts/` |
