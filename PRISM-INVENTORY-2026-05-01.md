...
**Updated:** 2026-05-01T21:19:54.719Z
...
|----------|-------|--------|
| **Engines** | 3024 | live: `src/engines/*.ts` |
| **Dispatchers** | 95 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 6661 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 3091 | live: `src/__tests__/**/*.test.ts` |
