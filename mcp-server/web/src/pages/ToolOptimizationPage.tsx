  ...
  const handleOptimize = useCallback(async () => {
    ...
    try {
      if (mode === 'tool-change') {
        ...
        const data = (resp as { result?: ToolChangeResult; data?: ToolChangeResult }).result
          ?? (resp as { result?: ToolChangeResult; data?: ToolChangeResult }).data
          ?? (resp as ToolChangeResult);
        ...
        const data = (resp as { result?: MagazineResult; data?: MagazineResult }).result
          ?? (resp as { result?: MagazineResult; data?: MagazineResult }).data
          ?? (resp as MagazineResult);
