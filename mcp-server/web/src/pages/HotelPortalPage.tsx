...
// attaches `Authorization: Bearer <token>` once setApiKey() ran at login; a logged-out visitor gets 401
// (surfaced as the page's error state). Previously these fetches sent no auth and the routes were anon.
