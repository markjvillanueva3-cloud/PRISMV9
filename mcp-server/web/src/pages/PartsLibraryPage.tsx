...
export function PartsLibraryPage() {
  ...
  const releaseSeed = useMemo(
    ...
    [attachments, revisions, selectedPart],
  );
  const links = {
    ...
    release: buildWorkflowPath('/print-to-cnc', location.search, {
      ...
      extras: {
        ...
        note: 'Carry revision lineage and linked files from Parts Library into Print to CNC.',
        partClassId: releaseSeed.partClassId,
        cadSourceId: releaseSeed.cadSourceId,
      },
    }),
