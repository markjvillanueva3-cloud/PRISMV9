...
const SAMPLE_JOBSHOP_RESULT: ScheduleResult = {
  ...
  utilization: 0.84,
  schedule: [
    { job_id: 'BRKT-01', machine: 'Haas VF-2SS', start: 0, end: 70 },
    { job_id: 'VALVE-22', machine: 'Haas ST-20Y', start: 0, end: 54 },
    { job_id: 'IMP-07', machine: 'Haas UMC-750', start: 0, end: 110 },
    { job_id: 'VALVE-22', machine: 'Haas VF-2SS', start: 74, end: 124 },
