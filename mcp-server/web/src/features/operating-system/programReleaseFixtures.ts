...
export const PROGRAM_RELEASE_CATALOG: ProgramReleaseCatalog = {
  ...
  machines: [
    ...
    },
    {
      ...
      manufacturerId: 'mazak',
      manufacturer: 'Mazak',
      label: 'Mazak Integrex',
      familyId: 'mill-turn',
      familyLabel: 'Mill-turn',
    ...
    {
      id: 'aln600g-wire',
      manufacturerId: 'sodick',
      manufacturer: 'Sodick',
      label: 'Sodick ALN600G',
      familyId: 'wire-edm',
      familyLabel: 'Wire EDM',
      controller: 'Sodick LN2W',
      kinematics: 'Wire EDM',
      spindle: 'Linear motor wire axis',
      maxRpm: 0,
      strength: 'High-precision wire burn posture with skim-cut stability',
      collisionEnvelope: 'Upper/lower head travel + flush cup clearance + submerged tank window',
      machineRatePerHour: 165,
    },
  ],
  toolholders: [
    {
  ...
  stockProfiles: [
    ...
    {
      id: 'd2-plate',
      label: 'D2 plate blank',
      material: 'D2 tool steel',
      size: '8.0 x 4.0 x 1.0 in',
      source: 'Tool steel rack',
      marketPrice: 118,
      logisticsCost: 16,
      volatility: 'Medium',
    },
