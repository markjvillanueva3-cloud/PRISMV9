...
const STORAGE_KEY = 'prism-theme-tokens-v1';
...
describe('applyThemeTokens (pure helper) + presets', () => {
  ...
  it('ACCENT_PRESETS includes PRISM Cyan and System Blue as RGB triples', () => {
    const byName = new Map(ACCENT_PRESETS.map((p) => [p.name, p.rgb]));
    expect(byName.get('PRISM Cyan')).toBe('34 211 238');
