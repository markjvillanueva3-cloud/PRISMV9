...
import { safeAreaPadding } from '../mobile/MobileSafeArea';
import {
  ALL_COURSES,
  type Course,
  type CourseDomain,
  ...
  return (
    <div className="mx-auto max-w-6xl p-4 pb-32 lg:pb-8">
      <header className="mb-4">
        <h1 className="text-2xl font-bold text-slate-900 sm:text-3xl">Kienzle Academy</h1>
      ...
      <div
        ...
        style={safeAreaPadding(['bottom'], 12)}
      >
