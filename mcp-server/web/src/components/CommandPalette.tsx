...
export function CommandPalette({ items, onClose, isOpen }: CommandPaletteProps) {
  ...
  return (
    ...
    >
      <div
        style={{
          width: "100%", maxWidth: 560, backgroundColor: "#1e1e2e",
      ...
      >
          ...
          {filtered.map((item, i) => (
            <div
              ...
              style={{
                ...
                backgroundColor: i === selectedIndex ? "#313244" : "transparent",
            ...
            >
              ...
              <span style={{
                fontSize: 11, color: "#585b70", textTransform: "uppercase",
                padding: "2px 6px", borderRadius: 4, backgroundColor: "#181825",
              }}>
                {item.category}
              </span>
            </div>
        ...
        <div style={{
          ...
          display: "flex", gap: 16, color: "#585b70", fontSize: 12,
        }}>
...
/**
 * Hook to register Ctrl+K keyboard shortcut for command palette.
 */
