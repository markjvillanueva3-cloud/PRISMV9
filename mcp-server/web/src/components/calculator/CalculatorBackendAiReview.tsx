...
export function CalculatorBackendAiReview(props: CalculatorBackendAiReviewProps) {
  ...
  const runReview = useCallback(
    async (force = false) => {
      ...
      try {
        await Promise.all([
          orchestrator.classify(reviewIntent, reviewContext),
    ...
    [orchestrator, reviewAvailable, reviewContext, reviewIntent, reviewKey],
  );
  ...
  }, [orchestrator, reviewAvailable, runReview]);
  ...
  }, [orchestrator, reviewAvailable, reviewContext, reviewIntent]);
