...
const MachineLivePage = lazyNamed(() => import('./pages/MachineLivePage'), 'MachineLivePage');
const DiagnosisPage = lazyNamed(() => import('./pages/DiagnosisPage'), 'DiagnosisPage');
const CncOpsPage = lazyNamed(() => import('./pages/CncOpsPage'), 'CncOpsPage');
const KnowledgeExtPage = lazyNamed(() => import('./pages/KnowledgeExtPage'), 'KnowledgeExtPage');
const VibrationPage = lazyNamed(() => import('./pages/VibrationPage'), 'VibrationPage');
const ThermalPage = lazyNamed(() => import('./pages/ThermalPage'), 'ThermalPage');
const EdmPage = lazyNamed(() => import('./pages/EdmPage'), 'EdmPage');
const TurningPage = lazyNamed(() => import('./pages/TurningPage'), 'TurningPage');
const GrindingPage = lazyNamed(() => import('./pages/GrindingPage'), 'GrindingPage');
const FormingPage = lazyNamed(() => import('./pages/FormingPage'), 'FormingPage');
const WeldingPage = lazyNamed(() => import('./pages/WeldingPage'), 'WeldingPage');
const SettingsPage = lazyNamed(() => import('./pages/SettingsPage'), 'SettingsPage');
// WIRE-MS0: Additional merged pages
const AdminPage = lazyNamed(() => import('./pages/AdminPage'), 'AdminPage');
const CamStrategyPage = lazyNamed(() => import('./pages/CamStrategyPage'), 'CamStrategyPage');
const CompliancePage = lazyNamed(() => import('./pages/CompliancePage'), 'CompliancePage');
const CostEstimatorPage = lazyNamed(() => import('./pages/CostEstimatorPage'), 'CostEstimatorPage');
const DataManagementPage = lazyNamed(() => import('./pages/DataManagementPage'), 'DataManagementPage');
const ErpDashboard = lazyNamed(() => import('./pages/ErpDashboard'), 'ErpDashboard');
const LandingPage = lazyNamed(() => import('./pages/LandingPage'), 'LandingPage');
const PostProcessorStorePage = lazyNamed(() => import('./pages/PostProcessorStorePage'), 'PostProcessorStorePage');
const PpgPage = lazyNamed(() => import('./pages/PpgPage'), 'PpgPage');
const QualityPage = lazyNamed(() => import('./pages/QualityPage'), 'QualityPage');
const SafetyDashboardPage = lazyNamed(() => import('./pages/SafetyDashboardPage'), 'SafetyDashboardPage');
const SfcCalculatorPage = lazyNamed(() => import('./pages/SfcCalculatorPage'), 'SfcCalculatorPage');
const ShopDashboardPage = lazyNamed(() => import('./pages/ShopDashboardPage'), 'ShopDashboardPage');
const SpeedFeedPage = lazyNamed(() => import('./pages/SpeedFeedPage'), 'SpeedFeedPage');
const TelemetryPage = lazyNamed(() => import('./pages/TelemetryPage'), 'TelemetryPage');
const WireEdmStudioPage = lazyNamed(() => import('./pages/WireEdmStudioPage'), 'WireEdmStudioPage');
