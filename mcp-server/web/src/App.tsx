...
const AccountingClosePage = lazyNamed(() => import('./pages/AccountingClosePage'), 'AccountingClosePage');
        ...
        <LearningProvider>
          <Routes>
            ...
            <Route element={<Layout />}>
              ...
              <Route path="accounting-close" element={lazyElement(secure(<AccountingClosePage />, 'hr_manager'))} />
