...
const CHRIS_TRACK: CurriculumTrack = {
  ...
  course_ids: [
    ...
    'course-50',  // Tooling database mastery (PRISM toolRegistry)
...
const MARK_TRACK: CurriculumTrack = {
  ...
  rationale: 'Manager + engineer path: business operations (35 accounting, 36 quoting, 38 logistics, 39 Excel) → engineering validation (52 CAD advanced, 54 FEA stress, 43 process validation) → operational excellence (47 lean/sigma/kaizen, 41 external resources, 42 PRISM app) → quick references for the things he buys + schedules (50 tooling DB, 51 workholding DB, 49 speed/feed). admin clearance gate.',
  course_ids: [
    ...
    'course-42',  // PRISM app mastery (he's the operator)
