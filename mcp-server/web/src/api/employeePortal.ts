...
// U-PORTAL-EXPRESS-ROUTES (2026-07-05): the dispatch endpoint now EXISTS, at the employee-portal
// mount. The original '/api/v1/portal' target was the CUSTOMER portal router, which never had a
// /dispatch route -- every action below hard-404'd from ship date until this fix.
const API_BASE = '/api/v1/employee-portal';
