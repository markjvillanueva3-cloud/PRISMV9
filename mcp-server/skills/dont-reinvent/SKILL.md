...
| 2     | ThreadCalculationEngine| engines/ThreadCalculationEngine.ts | 85%   |
...
## Autofire Integration
To make this fire automatically before forge operations, add to your local Claude hooks:
...
// In .claude/settings.json or project settings
{
  "hooks": {
    "PreSkillUse": [{
      "matcher": "forge-engine|forge-engines",
      "hooks": [{
        "type": "skill",
        "skill": "dont-reinvent"
      }]
...
Or manually invoke before any "build/create engine" request.
