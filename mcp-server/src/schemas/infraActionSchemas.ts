...
export const ACTION_INFRA_SCHEMAS: Record<string, z.ZodObject<any>> = {
  ...
  // -- INFRA-SYNERGY Phase 2: Elasticsearch backend observability (gated) --
  search_es_health: z.object({
    timeout_ms: z.number().int().positive().optional().describe("ES health request timeout in ms (default 10000)"),
  }),
