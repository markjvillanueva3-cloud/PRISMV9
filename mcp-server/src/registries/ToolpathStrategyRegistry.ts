...
console.error(`[ToolpathStrategyRegistry] Milling Roughing: ${MILLING_ROUGHING_COUNT} strategies`);
...
console.error(`[ToolpathStrategyRegistry] Milling Finishing: ${MILLING_FINISHING_COUNT} strategies`);
...
console.error(`[ToolpathStrategyRegistry] Hole Making: ${HOLE_MAKING_COUNT} strategies`);
...
console.error(`[ToolpathStrategyRegistry] Turning: ${TURNING_COUNT} strategies`);
...
console.error(`[ToolpathStrategyRegistry] Multi-Axis: ${MULTIAXIS_COUNT} strategies`);
...
console.error(`[ToolpathStrategyRegistry] PRISM Novel: ${PRISM_NOVEL_COUNT} strategies`);
...
console.error(`[ToolpathStrategyRegistry] Initialized with ${stats.total} strategies:`);
console.error(`  - Milling Roughing: ${stats.milling_roughing}`);
console.error(`  - Milling Finishing: ${stats.milling_finishing}`);
console.error(`  - Hole Making: ${stats.hole_making}`);
console.error(`  - Turning: ${stats.turning}`);
console.error(`  - Multi-Axis: ${stats.multiaxis}`);
console.error(`  - PRISM Novel: ${stats.prism_novel}`);
...
console.error(`[ToolpathStrategyRegistry] Extended Milling Roughing: ${Object.keys(MILLING_ROUGHING_EXTENDED).length} strategies`);
...
export function consolidateExtendedStrategies(): Map<string, ToolpathStrategy> {
  ...
  console.error(`[ToolpathStrategyRegistry] Consolidated ${allStrategies.size} extended strategies`);
...
// Log final count
console.error(`[ToolpathStrategyRegistry] Total extended strategies: ${EXTENDED_STRATEGIES.size}`);
console.error(`[ToolpathStrategyRegistry] Extended stats:`, JSON.stringify(getExtendedStats().byCategory, null, 2));
