...
const ENTITY_CONFIGS: Record<string, EntityConfig> = {
  ...
  shop_profiles: {
    ...
    primaryKey: "id",
    hasUpdatedAt: true,
    jsonColumns: ["rates", "machines", "company_profile", "source_roots", "seed_domains"],
    knownColumns: [
      "id",
      "name",
      "rates",
      ...
      "material_markup_pct",
      "tooling_cost_per_op",
      "material_cost_per_part_default",
      "admin_burden_pct",
      "company_profile",
      "source_roots",
      "seed_domains",
  ...
  // ── BIZ-MS0 U-BIZ01: Payroll Persistence ──────────────────────────────
  payroll_periods: {
    tableName: "payroll_periods",
    primaryKey: "id",
    hasUpdatedAt: false,
    knownColumns: ["id", "start_date", "end_date", "pay_date", "status", "type", "created_at"],
  },
  payroll_deductions: {
    ...
    businessKey: "employee_id",
    hasUpdatedAt: false,
    knownColumns: ["id", "employee_id", "federal_tax_rate", "state_tax_rate", "health_insurance_per_period", "retirement_401k_pct", "other_deductions_per_period", "created_at"],
  },
  payroll_ytd: {
    ...
    businessKey: "id",
    hasUpdatedAt: false,
    knownColumns: ["id", "gross", "federal_tax", "net", "created_at"],
  },
  // ── BIZ-MS0 U-BIZ02: ActualCost + QuoteAnalytics Persistence ─────────
  actual_cost_material: {
    tableName: "actual_cost_material",
    primaryKey: "id",
    businessKey: "job_id",
    hasUpdatedAt: false,
    knownColumns: ["id", "job_id", "cost", "scrap_cost", "created_at"],
  },
  actual_cost_machine: {
    tableName: "actual_cost_machine",
    primaryKey: "id",
    businessKey: "job_id",
    hasUpdatedAt: false,
    knownColumns: ["id", "job_id", "hours", "rate", "created_at"],
  },
  actual_cost_overhead: {
    tableName: "actual_cost_overhead",
    primaryKey: "id",
    businessKey: "job_id",
    hasUpdatedAt: false,
    knownColumns: ["id", "job_id", "rate_pct", "created_at"],
  },
  actual_cost_estimates: {
    tableName: "actual_cost_estimates",
    primaryKey: "id",
    businessKey: "job_id",
    jsonColumns: ["estimates"],
    hasUpdatedAt: false,
    knownColumns: ["id", "job_id", "estimates", "created_at"],
  },
  actual_cost_revenues: {
    tableName: "actual_cost_revenues",
    primaryKey: "id",
    businessKey: "job_id",
    hasUpdatedAt: false,
    knownColumns: ["id", "job_id", "revenue", "created_at"],
  },
  actual_cost_material_types: {
    tableName: "actual_cost_material_types",
    primaryKey: "id",
    businessKey: "job_id",
    hasUpdatedAt: false,
    knownColumns: ["id", "job_id", "material_type", "created_at"],
  },
  quote_analytics: {
    tableName: "quote_analytics",
    primaryKey: "id",
    businessKey: "quote_id",
    jsonColumns: ["quoted_cost_breakdown", "actual_cost_breakdown"],
    hasUpdatedAt: true,
    knownColumns: ["id", "quote_id", "part_name", "part_number", "customer", "material", "complexity", "quantity", "date_quoted", "valid_until", "quoted_unit_price", "quoted_total", "quoted_margin_pct", "quoted_lead_days", "quoted_cost_breakdown", "quoted_cycle_time_min", "status", "outcome_date", "loss_reason", "loss_notes", "competing_price", "actual_cost_breakdown", "actual_cycle_time_min", "actual_lead_days", "actual_margin_pct", "estimator", "created_at", "updated_at"],
  },
