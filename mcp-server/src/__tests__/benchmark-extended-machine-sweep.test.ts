 ...
 *
 * 205 machines × 3 materials × 3 operations = 1,845 test cases.
 *
...
// ════════════════════════════════════════════════════════════════════════════════
// 50 VMCs — Haas, DMG, Mazak, Okuma, Makino, Doosan, Hurco, Brother, Fanuc, Kitamura, Fadal, Hurco, YCM, Leadwell
// ════════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════════
// 30 Five-Axis — DMG, Hermle, Grob, Makino, Matsuura, Mazak, Okuma, Kern, Chiron, Mitsui Seiki, Heller
// ════════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════════
// 20 HMCs — Mazak, Okuma, Makino, DMG, Toyoda, Doosan, Kitamura, Heller, Quaser
// ════════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════════
// Sanity check: exactly 205 machines
// ════════════════════════════════════════════════════════════════════════════════

describe('Extended Machine Coverage Sweep', () => {
  it('should have exactly 205 machines', () => {
    expect(ALL_MACHINES.length).toBe(205);
    expect(VMCS.length).toBe(50);
    expect(FIVE_AXIS.length).toBe(30);
    expect(HMCS.length).toBe(20);
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // Parametric sweep: 205 machines × 3 materials × 3 ops = 1,845 tests
  // ══════════════════════════════════════════════════════════════════════════
