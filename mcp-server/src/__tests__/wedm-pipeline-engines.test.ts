...
describe("WEDM Pipeline Action Schemas", () => {
  it("exports 51 action schemas (48 base + 3 scheduling)", () => {
    expect(WEDM_PIPELINE_ACTIONS.length).toBe(51);
    expect(Object.keys(WEDM_PIPELINE_ACTION_SCHEMAS).length).toBe(51);
  });
