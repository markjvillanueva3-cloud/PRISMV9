...
const MATERIALS = {
  '4140_annealed': {
    kienzle: { kc1_1: 1496, mc: 0.22, iso_group: 'P', data_quality: 'verified' } as unknown as KienzleCoefficients,
    taylor: { C: 238, n: 0.20, tool_material: 'Carbide' } as TaylorCoefficients
  },
  '1045_annealed': {
    kienzle: { kc1_1: 1390, mc: 0.22, iso_group: 'P', data_quality: 'verified' } as unknown as KienzleCoefficients,
    taylor: { C: 255, n: 0.20, tool_material: 'Carbide' } as TaylorCoefficients
  },
  'ti6al4v': {
    kienzle: { kc1_1: 1458, mc: 0.21, iso_group: 'S', data_quality: 'verified' } as unknown as KienzleCoefficients,
    taylor: { C: 60, n: 0.15, tool_material: 'Carbide' } as TaylorCoefficients
  },
  '316_stainless': {
    kienzle: { kc1_1: 1980, mc: 0.235, iso_group: 'M', data_quality: 'verified' } as unknown as KienzleCoefficients,
    taylor: { C: 136, n: 0.16, tool_material: 'Carbide' } as TaylorCoefficients
  },
  '6061_aluminum': {
    kienzle: { kc1_1: 398, mc: 0.20, iso_group: 'N', data_quality: 'verified' } as unknown as KienzleCoefficients,
