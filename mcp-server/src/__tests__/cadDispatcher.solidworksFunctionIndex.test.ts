...
describe("cadDispatcher SolidWorks Function Index integration (U-CAD-FIDX-SW-01)", () => {
  ...
  describe("cad_solidworks_list_operations", () => {
    ...
    it("returns 24 operations for the drawing_operations module (shipped in U-05)", async () => {
    ...
    it("returns 15 operations for the weldment_operations module (shipped in U-07)", async () => {
