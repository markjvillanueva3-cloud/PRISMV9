...
`;
          ...
          case "token_economy_compute_roi": {
            const { tokenEconomyEngine } = await import("../../engines/TokenEconomyEngine.js");
            const roi = tokenEconomyEngine.computeROI(params.task_class, params.tokens_spent, params.capabilities_delivered);
            return ok({ roi });
          }
