...
${patterns.map(p => `  it("has ${p.type} at line ${p.line}", () => { expect("${p.pattern}").toContain("G"); });`).join("\n")}
          ...
          // ── CAM-EXHAUST-MS0/U-CAM49: ESPRITMillingFunctionIndexEngine ──
          case "esprit_mill_index": {
            const eng = await getEngine("espritMill");
            result = eng.getIndex();
            break;
          }
          case "esprit_mill_summary": {
            const eng = await getEngine("espritMill");
            result = eng.getSummary();
            break;
          }
          case "esprit_mill_list_ops": {
            const eng = await getEngine("espritMill");
            result = eng.listOperations();
            break;
          }
          case "esprit_mill_get_op": {
            const eng = await getEngine("espritMill");
            result = eng.getOperation(params.operation_id);
            break;
          }
          case "esprit_mill_by_category": {
            const eng = await getEngine("espritMill");
            result = eng.getOperationsByCategory(params.category);
            break;
          }
          case "esprit_mill_find_param": {
            const eng = await getEngine("espritMill");
            result = eng.findParameter(params.parameter_name, params.limit ?? 50);
            break;
          }
          case "esprit_mill_recommend": {
            const eng = await getEngine("espritMill");
            result = eng.recommendByFeature(params.intent);
            break;
          }
          case "esprit_mill_classify_doc": {
            const eng = await getEngine("espritMill");
            result = eng.classifyDocStrategy(params.material_iso, params.hardness_hb);
            break;
          }
          case "esprit_mill_profitmilling_envelope": {
            const eng = await getEngine("espritMill");
            result = eng.profitmillingEnvelope();
            break;
          }
          case "esprit_mill_select_drill": {
            const eng = await getEngine("espritMill");
            result = eng.selectDrillCycle(params.L_over_D, params.blind ?? false, params.tap ?? false);
            break;
          }

          // ── CAM-EXHAUST-MS0/U-CAM50: ESPRITLatheMillTurnFunctionIndexEngine ──
          case "esprit_lathe_index": {
            const eng = await getEngine("espritLathe");
            result = eng.getIndex();
            break;
          }
          case "esprit_lathe_summary": {
            const eng = await getEngine("espritLathe");
            result = eng.getSummary();
            break;
          }
          case "esprit_lathe_list_ops": {
            const eng = await getEngine("espritLathe");
            result = eng.listOperations();
            break;
          }
          case "esprit_lathe_get_op": {
            const eng = await getEngine("espritLathe");
            result = eng.getOperation(params.operation_id);
            break;
          }
          case "esprit_lathe_by_category": {
            const eng = await getEngine("espritLathe");
            result = eng.getOperationsByCategory(params.category);
            break;
          }
          case "esprit_lathe_find_param": {
            const eng = await getEngine("espritLathe");
            result = eng.findParameter(params.parameter_name, params.limit ?? 50);
            break;
          }
          case "esprit_lathe_recommend": {
            const eng = await getEngine("espritLathe");
            result = eng.recommendByFeature(params.intent);
            break;
          }
          case "esprit_lathe_select_threading": {
            const eng = await getEngine("espritLathe");
            result = eng.selectThreadingInfeed(params.pitch_mm, params.material_iso);
            break;
          }
          case "esprit_lathe_select_millturn_axis": {
            const eng = await getEngine("espritLathe");
            result = eng.selectMillturnAxis(params.machine_has_y, params.feature_off_axis);
            break;
          }
          ...
          // ── CAM-EXHAUST-MS0/U-CAM52: ESPRITKBMFunctionIndexEngine ──
          case "esprit_kbm_index": {
            const eng = await getEngine("espritKbm");
            result = eng.getIndex();
            break;
          }
          case "esprit_kbm_summary": {
            const eng = await getEngine("espritKbm");
            result = eng.getSummary();
            break;
          }
          case "esprit_kbm_list_ops": {
            const eng = await getEngine("espritKbm");
            result = eng.listOperations();
            break;
          }
          case "esprit_kbm_get_op": {
            const eng = await getEngine("espritKbm");
            result = eng.getOperation(params.operation_id);
            break;
          }
          case "esprit_kbm_by_category": {
            const eng = await getEngine("espritKbm");
            result = eng.getOperationsByCategory(params.category);
            break;
          }
          case "esprit_kbm_find_param": {
            const eng = await getEngine("espritKbm");
            result = eng.findParameter(params.parameter_name, params.limit ?? 50);
            break;
          }
          case "esprit_kbm_recommend": {
            const eng = await getEngine("espritKbm");
            result = eng.recommendByFeature(params.intent);
            break;
          }
          case "esprit_kbm_select_scan_depth": {
            const eng = await getEngine("espritKbm");
            result = eng.selectScanDepth(params.part_complexity_score);
            break;
          }
          case "esprit_kbm_probe_tolerance_for_it": {
            const eng = await getEngine("espritKbm");
            result = eng.probeToleranceForIT(params.it_grade);
            break;
          }
          ...
          // ── CAM-EXHAUST-MS0/U-CAM44: PowerMillFinishingFunctionIndexEngine ──
          case "pm_finishing_index": {
            const eng = await getEngine("pmFinishingIndex");
            result = eng.getIndex();
            break;
          }
          case "pm_finishing_summary": {
            const eng = await getEngine("pmFinishingIndex");
            result = eng.getSummary();
            break;
          }
          case "pm_finishing_list_ops": {
            const eng = await getEngine("pmFinishingIndex");
            result = eng.listOperations();
            break;
          }
          case "pm_finishing_get_op": {
            const eng = await getEngine("pmFinishingIndex");
            result = eng.getOperation(params.operation_id);
            break;
          }
          ...
          case "pm_finishing_classify_steep_shallow": {
            const eng = await getEngine("pmFinishingIndex");
            result = eng.classifySurfaceSteepShallow(params.surface_angle_deg, params.threshold_deg, params.overlap_deg ?? 0);
            break;
          }
          case "pm_finishing_stepover_for_cusp": {
            const eng = await getEngine("pmFinishingIndex");
            result = eng.stepoverForCuspTarget(params.target_cusp_mm, params.tool_diameter_mm);
            break;
          }
          case "pm_finishing_pencil_feasibility": {
            const eng = await getEngine("pmFinishingIndex");
            result = eng.pencilTraceFeasibility(params.internal_corner_radius_mm, params.tool_radius_mm);
            break;
          }
          // ── CAM-EXHAUST-MS0/U-CAM45: PowerMill5AxisRobotFunctionIndexEngine ──
          case "pm_5axisrobot_index": {
            const eng = await getEngine("pm5AxisRobotIndex");
            result = eng.getIndex();
            break;
          }
          case "pm_5axisrobot_summary": {
            const eng = await getEngine("pm5AxisRobotIndex");
            result = eng.getSummary();
            break;
          }
          case "pm_5axisrobot_list_ops": {
            const eng = await getEngine("pm5AxisRobotIndex");
            result = eng.listOperations();
            break;
          }
          case "pm_5axisrobot_get_op": {
            const eng = await getEngine("pm5AxisRobotIndex");
            result = eng.getOperation(params.operation_id);
            break;
          }
          case "pm_5axisrobot_by_category": {
            const eng = await getEngine("pm5AxisRobotIndex");
            result = eng.getOperationsByCategory(params.category);
            break;
          }
          case "pm_5axisrobot_find_param": {
            const eng = await getEngine("pm5AxisRobotIndex");
            result = eng.findParameter(params.parameter_name, params.limit ?? 20);
            break;
          }
          case "pm_5axisrobot_recommend": {
            const eng = await getEngine("pm5AxisRobotIndex");
            result = eng.recommendByFeature(params.intent);
            break;
          }
          case "pm_5axisrobot_classify_kinematic": {
            const eng = await getEngine("pm5AxisRobotIndex");
            result = eng.classifyKinematicConfig(params.rotary_on_head, params.rotary_on_table, params.robot_articulated ?? false);
            break;
          }
          case "pm_5axisrobot_singularity_check": {
            const eng = await getEngine("pm5AxisRobotIndex");
            result = eng.checkSingularityRisk(params.primary_rotary_deg, params.threshold_deg ?? 3);
            break;
          }
