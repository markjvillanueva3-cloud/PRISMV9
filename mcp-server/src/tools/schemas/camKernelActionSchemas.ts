...
export const cam_multi_process = z.object({
  features: z.array(z.object({
    ...
    turning: z.record(z.string(), z.unknown()).optional(),
    edm: z.record(z.string(), z.unknown()).optional(),
    grinding: z.record(z.string(), z.unknown()).optional(),
    cutting: z.record(z.string(), z.unknown()).optional(),
    dimensions: DimensionsSchema,
    tolerance_mm: z.number().positive().optional(),
    surface_finish_Ra: z.number().positive().optional(),
  })).min(1),
...
export const cam_advanced_strategy = z.object({
  ...
  surface_points: z.array(z.unknown()).optional(),
  start_curve: z.array(z.unknown()).optional(),
  end_curve: z.array(z.unknown()).optional(),
  top_curve: z.array(z.unknown()).optional(),
  bottom_curve: z.array(z.unknown()).optional(),
