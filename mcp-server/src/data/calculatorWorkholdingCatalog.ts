export type WorkholdingMachineMode =
  | "mill"
  | "lathe"
  | "edm"
  | "wire_edm"
...
export const WORKHOLDING_CATEGORY_OPTIONS: Record<WorkholdingMachineMode, SelectionOption[]> = {
  mill: [
...
export const WORKHOLDING_BRAND_OPTIONS: Record<WorkholdingMachineMode, SelectionOption[]> = {
  mill: [
...
export function getWorkholdingCatalogBundle(mode: WorkholdingMachineMode): WorkholdingCatalogBundle {
  return {
