...
const CAREER_MODULES = [
  ...
  { title: "Citation Discipline — A Career Skill", desc: "Citing your sources is what separates a machinist who knows from a machinist who guesses. Career-defining citation surfaces: setup sheets (cite tool catalog + chip-load source), FAI reports (cite ASME B89/Y14.5 + calibration certificate), quote/estimate (cite Kalpakjian or ASM Metals Handbook Vol. 16 for machinability data), audit response (cite OSHA 29 CFR + ANSI B11 + ISO 9001/AS9100D), continuous-learning notes (cite the trade journal, book, or vendor manual). Professional certifications that reward citation literacy: NIMS (National Institute for Metalworking Skills), SME CMfgT (Certified Manufacturing Technologist), ASQ CQE (Certified Quality Engineer). Career-success rule per the lima discipline: every claim you put on a setup sheet, quote, FAI, or audit response is traceable to a named source with a date and clause. Uncited claims quietly demote you every time you make them; cited claims compound your reputation across the entire shop floor." },
];
