...
const MILL_CASES: ReadonlyArray<ValidationTestCase> = [
  {
    ...
    input: {
      ...
      callouts: [
        { kind: "tolerance", value: "+0.0005/-0.000 on width 1.000" },
        { kind: "tolerance", value: "+0.0005/-0.000 on length 0.500" },
        { kind: "surface", value: "32 Ra" },
      ],
    },
    expectedOpLogMin: 2,
  },
  ...
  },
  {
    ...
    input: {
      intent: "mill a 0.187 wide by 0.625 long thru slot with sharp corners",
      callouts: [{ kind: "surface", value: "63 Ra interior" }],
    },
    expectedOpLogMin: 2,
  },
  {
    ...
    input: {
      intent: "contour 3D surface with R0.030 fillet on all edges, ±0.001 tolerance",
      callouts: [
        { kind: "tolerance", value: "±0.001 on all surfaces" },
        { kind: "surface", value: "32 Ra finish" },
      ],
    },
    expectedOpLogMin: 3,
  },
...
const LATHE_CASES: ReadonlyArray<ValidationTestCase> = [
  {
    ...
    input: {
      ...
      callouts: [
        { kind: "tolerance", value: "±0.0005 OD" },
        { kind: "surface", value: "16 Ra" },
      ],
    },
    expectedOpLogMin: 2,
  },
  ...
  },
  {
    ...
    input: {
      ...
      callouts: [
        { kind: "tolerance", value: "±0.0003 OD" },
        { kind: "material", value: "D2 tool steel HRC 58-62" },
      ],
    },
    expectedOpLogMin: 2,
  },
...
const WEDM_CASES: ReadonlyArray<ValidationTestCase> = [
  {
    ...
    input: {
      intent: "wire-EDM 4-cavity progressive die blank with 0.0002 wire offset, +0.0000/-0.0005 tolerance",
      callouts: [
        { kind: "tolerance", value: "+0.0000/-0.0005 on all features" },
        { kind: "surface", value: "16 Ra wire-cut" },
      ],
    },
    expectedOpLogMin: 4,
  },
  {
    ...
    input: {
      ...
      callouts: [
        { kind: "tolerance", value: "±0.0002 on edges" },
        { kind: "material", value: "A2 air-hardening tool steel" },
      ],
    },
    expectedOpLogMin: 2,
  },
  ...
  },
  {
    ...
    input: {
      ...
      callouts: [
        { kind: "tolerance", value: "±0.0001 on finished contour" },
        { kind: "surface", value: "8 Ra finish pass" },
      ],
    },
    expectedOpLogMin: 5,
  },
