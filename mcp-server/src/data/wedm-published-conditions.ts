...
export const PUBLISHED_PULSE_CONDITIONS: PublishedPulseCondition[] = [
  ...
  },
  {
    ...
    expected_ra_um: 2.8,
    expected_feed_mm_min: 3.0,
    expected_mrr_mm2_min: 76,
    source: "ITW SHAKEPROOF real NC program; Klocke (2013) Table 8.1; Sommer & Sommer (2013) Ch.12",
    source_detail: "Real shop program: AISI D2 1.000in (25.4mm) rough cut F0.12 in/min = 3.048 mm/min. " +
      "Feed rate is nearly identical to 50mm entry (PPC-006: 3.0 mm/min) confirming flat thickness response.",
    confidence: "manufacturer_table",
  },
  {
    id: "PPC-010A",
    ...
    source: "Klocke (2013) Table 8.1; calibrated vs real shop data",
    source_detail: "Thin-stock D2: feed slightly above 25mm/50mm plateau (~3.0mm/min) due to easier flushing. " +
      "Old value of 6.2 was over-extrapolated; real evidence shows nearly flat thickness response.",
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // MAKINO DUO43/DUO64 — E-PACK CONDITIONS FROM MASTERCAM X8 TECH FILE
  // Source: Mastercam X8 "Makino DUO-Ver6-METRIC-V Guide.TECH"
  //   Machine: Makino DUO43, DUO64
  //   Control: Generic Makino (Fanuc-based)
  //   Wire: 0.20mm BS (brass), Method: Both Away Precision
  //   Units: Metric
  //   File path: SharedDefaults/wire/Power/Makino DUO-Ver6-METRIC-V Guide.TECH
  // Note: Makino feed values are 0.0 (machine auto-adjusts via servo control);
  //       offsets are in mm (cumulative from spark gap reference).
  //       Ra values are from the <ra> tag in the tech file (µm).
  //       E-pack codes: rough = integer (e.g., 1006), skim = Exxxx (e.g., E1505).
  // ─────────────────────────────────────────────────────────────────────────

  // --- Steel, 0.20mm wire, 10mm thickness, 5-pass Both Away Precision ---
  {
    id: "PPC-043",
    material_group: "tool_steel",
    material_examples: ["AISI D2", "AISI A2", "AISI H13", "Tool steel general"],
    thickness_mm: 10,
    wire_diameter_mm: 0.20,
    wire_type: "brass",
    pass_type: "rough",
    pass_number: 1,
    // Pulse params not stored in Makino DUO tech file (machine-internal).
    // Offsets and Ra sourced directly from tech file.
    t_on_us: 0,
    t_off_us: 0,
    peak_current_A: 0,
    open_voltage_V: 0,
    ...
    wire_speed_m_min: 0,
    wire_tension_N: 0,
    expected_ra_um: 19.0,   // Ra tag: "18~20" → midpoint 19
    expected_feed_mm_min: 0, // Auto-servo; not published
    expected_mrr_mm2_min: 0,
    source: "Mastercam X8 Makino DUO-Ver6-METRIC-V Guide.TECH (Makino DUO43/DUO64)",
    source_detail: "E-pack 1036; offset 0.125mm; Ra 18~20µm rough. Record num=4, pass=1, wire=0.2mm BS, method=Both Away Precision, material=St (steel).",
    confidence: "manufacturer_table",
  },
  {
    id: "PPC-044",
    ...
    wire_speed_m_min: 0,
    wire_tension_N: 0,
    expected_ra_um: 13.0,   // Ra "12~14" → midpoint
    expected_feed_mm_min: 0,
    expected_mrr_mm2_min: 0,
    source: "Mastercam X8 Makino DUO-Ver6-METRIC-V Guide.TECH (Makino DUO43/DUO64)",
    source_detail: "E-pack 1036, E1535; offsets 0.154, 0.104mm; Ra 12~14µm. Record=4, pass=2, wire=0.2mm BS, Both Away Precision, St.",
    confidence: "manufacturer_table",
  },
  {
    id: "PPC-045",
    ...
    wire_speed_m_min: 0,
    wire_tension_N: 0,
    expected_ra_um: 2.25,   // Ra "2~2.5" → midpoint
    expected_feed_mm_min: 0,
    expected_mrr_mm2_min: 0,
    source: "Mastercam X8 Makino DUO-Ver6-METRIC-V Guide.TECH (Makino DUO43/DUO64)",
    source_detail: "E-pack 1036, E1535, E1536, E1537, E1538; offsets 0.172, 0.122, 0.113, 0.107, 0.107mm; Ra 2~2.5µm. Record=4, pass=5 (super-finish).",
    confidence: "manufacturer_table",
  },

  // --- Steel, 0.20mm wire, 25mm thickness, 5-pass Both Away Precision ---
  {
    id: "PPC-046",
    material_group: "tool_steel",
    material_examples: ["AISI D2", "AISI A2", "AISI H13", "Tool steel general"],
    ...
    wire_speed_m_min: 0,
    wire_tension_N: 0,
    expected_ra_um: 19.0,   // Ra "18~20"
    expected_feed_mm_min: 0,
    expected_mrr_mm2_min: 0,
    source: "Mastercam X8 Makino DUO-Ver6-METRIC-V Guide.TECH (Makino DUO43/DUO64)",
    source_detail: "E-pack 1066; offset 0.130mm; Ra 18~20µm. Record=7 (25mm), pass=1, wire=0.2mm BS, Both Away Precision, St.",
    confidence: "manufacturer_table",
  },
  {
    id: "PPC-047",
    ...
    wire_speed_m_min: 0,
    wire_tension_N: 0,
    expected_ra_um: 2.25,   // Ra "2~2.5"
    expected_feed_mm_min: 0,
    expected_mrr_mm2_min: 0,
    source: "Mastercam X8 Makino DUO-Ver6-METRIC-V Guide.TECH (Makino DUO43/DUO64)",
    source_detail: "E-pack 1066, E1565-E1568; Ra 2~2.5µm. Record=7 (25mm), pass=5, Both Away Precision, St.",
    confidence: "manufacturer_table",
  },

  // --- Tungsten Carbide (WC), 0.20mm wire, 10mm thickness, Both Away Precision ---
  {
    id: "PPC-048",
    material_group: "tungsten_carbide",
    material_examples: ["WC-Co carbide", "Tungsten carbide"],
    thickness_mm: 10,
    wire_diameter_mm: 0.20,
    wire_type: "brass",
    pass_type: "rough",
    ...
    wire_speed_m_min: 0,
    wire_tension_N: 0,
    expected_ra_um: 9.75,   // Ra "9.5~10"
    expected_feed_mm_min: 0,
    expected_mrr_mm2_min: 0,
    source: "Mastercam X8 Makino DUO-Ver6-METRIC-V Guide.TECH (Makino DUO43/DUO64)",
    source_detail: "E-pack 5036; offset 0.132mm; Ra 9.5~10µm. Record=2 (10mm WC), pass=1, wire=0.2mm BS, Both Away Precision, WC.",
    confidence: "manufacturer_table",
  },
  {
    id: "PPC-049",
    ...
    wire_speed_m_min: 0,
    wire_tension_N: 0,
    expected_ra_um: 1.75,   // Ra "1.5~2"
    expected_feed_mm_min: 0,
    expected_mrr_mm2_min: 0,
    source: "Mastercam X8 Makino DUO-Ver6-METRIC-V Guide.TECH (Makino DUO43/DUO64)",
    source_detail: "E-pack 5036, E5535-E5538; offsets 0.172, 0.120, 0.113, 0.108, 0.106mm; Ra 1.5~2µm. Record=2 (10mm WC), pass=5.",
    confidence: "manufacturer_table",
  },

  // --- Aluminum, 0.20mm wire, 10mm thickness, Both Away Precision ---
  {
    id: "PPC-050",
    material_group: "aluminum",
    material_examples: ["Aluminum alloy", "6061", "7075", "2024"],
    thickness_mm: 10,
    wire_diameter_mm: 0.20,
    wire_type: "brass",
    pass_type: "rough",
    ...
    wire_speed_m_min: 0,
    wire_tension_N: 0,
    expected_ra_um: 20.0,   // Ra "20"
    expected_feed_mm_min: 0,
    expected_mrr_mm2_min: 0,
    source: "Mastercam X8 Makino DUO-Ver6-METRIC-V Guide.TECH (Makino DUO43/DUO64)",
    source_detail: "E-pack 6036; offset 0.130mm; Ra 20µm. Record=1 (10mm AL), pass=1, wire=0.2mm BS, Both Away Precision, AL.",
    confidence: "manufacturer_table",
  },
  {
    id: "PPC-051",
    ...
    wire_speed_m_min: 0,
    wire_tension_N: 0,
    expected_ra_um: 3.0,   // Ra "3"
    expected_feed_mm_min: 0,
    expected_mrr_mm2_min: 0,
    source: "Mastercam X8 Makino DUO-Ver6-METRIC-V Guide.TECH (Makino DUO43/DUO64)",
    source_detail: "E-pack 6036, E6535-E6538; offsets 0.177, 0.126, 0.115, 0.110, 0.108mm; Ra 3µm. Record=1 (10mm AL), pass=5.",
    confidence: "manufacturer_table",
  },

  // --- Makino DUO 0.1mm wire steel Both Away Precision — thin/micro wire ---
  {
    id: "PPC-052",
    material_group: "tool_steel",
    material_examples: ["AISI D2", "AISI A2", "tool steel"],
    thickness_mm: 10,
    wire_diameter_mm: 0.10,
    wire_type: "brass",
    pass_type: "rough",
    ...
    wire_speed_m_min: 0,
    wire_tension_N: 0,
    expected_ra_um: 12.5,  // Ra "12~13"
    expected_feed_mm_min: 0,
    expected_mrr_mm2_min: 0,
    source: "Mastercam X8 Makino DUO-Ver6-METRIC-V Guide.TECH (Makino DUO43/DUO64)",
    source_detail: "E-pack 1036; offset 0.069mm; Ra 12~13µm. Record=4 (10mm), pass=1, wire=0.1mm BS, Both Away Precision, St (steel).",
    confidence: "manufacturer_table",
  },
];
...
// ═══════════════════════════════════════════════════════════════════════════
// REAL SHOP PROGRAM CATALOG (U-WLAUNCH03)
//
// Full-program data points extracted from Box Drive NC files.
// These are the ground-truth calibration anchors for the PRISM feed model.
// ═══════════════════════════════════════════════════════════════════════════

export interface RealProgramEntry {
  id: string;
  filename: string;
  date: string;
  material: string;
  ...
  passes: Array<{
    pass_number: number;
    e_pack_code: string;
    h_offset_inch: number;
    feed_inch_min: number;
    feed_mm_min: number;
    has_uv: boolean;
  }>;
  /** Skim cascade direction observed in the real program */
  skim_cascade: "increasing" | "decreasing";
  notes: string;
}

/**
 * Box Drive real NC programs — extracted 2026-04-08.
 *
 * Source: C:/Users/wompu/Box/WIRE EDM/
 * These files are REAL shop programs run on Mitsubishi wire EDMs.
 */
export const REAL_PROGRAM_CATALOG: RealProgramEntry[] = [
  {
    id: "RP-001",
    ...
    material: "D2",
    material_group: "tool_steel",
    thickness_mm: 25.4,  // 1.000 inch
    controller: "mitsubishi",
    taper: false,
    num_passes: 4,
    passes: [
      { pass_number: 1, e_pack_code: "E1221", h_offset_inch: 0.0085, feed_inch_min: 0.12, feed_mm_min: 3.048, has_uv: false },
      { pass_number: 2, e_pack_code: "E1222", h_offset_inch: 0.0064, feed_inch_min: 0.24, feed_mm_min: 6.096, has_uv: false },
      { pass_number: 3, e_pack_code: "E1223", h_offset_inch: 0.0058, feed_inch_min: 0.21, feed_mm_min: 5.334, has_uv: false },
      { pass_number: 4, e_pack_code: "E1224", h_offset_inch: 0.0053, feed_inch_min: 0.20, feed_mm_min: 5.080, has_uv: false },
    ],
    skim_cascade: "decreasing",
    notes: "2 profiles: hexagonal die + round bore. H175=0 (no global offset adjustment). " +
      "Skim cascade: F.24 → .21 → .20 (decreasing after skim1 jump from F.12 rough). " +
      "Glue stop (M01) after profile 1 pass 1. Adaptive control (M90/M91) on rough only.",
  },
  {
    id: "RP-002",
    ...
    material_group: "stainless_steel",
    thickness_mm: 250,  // Unknown exact — using 250mm (10") typical for taper test blocks
    controller: "mitsubishi",
    taper: true,
    num_passes: 5,
    passes: [
      { pass_number: 1, e_pack_code: "E2821", h_offset_inch: 0.0, feed_inch_min: 0.16, feed_mm_min: 4.064, has_uv: true },
      { pass_number: 2, e_pack_code: "E2822", h_offset_inch: 0.0, feed_inch_min: 0.23, feed_mm_min: 5.842, has_uv: true },
      { pass_number: 3, e_pack_code: "E2823", h_offset_inch: 0.0, feed_inch_min: 0.26, feed_mm_min: 6.604, has_uv: true },
      { pass_number: 4, e_pack_code: "E2824", h_offset_inch: 0.0, feed_inch_min: 0.30, feed_mm_min: 7.620, has_uv: true },
      { pass_number: 5, e_pack_code: "E2825", h_offset_inch: 0.0, feed_inch_min: 0.0,  feed_mm_min: 0.0,   has_uv: true },
    ],
    skim_cascade: "increasing",
    notes: "Taper program with UV axis. H-offsets all 0 (taper uses UV interpolation, not H comp). " +
      "Skim cascade: F.16 → .23 → .26 → .30 (INCREASING — opposite of ITW straight). " +
      "Pass 5 has no explicit feed (spring pass / polish). E28xx = material group 2 (SS), " +
      "thickness code 8, condition 2 (standard). Single profile, no glue stop.",
  },
  {
    id: "RP-003",
    ...
    date: "unknown",
    material: "unknown",
    material_group: "tool_steel",  // Assumed — most common for die work
    thickness_mm: 0,  // Not specified in file
    controller: "unknown",  // No E-pack codes, no M-codes
    taper: false,
    num_passes: 1,
    passes: [
      { pass_number: 1, e_pack_code: "", h_offset_inch: 0.0, feed_inch_min: 0.0, feed_mm_min: 0.0, has_uv: false },
    ],
    skim_cascade: "decreasing",
    notes: "Geometry-only template: 5-inch square (G54 X0 Y0, G1 X5.0, Y-5.0, X0, Y0). " +
      "No E-pack codes, no H-offsets, no multi-pass, no threading/flushing M-codes. " +
      "Not a production program — appears to be a toolpath geometry template only.",
  },
];
