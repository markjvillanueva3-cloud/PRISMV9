...
import { createEmployeePortalRouter } from "./employee-portal.js";
import { createWedmLiveRouter } from "./wedm-live.js";
...
export function registerRoutes(app: Express, callTool: CallToolFn): void {
  ...
  app.use("/api/v1/employee-portal", createEmployeePortalRouter(callTool)); // prism_shop emp_* dispatch (U-PORTAL-EXPRESS-ROUTES)
  app.use("/api/v1/wedm-live", createWedmLiveRouter(callTool)); // WireEdmWizardPage status panels (U-WEDM-LIVE-ROUTES)
