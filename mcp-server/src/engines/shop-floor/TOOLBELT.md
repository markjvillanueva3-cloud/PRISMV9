# shop-floor galaxy — TOOLBELT (auto-derived baseline)
...
- **This domain's knowledge layers (auto-invoked via wiki-precheck-inject when relevant):** [[shop-floor-foundations]] / [[shop-floor-source-atlas]] / [[shop-floor-applied-practice]].
