# corpus-aggregation galaxy — TOOLBELT (auto-derived baseline)
...
- **This domain's knowledge layers (auto-invoked via wiki-precheck-inject when relevant):** [[corpus-aggregation-foundations]] / [[corpus-aggregation-source-atlas]] / [[corpus-aggregation-applied-practice]].
