...
const MATERIAL_THERMAL_EXT: Record<string, MaterialThermalProps> = {
  aluminum_6061: { kc11_mpa: 800, mc: 0.23, density_kg_m3: 2700, specific_heat_j_kgk: 896, thermal_conductivity_w_mk: 167, expansion_coeff_per_k: 23.6e-6, chip_heat_ratio: 0.85, elastic_modulus_mpa: 69000 },
  steel_1045: { kc11_mpa: 2100, mc: 0.25, density_kg_m3: 7850, specific_heat_j_kgk: 486, thermal_conductivity_w_mk: 49.8, expansion_coeff_per_k: 11.2e-6, chip_heat_ratio: 0.65, elastic_modulus_mpa: 205000 },
  stainless_304: { kc11_mpa: 2500, mc: 0.25, density_kg_m3: 8000, specific_heat_j_kgk: 500, thermal_conductivity_w_mk: 16.2, expansion_coeff_per_k: 17.3e-6, chip_heat_ratio: 0.55, elastic_modulus_mpa: 193000 },
  titanium_6al4v: { kc11_mpa: 1800, mc: 0.27, density_kg_m3: 4430, specific_heat_j_kgk: 526, thermal_conductivity_w_mk: 6.7, expansion_coeff_per_k: 8.6e-6, chip_heat_ratio: 0.45, elastic_modulus_mpa: 114000 },
  inconel_718: { kc11_mpa: 3200, mc: 0.28, density_kg_m3: 8190, specific_heat_j_kgk: 435, thermal_conductivity_w_mk: 11.4, expansion_coeff_per_k: 13.0e-6, chip_heat_ratio: 0.40, elastic_modulus_mpa: 205000 },
  cast_iron_gray: { kc11_mpa: 1500, mc: 0.25, density_kg_m3: 7200, specific_heat_j_kgk: 490, thermal_conductivity_w_mk: 50, expansion_coeff_per_k: 10.8e-6, chip_heat_ratio: 0.70, elastic_modulus_mpa: 120000 },
};
