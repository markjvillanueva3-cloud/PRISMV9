...
const TAYLOR_C: Record<string, Record<string, number>> = {
  P: { carbide: 350, hss: 120, cermet: 400, ceramic: 800, cbn: 1200, pcd: 600 },
  M: { carbide: 250, hss: 80,  cermet: 300, ceramic: 600, cbn: 900,  pcd: 450 },
  K: { carbide: 400, hss: 150, cermet: 450, ceramic: 900, cbn: 1400, pcd: 800 },
  N: { carbide: 600, hss: 250, cermet: 500, ceramic: 700, cbn: 800,  pcd: 1500 },
  S: { carbide: 180, hss: 50,  cermet: 200, ceramic: 400, cbn: 700,  pcd: 350 },
  H: { carbide: 150, hss: 40,  cermet: 180, ceramic: 500, cbn: 1000, pcd: 300 },
};

/** Taylor n exponent by tool material */
