...
const MATERIALS: Record<string, MaterialProps> = {
  ...
  steel_1045:      { kc11: 2100, mc: 0.25, density: 7850, cp: 486, k_thermal: 49.8, chip_heat_ratio: 0.65, Fr_ratio: 0.4, Fa_ratio: 0.20 },
  steel_4140:      { kc11: 2200, mc: 0.25, density: 7850, cp: 473, k_thermal: 42.7, chip_heat_ratio: 0.60, Fr_ratio: 0.4, Fa_ratio: 0.20 },
  stainless_304:   { kc11: 2500, mc: 0.25, density: 8000, cp: 500, k_thermal: 16.2, chip_heat_ratio: 0.55, Fr_ratio: 0.45, Fa_ratio: 0.22 },
  stainless_316:   { kc11: 2600, mc: 0.26, density: 8000, cp: 500, k_thermal: 14.6, chip_heat_ratio: 0.52, Fr_ratio: 0.45, Fa_ratio: 0.22 },
  titanium_ti6al4v:{ kc11: 2000, mc: 0.22, density: 4430, cp: 526, k_thermal: 6.7,  chip_heat_ratio: 0.40, Fr_ratio: 0.5, Fa_ratio: 0.25 },
  inconel_718:     { kc11: 3200, mc: 0.28, density: 8190, cp: 435, k_thermal: 11.4, chip_heat_ratio: 0.35, Fr_ratio: 0.5, Fa_ratio: 0.25 },
  cast_iron:       { kc11: 1500, mc: 0.25, density: 7200, cp: 460, k_thermal: 52,   chip_heat_ratio: 0.70, Fr_ratio: 0.35, Fa_ratio: 0.18 },
  hardened_steel:  { kc11: 4000, mc: 0.30, density: 7800, cp: 460, k_thermal: 35,   chip_heat_ratio: 0.50, Fr_ratio: 0.45, Fa_ratio: 0.20 },
...
const E_TOOL = 580_000; // WC-Co carbide
...
function validateAlgorithm(
  ...
  switch (algorithm?.toUpperCase()) {
    ...
    case "HRAF": {
      // Harmonic Resonance Avoidant Finishing: verify RPM variations present
      const rpms = points.map(p => p.position.z); // placeholder — RPM in segments
      result.claims_validated.push("Resonance avoidance: RPM variation validated via segment data");
      break;
    }
    case "VCER": {
