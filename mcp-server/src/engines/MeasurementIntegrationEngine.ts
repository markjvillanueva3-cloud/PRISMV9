...
/** Returns the source file catalog for measurement integration engine traceability. */
export function getSourceFileCatalog(): typeof MEASUREMENT_SOURCE_FILE_CATALOG {
  return MEASUREMENT_SOURCE_FILE_CATALOG;
}
