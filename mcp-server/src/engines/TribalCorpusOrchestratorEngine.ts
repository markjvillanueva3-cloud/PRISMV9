    ...
    try {
      switch (category) {
        case "sinker_edm": {
          ...
          child_result = sinkerEDMTribalCorpusEngine.surface(input.child_params as Parameters<typeof sinkerEDMTribalCorpusEngine.surface>[0]);
        ...
        case "laser_cut": {
          ...
          child_result = laserCuttingTribalCorpusEngine.surface(input.child_params as Parameters<typeof laserCuttingTribalCorpusEngine.surface>[0]);
        ...
        case "waterjet": {
          ...
          child_result = waterjetCuttingTribalCorpusEngine.surface(input.child_params as Parameters<typeof waterjetCuttingTribalCorpusEngine.surface>[0]);
          routed_action = "waterjet_cutting_tribal_surface";
          break;
        }
        case "grinding": {
          const { grindingTribalCorpusEngine } = await import("./GrindingTribalCorpusEngine.js");
          child_result = grindingTribalCorpusEngine.surface(input.child_params as Parameters<typeof grindingTribalCorpusEngine.surface>[0]);
          routed_action = "grinding_tribal_surface";
          break;
        }
        case "welding": {
          const { weldingTribalCorpusEngine } = await import("./WeldingTribalCorpusEngine.js");
          child_result = weldingTribalCorpusEngine.surface(input.child_params as Parameters<typeof weldingTribalCorpusEngine.surface>[0]);
        ...
        case "additive": {
          ...
          child_result = additiveManufacturingTribalCorpusEngine.surface(input.child_params as Parameters<typeof additiveManufacturingTribalCorpusEngine.surface>[0]);
        ...
        default: {
          ...
          child_result = operatorCoachingTipsEngine.coach(input.child_params as Parameters<typeof operatorCoachingTipsEngine.coach>[0]);
