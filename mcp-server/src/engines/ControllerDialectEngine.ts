...
const DIALECTS: Record<string, ControllerDialect> = {
  ...
  siemens_810d: {
    id: "siemens_810d",
    display_name: "Siemens 810D (Legacy)",
    manufacturer: "Siemens",
    base_family: "siemens",
    program_start: ["; SIEMENS 810D PROGRAM"],
    program_end: ["M30"],
    ...
    // No probing cycles on 810D (optional add-on only)
    cycle_call_prefix: "MCALL ",
    sub_program_call: "CALL \"{name}\"",
    sub_program_return: "RET",
    features: {
      // No CYCLE832 - use G64x directly
      smoothing: { rough: "G64", medium: "G641", finish: "G642" },
      // No TRAORI - 5-axis not supported
      // No CYCLE800 on early 810D (limited on later versions)
      look_ahead_blocks: 80, block_processing_rate: 1500, nurbs_interpolation: false,
      max_simultaneous_axes: 4, work_offset_count: 48, macro_b_support: false, program_memory_kb: 512,
    },
  },
...
const ALIAS_MAP: Record<string, string> = {
  ...
  siemens: "siemens_840d", "siemens_810d": "siemens_810d", "810d": "siemens_810d", "siemens_828d": "siemens_828d", "828d": "siemens_828d", "siemens_840d": "siemens_840d", "siemens_one": "siemens_one", "840d": "siemens_840d",
