...
const KIENZLE_DB: Record<string, KienzleMaterialData> = {
  P: { kc1_1: 2000, mc: 0.26, hardness_hrc: 25, thermal_conductivity_wm_k: 45 },
  M: { kc1_1: 2400, mc: 0.25, hardness_hrc: 30, thermal_conductivity_wm_k: 15 },
  K: { kc1_1: 1200, mc: 0.28, hardness_hrc: 20, thermal_conductivity_wm_k: 50 },
  N: { kc1_1: 800, mc: 0.23, hardness_hrc: 10, thermal_conductivity_wm_k: 170 },
  S: { kc1_1: 2800, mc: 0.25, hardness_hrc: 35, thermal_conductivity_wm_k: 7 },
  H: { kc1_1: 3500, mc: 0.30, hardness_hrc: 55, thermal_conductivity_wm_k: 25 },
};
