...
const GENOME_DB: GenomeRecord[] = [
  ...
  },
  {
    ...
    machinability: { kc1_1: 2800, mc: 0.28, taylor_C: 100, taylor_n: 0.15, chip_formation: "segmented", work_hardening_rate: 0.45, bue_tendency: 0.3, abrasiveness: 0.5, optimal_chip_thickness_mm: [0.04, 0.10], vc_range_carbide: [30, 80] },
