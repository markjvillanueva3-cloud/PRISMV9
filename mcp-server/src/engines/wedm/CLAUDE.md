...
This galaxy is a first-class AI-substrate **participant** -- it OWNS 14 AI engine(s) (e.g. `WEDMAnalogicalReasoningEngine`, `WEDMLoRAAdapterEngine`, `WEDMLoRACadenceEngine`), wired to PSN leg #10 via `wedm_post_agie_generate`, `wedm_post_agie_parse`, `wedm_post_agie_tech_table`.
...
- **Reasoning bridge** (`scripts/lib/galaxy-reasoning-bridge.mjs`, PSN leg #10): **CAG** + **RAG** hybrid
  ...
  local Ollama stack -- `node scripts/lib/galaxy-reasoning-bridge.mjs wedm "<question>"`.
- **Vault -> LoRA**: this galaxy's Obsidian **synthesis** brain (`knowledge/memories/patterns/wedm_synthesis.md`)
