# bug-hunting galaxy — TOOLBELT (auto-derived baseline)
...
- `prism_guard` — domain action surface
...
- **This domain's knowledge layers (auto-invoked via wiki-precheck-inject when relevant):** [[bug-hunting-foundations]] / [[bug-hunting-source-atlas]] / [[bug-hunting-applied-practice]].
