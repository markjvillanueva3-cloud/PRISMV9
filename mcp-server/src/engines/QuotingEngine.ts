 ...
 *
 * Manufacturing quote generation with margin targets, rush/prototype
 * multipliers, volume discounts, price breaks, and lead time estimation.
 *
 * Ported from PRISM_QUOTING_ENGINE.js (monolith R2.3.1).
 *
