...
const MATERIAL_DB: Record<string, MaterialProps> = {
  ...
  titanium:   { vc_base_mpm: 60,  kc1_1: 1400, mc: 0.22, taylor_C_factor: 1.5, taylor_n: 0.30 },
  stainless:  { vc_base_mpm: 150, kc1_1: 2100, mc: 0.27, taylor_C_factor: 1.5, taylor_n: 0.28 },
  cast_iron:  { vc_base_mpm: 180, kc1_1: 1200, mc: 0.18, taylor_C_factor: 1.5, taylor_n: 0.22 },
  inconel:    { vc_base_mpm: 30,  kc1_1: 2500, mc: 0.30, taylor_C_factor: 1.5, taylor_n: 0.35 },
};
