...
/**
 * Roles that hold orchestrator authority. EXPORTED (2026-06-15, C4) as the single
 * source of truth so ZuluDelegationContractEngine's "only an orchestrator may grant
 * a delegation" gate consumes THIS set -- a duplicated copy could silently drift in
 * the safety-critical direction (a worker role wrongly able to grant authority).
 */
export const ORCHESTRATOR_ROLES = new Set([
  "fleet-orchestrator",
  "generalist",
  "hermes-router",
  "zulu-orchestrator",
