...
export const KIENZLE_DATABASE: KienzleEntry[] = [
  ...
  { iso_group: "S", material_class: "Titanium (Ti-6Al-4V)", kc1_1: 1700, mc: 0.23, hardness_range: "310-370 HB", source: "ISCAR Titanium Guide" },
  { iso_group: "S", material_class: "Titanium pure (Grade 2)", kc1_1: 1400, mc: 0.22, hardness_range: "200-260 HB", source: "Sandvik GC 2023" },
  ...
  // Titanium specifics
  { iso_group: "S", material_class: "Ti-6Al-4V ELI (Grade 23)", kc1_1: 1650, mc: 0.23, hardness_range: "300-350 HB", source: "ISCAR Titanium Guide" },
  { iso_group: "S", material_class: "Ti-6Al-2Sn-4Zr-2Mo", kc1_1: 1800, mc: 0.24, hardness_range: "320-380 HB", source: "Sandvik GC 2023" },
...
export function getKienzleByISO(iso: string): { kc1_1: number; mc: number } {
  const defaults: Record<string, { kc1_1: number; mc: number }> = {
    P: { kc1_1: 2000, mc: 0.25 },  // Medium carbon steel (most common)
    M: { kc1_1: 2200, mc: 0.24 },  // 304/316 (most common)
    K: { kc1_1: 1100, mc: 0.24 },  // Gray CI (most common)
    N: { kc1_1: 700, mc: 0.23 },   // 6061-T6 (most common)
    S: { kc1_1: 1700, mc: 0.23 },  // Ti-6Al-4V (most common)
