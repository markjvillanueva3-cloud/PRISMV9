# wiring galaxy — TOOLBELT (auto-derived baseline)
...
- `prism_ai` — domain action surface
- `prism_calc` — domain action surface
- `prism_cam` — domain action surface
- `prism_dev` — domain action surface
- `prism_knowledge` — domain action surface
- `prism_safety` — domain action surface
- `prism_session` — domain action surface
...
- **This domain's knowledge layers (auto-invoked via wiki-precheck-inject when relevant):** [[wiring-foundations]] / [[wiring-source-atlas]] / [[wiring-applied-practice]].
- **Resource roots (easy access):** this galaxy's PATHS.md + `mcp-server/src/engines/database-expansion/CRITICAL-RESOURCE-ROOTS.json` (H:/PRISM/resources, JM DIE, Docustrata) (owner: romeo).
<!-- /OPERATIONAL-CONTEXT -->
