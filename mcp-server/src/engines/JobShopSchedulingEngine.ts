 ...
 *
 * Production scheduling: dispatching rules (FIFO, SPT, LPT, EDD, CR, SLACK),
 * single-machine scheduling, Johnson's 2-machine flow shop algorithm,
 * multi-machine job shop simulation, and Critical Path Method (CPM).
 *
