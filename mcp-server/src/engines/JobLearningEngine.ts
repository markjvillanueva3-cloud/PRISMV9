...
/** Returns the job learning source file catalog for introspection and audit. */
export function getJobLearningSourceFileCatalog(): typeof JOB_LEARNING_SOURCE_FILE_CATALOG {
  return JOB_LEARNING_SOURCE_FILE_CATALOG;
}
