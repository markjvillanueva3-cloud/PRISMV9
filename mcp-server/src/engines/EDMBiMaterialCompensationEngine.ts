...
/**
 * EDM-specific properties per material grade (high-resolution per-grade data).
 * Values sourced from ASM Handbook Vol. 16 (Machining), Rajurkar (1993),
 * and manufacturer tech tables (Makino, Sodick, Mitsubishi).
 *
 * NOTE: Canonical broad-category data is in src/data/edm-material-db.ts
 * (EDM_BIMATERIAL_MATERIALS). This engine keeps per-grade resolution for
 * precision zone optimization. New grades should be added to both files.
 */
