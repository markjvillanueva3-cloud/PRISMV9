...
- **Reasoning bridge** (`scripts/lib/galaxy-reasoning-bridge.mjs`, PSN leg #10): **CAG** + **RAG** hybrid
  ...
  local Ollama stack -- `node scripts/lib/galaxy-reasoning-bridge.mjs pdf-corpus-mill "<question>"`.
- **Vault -> LoRA**: this galaxy's Obsidian **synthesis** brain (`knowledge/memories/patterns/pdf-corpus-mill_synthesis.md`)
...
**Domain angle:** Mill-PDF (Haas / Mazak) extraction FEEDS the corpus that trains this substrate (deep-learning training data).
