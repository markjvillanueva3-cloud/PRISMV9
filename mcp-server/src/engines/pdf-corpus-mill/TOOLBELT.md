# pdf-corpus-mill galaxy — TOOLBELT (auto-derived baseline)
...
- **This domain's knowledge layers (auto-invoked via wiki-precheck-inject when relevant):** [[pdf-corpus-mill-foundations]] / [[pdf-corpus-mill-source-atlas]] / [[pdf-corpus-mill-applied-practice]].
