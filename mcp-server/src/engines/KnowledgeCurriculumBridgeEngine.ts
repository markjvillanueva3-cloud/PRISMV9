...
export class KnowledgeCurriculumBridgeEngine {
  ...
  private materials: MaterialData[] = [
    ...
    { name: "Ti-6Al-4V", iso_group: "S", kc1_1: 1450, mc: 0.23, vc_range: [30, 60], fz_range: [0.05, 0.12] },
    { name: "Inconel 718", iso_group: "S", kc1_1: 3000, mc: 0.25, vc_range: [15, 30], fz_range: [0.04, 0.08] },
    { name: "D2 Tool Steel", iso_group: "H", kc1_1: 2500, mc: 0.28, vc_range: [80, 150], fz_range: [0.03, 0.06] },
