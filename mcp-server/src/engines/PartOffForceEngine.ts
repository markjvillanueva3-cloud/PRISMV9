...
const KC_PARTING: Record<string, { kc11: number; mc: number }> = {
  ...
  stainless:   { kc11: 2600, mc: 0.24 },
  aluminum:    { kc11: 900,  mc: 0.22 },
  cast_iron:   { kc11: 1500, mc: 0.28 },
  titanium:    { kc11: 1800, mc: 0.22 },
  inconel:     { kc11: 3200, mc: 0.25 },
  copper:      { kc11: 1200, mc: 0.20 },
  brass:       { kc11: 1000, mc: 0.18 },
  carbon_steel:{ kc11: 2000, mc: 0.25 },
