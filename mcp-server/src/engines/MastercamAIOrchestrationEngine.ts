...
export class MastercamAIOrchestrationEngine {
   ...
   */
  private mapFeatureType(feature: string): import("./MastercamDeepLearningEngine.js").MastercamFeatureType {
    type FT = import("./MastercamDeepLearningEngine.js").MastercamFeatureType;
   ...
   */
  private mapMachineType(machine: string): import("./MastercamDeepLearningEngine.js").MastercamMachineType {
    type MT = import("./MastercamDeepLearningEngine.js").MastercamMachineType;
