...
const MATERIAL_DB: Record<string, MaterialData> = {
  aluminum_6061:   { kc11: 800,  mc: 0.23, vc_base: 300, fz_base: 0.10 },
  aluminum_7075:   { kc11: 900,  mc: 0.25, vc_base: 250, fz_base: 0.09 },
  steel_1018:      { kc11: 1800, mc: 0.26, vc_base: 120, fz_base: 0.08 },
  steel_4140:      { kc11: 2100, mc: 0.25, vc_base: 90,  fz_base: 0.07 },
  steel_4340:      { kc11: 2300, mc: 0.27, vc_base: 80,  fz_base: 0.06 },
  stainless_304:   { kc11: 2200, mc: 0.21, vc_base: 70,  fz_base: 0.06 },
  stainless_316:   { kc11: 2400, mc: 0.22, vc_base: 60,  fz_base: 0.05 },
  titanium_ti6al4v:{ kc11: 1900, mc: 0.23, vc_base: 50,  fz_base: 0.05 },
  inconel_718:     { kc11: 3200, mc: 0.28, vc_base: 25,  fz_base: 0.04 },
  copper_c110:     { kc11: 1200, mc: 0.18, vc_base: 200, fz_base: 0.10 },
  brass_c360:      { kc11: 700,  mc: 0.17, vc_base: 250, fz_base: 0.12 },
};
