# agent-orchestration galaxy — TOOLBELT (auto-derived baseline)
...
- `prism_orchestrate` — domain action surface
...
- **This domain's knowledge layers (auto-invoked via wiki-precheck-inject when relevant):** [[agent-orchestration-foundations]] / [[agent-orchestration-source-atlas]] / [[agent-orchestration-applied-practice]].
