...
- **Engines:** Hermes/Zulu agent-fleet orchestration set — `MoonshotInvocationEngine` (Opus heavy-reasoning routing), `MultiModelConsensusEngine` (the octopus 7-voice consensus), self-reflect populater, dream-cycle synth. Bravo builds + stub-hunts; zulu synthesizes cross-slot work orders.
