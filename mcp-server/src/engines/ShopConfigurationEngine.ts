...
export interface ShopMachine {
  ...
  // Spindle/machine-specific fields (LATHE-UNIFIED M5, MILL-HARD-MS0)
  ...
  // MILL-HARD-MS2: 4th axis rotary table specs
  rotary_table?: {
    model: string;
    axis: "A" | "B" | "C";
    max_load_kg: number;
    max_rpm: number;
    tilt_axis?: "A" | "B" | "C";
    tilt_range?: [number, number];  // [min_deg, max_deg]
  };
...
const DEFAULT_MACHINES: ShopMachine[] = [
  ...
  // ── MILLS (5) ─────────────────────────────────────────────────────────────
  // Spindle specs from manufacturer datasheets — MILL-HARD-MS0 validated 2026-04-14
  {
    ...
    hours_per_shift: 10, shifts_per_day: 1, days_per_week: 5,
    controller: "hurco", max_rpm: 12000, max_power_kw: 18.5, max_torque_nm: 100,
    spindle_taper: "BT40", work_envelope: { x_mm: 1016, y_mm: 508, z_mm: 610 },
    rotary_table: { model: "HRT210", axis: "A", max_load_kg: 136, max_rpm: 100 },
  },
  {
    id: "VMC-02", name: "Okuma M460V-5AX", type: "5-axis",
    hourly_rate: 135.00, efficiency_factor: 0.78,
    capabilities: ["milling", "drilling", "5axis_contouring", "high_speed_milling", "die_sinking", "4th_axis_indexing"],
    hours_per_shift: 10, shifts_per_day: 1, days_per_week: 5,
    controller: "okuma", max_rpm: 15000, max_power_kw: 22, max_torque_nm: 140,
    spindle_taper: "BT40", work_envelope: { x_mm: 762, y_mm: 460, z_mm: 460 },
    // Note: 5-axis machine can run 4-axis indexing by locking B or C axis
    rotary_table: { model: "Integrated trunnion", axis: "A", max_load_kg: 100, max_rpm: 50, tilt_axis: "C" },
  },
  {
    ...
    hours_per_shift: 10, shifts_per_day: 1, days_per_week: 5,
    controller: "haas", max_rpm: 8100, max_power_kw: 22.4, max_torque_nm: 122,
    spindle_taper: "CAT40", work_envelope: { x_mm: 762, y_mm: 406, z_mm: 508 },
    // MILL-HARD-MS2: TR160 rotary table for 4th axis work
    rotary_table: { model: "TR160", axis: "A", max_load_kg: 54, max_rpm: 100, tilt_axis: "B", tilt_range: [-120, 30] },
  },
  {
    id: "VMC-04", name: "Haas OM-2", type: "VMC",
    hourly_rate: 55.00, efficiency_factor: 0.85,
    capabilities: ["milling", "drilling", "engraving", "small_parts", "high_speed_milling"],
    hours_per_shift: 10, shifts_per_day: 1, days_per_week: 5,
    controller: "haas", max_rpm: 30000, max_power_kw: 7.5, max_torque_nm: 3.4,
    spindle_taper: "BT30", work_envelope: { x_mm: 305, y_mm: 254, z_mm: 305 },
  },
  {
    ...
    hours_per_shift: 10, shifts_per_day: 1, days_per_week: 5,
    controller: "fanuc", max_rpm: 30000, max_power_kw: 7.5, max_torque_nm: 15,
    spindle_taper: "HSK-E40", work_envelope: { x_mm: 600, y_mm: 500, z_mm: 300 },
  },
  // ── SINKER EDM (2) ────────────────────────────────────────────────────────
  {
