...
export interface ShopMachine {
  ...
  spindle_taper?: string; // mill spindle taper designation (e.g. CAT40, BT30, HSK63A)
...
const DEFAULT_MACHINES: ShopMachine[] = [
  ...
  // ── MILLS (5) ─────────────────────────────────────────────────────────────
  {
    ...
    hours_per_shift: 10, shifts_per_day: 1, days_per_week: 5,
    // Spindle nameplate (U-KSF-01, OEM-verified 2026-06-26): Hurco VM30i CAT40, 12k rpm / 20 hp (15 kW).
    max_rpm: 12000, max_power_kw: 15,
  },
  {
    ...
    hours_per_shift: 10, shifts_per_day: 1, days_per_week: 5,
    controller: "okuma",
    // Spindle nameplate (U-KSF-01, OEM-verified 2026-06-26): Okuma GENOS M460V-5AX, 15k rpm / 22 kW / 199 Nm.
    max_rpm: 15000, max_power_kw: 22, max_torque_nm: 199,
  },
  {
    ...
    hours_per_shift: 10, shifts_per_day: 1, days_per_week: 5,
    controller: "haas",
    // Spindle nameplate (U-KSF-01, OEM-verified 2026-06-26): Haas VF-2, 8.1k rpm / 22.4 kW / 122 Nm @ 2000 rpm.
  ...
  },
  {
    ...
    hours_per_shift: 10, shifts_per_day: 1, days_per_week: 5,
    controller: "haas",
    // Spindle nameplate (U-KSF-01, OEM-verified 2026-06-26): Haas Office Mill OM-2, 30k rpm / 5 hp (3.7 kW) ISO20.
    // CORRECTS the Claude-design jm-data.js value of 7.5 hp -- the OM-2 native spindle is 5 hp; 7.5 hp is a different platform.
    max_rpm: 30000, max_power_kw: 3.7,
  },
  {
    ...
    hours_per_shift: 10, shifts_per_day: 1, days_per_week: 5,
    controller: "fanuc",
    // Spindle nameplate (U-KSF-01, OEM-verified 2026-06-26): Roku-Roku HC-658 II, 32k rpm (200-32,000) / ~15 hp (11 kW).
    // CORRECTS the Claude-design jm-data.js value of 40k rpm -- the HC-658 II standard spindle tops at 32k (40k would allow 25% over-speed).
    max_rpm: 32000, max_power_kw: 11,
  },
  // ── SINKER EDM (2) ────────────────────────────────────────────────────────
  {
