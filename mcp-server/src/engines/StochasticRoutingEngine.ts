...
const KIENZLE_DB: Record<string, { kc11: number; mc: number }> = {
  aluminum:        { kc11: 700,  mc: 0.25 },
  steel:           { kc11: 1800, mc: 0.26 },
  stainless_steel: { kc11: 2100, mc: 0.27 },
  titanium:        { kc11: 1600, mc: 0.24 },
  inconel:         { kc11: 2400, mc: 0.28 },
  cast_iron:       { kc11: 1100, mc: 0.26 },
  brass:           { kc11: 750,  mc: 0.22 },
  hardened_steel:  { kc11: 2800, mc: 0.30 },
