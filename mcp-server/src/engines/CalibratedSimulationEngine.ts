...
const MATERIALS: Record<string, { kc11: number; mc: number; taylorC: number; taylorN: number; kThermal: number }> = {
  steel:     { kc11: 2000, mc: 0.26, taylorC: 200, taylorN: 0.25, kThermal: 0.30 },
  stainless: { kc11: 2200, mc: 0.27, taylorC: 120, taylorN: 0.20, kThermal: 0.35 },
  aluminum:  { kc11: 800,  mc: 0.23, taylorC: 500, taylorN: 0.35, kThermal: 0.15 },
  titanium:  { kc11: 1600, mc: 0.22, taylorC: 40,  taylorN: 0.15, kThermal: 0.50 },
  inconel:   { kc11: 2800, mc: 0.28, taylorC: 25,  taylorN: 0.12, kThermal: 0.60 },
  cast_iron: { kc11: 1200, mc: 0.24, taylorC: 250, taylorN: 0.28, kThermal: 0.25 },
};
