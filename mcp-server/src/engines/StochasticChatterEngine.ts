...
const MATERIAL_DB: Record<string, MaterialChatterProps> = {
  "Ti-6Al-4V":   { kc1_1: 1680, kc1_1_cv: 10, mc: 0.23, mc_cv: 8, fn_default_hz: 750, zeta_default: 0.025, zeta_cv: 40, stiffness_default: 8e6, process_damping: 0.04, process_damping_cv: 30 },
  "AISI 4140":   { kc1_1: 1820, kc1_1_cv: 8,  mc: 0.26, mc_cv: 6, fn_default_hz: 850, zeta_default: 0.030, zeta_cv: 35, stiffness_default: 1e7, process_damping: 0.02, process_damping_cv: 25 },
  "Al 7075-T6":  { kc1_1: 800,  kc1_1_cv: 12, mc: 0.23, mc_cv: 7, fn_default_hz: 1200, zeta_default: 0.020, zeta_cv: 45, stiffness_default: 6e6, process_damping: 0.01, process_damping_cv: 35 },
  "Inconel 718": { kc1_1: 2800, kc1_1_cv: 12, mc: 0.25, mc_cv: 9, fn_default_hz: 700, zeta_default: 0.028, zeta_cv: 40, stiffness_default: 9e6, process_damping: 0.05, process_damping_cv: 30 },
  "AISI 316L":   { kc1_1: 2100, kc1_1_cv: 9,  mc: 0.24, mc_cv: 7, fn_default_hz: 800, zeta_default: 0.032, zeta_cv: 35, stiffness_default: 1e7, process_damping: 0.03, process_damping_cv: 25 },
};
...
function bayesianUpdateFRF(
  ...
  const measuredZeta = (f2 - f1) / (2 * measuredFn);

  // Bayesian update: weighted average (measurement weight = 0.7, prior = 0.3)
  const wMeas = 0.7;
  ...
  const posteriorFnCv = priorFnCv * (1 - wMeas); // ~1.5% posterior
