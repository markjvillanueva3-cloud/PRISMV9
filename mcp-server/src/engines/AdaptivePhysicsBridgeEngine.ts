...
import { ControlOutput } from "./RealTimeAdaptiveControllerEngine.js";

// ============================================================================
// BRIDGE INTERFACES
// ============================================================================

/** Sensor data generated by the bridge for adaptive control integration */
export interface BridgedSensorData {
  ...
  temperature: { spindle: number; coolant: number; ambient: number };
  temperatureLimit: number;
  spindleLoad: number;
  spindleLoadLimit: number;
  toolWear: number;
  toolWearLimit: number;
}
...
class AdaptivePhysicsBridgeEngine {
  ...
  analyzeChipFormation(conditions: AdaptiveCuttingConditions): AdaptiveChipAnalysis {
    ...
    if (chipTypeCode <= 1 && conditions.feed_mm_rev < chipResult.min_feed_for_breaking.value) {
      adaptations.push({
        ...
        recommendedValue: String(chipResult.recommended_chipbreaker.unit ?? chipResult.recommended_chipbreaker.value),
  ...
  generateSensorInputs(
    ...
    return {
      ...
      temperature: { spindle: 200 + (100 - integratedAnalysis.coolant.thermalControlScore), coolant: 25, ambient: 22 },
