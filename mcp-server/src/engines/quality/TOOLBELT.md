# quality galaxy — TOOLBELT (auto-derived baseline)
...
- `prism_quality` — domain action surface
...
- **This domain's knowledge layers (auto-invoked via wiki-precheck-inject when relevant):** [[quality-foundations]] / [[quality-source-atlas]] / [[quality-applied-practice]].
