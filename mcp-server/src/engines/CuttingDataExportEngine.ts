...
const KIENZLE_DATA: Record<string, { kc1_1: number; mc: number }> = {
  P: { kc1_1: 1500, mc: 0.26 },   // Carbon / alloy steel
  M: { kc1_1: 1800, mc: 0.28 },   // Stainless steel
  K: { kc1_1: 1100, mc: 0.26 },   // Cast iron
  N: { kc1_1:  700, mc: 0.24 },   // Aluminum alloys
  S: { kc1_1: 2200, mc: 0.28 },   // Superalloys
  H: { kc1_1: 2500, mc: 0.30 },   // Hardened steel
};
