...
const estimateKc = (hrc: number): { kc1_1: number; mc: number } => {
  if (hrc <= 15) return { kc1_1: 1200, mc: 0.25 };  // soft steel / aluminum
  if (hrc <= 25) return { kc1_1: 1500, mc: 0.26 };  // low carbon steel
  if (hrc <= 35) return { kc1_1: 1800, mc: 0.25 };  // medium carbon steel
  if (hrc <= 45) return { kc1_1: 2200, mc: 0.24 };  // alloy steel
  if (hrc <= 55) return { kc1_1: 2800, mc: 0.22 };  // hardened steel
  return { kc1_1: 3500, mc: 0.20 };                  // fully hardened
};
