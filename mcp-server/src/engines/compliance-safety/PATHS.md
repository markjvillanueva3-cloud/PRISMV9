# compliance-safety galaxy — PATHS atlas (auto-derived baseline)
...
## Engines (name-matched to this domain, 52 found — verify ownership)
...
- `mcp-server/src/engines/ComplianceEngine.ts`
- `mcp-server/src/engines/CrossProcessNeuroSymbolicSafetyVerifierEngine.ts`
- `mcp-server/src/engines/DuplicationGuardEngine.ts`
- `mcp-server/src/engines/EmbeddingGuardEngine.ts`
- `mcp-server/src/engines/Fusion360SafetyHooksEngine.ts`
...
- `mcp-server/src/engines/HyperMillSafetyHooks.ts`
- `mcp-server/src/engines/ITARComplianceTaggerEngine.ts`
- `mcp-server/src/engines/IndustryStandardsComplianceEngine.ts`
- `mcp-server/src/engines/LatheAGISafetyContainmentEngine.ts`
- `mcp-server/src/engines/LatheLoRASafetyEvaluatorEngine.ts`
- `mcp-server/src/engines/LathePartoffSafetyRailEngine.ts`
- `mcp-server/src/engines/LatheSafetyPredicateEngine.ts`
- `mcp-server/src/engines/LatheSafetySignalEngine.ts`
- `mcp-server/src/engines/LegalComplianceOperatingEngine.ts`
- `mcp-server/src/engines/MachineEnvelopeGuardEngine.ts`
- `mcp-server/src/engines/MastercamSafetyHooksEngine.ts`
- `mcp-server/src/engines/MillAGISafetyContainmentEngine.ts`
- `mcp-server/src/engines/MillSafetyPredicateEngine.ts`
- `mcp-server/src/engines/NISTAIRMFComplianceEngine.ts`
- `mcp-server/src/engines/OSHAComplianceEngine.ts`
- `mcp-server/src/engines/OmegaSafetyScoreEngine.ts`
- `mcp-server/src/engines/PIIComplianceEngine.ts`
- `mcp-server/src/engines/PPSafetyEnvelopeVectorEngine.ts`
- `mcp-server/src/engines/PPSafetyRuleValidatorEngine.ts`
- `mcp-server/src/engines/PPSpindleSpeedSafetyEngine.ts`
...
- `mcp-server/src/engines/SafetyVetoSimulationGateEngine.ts`
...
- `mcp-server/src/engines/WEDMCurrentDensityGuardEngine.ts`
- `mcp-server/src/engines/WEDMPowerDensityGuardEngine.ts`
- `mcp-server/src/engines/WEDMProgramSafetyGateEngine.ts`
...
## 📥 Registered DB intake (juliett-owned stores the compliance-safety galaxy consumes — DB-EXPANSION-BRIDGE-MS0)
...
- **wiki (domain):** `knowledge/wiki/compliance-safety/` (4 entries) -- query before re-deriving
- **synthesis brain (Obsidian):** `knowledge/memories/patterns/compliance-safety_synthesis.md` -- compounded domain patterns; refresh via `galaxy-synthesis-refresh.mjs`
- **galaxy brain:** `CLAUDE.md` · `MEMORY.md` · `SOUL.md` · `AWARENESS.md` · `TOOLBELT.md` (this dir)

**Uniform recall routing (same for every domain):**
- memories (domain-tagged, flat corpus): `prism_memory:semantic_search query="compliance-safety" topK=20` -- auto-fed every Stop by `stop-obsidian-memory-feed.mjs`
...
- AI reasoning over ALL of the above (PSN leg #10): `node scripts/lib/galaxy-reasoning-bridge.mjs compliance-safety "<question>"` (hybrid CAG+RAG, local Ollama, $0)
