...
const MAT_THERMAL: Record<string, {
  kc_base: number;  // base cutting temp coefficient
  conductivity: number; // W/m·K
  melting_point: number; // °C
}> = {
  steel: { kc_base: 350, conductivity: 50, melting_point: 1500 },
  aluminum: { kc_base: 200, conductivity: 205, melting_point: 660 },
  titanium: { kc_base: 500, conductivity: 7, melting_point: 1670 },
  stainless: { kc_base: 420, conductivity: 15, melting_point: 1450 },
  cast_iron: { kc_base: 300, conductivity: 45, melting_point: 1200 },
  inconel: { kc_base: 550, conductivity: 11, melting_point: 1350 },
};
...
export class CuttingTemperatureEngine {
  calculate(
    ...
    const thermal = MAT_THERMAL[mat] ?? MAT_THERMAL.steel;
    ...
    const toolTemp = ambient + adjTempRise * toolFraction
      * coolFactor * 1.5; // tool sees concentrated heat
