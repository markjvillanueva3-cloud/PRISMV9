...
// ── Constants ─────────────────────────────────────────────────────────
// ARCH-MS1 U-SHAD05 AUDIT: No inline physics constants found.
// MATERIAL_ENTRY_FACTORS are CAM strategy parameters (helix/ramp limits per material),
// not Kienzle/Taylor/thermal physics constants. No migration needed.
