 ...
 *
 * shared-pattern: HyperMill + Fusion360 in-host runners. The 4th sibling
 * (Mastercam, U-CAMTEST04) will arrive next; per the 3x-rule the shared
 * core extraction is queued for a follow-up unit so this engine remains
 * source-readable without cross-file coupling for review purposes.
 */
