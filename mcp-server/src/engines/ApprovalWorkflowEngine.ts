...
export class ApprovalWorkflowEngine {
  ...
  configureWorkflow(input: WorkflowConfigInput): WorkflowDefinition {
    ...
    if (existing) {
      ...
      persistenceBridge.persist("approval_workflows", existing.id, existing as any);
    ...
    persistenceBridge.persist("approval_workflows", id, workflow as any);
  ...
  async submit(input: SubmitApprovalInput): Promise<ApprovalInstance> {
    ...
    persistenceBridge.persist("approval_instances", id, instance as any);
  ...
  async decide(input: DecideApprovalInput): Promise<ApprovalInstance> {
    ...
    persistenceBridge.persist("approval_instances", instance.id, instance as any);
    return instance;
  }
  ...
  async cancel(instanceId: string, cancelledBy: string, reason?: string): Promise<ApprovalInstance> {
    ...
    persistenceBridge.persist("approval_instances", instanceId, instance as any);
...
persistenceBridge.registerMap({
  ...
  getMap: () => approvalWorkflowEngine["workflows"] as Map<string, any>,
  keyField: "id",
});
persistenceBridge.registerMap({
  entity: "approval_instances",
  getMap: () => approvalWorkflowEngine["instances"] as Map<string, any>,
  keyField: "id",
});
