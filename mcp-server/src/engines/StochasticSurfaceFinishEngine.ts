 ...
 *
 * All math self-contained — no external dependencies.
 *
...
const MATERIAL_DB: Record<string, MaterialProps> = {
  'Al 7075-T6': {
    optimal_speed_mpm: 300, bue_susceptibility: 0.85,
    k_wear: 2.0, kc: 800, force_cv: 0.08,
  },
  'Al 6061-T6': {
    optimal_speed_mpm: 350, bue_susceptibility: 0.80,
    k_wear: 2.0, kc: 750, force_cv: 0.08,
  },
  'AISI 4140': {
    optimal_speed_mpm: 180, bue_susceptibility: 0.35,
    k_wear: 3.0, kc: 2100, force_cv: 0.12,
  },
  'AISI 1045': {
    optimal_speed_mpm: 200, bue_susceptibility: 0.40,
    k_wear: 2.8, kc: 1900, force_cv: 0.10,
  },
  'AISI 316L': {
    optimal_speed_mpm: 120, bue_susceptibility: 0.30,
    k_wear: 3.5, kc: 2400, force_cv: 0.14,
  },
  'AISI 304': {
    optimal_speed_mpm: 130, bue_susceptibility: 0.32,
    k_wear: 3.4, kc: 2300, force_cv: 0.13,
  },
  'Ti-6Al-4V': {
    optimal_speed_mpm: 60, bue_susceptibility: 0.45,
    k_wear: 3.8, kc: 1800, force_cv: 0.15,
  },
  'Inconel 718': {
    optimal_speed_mpm: 30, bue_susceptibility: 0.20,
    k_wear: 4.0, kc: 2800, force_cv: 0.18,
  },
  'Inconel 625': {
    optimal_speed_mpm: 25, bue_susceptibility: 0.18,
    k_wear: 4.0, kc: 2700, force_cv: 0.17,
  },
  'S45C': {
    optimal_speed_mpm: 190, bue_susceptibility: 0.38,
    k_wear: 2.9, kc: 1950, force_cv: 0.11,
  },
  'NAK80': {
    optimal_speed_mpm: 100, bue_susceptibility: 0.25,
    k_wear: 3.2, kc: 2200, force_cv: 0.13,
  },
  'Copper C101': {
    optimal_speed_mpm: 250, bue_susceptibility: 0.70,
    k_wear: 2.2, kc: 1100, force_cv: 0.09,
  },
};
...
function getMaterial(name: string): MaterialProps {
  ...
  // Heuristic defaults for unknown materials
  ...
  // Generic steel fallback
  return {
    optimal_speed_mpm: 180, bue_susceptibility: 0.35,
    k_wear: 3.0, kc: 2000, force_cv: 0.12,
  };
}
