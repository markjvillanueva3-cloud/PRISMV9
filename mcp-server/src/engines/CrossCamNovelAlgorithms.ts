...
const MAT_DB: Record<string, { kc11: number; mc: number; density: number; cp: number; k_therm: number; chip_ratio: number }> = {
  aluminum_6061: { kc11: 800, mc: 0.23, density: 2700, cp: 896, k_therm: 167, chip_ratio: 0.85 },
  steel_1045: { kc11: 2100, mc: 0.25, density: 7850, cp: 486, k_therm: 49.8, chip_ratio: 0.65 },
  stainless_304: { kc11: 2500, mc: 0.25, density: 8000, cp: 500, k_therm: 16.2, chip_ratio: 0.55 },
  titanium_6al4v: { kc11: 1800, mc: 0.27, density: 4430, cp: 526, k_therm: 6.7, chip_ratio: 0.45 },
  inconel_718: { kc11: 3200, mc: 0.28, density: 8190, cp: 435, k_therm: 11.4, chip_ratio: 0.40 },
  cast_iron_gray: { kc11: 1500, mc: 0.25, density: 7200, cp: 490, k_therm: 50, chip_ratio: 0.70 },
};
