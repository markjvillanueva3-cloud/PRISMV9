...
/** kc1.1 by ISO group for tapping (slightly higher than turning due to constraint) */
const TAP_KC: Record<string, { kc1_1: number; mc: number }> = {
  P: { kc1_1: 2000, mc: 0.25 },   // steel
  M: { kc1_1: 2400, mc: 0.25 },   // stainless (work hardening)
  K: { kc1_1: 1200, mc: 0.25 },   // cast iron
  N: { kc1_1: 800,  mc: 0.25 },   // aluminum
  S: { kc1_1: 3200, mc: 0.22 },   // superalloys
  H: { kc1_1: 3800, mc: 0.20 },   // hardened steel
};
