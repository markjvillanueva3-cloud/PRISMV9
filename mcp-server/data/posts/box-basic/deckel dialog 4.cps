/**
  ...
  Deckel Dialog 4 post processor configuration.

  $Revision: 44207 3c29ebc507e8e59a0898c47558016451f197da94 $
  $Date: 2025-12-17 08:29:21 $

  FORKID {59290D38-7FF7-4b10-9C1C-9D7CBEFBEAA1}
*/

description = "Deckel Dialog 4";
vendor = "Deckel";
...
longDescription = "Post for Deckel Dialog 4. Note that there are quite some difference between the Dialog 4 controls so this post would most likely need further customization to work properly for the specific control.";
