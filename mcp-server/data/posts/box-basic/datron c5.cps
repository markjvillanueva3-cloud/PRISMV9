/**
  ...
  $Revision: 44192 ecdae30df1dec02f3bfe942e212273c457f4caa2 $
  $Date: 2025-08-29 13:43:37 $
...
function onManualNC(command, value) {
  ...
  if (section.getId() != -1) { // output commands processed during a section immediately
