/**
  ...
  ANYCUBIC post processor configuration.
...
function onOpen() {
  ...
  writeBlock(gFormat.format(28), xOutput.format(0), yOutput.format(0)); // homing X Y
...
function onClose() {
  ...
  writeBlock(gFormat.format(1), yOutput.format(toPreciseUnit(180, MM)), feedOutput.format(toPreciseUnit(1800, MM)));
