/**
  ...
  Felder Hammer HNC post processor configuration..

  $Revision: 44104 165ed1a9c77e5601dab85a96f32381c0b4a83b25 $
  $Date: 2023-12-14 12:10:48 $

  FORKID {1518E04E-6A72-42B4-8B43-20E248DD451D}
*/
description = "Felder Hammer HNC";
vendor = "Felder";
vendorUrl = "https://www.felder-group.com";
longDescription = "Generic milling post for Felder Hammer CNC portal milling machine HNC.";

// >>>>> INCLUDED FROM ../common/eding mill.cps
...
// <<<<< INCLUDED FROM include_files/getOffsetCode_fanuc.cpi
// <<<<< INCLUDED FROM ../common/eding mill.cps
properties.safePositionMethod.value = "clearanceHeight"; // specifies the desired safe position option
