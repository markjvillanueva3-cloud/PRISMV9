/**
  ...
  ORIGINALMIND post processor configuration.

  $Revision: 44104 165ed1a9c77e5601dab85a96f32381c0b4a83b25 $
  $Date: 2023-12-14 12:10:48 $

  FORKID {4DF48197-ED6C-40D3-A548-F2D65B0D3CA3}
*/

description = "KitMill series";
vendor = "ORIGINALMIND";
vendorUrl = "http://www.originalmind.co.jp";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Post for the KitMill series of CNCs like AST200, RD300, and RD420.";
...
properties = {
  ...
  useG43: {
    title      : "Use G43 tool length offset",
    description: "Specifies to use G43 for tool length compensation",
    group      : "preferences",
    type       : "boolean",
    value      : true,
    scope      : "post"
...
var settings = {
  ...
  maximumToolNumber           : 16, // specifies the maximum allowed tool number
  maximumToolLengthOffset     : 16, // specifies the maximum allowed tool length offset number
  maximumToolDiameterOffset   : 16 // specifies the maximum allowed tool diameter offset number
};
...
function onOpen() {
  ...
  settings.outputToolLengthCompensation = (getProperty("safePositionMethod") != "clearanceHeight") && getProperty("useG43");
...
function onSection() {
  ...
  if (isRequired && !state.retractedZ) {
    writeBlock(gMotionModal.format(0), conditional(getProperty("useG43"), gFormat.format(43)), zOutput.format(initialPosition.z)); // position Z first
    forceXYZ();
  }
