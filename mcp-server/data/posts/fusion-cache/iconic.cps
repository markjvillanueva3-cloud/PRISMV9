/**
  ...
  ICONIC router post processor configuration.

  $Revision: 44104 165ed1a9c77e5601dab85a96f32381c0b4a83b25 $
  $Date: 2023-12-14 12:10:48 $

  FORKID {575F5286-2D7E-4DA8-AD18-03D35C519590}
*/

description = "ICONIC CNC";
vendor = "ICONIC";
vendorUrl = "http://iconiccnc.com";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Generic post for ICONIC CNC routers.";
...
function onOpen() {
  ...
  writeBlock(gAbsIncModal.format(90), getSection(0).wcs, gPlaneModal.format(17), xOutput.format(0), yOutput.format(0), zOutput.format(0)); // G54->G59
...
function onSection() {
  ...
  forceAny();
  //  writeBlock(gMotionModal.format(0), xOutput.format(0), yOutput.format(0), zOutput.format(0));
...
function onCommand(command) {
  ...
  case COMMAND_LOAD_TOOL:
    writeToolBlock("T" + toolFormat.format(tool.number), conditional(tool.description, formatComment(tool.description)));
