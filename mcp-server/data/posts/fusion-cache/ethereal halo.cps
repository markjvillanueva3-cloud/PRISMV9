/**
  ...
  Ethereal HALO post processor configuration.

  $Revision: 44107 fdbddcd9a1d3cf71c49c0d31d4963c1877e5a756 $
  $Date: 2024-01-11 15:12:03 $

  FORKID {36AFAD28-2752-4641-A54F-28CFAFA5085D}
*/

description = "Ethereal HALO Post Processor";
vendor = "Ethereal Machines";
vendorUrl = "https://etherealmachines.com/";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Generic milling post for Ethereal Machines - HALO";
...
function defineMachine() {
  ...
  if (!receivedMachineConfiguration) { // CAM provided machine configuration takes precedence
    var aAxis = createAxis({coordinate:0, table:true, axis:[1, 0, 0], range:[-110, 40], preference:1, tcp:useTCP});
...
function onDwell(seconds) {
  ...
  seconds = clamp(0.5, seconds, 99999.999);
...
function onCyclePoint(x, y, z) {
  ...
  expandCyclePoint(x, y, z); // expand all cycles - Currently Machine does not support any of the drilling cycles
  return;
}
