/**
  ...
  $Revision: 44113 e35cea3b4dc5e697f54e5e5f9ddc951bef950a88 $
  $Date: 2024-03-04 06:48:33 $
...
longDescription = "Generic post for Heidenhain iTNC 426.";
...
properties = {
  ...
  useM06: {
    title      : "Use M6 for tool change",
    description: "Enable to output an M6 code after a TOOL CALL block.",
    group      : "preferences",
    type       : "boolean",
    value      : false,
    scope      : "post"
...
function onSection() {
  ...
  if (insertToolCall) {
    ...
    writeBlock(
      ...
      SP + getSpindleAxisLetter(machineConfiguration.getSpindleAxis()) + conditional(!isProbeOperation(), " S" + rpmFormat.format(spindleSpeed))
    );
