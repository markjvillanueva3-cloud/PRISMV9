...
*/
  ...
  writeInitialPositioning(initialPosition, isRequired, "", getCoolantCodes(tool.coolant));
}
...
function onClose() {
  ...
  var homeX = machineConfiguration.hasHomePositionX() ? "X" + xyzFormat.format(machineConfiguration.getHomePositionX()) : "";
  var homeY = machineConfiguration.hasHomePositionY() ? "Y" + xyzFormat.format(machineConfiguration.getHomePositionY()) : "";
  if (homeX || homeY) {
