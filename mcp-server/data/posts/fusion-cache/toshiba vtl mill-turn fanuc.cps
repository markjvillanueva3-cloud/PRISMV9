...
var gCycleModal = createOutputVariable({}, g1Format); // modal group 9 // G81, ...
var gPolarModal = createOutputVariable({}, g1Format); // G12.1, G13.1
...
function onSection() {
  ...
  var yAxisWasEnabled = !machineState.usePolarInterpolation && !machineState.usePolarCoordinates && machineState.liveToolIsActive;
  ...
  if (subprogramsAreSupported() && !machineState.usePolarCoordinates) {
...
properties.useSubroutines.values = [
  {title:"No", id:"none"},
  {title:"Patterns", id:"patterns"}
];
