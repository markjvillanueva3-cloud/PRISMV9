...
properties = {
  material: {
    ...
    description: "Set the material type to either 'Steel' or 'Graphite'",
    group      : "preferences",
    type       : "enum",
    values     : [
...
function onCommand(command) {
  ...
  case COMMAND_COOLANT_ON:
    writeBlock(getProperty("material") == "graphite" ? "CLEANON" : "CLEANON");
    return;
  case COMMAND_COOLANT_OFF:
    writeBlock(getProperty("material") == "graphite" ? "CLEANOFF" : "CLEANOFF");
    return;
