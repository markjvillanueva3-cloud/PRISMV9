/**
  ...
  ShopSabre IS-M Series router post processor configuration.

  $Revision: 44104 165ed1a9c77e5601dab85a96f32381c0b4a83b25 $
  $Date: 2023-12-14 12:10:48 $

  FORKID {88B1EB2D-7EED-4D4B-B2C5-5886777DDDC5}
*/

description = "ShopSabre IS-M with Mitsubishi M8 Series Control";
longDescription = "Generic milling post for ShopSabre IS-M Series routers with a Mitsubishi M8 Series Control.";
...
properties.preloadTool.value = false; // preloads next tool on tool change if any
properties.toolChangeOrder.value = "M06Txx"; // output order of tool change block "TxxM06" or "M06Txx"

settings.supportsTCP = false; // specifies if the postprocessor does support TCP
