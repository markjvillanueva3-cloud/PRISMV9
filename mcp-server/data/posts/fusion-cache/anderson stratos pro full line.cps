/**
  ...
  $Revision: 44106 4f6419dad46d325a680a92bf121ce68dd30b5eaf $
  $Date: 2024-01-08 08:22:38 $
...
description = "Anderson Stratos Pro Full line";
...
longDescription = "Generic post for Anderson Stratos Pro Full line";
...
properties = {
  useSpindle: {
    title      : "Use Spindle",
    description: "Select 'Spindle 1' to enable first spindle(T101-T110), 'Spindle 2' to enable second spindle(T201-T210 ) ",
    group      : "preferences",
    type       : "enum",
    values     : [
  ...
  useStockForSheetSize: {
    ...
    description: "Specifies whether the stock X and Y should be used for the #527 and #528 database call, instead of the 'Sheet Size X' and 'Sheet Size Y' property.",
    group      : "preferences",
    type       : "boolean",
    value      : true,
    scope      : "post"
  ...
  sheetSizeX: {
    ...
    description: "Specifies the X Sheet size (in millimeter) when not using Use stock for sheet size property",
    group      : "preferences",
    type       : "integer",
    value      : 1800,
    scope      : "post"
  ...
  sheetSizeY: {
    ...
    description: "Specifies the Y Sheet size (in millimeter) when not using Use stock for sheet size property",
    group      : "preferences",
    type       : "integer",
    value      : 1200,
    scope      : "post"
...
function getCurrentSpindle() {
  if (getProperty("useSpindle") == "spindle1") {
    spindle = 1;
  } else {
    spindle = 2;
  }
...
function onOpen() {
  ...
  if (getProperty("useStockForSheetSize")) {
    ...
    writeBlock("#527=", xyzFormat.format(toPreciseUnit(getProperty("sheetSizeX"), MM)), "  (X SHEET SIZE)");
    writeBlock("#528=", xyzFormat.format(toPreciseUnit(getProperty("sheetSizeY"), MM)), "  (Y SHEET SIZE)");
  }
