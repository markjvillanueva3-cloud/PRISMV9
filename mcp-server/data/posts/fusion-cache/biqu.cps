/**
  ...
  BIQU post processor configuration.

  $Revision: 44106 85222cccf9cee3e216d9ee111aa5823d026a774f $
  $Date: 2024-01-03 15:11:55 $

  FORKID {2C1EC703-1CBF-40FD-A5BF-780C5A553B5C}
*/

description = "BIQU range of printers";
vendor = "BIQU";
vendorUrl = "https://biqu.equipment//";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Post for exporting toolpath to the BIQU range of printers (B1, B1 SE, B1 SE plus, BX, Hurakan...)";
...
properties = {
  enableBedLeveling: {
    title      : "Enable auto bed leveling",
    description: "Specifies if the bed leveling is activated via G29, or unused.",
    type       : "enum",
    values     : [
      {title:"G29", id:"g29"},
...
function onSection() {
  ...
  if (getProperty("enableBedLeveling") == "g29") {
    writeBlock(mFormat.format(117), " ABL Probing");
