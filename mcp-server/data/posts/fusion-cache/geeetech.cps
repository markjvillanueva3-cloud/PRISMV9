/**
  ...
  Geeetech post processor configuration.
...
longDescription = "Post for exporting toolpath to the Geeetech range of printers in gcode format (A10, A20, A30). No support for the color mixing functionality. Optional support for the bed probing.";
...
properties = {
  bedProbe: {
    title      : "Enable bed probing",
    description: "Enable the usage of the bed probe command (G29) in the program start.",
    type       : "boolean",
    value      : false,
    scope      : "post"
  }
...
function onSection() {
  ...
  if (getProperty("bedProbe")) {
    writeBlock(gFormat.format(29)); // enable optional bed probing
  }
