...
description = "HAAS (pre-NGC) Inspect Surface";
longDescription = "Generic post for use with all common 3-axis HAAS mills like the DM, VF, Office Mill, and Mini Mill series with inspect surface & Live connection capabilities.";
...
function inspectionValidateInspectionSettings() {
  ...
  if (errorText != "") {
    error(localize("The following properties need to be configured:" + errorText + "\n-Please consult the guide PDF found at https://cam.autodesk.com/hsmposts?p=haas_inspect_surface for more information-"));
  }
}
