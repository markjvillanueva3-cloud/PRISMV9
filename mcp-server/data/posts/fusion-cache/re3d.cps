/**
  ...
  Re3D post processor configuration.

  $Revision: 44106 85222cccf9cee3e216d9ee111aa5823d026a774f $
  $Date: 2024-01-03 15:11:55 $

  FORKID {41043392-21B3-43BD-A1CF-D60A409AC4A6}
*/

description = "Re3D";
vendor = "Re3D";
vendorUrl = "https://www.re3d.org";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Post for exporting toolpath to Re3D range of printers. (Exabot, Gigabot, Terabot)";
...
var settings = {
  ...
  maximumExtruderTemp: 320, // specifies the maximum extruder temperature
...
function onOpen() {
  ...
  writeBlock(gFormat.format(4), pFormat.format(5000));
...
function onSection() {
  ...
  writeBlock(mFormat.format(220), sFormat.format(100)); // Set speed factor override percentage
  writeBlock(mFormat.format(221), sFormat.format(100)); // Set extrude factor override percentage

  writeBlock("SET_PRESSURE_ADVANCE ADVANCE=0.096");
  ...
  writeBlock(mFormat.format(400)); // wait for moves to finish
  forceXYZE();
}

function onClose() {
  writeBlock(mFormat.format(117), localize("Print finished"));
  writeBlock(gFormat.format(28), "X Y"); //homing
