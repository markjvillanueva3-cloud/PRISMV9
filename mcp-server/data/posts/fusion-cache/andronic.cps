...
var drillFeedOutput = createOutputVariable({prefix:"E"}, feedFormat);
...
var gMotionModal = createOutputVariable({}, gFormat); // modal group a // G0-G3, ...
var gPlaneModal = createOutputVariable({onchange:function () {gMotionModal.reset();}}, gFormat); // modal group c // G17-19
var gUnitModal = createOutputVariable({}, gFormat); // modal group m // G70-71
var gAbsIncModal = createOutputVariable({}, gFormat); // modal group j // G90-91
var gFeedModeModal = createOutputVariable({}, gFormat); // modal group k // G94-G95
var gCycleModal = createOutputVariable({}, gFormat); // modal group e // G81, ...
var gArcCenterModal = createOutputVariable({}, gFormat); // modal group 10 // G190-G191
...
var settings = {
  ...
  parametricFeeds: {
    ...
    feedAssignmentVariable: "Q", // specifies the syntax to define a parameter
    feedOutputVariable    : "F=Q" // specifies the syntax to output the feedrate as parameter
  },
