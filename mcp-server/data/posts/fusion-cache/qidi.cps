/**
  ...
  Qidi post processor configuration.

  $Revision: 44106 85222cccf9cee3e216d9ee111aa5823d026a774f $
  $Date: 2024-01-03 15:11:55 $

  FORKID {FFA10F60-112F-4355-8399-45406ED14E1E}
*/

description = "Qidi";
vendor = "Qidi";
vendorUrl = "https://qidi3d.com/";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Post for exporting toolpath to the Qidi range of printer in gcode format (x-maker, x-max, x-one 2, x-plus, x-pro, x-smart)";
...
properties = {
  shutDown: {
    title      : "Shut down",
    description: "Shut down the printer at the end of the program.",
    type       : "boolean",
    value      : false,
    scope      : "post",
    group      : "preferences"
...
function onClose() {
  ...
  if (getProperty("shutDown")) {
    writeBlock(mFormat.format(4003), formatComment(localize("shutdown")));
  }
