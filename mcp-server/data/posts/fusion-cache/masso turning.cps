/**
  ...
  MASSO Lathe post processor configuration.

  $Revision: 44054 9c2b6defde725d736aa800a0dd87f214bcdedf1b $
  $Date: 2023-02-27 14:44:04 $

  FORKID {8A5B9C61-2651-4395-B1BF-FFC107F72B4C}
*/

description = "MASSO TURNING";
...
longDescription = "Turning post for Masso.";
...
function onOpen() {
  ...
  writeBlock(gAbsIncModal.format(90), gFeedModeModal.format(94), gPlaneModal.format(18));
...
function onLinear(_x, _y, _z, feed) {
  if (isSpeedFeedSynchronizationActive()) {
    ...
    if (xOutput.getCurrent() !== _x) {
      error(localize("G32 does not support tapers."));
    }
...
function onCyclePoint(x, y, z) {
  ...
  switch (cycleType) {
  case "thread-turning":
    error(localize("Thread turning cycle is not supported. Use G32."));
  ...
  if (isFirstCyclePoint()) {
    ...
    case "tapping":
      ...
      writeBlock(
        (getProperty("type") == "A") ? "" : gRetractModal.format(98), conditional(getProperty("type") != "A", gAbsIncModal.format(90)), gCycleModal.format((tool.type == TOOL_TAP_LEFT_HAND) ? 74 : 84),
        getCommonCycle(x, y, z, cycle.retract),
        "P" + milliFormat.format(P),
        feedOutput.format(F)
      );
    ...
    case "left-tapping":
      ...
      writeBlock(
        (getProperty("type") == "A") ? "" : gRetractModal.format(98), conditional(getProperty("type") != "A", gAbsIncModal.format(90)), gCycleModal.format(74),
        getCommonCycle(x, y, z, cycle.retract),
        "P" + milliFormat.format(P),
        feedOutput.format(F)
      );
    ...
    case "right-tapping":
      ...
      writeBlock(
        (getProperty("type") == "A") ? "" : gRetractModal.format(98), conditional(getProperty("type") != "A", gAbsIncModal.format(90)), gCycleModal.format(84),
        getCommonCycle(x, y, z, cycle.retract),
        "P" + milliFormat.format(P),
        feedOutput.format(F)
      );
    ...
    case "fine-boring":
      writeBlock(
        (getProperty("type") == "A") ? "" : gRetractModal.format(98), conditional(getProperty("type") != "A", gAbsIncModal.format(90)), gCycleModal.format(76),
        getCommonCycle(x, y, z, cycle.retract),
    ...
    case "reaming":
      if (P > 0) {
        writeBlock(
          (getProperty("type") == "A") ? "" : gRetractModal.format(98), conditional(getProperty("type") != "A", gAbsIncModal.format(90)), gCycleModal.format(89),
          getCommonCycle(x, y, z, cycle.retract),
          "P" + milliFormat.format(P),
          feedOutput.format(F)
        );
        ...
        writeBlock(
          (getProperty("type") == "A") ? "" : gRetractModal.format(98), conditional(getProperty("type") != "A", gAbsIncModal.format(90)), gCycleModal.format(85),
          getCommonCycle(x, y, z, cycle.retract),
          feedOutput.format(F)
        );
      }
    ...
    case "stop-boring":
      if (P > 0) {
        ...
        writeBlock(
          (getProperty("type") == "A") ? "" : gRetractModal.format(98), conditional(getProperty("type") != "A", gAbsIncModal.format(90)), gCycleModal.format(86),
          getCommonCycle(x, y, z, cycle.retract),
          feedOutput.format(F)
        );
      }
