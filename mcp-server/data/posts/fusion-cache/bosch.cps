...
longDescription = "Generic milling post for Bosch.";
...
var secFormat = createFormat({decimals:2, forceDecimal:true}); // seconds - range 0.01-99999
...
var gMotionModal = createOutputVariable({}, gFormat); // modal group 2 // G0-G3, ...
var gPlaneModal = createOutputVariable({onchange:function () {gMotionModal.reset();}}, gFormat); // modal group 10 // G17-19
var gAbsIncModal = createOutputVariable({}, gFormat); // modal group 4 // G90-91
var gFeedModeModal = createOutputVariable({}, gFormat); // modal group 7 // G93-95
var gUnitModal = createOutputVariable({}, gFormat); // modal group 3 // G70-71
var gCycleModal = createOutputVariable({}, gFormat); // modal group 16 // G81, ...
