...
description = "MASSO";
longDescription = "Generic milling post for MASSO controller. Use the 'Has 5-Axis' property for 5 axis toolpaths. Post defaults to an AC trunnion type machine. Other configurations require post modification.";
