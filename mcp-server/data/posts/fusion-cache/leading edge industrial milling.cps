/**
  ...
  FORKID {29D122ED-F74F-4165-9F73-67C09B54CCB2}
*/

description = "Leading Edge Industrial Milling";
...
longDescription = "Milling post for LEI Vertical Machining Center.";
...
function onSectionEnd() {
  if (!isLastSection() && (getNextSection().getTool().coolant != tool.coolant)) { // writeBlock(gPlaneModal.format(17));
    setCoolant(COOLANT_OFF);
  }
  forceAny();
}
