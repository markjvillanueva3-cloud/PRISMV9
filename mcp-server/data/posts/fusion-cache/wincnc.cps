...
properties = {
  ...
  ATCMode: {
    title      : "ATC mode",
    description: "M0 or M1 on the ATC line in the WinCNC.ini file.",
    group      : "preferences",
    type       : "integer",
    value      : 0,
    scope      : "post"
...
function onSection() {
  ...
  // Start of F_XY F_Z feed rate type logic
  var xyzFeeds = (
  ...
  // End of F_XY F_Z feed rate type
