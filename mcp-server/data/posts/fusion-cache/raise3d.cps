/**
  ...
  Raise3D post processor configuration.

  $Revision: 44106 85222cccf9cee3e216d9ee111aa5823d026a774f $
  $Date: 2024-01-03 15:11:55 $

  FORKID {AD5D15BA-BA25-4B00-8201-8AF67FFBADF7}
*/

description = "Raise3D";
vendor = "Raise3D";
vendorUrl = "https://www.raise3d.com/";
legal = "Copyright (C) 2012-2023 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45917;

longDescription = "Post for exporting toolpath to the Raise3D range of printers in gcode format (E2, Pro2, Pro2 Plus, Pro3, Pro3 Plus).";
...
function onOpen() {
  ...
  writeBlock(gFormat.format(28), xOutput.format(0), yOutput.format(0)); // homing
...
function onSection() {
  ...
  writeBlock(mFormat.format(1001));  // for automatic power failure detection
}
...
function onClose() {
  ...
  writeBlock(gMotionModal.format(1), zOutput.format(toPreciseUnit(5, MM)));
