...
RG: src/registries/ | H: src/hooks/ | U: src/utils/ | C: src/data/ | S: src/schemas/
M: data/milestones/ | DOC: data/docs/ | Routes: src/routes/ | Web: web/src/

## Digests (load for detail)
