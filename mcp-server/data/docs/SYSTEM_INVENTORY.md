...
## Last Updated: 2026-03-06 | Auto-generated by /forge-audit
...
|----------|-------|----------|
| **Engines** | 218 files (150 exported, 68 unwired) | `src/engines/` |
| **Algorithms** | 52 (18 physics, 18 ML/optimization, 14 mfg-specific, 2 support) | `src/algorithms/` |
| **Dispatchers** | 53 files | `src/tools/dispatchers/` |
| **Actions** | 1710 total across all dispatchers | dispatchers |
...
| **Tests (Backend)** | 5617 passing, 170 files | `src/__tests__/` |
...
| **Milestones** | 95/95 COMPLETE | `data/milestones/` |

---

## ENGINES BY CATEGORY (218 total)

### Exported (150) — in `src/engines/index.ts`
...
### Unwired (68) — on disk but not exported
...
|---|-----------|---------|--------|
| 1 | calcDispatcher | 432 | Physics, math, optimization, manufacturing calculations |
