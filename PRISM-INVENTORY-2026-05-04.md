...
**Updated:** 2026-05-04T23:59:42.353Z
...
|----------|-------|--------|
| **Engines** | 3047 | live: `src/engines/*.ts` |
| **Dispatchers** | 95 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 6814 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 3191 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 422 | live: `.claude/hooks/**/*.mjs` |
