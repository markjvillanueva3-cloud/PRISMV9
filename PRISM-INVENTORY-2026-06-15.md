...
**Updated:** 2026-06-15T23:57:25.399Z
**Source:** live scan (104ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3803 | live: `src/engines/*.ts` |
| **Dispatchers** | 111 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10240 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4834 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 1002 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2732 | live: `scripts/` + `mcp-server/scripts/` |
