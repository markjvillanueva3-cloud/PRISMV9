...
**Updated:** 2026-05-08T23:57:26.440Z
...
|----------|-------|--------|
| **Engines** | 3173 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 7305 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 3416 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 440 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 469 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 246 | live: `.claude/commands/` |
| **Slash Commands (user)** | 379 | live: `~/.claude/commands/` |
