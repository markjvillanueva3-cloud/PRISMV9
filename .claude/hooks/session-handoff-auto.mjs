...
try {
  ...
  console.log(JSON.stringify({ continue: true, systemMessage: `✓ Handoff saved: ${sessionId}` }));
} catch (err) {
  console.log(JSON.stringify({ continue: true, systemMessage: `⚠️ Handoff write failed: ${err.message}` }));
}
