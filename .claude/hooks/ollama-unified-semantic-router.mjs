...
// P20-U04: model selection now goes through ModelRouterEngine (tier-1
// "code-simple" → qwen2.5-coder:7b by default; engine can re-tier
// centrally via P23 telemetry). pickModel falls back to qwen2.5-coder:7b
// if the compiled engine is unreachable, so hook stays resilient.
...
Your recommendations:`;
  ...
  try {
    const model = await pickModel({ kind: 'general', complexity: 'simple' });
