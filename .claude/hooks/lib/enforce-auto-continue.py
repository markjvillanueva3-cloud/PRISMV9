...
def main():
    ...
    tracker_path = "H:/prism/state/auto-compact-tracker.json"
    try:
    ...
    try:
        flag_path = "H:/prism/state/compact-just-happened.json"
    ...
    handoff_path = "H:/prism/state/HANDOFF.md"
    ...
    if resume:
        ...
        msg = (
            ...
            "Read H:/prism/state/HANDOFF.md and H:/prism/state/COMPACTION_SURVIVAL.json "
