...
export const TIER_PREFERENCES = Object.freeze({
  ...
  balanced: Object.freeze([
    ...
    // NOT installed on this host, so a balanced task escalates upward to `strong`
    // (gpt-oss:20b, 185 tok/s) / `best` — the higher-tier, faster replacement. Tiers
    // are kept DISJOINT (gpt-oss:20b lives only in `strong`) so the escalation path
    // is unambiguous; the result is identical to listing it here. Kept as registry
    // options so a smaller host that pulls one still routes correctly.
    "qwen2.5:7b",
    "codellama:7b",
    "deepseek-coder:6.7b",
  ]),
  ...
  best: Object.freeze([
    ...
    "qwen3-coder:30b",      // BLACKWELL-MODEL-EXPAND 2026-06-10: Qwen3-Coder 30B-A3B MoE, 18GB, INSTALLED -- newer/faster local coder, preferred over qwen2.5-coder:32b
    "qwen2.5-coder:32b",    // prior CODER (~20GB) -- the held fast-coder
