...
Also maintains a persistent "built but unwired" ledger at H:/prism/state/unwired-engines-ledger.json
...
MASTER_INDEX = "H:/prism/mcp-server/data/docs/MASTER_INDEX_COMPACT.md"
