 ...
 *   PRISM_OLLAMA_ROUTE_MODEL         → model for the auto summary (default qwen2.5-coder:32b)
 ...
 *     { "mode": "auto" | "suggest", "minKb": >=8, "model": "qwen2.5-coder:32b" }
...
export async function runRoute({
  ...
  if (mode === "auto") {
    ...
    tagsOk = tags.ok;
    modelOk = tagsOk && tags.models.includes(model);
