param(
  ...
  # reap+restart), so a 10-min tick on a HEALTHY host just runs the ~4s generate probe
  # (qwen2.5-coder:1.5b, keep_alive 30m) -> it doubles as a health monitor + warm-probe.
