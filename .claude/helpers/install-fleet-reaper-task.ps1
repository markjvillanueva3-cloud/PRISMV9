...
# sweep never piles a second instance on top of itself.
...
Write-Host "Registered: $TaskName ($mode, fleet-reaper-sweep.mjs --once, every $EveryMinutes min, +$($StartOffsetSeconds)s phase offset, node=$nodeExe)"
