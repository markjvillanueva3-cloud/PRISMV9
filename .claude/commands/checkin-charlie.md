...
Any args after `/checkin-charlie` are treated identically to args passed to `/checkin`. Example: `/checkin-charlie /loop system-viz-brain until /goal` enters the dev pipeline + /loop loop.
