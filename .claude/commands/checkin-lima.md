...
Any args after `/checkin-lima` are treated identically to args passed to `/checkin`. Example: `/checkin-lima /loop system-viz-brain until /goal` enters the dev pipeline + /loop loop.
