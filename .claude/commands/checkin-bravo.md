...
Any args after `/checkin-bravo` are treated identically to args passed to `/checkin`. Example: `/checkin-bravo /loop system-viz-brain until /goal` enters the dev pipeline + /loop loop.
