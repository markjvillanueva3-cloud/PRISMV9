...
Any args after `/checkin-echo` are treated identically to args passed to `/checkin`. Example: `/checkin-echo /loop system-viz-brain until /goal` enters the dev pipeline + /loop loop.
