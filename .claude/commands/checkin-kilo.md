...
Any args after `/checkin-kilo` are treated identically to args passed to `/checkin`. Example: `/checkin-kilo /loop system-viz-brain until /goal` enters the dev pipeline + /loop loop.
