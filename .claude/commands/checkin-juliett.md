...
Any args after `/checkin-juliett` are treated identically to args passed to `/checkin`. Example: `/checkin-juliett /loop system-viz-brain until /goal` enters the dev pipeline + /loop loop.
