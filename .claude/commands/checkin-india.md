...
Any args after `/checkin-india` are treated identically to args passed to `/checkin`. Example: `/checkin-india /loop system-viz-brain until /goal` enters the dev pipeline + /loop loop.
