...
Any args after `/checkin-foxtrot` are treated identically to args passed to `/checkin`. Example: `/checkin-foxtrot /loop system-viz-brain until /goal` enters the dev pipeline + /loop loop.
