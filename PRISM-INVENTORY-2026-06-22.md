...
**Updated:** 2026-06-22T23:27:36.052Z
...
|----------|-------|--------|
| **Engines** | 3828 | live: `src/engines/*.ts` |
| **Dispatchers** | 111 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10313 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4974 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 1030 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2955 | live: `scripts/` + `mcp-server/scripts/` |
