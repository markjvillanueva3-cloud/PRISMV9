...
**Updated:** 2026-06-16T22:19:54.147Z
**Source:** live scan (76ms) — via scripts/update-prism-inventory.mjs
...
| **Tests** | 4845 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 1004 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2755 | live: `scripts/` + `mcp-server/scripts/` |
