...
**Updated:** 2026-06-14T07:31:17.908Z
**Source:** live scan (51ms) — via scripts/update-prism-inventory.mjs
...
| **Dispatchers** | 110 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10072 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4785 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 984 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2641 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 747 | live: `.claude/commands/` |
