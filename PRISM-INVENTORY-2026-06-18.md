...
**Updated:** 2026-06-18T20:27:06.832Z
...
|----------|-------|--------|
| **Engines** | 3814 | live: `src/engines/*.ts` |
| **Dispatchers** | 111 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10268 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4866 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 1020 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2830 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 766 | live: `.claude/commands/` |
