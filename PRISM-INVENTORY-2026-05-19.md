...
**Updated:** 2026-05-19T23:49:50.430Z
**Source:** live scan (95ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3286 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 8315 | live: `z.enum` count across dispatchers |
| **Algorithms** | 61 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 3919 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 664 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1079 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 294 | live: `.claude/commands/` |
