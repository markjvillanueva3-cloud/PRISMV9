...
```javascript
// For steels:
Kc11 = 3.5 × UTS + 500  // Low carbon (< 0.25% C)
Kc11 = 4.0 × UTS + 400  // Medium carbon (0.25-0.55% C)
Kc11 = 4.5 × UTS + 300  // High carbon (> 0.55% C)
Kc11 = 5.0 × UTS + 200  // Alloy steels

// For stainless:
Kc11 = 4.2 × UTS + 600  // Austenitic
Kc11 = 3.8 × UTS + 500  // Ferritic/Martensitic
...
```javascript
// A ≈ Yield strength for annealed condition
// A = Yield × 1.1 for cold worked
// A = Yield × 0.95 for elevated temperature reference
```
...
// HSS: C ≈ 0.12 × UTS + 20
// Carbide uncoated: C ≈ 0.75 × UTS + 100
// Carbide coated: C ≈ 1.0 × UTS + 120
// Ceramic: C ≈ 1.8 × UTS + 200
