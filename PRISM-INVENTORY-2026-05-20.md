...
**Updated:** 2026-05-20T23:50:50.196Z
**Source:** live scan (112ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3295 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 8362 | live: `z.enum` count across dispatchers |
| **Algorithms** | 61 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 3957 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 691 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1175 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 300 | live: `.claude/commands/` |
