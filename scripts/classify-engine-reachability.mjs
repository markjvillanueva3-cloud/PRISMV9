...
// to ...-2026-05-07.json -> a 40-day-stale unwired list). Fallback keeps the old name if none found.
const SHARED_DIR = path.join(ROOT, "state", "shared");
const AUDIT = findFreshestUnwiredAuditPath({ sharedDir: SHARED_DIR }) || path.join(SHARED_DIR, "UNWIRED-ENGINE-AUDIT-2026-05-07.json");
