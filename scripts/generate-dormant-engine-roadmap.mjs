...
const AUDIT = join(ROOT, 'state', 'shared', 'UNWIRED-ENGINE-AUDIT-2026-05-07.json');
...
function main() {
  ...
  const split = {
    ...
    milestone: 'DEA-MS0',
    owner: PRIMARY_SLOT,
    source: { audit: 'UNWIRED-ENGINE-AUDIT-2026-05-07.json', typeA_unwired: engines.length },
  ...
  const envelope = {
    ...
    resources_utilized: {
      audit: 'UNWIRED-ENGINE-AUDIT-2026-05-07.json',
