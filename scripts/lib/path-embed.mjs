...
//        PRISM_PATH_EMBED_URL (default http://localhost:11434) · PRISM_PATH_EMBED_TIMEOUT_MS (default 5000)
...
const DEFAULT_URL = () => process.env.PRISM_PATH_EMBED_URL || "http://localhost:11434";
