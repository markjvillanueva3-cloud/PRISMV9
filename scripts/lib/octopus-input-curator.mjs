...
//
// Before the octopus 5-voice fan-out fires, RAG-rerank the operator prompt
...
// The 5 voices then disagree (or agree) over the same enriched substrate,
...
//
// Inputs:
//   prompt: string — operator's question / directive going to the 5 voices.
