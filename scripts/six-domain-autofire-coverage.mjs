...
export const DOMAINS = Object.freeze([
  ...
  // ---- 4 greenfield domains (slot:zulu 2026-07-01, DOMAIN-APPROACH-ENRICH); harness now covers 10 despite the filename ----
  { key: "speed-feed", slot: "oscar",   lib: "scripts/lib/speed-feed-approach-knowledge.mjs", hook: "oscar-speed-feed-approach-inject.mjs" },
  { key: "academy",    slot: "lima",    lib: "scripts/lib/academy-approach-knowledge.mjs",    hook: "lima-academy-approach-inject.mjs" },
  { key: "business",   slot: "hotel",   lib: "scripts/lib/business-approach-knowledge.mjs",   hook: "hotel-business-approach-inject.mjs" },
  { key: "quoting",    slot: "charlie", lib: "scripts/lib/quoting-approach-knowledge.mjs",     hook: "charlie-quoting-approach-inject.mjs" },
]);
...
export function renderReport(cov, stamp = "") {
  ...
  const r = c.rollup || {};
  const out = [];
  out.push("# DOMAIN auto-firing coverage -- live VALIDATE (10 domains)");
  out.push("");
  ...
  out.push(`- all ${r.domains} fire live: **${yn(r.allFire)}**`);
  out.push(`- all ${r.domains} bundle-wired: **${yn(r.allWired)}**`);
