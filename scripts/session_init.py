...
# Resolve paths relative to wherever PRISM actually lives — portable across
# drive letters (C:, H:, etc.). See scripts/_prism_paths.py.
sys.path.insert(0, str(Path(__file__).resolve().parent))
from _prism_paths import PRISM_ROOT, STATE_DIR, SCRIPTS_DIR, CONFIG_DIR  # noqa: E402

STATE_PATH = STATE_DIR / "CURRENT_STATE.json"
PEAK_CONFIG = CONFIG_DIR / "PEAK_RESOURCES.json"
