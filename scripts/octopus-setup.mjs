 ...
 *
 * @param {object} a
 * @param {string} a.voice                  one of: anthropic | codex | ollama | xai | google
...
export function renderChecklist(statuses) {
  ...
  const lines = [
    `# 🐙 Octopus 5-voice setup — ${readyCount}/${totalCount} ready (${verdict.toUpperCase()})`,
    "",
  ];
...
async function probeAllVoices() {
  // Anthropic, xAI, Google are trivial; Codex + Ollama are external.
