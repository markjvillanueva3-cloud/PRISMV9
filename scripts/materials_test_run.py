    ...
    try:
        ...
        if json_match:
            try:
                ...
                # Save test output
                test_output = r"C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\_REPORTS\test_material_output.json"
                ...
                with open(r"C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\_REPORTS\test_raw_output.txt", 'w') as f:
                    f.write(content)
                return True
