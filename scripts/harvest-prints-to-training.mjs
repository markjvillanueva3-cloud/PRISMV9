...
import { readdirSync, statSync, existsSync, mkdirSync, writeFileSync, renameSync, readFileSync, appendFileSync } from "node:fs";
  ...
  return {
    ...
    recordEvent: async (event) => {
      try {
        ...
        return { success: true, written_to: eventsFile };
      } catch (e) {
