...
// CLI guard: `file://${argv[1]}` yields file://H:/... on Windows but import.meta.url is
// file:///H:/... (empty authority) -> the guard was NEVER true here, so main() silently no-oped
// on every regen since 2026-06-22 (the AUG-STALE-ORPHAN the freshness audit flagged).
