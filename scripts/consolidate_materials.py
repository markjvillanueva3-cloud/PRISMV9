...
============================================
Merges all materials from PRISM REBUILD + C:\PRISM into unified JSON database
...
# Paths
PRISM_REBUILD = Path("C:/PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)/EXTRACTED")
...
def main():
    ...
    # =========================================================================
    # PHASE 1: Load from PRISM REBUILD (JS files)
    # =========================================================================
    print("PHASE 1: Loading from PRISM REBUILD...")
