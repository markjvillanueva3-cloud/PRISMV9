...
**Updated:** 2026-05-12T22:04:43.263Z
...
|----------|-------|--------|
| **Engines** | 3202 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 7375 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 3474 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 506 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 612 | live: `scripts/` + `mcp-server/scripts/` |
| **Slash Commands (local)** | 170 | live: `.claude/commands/` |
