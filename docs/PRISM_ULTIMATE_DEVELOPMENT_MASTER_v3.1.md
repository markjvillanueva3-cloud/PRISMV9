...
1. CHECK Box folder access:
   Filesystem:list_directory → C:\Users\wompu\Box\PRISM\

2. READ latest session log:
   Filesystem:read_file → C:\Users\wompu\Box\PRISM\SESSION_LOGS\[latest]

3. CHECK _REGISTRY for status:
   Filesystem:read_file → C:\Users\wompu\Box\PRISM\_REGISTRY\MASTER_INVENTORY.json
...
║   ALWAYS save directly to: C:\Users\wompu\Box\PRISM\                            ║
║                                                                                          ║
║   This ensures:                                                                          ║
