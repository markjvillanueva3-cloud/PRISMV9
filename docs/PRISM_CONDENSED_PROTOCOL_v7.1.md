...
| Location | Path | Use |
|----------|------|-----|
| **State** | `C:\PRISM...\CURRENT_STATE.json` | Session state |
| **Extracted** | `C:\PRISM...\EXTRACTED\` | Modules |
| **Logs** | `C:\PRISM...\SESSION_LOGS\` | Session logs |
| **Skills** | `/mnt/skills/user/prism-*/SKILL.md` | Read-only guidance |
| **Resources** | `C:\...\Box\PRISM\RESOURCES\` | Reference files |
...
// List extracted
Filesystem:list_directory("C:\\PRISM\\EXTRACTED\\")
