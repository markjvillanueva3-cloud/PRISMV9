...
path: H:\prism\state\CURRENT_STATE.json
```
...
```
ROOT:        H:\prism\
STATE:       H:\prism\state\CURRENT_STATE.json
FORMULAS:    H:\prism\data\FORMULA_REGISTRY.json
COEFF:       H:\prism\data\COEFFICIENT_DATABASE.json
RESOURCES:   H:\prism\data\coordination\RESOURCE_REGISTRY.json
SCRIPTS:     H:\prism\scripts\
SKILLS:      H:\prism\skills\
DATA:        H:\prism\data\
MATERIALS:   H:\prism\data\materials\
MACHINES:    H:\prism\data\machines\
TOOLS:       H:\prism\data\tools\
```
...
py -3 H:\prism\scripts\prism_unified_system_v6.py --optimal "Task"

# Intelligent swarm (64 agents)
py -3 H:\prism\scripts\prism_unified_system_v6.py --intelligent "Task"

# Manufacturing analysis (8 experts)
py -3 H:\prism\scripts\prism_orchestrator_v2.py --manufacturing "Material" "Op"

# Ralph loop (iterate until perfect)
py -3 H:\prism\scripts\prism_unified_system_v6.py --ralph agent "Prompt" 10

# List all agents
py -3 H:\prism\scripts\prism_unified_system_v6.py --list
```
