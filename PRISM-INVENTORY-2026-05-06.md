...
**Updated:** 2026-05-06T23:56:59.846Z
...
|----------|-------|--------|
| **Engines** | 3134 | live: `src/engines/*.ts` |
| **Dispatchers** | 96 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 7252 | live: `z.enum` count across dispatchers |
| **Algorithms** | 53 | live: `src/algorithms/*.ts` |
| **Registries** | 26 | live: `src/registries/*.ts` |
| **Tests** | 3295 | live: `src/__tests__/**/*.test.ts` |
