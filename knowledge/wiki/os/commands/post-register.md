...
source: .claude/commands/post-register.md
description: "Register and configure post-processors in PRISM for machine compatibility."
---
...
See `.claude/commands/post-register.md` for the live executable surface.
