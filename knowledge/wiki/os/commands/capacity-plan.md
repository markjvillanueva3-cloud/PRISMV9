...
source: .claude/commands/capacity-plan.md
description: "Plan shop capacity with variability-aware cycle time estimates."
---
...
See `.claude/commands/capacity-plan.md` for the live executable surface.
