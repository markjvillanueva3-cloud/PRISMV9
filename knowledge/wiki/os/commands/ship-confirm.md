...
source: .claude/commands/ship-confirm.md
description: "Confirm shipment readiness and generate shipping documentation."
---
...
See `.claude/commands/ship-confirm.md` for the live executable surface.
