...
source: .claude/commands/pre-review.md
description: "Manual invocation of the **pre-Claude review pattern** (sibling of automatic"
---
...
See `.claude/commands/pre-review.md` for the live executable surface.
