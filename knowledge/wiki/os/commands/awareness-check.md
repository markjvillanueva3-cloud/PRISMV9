...
source: .claude/commands/awareness-check.md
description: "Check and report the current awareness score and identify coverage gaps."
---
...
See `.claude/commands/awareness-check.md` for the live executable surface.
