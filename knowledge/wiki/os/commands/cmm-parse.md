...
source: .claude/commands/cmm-parse.md
description: "Parse and analyze CMM measurement reports for quality insights."
---
...
See `.claude/commands/cmm-parse.md` for the live executable surface.
