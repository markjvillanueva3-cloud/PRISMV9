...
source: .claude/commands/formula-check.md
description: "Envelope:** `MILL-MASTER` v4.0.0"
---

# /formula-check

Envelope:** `MILL-MASTER` v4.0.0

## Source command

See `.claude/commands/formula-check.md` for the live executable surface.
