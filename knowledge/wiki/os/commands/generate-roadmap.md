...
source: .claude/commands/generate-roadmap.md
description: "Generate a fully-detailed RGS-format roadmap from a brief."
---
...
See `.claude/commands/generate-roadmap.md` for the live executable surface.
