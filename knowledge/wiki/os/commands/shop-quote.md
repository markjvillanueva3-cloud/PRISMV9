...
source: .claude/commands/shop-quote.md
description: "Generate rapid quotes for shop floor requests with variability-aware time estimates."
---
...
See `.claude/commands/shop-quote.md` for the live executable surface.
