...
description: "Route learning requests to the appropriate specialized learning skill based on source type."
---
...
See `.claude/commands/learn.md` for the live executable surface.
