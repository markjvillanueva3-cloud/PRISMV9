...
source: .claude/commands/cad-review.md
description: "Review CAD model for manufacturability, quality issues, and design best practices."
---
...
See `.claude/commands/cad-review.md` for the live executable surface.
