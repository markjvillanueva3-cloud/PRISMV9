...
source: .claude/commands/cad-corpus.md
description: "Manage the JM Die CAD training corpus for neural CAD generation."
---
...
See `.claude/commands/cad-corpus.md` for the live executable surface.
