...
source: .claude/commands/schedule.md
description: "Schedule manufacturing jobs with capacity planning, due date optimization, and resource allocation."
---
...
See `.claude/commands/schedule.md` for the live executable surface.
