...
source: .claude/commands/post-generate.md
description: "Generate production-ready NC code with adaptive parameter injection."
---
...
See `.claude/commands/post-generate.md` for the live executable surface.
