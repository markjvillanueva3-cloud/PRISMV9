...
source: .claude/commands/quote.md
description: "Generate quotes for manufacturing jobs with accurate cost estimation, cycle time prediction, and competitive pricing."
---
...
See `.claude/commands/quote.md` for the live executable surface.
