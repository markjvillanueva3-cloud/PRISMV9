...
source: .claude/commands/sync-terminals.md
description: "Synchronize awareness and state across multiple Claude Code terminal sessions."
---
...
See `.claude/commands/sync-terminals.md` for the live executable surface.
