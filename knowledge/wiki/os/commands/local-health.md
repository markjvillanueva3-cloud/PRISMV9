...
source: .claude/commands/local-health.md
description: "Check Ollama/Docker stack health and token savings potential"
---
...
See `.claude/commands/local-health.md` for the live executable surface.
