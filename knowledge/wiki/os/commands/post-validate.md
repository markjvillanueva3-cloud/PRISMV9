...
source: .claude/commands/post-validate.md
description: "Validate G-code output against machine capabilities and safety requirements."
---
...
See `.claude/commands/post-validate.md` for the live executable surface.
