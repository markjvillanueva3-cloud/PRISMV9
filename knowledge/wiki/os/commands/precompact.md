...
source: .claude/commands/precompact.md
description: "Writes a structured handoff through psk's `handoff` syscall so the post-`/compact`"
---
...
See `.claude/commands/precompact.md` for the live executable surface.
