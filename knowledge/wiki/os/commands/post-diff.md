...
source: .claude/commands/post-diff.md
description: "Compare NC code from different posts or versions for validation."
---
...
See `.claude/commands/post-diff.md` for the live executable surface.
