...
source: .claude/commands/brain-recall.md
description: "Query the unified Obsidian-vault + system-graph + wiki BM25 brain"
---
...
See `.claude/commands/brain-recall.md` for the live executable surface.
