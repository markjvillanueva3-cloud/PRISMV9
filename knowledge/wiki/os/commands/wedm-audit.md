...
source: .claude/commands/wedm-audit.md
description: "Audit WEDM asset counts and dispatcher wiring status"
---
...
See `.claude/commands/wedm-audit.md` for the live executable surface.
