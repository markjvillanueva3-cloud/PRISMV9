...
source: .claude/commands/model-status.md
description: "Report health of the local LLM stack: Ollama daemon reachability, installed models, warm-up state, active LoRA adapters, and cloud fallback availability."
---
...
See `.claude/commands/model-status.md` for the live executable surface.
