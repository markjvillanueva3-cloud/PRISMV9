...
source: .claude/commands/job-cost.md
description: "Estimate complete job costs using PRISM's JobCostingEngine with shop-configured rates."
---
...
See `.claude/commands/job-cost.md` for the live executable surface.
