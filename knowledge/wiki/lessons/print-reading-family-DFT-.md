---
title: Print-reading lesson — family-DFT-
slug: print-reading-family-DFT-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-DFT- corpus

Generated from the corpus-wide scan (U2 output, 172 prints).
...
The family-DFT- cluster contains 172 prints whose extraction floor distribution is:

- `low_no_vision`: 172 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-DFT-.jsonl` — raw rows
