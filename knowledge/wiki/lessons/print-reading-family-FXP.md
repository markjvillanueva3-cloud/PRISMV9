---
title: Print-reading lesson — family-FXP
slug: print-reading-family-FXP
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-FXP corpus
...
The family-FXP cluster contains 22 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-FXP.jsonl` — raw rows
