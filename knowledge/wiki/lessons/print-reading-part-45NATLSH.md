---
title: Print-reading lesson — part-45NATLSH
slug: print-reading-part-45NATLSH
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-45NATLSH corpus
...
The part-45NATLSH cluster contains 38 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/part-45NATLSH.jsonl` — raw rows
