---
title: Print-reading lesson — part-654820-4
slug: print-reading-part-654820-4
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-654820-4 corpus

Generated from the corpus-wide scan (U2 output, 24 prints).
...
The part-654820-4 cluster contains 24 prints whose extraction floor distribution is:

- `low_no_vision`: 24 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-654820-4.jsonl` — raw rows
