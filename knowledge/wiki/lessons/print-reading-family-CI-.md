---
title: Print-reading lesson — family-CI-
slug: print-reading-family-CI-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-CI- corpus
...
The family-CI- cluster contains 62 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-CI-.jsonl` — raw rows
