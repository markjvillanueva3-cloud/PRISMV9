---
title: Print-reading lesson — family-UP-
slug: print-reading-family-UP-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-UP- corpus

Generated from the corpus-wide scan (U2 output, 98 prints).
...
The family-UP- cluster contains 98 prints whose extraction floor distribution is:

- `low_no_vision`: 98 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-UP-.jsonl` — raw rows
