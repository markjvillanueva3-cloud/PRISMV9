---
title: Print-reading lesson — family-RC
slug: print-reading-family-RC
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-RC corpus

Generated from the corpus-wide scan (U2 output, 60 prints).
...
The family-RC cluster contains 60 prints whose extraction floor distribution is:

- `low_no_vision`: 60 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-RC.jsonl` — raw rows
