---
title: Print-reading lesson — part-3605
slug: print-reading-part-3605
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-3605 corpus
...
The part-3605 cluster contains 32 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/part-3605.jsonl` — raw rows
