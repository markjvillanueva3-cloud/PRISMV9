---
title: Print-reading lesson — part-3174__fr
slug: print-reading-part-3174__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-3174__fr corpus

Generated from the corpus-wide scan (U2 output, 247 prints).
...
The part-3174__fr cluster contains 247 prints whose extraction floor distribution is:

- `low_no_vision`: 247 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-3174__fr.jsonl` — raw rows
