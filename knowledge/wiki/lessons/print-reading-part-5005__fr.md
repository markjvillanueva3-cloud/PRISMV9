---
title: Print-reading lesson — part-5005__fr
slug: print-reading-part-5005__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-5005__fr corpus

Generated from the corpus-wide scan (U2 output, 222 prints).
...
The part-5005__fr cluster contains 222 prints whose extraction floor distribution is:

- `low_no_vision`: 222 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-5005__fr.jsonl` — raw rows
