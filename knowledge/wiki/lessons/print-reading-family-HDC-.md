---
title: Print-reading lesson — family-HDC-
slug: print-reading-family-HDC-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-HDC- corpus
...
The family-HDC- cluster contains 24 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-HDC-.jsonl` — raw rows
