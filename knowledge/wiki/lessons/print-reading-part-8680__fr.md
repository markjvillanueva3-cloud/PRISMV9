---
title: Print-reading lesson — part-8680__fr
slug: print-reading-part-8680__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-8680__fr corpus
...
The part-8680__fr cluster contains 34 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/part-8680__fr.jsonl` — raw rows
