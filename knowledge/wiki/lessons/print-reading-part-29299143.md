---
title: Print-reading lesson — part-29299143
slug: print-reading-part-29299143
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-29299143 corpus

Generated from the corpus-wide scan (U2 output, 27 prints).
...
The part-29299143 cluster contains 27 prints whose extraction floor distribution is:

- `low_no_vision`: 27 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-29299143.jsonl` — raw rows
