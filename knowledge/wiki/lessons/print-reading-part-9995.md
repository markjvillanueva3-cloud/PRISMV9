---
title: Print-reading lesson — part-9995
slug: print-reading-part-9995
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-9995 corpus
...
The part-9995 cluster contains 24 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/part-9995.jsonl` — raw rows
