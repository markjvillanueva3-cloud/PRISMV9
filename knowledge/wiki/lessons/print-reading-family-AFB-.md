---
title: Print-reading lesson — family-AFB-
slug: print-reading-family-AFB-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-AFB- corpus

Generated from the corpus-wide scan (U2 output, 80 prints).
...
The family-AFB- cluster contains 80 prints whose extraction floor distribution is:

- `low_no_vision`: 80 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-AFB-.jsonl` — raw rows
