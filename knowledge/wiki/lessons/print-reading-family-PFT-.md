---
title: Print-reading lesson — family-PFT-
slug: print-reading-family-PFT-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-PFT- corpus

Generated from the corpus-wide scan (U2 output, 56 prints).
...
The family-PFT- cluster contains 56 prints whose extraction floor distribution is:

- `low_no_vision`: 56 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-PFT-.jsonl` — raw rows
