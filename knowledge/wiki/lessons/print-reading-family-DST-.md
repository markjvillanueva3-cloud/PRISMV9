---
title: Print-reading lesson — family-DST-
slug: print-reading-family-DST-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-DST- corpus

Generated from the corpus-wide scan (U2 output, 124 prints).
...
The family-DST- cluster contains 124 prints whose extraction floor distribution is:

- `low_no_vision`: 124 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-DST-.jsonl` — raw rows
