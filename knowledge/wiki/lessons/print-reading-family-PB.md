---
title: Print-reading lesson — family-PB
slug: print-reading-family-PB
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-PB corpus
...
The family-PB cluster contains 26 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-PB.jsonl` — raw rows
