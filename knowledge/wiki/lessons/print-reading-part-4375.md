---
title: Print-reading lesson — part-4375
slug: print-reading-part-4375
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-4375 corpus

Generated from the corpus-wide scan (U2 output, 58 prints).
...
The part-4375 cluster contains 58 prints whose extraction floor distribution is:

- `low_no_vision`: 58 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-4375.jsonl` — raw rows
