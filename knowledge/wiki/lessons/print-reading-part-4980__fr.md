---
title: Print-reading lesson — part-4980__fr
slug: print-reading-part-4980__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-4980__fr corpus

Generated from the corpus-wide scan (U2 output, 104 prints).
...
The part-4980__fr cluster contains 104 prints whose extraction floor distribution is:

- `low_no_vision`: 104 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-4980__fr.jsonl` — raw rows
