---
title: Print-reading lesson — family-ABB-
slug: print-reading-family-ABB-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-ABB- corpus
...
The family-ABB- cluster contains 22 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-ABB-.jsonl` — raw rows
