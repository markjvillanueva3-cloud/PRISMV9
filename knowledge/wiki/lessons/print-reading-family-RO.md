---
title: Print-reading lesson — family-RO
slug: print-reading-family-RO
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-RO corpus
...
The family-RO cluster contains 30 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-RO.jsonl` — raw rows
