---
title: Print-reading lesson — family-P-
slug: print-reading-family-P-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-P- corpus

Generated from the corpus-wide scan (U2 output, 112 prints).
...
The family-P- cluster contains 112 prints whose extraction floor distribution is:

- `low_no_vision`: 112 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-P-.jsonl` — raw rows
