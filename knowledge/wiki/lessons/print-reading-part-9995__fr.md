---
title: Print-reading lesson — part-9995__fr
slug: print-reading-part-9995__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-9995__fr corpus

Generated from the corpus-wide scan (U2 output, 276 prints).
...
The part-9995__fr cluster contains 276 prints whose extraction floor distribution is:

- `low_no_vision`: 276 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-9995__fr.jsonl` — raw rows
