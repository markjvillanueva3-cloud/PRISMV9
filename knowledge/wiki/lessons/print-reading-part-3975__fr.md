---
title: Print-reading lesson — part-3975__fr
slug: print-reading-part-3975__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-3975__fr corpus
...
The part-3975__fr cluster contains 28 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/part-3975__fr.jsonl` — raw rows
