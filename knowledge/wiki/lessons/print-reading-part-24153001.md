---
title: Print-reading lesson — part-24153001
slug: print-reading-part-24153001
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-24153001 corpus

Generated from the corpus-wide scan (U2 output, 35 prints).
...
The part-24153001 cluster contains 35 prints whose extraction floor distribution is:

- `low_no_vision`: 35 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-24153001.jsonl` — raw rows
