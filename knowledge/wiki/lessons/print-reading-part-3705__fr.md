---
title: Print-reading lesson — part-3705__fr
slug: print-reading-part-3705__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-3705__fr corpus

Generated from the corpus-wide scan (U2 output, 36 prints).
...
The part-3705__fr cluster contains 36 prints whose extraction floor distribution is:

- `low_no_vision`: 36 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-3705__fr.jsonl` — raw rows
