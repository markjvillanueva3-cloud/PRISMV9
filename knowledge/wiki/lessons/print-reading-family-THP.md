---
title: Print-reading lesson — family-THP
slug: print-reading-family-THP
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-THP corpus

Generated from the corpus-wide scan (U2 output, 388 prints).
...
The family-THP cluster contains 388 prints whose extraction floor distribution is:

- `low_no_vision`: 388 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-THP.jsonl` — raw rows
