---
title: Print-reading lesson — family-DPT-
slug: print-reading-family-DPT-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-DPT- corpus

Generated from the corpus-wide scan (U2 output, 204 prints).
...
The family-DPT- cluster contains 204 prints whose extraction floor distribution is:

- `low_no_vision`: 204 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-DPT-.jsonl` — raw rows
