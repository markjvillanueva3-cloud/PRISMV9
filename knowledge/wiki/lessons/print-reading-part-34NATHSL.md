---
title: Print-reading lesson — part-34NATHSL
slug: print-reading-part-34NATHSL
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-34NATHSL corpus
...
The part-34NATHSL cluster contains 34 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/part-34NATHSL.jsonl` — raw rows
