---
title: Print-reading lesson — family-ST-
slug: print-reading-family-ST-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-ST- corpus

Generated from the corpus-wide scan (U2 output, 74 prints).
...
The family-ST- cluster contains 74 prints whose extraction floor distribution is:

- `low_no_vision`: 74 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-ST-.jsonl` — raw rows
