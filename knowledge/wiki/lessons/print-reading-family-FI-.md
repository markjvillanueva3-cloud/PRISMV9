---
title: Print-reading lesson — family-FI-
slug: print-reading-family-FI-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-FI- corpus

Generated from the corpus-wide scan (U2 output, 40 prints).
...
The family-FI- cluster contains 40 prints whose extraction floor distribution is:

- `low_no_vision`: 40 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-FI-.jsonl` — raw rows
