---
title: Print-reading lesson — family-D-
slug: print-reading-family-D-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-D- corpus

Generated from the corpus-wide scan (U2 output, 188 prints).
...
The family-D- cluster contains 188 prints whose extraction floor distribution is:

- `low_no_vision`: 188 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-D-.jsonl` — raw rows
