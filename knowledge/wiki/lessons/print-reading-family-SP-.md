---
title: Print-reading lesson — family-SP-
slug: print-reading-family-SP-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-SP- corpus

Generated from the corpus-wide scan (U2 output, 122 prints).
...
The family-SP- cluster contains 122 prints whose extraction floor distribution is:

- `low_no_vision`: 122 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-SP-.jsonl` — raw rows
