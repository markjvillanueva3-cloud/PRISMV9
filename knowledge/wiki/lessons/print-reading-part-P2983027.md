---
title: Print-reading lesson — part-P2983027
slug: print-reading-part-P2983027
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-P2983027 corpus

Generated from the corpus-wide scan (U2 output, 30 prints).
...
The part-P2983027 cluster contains 30 prints whose extraction floor distribution is:

- `low_no_vision`: 30 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-P2983027.jsonl` — raw rows
