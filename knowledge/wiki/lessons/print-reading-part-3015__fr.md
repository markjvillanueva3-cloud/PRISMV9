---
title: Print-reading lesson — part-3015__fr
slug: print-reading-part-3015__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-3015__fr corpus

Generated from the corpus-wide scan (U2 output, 23 prints).
...
The part-3015__fr cluster contains 23 prints whose extraction floor distribution is:

- `low_no_vision`: 23 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-3015__fr.jsonl` — raw rows
