---
title: Print-reading lesson — family-MTP-
slug: print-reading-family-MTP-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-MTP- corpus
...
The family-MTP- cluster contains 24 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-MTP-.jsonl` — raw rows
