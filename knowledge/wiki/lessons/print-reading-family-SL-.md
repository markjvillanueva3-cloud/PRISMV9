---
title: Print-reading lesson — family-SL-
slug: print-reading-family-SL-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-SL- corpus

Generated from the corpus-wide scan (U2 output, 32 prints).
...
The family-SL- cluster contains 32 prints whose extraction floor distribution is:

- `low_no_vision`: 32 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-SL-.jsonl` — raw rows
