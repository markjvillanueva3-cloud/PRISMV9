---
title: Print-reading lesson — part-9091799_
slug: print-reading-part-9091799_
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-9091799_ corpus

Generated from the corpus-wide scan (U2 output, 52 prints).
...
The part-9091799_ cluster contains 52 prints whose extraction floor distribution is:

- `low_no_vision`: 52 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-9091799_.jsonl` — raw rows
