---
title: Print-reading lesson — long-tail-small-families
slug: print-reading-long-tail-small-families
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the long-tail-small-families corpus

Generated from the corpus-wide scan (U2 output, 34596 prints).
...
> This lesson aggregates 11433 small part-families (each < 20 prints). Families large enough to warrant their own lesson are emitted separately.

## What the corpus tells us

The long-tail-small-families cluster contains 34596 prints whose extraction floor distribution is:

- `low_no_vision`: 34596 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/long-tail-small-families.jsonl` — raw rows
