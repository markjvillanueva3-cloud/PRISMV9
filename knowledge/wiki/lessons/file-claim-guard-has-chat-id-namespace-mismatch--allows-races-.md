---
title: "file-claim-guard has chat-ID namespace mismatch (allows races)"
name: file-claim-guard-has-chat-id-namespace-mismatch--allows-races-
kind: reference
status: promoted
category: lessons
domain: knowledge-vault
promoted_from: knowledge/memories/feedback/feedback_file_claim_namespace_bug.md
promoted_at: 2026-06-06T04:55:46.793Z
source_refs: 3
---

# file-claim-guard has chat-ID namespace mismatch (allows races)
...
Promoted from memory [[feedback_file_claim_namespace_bug]] (referenced 3x across the vault). The memory remains the editable source of truth.
