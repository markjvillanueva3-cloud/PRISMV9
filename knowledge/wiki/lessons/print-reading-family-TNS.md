---
title: Print-reading lesson — family-TNS
slug: print-reading-family-TNS
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-TNS corpus
...
The family-TNS cluster contains 26 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-TNS.jsonl` — raw rows
