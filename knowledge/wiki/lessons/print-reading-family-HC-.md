---
title: Print-reading lesson — family-HC-
slug: print-reading-family-HC-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-HC- corpus
...
The family-HC- cluster contains 36 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-HC-.jsonl` — raw rows
