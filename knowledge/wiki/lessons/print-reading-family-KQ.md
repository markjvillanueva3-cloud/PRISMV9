---
title: Print-reading lesson — family-KQ
slug: print-reading-family-KQ
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-KQ corpus
...
The family-KQ cluster contains 22 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-KQ.jsonl` — raw rows
