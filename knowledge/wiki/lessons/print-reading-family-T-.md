---
title: Print-reading lesson — family-T-
slug: print-reading-family-T-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-T- corpus

Generated from the corpus-wide scan (U2 output, 178 prints).
...
The family-T- cluster contains 178 prints whose extraction floor distribution is:

- `low_no_vision`: 178 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-T-.jsonl` — raw rows
