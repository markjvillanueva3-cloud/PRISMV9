---
title: Print-reading lesson — part-A225108H
slug: print-reading-part-A225108H
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-A225108H corpus

Generated from the corpus-wide scan (U2 output, 86 prints).
...
The part-A225108H cluster contains 86 prints whose extraction floor distribution is:

- `low_no_vision`: 86 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-A225108H.jsonl` — raw rows
