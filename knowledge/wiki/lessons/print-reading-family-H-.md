---
title: Print-reading lesson — family-H-
slug: print-reading-family-H-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-H- corpus

Generated from the corpus-wide scan (U2 output, 76 prints).
...
The family-H- cluster contains 76 prints whose extraction floor distribution is:

- `low_no_vision`: 76 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-H-.jsonl` — raw rows
