---
title: Print-reading lesson — part-8745__fr
slug: print-reading-part-8745__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-8745__fr corpus

Generated from the corpus-wide scan (U2 output, 170 prints).
...
The part-8745__fr cluster contains 170 prints whose extraction floor distribution is:

- `low_no_vision`: 170 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-8745__fr.jsonl` — raw rows
