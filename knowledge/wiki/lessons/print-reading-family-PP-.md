---
title: Print-reading lesson — family-PP-
slug: print-reading-family-PP-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-PP- corpus
...
The family-PP- cluster contains 20 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-PP-.jsonl` — raw rows
