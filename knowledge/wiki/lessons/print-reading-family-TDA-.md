---
title: Print-reading lesson — family-TDA-
slug: print-reading-family-TDA-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-TDA- corpus
...
The family-TDA- cluster contains 24 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-TDA-.jsonl` — raw rows
