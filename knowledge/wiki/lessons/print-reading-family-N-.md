---
title: Print-reading lesson — family-N-
slug: print-reading-family-N-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-N- corpus
...
The family-N- cluster contains 38 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-N-.jsonl` — raw rows
