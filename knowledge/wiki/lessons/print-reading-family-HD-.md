---
title: Print-reading lesson — family-HD-
slug: print-reading-family-HD-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-HD- corpus

Generated from the corpus-wide scan (U2 output, 42 prints).
...
The family-HD- cluster contains 42 prints whose extraction floor distribution is:

- `low_no_vision`: 42 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-HD-.jsonl` — raw rows
