---
title: Print-reading lesson — family-NS
slug: print-reading-family-NS
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-NS corpus

Generated from the corpus-wide scan (U2 output, 136 prints).
...
The family-NS cluster contains 136 prints whose extraction floor distribution is:

- `low_no_vision`: 136 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-NS.jsonl` — raw rows
