---
title: Print-reading lesson — family-R-
slug: print-reading-family-R-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-R- corpus
...
The family-R- cluster contains 48 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-R-.jsonl` — raw rows
