---
title: Print-reading lesson — part-25HDR-75
slug: print-reading-part-25HDR-75
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-25HDR-75 corpus

Generated from the corpus-wide scan (U2 output, 25 prints).
...
The part-25HDR-75 cluster contains 25 prints whose extraction floor distribution is:

- `low_no_vision`: 25 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-25HDR-75.jsonl` — raw rows
