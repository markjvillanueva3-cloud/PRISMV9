---
title: Print-reading lesson — family-HF-
slug: print-reading-family-HF-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-HF- corpus

Generated from the corpus-wide scan (U2 output, 72 prints).
...
The family-HF- cluster contains 72 prints whose extraction floor distribution is:

- `low_no_vision`: 72 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-HF-.jsonl` — raw rows
