---
title: Print-reading lesson — part-50000
slug: print-reading-part-50000
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-50000 corpus

Generated from the corpus-wide scan (U2 output, 90 prints).
...
The part-50000 cluster contains 90 prints whose extraction floor distribution is:

- `low_no_vision`: 90 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-50000.jsonl` — raw rows
