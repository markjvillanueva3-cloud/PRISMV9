---
title: Print-reading lesson — family-PXL-
slug: print-reading-family-PXL-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-PXL- corpus
...
The family-PXL- cluster contains 26 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-PXL-.jsonl` — raw rows
