---
title: Print-reading lesson — family-NC-
slug: print-reading-family-NC-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-NC- corpus
...
The family-NC- cluster contains 26 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-NC-.jsonl` — raw rows
