---
title: Print-reading lesson — part-2255__fr
slug: print-reading-part-2255__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-2255__fr corpus

Generated from the corpus-wide scan (U2 output, 66 prints).
...
The part-2255__fr cluster contains 66 prints whose extraction floor distribution is:

- `low_no_vision`: 66 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-2255__fr.jsonl` — raw rows
