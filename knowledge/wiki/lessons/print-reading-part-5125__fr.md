---
title: Print-reading lesson — part-5125__fr
slug: print-reading-part-5125__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-5125__fr corpus

Generated from the corpus-wide scan (U2 output, 84 prints).
...
The part-5125__fr cluster contains 84 prints whose extraction floor distribution is:

- `low_no_vision`: 84 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-5125__fr.jsonl` — raw rows
