---
title: Print-reading lesson — part-3024__fr
slug: print-reading-part-3024__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-3024__fr corpus

Generated from the corpus-wide scan (U2 output, 29 prints).
...
The part-3024__fr cluster contains 29 prints whose extraction floor distribution is:

- `low_no_vision`: 29 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-3024__fr.jsonl` — raw rows
