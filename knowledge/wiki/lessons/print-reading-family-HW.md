---
title: Print-reading lesson — family-HW
slug: print-reading-family-HW
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-HW corpus
...
The family-HW cluster contains 26 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-HW.jsonl` — raw rows
