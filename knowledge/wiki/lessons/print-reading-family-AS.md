---
title: Print-reading lesson — family-AS
slug: print-reading-family-AS
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-AS corpus
...
The family-AS cluster contains 56 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-AS.jsonl` — raw rows
