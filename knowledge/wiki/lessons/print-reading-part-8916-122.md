---
title: Print-reading lesson — part-8916-122
slug: print-reading-part-8916-122
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-8916-122 corpus

Generated from the corpus-wide scan (U2 output, 20 prints).
...
The part-8916-122 cluster contains 20 prints whose extraction floor distribution is:

- `low_no_vision`: 20 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-8916-122.jsonl` — raw rows
