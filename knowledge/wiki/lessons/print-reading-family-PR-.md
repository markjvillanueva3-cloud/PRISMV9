---
title: Print-reading lesson — family-PR-
slug: print-reading-family-PR-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-PR- corpus
...
The family-PR- cluster contains 104 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-PR-.jsonl` — raw rows
