---
title: Print-reading lesson — part-6000__fr
slug: print-reading-part-6000__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-6000__fr corpus

Generated from the corpus-wide scan (U2 output, 174 prints).
...
The part-6000__fr cluster contains 174 prints whose extraction floor distribution is:

- `low_no_vision`: 174 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-6000__fr.jsonl` — raw rows
