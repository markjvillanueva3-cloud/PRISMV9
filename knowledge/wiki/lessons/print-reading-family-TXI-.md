---
title: Print-reading lesson — family-TXI-
slug: print-reading-family-TXI-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-TXI- corpus
...
The family-TXI- cluster contains 30 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-TXI-.jsonl` — raw rows
