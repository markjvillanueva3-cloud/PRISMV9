---
title: Print-reading lesson — part-5700__fr
slug: print-reading-part-5700__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-5700__fr corpus

Generated from the corpus-wide scan (U2 output, 88 prints).
...
The part-5700__fr cluster contains 88 prints whose extraction floor distribution is:

- `low_no_vision`: 88 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-5700__fr.jsonl` — raw rows
