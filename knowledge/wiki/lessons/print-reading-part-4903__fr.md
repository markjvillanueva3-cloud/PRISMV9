---
title: Print-reading lesson — part-4903__fr
slug: print-reading-part-4903__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-4903__fr corpus

Generated from the corpus-wide scan (U2 output, 28 prints).
...
The part-4903__fr cluster contains 28 prints whose extraction floor distribution is:

- `low_no_vision`: 28 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-4903__fr.jsonl` — raw rows
