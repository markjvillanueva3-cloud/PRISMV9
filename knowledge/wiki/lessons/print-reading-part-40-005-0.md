---
title: Print-reading lesson — part-40-005-0
slug: print-reading-part-40-005-0
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-40-005-0 corpus

Generated from the corpus-wide scan (U2 output, 34 prints).
...
The part-40-005-0 cluster contains 34 prints whose extraction floor distribution is:

- `low_no_vision`: 34 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-40-005-0.jsonl` — raw rows
