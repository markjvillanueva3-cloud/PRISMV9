---
title: Print-reading lesson — family-TB-
slug: print-reading-family-TB-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-TB- corpus
...
The family-TB- cluster contains 104 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-TB-.jsonl` — raw rows
