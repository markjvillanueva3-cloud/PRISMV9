---
title: Print-reading lesson — part-4995__fr
slug: print-reading-part-4995__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-4995__fr corpus

Generated from the corpus-wide scan (U2 output, 110 prints).
...
The part-4995__fr cluster contains 110 prints whose extraction floor distribution is:

- `low_no_vision`: 110 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-4995__fr.jsonl` — raw rows
