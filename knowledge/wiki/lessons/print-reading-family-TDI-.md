---
title: Print-reading lesson — family-TDI-
slug: print-reading-family-TDI-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-TDI- corpus
...
The family-TDI- cluster contains 22 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-TDI-.jsonl` — raw rows
