---
title: Print-reading lesson — family-TCI
slug: print-reading-family-TCI
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-TCI corpus
...
The family-TCI cluster contains 36 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-TCI.jsonl` — raw rows
