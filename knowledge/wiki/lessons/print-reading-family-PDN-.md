---
title: Print-reading lesson — family-PDN-
slug: print-reading-family-PDN-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-PDN- corpus
...
The family-PDN- cluster contains 24 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-PDN-.jsonl` — raw rows
