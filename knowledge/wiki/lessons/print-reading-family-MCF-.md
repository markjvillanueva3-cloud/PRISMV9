---
title: Print-reading lesson — family-MCF-
slug: print-reading-family-MCF-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-MCF- corpus

Generated from the corpus-wide scan (U2 output, 164 prints).
...
The family-MCF- cluster contains 164 prints whose extraction floor distribution is:

- `low_no_vision`: 164 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-MCF-.jsonl` — raw rows
