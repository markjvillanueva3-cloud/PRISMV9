---
title: Print-reading lesson — part-4005__fr
slug: print-reading-part-4005__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-4005__fr corpus

Generated from the corpus-wide scan (U2 output, 50 prints).
...
The part-4005__fr cluster contains 50 prints whose extraction floor distribution is:

- `low_no_vision`: 50 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-4005__fr.jsonl` — raw rows
