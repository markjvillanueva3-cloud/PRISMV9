---
title: Print-reading lesson — part-532-2041
slug: print-reading-part-532-2041
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-532-2041 corpus

Generated from the corpus-wide scan (U2 output, 46 prints).
...
The part-532-2041 cluster contains 46 prints whose extraction floor distribution is:

- `low_no_vision`: 46 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-532-2041.jsonl` — raw rows
