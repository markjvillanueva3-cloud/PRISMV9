---
title: Print-reading lesson — family-C-
slug: print-reading-family-C-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-C- corpus

Generated from the corpus-wide scan (U2 output, 54 prints).
...
The family-C- cluster contains 54 prints whose extraction floor distribution is:

- `low_no_vision`: 54 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-C-.jsonl` — raw rows
