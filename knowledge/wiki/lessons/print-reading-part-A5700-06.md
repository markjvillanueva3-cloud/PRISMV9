---
title: Print-reading lesson — part-A5700-06
slug: print-reading-part-A5700-06
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-A5700-06 corpus

Generated from the corpus-wide scan (U2 output, 62 prints).
...
The part-A5700-06 cluster contains 62 prints whose extraction floor distribution is:

- `low_no_vision`: 62 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-A5700-06.jsonl` — raw rows
