---
title: Print-reading lesson — part-4925__fr
slug: print-reading-part-4925__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-4925__fr corpus

Generated from the corpus-wide scan (U2 output, 38 prints).
...
The part-4925__fr cluster contains 38 prints whose extraction floor distribution is:

- `low_no_vision`: 38 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-4925__fr.jsonl` — raw rows
