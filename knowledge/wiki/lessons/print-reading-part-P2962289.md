---
title: Print-reading lesson — part-P2962289
slug: print-reading-part-P2962289
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-P2962289 corpus

Generated from the corpus-wide scan (U2 output, 26 prints).
...
The part-P2962289 cluster contains 26 prints whose extraction floor distribution is:

- `low_no_vision`: 26 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-P2962289.jsonl` — raw rows
