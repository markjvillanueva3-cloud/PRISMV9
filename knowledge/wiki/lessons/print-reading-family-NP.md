---
title: Print-reading lesson — family-NP
slug: print-reading-family-NP
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-NP corpus
...
The family-NP cluster contains 28 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-NP.jsonl` — raw rows
