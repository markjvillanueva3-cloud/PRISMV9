---
title: Print-reading lesson — family-PF
slug: print-reading-family-PF
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-PF corpus
...
The family-PF cluster contains 36 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-PF.jsonl` — raw rows
