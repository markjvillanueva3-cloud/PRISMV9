---
title: Print-reading lesson — family-SDO-
slug: print-reading-family-SDO-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-SDO- corpus
...
The family-SDO- cluster contains 28 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-SDO-.jsonl` — raw rows
