---
title: Print-reading lesson — part-4370__fr
slug: print-reading-part-4370__fr
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-4370__fr corpus

Generated from the corpus-wide scan (U2 output, 48 prints).
...
The part-4370__fr cluster contains 48 prints whose extraction floor distribution is:

- `low_no_vision`: 48 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-4370__fr.jsonl` — raw rows
