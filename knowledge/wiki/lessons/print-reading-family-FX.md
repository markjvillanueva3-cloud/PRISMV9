---
title: Print-reading lesson — family-FX
slug: print-reading-family-FX
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-FX corpus

Generated from the corpus-wide scan (U2 output, 102 prints).
...
The family-FX cluster contains 102 prints whose extraction floor distribution is:

- `low_no_vision`: 102 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-FX.jsonl` — raw rows
