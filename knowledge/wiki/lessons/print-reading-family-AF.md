---
title: Print-reading lesson — family-AF
slug: print-reading-family-AF
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-AF corpus

Generated from the corpus-wide scan (U2 output, 140 prints).
...
The family-AF cluster contains 140 prints whose extraction floor distribution is:

- `low_no_vision`: 140 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-AF.jsonl` — raw rows
