---
title: Print-reading lesson — part-9096162_
slug: print-reading-part-9096162_
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the part-9096162_ corpus

Generated from the corpus-wide scan (U2 output, 22 prints).
...
The part-9096162_ cluster contains 22 prints whose extraction floor distribution is:

- `low_no_vision`: 22 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/part-9096162_.jsonl` — raw rows
