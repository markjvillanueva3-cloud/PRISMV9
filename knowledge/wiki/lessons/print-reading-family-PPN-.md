---
title: Print-reading lesson — family-PPN-
slug: print-reading-family-PPN-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-PPN- corpus
...
The family-PPN- cluster contains 62 prints whose extraction floor distribution is:
...
- `state/shared/print-corpus-tables/by-customer/family-PPN-.jsonl` — raw rows
