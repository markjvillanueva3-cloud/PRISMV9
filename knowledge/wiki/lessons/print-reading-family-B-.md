---
title: Print-reading lesson — family-B-
slug: print-reading-family-B-
kind: lesson
status: shipped
date: 2026-05-21
...
# Print-reading patterns observed in the family-B- corpus

Generated from the corpus-wide scan (U2 output, 458 prints).
...
The family-B- cluster contains 458 prints whose extraction floor distribution is:

- `low_no_vision`: 458 (100.0%)
...
- `state/shared/print-corpus-tables/by-customer/family-B-.jsonl` — raw rows
