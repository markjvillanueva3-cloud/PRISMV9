---
title: "Local LLM routing — Ollama models loaded on this machine"
name: local-llm-routing---ollama-models-loaded-on-this-machine
kind: reference
status: promoted
category: reference
domain: knowledge-vault
promoted_from: knowledge/memories/reference/reference_local_llm_routing.md
promoted_at: 2026-06-06T04:55:54.744Z
source_refs: 4
---

# Local LLM routing — Ollama models loaded on this machine
...
Promoted from memory [[reference_local_llm_routing]] (referenced 4x across the vault). The memory remains the editable source of truth.
