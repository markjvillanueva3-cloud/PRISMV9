---
title: "reference-mcp-oom-heap-bump-2026-05-23"
name: reference-mcp-oom-heap-bump-2026-05-23
kind: reference
status: promoted
category: reference
domain: knowledge-vault
promoted_from: knowledge/memories/reference/reference_mcp_oom_heap_bump_2026_05_23.md
...
Promoted from memory [[reference_mcp_oom_heap_bump_2026_05_23]] (referenced 3x across the vault). The memory remains the editable source of truth.
