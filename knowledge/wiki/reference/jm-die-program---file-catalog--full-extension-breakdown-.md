---
title: "JM Die program & file catalog (full extension breakdown)"
name: jm-die-program---file-catalog--full-extension-breakdown-
kind: reference
status: promoted
category: reference
domain: knowledge-vault
promoted_from: knowledge/memories/reference/reference_jm_die_program_save_practice.md
promoted_at: 2026-06-06T04:55:53.676Z
source_refs: 3
---
...
Promoted from memory [[reference_jm_die_program_save_practice]] (referenced 3x across the vault). The memory remains the editable source of truth.
