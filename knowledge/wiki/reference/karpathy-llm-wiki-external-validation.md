---
title: "Karpathy LLM-Wiki external validation"
name: karpathy-llm-wiki-external-validation
kind: reference
status: promoted
category: reference
domain: knowledge-vault
promoted_from: knowledge/memories/reference/reference_karpathy_llm_wiki_external_validation.md
promoted_at: 2026-06-06T04:55:53.802Z
source_refs: 5
---

# Karpathy LLM-Wiki external validation
...
Promoted from memory [[reference_karpathy_llm_wiki_external_validation]] (referenced 5x across the vault). The memory remains the editable source of truth.
