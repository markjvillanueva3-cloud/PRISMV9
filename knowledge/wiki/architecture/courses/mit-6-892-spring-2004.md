---
title: MIT course — 6.892-spring-2004 (title pending — MIT 6.892-spring-2004)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:36.008Z
...
# MIT course — `6.892-spring-2004` (title pending — MIT 6.892-spring-2004) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `6.892-spring-2004` |
| Title | (title pending — MIT 6.892-spring-2004) |
| Department | EECS / Brain & Cognitive Sciences |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/6.892-spring-2004`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-6-892-spring-2004.md`.
