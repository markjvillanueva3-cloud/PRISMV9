---
title: MIT course — 9.40-spring-2018 (title pending — MIT 9.40-spring-2018)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.888Z
...
# MIT course — `9.40-spring-2018` (title pending — MIT 9.40-spring-2018) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `9.40-spring-2018` |
| Title | (title pending — MIT 9.40-spring-2018) |
| Department | Mathematics / EECS |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/9.40-spring-2018`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-9-40-spring-2018.md`.
