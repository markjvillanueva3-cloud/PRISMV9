---
title: MIT course — 15.980j-spring-2007 (title pending — MIT 15.980j-spring-2007)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.979Z
...
# MIT course — `15.980j-spring-2007` (title pending — MIT 15.980j-spring-2007) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `15.980j-spring-2007` |
| Title | (title pending — MIT 15.980j-spring-2007) |
| Department | MIT (subject varies) |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/15.980j-spring-2007`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-15-980j-spring-2007.md`.
