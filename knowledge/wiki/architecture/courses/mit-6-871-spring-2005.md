---
title: MIT course — 6.871-spring-2005 (title pending — MIT 6.871-spring-2005)
type: architecture
kind: course
course_kind: mit-ocw
course_code: "6.871-spring-2005"
department: EECS / Brain & Cognitive Sciences
generated_by: scripts/mit-course-catalog-bootstrap.mjs
generated_at: 2026-05-24T01:36:35.913Z
...
# MIT course — `6.871-spring-2005` (title pending — MIT 6.871-spring-2005) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `6.871-spring-2005` |
| Title | (title pending — MIT 6.871-spring-2005) |
| Department | EECS / Brain & Cognitive Sciences |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/6.871-spring-2005`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-6-871-spring-2005.md`.
