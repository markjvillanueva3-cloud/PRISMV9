---
title: MIT course — 2.003-spring-2005 (title pending — MIT 2.003-spring-2005)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.879Z
...
# MIT course — `2.003-spring-2005` (title pending — MIT 2.003-spring-2005) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `2.003-spring-2005` |
| Title | (title pending — MIT 2.003-spring-2005) |
| Department | Mechanical Engineering |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/2.003-spring-2005`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-2-003-spring-2005.md`.
