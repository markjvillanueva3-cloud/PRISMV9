---
title: MIT course — esd.60-summer-2004 (title pending — MIT esd.60-summer-2004)
type: architecture
kind: course
course_kind: mit-ocw
course_code: "esd.60-summer-2004"
department: Sloan / ESD
generated_by: scripts/mit-course-catalog-bootstrap.mjs
generated_at: 2026-05-24T01:36:36.016Z
...
# MIT course — `esd.60-summer-2004` (title pending — MIT esd.60-summer-2004) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `esd.60-summer-2004` |
| Title | (title pending — MIT esd.60-summer-2004) |
| Department | Sloan / ESD |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/esd.60-summer-2004`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-esd-60-summer-2004.md`.
