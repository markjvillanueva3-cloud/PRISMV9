---
title: MIT course — 3.21-spring-2006 (title pending — MIT 3.21-spring-2006)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.997Z
...
primary_category: materials
course_term: ?
tags: [architecture, system-viz, course, mit, ocw, training, knowledge, materials]
related:
...
# MIT course — `3.21-spring-2006` (title pending — MIT 3.21-spring-2006) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `3.21-spring-2006` |
| Title | (title pending — MIT 3.21-spring-2006) |
| Department | Materials Science / Chemical Engineering |
| Primary category | materials |
| What PRISM uses it for | crystal structures, phase diagrams, diffusion, mechanical properties, material selection |
| What's extracted | crystal structures, phase diagrams, diffusion, mechanical properties, material selection |
| Consuming engines | [[materialregistryengine]], [[johnsoncookflowstressengine]], [[taylorwearengine]], [[coatingselectionengine]] |
| Source modules | `H:/PRISM/resources/MIT COURSES/3.21-spring-2006`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-3-21-spring-2006.md`.
