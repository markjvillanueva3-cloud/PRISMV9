---
title: MIT course — esd.342-spring-2006 (title pending — MIT esd.342-spring-2006)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.889Z
...
# MIT course — `esd.342-spring-2006` (title pending — MIT esd.342-spring-2006) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `esd.342-spring-2006` |
| Title | (title pending — MIT esd.342-spring-2006) |
| Department | Sloan / ESD |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/esd.342-spring-2006`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-esd-342-spring-2006.md`.
