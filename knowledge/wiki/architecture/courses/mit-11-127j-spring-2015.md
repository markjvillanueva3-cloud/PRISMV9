---
title: MIT course — 11.127j-spring-2015 (title pending — MIT 11.127j-spring-2015)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.962Z
...
# MIT course — `11.127j-spring-2015` (title pending — MIT 11.127j-spring-2015) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `11.127j-spring-2015` |
| Title | (title pending — MIT 11.127j-spring-2015) |
| Department | Sloan / ESD |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/11.127j-spring-2015`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-11-127j-spring-2015.md`.
