---
title: MIT course — 1.040-spring-2004 (title pending — MIT 1.040-spring-2004)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.955Z
...
# MIT course — `1.040-spring-2004` (title pending — MIT 1.040-spring-2004) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `1.040-spring-2004` |
| Title | (title pending — MIT 1.040-spring-2004) |
| Department | MIT (subject varies) |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/1.040-spring-2004`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-1-040-spring-2004.md`.
