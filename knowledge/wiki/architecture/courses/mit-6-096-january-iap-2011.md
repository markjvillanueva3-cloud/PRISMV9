---
title: MIT course — 6.096-january-iap-2011 (title pending — MIT 6.096-january-iap-2011)
type: architecture
kind: course
course_kind: mit-ocw
course_code: "6.096-january-iap-2011"
department: EECS
generated_by: scripts/mit-course-catalog-bootstrap.mjs
generated_at: 2026-05-24T01:36:36.004Z
...
# MIT course — `6.096-january-iap-2011` (title pending — MIT 6.096-january-iap-2011) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `6.096-january-iap-2011` |
| Title | (title pending — MIT 6.096-january-iap-2011) |
| Department | EECS |
| Primary category | algorithms |
| What PRISM uses it for | asymptotic analysis, divide-and-conquer, dynamic programming, graph algorithms, NP-completeness |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/6.096-january-iap-2011`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-6-096-january-iap-2011.md`.
