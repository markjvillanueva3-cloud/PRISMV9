---
title: MIT course — 6.046j-spring-2015 (title pending — MIT 6.046j-spring-2015)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.885Z
...
course_term: Spring
tags: [architecture, system-viz, course, mit, ocw, training, knowledge, algorithms]
related:
...
# MIT course — `6.046j-spring-2015` (title pending — MIT 6.046j-spring-2015)
...
| Field | Value |
|-------|-------|
| Course code | `6.046j-spring-2015` |
| Title | (title pending — MIT 6.046j-spring-2015) |
| Department | EECS |
| Primary category | algorithms |
| What PRISM uses it for | asymptotic analysis, divide-and-conquer, dynamic programming, graph algorithms, NP-completeness (course topics: Engineering / Computer Science / Algorithms and Data Structures / Engineering / Computer Science / Computer Networks) |
| What's extracted | asymptotic analysis, divide-and-conquer, dynamic programming, graph algorithms, NP-completeness |
| Consuming engines | [[toolpathoptimizationengine]], [[binpackingengine]], [[schedulingengine]] |
| Source modules | `H:/PRISM/resources/MIT COURSES/6.046j-spring-2015`/ |
| Catalog type | extracted |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-6-046j-spring-2015.md`.
