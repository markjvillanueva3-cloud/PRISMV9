---
title: MIT course — sts.081-spring-2017 (title pending — MIT sts.081-spring-2017)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.948Z
...
# MIT course — `sts.081-spring-2017` (title pending — MIT sts.081-spring-2017) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `sts.081-spring-2017` |
| Title | (title pending — MIT sts.081-spring-2017) |
| Department | MIT (subject varies) |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/sts.081-spring-2017`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-sts-081-spring-2017.md`.
