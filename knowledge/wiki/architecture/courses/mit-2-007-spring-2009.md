---
title: MIT course — 2.007-spring-2009 (title pending — MIT 2.007-spring-2009)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.891Z
...
# MIT course — `2.007-spring-2009` (title pending — MIT 2.007-spring-2009) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `2.007-spring-2009` |
| Title | (title pending — MIT 2.007-spring-2009) |
| Department | Mechanical Engineering |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/2.007-spring-2009`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-2-007-spring-2009.md`.
