---
title: MIT course — res.ll-005-january-iap-2020 (title pending — MIT res.ll-005-january-iap-2020)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.918Z
...
# MIT course — `res.ll-005-january-iap-2020` (title pending — MIT res.ll-005-january-iap-2020) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `res.ll-005-january-iap-2020` |
| Title | (title pending — MIT res.ll-005-january-iap-2020) |
| Department | MIT (subject varies) |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/res.ll-005-january-iap-2020`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-res-ll-005-january-iap-2020.md`.
