---
title: MIT course — 2.830j-spring-2008 (title pending — MIT 2.830j-spring-2008)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.910Z
...
# MIT course — `2.830j-spring-2008` (title pending — MIT 2.830j-spring-2008) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `2.830j-spring-2008` |
| Title | (title pending — MIT 2.830j-spring-2008) |
| Department | Mechanical Engineering |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/2.830j-spring-2008`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-2-830j-spring-2008.md`.
