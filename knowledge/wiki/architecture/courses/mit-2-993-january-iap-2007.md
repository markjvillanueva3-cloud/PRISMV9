---
title: MIT course — 2.993-january-iap-2007 (title pending — MIT 2.993-january-iap-2007)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.991Z
...
# MIT course — `2.993-january-iap-2007` (title pending — MIT 2.993-january-iap-2007) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `2.993-january-iap-2007` |
| Title | (title pending — MIT 2.993-january-iap-2007) |
| Department | Mechanical Engineering |
...
| Consuming engines | [[kienzle-force-model]], [[spcprocesscapabilityengine]], [[dfmcheckengine]], [[machiningenergymodelengine]] |
| Source modules | `H:/PRISM/resources/MIT COURSES/2.993-january-iap-2007`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-2-993-january-iap-2007.md`.
