---
title: MIT course — 2.852-spring-2010 (title pending — MIT 2.852-spring-2010)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.892Z
...
# MIT course — `2.852-spring-2010` (title pending — MIT 2.852-spring-2010) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `2.852-spring-2010` |
| Title | (title pending — MIT 2.852-spring-2010) |
| Department | Mechanical Engineering |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/2.852-spring-2010`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-2-852-spring-2010.md`.
