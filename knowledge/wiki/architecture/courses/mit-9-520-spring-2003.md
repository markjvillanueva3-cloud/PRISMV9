---
title: MIT course — 9.520-spring-2003 (title pending — MIT 9.520-spring-2003)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:36.012Z
...
# MIT course — `9.520-spring-2003` (title pending — MIT 9.520-spring-2003) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `9.520-spring-2003` |
| Title | (title pending — MIT 9.520-spring-2003) |
| Department | EECS / Brain & Cognitive Sciences |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/9.520-spring-2003`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-9-520-spring-2003.md`.
