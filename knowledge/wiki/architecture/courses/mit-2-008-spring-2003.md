---
title: MIT course — 2.008-spring-2003 (title pending — MIT 2.008-spring-2003)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.905Z
...
# MIT course — `2.008-spring-2003` (title pending — MIT 2.008-spring-2003) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `2.008-spring-2003` |
| Title | (title pending — MIT 2.008-spring-2003) |
| Department | Mechanical Engineering |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/2.008-spring-2003`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-2-008-spring-2003.md`.
