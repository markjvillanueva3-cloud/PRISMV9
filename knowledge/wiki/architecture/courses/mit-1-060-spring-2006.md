---
title: MIT course — 1.060-spring-2006 (title pending — MIT 1.060-spring-2006)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.867Z
...
# MIT course — `1.060-spring-2006` (title pending — MIT 1.060-spring-2006) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `1.060-spring-2006` |
| Title | (title pending — MIT 1.060-spring-2006) |
| Department | MIT (subject varies) |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/1.060-spring-2006`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-1-060-spring-2006.md`.
