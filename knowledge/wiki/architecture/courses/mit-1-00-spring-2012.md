---
title: MIT course — 1.00-spring-2012 (title pending — MIT 1.00-spring-2012)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.952Z
...
# MIT course — `1.00-spring-2012` (title pending — MIT 1.00-spring-2012) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `1.00-spring-2012` |
| Title | (title pending — MIT 1.00-spring-2012) |
| Department | MIT (subject varies) |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/1.00-spring-2012`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-1-00-spring-2012.md`.
