---
title: MIT course — esd.33-summer-2010 (title pending — MIT esd.33-summer-2010)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:36.014Z
...
# MIT course — `esd.33-summer-2010` (title pending — MIT esd.33-summer-2010) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `esd.33-summer-2010` |
| Title | (title pending — MIT esd.33-summer-2010) |
| Department | Sloan / ESD |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/esd.33-summer-2010`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-esd-33-summer-2010.md`.
