---
title: MIT course — 2.14-spring-2014 (title pending — MIT 2.14-spring-2014)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.881Z
...
# MIT course — `2.14-spring-2014` (title pending — MIT 2.14-spring-2014) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `2.14-spring-2014` |
| Title | (title pending — MIT 2.14-spring-2014) |
| Department | Mechanical Engineering |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/2.14-spring-2014`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-2-14-spring-2014.md`.
