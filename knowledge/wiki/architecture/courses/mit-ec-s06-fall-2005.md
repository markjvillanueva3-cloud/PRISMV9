---
title: MIT course — ec.s06-fall-2005 (title pending — MIT ec.s06-fall-2005)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:36.013Z
...
# MIT course — `ec.s06-fall-2005` (title pending — MIT ec.s06-fall-2005) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `ec.s06-fall-2005` |
| Title | (title pending — MIT ec.s06-fall-2005) |
| Department | MIT (subject varies) |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/ec.s06-fall-2005`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-ec-s06-fall-2005.md`.
