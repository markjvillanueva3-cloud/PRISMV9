---
title: MIT course — 6.033-spring-2018 (title pending — MIT 6.033-spring-2018)
type: architecture
kind: course
course_kind: mit-ocw
course_code: "6.033-spring-2018"
department: EECS
generated_by: scripts/mit-course-catalog-bootstrap.mjs
generated_at: 2026-05-24T01:36:36.002Z
...
primary_category: signal
course_term: ?
tags: [architecture, system-viz, course, mit, ocw, training, knowledge, signal]
related:
...
# MIT course — `6.033-spring-2018` (title pending — MIT 6.033-spring-2018) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `6.033-spring-2018` |
| Title | (title pending — MIT 6.033-spring-2018) |
| Department | EECS |
| Primary category | signal |
| What PRISM uses it for | Fourier + Laplace transforms, sampling, digital filters, signal detection |
| What's extracted | Fourier + Laplace transforms, sampling, digital filters, signal detection |
| Consuming engines | [[stftchatterengine]], [[ewmaengine]], [[acousticemissionmonitoringengine]] |
| Source modules | `H:/PRISM/resources/MIT COURSES/6.033-spring-2018`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-6-033-spring-2018.md`.
