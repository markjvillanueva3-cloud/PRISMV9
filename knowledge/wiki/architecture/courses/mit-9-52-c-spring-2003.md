---
title: MIT course — 9.52-c-spring-2003 (title pending — MIT 9.52-c-spring-2003)
type: architecture
kind: course
course_kind: mit-ocw
course_code: "9.52-c-spring-2003"
department: EECS / Brain & Cognitive Sciences
generated_by: scripts/mit-course-catalog-bootstrap.mjs
generated_at: 2026-05-24T01:36:36.010Z
...
course_term: ?
tags: [architecture, system-viz, course, mit, ocw, training, knowledge, ml_ai]
related:
...
# MIT course — `9.52-c-spring-2003` (title pending — MIT 9.52-c-spring-2003) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `9.52-c-spring-2003` |
| Title | (title pending — MIT 9.52-c-spring-2003) |
| Department | EECS / Brain & Cognitive Sciences |
| Primary category | ml_ai |
| What PRISM uses it for | supervised learning, neural networks, gradient descent, backpropagation, reinforcement learning |
| What's extracted | supervised learning, neural networks, gradient descent, backpropagation, reinforcement learning |
| Consuming engines | [[mlopsengine]], [[deeplearningengine]], [[reinforcementlearningengine]], [[gnntrainingengine]] |
| Source modules | `H:/PRISM/resources/MIT COURSES/9.52-c-spring-2003`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-9-52-c-spring-2003.md`.
