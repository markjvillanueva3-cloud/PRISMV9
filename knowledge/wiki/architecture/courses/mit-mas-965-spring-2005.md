---
title: MIT course — mas.965-spring-2005 (title pending — MIT mas.965-spring-2005)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.915Z
...
# MIT course — `mas.965-spring-2005` (title pending — MIT mas.965-spring-2005) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `mas.965-spring-2005` |
| Title | (title pending — MIT mas.965-spring-2005) |
| Department | MIT (subject varies) |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/mas.965-spring-2005`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-mas-965-spring-2005.md`.
