---
title: MIT course — 15.066j-summer-2003 (title pending — MIT 15.066j-summer-2003)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.894Z
...
course_term: ?
tags: [architecture, system-viz, course, mit, ocw, training, knowledge, statistics]
related:
...
# MIT course — `15.066j-summer-2003` (title pending — MIT 15.066j-summer-2003) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `15.066j-summer-2003` |
| Title | (title pending — MIT 15.066j-summer-2003) |
| Department | Mathematics / EECS |
| Primary category | statistics |
| What PRISM uses it for | probability distributions, hypothesis testing, regression, Bayesian inference, Monte Carlo |
| What's extracted | probability distributions, hypothesis testing, regression, Bayesian inference, Monte Carlo |
| Consuming engines | [[spcprocesscapabilityengine]], [[stochasticcuttingforceengine]], [[stochastictoollifeengine]], [[monte-carlo-engine]] |
| Source modules | `H:/PRISM/resources/MIT COURSES/15.066j-summer-2003`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-15-066j-summer-2003.md`.
