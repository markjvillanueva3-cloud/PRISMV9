---
title: MIT course — mas.632-fall-2008 (title pending — MIT mas.632-fall-2008)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.946Z
...
# MIT course — `mas.632-fall-2008` (title pending — MIT mas.632-fall-2008) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `mas.632-fall-2008` |
| Title | (title pending — MIT mas.632-fall-2008) |
| Department | MIT (subject varies) |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/mas.632-fall-2008`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-mas-632-fall-2008.md`.
