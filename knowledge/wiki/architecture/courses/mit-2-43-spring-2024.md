---
title: MIT course — 2.43-spring-2024 (title pending — MIT 2.43-spring-2024)
type: architecture
kind: course
course_kind: mit-ocw
...
generated_at: 2026-05-24T01:36:35.883Z
...
# MIT course — `2.43-spring-2024` (title pending — MIT 2.43-spring-2024) (archived .zip — not extracted)
...
| Field | Value |
|-------|-------|
| Course code | `2.43-spring-2024` |
| Title | (title pending — MIT 2.43-spring-2024) |
| Department | MIT (subject varies) |
...
| Source modules | `H:/PRISM/resources/MIT COURSES/2.43-spring-2024`.zip |
...
- **Triplet stub** — auto-emitted by `scripts/mit-course-triplet-extractor.mjs` to `courses/triplet-stubs/mit-2-43-spring-2024.md`.
