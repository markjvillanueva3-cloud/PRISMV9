---
title: Formula — router · post_line_by_line
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_line_by_line
...
# Formula — `router · post_line_by_line`
...
| Field | Value |
|-------|-------|
| Name | `router · post_line_by_line` |
| Graph node | `formula.adjusted.camdispatcher.action.post_line_by_line` |
| Kind | dispatcher_router |
