---
title: Formula — router · spm_doe_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.spm_doe_generate
...
# Formula — `router · spm_doe_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · spm_doe_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.spm_doe_generate` |
| Kind | dispatcher_router |
