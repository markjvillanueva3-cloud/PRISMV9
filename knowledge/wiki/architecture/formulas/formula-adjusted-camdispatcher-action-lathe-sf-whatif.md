---
title: Formula — router · lathe_sf_whatif
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_sf_whatif
...
# Formula — `router · lathe_sf_whatif`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_sf_whatif` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_sf_whatif` |
| Kind | dispatcher_router |
