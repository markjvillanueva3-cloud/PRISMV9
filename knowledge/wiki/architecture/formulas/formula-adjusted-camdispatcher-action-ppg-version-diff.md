---
title: Formula — router · ppg_version_diff
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_version_diff
...
# Formula — `router · ppg_version_diff`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_version_diff` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_version_diff` |
| Kind | dispatcher_router |
