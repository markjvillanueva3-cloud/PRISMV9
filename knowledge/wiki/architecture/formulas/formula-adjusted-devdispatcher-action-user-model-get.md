---
title: Formula — router · user_model_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.user_model_get
...
| Field | Value |
|-------|-------|
| Name | `router · user_model_get` |
| Graph node | `formula.adjusted.devdispatcher.action.user_model_get` |
| Kind | dispatcher_router |
