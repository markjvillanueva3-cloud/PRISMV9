---
title: Formula — router · wedm_predict_break
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_predict_break
...
# Formula — `router · wedm_predict_break`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_predict_break` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_predict_break` |
| Kind | dispatcher_router |
