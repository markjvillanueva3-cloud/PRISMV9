---
title: Formula — router · xproc_aps_reset
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.xproc_aps_reset
...
# Formula — `router · xproc_aps_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · xproc_aps_reset` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.xproc_aps_reset` |
| Kind | dispatcher_router |
