---
title: Formula — router · sf_orchestrate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sf_orchestrate
...
| Field | Value |
|-------|-------|
| Name | `router · sf_orchestrate` |
| Graph node | `formula.adjusted.calcdispatcher.action.sf_orchestrate` |
| Kind | dispatcher_router |
