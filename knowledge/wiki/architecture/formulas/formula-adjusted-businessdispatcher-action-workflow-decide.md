---
title: Formula — router · workflow_decide
type: formula
formula_id: formula.adjusted.businessdispatcher.action.workflow_decide
...
# Formula — `router · workflow_decide`
...
| Field | Value |
|-------|-------|
| Name | `router · workflow_decide` |
| Graph node | `formula.adjusted.businessdispatcher.action.workflow_decide` |
| Kind | dispatcher_router |
