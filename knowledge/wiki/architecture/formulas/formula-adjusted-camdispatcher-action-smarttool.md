---
title: Formula — router · smartTool
type: formula
formula_id: formula.adjusted.camdispatcher.action.smarttool
...
| Field | Value |
|-------|-------|
| Name | `router · smartTool` |
| Graph node | `formula.adjusted.camdispatcher.action.smarttool` |
| Kind | dispatcher_router |
