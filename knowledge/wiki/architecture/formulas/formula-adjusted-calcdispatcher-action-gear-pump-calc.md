---
title: Formula — router · gear_pump_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gear_pump_calc
...
| Field | Value |
|-------|-------|
| Name | `router · gear_pump_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.gear_pump_calc` |
| Kind | dispatcher_router |
