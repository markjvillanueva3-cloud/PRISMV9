---
title: Formula — router · pcr_has_dossier
type: formula
formula_id: formula.adjusted.devdispatcher.action.pcr_has_dossier
...
# Formula — `router · pcr_has_dossier`
...
| Field | Value |
|-------|-------|
| Name | `router · pcr_has_dossier` |
| Graph node | `formula.adjusted.devdispatcher.action.pcr_has_dossier` |
| Kind | dispatcher_router |
