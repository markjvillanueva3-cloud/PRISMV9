---
title: Formula — router · twin_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.twin_predict
...
| Field | Value |
|-------|-------|
| Name | `router · twin_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.twin_predict` |
| Kind | dispatcher_router |
