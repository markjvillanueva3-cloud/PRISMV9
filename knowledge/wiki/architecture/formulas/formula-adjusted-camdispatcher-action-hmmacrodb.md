---
title: Formula — router · hmMacroDB
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmmacrodb
...
| Field | Value |
|-------|-------|
| Name | `router · hmMacroDB` |
| Graph node | `formula.adjusted.camdispatcher.action.hmmacrodb` |
| Kind | dispatcher_router |
