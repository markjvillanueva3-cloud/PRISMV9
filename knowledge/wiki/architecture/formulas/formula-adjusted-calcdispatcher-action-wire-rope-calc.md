---
title: Formula — router · wire_rope_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.wire_rope_calc
...
| Field | Value |
|-------|-------|
| Name | `router · wire_rope_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.wire_rope_calc` |
| Kind | dispatcher_router |
