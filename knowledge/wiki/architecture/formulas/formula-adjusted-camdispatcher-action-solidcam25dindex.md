---
title: Formula — router · solidcam25dIndex
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcam25dindex
...
# Formula — `router · solidcam25dIndex`
...
| Field | Value |
|-------|-------|
| Name | `router · solidcam25dIndex` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcam25dindex` |
| Kind | dispatcher_router |
