---
title: Formula — router · wedm_kerf_width
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_kerf_width
...
# Formula — `router · wedm_kerf_width`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_kerf_width` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_kerf_width` |
| Kind | dispatcher_router |
