---
title: Formula — router · dlt_formulas
type: formula
formula_id: formula.adjusted.devdispatcher.action.dlt_formulas
...
| Field | Value |
|-------|-------|
| Name | `router · dlt_formulas` |
| Graph node | `formula.adjusted.devdispatcher.action.dlt_formulas` |
| Kind | dispatcher_router |
