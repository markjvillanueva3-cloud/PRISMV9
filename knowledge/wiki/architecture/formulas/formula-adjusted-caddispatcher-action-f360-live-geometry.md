---
title: Formula — router · f360_live_geometry
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_geometry
...
# Formula — `router · f360_live_geometry`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_geometry` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_geometry` |
| Kind | dispatcher_router |
