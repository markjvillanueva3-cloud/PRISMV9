---
title: Formula — router · latheSFDL
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathesfdl
...
| Field | Value |
|-------|-------|
| Name | `router · latheSFDL` |
| Graph node | `formula.adjusted.camdispatcher.action.lathesfdl` |
| Kind | dispatcher_router |
