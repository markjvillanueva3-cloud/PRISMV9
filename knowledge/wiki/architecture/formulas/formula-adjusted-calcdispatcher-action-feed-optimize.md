---
title: Formula — router · feed_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.feed_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · feed_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.feed_optimize` |
| Kind | dispatcher_router |
