---
title: Formula — router · mda_report
type: formula
formula_id: formula.adjusted.devdispatcher.action.mda_report
...
| Field | Value |
|-------|-------|
| Name | `router · mda_report` |
| Graph node | `formula.adjusted.devdispatcher.action.mda_report` |
| Kind | dispatcher_router |
