---
title: Formula — router · lathePost
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathepost
...
| Field | Value |
|-------|-------|
| Name | `router · lathePost` |
| Graph node | `formula.adjusted.camdispatcher.action.lathepost` |
| Kind | dispatcher_router |
