---
title: Formula — router · ts_change_point
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ts_change_point
...
# Formula — `router · ts_change_point`
...
| Field | Value |
|-------|-------|
| Name | `router · ts_change_point` |
| Graph node | `formula.adjusted.calcdispatcher.action.ts_change_point` |
| Kind | dispatcher_router |
