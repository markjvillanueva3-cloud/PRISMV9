---
title: Formula — router · edm_parameter_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.edm_parameter_calc
...
# Formula — `router · edm_parameter_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · edm_parameter_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.edm_parameter_calc` |
| Kind | dispatcher_router |
