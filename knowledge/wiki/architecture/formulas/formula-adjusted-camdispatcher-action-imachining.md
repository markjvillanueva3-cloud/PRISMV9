---
title: Formula — router · iMachining
type: formula
formula_id: formula.adjusted.camdispatcher.action.imachining
...
| Field | Value |
|-------|-------|
| Name | `router · iMachining` |
| Graph node | `formula.adjusted.camdispatcher.action.imachining` |
| Kind | dispatcher_router |
