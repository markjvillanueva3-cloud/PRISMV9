---
title: Formula — router · rbd_fault_tree
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rbd_fault_tree
...
| Field | Value |
|-------|-------|
| Name | `router · rbd_fault_tree` |
| Graph node | `formula.adjusted.calcdispatcher.action.rbd_fault_tree` |
| Kind | dispatcher_router |
