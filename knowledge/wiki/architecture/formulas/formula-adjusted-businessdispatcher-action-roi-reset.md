---
title: Formula — router · roi_reset
type: formula
formula_id: formula.adjusted.businessdispatcher.action.roi_reset
...
| Field | Value |
|-------|-------|
| Name | `router · roi_reset` |
| Graph node | `formula.adjusted.businessdispatcher.action.roi_reset` |
| Kind | dispatcher_router |
