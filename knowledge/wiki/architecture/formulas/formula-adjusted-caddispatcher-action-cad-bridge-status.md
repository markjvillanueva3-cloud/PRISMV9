---
title: Formula — router · cad_bridge_status
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_bridge_status
...
# Formula — `router · cad_bridge_status`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_bridge_status` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_bridge_status` |
| Kind | dispatcher_router |
