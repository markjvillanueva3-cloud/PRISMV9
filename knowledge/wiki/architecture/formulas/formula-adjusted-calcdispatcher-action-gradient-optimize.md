---
title: Formula — router · gradient_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gradient_optimize
...
# Formula — `router · gradient_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · gradient_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.gradient_optimize` |
| Kind | dispatcher_router |
