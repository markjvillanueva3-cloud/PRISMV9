---
title: Formula — router · lathe_p2p_dl_batch
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_p2p_dl_batch
...
# Formula — `router · lathe_p2p_dl_batch`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_p2p_dl_batch` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_p2p_dl_batch` |
| Kind | dispatcher_router |
