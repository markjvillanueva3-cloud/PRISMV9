---
title: Formula — router · catia_mfg_program
type: formula
formula_id: formula.adjusted.camdispatcher.action.catia_mfg_program
...
# Formula — `router · catia_mfg_program`
...
| Field | Value |
|-------|-------|
| Name | `router · catia_mfg_program` |
| Graph node | `formula.adjusted.camdispatcher.action.catia_mfg_program` |
| Kind | dispatcher_router |
