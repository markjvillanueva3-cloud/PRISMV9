---
title: Formula — router · claim
type: formula
formula_id: formula.adjusted.contextdispatcher.action.claim
...
|-------|-------|
| Name | `router · claim` |
| Graph node | `formula.adjusted.contextdispatcher.action.claim` |
| Kind | dispatcher_router |
