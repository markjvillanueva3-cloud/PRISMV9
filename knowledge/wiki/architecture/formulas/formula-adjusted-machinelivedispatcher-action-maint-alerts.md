---
title: Formula — router · maint_alerts
type: formula
formula_id: formula.adjusted.machinelivedispatcher.action.maint_alerts
...
| Field | Value |
|-------|-------|
| Name | `router · maint_alerts` |
| Graph node | `formula.adjusted.machinelivedispatcher.action.maint_alerts` |
| Kind | dispatcher_router |
