---
title: Formula — router · batchCAM
type: formula
formula_id: formula.adjusted.camdispatcher.action.batchcam
...
| Field | Value |
|-------|-------|
| Name | `router · batchCAM` |
| Graph node | `formula.adjusted.camdispatcher.action.batchcam` |
| Kind | dispatcher_router |
