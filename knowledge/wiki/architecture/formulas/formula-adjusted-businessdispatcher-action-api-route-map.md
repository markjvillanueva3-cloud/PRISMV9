---
title: Formula — router · api_route_map
type: formula
formula_id: formula.adjusted.businessdispatcher.action.api_route_map
...
| Field | Value |
|-------|-------|
| Name | `router · api_route_map` |
| Graph node | `formula.adjusted.businessdispatcher.action.api_route_map` |
| Kind | dispatcher_router |
