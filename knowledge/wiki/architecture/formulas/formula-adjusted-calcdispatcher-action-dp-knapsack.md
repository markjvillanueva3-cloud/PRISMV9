---
title: Formula — router · dp_knapsack
type: formula
formula_id: formula.adjusted.calcdispatcher.action.dp_knapsack
...
| Field | Value |
|-------|-------|
| Name | `router · dp_knapsack` |
| Graph node | `formula.adjusted.calcdispatcher.action.dp_knapsack` |
| Kind | dispatcher_router |
