---
title: Formula — router · mdof_compare_sdof
type: formula
formula_id: formula.adjusted.calcdispatcher.action.mdof_compare_sdof
...
# Formula — `router · mdof_compare_sdof`
...
| Field | Value |
|-------|-------|
| Name | `router · mdof_compare_sdof` |
| Graph node | `formula.adjusted.calcdispatcher.action.mdof_compare_sdof` |
| Kind | dispatcher_router |
