---
title: Formula — router · circle
type: formula
formula_id: formula.adjusted.caddispatcher.action.circle
...
|-------|-------|
| Name | `router · circle` |
| Graph node | `formula.adjusted.caddispatcher.action.circle` |
| Kind | dispatcher_router |
