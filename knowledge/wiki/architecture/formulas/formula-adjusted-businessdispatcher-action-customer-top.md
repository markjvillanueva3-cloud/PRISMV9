---
title: Formula — router · customer_top
type: formula
formula_id: formula.adjusted.businessdispatcher.action.customer_top
...
| Field | Value |
|-------|-------|
| Name | `router · customer_top` |
| Graph node | `formula.adjusted.businessdispatcher.action.customer_top` |
| Kind | dispatcher_router |
