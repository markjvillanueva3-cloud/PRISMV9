---
title: Formula — router · tool_sync_status
type: formula
formula_id: formula.adjusted.camdispatcher.action.tool_sync_status
...
# Formula — `router · tool_sync_status`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_sync_status` |
| Graph node | `formula.adjusted.camdispatcher.action.tool_sync_status` |
| Kind | dispatcher_router |
