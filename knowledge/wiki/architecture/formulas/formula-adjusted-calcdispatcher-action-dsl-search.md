---
title: Formula — router · dsl_search
type: formula
formula_id: formula.adjusted.calcdispatcher.action.dsl_search
...
| Field | Value |
|-------|-------|
| Name | `router · dsl_search` |
| Graph node | `formula.adjusted.calcdispatcher.action.dsl_search` |
| Kind | dispatcher_router |
