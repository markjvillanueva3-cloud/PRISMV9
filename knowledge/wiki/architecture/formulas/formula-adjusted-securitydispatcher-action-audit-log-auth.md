---
title: Formula — router · audit_log_auth
type: formula
formula_id: formula.adjusted.securitydispatcher.action.audit_log_auth
...
| Field | Value |
|-------|-------|
| Name | `router · audit_log_auth` |
| Graph node | `formula.adjusted.securitydispatcher.action.audit_log_auth` |
| Kind | dispatcher_router |
