---
title: Formula — router · savings_trend
type: formula
formula_id: formula.adjusted.businessdispatcher.action.savings_trend
...
| Field | Value |
|-------|-------|
| Name | `router · savings_trend` |
| Graph node | `formula.adjusted.businessdispatcher.action.savings_trend` |
| Kind | dispatcher_router |
