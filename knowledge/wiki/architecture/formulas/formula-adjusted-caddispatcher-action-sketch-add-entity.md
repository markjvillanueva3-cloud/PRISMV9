---
title: Formula — router · sketch_add_entity
type: formula
formula_id: formula.adjusted.caddispatcher.action.sketch_add_entity
...
# Formula — `router · sketch_add_entity`
...
| Field | Value |
|-------|-------|
| Name | `router · sketch_add_entity` |
| Graph node | `formula.adjusted.caddispatcher.action.sketch_add_entity` |
| Kind | dispatcher_router |
