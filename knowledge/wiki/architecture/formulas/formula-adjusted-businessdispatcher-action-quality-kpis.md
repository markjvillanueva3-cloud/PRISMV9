---
title: Formula — router · quality_kpis
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quality_kpis
...
| Field | Value |
|-------|-------|
| Name | `router · quality_kpis` |
| Graph node | `formula.adjusted.businessdispatcher.action.quality_kpis` |
| Kind | dispatcher_router |
