---
title: Formula — router · printToFusion
type: formula
formula_id: formula.adjusted.caddispatcher.action.printtofusion
...
| Field | Value |
|-------|-------|
| Name | `router · printToFusion` |
| Graph node | `formula.adjusted.caddispatcher.action.printtofusion` |
| Kind | dispatcher_router |
