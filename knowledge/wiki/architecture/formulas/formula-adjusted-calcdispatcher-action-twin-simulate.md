---
title: Formula — router · twin_simulate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.twin_simulate
...
| Field | Value |
|-------|-------|
| Name | `router · twin_simulate` |
| Graph node | `formula.adjusted.calcdispatcher.action.twin_simulate` |
| Kind | dispatcher_router |
