---
title: Formula — router · by_stage
type: formula
formula_id: formula.adjusted.devdispatcher.action.by_stage
...
| Field | Value |
|-------|-------|
| Name | `router · by_stage` |
| Graph node | `formula.adjusted.devdispatcher.action.by_stage` |
| Kind | dispatcher_router |
