---
title: Formula — router · pp_run_partial
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_run_partial
...
| Field | Value |
|-------|-------|
| Name | `router · pp_run_partial` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_run_partial` |
| Kind | dispatcher_router |
