---
title: Formula — router · cam_export_get
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_export_get
...
| Field | Value |
|-------|-------|
| Name | `router · cam_export_get` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_export_get` |
| Kind | dispatcher_router |
