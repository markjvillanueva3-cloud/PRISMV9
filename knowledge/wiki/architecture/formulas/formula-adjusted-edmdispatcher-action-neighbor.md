---
title: Formula — router · neighbor
type: formula
formula_id: formula.adjusted.edmdispatcher.action.neighbor
...
| Field | Value |
|-------|-------|
| Name | `router · neighbor` |
| Graph node | `formula.adjusted.edmdispatcher.action.neighbor` |
| Kind | dispatcher_router |
