---
title: Formula — router · gap_scan_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.gap_scan_summary
...
# Formula — `router · gap_scan_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · gap_scan_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.gap_scan_summary` |
| Kind | dispatcher_router |
