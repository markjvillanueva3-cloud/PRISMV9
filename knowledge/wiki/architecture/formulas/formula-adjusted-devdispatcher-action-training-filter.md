---
title: Formula — router · training_filter
type: formula
formula_id: formula.adjusted.devdispatcher.action.training_filter
...
# Formula — `router · training_filter`
...
| Field | Value |
|-------|-------|
| Name | `router · training_filter` |
| Graph node | `formula.adjusted.devdispatcher.action.training_filter` |
| Kind | dispatcher_router |
