---
title: Formula — router · spectral_partition
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spectral_partition
...
# Formula — `router · spectral_partition`
...
| Field | Value |
|-------|-------|
| Name | `router · spectral_partition` |
| Graph node | `formula.adjusted.calcdispatcher.action.spectral_partition` |
| Kind | dispatcher_router |
