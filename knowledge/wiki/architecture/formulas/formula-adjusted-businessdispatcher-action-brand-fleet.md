---
title: Formula — router · brand_fleet
type: formula
formula_id: formula.adjusted.businessdispatcher.action.brand_fleet
...
| Field | Value |
|-------|-------|
| Name | `router · brand_fleet` |
| Graph node | `formula.adjusted.businessdispatcher.action.brand_fleet` |
| Kind | dispatcher_router |
