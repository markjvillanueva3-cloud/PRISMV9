---
title: Formula — router · five_axis_contour
type: formula
formula_id: formula.adjusted.camdispatcher.action.five_axis_contour
...
# Formula — `router · five_axis_contour`
...
| Field | Value |
|-------|-------|
| Name | `router · five_axis_contour` |
| Graph node | `formula.adjusted.camdispatcher.action.five_axis_contour` |
| Kind | dispatcher_router |
