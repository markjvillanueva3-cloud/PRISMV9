---
title: Formula — router · springback_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.springback_predict
...
# Formula — `router · springback_predict`
...
| Field | Value |
|-------|-------|
| Name | `router · springback_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.springback_predict` |
| Kind | dispatcher_router |
