---
title: Formula — router · rivet_joint_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rivet_joint_calc
...
# Formula — `router · rivet_joint_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · rivet_joint_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.rivet_joint_calc` |
| Kind | dispatcher_router |
