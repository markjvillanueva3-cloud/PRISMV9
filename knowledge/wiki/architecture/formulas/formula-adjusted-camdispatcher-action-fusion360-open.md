---
title: Formula — router · fusion360_open
type: formula
formula_id: formula.adjusted.camdispatcher.action.fusion360_open
...
| Field | Value |
|-------|-------|
| Name | `router · fusion360_open` |
| Graph node | `formula.adjusted.camdispatcher.action.fusion360_open` |
| Kind | dispatcher_router |
