---
title: Formula — router · wedm_dxf_validate
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_dxf_validate
...
# Formula — `router · wedm_dxf_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_dxf_validate` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_dxf_validate` |
| Kind | dispatcher_router |
