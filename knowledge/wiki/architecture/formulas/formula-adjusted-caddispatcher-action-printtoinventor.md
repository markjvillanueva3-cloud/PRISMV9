---
title: Formula — router · printToInventor
type: formula
formula_id: formula.adjusted.caddispatcher.action.printtoinventor
...
# Formula — `router · printToInventor`
...
| Field | Value |
|-------|-------|
| Name | `router · printToInventor` |
| Graph node | `formula.adjusted.caddispatcher.action.printtoinventor` |
| Kind | dispatcher_router |
