---
title: Formula — router · cad_rag_rank
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_rag_rank
...
| Field | Value |
|-------|-------|
| Name | `router · cad_rag_rank` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_rag_rank` |
| Kind | dispatcher_router |
