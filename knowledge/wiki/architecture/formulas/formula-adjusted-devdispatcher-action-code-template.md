---
title: Formula — router · code_template
type: formula
formula_id: formula.adjusted.devdispatcher.action.code_template
...
| Field | Value |
|-------|-------|
| Name | `router · code_template` |
| Graph node | `formula.adjusted.devdispatcher.action.code_template` |
| Kind | dispatcher_router |
