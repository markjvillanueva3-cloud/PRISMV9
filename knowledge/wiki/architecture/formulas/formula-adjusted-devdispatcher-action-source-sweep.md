---
title: Formula — router · source_sweep
type: formula
formula_id: formula.adjusted.devdispatcher.action.source_sweep
...
| Field | Value |
|-------|-------|
| Name | `router · source_sweep` |
| Graph node | `formula.adjusted.devdispatcher.action.source_sweep` |
| Kind | dispatcher_router |
