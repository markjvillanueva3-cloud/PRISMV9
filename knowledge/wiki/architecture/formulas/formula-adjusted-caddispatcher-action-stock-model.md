---
title: Formula — router · stock_model
type: formula
formula_id: formula.adjusted.caddispatcher.action.stock_model
...
| Field | Value |
|-------|-------|
| Name | `router · stock_model` |
| Graph node | `formula.adjusted.caddispatcher.action.stock_model` |
| Kind | dispatcher_router |
