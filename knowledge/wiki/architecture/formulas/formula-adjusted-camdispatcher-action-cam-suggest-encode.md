---
title: Formula — router · cam_suggest_encode
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_suggest_encode
...
# Formula — `router · cam_suggest_encode`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_suggest_encode` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_suggest_encode` |
| Kind | dispatcher_router |
