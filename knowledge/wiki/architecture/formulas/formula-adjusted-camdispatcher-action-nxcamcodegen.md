---
title: Formula — router · nxCAMCodeGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcamcodegen
...
| Field | Value |
|-------|-------|
| Name | `router · nxCAMCodeGen` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcamcodegen` |
| Kind | dispatcher_router |
