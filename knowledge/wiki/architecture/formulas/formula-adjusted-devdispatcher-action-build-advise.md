---
title: Formula — router · build_advise
type: formula
formula_id: formula.adjusted.devdispatcher.action.build_advise
...
| Field | Value |
|-------|-------|
| Name | `router · build_advise` |
| Graph node | `formula.adjusted.devdispatcher.action.build_advise` |
| Kind | dispatcher_router |
