---
title: Formula — router · onlineLearning
type: formula
formula_id: formula.adjusted.edmdispatcher.action.onlinelearning
...
| Field | Value |
|-------|-------|
| Name | `router · onlineLearning` |
| Graph node | `formula.adjusted.edmdispatcher.action.onlinelearning` |
| Kind | dispatcher_router |
