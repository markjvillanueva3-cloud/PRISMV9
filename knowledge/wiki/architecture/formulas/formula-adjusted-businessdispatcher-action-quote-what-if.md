---
title: Formula — router · quote_what_if
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quote_what_if
...
| Field | Value |
|-------|-------|
| Name | `router · quote_what_if` |
| Graph node | `formula.adjusted.businessdispatcher.action.quote_what_if` |
| Kind | dispatcher_router |
