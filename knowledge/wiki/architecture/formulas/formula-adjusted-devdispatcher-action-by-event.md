---
title: Formula — router · by_event
type: formula
formula_id: formula.adjusted.devdispatcher.action.by_event
...
| Field | Value |
|-------|-------|
| Name | `router · by_event` |
| Graph node | `formula.adjusted.devdispatcher.action.by_event` |
| Kind | dispatcher_router |
