---
title: Formula — router · nvidia_cam_query
type: formula
formula_id: formula.adjusted.camdispatcher.action.nvidia_cam_query
...
# Formula — `router · nvidia_cam_query`
...
| Field | Value |
|-------|-------|
| Name | `router · nvidia_cam_query` |
| Graph node | `formula.adjusted.camdispatcher.action.nvidia_cam_query` |
| Kind | dispatcher_router |
