---
title: Formula — router · solidCAMSWBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcamswbridge
...
# Formula — `router · solidCAMSWBridge`
...
| Field | Value |
|-------|-------|
| Name | `router · solidCAMSWBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcamswbridge` |
| Kind | dispatcher_router |
