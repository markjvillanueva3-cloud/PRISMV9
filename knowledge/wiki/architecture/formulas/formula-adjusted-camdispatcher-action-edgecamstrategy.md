---
title: Formula — router · edgecamStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.edgecamstrategy
...
# Formula — `router · edgecamStrategy`
...
| Field | Value |
|-------|-------|
| Name | `router · edgecamStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.edgecamstrategy` |
| Kind | dispatcher_router |
