---
title: Formula — router · tribalRuntime
type: formula
formula_id: formula.adjusted.edmdispatcher.action.tribalruntime
...
| Field | Value |
|-------|-------|
| Name | `router · tribalRuntime` |
| Graph node | `formula.adjusted.edmdispatcher.action.tribalruntime` |
| Kind | dispatcher_router |
