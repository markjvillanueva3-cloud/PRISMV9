---
title: Formula — router · asset_register
type: formula
formula_id: formula.adjusted.businessdispatcher.action.asset_register
...
| Field | Value |
|-------|-------|
| Name | `router · asset_register` |
| Graph node | `formula.adjusted.businessdispatcher.action.asset_register` |
| Kind | dispatcher_router |
