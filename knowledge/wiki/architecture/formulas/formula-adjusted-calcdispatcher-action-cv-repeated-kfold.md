---
title: Formula — router · cv_repeated_kfold
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cv_repeated_kfold
...
# Formula — `router · cv_repeated_kfold`
...
| Field | Value |
|-------|-------|
| Name | `router · cv_repeated_kfold` |
| Graph node | `formula.adjusted.calcdispatcher.action.cv_repeated_kfold` |
| Kind | dispatcher_router |
