---
title: Formula — router · chip_conveyor_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.chip_conveyor_calc
...
# Formula — `router · chip_conveyor_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · chip_conveyor_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.chip_conveyor_calc` |
| Kind | dispatcher_router |
