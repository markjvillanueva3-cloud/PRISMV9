---
title: Formula — router · cycloid_drive_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cycloid_drive_calc
...
# Formula — `router · cycloid_drive_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · cycloid_drive_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.cycloid_drive_calc` |
| Kind | dispatcher_router |
