---
title: Formula — router · stochastic_wear
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stochastic_wear
...
# Formula — `router · stochastic_wear`
...
| Field | Value |
|-------|-------|
| Name | `router · stochastic_wear` |
| Graph node | `formula.adjusted.calcdispatcher.action.stochastic_wear` |
| Kind | dispatcher_router |
