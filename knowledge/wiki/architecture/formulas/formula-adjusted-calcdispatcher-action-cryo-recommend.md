---
title: Formula — router · cryo_recommend
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cryo_recommend
...
| Field | Value |
|-------|-------|
| Name | `router · cryo_recommend` |
| Graph node | `formula.adjusted.calcdispatcher.action.cryo_recommend` |
| Kind | dispatcher_router |
