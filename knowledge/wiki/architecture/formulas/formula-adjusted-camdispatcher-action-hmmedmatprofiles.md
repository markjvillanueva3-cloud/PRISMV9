---
title: Formula — router · hmMedMatProfiles
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmmedmatprofiles
...
# Formula — `router · hmMedMatProfiles`
...
| Field | Value |
|-------|-------|
| Name | `router · hmMedMatProfiles` |
| Graph node | `formula.adjusted.camdispatcher.action.hmmedmatprofiles` |
| Kind | dispatcher_router |
