---
title: Formula — router · tool_regrind
type: formula
formula_id: formula.adjusted.businessdispatcher.action.tool_regrind
...
| Field | Value |
|-------|-------|
| Name | `router · tool_regrind` |
| Graph node | `formula.adjusted.businessdispatcher.action.tool_regrind` |
| Kind | dispatcher_router |
