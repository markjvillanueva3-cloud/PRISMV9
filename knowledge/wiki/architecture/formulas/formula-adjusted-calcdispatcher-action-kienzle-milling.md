---
title: Formula — router · kienzle_milling
type: formula
formula_id: formula.adjusted.calcdispatcher.action.kienzle_milling
...
# Formula — `router · kienzle_milling`
...
| Field | Value |
|-------|-------|
| Name | `router · kienzle_milling` |
| Graph node | `formula.adjusted.calcdispatcher.action.kienzle_milling` |
| Kind | dispatcher_router |
