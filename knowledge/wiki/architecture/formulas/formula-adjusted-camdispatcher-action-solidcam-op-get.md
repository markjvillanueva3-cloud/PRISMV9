---
title: Formula — router · solidcam_op_get
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcam_op_get
...
# Formula — `router · solidcam_op_get`
...
| Field | Value |
|-------|-------|
| Name | `router · solidcam_op_get` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcam_op_get` |
| Kind | dispatcher_router |
