---
title: Formula — router · ontology_get_range
type: formula
formula_id: formula.adjusted.camdispatcher.action.ontology_get_range
...
# Formula — `router · ontology_get_range`
...
| Field | Value |
|-------|-------|
| Name | `router · ontology_get_range` |
| Graph node | `formula.adjusted.camdispatcher.action.ontology_get_range` |
| Kind | dispatcher_router |
