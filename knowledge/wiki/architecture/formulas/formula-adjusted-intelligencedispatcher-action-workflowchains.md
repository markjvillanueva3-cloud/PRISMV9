---
title: Formula — router · workflowChains
type: formula
formula_id: formula.adjusted.intelligencedispatcher.action.workflowchains
...
| Field | Value |
|-------|-------|
| Name | `router · workflowChains` |
| Graph node | `formula.adjusted.intelligencedispatcher.action.workflowchains` |
| Kind | dispatcher_router |
