---
title: Formula — router · pfh_list_crashes
type: formula
formula_id: formula.adjusted.devdispatcher.action.pfh_list_crashes
...
# Formula — `router · pfh_list_crashes`
...
| Field | Value |
|-------|-------|
| Name | `router · pfh_list_crashes` |
| Graph node | `formula.adjusted.devdispatcher.action.pfh_list_crashes` |
| Kind | dispatcher_router |
