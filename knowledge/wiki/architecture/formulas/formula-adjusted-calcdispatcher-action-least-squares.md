---
title: Formula — router · least_squares
type: formula
formula_id: formula.adjusted.calcdispatcher.action.least_squares
...
| Field | Value |
|-------|-------|
| Name | `router · least_squares` |
| Graph node | `formula.adjusted.calcdispatcher.action.least_squares` |
| Kind | dispatcher_router |
