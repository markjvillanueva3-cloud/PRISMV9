---
title: Formula — router · constitutive
type: formula
formula_id: formula.adjusted.camdispatcher.action.constitutive
...
| Field | Value |
|-------|-------|
| Name | `router · constitutive` |
| Graph node | `formula.adjusted.camdispatcher.action.constitutive` |
| Kind | dispatcher_router |
