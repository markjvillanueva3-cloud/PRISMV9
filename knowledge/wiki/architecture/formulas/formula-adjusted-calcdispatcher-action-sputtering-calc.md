---
title: Formula — router · sputtering_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sputtering_calc
...
# Formula — `router · sputtering_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · sputtering_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.sputtering_calc` |
| Kind | dispatcher_router |
