---
title: Formula — router · nxGen
type: formula
formula_id: formula.adjusted.caddispatcher.action.nxgen
...
|-------|-------|
| Name | `router · nxGen` |
| Graph node | `formula.adjusted.caddispatcher.action.nxgen` |
| Kind | dispatcher_router |
