---
title: Formula — router · wedm_online_list
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_online_list
...
# Formula — `router · wedm_online_list`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_online_list` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_online_list` |
| Kind | dispatcher_router |
