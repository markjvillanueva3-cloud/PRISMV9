---
title: Formula — router · wedm_online_update
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_online_update
...
# Formula — `router · wedm_online_update`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_online_update` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_online_update` |
| Kind | dispatcher_router |
