---
title: Formula — router · ccd_check_move
type: formula
formula_id: formula.adjusted.devdispatcher.action.ccd_check_move
...
| Field | Value |
|-------|-------|
| Name | `router · ccd_check_move` |
| Graph node | `formula.adjusted.devdispatcher.action.ccd_check_move` |
| Kind | dispatcher_router |
