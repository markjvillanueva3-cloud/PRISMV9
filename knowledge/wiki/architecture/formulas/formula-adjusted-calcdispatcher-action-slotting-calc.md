---
title: Formula — router · slotting_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.slotting_calc
...
| Field | Value |
|-------|-------|
| Name | `router · slotting_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.slotting_calc` |
| Kind | dispatcher_router |
