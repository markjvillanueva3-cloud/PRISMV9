---
title: Formula — router · cam_tooltip_reset
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_tooltip_reset
...
# Formula — `router · cam_tooltip_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_tooltip_reset` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_tooltip_reset` |
| Kind | dispatcher_router |
