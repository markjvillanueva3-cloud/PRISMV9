---
title: Formula — router · wedm_online_state
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_online_state
...
# Formula — `router · wedm_online_state`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_online_state` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_online_state` |
| Kind | dispatcher_router |
