---
title: Formula — router · screw_jack_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.screw_jack_calc
...
# Formula — `router · screw_jack_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · screw_jack_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.screw_jack_calc` |
| Kind | dispatcher_router |
