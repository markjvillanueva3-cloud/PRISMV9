---
title: Formula — router · nxCAMCtrlCat
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcamctrlcat
...
| Field | Value |
|-------|-------|
| Name | `router · nxCAMCtrlCat` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcamctrlcat` |
| Kind | dispatcher_router |
