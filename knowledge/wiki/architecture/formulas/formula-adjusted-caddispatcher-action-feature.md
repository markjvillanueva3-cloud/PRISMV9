---
title: Formula — router · feature
type: formula
formula_id: formula.adjusted.caddispatcher.action.feature
...
|-------|-------|
| Name | `router · feature` |
| Graph node | `formula.adjusted.caddispatcher.action.feature` |
| Kind | dispatcher_router |
