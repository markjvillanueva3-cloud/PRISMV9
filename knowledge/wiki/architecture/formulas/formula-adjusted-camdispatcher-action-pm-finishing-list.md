---
title: Formula — router · pm_finishing_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_finishing_list
...
# Formula — `router · pm_finishing_list`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_finishing_list` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_finishing_list` |
| Kind | dispatcher_router |
