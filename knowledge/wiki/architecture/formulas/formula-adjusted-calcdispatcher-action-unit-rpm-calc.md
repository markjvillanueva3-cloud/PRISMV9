---
title: Formula — router · unit_rpm_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.unit_rpm_calc
...
| Field | Value |
|-------|-------|
| Name | `router · unit_rpm_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.unit_rpm_calc` |
| Kind | dispatcher_router |
