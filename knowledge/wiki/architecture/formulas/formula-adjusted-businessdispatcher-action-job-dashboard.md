---
title: Formula — router · job_dashboard
type: formula
formula_id: formula.adjusted.businessdispatcher.action.job_dashboard
...
| Field | Value |
|-------|-------|
| Name | `router · job_dashboard` |
| Graph node | `formula.adjusted.businessdispatcher.action.job_dashboard` |
| Kind | dispatcher_router |
