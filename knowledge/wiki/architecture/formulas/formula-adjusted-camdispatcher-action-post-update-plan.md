---
title: Formula — router · post_update_plan
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_update_plan
...
# Formula — `router · post_update_plan`
...
| Field | Value |
|-------|-------|
| Name | `router · post_update_plan` |
| Graph node | `formula.adjusted.camdispatcher.action.post_update_plan` |
| Kind | dispatcher_router |
