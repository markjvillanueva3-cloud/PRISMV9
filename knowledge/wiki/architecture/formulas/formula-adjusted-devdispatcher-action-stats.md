---
title: Formula — router · stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.stats
...
|-------|-------|
| Name | `router · stats` |
| Graph node | `formula.adjusted.devdispatcher.action.stats` |
| Kind | dispatcher_router |
