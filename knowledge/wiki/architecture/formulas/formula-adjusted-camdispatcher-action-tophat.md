---
title: Formula — router · tophat
type: formula
formula_id: formula.adjusted.camdispatcher.action.tophat
...
|-------|-------|
| Name | `router · tophat` |
| Graph node | `formula.adjusted.camdispatcher.action.tophat` |
| Kind | dispatcher_router |
