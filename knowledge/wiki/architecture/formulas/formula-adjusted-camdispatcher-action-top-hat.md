---
title: Formula — router · top_hat
type: formula
formula_id: formula.adjusted.camdispatcher.action.top_hat
...
|-------|-------|
| Name | `router · top_hat` |
| Graph node | `formula.adjusted.camdispatcher.action.top_hat` |
| Kind | dispatcher_router |
