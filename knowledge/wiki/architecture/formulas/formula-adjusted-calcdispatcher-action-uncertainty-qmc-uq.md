---
title: Formula — router · uncertainty_qmc_uq
type: formula
formula_id: formula.adjusted.calcdispatcher.action.uncertainty_qmc_uq
...
# Formula — `router · uncertainty_qmc_uq`
...
| Field | Value |
|-------|-------|
| Name | `router · uncertainty_qmc_uq` |
| Graph node | `formula.adjusted.calcdispatcher.action.uncertainty_qmc_uq` |
| Kind | dispatcher_router |
