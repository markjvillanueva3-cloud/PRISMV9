---
title: Formula — router · hyperMillCodeGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.hypermillcodegen
...
# Formula — `router · hyperMillCodeGen`
...
| Field | Value |
|-------|-------|
| Name | `router · hyperMillCodeGen` |
| Graph node | `formula.adjusted.camdispatcher.action.hypermillcodegen` |
| Kind | dispatcher_router |
