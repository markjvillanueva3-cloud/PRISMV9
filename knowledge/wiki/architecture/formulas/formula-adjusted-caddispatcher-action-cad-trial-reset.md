---
title: Formula — router · cad_trial_reset
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_trial_reset
...
# Formula — `router · cad_trial_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_trial_reset` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_trial_reset` |
| Kind | dispatcher_router |
