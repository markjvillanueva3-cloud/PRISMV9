---
title: Formula — router · pm_roughing_get_op
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_roughing_get_op
...
# Formula — `router · pm_roughing_get_op`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_roughing_get_op` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_roughing_get_op` |
| Kind | dispatcher_router |
