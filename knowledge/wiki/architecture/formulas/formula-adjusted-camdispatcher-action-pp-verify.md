---
title: Formula — router · pp_verify
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_verify
...
| Field | Value |
|-------|-------|
| Name | `router · pp_verify` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_verify` |
| Kind | dispatcher_router |
