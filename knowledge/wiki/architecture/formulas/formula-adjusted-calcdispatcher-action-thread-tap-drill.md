---
title: Formula — router · thread_tap_drill
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thread_tap_drill
...
# Formula — `router · thread_tap_drill`
...
| Field | Value |
|-------|-------|
| Name | `router · thread_tap_drill` |
| Graph node | `formula.adjusted.calcdispatcher.action.thread_tap_drill` |
| Kind | dispatcher_router |
