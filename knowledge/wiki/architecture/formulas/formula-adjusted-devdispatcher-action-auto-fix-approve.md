---
title: Formula — router · auto_fix_approve
type: formula
formula_id: formula.adjusted.devdispatcher.action.auto_fix_approve
...
# Formula — `router · auto_fix_approve`
...
| Field | Value |
|-------|-------|
| Name | `router · auto_fix_approve` |
| Graph node | `formula.adjusted.devdispatcher.action.auto_fix_approve` |
| Kind | dispatcher_router |
