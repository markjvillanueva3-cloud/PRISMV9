---
title: Formula — router · cut_to_learn
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cut_to_learn
...
| Field | Value |
|-------|-------|
| Name | `router · cut_to_learn` |
| Graph node | `formula.adjusted.calcdispatcher.action.cut_to_learn` |
| Kind | dispatcher_router |
