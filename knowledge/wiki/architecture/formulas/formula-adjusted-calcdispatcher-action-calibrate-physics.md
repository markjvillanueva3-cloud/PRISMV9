---
title: Formula — router · calibrate_physics
type: formula
formula_id: formula.adjusted.calcdispatcher.action.calibrate_physics
...
# Formula — `router · calibrate_physics`
...
| Field | Value |
|-------|-------|
| Name | `router · calibrate_physics` |
| Graph node | `formula.adjusted.calcdispatcher.action.calibrate_physics` |
| Kind | dispatcher_router |
