---
title: Formula — router · cam_simulate
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_simulate
...
| Field | Value |
|-------|-------|
| Name | `router · cam_simulate` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_simulate` |
| Kind | dispatcher_router |
