---
title: Formula — router · pm_schedule_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.pm_schedule_list
...
# Formula — `router · pm_schedule_list`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_schedule_list` |
| Graph node | `formula.adjusted.businessdispatcher.action.pm_schedule_list` |
| Kind | dispatcher_router |
