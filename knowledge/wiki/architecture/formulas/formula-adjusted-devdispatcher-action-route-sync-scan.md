---
title: Formula — router · route_sync_scan
type: formula
formula_id: formula.adjusted.devdispatcher.action.route_sync_scan
...
# Formula — `router · route_sync_scan`
...
| Field | Value |
|-------|-------|
| Name | `router · route_sync_scan` |
| Graph node | `formula.adjusted.devdispatcher.action.route_sync_scan` |
| Kind | dispatcher_router |
