---
title: Formula — router · sfc_calculate
type: formula
formula_id: formula.adjusted.productdispatcher.action.sfc_calculate
...
| Field | Value |
|-------|-------|
| Name | `router · sfc_calculate` |
| Graph node | `formula.adjusted.productdispatcher.action.sfc_calculate` |
| Kind | dispatcher_router |
