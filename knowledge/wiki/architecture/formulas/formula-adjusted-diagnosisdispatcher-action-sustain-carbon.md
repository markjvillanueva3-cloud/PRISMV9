---
title: Formula — router · sustain_carbon
type: formula
formula_id: formula.adjusted.diagnosisdispatcher.action.sustain_carbon
...
| Field | Value |
|-------|-------|
| Name | `router · sustain_carbon` |
| Graph node | `formula.adjusted.diagnosisdispatcher.action.sustain_carbon` |
| Kind | dispatcher_router |
