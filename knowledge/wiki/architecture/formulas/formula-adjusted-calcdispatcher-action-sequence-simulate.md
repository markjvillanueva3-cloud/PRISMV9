---
title: Formula — router · sequence_simulate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sequence_simulate
...
# Formula — `router · sequence_simulate`
...
| Field | Value |
|-------|-------|
| Name | `router · sequence_simulate` |
| Graph node | `formula.adjusted.calcdispatcher.action.sequence_simulate` |
| Kind | dispatcher_router |
