---
title: Formula — router · voxel_remove_path
type: formula
formula_id: formula.adjusted.calcdispatcher.action.voxel_remove_path
...
# Formula — `router · voxel_remove_path`
...
| Field | Value |
|-------|-------|
| Name | `router · voxel_remove_path` |
| Graph node | `formula.adjusted.calcdispatcher.action.voxel_remove_path` |
| Kind | dispatcher_router |
