---
title: Formula — router · printReading
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.printreading
...
| Field | Value |
|-------|-------|
| Name | `router · printReading` |
| Graph node | `formula.adjusted.qualitydispatcher.action.printreading` |
| Kind | dispatcher_router |
