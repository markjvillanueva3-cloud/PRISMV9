---
title: Formula — router · box_safety_check
type: formula
formula_id: formula.adjusted.datadispatcher.action.box_safety_check
...
# Formula — `router · box_safety_check`
...
| Field | Value |
|-------|-------|
| Name | `router · box_safety_check` |
| Graph node | `formula.adjusted.datadispatcher.action.box_safety_check` |
| Kind | dispatcher_router |
