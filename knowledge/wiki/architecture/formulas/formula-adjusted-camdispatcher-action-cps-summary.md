---
title: Formula — router · cps_summary
type: formula
formula_id: formula.adjusted.camdispatcher.action.cps_summary
...
| Field | Value |
|-------|-------|
| Name | `router · cps_summary` |
| Graph node | `formula.adjusted.camdispatcher.action.cps_summary` |
| Kind | dispatcher_router |
