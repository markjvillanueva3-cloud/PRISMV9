---
title: Formula — router · consistency_check
type: formula
formula_id: formula.adjusted.calcdispatcher.action.consistency_check
...
# Formula — `router · consistency_check`
...
| Field | Value |
|-------|-------|
| Name | `router · consistency_check` |
| Graph node | `formula.adjusted.calcdispatcher.action.consistency_check` |
| Kind | dispatcher_router |
