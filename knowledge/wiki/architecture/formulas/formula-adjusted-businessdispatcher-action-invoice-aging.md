---
title: Formula — router · invoice_aging
type: formula
formula_id: formula.adjusted.businessdispatcher.action.invoice_aging
...
| Field | Value |
|-------|-------|
| Name | `router · invoice_aging` |
| Graph node | `formula.adjusted.businessdispatcher.action.invoice_aging` |
| Kind | dispatcher_router |
