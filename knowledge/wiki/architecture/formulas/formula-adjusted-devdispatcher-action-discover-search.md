---
title: Formula — router · discover_search
type: formula
formula_id: formula.adjusted.devdispatcher.action.discover_search
...
# Formula — `router · discover_search`
...
| Field | Value |
|-------|-------|
| Name | `router · discover_search` |
| Graph node | `formula.adjusted.devdispatcher.action.discover_search` |
| Kind | dispatcher_router |
