---
title: Formula — router · pattern_record
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.pattern_record
...
| Field | Value |
|-------|-------|
| Name | `router · pattern_record` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.pattern_record` |
| Kind | dispatcher_router |
