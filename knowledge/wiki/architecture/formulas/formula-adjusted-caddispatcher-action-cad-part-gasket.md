---
title: Formula — router · cad_part_gasket
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_part_gasket
...
# Formula — `router · cad_part_gasket`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_part_gasket` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_part_gasket` |
| Kind | dispatcher_router |
