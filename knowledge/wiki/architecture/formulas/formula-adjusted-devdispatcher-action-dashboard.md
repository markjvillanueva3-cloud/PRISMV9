---
title: Formula — router · dashboard
type: formula
formula_id: formula.adjusted.devdispatcher.action.dashboard
...
| Graph node | `formula.adjusted.devdispatcher.action.dashboard` |
| Kind | dispatcher_router |
