---
title: Formula — router · strategyComparison
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategycomparison
...
# Formula — `router · strategyComparison`
...
| Field | Value |
|-------|-------|
| Name | `router · strategyComparison` |
| Graph node | `formula.adjusted.camdispatcher.action.strategycomparison` |
| Kind | dispatcher_router |
