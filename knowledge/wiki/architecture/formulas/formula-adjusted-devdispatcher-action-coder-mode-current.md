---
title: Formula — router · coder_mode_current
type: formula
formula_id: formula.adjusted.devdispatcher.action.coder_mode_current
...
# Formula — `router · coder_mode_current`
...
| Field | Value |
|-------|-------|
| Name | `router · coder_mode_current` |
| Graph node | `formula.adjusted.devdispatcher.action.coder_mode_current` |
| Kind | dispatcher_router |
