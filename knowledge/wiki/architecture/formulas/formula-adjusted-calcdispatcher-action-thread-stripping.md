---
title: Formula — router · thread_stripping
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thread_stripping
...
# Formula — `router · thread_stripping`
...
| Field | Value |
|-------|-------|
| Name | `router · thread_stripping` |
| Graph node | `formula.adjusted.calcdispatcher.action.thread_stripping` |
| Kind | dispatcher_router |
