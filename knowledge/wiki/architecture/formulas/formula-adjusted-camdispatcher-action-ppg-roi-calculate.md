---
title: Formula — router · ppg_roi_calculate
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_roi_calculate
...
# Formula — `router · ppg_roi_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_roi_calculate` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_roi_calculate` |
| Kind | dispatcher_router |
