---
title: Formula — router · coolant_flow_check
type: formula
formula_id: formula.adjusted.calcdispatcher.action.coolant_flow_check
...
# Formula — `router · coolant_flow_check`
...
| Field | Value |
|-------|-------|
| Name | `router · coolant_flow_check` |
| Graph node | `formula.adjusted.calcdispatcher.action.coolant_flow_check` |
| Kind | dispatcher_router |
