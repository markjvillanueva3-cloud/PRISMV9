---
title: Formula — router · chip_load_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.chip_load_calc
...
| Field | Value |
|-------|-------|
| Name | `router · chip_load_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.chip_load_calc` |
| Kind | dispatcher_router |
