---
title: Formula — router · solidcam5AxisIndex
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcam5axisindex
...
# Formula — `router · solidcam5AxisIndex`
...
| Field | Value |
|-------|-------|
| Name | `router · solidcam5AxisIndex` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcam5axisindex` |
| Kind | dispatcher_router |
