---
title: Formula — router · pp_analyze_safety
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_analyze_safety
...
# Formula — `router · pp_analyze_safety`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_analyze_safety` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_analyze_safety` |
| Kind | dispatcher_router |
