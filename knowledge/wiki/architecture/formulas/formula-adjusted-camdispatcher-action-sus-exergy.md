---
title: Formula — router · sus_exergy
type: formula
formula_id: formula.adjusted.camdispatcher.action.sus_exergy
...
| Field | Value |
|-------|-------|
| Name | `router · sus_exergy` |
| Graph node | `formula.adjusted.camdispatcher.action.sus_exergy` |
| Kind | dispatcher_router |
