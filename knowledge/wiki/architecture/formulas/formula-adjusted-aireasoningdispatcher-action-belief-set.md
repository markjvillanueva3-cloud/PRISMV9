---
title: Formula — router · belief_set
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.belief_set
...
| Field | Value |
|-------|-------|
| Name | `router · belief_set` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.belief_set` |
| Kind | dispatcher_router |
