---
title: Formula — router · laserAsm
type: formula
formula_id: formula.adjusted.camdispatcher.action.laserasm
...
| Field | Value |
|-------|-------|
| Name | `router · laserAsm` |
| Graph node | `formula.adjusted.camdispatcher.action.laserasm` |
| Kind | dispatcher_router |
