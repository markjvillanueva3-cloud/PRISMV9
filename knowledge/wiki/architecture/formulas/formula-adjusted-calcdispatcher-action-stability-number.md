---
title: Formula — router · stability_number
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stability_number
...
# Formula — `router · stability_number`
...
| Field | Value |
|-------|-------|
| Name | `router · stability_number` |
| Graph node | `formula.adjusted.calcdispatcher.action.stability_number` |
| Kind | dispatcher_router |
