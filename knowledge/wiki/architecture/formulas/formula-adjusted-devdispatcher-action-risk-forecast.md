---
title: Formula — router · risk_forecast
type: formula
formula_id: formula.adjusted.devdispatcher.action.risk_forecast
...
| Field | Value |
|-------|-------|
| Name | `router · risk_forecast` |
| Graph node | `formula.adjusted.devdispatcher.action.risk_forecast` |
| Kind | dispatcher_router |
