---
title: Formula — router · quick_mrr
type: formula
formula_id: formula.adjusted.calcdispatcher.action.quick_mrr
...
| Field | Value |
|-------|-------|
| Name | `router · quick_mrr` |
| Graph node | `formula.adjusted.calcdispatcher.action.quick_mrr` |
| Kind | dispatcher_router |
