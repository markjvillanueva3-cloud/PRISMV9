---
title: Formula — router · fusAIOrch
type: formula
formula_id: formula.adjusted.camdispatcher.action.fusaiorch
...
| Field | Value |
|-------|-------|
| Name | `router · fusAIOrch` |
| Graph node | `formula.adjusted.camdispatcher.action.fusaiorch` |
| Kind | dispatcher_router |
