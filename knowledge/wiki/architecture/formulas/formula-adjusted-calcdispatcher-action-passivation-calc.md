---
title: Formula — router · passivation_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.passivation_calc
...
# Formula — `router · passivation_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · passivation_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.passivation_calc` |
| Kind | dispatcher_router |
