---
title: Formula — router · preview
type: formula
formula_id: formula.adjusted.devdispatcher.action.preview
...
|-------|-------|
| Name | `router · preview` |
| Graph node | `formula.adjusted.devdispatcher.action.preview` |
| Kind | dispatcher_router |
