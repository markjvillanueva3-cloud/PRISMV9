---
title: Formula — router · miner_tool_fatigue
type: formula
formula_id: formula.adjusted.calcdispatcher.action.miner_tool_fatigue
...
# Formula — `router · miner_tool_fatigue`
...
| Field | Value |
|-------|-------|
| Name | `router · miner_tool_fatigue` |
| Graph node | `formula.adjusted.calcdispatcher.action.miner_tool_fatigue` |
| Kind | dispatcher_router |
