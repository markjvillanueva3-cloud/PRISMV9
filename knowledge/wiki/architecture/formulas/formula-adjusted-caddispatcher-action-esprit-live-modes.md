---
title: Formula — router · esprit_live_modes
type: formula
formula_id: formula.adjusted.caddispatcher.action.esprit_live_modes
...
# Formula — `router · esprit_live_modes`
...
| Field | Value |
|-------|-------|
| Name | `router · esprit_live_modes` |
| Graph node | `formula.adjusted.caddispatcher.action.esprit_live_modes` |
| Kind | dispatcher_router |
