---
title: Formula — router · autoSF
type: formula
formula_id: formula.adjusted.camdispatcher.action.autosf
...
|-------|-------|
| Name | `router · autoSF` |
| Graph node | `formula.adjusted.camdispatcher.action.autosf` |
| Kind | dispatcher_router |
