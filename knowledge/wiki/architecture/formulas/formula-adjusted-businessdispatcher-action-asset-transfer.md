---
title: Formula — router · asset_transfer
type: formula
formula_id: formula.adjusted.businessdispatcher.action.asset_transfer
...
| Field | Value |
|-------|-------|
| Name | `router · asset_transfer` |
| Graph node | `formula.adjusted.businessdispatcher.action.asset_transfer` |
| Kind | dispatcher_router |
