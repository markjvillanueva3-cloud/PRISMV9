---
title: Formula — router · workflow_plan
type: formula
formula_id: formula.adjusted.devdispatcher.action.workflow_plan
...
| Field | Value |
|-------|-------|
| Name | `router · workflow_plan` |
| Graph node | `formula.adjusted.devdispatcher.action.workflow_plan` |
| Kind | dispatcher_router |
