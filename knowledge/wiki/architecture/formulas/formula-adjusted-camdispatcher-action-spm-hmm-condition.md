---
title: Formula — router · spm_hmm_condition
type: formula
formula_id: formula.adjusted.camdispatcher.action.spm_hmm_condition
...
# Formula — `router · spm_hmm_condition`
...
| Field | Value |
|-------|-------|
| Name | `router · spm_hmm_condition` |
| Graph node | `formula.adjusted.camdispatcher.action.spm_hmm_condition` |
| Kind | dispatcher_router |
