---
title: Formula — router · aiml_predict
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.aiml_predict
...
| Field | Value |
|-------|-------|
| Name | `router · aiml_predict` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.aiml_predict` |
| Kind | dispatcher_router |
