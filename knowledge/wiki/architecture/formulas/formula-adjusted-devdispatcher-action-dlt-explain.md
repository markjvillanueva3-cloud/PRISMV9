---
title: Formula — router · dlt_explain
type: formula
formula_id: formula.adjusted.devdispatcher.action.dlt_explain
...
| Field | Value |
|-------|-------|
| Name | `router · dlt_explain` |
| Graph node | `formula.adjusted.devdispatcher.action.dlt_explain` |
| Kind | dispatcher_router |
