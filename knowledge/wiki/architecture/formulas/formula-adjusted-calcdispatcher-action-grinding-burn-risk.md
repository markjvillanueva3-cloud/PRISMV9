---
title: Formula — router · grinding_burn_risk
type: formula
formula_id: formula.adjusted.calcdispatcher.action.grinding_burn_risk
...
# Formula — `router · grinding_burn_risk`
...
| Field | Value |
|-------|-------|
| Name | `router · grinding_burn_risk` |
| Graph node | `formula.adjusted.calcdispatcher.action.grinding_burn_risk` |
| Kind | dispatcher_router |
