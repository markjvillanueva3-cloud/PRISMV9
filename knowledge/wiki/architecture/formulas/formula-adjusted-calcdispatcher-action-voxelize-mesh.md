---
title: Formula — router · voxelize_mesh
type: formula
formula_id: formula.adjusted.calcdispatcher.action.voxelize_mesh
...
| Field | Value |
|-------|-------|
| Name | `router · voxelize_mesh` |
| Graph node | `formula.adjusted.calcdispatcher.action.voxelize_mesh` |
| Kind | dispatcher_router |
