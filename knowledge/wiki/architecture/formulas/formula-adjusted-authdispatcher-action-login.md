---
title: Formula — router · login
type: formula
formula_id: formula.adjusted.authdispatcher.action.login
...
|-------|-------|
| Name | `router · login` |
| Graph node | `formula.adjusted.authdispatcher.action.login` |
| Kind | dispatcher_router |
