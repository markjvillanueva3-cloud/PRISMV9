---
title: Formula — router · cadEmbedIndex
type: formula
formula_id: formula.adjusted.caddispatcher.action.cadembedindex
...
| Field | Value |
|-------|-------|
| Name | `router · cadEmbedIndex` |
| Graph node | `formula.adjusted.caddispatcher.action.cadembedindex` |
| Kind | dispatcher_router |
