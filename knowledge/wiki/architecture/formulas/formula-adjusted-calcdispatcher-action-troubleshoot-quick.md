---
title: Formula — router · troubleshoot_quick
type: formula
formula_id: formula.adjusted.calcdispatcher.action.troubleshoot_quick
...
# Formula — `router · troubleshoot_quick`
...
| Field | Value |
|-------|-------|
| Name | `router · troubleshoot_quick` |
| Graph node | `formula.adjusted.calcdispatcher.action.troubleshoot_quick` |
| Kind | dispatcher_router |
