---
title: Formula — router · workflow_create
type: formula
formula_id: formula.adjusted.devdispatcher.action.workflow_create
...
# Formula — `router · workflow_create`
...
| Field | Value |
|-------|-------|
| Name | `router · workflow_create` |
| Graph node | `formula.adjusted.devdispatcher.action.workflow_create` |
| Kind | dispatcher_router |
