---
title: Formula — router · resume_score
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.resume_score
...
| Field | Value |
|-------|-------|
| Name | `router · resume_score` |
| Graph node | `formula.adjusted.sessiondispatcher.action.resume_score` |
| Kind | dispatcher_router |
