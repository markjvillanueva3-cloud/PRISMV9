---
title: Formula — router · part_add_feature
type: formula
formula_id: formula.adjusted.caddispatcher.action.part_add_feature
...
# Formula — `router · part_add_feature`
...
| Field | Value |
|-------|-------|
| Name | `router · part_add_feature` |
| Graph node | `formula.adjusted.caddispatcher.action.part_add_feature` |
| Kind | dispatcher_router |
