---
title: Formula — router · f360_live_fillet
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_fillet
...
# Formula — `router · f360_live_fillet`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_fillet` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_fillet` |
| Kind | dispatcher_router |
