---
title: Formula — router · trainingPipeline
type: formula
formula_id: formula.adjusted.ppdispatcher.action.trainingpipeline
...
# Formula — `router · trainingPipeline`
...
| Field | Value |
|-------|-------|
| Name | `router · trainingPipeline` |
| Graph node | `formula.adjusted.ppdispatcher.action.trainingpipeline` |
| Kind | dispatcher_router |
