---
title: Formula — router · f360_live_export
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_export
...
# Formula — `router · f360_live_export`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_export` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_export` |
| Kind | dispatcher_router |
