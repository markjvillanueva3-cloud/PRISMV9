---
title: Formula — router · hr_pto_balance
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_pto_balance
...
| Field | Value |
|-------|-------|
| Name | `router · hr_pto_balance` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_pto_balance` |
| Kind | dispatcher_router |
