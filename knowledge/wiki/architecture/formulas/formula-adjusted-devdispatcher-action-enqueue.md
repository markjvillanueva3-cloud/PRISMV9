---
title: Formula — router · enqueue
type: formula
formula_id: formula.adjusted.devdispatcher.action.enqueue
...
|-------|-------|
| Name | `router · enqueue` |
| Graph node | `formula.adjusted.devdispatcher.action.enqueue` |
| Kind | dispatcher_router |
