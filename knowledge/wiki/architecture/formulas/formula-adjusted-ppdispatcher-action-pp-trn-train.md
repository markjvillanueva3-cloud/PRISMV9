---
title: Formula — router · pp_trn_train
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_trn_train
...
| Field | Value |
|-------|-------|
| Name | `router · pp_trn_train` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_trn_train` |
| Kind | dispatcher_router |
