---
title: Formula — router · lathe_p2p_ingest
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_p2p_ingest
...
# Formula — `router · lathe_p2p_ingest`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_p2p_ingest` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_p2p_ingest` |
| Kind | dispatcher_router |
