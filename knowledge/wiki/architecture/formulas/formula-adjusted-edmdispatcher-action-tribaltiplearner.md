---
title: Formula — router · tribalTipLearner
type: formula
formula_id: formula.adjusted.edmdispatcher.action.tribaltiplearner
...
# Formula — `router · tribalTipLearner`
...
| Field | Value |
|-------|-------|
| Name | `router · tribalTipLearner` |
| Graph node | `formula.adjusted.edmdispatcher.action.tribaltiplearner` |
| Kind | dispatcher_router |
