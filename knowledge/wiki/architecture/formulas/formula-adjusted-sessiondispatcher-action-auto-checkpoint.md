---
title: Formula — router · auto_checkpoint
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.auto_checkpoint
...
# Formula — `router · auto_checkpoint`
...
| Field | Value |
|-------|-------|
| Name | `router · auto_checkpoint` |
| Graph node | `formula.adjusted.sessiondispatcher.action.auto_checkpoint` |
| Kind | dispatcher_router |
