---
title: Formula — router · latheSFReasoning
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathesfreasoning
...
# Formula — `router · latheSFReasoning`
...
| Field | Value |
|-------|-------|
| Name | `router · latheSFReasoning` |
| Graph node | `formula.adjusted.camdispatcher.action.lathesfreasoning` |
| Kind | dispatcher_router |
