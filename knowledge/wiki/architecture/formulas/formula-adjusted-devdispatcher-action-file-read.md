---
title: Formula — router · file_read
type: formula
formula_id: formula.adjusted.devdispatcher.action.file_read
...
| Field | Value |
|-------|-------|
| Name | `router · file_read` |
| Graph node | `formula.adjusted.devdispatcher.action.file_read` |
| Kind | dispatcher_router |
