---
title: Formula — router · robust_outliers
type: formula
formula_id: formula.adjusted.calcdispatcher.action.robust_outliers
...
# Formula — `router · robust_outliers`
...
| Field | Value |
|-------|-------|
| Name | `router · robust_outliers` |
| Graph node | `formula.adjusted.calcdispatcher.action.robust_outliers` |
| Kind | dispatcher_router |
