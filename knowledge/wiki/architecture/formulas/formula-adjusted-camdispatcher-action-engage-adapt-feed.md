---
title: Formula — router · engage_adapt_feed
type: formula
formula_id: formula.adjusted.camdispatcher.action.engage_adapt_feed
...
# Formula — `router · engage_adapt_feed`
...
| Field | Value |
|-------|-------|
| Name | `router · engage_adapt_feed` |
| Graph node | `formula.adjusted.camdispatcher.action.engage_adapt_feed` |
| Kind | dispatcher_router |
