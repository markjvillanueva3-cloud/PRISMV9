---
title: Formula — router · capability_number
type: formula
formula_id: formula.adjusted.calcdispatcher.action.capability_number
...
# Formula — `router · capability_number`
...
| Field | Value |
|-------|-------|
| Name | `router · capability_number` |
| Graph node | `formula.adjusted.calcdispatcher.action.capability_number` |
| Kind | dispatcher_router |
