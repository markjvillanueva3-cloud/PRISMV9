---
title: Formula — router · error_budget
type: formula
formula_id: formula.adjusted.calcdispatcher.action.error_budget
...
| Field | Value |
|-------|-------|
| Name | `router · error_budget` |
| Graph node | `formula.adjusted.calcdispatcher.action.error_budget` |
| Kind | dispatcher_router |
