---
title: Formula — router · po_approve
type: formula
formula_id: formula.adjusted.businessdispatcher.action.po_approve
...
| Field | Value |
|-------|-------|
| Name | `router · po_approve` |
| Graph node | `formula.adjusted.businessdispatcher.action.po_approve` |
| Kind | dispatcher_router |
