---
title: Formula — router · wireHeating
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wireheating
...
| Field | Value |
|-------|-------|
| Name | `router · wireHeating` |
| Graph node | `formula.adjusted.edmdispatcher.action.wireheating` |
| Kind | dispatcher_router |
