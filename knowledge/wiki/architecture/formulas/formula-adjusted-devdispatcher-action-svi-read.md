---
title: Formula — router · svi_read
type: formula
formula_id: formula.adjusted.devdispatcher.action.svi_read
...
| Field | Value |
|-------|-------|
| Name | `router · svi_read` |
| Graph node | `formula.adjusted.devdispatcher.action.svi_read` |
| Kind | dispatcher_router |
