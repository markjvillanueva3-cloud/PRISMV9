---
title: Formula — router · print_to_hypermill
type: formula
formula_id: formula.adjusted.camdispatcher.action.print_to_hypermill
...
# Formula — `router · print_to_hypermill`
...
| Field | Value |
|-------|-------|
| Name | `router · print_to_hypermill` |
| Graph node | `formula.adjusted.camdispatcher.action.print_to_hypermill` |
| Kind | dispatcher_router |
