---
title: Formula — router · wrtl_by_dispatcher
type: formula
formula_id: formula.adjusted.devdispatcher.action.wrtl_by_dispatcher
...
# Formula — `router · wrtl_by_dispatcher`
...
| Field | Value |
|-------|-------|
| Name | `router · wrtl_by_dispatcher` |
| Graph node | `formula.adjusted.devdispatcher.action.wrtl_by_dispatcher` |
| Kind | dispatcher_router |
