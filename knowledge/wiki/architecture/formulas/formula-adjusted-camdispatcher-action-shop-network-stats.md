---
title: Formula — router · shop_network_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.shop_network_stats
...
# Formula — `router · shop_network_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · shop_network_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.shop_network_stats` |
| Kind | dispatcher_router |
