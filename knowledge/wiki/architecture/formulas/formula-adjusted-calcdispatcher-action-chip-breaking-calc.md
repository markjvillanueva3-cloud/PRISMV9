---
title: Formula — router · chip_breaking_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.chip_breaking_calc
...
# Formula — `router · chip_breaking_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · chip_breaking_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.chip_breaking_calc` |
| Kind | dispatcher_router |
