---
title: Formula — router · ncsimul_export
type: formula
formula_id: formula.adjusted.camdispatcher.action.ncsimul_export
...
| Field | Value |
|-------|-------|
| Name | `router · ncsimul_export` |
| Graph node | `formula.adjusted.camdispatcher.action.ncsimul_export` |
| Kind | dispatcher_router |
