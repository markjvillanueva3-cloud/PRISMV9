---
title: Formula — router · route_sync_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.route_sync_summary
...
# Formula — `router · route_sync_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · route_sync_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.route_sync_summary` |
| Kind | dispatcher_router |
