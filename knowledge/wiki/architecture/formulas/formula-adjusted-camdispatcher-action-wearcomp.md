---
title: Formula — router · wearComp
type: formula
formula_id: formula.adjusted.camdispatcher.action.wearcomp
...
| Field | Value |
|-------|-------|
| Name | `router · wearComp` |
| Graph node | `formula.adjusted.camdispatcher.action.wearcomp` |
| Kind | dispatcher_router |
