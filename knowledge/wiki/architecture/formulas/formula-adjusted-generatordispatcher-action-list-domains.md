---
title: Formula — router · list_domains
type: formula
formula_id: formula.adjusted.generatordispatcher.action.list_domains
...
| Field | Value |
|-------|-------|
| Name | `router · list_domains` |
| Graph node | `formula.adjusted.generatordispatcher.action.list_domains` |
| Kind | dispatcher_router |
