---
title: Formula — router · partLib
type: formula
formula_id: formula.adjusted.caddispatcher.action.partlib
...
|-------|-------|
| Name | `router · partLib` |
| Graph node | `formula.adjusted.caddispatcher.action.partlib` |
| Kind | dispatcher_router |
