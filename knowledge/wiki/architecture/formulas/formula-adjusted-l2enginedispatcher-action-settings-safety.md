---
title: Formula — router · settings_safety
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.settings_safety
...
# Formula — `router · settings_safety`
...
| Field | Value |
|-------|-------|
| Name | `router · settings_safety` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.settings_safety` |
| Kind | dispatcher_router |
