---
title: Formula — router · rel_delay_time
type: formula
formula_id: formula.adjusted.camdispatcher.action.rel_delay_time
...
| Field | Value |
|-------|-------|
| Name | `router · rel_delay_time` |
| Graph node | `formula.adjusted.camdispatcher.action.rel_delay_time` |
| Kind | dispatcher_router |
