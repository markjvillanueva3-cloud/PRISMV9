---
title: Formula — router · schema_history
type: formula
formula_id: formula.adjusted.devdispatcher.action.schema_history
...
| Field | Value |
|-------|-------|
| Name | `router · schema_history` |
| Graph node | `formula.adjusted.devdispatcher.action.schema_history` |
| Kind | dispatcher_router |
