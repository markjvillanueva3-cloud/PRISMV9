---
title: Formula — router · castingQuote
type: formula
formula_id: formula.adjusted.businessdispatcher.action.castingquote
...
| Field | Value |
|-------|-------|
| Name | `router · castingQuote` |
| Graph node | `formula.adjusted.businessdispatcher.action.castingquote` |
| Kind | dispatcher_router |
