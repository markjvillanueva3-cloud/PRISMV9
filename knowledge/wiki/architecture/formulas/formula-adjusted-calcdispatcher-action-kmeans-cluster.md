---
title: Formula — router · kmeans_cluster
type: formula
formula_id: formula.adjusted.calcdispatcher.action.kmeans_cluster
...
| Field | Value |
|-------|-------|
| Name | `router · kmeans_cluster` |
| Graph node | `formula.adjusted.calcdispatcher.action.kmeans_cluster` |
| Kind | dispatcher_router |
