---
title: Formula — router · postProcessGCode
type: formula
formula_id: formula.adjusted.edmdispatcher.action.postprocessgcode
...
# Formula — `router · postProcessGCode`
...
| Field | Value |
|-------|-------|
| Name | `router · postProcessGCode` |
| Graph node | `formula.adjusted.edmdispatcher.action.postprocessgcode` |
| Kind | dispatcher_router |
