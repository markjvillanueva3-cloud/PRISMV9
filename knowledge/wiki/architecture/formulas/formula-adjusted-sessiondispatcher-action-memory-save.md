---
title: Formula — router · memory_save
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.memory_save
...
| Field | Value |
|-------|-------|
| Name | `router · memory_save` |
| Graph node | `formula.adjusted.sessiondispatcher.action.memory_save` |
| Kind | dispatcher_router |
