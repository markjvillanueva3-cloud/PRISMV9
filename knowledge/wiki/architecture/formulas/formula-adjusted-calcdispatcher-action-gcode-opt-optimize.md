---
title: Formula — router · gcode_opt_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gcode_opt_optimize
...
# Formula — `router · gcode_opt_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_opt_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.gcode_opt_optimize` |
| Kind | dispatcher_router |
