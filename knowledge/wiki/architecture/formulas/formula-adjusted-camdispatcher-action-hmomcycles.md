---
title: Formula — router · hmOmCycles
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmomcycles
...
| Field | Value |
|-------|-------|
| Name | `router · hmOmCycles` |
| Graph node | `formula.adjusted.camdispatcher.action.hmomcycles` |
| Kind | dispatcher_router |
