---
title: Formula — router · context_tree
type: formula
formula_id: formula.adjusted.calcdispatcher.action.context_tree
...
| Field | Value |
|-------|-------|
| Name | `router · context_tree` |
| Graph node | `formula.adjusted.calcdispatcher.action.context_tree` |
| Kind | dispatcher_router |
