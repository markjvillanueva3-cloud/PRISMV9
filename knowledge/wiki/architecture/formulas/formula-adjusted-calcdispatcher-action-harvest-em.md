---
title: Formula — router · harvest_em
type: formula
formula_id: formula.adjusted.calcdispatcher.action.harvest_em
...
| Field | Value |
|-------|-------|
| Name | `router · harvest_em` |
| Graph node | `formula.adjusted.calcdispatcher.action.harvest_em` |
| Kind | dispatcher_router |
