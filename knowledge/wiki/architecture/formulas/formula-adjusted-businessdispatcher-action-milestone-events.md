---
title: Formula — router · milestone_events
type: formula
formula_id: formula.adjusted.businessdispatcher.action.milestone_events
...
# Formula — `router · milestone_events`
...
| Field | Value |
|-------|-------|
| Name | `router · milestone_events` |
| Graph node | `formula.adjusted.businessdispatcher.action.milestone_events` |
| Kind | dispatcher_router |
