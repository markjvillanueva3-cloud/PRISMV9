---
title: Formula — router · thread_mill_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thread_mill_calc
...
# Formula — `router · thread_mill_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · thread_mill_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.thread_mill_calc` |
| Kind | dispatcher_router |
