---
title: Formula — router · mastercam_op_get
type: formula
formula_id: formula.adjusted.camdispatcher.action.mastercam_op_get
...
# Formula — `router · mastercam_op_get`
...
| Field | Value |
|-------|-------|
| Name | `router · mastercam_op_get` |
| Graph node | `formula.adjusted.camdispatcher.action.mastercam_op_get` |
| Kind | dispatcher_router |
