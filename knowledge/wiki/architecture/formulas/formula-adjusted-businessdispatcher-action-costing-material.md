---
title: Formula — router · costing_material
type: formula
formula_id: formula.adjusted.businessdispatcher.action.costing_material
...
# Formula — `router · costing_material`
...
| Field | Value |
|-------|-------|
| Name | `router · costing_material` |
| Graph node | `formula.adjusted.businessdispatcher.action.costing_material` |
| Kind | dispatcher_router |
