---
title: Formula — router · tool_chain_suggest
type: formula
formula_id: formula.adjusted.devdispatcher.action.tool_chain_suggest
...
# Formula — `router · tool_chain_suggest`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_chain_suggest` |
| Graph node | `formula.adjusted.devdispatcher.action.tool_chain_suggest` |
| Kind | dispatcher_router |
