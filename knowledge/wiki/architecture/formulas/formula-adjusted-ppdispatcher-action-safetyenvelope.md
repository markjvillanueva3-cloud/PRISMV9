---
title: Formula — router · safetyEnvelope
type: formula
formula_id: formula.adjusted.ppdispatcher.action.safetyenvelope
...
| Field | Value |
|-------|-------|
| Name | `router · safetyEnvelope` |
| Graph node | `formula.adjusted.ppdispatcher.action.safetyenvelope` |
| Kind | dispatcher_router |
