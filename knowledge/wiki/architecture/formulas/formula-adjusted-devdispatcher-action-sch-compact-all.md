---
title: Formula — router · sch_compact_all
type: formula
formula_id: formula.adjusted.devdispatcher.action.sch_compact_all
...
# Formula — `router · sch_compact_all`
...
| Field | Value |
|-------|-------|
| Name | `router · sch_compact_all` |
| Graph node | `formula.adjusted.devdispatcher.action.sch_compact_all` |
| Kind | dispatcher_router |
