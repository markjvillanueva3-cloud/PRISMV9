---
title: Formula — router · ags_propose
type: formula
formula_id: formula.adjusted.devdispatcher.action.ags_propose
...
| Field | Value |
|-------|-------|
| Name | `router · ags_propose` |
| Graph node | `formula.adjusted.devdispatcher.action.ags_propose` |
| Kind | dispatcher_router |
