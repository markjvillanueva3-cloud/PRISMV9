---
title: Formula — router · nxCAMSafety
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcamsafety
...
| Field | Value |
|-------|-------|
| Name | `router · nxCAMSafety` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcamsafety` |
| Kind | dispatcher_router |
