---
title: Formula — router · discover_recommend
type: formula
formula_id: formula.adjusted.devdispatcher.action.discover_recommend
...
# Formula — `router · discover_recommend`
...
| Field | Value |
|-------|-------|
| Name | `router · discover_recommend` |
| Graph node | `formula.adjusted.devdispatcher.action.discover_recommend` |
| Kind | dispatcher_router |
