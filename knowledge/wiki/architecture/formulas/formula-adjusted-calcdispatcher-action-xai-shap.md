---
title: Formula — router · xai_shap
type: formula
formula_id: formula.adjusted.calcdispatcher.action.xai_shap
...
| Field | Value |
|-------|-------|
| Name | `router · xai_shap` |
| Graph node | `formula.adjusted.calcdispatcher.action.xai_shap` |
| Kind | dispatcher_router |
