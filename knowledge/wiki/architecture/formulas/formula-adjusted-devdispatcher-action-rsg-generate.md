---
title: Formula — router · rsg_generate
type: formula
formula_id: formula.adjusted.devdispatcher.action.rsg_generate
...
| Field | Value |
|-------|-------|
| Name | `router · rsg_generate` |
| Graph node | `formula.adjusted.devdispatcher.action.rsg_generate` |
| Kind | dispatcher_router |
