---
title: Formula — router · usm_feasibility
type: formula
formula_id: formula.adjusted.calcdispatcher.action.usm_feasibility
...
# Formula — `router · usm_feasibility`
...
| Field | Value |
|-------|-------|
| Name | `router · usm_feasibility` |
| Graph node | `formula.adjusted.calcdispatcher.action.usm_feasibility` |
| Kind | dispatcher_router |
