---
title: Formula — router · cadAutomation
type: formula
formula_id: formula.adjusted.cadautomationdispatcher
...
| Field | Value |
|-------|-------|
| Name | `router · cadAutomation` |
| Graph node | `formula.adjusted.cadautomationdispatcher` |
| Kind | dispatcher_router |
