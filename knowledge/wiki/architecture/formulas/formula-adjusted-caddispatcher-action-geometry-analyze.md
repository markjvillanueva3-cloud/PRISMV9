---
title: Formula — router · geometry_analyze
type: formula
formula_id: formula.adjusted.caddispatcher.action.geometry_analyze
...
# Formula — `router · geometry_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · geometry_analyze` |
| Graph node | `formula.adjusted.caddispatcher.action.geometry_analyze` |
| Kind | dispatcher_router |
