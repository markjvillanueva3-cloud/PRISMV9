---
title: Formula — router · assembly
type: formula
formula_id: formula.adjusted.caddispatcher.action.assembly
...
| Field | Value |
|-------|-------|
| Name | `router · assembly` |
| Graph node | `formula.adjusted.caddispatcher.action.assembly` |
| Kind | dispatcher_router |
