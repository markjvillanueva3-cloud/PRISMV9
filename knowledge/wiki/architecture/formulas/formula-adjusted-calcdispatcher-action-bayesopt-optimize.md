---
title: Formula — router · bayesopt_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bayesopt_optimize
...
# Formula — `router · bayesopt_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · bayesopt_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.bayesopt_optimize` |
| Kind | dispatcher_router |
