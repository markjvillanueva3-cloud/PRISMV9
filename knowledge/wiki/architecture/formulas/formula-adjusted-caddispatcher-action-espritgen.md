---
title: Formula — router · espritGen
type: formula
formula_id: formula.adjusted.caddispatcher.action.espritgen
...
| Field | Value |
|-------|-------|
| Name | `router · espritGen` |
| Graph node | `formula.adjusted.caddispatcher.action.espritgen` |
| Kind | dispatcher_router |
