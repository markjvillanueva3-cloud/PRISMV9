---
title: Formula — router · geometryParser
type: formula
formula_id: formula.adjusted.edmdispatcher.action.geometryparser
...
| Field | Value |
|-------|-------|
| Name | `router · geometryParser` |
| Graph node | `formula.adjusted.edmdispatcher.action.geometryparser` |
| Kind | dispatcher_router |
