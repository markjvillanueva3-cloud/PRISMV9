---
title: Formula — router · power
type: formula
formula_id: formula.adjusted.calcdispatcher.action.power
...
|-------|-------|
| Name | `router · power` |
| Graph node | `formula.adjusted.calcdispatcher.action.power` |
| Kind | dispatcher_router |
