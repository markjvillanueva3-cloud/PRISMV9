---
title: Formula — router · gl_journal_entry
type: formula
formula_id: formula.adjusted.businessdispatcher.action.gl_journal_entry
...
# Formula — `router · gl_journal_entry`
...
| Field | Value |
|-------|-------|
| Name | `router · gl_journal_entry` |
| Graph node | `formula.adjusted.businessdispatcher.action.gl_journal_entry` |
| Kind | dispatcher_router |
