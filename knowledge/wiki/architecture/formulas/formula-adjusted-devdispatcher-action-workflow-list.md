---
title: Formula — router · workflow_list
type: formula
formula_id: formula.adjusted.devdispatcher.action.workflow_list
...
| Graph node | `formula.adjusted.devdispatcher.action.workflow_list` |
| Kind | dispatcher_router |
