---
title: Formula — router · turning_validate
type: formula
formula_id: formula.adjusted.turningdispatcher.action.turning_validate
...
# Formula — `router · turning_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · turning_validate` |
| Graph node | `formula.adjusted.turningdispatcher.action.turning_validate` |
| Kind | dispatcher_router |
