---
title: Formula — router · mesh_decimate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.mesh_decimate
...
| Field | Value |
|-------|-------|
| Name | `router · mesh_decimate` |
| Graph node | `formula.adjusted.calcdispatcher.action.mesh_decimate` |
| Kind | dispatcher_router |
