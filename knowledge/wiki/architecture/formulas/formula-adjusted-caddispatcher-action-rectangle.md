---
title: Formula — router · rectangle
type: formula
formula_id: formula.adjusted.caddispatcher.action.rectangle
...
| Field | Value |
|-------|-------|
| Name | `router · rectangle` |
| Graph node | `formula.adjusted.caddispatcher.action.rectangle` |
| Kind | dispatcher_router |
