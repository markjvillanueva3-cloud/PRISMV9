---
title: Formula — router · crosscam_compute
type: formula
formula_id: formula.adjusted.toolpathdispatcher.action.crosscam_compute
...
# Formula — `router · crosscam_compute`
...
| Field | Value |
|-------|-------|
| Name | `router · crosscam_compute` |
| Graph node | `formula.adjusted.toolpathdispatcher.action.crosscam_compute` |
| Kind | dispatcher_router |
