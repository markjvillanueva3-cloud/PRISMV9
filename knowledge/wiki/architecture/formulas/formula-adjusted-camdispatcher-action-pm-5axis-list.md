---
title: Formula — router · pm_5axis_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_5axis_list
...
| Field | Value |
|-------|-------|
| Name | `router · pm_5axis_list` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_5axis_list` |
| Kind | dispatcher_router |
