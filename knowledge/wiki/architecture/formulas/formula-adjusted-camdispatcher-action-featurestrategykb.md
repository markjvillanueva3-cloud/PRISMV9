---
title: Formula — router · featureStrategyKB
type: formula
formula_id: formula.adjusted.camdispatcher.action.featurestrategykb
...
# Formula — `router · featureStrategyKB`
...
| Field | Value |
|-------|-------|
| Name | `router · featureStrategyKB` |
| Graph node | `formula.adjusted.camdispatcher.action.featurestrategykb` |
| Kind | dispatcher_router |
