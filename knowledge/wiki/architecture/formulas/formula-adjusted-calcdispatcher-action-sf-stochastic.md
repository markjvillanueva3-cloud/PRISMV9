---
title: Formula — router · sf_stochastic
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sf_stochastic
...
| Field | Value |
|-------|-------|
| Name | `router · sf_stochastic` |
| Graph node | `formula.adjusted.calcdispatcher.action.sf_stochastic` |
| Kind | dispatcher_router |
