---
title: Formula — router · strategy_compare
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategy_compare
...
# Formula — `router · strategy_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_compare` |
| Graph node | `formula.adjusted.camdispatcher.action.strategy_compare` |
| Kind | dispatcher_router |
