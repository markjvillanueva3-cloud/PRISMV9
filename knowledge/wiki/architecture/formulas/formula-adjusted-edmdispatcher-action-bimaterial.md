---
title: Formula — router · biMaterial
type: formula
formula_id: formula.adjusted.edmdispatcher.action.bimaterial
...
| Field | Value |
|-------|-------|
| Name | `router · biMaterial` |
| Graph node | `formula.adjusted.edmdispatcher.action.bimaterial` |
| Kind | dispatcher_router |
