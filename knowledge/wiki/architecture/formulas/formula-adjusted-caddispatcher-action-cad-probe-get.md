---
title: Formula — router · cad_probe_get
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_probe_get
...
| Field | Value |
|-------|-------|
| Name | `router · cad_probe_get` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_probe_get` |
| Kind | dispatcher_router |
