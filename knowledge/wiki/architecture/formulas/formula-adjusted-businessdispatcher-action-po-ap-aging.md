---
title: Formula — router · po_ap_aging
type: formula
formula_id: formula.adjusted.businessdispatcher.action.po_ap_aging
...
| Field | Value |
|-------|-------|
| Name | `router · po_ap_aging` |
| Graph node | `formula.adjusted.businessdispatcher.action.po_ap_aging` |
| Kind | dispatcher_router |
