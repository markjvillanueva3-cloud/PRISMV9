---
title: Formula — router · sketch
type: formula
formula_id: formula.adjusted.caddispatcher.action.sketch
...
|-------|-------|
| Name | `router · sketch` |
| Graph node | `formula.adjusted.caddispatcher.action.sketch` |
| Kind | dispatcher_router |
