---
title: Formula — router · cad_cas_upsert
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_cas_upsert
...
| Field | Value |
|-------|-------|
| Name | `router · cad_cas_upsert` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_cas_upsert` |
| Kind | dispatcher_router |
