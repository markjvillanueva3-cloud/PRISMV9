---
title: Formula — router · cryo_heat_transfer
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cryo_heat_transfer
...
# Formula — `router · cryo_heat_transfer`
...
| Field | Value |
|-------|-------|
| Name | `router · cryo_heat_transfer` |
| Graph node | `formula.adjusted.calcdispatcher.action.cryo_heat_transfer` |
| Kind | dispatcher_router |
