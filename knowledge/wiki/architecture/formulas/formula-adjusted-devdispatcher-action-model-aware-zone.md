---
title: Formula — router · model_aware_zone
type: formula
formula_id: formula.adjusted.devdispatcher.action.model_aware_zone
...
# Formula — `router · model_aware_zone`
...
| Field | Value |
|-------|-------|
| Name | `router · model_aware_zone` |
| Graph node | `formula.adjusted.devdispatcher.action.model_aware_zone` |
| Kind | dispatcher_router |
