---
title: Formula — router · test_generate_scan
type: formula
formula_id: formula.adjusted.devdispatcher.action.test_generate_scan
...
# Formula — `router · test_generate_scan`
...
| Field | Value |
|-------|-------|
| Name | `router · test_generate_scan` |
| Graph node | `formula.adjusted.devdispatcher.action.test_generate_scan` |
| Kind | dispatcher_router |
