---
title: Formula — router · box_post_trainer
type: formula
formula_id: formula.adjusted.datadispatcher.action.box_post_trainer
...
# Formula — `router · box_post_trainer`
...
| Field | Value |
|-------|-------|
| Name | `router · box_post_trainer` |
| Graph node | `formula.adjusted.datadispatcher.action.box_post_trainer` |
| Kind | dispatcher_router |
