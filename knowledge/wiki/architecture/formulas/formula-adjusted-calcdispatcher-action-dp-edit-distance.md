---
title: Formula — router · dp_edit_distance
type: formula
formula_id: formula.adjusted.calcdispatcher.action.dp_edit_distance
...
# Formula — `router · dp_edit_distance`
...
| Field | Value |
|-------|-------|
| Name | `router · dp_edit_distance` |
| Graph node | `formula.adjusted.calcdispatcher.action.dp_edit_distance` |
| Kind | dispatcher_router |
