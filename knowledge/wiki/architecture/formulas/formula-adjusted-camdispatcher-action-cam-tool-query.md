---
title: Formula — router · cam_tool_query
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_tool_query
...
| Field | Value |
|-------|-------|
| Name | `router · cam_tool_query` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_tool_query` |
| Kind | dispatcher_router |
