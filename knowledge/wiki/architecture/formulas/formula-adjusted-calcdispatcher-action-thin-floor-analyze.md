---
title: Formula — router · thin_floor_analyze
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thin_floor_analyze
...
# Formula — `router · thin_floor_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · thin_floor_analyze` |
| Graph node | `formula.adjusted.calcdispatcher.action.thin_floor_analyze` |
| Kind | dispatcher_router |
