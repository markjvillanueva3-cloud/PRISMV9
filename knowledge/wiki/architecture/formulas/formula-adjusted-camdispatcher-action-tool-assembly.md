---
title: Formula — router · tool_assembly
type: formula
formula_id: formula.adjusted.camdispatcher.action.tool_assembly
...
| Field | Value |
|-------|-------|
| Name | `router · tool_assembly` |
| Graph node | `formula.adjusted.camdispatcher.action.tool_assembly` |
| Kind | dispatcher_router |
