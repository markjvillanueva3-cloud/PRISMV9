---
title: Formula — router · nx_addin_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_addin_generate
...
# Formula — `router · nx_addin_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_addin_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_addin_generate` |
| Kind | dispatcher_router |
