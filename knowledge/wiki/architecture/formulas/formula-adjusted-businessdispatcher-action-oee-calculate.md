---
title: Formula — router · oee_calculate
type: formula
formula_id: formula.adjusted.businessdispatcher.action.oee_calculate
...
| Field | Value |
|-------|-------|
| Name | `router · oee_calculate` |
| Graph node | `formula.adjusted.businessdispatcher.action.oee_calculate` |
| Kind | dispatcher_router |
