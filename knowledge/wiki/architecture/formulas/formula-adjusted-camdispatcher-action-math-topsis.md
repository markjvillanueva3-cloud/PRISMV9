---
title: Formula — router · math_topsis
type: formula
formula_id: formula.adjusted.camdispatcher.action.math_topsis
...
| Field | Value |
|-------|-------|
| Name | `router · math_topsis` |
| Graph node | `formula.adjusted.camdispatcher.action.math_topsis` |
| Kind | dispatcher_router |
