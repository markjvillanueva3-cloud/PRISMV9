---
title: Formula — router · tolerance_stack
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.tolerance_stack
...
# Formula — `router · tolerance_stack`
...
| Field | Value |
|-------|-------|
| Name | `router · tolerance_stack` |
| Graph node | `formula.adjusted.qualitydispatcher.action.tolerance_stack` |
| Kind | dispatcher_router |
