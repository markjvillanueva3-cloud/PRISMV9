---
title: Formula — router · cam_lora_ensemble
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_lora_ensemble
...
# Formula — `router · cam_lora_ensemble`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_lora_ensemble` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_lora_ensemble` |
| Kind | dispatcher_router |
