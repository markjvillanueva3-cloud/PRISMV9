---
title: Formula — router · reporting_pareto
type: formula
formula_id: formula.adjusted.businessdispatcher.action.reporting_pareto
...
# Formula — `router · reporting_pareto`
...
| Field | Value |
|-------|-------|
| Name | `router · reporting_pareto` |
| Graph node | `formula.adjusted.businessdispatcher.action.reporting_pareto` |
| Kind | dispatcher_router |
