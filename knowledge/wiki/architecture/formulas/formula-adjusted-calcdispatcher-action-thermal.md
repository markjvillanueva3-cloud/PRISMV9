---
title: Formula — router · thermal
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thermal
...
|-------|-------|
| Name | `router · thermal` |
| Graph node | `formula.adjusted.calcdispatcher.action.thermal` |
| Kind | dispatcher_router |
