---
title: Formula — router · speed_feed_calc
type: formula
formula_id: formula.adjusted.datadispatcher.action.speed_feed_calc
...
# Formula — `router · speed_feed_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · speed_feed_calc` |
| Graph node | `formula.adjusted.datadispatcher.action.speed_feed_calc` |
| Kind | dispatcher_router |
