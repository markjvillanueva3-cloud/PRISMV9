---
title: Formula — router · hypermill_cfg_diff
type: formula
formula_id: formula.adjusted.camdispatcher.action.hypermill_cfg_diff
...
# Formula — `router · hypermill_cfg_diff`
...
| Field | Value |
|-------|-------|
| Name | `router · hypermill_cfg_diff` |
| Graph node | `formula.adjusted.camdispatcher.action.hypermill_cfg_diff` |
| Kind | dispatcher_router |
