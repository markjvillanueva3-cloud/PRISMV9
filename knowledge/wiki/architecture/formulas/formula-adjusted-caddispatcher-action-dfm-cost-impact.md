---
title: Formula — router · dfm_cost_impact
type: formula
formula_id: formula.adjusted.caddispatcher.action.dfm_cost_impact
...
# Formula — `router · dfm_cost_impact`
...
| Field | Value |
|-------|-------|
| Name | `router · dfm_cost_impact` |
| Graph node | `formula.adjusted.caddispatcher.action.dfm_cost_impact` |
| Kind | dispatcher_router |
