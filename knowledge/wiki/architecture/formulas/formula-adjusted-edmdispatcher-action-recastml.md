---
title: Formula — router · recastML
type: formula
formula_id: formula.adjusted.edmdispatcher.action.recastml
...
| Field | Value |
|-------|-------|
| Name | `router · recastML` |
| Graph node | `formula.adjusted.edmdispatcher.action.recastml` |
| Kind | dispatcher_router |
