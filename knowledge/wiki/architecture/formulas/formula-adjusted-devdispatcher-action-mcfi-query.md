---
title: Formula — router · mcfi_query
type: formula
formula_id: formula.adjusted.devdispatcher.action.mcfi_query
...
| Field | Value |
|-------|-------|
| Name | `router · mcfi_query` |
| Graph node | `formula.adjusted.devdispatcher.action.mcfi_query` |
| Kind | dispatcher_router |
