---
title: Formula — router · mastercamSafety
type: formula
formula_id: formula.adjusted.camdispatcher.action.mastercamsafety
...
# Formula — `router · mastercamSafety`
...
| Field | Value |
|-------|-------|
| Name | `router · mastercamSafety` |
| Graph node | `formula.adjusted.camdispatcher.action.mastercamsafety` |
| Kind | dispatcher_router |
