---
title: Formula — router · solidCAMCtrlCat
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcamctrlcat
...
# Formula — `router · solidCAMCtrlCat`
...
| Field | Value |
|-------|-------|
| Name | `router · solidCAMCtrlCat` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcamctrlcat` |
| Kind | dispatcher_router |
