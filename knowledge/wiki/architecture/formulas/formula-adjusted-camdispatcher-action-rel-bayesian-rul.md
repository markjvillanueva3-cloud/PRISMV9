---
title: Formula — router · rel_bayesian_rul
type: formula
formula_id: formula.adjusted.camdispatcher.action.rel_bayesian_rul
...
# Formula — `router · rel_bayesian_rul`
...
| Field | Value |
|-------|-------|
| Name | `router · rel_bayesian_rul` |
| Graph node | `formula.adjusted.camdispatcher.action.rel_bayesian_rul` |
| Kind | dispatcher_router |
