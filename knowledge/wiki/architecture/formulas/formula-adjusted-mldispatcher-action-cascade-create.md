---
title: Formula — router · cascade_create
type: formula
formula_id: formula.adjusted.mldispatcher.action.cascade_create
...
| Field | Value |
|-------|-------|
| Name | `router · cascade_create` |
| Graph node | `formula.adjusted.mldispatcher.action.cascade_create` |
| Kind | dispatcher_router |
