---
title: Formula — router · keyway_calculate
type: formula
formula_id: formula.adjusted.cncopsdispatcher.action.keyway_calculate
...
# Formula — `router · keyway_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · keyway_calculate` |
| Graph node | `formula.adjusted.cncopsdispatcher.action.keyway_calculate` |
| Kind | dispatcher_router |
