---
title: Formula — router · chuck
type: formula
formula_id: formula.adjusted.turningdispatcher.action.chuck
...
|-------|-------|
| Name | `router · chuck` |
| Graph node | `formula.adjusted.turningdispatcher.action.chuck` |
| Kind | dispatcher_router |
