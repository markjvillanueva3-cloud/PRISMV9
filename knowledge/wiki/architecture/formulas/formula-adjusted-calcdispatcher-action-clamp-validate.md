---
title: Formula — router · clamp_validate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.clamp_validate
...
| Field | Value |
|-------|-------|
| Name | `router · clamp_validate` |
| Graph node | `formula.adjusted.calcdispatcher.action.clamp_validate` |
| Kind | dispatcher_router |
