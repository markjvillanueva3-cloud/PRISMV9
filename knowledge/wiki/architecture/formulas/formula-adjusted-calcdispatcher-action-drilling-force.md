---
title: Formula — router · drilling_force
type: formula
formula_id: formula.adjusted.calcdispatcher.action.drilling_force
...
| Field | Value |
|-------|-------|
| Name | `router · drilling_force` |
| Graph node | `formula.adjusted.calcdispatcher.action.drilling_force` |
| Kind | dispatcher_router |
