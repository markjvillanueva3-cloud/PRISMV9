---
title: Formula — router · grafanaBridge
type: formula
formula_id: formula.adjusted.monitoringdispatcher.action.grafanabridge
...
| Field | Value |
|-------|-------|
| Name | `router · grafanaBridge` |
| Graph node | `formula.adjusted.monitoringdispatcher.action.grafanabridge` |
| Kind | dispatcher_router |
