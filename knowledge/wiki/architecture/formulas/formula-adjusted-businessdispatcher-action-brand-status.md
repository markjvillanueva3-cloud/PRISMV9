---
title: Formula — router · brand_status
type: formula
formula_id: formula.adjusted.businessdispatcher.action.brand_status
...
| Field | Value |
|-------|-------|
| Name | `router · brand_status` |
| Graph node | `formula.adjusted.businessdispatcher.action.brand_status` |
| Kind | dispatcher_router |
