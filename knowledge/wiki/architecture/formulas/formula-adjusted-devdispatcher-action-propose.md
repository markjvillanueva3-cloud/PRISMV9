---
title: Formula — router · propose
type: formula
formula_id: formula.adjusted.devdispatcher.action.propose
...
|-------|-------|
| Name | `router · propose` |
| Graph node | `formula.adjusted.devdispatcher.action.propose` |
| Kind | dispatcher_router |
