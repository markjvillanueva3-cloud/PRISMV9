---
title: Formula — router · timeClock
type: formula
formula_id: formula.adjusted.businessdispatcher.action.timeclock
...
| Field | Value |
|-------|-------|
| Name | `router · timeClock` |
| Graph node | `formula.adjusted.businessdispatcher.action.timeclock` |
| Kind | dispatcher_router |
