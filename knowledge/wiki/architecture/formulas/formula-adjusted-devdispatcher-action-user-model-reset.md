---
title: Formula — router · user_model_reset
type: formula
formula_id: formula.adjusted.devdispatcher.action.user_model_reset
...
# Formula — `router · user_model_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · user_model_reset` |
| Graph node | `formula.adjusted.devdispatcher.action.user_model_reset` |
| Kind | dispatcher_router |
