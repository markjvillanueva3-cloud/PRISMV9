---
title: Formula — router · xproc_aps_set
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.xproc_aps_set
...
| Field | Value |
|-------|-------|
| Name | `router · xproc_aps_set` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.xproc_aps_set` |
| Kind | dispatcher_router |
