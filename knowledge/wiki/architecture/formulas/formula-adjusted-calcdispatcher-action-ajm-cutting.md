---
title: Formula — router · ajm_cutting
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ajm_cutting
...
| Field | Value |
|-------|-------|
| Name | `router · ajm_cutting` |
| Graph node | `formula.adjusted.calcdispatcher.action.ajm_cutting` |
| Kind | dispatcher_router |
