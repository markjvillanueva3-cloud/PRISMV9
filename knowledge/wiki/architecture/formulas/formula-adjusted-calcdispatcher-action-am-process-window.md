---
title: Formula — router · am_process_window
type: formula
formula_id: formula.adjusted.calcdispatcher.action.am_process_window
...
# Formula — `router · am_process_window`
...
| Field | Value |
|-------|-------|
| Name | `router · am_process_window` |
| Graph node | `formula.adjusted.calcdispatcher.action.am_process_window` |
| Kind | dispatcher_router |
