---
title: Formula — router · replay_context
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.replay_context
...
| Field | Value |
|-------|-------|
| Name | `router · replay_context` |
| Graph node | `formula.adjusted.sessiondispatcher.action.replay_context` |
| Kind | dispatcher_router |
