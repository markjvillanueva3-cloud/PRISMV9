---
title: Formula — router · camxEnergyOpt
type: formula
formula_id: formula.adjusted.camdispatcher.action.camxenergyopt
...
| Field | Value |
|-------|-------|
| Name | `router · camxEnergyOpt` |
| Graph node | `formula.adjusted.camdispatcher.action.camxenergyopt` |
| Kind | dispatcher_router |
