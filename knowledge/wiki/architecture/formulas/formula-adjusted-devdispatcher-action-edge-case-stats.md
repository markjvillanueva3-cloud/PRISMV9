---
title: Formula — router · edge_case_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.edge_case_stats
...
# Formula — `router · edge_case_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · edge_case_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.edge_case_stats` |
| Kind | dispatcher_router |
