---
title: Formula — router · ramping_calculate
type: formula
formula_id: formula.adjusted.cncopsdispatcher.action.ramping_calculate
...
# Formula — `router · ramping_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · ramping_calculate` |
| Graph node | `formula.adjusted.cncopsdispatcher.action.ramping_calculate` |
| Kind | dispatcher_router |
