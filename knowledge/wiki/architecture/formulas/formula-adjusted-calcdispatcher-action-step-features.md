---
title: Formula — router · step_features
type: formula
formula_id: formula.adjusted.calcdispatcher.action.step_features
...
| Field | Value |
|-------|-------|
| Name | `router · step_features` |
| Graph node | `formula.adjusted.calcdispatcher.action.step_features` |
| Kind | dispatcher_router |
