---
title: Formula — router · me_get_records
type: formula
formula_id: formula.adjusted.devdispatcher.action.me_get_records
...
| Field | Value |
|-------|-------|
| Name | `router · me_get_records` |
| Graph node | `formula.adjusted.devdispatcher.action.me_get_records` |
| Kind | dispatcher_router |
