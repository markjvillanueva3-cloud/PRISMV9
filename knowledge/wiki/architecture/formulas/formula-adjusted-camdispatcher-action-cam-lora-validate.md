---
title: Formula — router · cam_lora_validate
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_lora_validate
...
# Formula — `router · cam_lora_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_lora_validate` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_lora_validate` |
| Kind | dispatcher_router |
