---
title: Formula — router · cam_sdk_batch
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_sdk_batch
...
| Field | Value |
|-------|-------|
| Name | `router · cam_sdk_batch` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_sdk_batch` |
| Kind | dispatcher_router |
