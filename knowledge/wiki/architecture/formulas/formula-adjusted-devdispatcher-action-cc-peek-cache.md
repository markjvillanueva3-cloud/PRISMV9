---
title: Formula — router · cc_peek_cache
type: formula
formula_id: formula.adjusted.devdispatcher.action.cc_peek_cache
...
| Field | Value |
|-------|-------|
| Name | `router · cc_peek_cache` |
| Graph node | `formula.adjusted.devdispatcher.action.cc_peek_cache` |
| Kind | dispatcher_router |
