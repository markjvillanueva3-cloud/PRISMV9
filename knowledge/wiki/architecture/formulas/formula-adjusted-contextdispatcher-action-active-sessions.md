---
title: Formula — router · active_sessions
type: formula
formula_id: formula.adjusted.contextdispatcher.action.active_sessions
...
# Formula — `router · active_sessions`
...
| Field | Value |
|-------|-------|
| Name | `router · active_sessions` |
| Graph node | `formula.adjusted.contextdispatcher.action.active_sessions` |
| Kind | dispatcher_router |
