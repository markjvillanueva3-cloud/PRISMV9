---
title: Formula — router · fatigue_life_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fatigue_life_calc
...
# Formula — `router · fatigue_life_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · fatigue_life_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.fatigue_life_calc` |
| Kind | dispatcher_router |
