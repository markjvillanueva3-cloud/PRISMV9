---
title: Formula — router · test_results
type: formula
formula_id: formula.adjusted.devdispatcher.action.test_results
...
| Field | Value |
|-------|-------|
| Name | `router · test_results` |
| Graph node | `formula.adjusted.devdispatcher.action.test_results` |
| Kind | dispatcher_router |
