---
title: Formula — router · memory_search
type: formula
formula_id: formula.adjusted.devdispatcher.action.memory_search
...
| Field | Value |
|-------|-------|
| Name | `router · memory_search` |
| Graph node | `formula.adjusted.devdispatcher.action.memory_search` |
| Kind | dispatcher_router |
