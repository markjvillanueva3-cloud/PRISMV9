---
title: Formula — router · asset_dep_node
type: formula
formula_id: formula.adjusted.devdispatcher.action.asset_dep_node
...
| Field | Value |
|-------|-------|
| Name | `router · asset_dep_node` |
| Graph node | `formula.adjusted.devdispatcher.action.asset_dep_node` |
| Kind | dispatcher_router |
