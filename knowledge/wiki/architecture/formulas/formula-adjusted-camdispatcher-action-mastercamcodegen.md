---
title: Formula — router · mastercamCodeGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.mastercamcodegen
...
# Formula — `router · mastercamCodeGen`
...
| Field | Value |
|-------|-------|
| Name | `router · mastercamCodeGen` |
| Graph node | `formula.adjusted.camdispatcher.action.mastercamcodegen` |
| Kind | dispatcher_router |
