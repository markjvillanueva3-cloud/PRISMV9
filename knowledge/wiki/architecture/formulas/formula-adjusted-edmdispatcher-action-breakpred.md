---
title: Formula — router · breakPred
type: formula
formula_id: formula.adjusted.edmdispatcher.action.breakpred
...
| Field | Value |
|-------|-------|
| Name | `router · breakPred` |
| Graph node | `formula.adjusted.edmdispatcher.action.breakpred` |
| Kind | dispatcher_router |
