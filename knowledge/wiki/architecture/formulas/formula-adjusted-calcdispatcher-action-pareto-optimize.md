---
title: Formula — router · pareto_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.pareto_optimize
...
# Formula — `router · pareto_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · pareto_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.pareto_optimize` |
| Kind | dispatcher_router |
