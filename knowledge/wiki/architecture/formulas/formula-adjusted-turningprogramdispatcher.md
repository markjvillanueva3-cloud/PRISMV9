---
title: Formula — router · turningProgram
type: formula
formula_id: formula.adjusted.turningprogramdispatcher
...
| Field | Value |
|-------|-------|
| Name | `router · turningProgram` |
| Graph node | `formula.adjusted.turningprogramdispatcher` |
| Kind | dispatcher_router |
