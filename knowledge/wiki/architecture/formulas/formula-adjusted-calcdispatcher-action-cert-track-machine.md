---
title: Formula — router · cert_track_machine
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cert_track_machine
...
# Formula — `router · cert_track_machine`
...
| Field | Value |
|-------|-------|
| Name | `router · cert_track_machine` |
| Graph node | `formula.adjusted.calcdispatcher.action.cert_track_machine` |
| Kind | dispatcher_router |
