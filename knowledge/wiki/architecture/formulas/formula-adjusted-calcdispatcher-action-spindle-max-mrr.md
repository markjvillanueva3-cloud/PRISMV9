---
title: Formula — router · spindle_max_mrr
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spindle_max_mrr
...
# Formula — `router · spindle_max_mrr`
...
| Field | Value |
|-------|-------|
| Name | `router · spindle_max_mrr` |
| Graph node | `formula.adjusted.calcdispatcher.action.spindle_max_mrr` |
| Kind | dispatcher_router |
