---
title: Formula — router · permutation_anova
type: formula
formula_id: formula.adjusted.calcdispatcher.action.permutation_anova
...
# Formula — `router · permutation_anova`
...
| Field | Value |
|-------|-------|
| Name | `router · permutation_anova` |
| Graph node | `formula.adjusted.calcdispatcher.action.permutation_anova` |
| Kind | dispatcher_router |
