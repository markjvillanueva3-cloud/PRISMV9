---
title: Formula — router · quick_tap_drill
type: formula
formula_id: formula.adjusted.calcdispatcher.action.quick_tap_drill
...
# Formula — `router · quick_tap_drill`
...
| Field | Value |
|-------|-------|
| Name | `router · quick_tap_drill` |
| Graph node | `formula.adjusted.calcdispatcher.action.quick_tap_drill` |
| Kind | dispatcher_router |
