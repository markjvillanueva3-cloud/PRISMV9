---
title: Formula — router · regression_huber
type: formula
formula_id: formula.adjusted.calcdispatcher.action.regression_huber
...
# Formula — `router · regression_huber`
...
| Field | Value |
|-------|-------|
| Name | `router · regression_huber` |
| Graph node | `formula.adjusted.calcdispatcher.action.regression_huber` |
| Kind | dispatcher_router |
