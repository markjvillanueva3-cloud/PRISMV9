---
title: Formula — router · cam_post_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_post_list
...
| Field | Value |
|-------|-------|
| Name | `router · cam_post_list` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_post_list` |
| Kind | dispatcher_router |
