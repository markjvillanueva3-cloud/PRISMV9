---
title: Formula — router · postVerification
type: formula
formula_id: formula.adjusted.camdispatcher.action.postverification
...
# Formula — `router · postVerification`
...
| Field | Value |
|-------|-------|
| Name | `router · postVerification` |
| Graph node | `formula.adjusted.camdispatcher.action.postverification` |
| Kind | dispatcher_router |
