---
title: Formula — router · geometry_select
type: formula
formula_id: formula.adjusted.calcdispatcher.action.geometry_select
...
# Formula — `router · geometry_select`
...
| Field | Value |
|-------|-------|
| Name | `router · geometry_select` |
| Graph node | `formula.adjusted.calcdispatcher.action.geometry_select` |
| Kind | dispatcher_router |
