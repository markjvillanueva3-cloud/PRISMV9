---
title: Formula — router · dv_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.dv_stats
...
| Field | Value |
|-------|-------|
| Name | `router · dv_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.dv_stats` |
| Kind | dispatcher_router |
