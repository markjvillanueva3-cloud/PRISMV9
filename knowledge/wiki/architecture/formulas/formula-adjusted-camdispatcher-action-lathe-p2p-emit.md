---
title: Formula — router · lathe_p2p_emit
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_p2p_emit
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_p2p_emit` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_p2p_emit` |
| Kind | dispatcher_router |
