---
title: Formula — router · laser
type: formula
formula_id: formula.adjusted.edmdispatcher.action.laser
...
|-------|-------|
| Name | `router · laser` |
| Graph node | `formula.adjusted.edmdispatcher.action.laser` |
| Kind | dispatcher_router |
