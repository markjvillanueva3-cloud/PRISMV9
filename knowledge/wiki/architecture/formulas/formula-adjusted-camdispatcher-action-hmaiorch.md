---
title: Formula — router · hmAIOrch
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmaiorch
...
| Field | Value |
|-------|-------|
| Name | `router · hmAIOrch` |
| Graph node | `formula.adjusted.camdispatcher.action.hmaiorch` |
| Kind | dispatcher_router |
