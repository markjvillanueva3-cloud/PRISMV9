---
title: Formula — router · additive_quote
type: formula
formula_id: formula.adjusted.businessdispatcher.action.additive_quote
...
| Field | Value |
|-------|-------|
| Name | `router · additive_quote` |
| Graph node | `formula.adjusted.businessdispatcher.action.additive_quote` |
| Kind | dispatcher_router |
