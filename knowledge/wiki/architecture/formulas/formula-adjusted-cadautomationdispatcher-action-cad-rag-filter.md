---
title: Formula — router · cad_rag_filter
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_rag_filter
...
| Field | Value |
|-------|-------|
| Name | `router · cad_rag_filter` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_rag_filter` |
| Kind | dispatcher_router |
