---
title: Formula — router · pm_unified_catalog
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_unified_catalog
...
# Formula — `router · pm_unified_catalog`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_unified_catalog` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_unified_catalog` |
| Kind | dispatcher_router |
