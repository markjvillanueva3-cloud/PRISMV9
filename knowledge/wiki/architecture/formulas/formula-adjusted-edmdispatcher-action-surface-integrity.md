---
title: Formula — router · surface_integrity
type: formula
formula_id: formula.adjusted.edmdispatcher.action.surface_integrity
...
# Formula — `router · surface_integrity`
...
| Field | Value |
|-------|-------|
| Name | `router · surface_integrity` |
| Graph node | `formula.adjusted.edmdispatcher.action.surface_integrity` |
| Kind | dispatcher_router |
