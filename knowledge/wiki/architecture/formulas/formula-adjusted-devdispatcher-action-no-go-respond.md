---
title: Formula — router · no_go_respond
type: formula
formula_id: formula.adjusted.devdispatcher.action.no_go_respond
...
| Field | Value |
|-------|-------|
| Name | `router · no_go_respond` |
| Graph node | `formula.adjusted.devdispatcher.action.no_go_respond` |
| Kind | dispatcher_router |
