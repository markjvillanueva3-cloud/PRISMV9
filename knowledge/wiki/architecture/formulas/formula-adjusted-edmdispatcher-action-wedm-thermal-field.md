---
title: Formula — router · wedm_thermal_field
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_thermal_field
...
# Formula — `router · wedm_thermal_field`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_thermal_field` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_thermal_field` |
| Kind | dispatcher_router |
