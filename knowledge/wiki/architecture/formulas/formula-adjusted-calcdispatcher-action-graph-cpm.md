---
title: Formula — router · graph_cpm
type: formula
formula_id: formula.adjusted.calcdispatcher.action.graph_cpm
...
| Field | Value |
|-------|-------|
| Name | `router · graph_cpm` |
| Graph node | `formula.adjusted.calcdispatcher.action.graph_cpm` |
| Kind | dispatcher_router |
