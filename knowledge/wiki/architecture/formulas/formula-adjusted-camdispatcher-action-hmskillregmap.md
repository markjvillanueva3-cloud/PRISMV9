---
title: Formula — router · hmSkillRegMap
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmskillregmap
...
| Field | Value |
|-------|-------|
| Name | `router · hmSkillRegMap` |
| Graph node | `formula.adjusted.camdispatcher.action.hmskillregmap` |
| Kind | dispatcher_router |
