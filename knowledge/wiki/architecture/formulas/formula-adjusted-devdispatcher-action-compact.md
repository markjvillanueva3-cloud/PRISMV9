---
title: Formula — router · compact
type: formula
formula_id: formula.adjusted.devdispatcher.action.compact
...
|-------|-------|
| Name | `router · compact` |
| Graph node | `formula.adjusted.devdispatcher.action.compact` |
| Kind | dispatcher_router |
