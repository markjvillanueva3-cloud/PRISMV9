---
title: Formula — router · get_state
type: formula
formula_id: formula.adjusted.devdispatcher.action.get_state
...
| Field | Value |
|-------|-------|
| Name | `router · get_state` |
| Graph node | `formula.adjusted.devdispatcher.action.get_state` |
| Kind | dispatcher_router |
