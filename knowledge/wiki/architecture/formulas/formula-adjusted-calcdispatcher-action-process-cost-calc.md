---
title: Formula — router · process_cost_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.process_cost_calc
...
# Formula — `router · process_cost_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · process_cost_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.process_cost_calc` |
| Kind | dispatcher_router |
