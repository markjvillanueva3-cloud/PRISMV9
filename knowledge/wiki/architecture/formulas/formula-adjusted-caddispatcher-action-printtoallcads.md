---
title: Formula — router · printToAllCads
type: formula
formula_id: formula.adjusted.caddispatcher.action.printtoallcads
...
| Field | Value |
|-------|-------|
| Name | `router · printToAllCads` |
| Graph node | `formula.adjusted.caddispatcher.action.printtoallcads` |
| Kind | dispatcher_router |
