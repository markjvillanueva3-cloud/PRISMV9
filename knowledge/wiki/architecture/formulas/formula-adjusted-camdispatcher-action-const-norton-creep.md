---
title: Formula — router · const_norton_creep
type: formula
formula_id: formula.adjusted.camdispatcher.action.const_norton_creep
...
# Formula — `router · const_norton_creep`
...
| Field | Value |
|-------|-------|
| Name | `router · const_norton_creep` |
| Graph node | `formula.adjusted.camdispatcher.action.const_norton_creep` |
| Kind | dispatcher_router |
