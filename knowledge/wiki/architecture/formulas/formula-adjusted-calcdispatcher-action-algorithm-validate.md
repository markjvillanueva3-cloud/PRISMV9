---
title: Formula — router · algorithm_validate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.algorithm_validate
...
# Formula — `router · algorithm_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · algorithm_validate` |
| Graph node | `formula.adjusted.calcdispatcher.action.algorithm_validate` |
| Kind | dispatcher_router |
