---
title: Formula — router · chain
type: formula
formula_id: formula.adjusted.hookdispatcher.action.chain
...
|-------|-------|
| Name | `router · chain` |
| Graph node | `formula.adjusted.hookdispatcher.action.chain` |
| Kind | dispatcher_router |
