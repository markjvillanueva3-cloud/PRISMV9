---
title: Formula — router · parse_cmm_export
type: formula
formula_id: formula.adjusted.calcdispatcher.action.parse_cmm_export
...
# Formula — `router · parse_cmm_export`
...
| Field | Value |
|-------|-------|
| Name | `router · parse_cmm_export` |
| Graph node | `formula.adjusted.calcdispatcher.action.parse_cmm_export` |
| Kind | dispatcher_router |
