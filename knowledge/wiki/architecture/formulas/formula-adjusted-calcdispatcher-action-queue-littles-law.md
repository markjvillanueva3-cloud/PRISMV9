---
title: Formula — router · queue_littles_law
type: formula
formula_id: formula.adjusted.calcdispatcher.action.queue_littles_law
...
# Formula — `router · queue_littles_law`
...
| Field | Value |
|-------|-------|
| Name | `router · queue_littles_law` |
| Graph node | `formula.adjusted.calcdispatcher.action.queue_littles_law` |
| Kind | dispatcher_router |
