---
title: Formula — router · sinker
type: formula
formula_id: formula.adjusted.edmdispatcher.action.sinker
...
|-------|-------|
| Name | `router · sinker` |
| Graph node | `formula.adjusted.edmdispatcher.action.sinker` |
| Kind | dispatcher_router |
