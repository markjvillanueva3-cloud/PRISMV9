---
title: Formula — router · conv_budget_check
type: formula
formula_id: formula.adjusted.devdispatcher.action.conv_budget_check
...
# Formula — `router · conv_budget_check`
...
| Field | Value |
|-------|-------|
| Name | `router · conv_budget_check` |
| Graph node | `formula.adjusted.devdispatcher.action.conv_budget_check` |
| Kind | dispatcher_router |
