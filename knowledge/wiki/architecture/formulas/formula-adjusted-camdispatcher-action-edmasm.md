---
title: Formula — router · edmAsm
type: formula
formula_id: formula.adjusted.camdispatcher.action.edmasm
...
|-------|-------|
| Name | `router · edmAsm` |
| Graph node | `formula.adjusted.camdispatcher.action.edmasm` |
| Kind | dispatcher_router |
