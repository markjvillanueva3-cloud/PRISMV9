---
title: Formula — router · digital_twin_sync
type: formula
formula_id: formula.adjusted.calcdispatcher.action.digital_twin_sync
...
# Formula — `router · digital_twin_sync`
...
| Field | Value |
|-------|-------|
| Name | `router · digital_twin_sync` |
| Graph node | `formula.adjusted.calcdispatcher.action.digital_twin_sync` |
| Kind | dispatcher_router |
