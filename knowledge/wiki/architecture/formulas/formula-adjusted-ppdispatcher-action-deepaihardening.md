---
title: Formula — router · deepAIHardening
type: formula
formula_id: formula.adjusted.ppdispatcher.action.deepaihardening
...
# Formula — `router · deepAIHardening`
...
| Field | Value |
|-------|-------|
| Name | `router · deepAIHardening` |
| Graph node | `formula.adjusted.ppdispatcher.action.deepaihardening` |
| Kind | dispatcher_router |
