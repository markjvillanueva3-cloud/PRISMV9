---
title: Formula — router · ppg_probe_wcs
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_probe_wcs
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_probe_wcs` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_probe_wcs` |
| Kind | dispatcher_router |
