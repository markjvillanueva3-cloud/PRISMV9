---
title: Formula — router · rotary_kiln_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rotary_kiln_calc
...
# Formula — `router · rotary_kiln_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · rotary_kiln_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.rotary_kiln_calc` |
| Kind | dispatcher_router |
