---
title: Formula — router · cam_material_map
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_material_map
...
# Formula — `router · cam_material_map`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_material_map` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_material_map` |
| Kind | dispatcher_router |
