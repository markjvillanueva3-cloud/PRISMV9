---
title: Formula — router · inventory_abc
type: formula
formula_id: formula.adjusted.businessdispatcher.action.inventory_abc
...
| Field | Value |
|-------|-------|
| Name | `router · inventory_abc` |
| Graph node | `formula.adjusted.businessdispatcher.action.inventory_abc` |
| Kind | dispatcher_router |
