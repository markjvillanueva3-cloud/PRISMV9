---
title: Formula — router · top_p95
type: formula
formula_id: formula.adjusted.devdispatcher.action.top_p95
...
|-------|-------|
| Name | `router · top_p95` |
| Graph node | `formula.adjusted.devdispatcher.action.top_p95` |
| Kind | dispatcher_router |
