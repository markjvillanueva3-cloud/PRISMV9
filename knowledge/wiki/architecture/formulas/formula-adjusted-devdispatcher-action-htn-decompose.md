---
title: Formula — router · htn_decompose
type: formula
formula_id: formula.adjusted.devdispatcher.action.htn_decompose
...
| Field | Value |
|-------|-------|
| Name | `router · htn_decompose` |
| Graph node | `formula.adjusted.devdispatcher.action.htn_decompose` |
| Kind | dispatcher_router |
