---
title: Formula — router · nx_material_search
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_material_search
...
# Formula — `router · nx_material_search`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_material_search` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_material_search` |
| Kind | dispatcher_router |
