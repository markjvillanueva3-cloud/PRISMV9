---
title: Formula — router · rbe_get_execution
type: formula
formula_id: formula.adjusted.devdispatcher.action.rbe_get_execution
...
# Formula — `router · rbe_get_execution`
...
| Field | Value |
|-------|-------|
| Name | `router · rbe_get_execution` |
| Graph node | `formula.adjusted.devdispatcher.action.rbe_get_execution` |
| Kind | dispatcher_router |
