---
title: Formula — router · context_load_plan
type: formula
formula_id: formula.adjusted.devdispatcher.action.context_load_plan
...
# Formula — `router · context_load_plan`
...
| Field | Value |
|-------|-------|
| Name | `router · context_load_plan` |
| Graph node | `formula.adjusted.devdispatcher.action.context_load_plan` |
| Kind | dispatcher_router |
