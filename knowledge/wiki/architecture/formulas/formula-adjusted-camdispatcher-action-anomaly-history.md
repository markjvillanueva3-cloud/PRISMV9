---
title: Formula — router · anomaly_history
type: formula
formula_id: formula.adjusted.camdispatcher.action.anomaly_history
...
# Formula — `router · anomaly_history`
...
| Field | Value |
|-------|-------|
| Name | `router · anomaly_history` |
| Graph node | `formula.adjusted.camdispatcher.action.anomaly_history` |
| Kind | dispatcher_router |
