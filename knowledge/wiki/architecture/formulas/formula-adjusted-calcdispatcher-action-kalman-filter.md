---
title: Formula — router · kalman_filter
type: formula
formula_id: formula.adjusted.calcdispatcher.action.kalman_filter
...
| Field | Value |
|-------|-------|
| Name | `router · kalman_filter` |
| Graph node | `formula.adjusted.calcdispatcher.action.kalman_filter` |
| Kind | dispatcher_router |
