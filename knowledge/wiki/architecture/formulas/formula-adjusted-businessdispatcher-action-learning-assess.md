---
title: Formula — router · learning_assess
type: formula
formula_id: formula.adjusted.businessdispatcher.action.learning_assess
...
# Formula — `router · learning_assess`
...
| Field | Value |
|-------|-------|
| Name | `router · learning_assess` |
| Graph node | `formula.adjusted.businessdispatcher.action.learning_assess` |
| Kind | dispatcher_router |
