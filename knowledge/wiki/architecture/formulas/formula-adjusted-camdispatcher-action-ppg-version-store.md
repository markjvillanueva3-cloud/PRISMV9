---
title: Formula — router · ppg_version_store
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_version_store
...
# Formula — `router · ppg_version_store`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_version_store` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_version_store` |
| Kind | dispatcher_router |
