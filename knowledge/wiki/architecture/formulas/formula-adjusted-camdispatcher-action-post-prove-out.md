---
title: Formula — router · post_prove_out
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_prove_out
...
| Field | Value |
|-------|-------|
| Name | `router · post_prove_out` |
| Graph node | `formula.adjusted.camdispatcher.action.post_prove_out` |
| Kind | dispatcher_router |
