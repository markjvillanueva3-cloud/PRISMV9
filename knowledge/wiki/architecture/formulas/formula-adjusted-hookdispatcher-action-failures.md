---
title: Formula — router · failures
type: formula
formula_id: formula.adjusted.hookdispatcher.action.failures
...
| Field | Value |
|-------|-------|
| Name | `router · failures` |
| Graph node | `formula.adjusted.hookdispatcher.action.failures` |
| Kind | dispatcher_router |
