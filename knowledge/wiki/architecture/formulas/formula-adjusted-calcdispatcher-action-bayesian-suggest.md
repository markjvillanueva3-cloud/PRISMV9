---
title: Formula — router · bayesian_suggest
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bayesian_suggest
...
# Formula — `router · bayesian_suggest`
...
| Field | Value |
|-------|-------|
| Name | `router · bayesian_suggest` |
| Graph node | `formula.adjusted.calcdispatcher.action.bayesian_suggest` |
| Kind | dispatcher_router |
