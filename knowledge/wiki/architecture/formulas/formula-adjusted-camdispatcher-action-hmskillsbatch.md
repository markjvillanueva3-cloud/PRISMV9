---
title: Formula — router · hmSkillsBatch
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmskillsbatch
...
| Field | Value |
|-------|-------|
| Name | `router · hmSkillsBatch` |
| Graph node | `formula.adjusted.camdispatcher.action.hmskillsbatch` |
| Kind | dispatcher_router |
