---
title: Formula — router · spray_drying_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spray_drying_calc
...
# Formula — `router · spray_drying_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · spray_drying_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.spray_drying_calc` |
| Kind | dispatcher_router |
