---
title: Formula — router · cryo_tool_life
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cryo_tool_life
...
| Field | Value |
|-------|-------|
| Name | `router · cryo_tool_life` |
| Graph node | `formula.adjusted.calcdispatcher.action.cryo_tool_life` |
| Kind | dispatcher_router |
