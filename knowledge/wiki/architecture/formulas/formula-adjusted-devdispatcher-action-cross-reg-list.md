---
title: Formula — router · cross_reg_list
type: formula
formula_id: formula.adjusted.devdispatcher.action.cross_reg_list
...
| Field | Value |
|-------|-------|
| Name | `router · cross_reg_list` |
| Graph node | `formula.adjusted.devdispatcher.action.cross_reg_list` |
| Kind | dispatcher_router |
