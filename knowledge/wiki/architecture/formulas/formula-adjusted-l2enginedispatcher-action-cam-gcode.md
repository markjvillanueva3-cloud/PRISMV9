---
title: Formula — router · cam_gcode
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.cam_gcode
...
| Field | Value |
|-------|-------|
| Name | `router · cam_gcode` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.cam_gcode` |
| Kind | dispatcher_router |
