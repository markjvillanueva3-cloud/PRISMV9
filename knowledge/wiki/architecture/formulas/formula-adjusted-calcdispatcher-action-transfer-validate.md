---
title: Formula — router · transfer_validate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.transfer_validate
...
# Formula — `router · transfer_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · transfer_validate` |
| Graph node | `formula.adjusted.calcdispatcher.action.transfer_validate` |
| Kind | dispatcher_router |
