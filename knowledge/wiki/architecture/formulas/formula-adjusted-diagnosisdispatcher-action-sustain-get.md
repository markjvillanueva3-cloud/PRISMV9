---
title: Formula — router · sustain_get
type: formula
formula_id: formula.adjusted.diagnosisdispatcher.action.sustain_get
...
| Field | Value |
|-------|-------|
| Name | `router · sustain_get` |
| Graph node | `formula.adjusted.diagnosisdispatcher.action.sustain_get` |
| Kind | dispatcher_router |
