---
title: Formula — router · cad_cas_load
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_cas_load
...
| Field | Value |
|-------|-------|
| Name | `router · cad_cas_load` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_cas_load` |
| Kind | dispatcher_router |
