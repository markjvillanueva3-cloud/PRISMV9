---
title: Formula — router · tco_dashboard
type: formula
formula_id: formula.adjusted.camdispatcher.action.tco_dashboard
...
| Field | Value |
|-------|-------|
| Name | `router · tco_dashboard` |
| Graph node | `formula.adjusted.camdispatcher.action.tco_dashboard` |
| Kind | dispatcher_router |
