---
title: Formula — router · wcs_setup
type: formula
formula_id: formula.adjusted.caddispatcher.action.wcs_setup
...
| Field | Value |
|-------|-------|
| Name | `router · wcs_setup` |
| Graph node | `formula.adjusted.caddispatcher.action.wcs_setup` |
| Kind | dispatcher_router |
