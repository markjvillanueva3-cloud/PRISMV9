---
title: Formula — router · cad_thumb_get
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_thumb_get
...
| Field | Value |
|-------|-------|
| Name | `router · cad_thumb_get` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_thumb_get` |
| Kind | dispatcher_router |
