---
title: Formula — router · powermill_op_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.powermill_op_list
...
# Formula — `router · powermill_op_list`
...
| Field | Value |
|-------|-------|
| Name | `router · powermill_op_list` |
| Graph node | `formula.adjusted.camdispatcher.action.powermill_op_list` |
| Kind | dispatcher_router |
