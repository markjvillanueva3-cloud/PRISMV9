---
title: Formula — router · wedm_gnn_attend
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_gnn_attend
...
# Formula — `router · wedm_gnn_attend`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_gnn_attend` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_gnn_attend` |
| Kind | dispatcher_router |
