---
title: Formula — router · honing_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.honing_calc
...
| Field | Value |
|-------|-------|
| Name | `router · honing_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.honing_calc` |
| Kind | dispatcher_router |
