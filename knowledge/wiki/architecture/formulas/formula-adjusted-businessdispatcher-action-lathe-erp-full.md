---
title: Formula — router · lathe_erp_full
type: formula
formula_id: formula.adjusted.businessdispatcher.action.lathe_erp_full
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_erp_full` |
| Graph node | `formula.adjusted.businessdispatcher.action.lathe_erp_full` |
| Kind | dispatcher_router |
