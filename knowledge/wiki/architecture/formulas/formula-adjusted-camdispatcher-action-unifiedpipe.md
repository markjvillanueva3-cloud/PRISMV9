---
title: Formula — router · unifiedPipe
type: formula
formula_id: formula.adjusted.camdispatcher.action.unifiedpipe
...
| Field | Value |
|-------|-------|
| Name | `router · unifiedPipe` |
| Graph node | `formula.adjusted.camdispatcher.action.unifiedpipe` |
| Kind | dispatcher_router |
