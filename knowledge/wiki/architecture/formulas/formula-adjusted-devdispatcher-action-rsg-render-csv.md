---
title: Formula — router · rsg_render_csv
type: formula
formula_id: formula.adjusted.devdispatcher.action.rsg_render_csv
...
| Field | Value |
|-------|-------|
| Name | `router · rsg_render_csv` |
| Graph node | `formula.adjusted.devdispatcher.action.rsg_render_csv` |
| Kind | dispatcher_router |
