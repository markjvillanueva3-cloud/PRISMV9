---
title: Formula — router · accuracy_report
type: formula
formula_id: formula.adjusted.calcdispatcher.action.accuracy_report
...
# Formula — `router · accuracy_report`
...
| Field | Value |
|-------|-------|
| Name | `router · accuracy_report` |
| Graph node | `formula.adjusted.calcdispatcher.action.accuracy_report` |
| Kind | dispatcher_router |
