---
title: Formula — router · cluster_silhouette
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cluster_silhouette
...
# Formula — `router · cluster_silhouette`
...
| Field | Value |
|-------|-------|
| Name | `router · cluster_silhouette` |
| Graph node | `formula.adjusted.calcdispatcher.action.cluster_silhouette` |
| Kind | dispatcher_router |
