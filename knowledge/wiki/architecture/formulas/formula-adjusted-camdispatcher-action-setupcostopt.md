---
title: Formula — router · setupCostOpt
type: formula
formula_id: formula.adjusted.camdispatcher.action.setupcostopt
...
| Field | Value |
|-------|-------|
| Name | `router · setupCostOpt` |
| Graph node | `formula.adjusted.camdispatcher.action.setupcostopt` |
| Kind | dispatcher_router |
