---
title: Formula — router · graph_bellman_ford
type: formula
formula_id: formula.adjusted.calcdispatcher.action.graph_bellman_ford
...
# Formula — `router · graph_bellman_ford`
...
| Field | Value |
|-------|-------|
| Name | `router · graph_bellman_ford` |
| Graph node | `formula.adjusted.calcdispatcher.action.graph_bellman_ford` |
| Kind | dispatcher_router |
