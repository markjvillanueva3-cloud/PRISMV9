---
title: Formula — router · build_script
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.build_script
...
| Field | Value |
|-------|-------|
| Name | `router · build_script` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.build_script` |
| Kind | dispatcher_router |
