---
title: Formula — router · const_ptw
type: formula
formula_id: formula.adjusted.camdispatcher.action.const_ptw
...
| Field | Value |
|-------|-------|
| Name | `router · const_ptw` |
| Graph node | `formula.adjusted.camdispatcher.action.const_ptw` |
| Kind | dispatcher_router |
