---
title: Formula — router · controllerMatrix
type: formula
formula_id: formula.adjusted.camdispatcher.action.controllermatrix
...
# Formula — `router · controllerMatrix`
...
| Field | Value |
|-------|-------|
| Name | `router · controllerMatrix` |
| Graph node | `formula.adjusted.camdispatcher.action.controllermatrix` |
| Kind | dispatcher_router |
