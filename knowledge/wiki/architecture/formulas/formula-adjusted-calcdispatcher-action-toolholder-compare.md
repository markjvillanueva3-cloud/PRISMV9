---
title: Formula — router · toolholder_compare
type: formula
formula_id: formula.adjusted.calcdispatcher.action.toolholder_compare
...
# Formula — `router · toolholder_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · toolholder_compare` |
| Graph node | `formula.adjusted.calcdispatcher.action.toolholder_compare` |
| Kind | dispatcher_router |
