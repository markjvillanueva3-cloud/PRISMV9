---
title: Formula — router · rl_post_learn
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rl_post_learn
...
| Field | Value |
|-------|-------|
| Name | `router · rl_post_learn` |
| Graph node | `formula.adjusted.calcdispatcher.action.rl_post_learn` |
| Kind | dispatcher_router |
