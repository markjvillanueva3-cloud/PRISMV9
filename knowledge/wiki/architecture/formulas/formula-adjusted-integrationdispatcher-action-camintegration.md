---
title: Formula — router · camIntegration
type: formula
formula_id: formula.adjusted.integrationdispatcher.action.camintegration
...
| Field | Value |
|-------|-------|
| Name | `router · camIntegration` |
| Graph node | `formula.adjusted.integrationdispatcher.action.camintegration` |
| Kind | dispatcher_router |
