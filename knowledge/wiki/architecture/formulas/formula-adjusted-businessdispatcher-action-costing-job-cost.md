---
title: Formula — router · costing_job_cost
type: formula
formula_id: formula.adjusted.businessdispatcher.action.costing_job_cost
...
# Formula — `router · costing_job_cost`
...
| Field | Value |
|-------|-------|
| Name | `router · costing_job_cost` |
| Graph node | `formula.adjusted.businessdispatcher.action.costing_job_cost` |
| Kind | dispatcher_router |
