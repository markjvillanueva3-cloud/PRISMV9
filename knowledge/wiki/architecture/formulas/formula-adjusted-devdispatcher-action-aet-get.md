---
title: Formula — router · aet_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.aet_get
...
|-------|-------|
| Name | `router · aet_get` |
| Graph node | `formula.adjusted.devdispatcher.action.aet_get` |
| Kind | dispatcher_router |
