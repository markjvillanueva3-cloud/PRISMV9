---
title: Formula — router · creative_solve
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.creative_solve
...
| Field | Value |
|-------|-------|
| Name | `router · creative_solve` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.creative_solve` |
| Kind | dispatcher_router |
