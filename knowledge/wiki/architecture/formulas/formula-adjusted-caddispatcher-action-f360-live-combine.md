---
title: Formula — router · f360_live_combine
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_combine
...
# Formula — `router · f360_live_combine`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_combine` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_combine` |
| Kind | dispatcher_router |
