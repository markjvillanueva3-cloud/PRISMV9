---
title: Formula — router · compact_diff_stat
type: formula
formula_id: formula.adjusted.devdispatcher.action.compact_diff_stat
...
# Formula — `router · compact_diff_stat`
...
| Field | Value |
|-------|-------|
| Name | `router · compact_diff_stat` |
| Graph node | `formula.adjusted.devdispatcher.action.compact_diff_stat` |
| Kind | dispatcher_router |
