---
title: Formula — router · post_fleet_status
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_fleet_status
...
# Formula — `router · post_fleet_status`
...
| Field | Value |
|-------|-------|
| Name | `router · post_fleet_status` |
| Graph node | `formula.adjusted.camdispatcher.action.post_fleet_status` |
| Kind | dispatcher_router |
