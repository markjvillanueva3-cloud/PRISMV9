---
title: Formula — router · geometry_job_plan
type: formula
formula_id: formula.adjusted.calcdispatcher.action.geometry_job_plan
...
# Formula — `router · geometry_job_plan`
...
| Field | Value |
|-------|-------|
| Name | `router · geometry_job_plan` |
| Graph node | `formula.adjusted.calcdispatcher.action.geometry_job_plan` |
| Kind | dispatcher_router |
