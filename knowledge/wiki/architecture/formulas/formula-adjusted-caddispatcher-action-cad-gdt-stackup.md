---
title: Formula — router · cad_gdt_stackup
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_gdt_stackup
...
# Formula — `router · cad_gdt_stackup`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_gdt_stackup` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_gdt_stackup` |
| Kind | dispatcher_router |
