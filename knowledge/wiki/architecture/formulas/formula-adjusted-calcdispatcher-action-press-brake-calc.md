---
title: Formula — router · press_brake_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.press_brake_calc
...
# Formula — `router · press_brake_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · press_brake_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.press_brake_calc` |
| Kind | dispatcher_router |
