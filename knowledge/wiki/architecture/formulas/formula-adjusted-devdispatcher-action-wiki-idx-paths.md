---
title: Formula — router · wiki_idx_paths
type: formula
formula_id: formula.adjusted.devdispatcher.action.wiki_idx_paths
...
| Field | Value |
|-------|-------|
| Name | `router · wiki_idx_paths` |
| Graph node | `formula.adjusted.devdispatcher.action.wiki_idx_paths` |
| Kind | dispatcher_router |
