---
title: Formula — router · auto_fix_read
type: formula
formula_id: formula.adjusted.devdispatcher.action.auto_fix_read
...
| Field | Value |
|-------|-------|
| Name | `router · auto_fix_read` |
| Graph node | `formula.adjusted.devdispatcher.action.auto_fix_read` |
| Kind | dispatcher_router |
