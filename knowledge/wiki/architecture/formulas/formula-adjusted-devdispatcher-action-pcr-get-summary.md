---
title: Formula — router · pcr_get_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.pcr_get_summary
...
# Formula — `router · pcr_get_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · pcr_get_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.pcr_get_summary` |
| Kind | dispatcher_router |
