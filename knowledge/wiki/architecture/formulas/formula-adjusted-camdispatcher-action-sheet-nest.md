---
title: Formula — router · sheet_nest
type: formula
formula_id: formula.adjusted.camdispatcher.action.sheet_nest
...
| Field | Value |
|-------|-------|
| Name | `router · sheet_nest` |
| Graph node | `formula.adjusted.camdispatcher.action.sheet_nest` |
| Kind | dispatcher_router |
