---
title: Formula — router · laser_drilling
type: formula
formula_id: formula.adjusted.calcdispatcher.action.laser_drilling
...
| Field | Value |
|-------|-------|
| Name | `router · laser_drilling` |
| Graph node | `formula.adjusted.calcdispatcher.action.laser_drilling` |
| Kind | dispatcher_router |
