---
title: Formula — router · f360_live_chamfer
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_chamfer
...
# Formula — `router · f360_live_chamfer`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_chamfer` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_chamfer` |
| Kind | dispatcher_router |
