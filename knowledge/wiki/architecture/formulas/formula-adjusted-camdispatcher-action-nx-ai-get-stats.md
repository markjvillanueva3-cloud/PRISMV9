---
title: Formula — router · nx_ai_get_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_ai_get_stats
...
# Formula — `router · nx_ai_get_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_ai_get_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_ai_get_stats` |
| Kind | dispatcher_router |
