---
title: Formula — router · budget_trim_preset
type: formula
formula_id: formula.adjusted.devdispatcher.action.budget_trim_preset
...
# Formula — `router · budget_trim_preset`
...
| Field | Value |
|-------|-------|
| Name | `router · budget_trim_preset` |
| Graph node | `formula.adjusted.devdispatcher.action.budget_trim_preset` |
| Kind | dispatcher_router |
