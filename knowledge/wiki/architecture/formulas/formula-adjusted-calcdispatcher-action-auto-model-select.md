---
title: Formula — router · auto_model_select
type: formula
formula_id: formula.adjusted.calcdispatcher.action.auto_model_select
...
# Formula — `router · auto_model_select`
...
| Field | Value |
|-------|-------|
| Name | `router · auto_model_select` |
| Graph node | `formula.adjusted.calcdispatcher.action.auto_model_select` |
| Kind | dispatcher_router |
