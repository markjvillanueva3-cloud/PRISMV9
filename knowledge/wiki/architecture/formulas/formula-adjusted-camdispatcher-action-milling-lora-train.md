---
title: Formula — router · milling_lora_train
type: formula
formula_id: formula.adjusted.camdispatcher.action.milling_lora_train
...
# Formula — `router · milling_lora_train`
...
| Field | Value |
|-------|-------|
| Name | `router · milling_lora_train` |
| Graph node | `formula.adjusted.camdispatcher.action.milling_lora_train` |
| Kind | dispatcher_router |
