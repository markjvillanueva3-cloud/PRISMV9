---
title: Formula — router · maint_history
type: formula
formula_id: formula.adjusted.machinelivedispatcher.action.maint_history
...
| Field | Value |
|-------|-------|
| Name | `router · maint_history` |
| Graph node | `formula.adjusted.machinelivedispatcher.action.maint_history` |
| Kind | dispatcher_router |
