---
title: Formula — router · lbd_get_budget
type: formula
formula_id: formula.adjusted.devdispatcher.action.lbd_get_budget
...
| Field | Value |
|-------|-------|
| Name | `router · lbd_get_budget` |
| Graph node | `formula.adjusted.devdispatcher.action.lbd_get_budget` |
| Kind | dispatcher_router |
