---
title: Formula — router · wedm_spark_erosion
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_spark_erosion
...
# Formula — `router · wedm_spark_erosion`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_spark_erosion` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_spark_erosion` |
| Kind | dispatcher_router |
