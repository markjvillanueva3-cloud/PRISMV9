---
title: Formula — router · sustain_compare
type: formula
formula_id: formula.adjusted.diagnosisdispatcher.action.sustain_compare
...
# Formula — `router · sustain_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · sustain_compare` |
| Graph node | `formula.adjusted.diagnosisdispatcher.action.sustain_compare` |
| Kind | dispatcher_router |
