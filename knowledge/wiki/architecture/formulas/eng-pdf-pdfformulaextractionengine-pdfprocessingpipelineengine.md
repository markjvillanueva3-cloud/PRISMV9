---
title: Formula — PDFProcessingPipelineEngine
type: formula
formula_id: eng.pdf.pdfformulaextractionengine.pdfprocessingpipelineengine
...
# Formula — `PDFProcessingPipelineEngine`
...
| Field | Value |
|-------|-------|
| Name | `PDFProcessingPipelineEngine` |
| Graph node | `eng.pdf.pdfformulaextractionengine.pdfprocessingpipelineengine` |
| Kind | pdf.pdfformulaextractionengine_engines |
