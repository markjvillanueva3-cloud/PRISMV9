---
title: Formula — router · self_learn_fleet
type: formula
formula_id: formula.adjusted.camdispatcher.action.self_learn_fleet
...
# Formula — `router · self_learn_fleet`
...
| Field | Value |
|-------|-------|
| Name | `router · self_learn_fleet` |
| Graph node | `formula.adjusted.camdispatcher.action.self_learn_fleet` |
| Kind | dispatcher_router |
