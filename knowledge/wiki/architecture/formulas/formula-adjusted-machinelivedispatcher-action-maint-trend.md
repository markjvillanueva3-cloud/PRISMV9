---
title: Formula — router · maint_trend
type: formula
formula_id: formula.adjusted.machinelivedispatcher.action.maint_trend
...
| Field | Value |
|-------|-------|
| Name | `router · maint_trend` |
| Graph node | `formula.adjusted.machinelivedispatcher.action.maint_trend` |
| Kind | dispatcher_router |
