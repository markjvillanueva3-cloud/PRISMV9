---
title: Formula — router · cmm_plan_path
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cmm_plan_path
...
| Field | Value |
|-------|-------|
| Name | `router · cmm_plan_path` |
| Graph node | `formula.adjusted.calcdispatcher.action.cmm_plan_path` |
| Kind | dispatcher_router |
