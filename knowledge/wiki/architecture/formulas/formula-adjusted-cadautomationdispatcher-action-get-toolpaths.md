---
title: Formula — router · get_toolpaths
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.get_toolpaths
...
| Field | Value |
|-------|-------|
| Name | `router · get_toolpaths` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.get_toolpaths` |
| Kind | dispatcher_router |
