---
title: Formula — router · post_get_options
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_get_options
...
# Formula — `router · post_get_options`
...
| Field | Value |
|-------|-------|
| Name | `router · post_get_options` |
| Graph node | `formula.adjusted.camdispatcher.action.post_get_options` |
| Kind | dispatcher_router |
