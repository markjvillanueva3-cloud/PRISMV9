---
title: Formula — router · eb_welding_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.eb_welding_calc
...
# Formula — `router · eb_welding_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · eb_welding_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.eb_welding_calc` |
| Kind | dispatcher_router |
