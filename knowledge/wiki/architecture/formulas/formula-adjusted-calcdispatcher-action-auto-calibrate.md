---
title: Formula — router · auto_calibrate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.auto_calibrate
...
| Field | Value |
|-------|-------|
| Name | `router · auto_calibrate` |
| Graph node | `formula.adjusted.calcdispatcher.action.auto_calibrate` |
| Kind | dispatcher_router |
