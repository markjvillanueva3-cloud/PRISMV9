---
title: Formula — router · mastercamNETBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.mastercamnetbridge
...
# Formula — `router · mastercamNETBridge`
...
| Field | Value |
|-------|-------|
| Name | `router · mastercamNETBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.mastercamnetbridge` |
| Kind | dispatcher_router |
