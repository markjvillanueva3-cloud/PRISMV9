---
title: Formula — router · capacity_what_if
type: formula
formula_id: formula.adjusted.businessdispatcher.action.capacity_what_if
...
# Formula — `router · capacity_what_if`
...
| Field | Value |
|-------|-------|
| Name | `router · capacity_what_if` |
| Graph node | `formula.adjusted.businessdispatcher.action.capacity_what_if` |
| Kind | dispatcher_router |
