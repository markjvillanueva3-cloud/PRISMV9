---
title: Formula — router · step_import
type: formula
formula_id: formula.adjusted.calcdispatcher.action.step_import
...
| Field | Value |
|-------|-------|
| Name | `router · step_import` |
| Graph node | `formula.adjusted.calcdispatcher.action.step_import` |
| Kind | dispatcher_router |
