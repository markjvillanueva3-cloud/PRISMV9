---
title: Formula — router · pp_backplot
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_backplot
...
| Field | Value |
|-------|-------|
| Name | `router · pp_backplot` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_backplot` |
| Kind | dispatcher_router |
