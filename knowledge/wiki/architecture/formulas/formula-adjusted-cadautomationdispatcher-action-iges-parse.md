---
title: Formula — router · iges_parse
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.iges_parse
...
| Field | Value |
|-------|-------|
| Name | `router · iges_parse` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.iges_parse` |
| Kind | dispatcher_router |
