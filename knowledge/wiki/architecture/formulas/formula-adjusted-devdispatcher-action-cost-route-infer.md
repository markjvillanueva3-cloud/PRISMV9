---
title: Formula — router · cost_route_infer
type: formula
formula_id: formula.adjusted.devdispatcher.action.cost_route_infer
...
# Formula — `router · cost_route_infer`
...
| Field | Value |
|-------|-------|
| Name | `router · cost_route_infer` |
| Graph node | `formula.adjusted.devdispatcher.action.cost_route_infer` |
| Kind | dispatcher_router |
