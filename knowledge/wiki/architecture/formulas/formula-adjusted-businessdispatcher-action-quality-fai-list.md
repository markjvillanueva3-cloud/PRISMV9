---
title: Formula — router · quality_fai_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quality_fai_list
...
# Formula — `router · quality_fai_list`
...
| Field | Value |
|-------|-------|
| Name | `router · quality_fai_list` |
| Graph node | `formula.adjusted.businessdispatcher.action.quality_fai_list` |
| Kind | dispatcher_router |
