---
title: Formula — router · camWorksStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.camworksstrategy
...
# Formula — `router · camWorksStrategy`
...
| Field | Value |
|-------|-------|
| Name | `router · camWorksStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.camworksstrategy` |
| Kind | dispatcher_router |
