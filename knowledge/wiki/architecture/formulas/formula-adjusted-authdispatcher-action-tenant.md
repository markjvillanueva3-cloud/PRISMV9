---
title: Formula — router · tenant
type: formula
formula_id: formula.adjusted.authdispatcher.action.tenant
...
|-------|-------|
| Name | `router · tenant` |
| Graph node | `formula.adjusted.authdispatcher.action.tenant` |
| Kind | dispatcher_router |
