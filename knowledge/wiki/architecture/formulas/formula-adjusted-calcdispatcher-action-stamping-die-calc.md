---
title: Formula — router · stamping_die_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stamping_die_calc
...
# Formula — `router · stamping_die_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · stamping_die_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.stamping_die_calc` |
| Kind | dispatcher_router |
