---
title: Formula — router · step_validate
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.step_validate
...
| Field | Value |
|-------|-------|
| Name | `router · step_validate` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.step_validate` |
| Kind | dispatcher_router |
