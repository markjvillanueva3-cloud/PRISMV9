---
title: Formula — router · imachining_spiral
type: formula
formula_id: formula.adjusted.camdispatcher.action.imachining_spiral
...
# Formula — `router · imachining_spiral`
...
| Field | Value |
|-------|-------|
| Name | `router · imachining_spiral` |
| Graph node | `formula.adjusted.camdispatcher.action.imachining_spiral` |
| Kind | dispatcher_router |
