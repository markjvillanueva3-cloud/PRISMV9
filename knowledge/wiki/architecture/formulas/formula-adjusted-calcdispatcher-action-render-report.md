---
title: Formula — router · render_report
type: formula
formula_id: formula.adjusted.calcdispatcher.action.render_report
...
| Field | Value |
|-------|-------|
| Name | `router · render_report` |
| Graph node | `formula.adjusted.calcdispatcher.action.render_report` |
| Kind | dispatcher_router |
