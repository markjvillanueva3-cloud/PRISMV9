---
title: Formula — router · create_part_folder
type: formula
formula_id: formula.adjusted.caddispatcher.action.create_part_folder
...
# Formula — `router · create_part_folder`
...
| Field | Value |
|-------|-------|
| Name | `router · create_part_folder` |
| Graph node | `formula.adjusted.caddispatcher.action.create_part_folder` |
| Kind | dispatcher_router |
