---
title: Formula — router · gear_train_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gear_train_calc
...
# Formula — `router · gear_train_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · gear_train_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.gear_train_calc` |
| Kind | dispatcher_router |
