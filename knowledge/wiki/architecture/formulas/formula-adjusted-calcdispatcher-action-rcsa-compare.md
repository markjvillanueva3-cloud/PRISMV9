---
title: Formula — router · rcsa_compare
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rcsa_compare
...
| Field | Value |
|-------|-------|
| Name | `router · rcsa_compare` |
| Graph node | `formula.adjusted.calcdispatcher.action.rcsa_compare` |
| Kind | dispatcher_router |
