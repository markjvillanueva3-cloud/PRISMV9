---
title: Formula — router · shop_config_get
type: formula
formula_id: formula.adjusted.businessdispatcher.action.shop_config_get
...
# Formula — `router · shop_config_get`
...
| Field | Value |
|-------|-------|
| Name | `router · shop_config_get` |
| Graph node | `formula.adjusted.businessdispatcher.action.shop_config_get` |
| Kind | dispatcher_router |
