---
title: Formula — router · powerMillOpCat
type: formula
formula_id: formula.adjusted.camdispatcher.action.powermillopcat
...
| Field | Value |
|-------|-------|
| Name | `router · powerMillOpCat` |
| Graph node | `formula.adjusted.camdispatcher.action.powermillopcat` |
| Kind | dispatcher_router |
