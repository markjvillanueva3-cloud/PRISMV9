---
title: Formula — router · trainer
type: formula
formula_id: formula.adjusted.ppdispatcher.action.trainer
...
|-------|-------|
| Name | `router · trainer` |
| Graph node | `formula.adjusted.ppdispatcher.action.trainer` |
| Kind | dispatcher_router |
