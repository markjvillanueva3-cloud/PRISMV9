---
title: Formula — router · auto_fix_generate
type: formula
formula_id: formula.adjusted.devdispatcher.action.auto_fix_generate
...
# Formula — `router · auto_fix_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · auto_fix_generate` |
| Graph node | `formula.adjusted.devdispatcher.action.auto_fix_generate` |
| Kind | dispatcher_router |
