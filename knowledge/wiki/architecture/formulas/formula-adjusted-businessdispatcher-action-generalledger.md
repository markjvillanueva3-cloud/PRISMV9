---
title: Formula — router · generalLedger
type: formula
formula_id: formula.adjusted.businessdispatcher.action.generalledger
...
| Field | Value |
|-------|-------|
| Name | `router · generalLedger` |
| Graph node | `formula.adjusted.businessdispatcher.action.generalledger` |
| Kind | dispatcher_router |
