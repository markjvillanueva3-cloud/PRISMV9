---
title: Formula — router · transfer_material
type: formula
formula_id: formula.adjusted.calcdispatcher.action.transfer_material
...
# Formula — `router · transfer_material`
...
| Field | Value |
|-------|-------|
| Name | `router · transfer_material` |
| Graph node | `formula.adjusted.calcdispatcher.action.transfer_material` |
| Kind | dispatcher_router |
