---
title: Formula — router · sle_optimize_rpm
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sle_optimize_rpm
...
# Formula — `router · sle_optimize_rpm`
...
| Field | Value |
|-------|-------|
| Name | `router · sle_optimize_rpm` |
| Graph node | `formula.adjusted.calcdispatcher.action.sle_optimize_rpm` |
| Kind | dispatcher_router |
