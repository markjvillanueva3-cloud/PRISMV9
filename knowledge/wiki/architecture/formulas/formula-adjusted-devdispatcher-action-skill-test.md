---
title: Formula — router · skill_test
type: formula
formula_id: formula.adjusted.devdispatcher.action.skill_test
...
| Field | Value |
|-------|-------|
| Name | `router · skill_test` |
| Graph node | `formula.adjusted.devdispatcher.action.skill_test` |
| Kind | dispatcher_router |
