---
title: Formula — router · per_hook
type: formula
formula_id: formula.adjusted.devdispatcher.action.per_hook
...
| Field | Value |
|-------|-------|
| Name | `router · per_hook` |
| Graph node | `formula.adjusted.devdispatcher.action.per_hook` |
| Kind | dispatcher_router |
