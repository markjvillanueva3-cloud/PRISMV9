---
title: Formula — router · shot_peening
type: formula
formula_id: formula.adjusted.calcdispatcher.action.shot_peening
...
| Field | Value |
|-------|-------|
| Name | `router · shot_peening` |
| Graph node | `formula.adjusted.calcdispatcher.action.shot_peening` |
| Kind | dispatcher_router |
