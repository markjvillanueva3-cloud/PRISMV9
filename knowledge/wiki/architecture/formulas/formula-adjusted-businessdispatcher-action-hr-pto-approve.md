---
title: Formula — router · hr_pto_approve
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_pto_approve
...
| Field | Value |
|-------|-------|
| Name | `router · hr_pto_approve` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_pto_approve` |
| Kind | dispatcher_router |
