---
title: Formula — router · wrtl_by_action
type: formula
formula_id: formula.adjusted.devdispatcher.action.wrtl_by_action
...
| Field | Value |
|-------|-------|
| Name | `router · wrtl_by_action` |
| Graph node | `formula.adjusted.devdispatcher.action.wrtl_by_action` |
| Kind | dispatcher_router |
