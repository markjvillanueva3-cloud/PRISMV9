---
title: Formula — router · import_cost_heavy
type: formula
formula_id: formula.adjusted.devdispatcher.action.import_cost_heavy
...
# Formula — `router · import_cost_heavy`
...
| Field | Value |
|-------|-------|
| Name | `router · import_cost_heavy` |
| Graph node | `formula.adjusted.devdispatcher.action.import_cost_heavy` |
| Kind | dispatcher_router |
