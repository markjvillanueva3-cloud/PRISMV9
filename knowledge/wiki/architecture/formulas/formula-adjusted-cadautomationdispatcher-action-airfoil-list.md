---
title: Formula — router · airfoil_list
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.airfoil_list
...
| Field | Value |
|-------|-------|
| Name | `router · airfoil_list` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.airfoil_list` |
| Kind | dispatcher_router |
