---
title: Formula — router · math_taguchi
type: formula
formula_id: formula.adjusted.camdispatcher.action.math_taguchi
...
| Field | Value |
|-------|-------|
| Name | `router · math_taguchi` |
| Graph node | `formula.adjusted.camdispatcher.action.math_taguchi` |
| Kind | dispatcher_router |
