---
title: Formula — router · print_to_esprit
type: formula
formula_id: formula.adjusted.caddispatcher.action.print_to_esprit
...
# Formula — `router · print_to_esprit`
...
| Field | Value |
|-------|-------|
| Name | `router · print_to_esprit` |
| Graph node | `formula.adjusted.caddispatcher.action.print_to_esprit` |
| Kind | dispatcher_router |
