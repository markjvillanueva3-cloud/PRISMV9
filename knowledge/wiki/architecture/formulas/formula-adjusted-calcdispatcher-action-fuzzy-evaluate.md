---
title: Formula — router · fuzzy_evaluate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fuzzy_evaluate
...
| Field | Value |
|-------|-------|
| Name | `router · fuzzy_evaluate` |
| Graph node | `formula.adjusted.calcdispatcher.action.fuzzy_evaluate` |
| Kind | dispatcher_router |
