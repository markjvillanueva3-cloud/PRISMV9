---
title: Formula — router · cps_parse
type: formula
formula_id: formula.adjusted.camdispatcher.action.cps_parse
...
| Field | Value |
|-------|-------|
| Name | `router · cps_parse` |
| Graph node | `formula.adjusted.camdispatcher.action.cps_parse` |
| Kind | dispatcher_router |
