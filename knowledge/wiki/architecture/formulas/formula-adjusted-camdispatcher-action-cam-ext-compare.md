---
title: Formula — router · cam_ext_compare
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_ext_compare
...
# Formula — `router · cam_ext_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_ext_compare` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_ext_compare` |
| Kind | dispatcher_router |
