---
title: Formula — router · pd_get_stats
type: formula
formula_id: formula.adjusted.monitoringdispatcher.action.pd_get_stats
...
| Field | Value |
|-------|-------|
| Name | `router · pd_get_stats` |
| Graph node | `formula.adjusted.monitoringdispatcher.action.pd_get_stats` |
| Kind | dispatcher_router |
