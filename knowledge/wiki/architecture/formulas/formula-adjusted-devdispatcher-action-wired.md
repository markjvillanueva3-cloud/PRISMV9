---
title: Formula — router · wired
type: formula
formula_id: formula.adjusted.devdispatcher.action.wired
...
|-------|-------|
| Name | `router · wired` |
| Graph node | `formula.adjusted.devdispatcher.action.wired` |
| Kind | dispatcher_router |
