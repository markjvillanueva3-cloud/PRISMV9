---
title: Formula — router · mock_toolpaths
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.mock_toolpaths
...
| Field | Value |
|-------|-------|
| Name | `router · mock_toolpaths` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.mock_toolpaths` |
| Kind | dispatcher_router |
