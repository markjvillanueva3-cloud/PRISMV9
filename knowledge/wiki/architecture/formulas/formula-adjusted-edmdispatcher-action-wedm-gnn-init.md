---
title: Formula — router · wedm_gnn_init
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_gnn_init
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_gnn_init` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_gnn_init` |
| Kind | dispatcher_router |
