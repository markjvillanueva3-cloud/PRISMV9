---
title: Formula — router · bfgs_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bfgs_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · bfgs_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.bfgs_optimize` |
| Kind | dispatcher_router |
