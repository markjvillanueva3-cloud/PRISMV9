---
title: Formula — router · dfmFeedback
type: formula
formula_id: formula.adjusted.camdispatcher.action.dfmfeedback
...
| Field | Value |
|-------|-------|
| Name | `router · dfmFeedback` |
| Graph node | `formula.adjusted.camdispatcher.action.dfmfeedback` |
| Kind | dispatcher_router |
