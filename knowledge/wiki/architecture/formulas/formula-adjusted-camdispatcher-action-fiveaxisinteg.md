---
title: Formula — router · fiveAxisInteg
type: formula
formula_id: formula.adjusted.camdispatcher.action.fiveaxisinteg
...
| Field | Value |
|-------|-------|
| Name | `router · fiveAxisInteg` |
| Graph node | `formula.adjusted.camdispatcher.action.fiveaxisinteg` |
| Kind | dispatcher_router |
