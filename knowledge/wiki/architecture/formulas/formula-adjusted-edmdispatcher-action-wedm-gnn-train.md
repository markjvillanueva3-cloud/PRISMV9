---
title: Formula — router · wedm_gnn_train
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_gnn_train
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_gnn_train` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_gnn_train` |
| Kind | dispatcher_router |
