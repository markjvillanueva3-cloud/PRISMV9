---
title: Formula — router · cool_jet_coherence
type: formula
formula_id: formula.adjusted.camdispatcher.action.cool_jet_coherence
...
# Formula — `router · cool_jet_coherence`
...
| Field | Value |
|-------|-------|
| Name | `router · cool_jet_coherence` |
| Graph node | `formula.adjusted.camdispatcher.action.cool_jet_coherence` |
| Kind | dispatcher_router |
