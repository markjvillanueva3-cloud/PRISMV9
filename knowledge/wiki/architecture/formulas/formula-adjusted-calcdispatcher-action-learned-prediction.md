---
title: Formula — router · learned_prediction
type: formula
formula_id: formula.adjusted.calcdispatcher.action.learned_prediction
...
# Formula — `router · learned_prediction`
...
| Field | Value |
|-------|-------|
| Name | `router · learned_prediction` |
| Graph node | `formula.adjusted.calcdispatcher.action.learned_prediction` |
| Kind | dispatcher_router |
