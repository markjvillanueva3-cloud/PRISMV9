---
title: Formula — router · disclose_raw
type: formula
formula_id: formula.adjusted.devdispatcher.action.disclose_raw
...
| Field | Value |
|-------|-------|
| Name | `router · disclose_raw` |
| Graph node | `formula.adjusted.devdispatcher.action.disclose_raw` |
| Kind | dispatcher_router |
