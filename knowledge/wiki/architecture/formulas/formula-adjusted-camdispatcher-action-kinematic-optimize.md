---
title: Formula — router · kinematic_optimize
type: formula
formula_id: formula.adjusted.camdispatcher.action.kinematic_optimize
...
# Formula — `router · kinematic_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · kinematic_optimize` |
| Graph node | `formula.adjusted.camdispatcher.action.kinematic_optimize` |
| Kind | dispatcher_router |
