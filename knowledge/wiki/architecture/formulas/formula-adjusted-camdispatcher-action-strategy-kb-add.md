---
title: Formula — router · strategy_kb_add
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategy_kb_add
...
# Formula — `router · strategy_kb_add`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_kb_add` |
| Graph node | `formula.adjusted.camdispatcher.action.strategy_kb_add` |
| Kind | dispatcher_router |
