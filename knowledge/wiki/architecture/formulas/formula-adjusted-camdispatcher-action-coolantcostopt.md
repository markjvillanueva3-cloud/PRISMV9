---
title: Formula — router · coolantCostOpt
type: formula
formula_id: formula.adjusted.camdispatcher.action.coolantcostopt
...
| Field | Value |
|-------|-------|
| Name | `router · coolantCostOpt` |
| Graph node | `formula.adjusted.camdispatcher.action.coolantcostopt` |
| Kind | dispatcher_router |
