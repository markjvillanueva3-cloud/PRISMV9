---
title: Formula — router · toolpath_optimize
type: formula
formula_id: formula.adjusted.camdispatcher.action.toolpath_optimize
...
# Formula — `router · toolpath_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · toolpath_optimize` |
| Graph node | `formula.adjusted.camdispatcher.action.toolpath_optimize` |
| Kind | dispatcher_router |
