---
title: Formula — router · corpus_harvest_mit
type: formula
formula_id: formula.adjusted.caddispatcher.action.corpus_harvest_mit
...
# Formula — `router · corpus_harvest_mit`
...
| Field | Value |
|-------|-------|
| Name | `router · corpus_harvest_mit` |
| Graph node | `formula.adjusted.caddispatcher.action.corpus_harvest_mit` |
| Kind | dispatcher_router |
