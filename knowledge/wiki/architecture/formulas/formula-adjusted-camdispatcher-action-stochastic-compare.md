---
title: Formula — router · stochastic_compare
type: formula
formula_id: formula.adjusted.camdispatcher.action.stochastic_compare
...
# Formula — `router · stochastic_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · stochastic_compare` |
| Graph node | `formula.adjusted.camdispatcher.action.stochastic_compare` |
| Kind | dispatcher_router |
