---
title: Formula — router · fatigue_thermal
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fatigue_thermal
...
# Formula — `router · fatigue_thermal`
...
| Field | Value |
|-------|-------|
| Name | `router · fatigue_thermal` |
| Graph node | `formula.adjusted.calcdispatcher.action.fatigue_thermal` |
| Kind | dispatcher_router |
