---
title: Formula — router · hmStrategyKB
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmstrategykb
...
| Field | Value |
|-------|-------|
| Name | `router · hmStrategyKB` |
| Graph node | `formula.adjusted.camdispatcher.action.hmstrategykb` |
| Kind | dispatcher_router |
