---
title: Formula — router · omvProbe
type: formula
formula_id: formula.adjusted.turningdispatcher.action.omvprobe
...
| Field | Value |
|-------|-------|
| Name | `router · omvProbe` |
| Graph node | `formula.adjusted.turningdispatcher.action.omvprobe` |
| Kind | dispatcher_router |
