---
title: Formula — router · token_detect_waste
type: formula
formula_id: formula.adjusted.devdispatcher.action.token_detect_waste
...
# Formula — `router · token_detect_waste`
...
| Field | Value |
|-------|-------|
| Name | `router · token_detect_waste` |
| Graph node | `formula.adjusted.devdispatcher.action.token_detect_waste` |
| Kind | dispatcher_router |
