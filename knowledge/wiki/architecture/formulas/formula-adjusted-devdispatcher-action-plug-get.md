---
title: Formula — router · plug_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.plug_get
...
| Field | Value |
|-------|-------|
| Name | `router · plug_get` |
| Graph node | `formula.adjusted.devdispatcher.action.plug_get` |
| Kind | dispatcher_router |
