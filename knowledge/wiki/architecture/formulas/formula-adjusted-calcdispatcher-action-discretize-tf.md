---
title: Formula — router · discretize_tf
type: formula
formula_id: formula.adjusted.calcdispatcher.action.discretize_tf
...
| Field | Value |
|-------|-------|
| Name | `router · discretize_tf` |
| Graph node | `formula.adjusted.calcdispatcher.action.discretize_tf` |
| Kind | dispatcher_router |
