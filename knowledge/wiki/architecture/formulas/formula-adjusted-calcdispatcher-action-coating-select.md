---
title: Formula — router · coating_select
type: formula
formula_id: formula.adjusted.calcdispatcher.action.coating_select
...
| Field | Value |
|-------|-------|
| Name | `router · coating_select` |
| Graph node | `formula.adjusted.calcdispatcher.action.coating_select` |
| Kind | dispatcher_router |
