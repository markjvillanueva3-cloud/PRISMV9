---
title: Formula — router · submit_measurement
type: formula
formula_id: formula.adjusted.calcdispatcher.action.submit_measurement
...
# Formula — `router · submit_measurement`
...
| Field | Value |
|-------|-------|
| Name | `router · submit_measurement` |
| Graph node | `formula.adjusted.calcdispatcher.action.submit_measurement` |
| Kind | dispatcher_router |
