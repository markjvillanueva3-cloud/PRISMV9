---
title: Formula — router · ml_strategy_rank
type: formula
formula_id: formula.adjusted.camdispatcher.action.ml_strategy_rank
...
# Formula — `router · ml_strategy_rank`
...
| Field | Value |
|-------|-------|
| Name | `router · ml_strategy_rank` |
| Graph node | `formula.adjusted.camdispatcher.action.ml_strategy_rank` |
| Kind | dispatcher_router |
