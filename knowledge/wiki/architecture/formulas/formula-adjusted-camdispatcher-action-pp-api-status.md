---
title: Formula — router · pp_api_status
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_api_status
...
| Field | Value |
|-------|-------|
| Name | `router · pp_api_status` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_api_status` |
| Kind | dispatcher_router |
