---
title: Formula — router · const_mts
type: formula
formula_id: formula.adjusted.camdispatcher.action.const_mts
...
| Field | Value |
|-------|-------|
| Name | `router · const_mts` |
| Graph node | `formula.adjusted.camdispatcher.action.const_mts` |
| Kind | dispatcher_router |
