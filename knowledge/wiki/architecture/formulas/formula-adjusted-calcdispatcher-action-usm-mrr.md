---
title: Formula — router · usm_mrr
type: formula
formula_id: formula.adjusted.calcdispatcher.action.usm_mrr
...
|-------|-------|
| Name | `router · usm_mrr` |
| Graph node | `formula.adjusted.calcdispatcher.action.usm_mrr` |
| Kind | dispatcher_router |
