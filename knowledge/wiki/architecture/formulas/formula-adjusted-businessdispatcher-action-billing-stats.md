---
title: Formula — router · billing_stats
type: formula
formula_id: formula.adjusted.businessdispatcher.action.billing_stats
...
| Field | Value |
|-------|-------|
| Name | `router · billing_stats` |
| Graph node | `formula.adjusted.businessdispatcher.action.billing_stats` |
| Kind | dispatcher_router |
