---
title: Formula — router · ccm_planned
type: formula
formula_id: formula.adjusted.devdispatcher.action.ccm_planned
...
| Field | Value |
|-------|-------|
| Name | `router · ccm_planned` |
| Graph node | `formula.adjusted.devdispatcher.action.ccm_planned` |
| Kind | dispatcher_router |
