---
title: Formula — router · motionDyn
type: formula
formula_id: formula.adjusted.camdispatcher.action.motiondyn
...
| Field | Value |
|-------|-------|
| Name | `router · motionDyn` |
| Graph node | `formula.adjusted.camdispatcher.action.motiondyn` |
| Kind | dispatcher_router |
