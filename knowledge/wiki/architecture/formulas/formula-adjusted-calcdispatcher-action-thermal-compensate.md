---
title: Formula — router · thermal_compensate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thermal_compensate
...
# Formula — `router · thermal_compensate`
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_compensate` |
| Graph node | `formula.adjusted.calcdispatcher.action.thermal_compensate` |
| Kind | dispatcher_router |
