---
title: Formula — router · cam_translate
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_translate
...
| Field | Value |
|-------|-------|
| Name | `router · cam_translate` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_translate` |
| Kind | dispatcher_router |
