---
title: Formula — router · plug_size
type: formula
formula_id: formula.adjusted.devdispatcher.action.plug_size
...
| Field | Value |
|-------|-------|
| Name | `router · plug_size` |
| Graph node | `formula.adjusted.devdispatcher.action.plug_size` |
| Kind | dispatcher_router |
