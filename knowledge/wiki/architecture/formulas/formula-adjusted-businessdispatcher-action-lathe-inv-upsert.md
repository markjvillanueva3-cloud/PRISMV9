---
title: Formula — router · lathe_inv_upsert
type: formula
formula_id: formula.adjusted.businessdispatcher.action.lathe_inv_upsert
...
# Formula — `router · lathe_inv_upsert`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_inv_upsert` |
| Graph node | `formula.adjusted.businessdispatcher.action.lathe_inv_upsert` |
| Kind | dispatcher_router |
