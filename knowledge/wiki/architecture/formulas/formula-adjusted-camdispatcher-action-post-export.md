---
title: Formula — router · post_export
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_export
...
| Field | Value |
|-------|-------|
| Name | `router · post_export` |
| Graph node | `formula.adjusted.camdispatcher.action.post_export` |
| Kind | dispatcher_router |
