---
title: Formula — router · timoshenko_deflect
type: formula
formula_id: formula.adjusted.calcdispatcher.action.timoshenko_deflect
...
# Formula — `router · timoshenko_deflect`
...
| Field | Value |
|-------|-------|
| Name | `router · timoshenko_deflect` |
| Graph node | `formula.adjusted.calcdispatcher.action.timoshenko_deflect` |
| Kind | dispatcher_router |
