---
title: Formula — router · garch_fit
type: formula
formula_id: formula.adjusted.calcdispatcher.action.garch_fit
...
| Field | Value |
|-------|-------|
| Name | `router · garch_fit` |
| Graph node | `formula.adjusted.calcdispatcher.action.garch_fit` |
| Kind | dispatcher_router |
