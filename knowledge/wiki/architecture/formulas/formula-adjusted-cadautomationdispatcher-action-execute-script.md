---
title: Formula — router · execute_script
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.execute_script
...
| Field | Value |
|-------|-------|
| Name | `router · execute_script` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.execute_script` |
| Kind | dispatcher_router |
