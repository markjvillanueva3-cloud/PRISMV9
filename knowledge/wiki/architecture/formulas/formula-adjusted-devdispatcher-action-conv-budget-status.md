---
title: Formula — router · conv_budget_status
type: formula
formula_id: formula.adjusted.devdispatcher.action.conv_budget_status
...
# Formula — `router · conv_budget_status`
...
| Field | Value |
|-------|-------|
| Name | `router · conv_budget_status` |
| Graph node | `formula.adjusted.devdispatcher.action.conv_budget_status` |
| Kind | dispatcher_router |
