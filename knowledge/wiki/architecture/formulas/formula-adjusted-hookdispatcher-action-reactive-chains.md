---
title: Formula — router · reactive_chains
type: formula
formula_id: formula.adjusted.hookdispatcher.action.reactive_chains
...
# Formula — `router · reactive_chains`
...
| Field | Value |
|-------|-------|
| Name | `router · reactive_chains` |
| Graph node | `formula.adjusted.hookdispatcher.action.reactive_chains` |
| Kind | dispatcher_router |
