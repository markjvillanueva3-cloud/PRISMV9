---
title: Formula — router · fus360CodeGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.fus360codegen
...
| Field | Value |
|-------|-------|
| Name | `router · fus360CodeGen` |
| Graph node | `formula.adjusted.camdispatcher.action.fus360codegen` |
| Kind | dispatcher_router |
