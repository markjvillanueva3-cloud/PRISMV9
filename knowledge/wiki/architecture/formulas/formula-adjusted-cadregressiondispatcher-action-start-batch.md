---
title: Formula — router · start_batch
type: formula
formula_id: formula.adjusted.cadregressiondispatcher.action.start_batch
...
| Field | Value |
|-------|-------|
| Name | `router · start_batch` |
| Graph node | `formula.adjusted.cadregressiondispatcher.action.start_batch` |
| Kind | dispatcher_router |
