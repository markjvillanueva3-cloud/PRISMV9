---
title: Formula — router · hook_chain
type: formula
formula_id: formula.adjusted.manusdispatcher.action.hook_chain
...
| Field | Value |
|-------|-------|
| Name | `router · hook_chain` |
| Graph node | `formula.adjusted.manusdispatcher.action.hook_chain` |
| Kind | dispatcher_router |
