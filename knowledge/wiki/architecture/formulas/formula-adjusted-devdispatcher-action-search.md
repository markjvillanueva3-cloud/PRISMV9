---
title: Formula — router · search
type: formula
formula_id: formula.adjusted.devdispatcher.action.search
...
|-------|-------|
| Name | `router · search` |
| Graph node | `formula.adjusted.devdispatcher.action.search` |
| Kind | dispatcher_router |
