---
title: Formula — router · plating_tolerance
type: formula
formula_id: formula.adjusted.calcdispatcher.action.plating_tolerance
...
# Formula — `router · plating_tolerance`
...
| Field | Value |
|-------|-------|
| Name | `router · plating_tolerance` |
| Graph node | `formula.adjusted.calcdispatcher.action.plating_tolerance` |
| Kind | dispatcher_router |
