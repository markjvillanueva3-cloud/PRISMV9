---
title: Formula — router · fixture
type: formula
formula_id: formula.adjusted.camdispatcher.action.fixture
...
|-------|-------|
| Name | `router · fixture` |
| Graph node | `formula.adjusted.camdispatcher.action.fixture` |
| Kind | dispatcher_router |
