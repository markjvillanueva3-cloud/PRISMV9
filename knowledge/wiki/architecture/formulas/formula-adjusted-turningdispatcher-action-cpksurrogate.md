---
title: Formula — router · cpkSurrogate
type: formula
formula_id: formula.adjusted.turningdispatcher.action.cpksurrogate
...
| Field | Value |
|-------|-------|
| Name | `router · cpkSurrogate` |
| Graph node | `formula.adjusted.turningdispatcher.action.cpksurrogate` |
| Kind | dispatcher_router |
