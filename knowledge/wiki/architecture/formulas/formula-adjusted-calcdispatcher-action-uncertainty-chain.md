---
title: Formula — router · uncertainty_chain
type: formula
formula_id: formula.adjusted.calcdispatcher.action.uncertainty_chain
...
# Formula — `router · uncertainty_chain`
...
| Field | Value |
|-------|-------|
| Name | `router · uncertainty_chain` |
| Graph node | `formula.adjusted.calcdispatcher.action.uncertainty_chain` |
| Kind | dispatcher_router |
