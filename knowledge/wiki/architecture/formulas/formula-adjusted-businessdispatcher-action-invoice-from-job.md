---
title: Formula — router · invoice_from_job
type: formula
formula_id: formula.adjusted.businessdispatcher.action.invoice_from_job
...
# Formula — `router · invoice_from_job`
...
| Field | Value |
|-------|-------|
| Name | `router · invoice_from_job` |
| Graph node | `formula.adjusted.businessdispatcher.action.invoice_from_job` |
| Kind | dispatcher_router |
