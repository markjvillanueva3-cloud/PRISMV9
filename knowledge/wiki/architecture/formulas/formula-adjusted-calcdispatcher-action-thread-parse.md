---
title: Formula — router · thread_parse
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thread_parse
...
| Field | Value |
|-------|-------|
| Name | `router · thread_parse` |
| Graph node | `formula.adjusted.calcdispatcher.action.thread_parse` |
| Kind | dispatcher_router |
