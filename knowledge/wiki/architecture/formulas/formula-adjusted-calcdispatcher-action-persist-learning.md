---
title: Formula — router · persist_learning
type: formula
formula_id: formula.adjusted.calcdispatcher.action.persist_learning
...
# Formula — `router · persist_learning`
...
| Field | Value |
|-------|-------|
| Name | `router · persist_learning` |
| Graph node | `formula.adjusted.calcdispatcher.action.persist_learning` |
| Kind | dispatcher_router |
