---
title: Formula — router · fcstd_parse
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.fcstd_parse
...
| Field | Value |
|-------|-------|
| Name | `router · fcstd_parse` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.fcstd_parse` |
| Kind | dispatcher_router |
