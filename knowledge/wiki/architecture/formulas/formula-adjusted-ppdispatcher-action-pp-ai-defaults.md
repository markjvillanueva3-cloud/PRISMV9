---
title: Formula — router · pp_ai_defaults
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_ai_defaults
...
| Field | Value |
|-------|-------|
| Name | `router · pp_ai_defaults` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_ai_defaults` |
| Kind | dispatcher_router |
