---
title: Formula — router · wiki_idx_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.wiki_idx_get
...
| Field | Value |
|-------|-------|
| Name | `router · wiki_idx_get` |
| Graph node | `formula.adjusted.devdispatcher.action.wiki_idx_get` |
| Kind | dispatcher_router |
