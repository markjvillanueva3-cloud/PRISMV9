---
title: Formula — router · calender
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.calender
...
| Field | Value |
|-------|-------|
| Name | `router · calender` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.calender` |
| Kind | dispatcher_router |
