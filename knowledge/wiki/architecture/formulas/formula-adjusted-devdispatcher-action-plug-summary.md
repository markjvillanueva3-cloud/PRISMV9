---
title: Formula — router · plug_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.plug_summary
...
| Field | Value |
|-------|-------|
| Name | `router · plug_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.plug_summary` |
| Kind | dispatcher_router |
