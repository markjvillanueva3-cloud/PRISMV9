---
title: Formula — router · schema_generate
type: formula
formula_id: formula.adjusted.devdispatcher.action.schema_generate
...
# Formula — `router · schema_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · schema_generate` |
| Graph node | `formula.adjusted.devdispatcher.action.schema_generate` |
| Kind | dispatcher_router |
