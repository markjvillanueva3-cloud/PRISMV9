---
title: Formula — router · wear_rabinowicz
type: formula
formula_id: formula.adjusted.camdispatcher.action.wear_rabinowicz
...
# Formula — `router · wear_rabinowicz`
...
| Field | Value |
|-------|-------|
| Name | `router · wear_rabinowicz` |
| Graph node | `formula.adjusted.camdispatcher.action.wear_rabinowicz` |
| Kind | dispatcher_router |
