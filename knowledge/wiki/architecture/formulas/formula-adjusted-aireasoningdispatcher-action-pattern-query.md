---
title: Formula — router · pattern_query
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.pattern_query
...
| Field | Value |
|-------|-------|
| Name | `router · pattern_query` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.pattern_query` |
| Kind | dispatcher_router |
