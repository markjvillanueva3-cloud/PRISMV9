---
title: Formula — router · cam_predict_encode
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_predict_encode
...
# Formula — `router · cam_predict_encode`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_predict_encode` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_predict_encode` |
| Kind | dispatcher_router |
