---
title: Formula — router · cryo_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cryo_predict
...
| Field | Value |
|-------|-------|
| Name | `router · cryo_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.cryo_predict` |
| Kind | dispatcher_router |
