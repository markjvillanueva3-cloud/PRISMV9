---
title: Formula — router · cam_deep_query
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_deep_query
...
| Field | Value |
|-------|-------|
| Name | `router · cam_deep_query` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_deep_query` |
| Kind | dispatcher_router |
