---
title: Formula — router · xproc_ewc_reset
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.xproc_ewc_reset
...
# Formula — `router · xproc_ewc_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · xproc_ewc_reset` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.xproc_ewc_reset` |
| Kind | dispatcher_router |
