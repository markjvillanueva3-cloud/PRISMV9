---
title: Formula — router · memory_recall
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.memory_recall
...
| Field | Value |
|-------|-------|
| Name | `router · memory_recall` |
| Graph node | `formula.adjusted.sessiondispatcher.action.memory_recall` |
| Kind | dispatcher_router |
