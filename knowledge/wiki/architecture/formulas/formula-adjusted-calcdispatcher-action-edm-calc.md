---
title: Formula — router · edm_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.edm_calc
...
| Field | Value |
|-------|-------|
| Name | `router · edm_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.edm_calc` |
| Kind | dispatcher_router |
