---
title: Formula — router · route_sync_read
type: formula
formula_id: formula.adjusted.devdispatcher.action.route_sync_read
...
# Formula — `router · route_sync_read`
...
| Field | Value |
|-------|-------|
| Name | `router · route_sync_read` |
| Graph node | `formula.adjusted.devdispatcher.action.route_sync_read` |
| Kind | dispatcher_router |
