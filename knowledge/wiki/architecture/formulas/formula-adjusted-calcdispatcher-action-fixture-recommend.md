---
title: Formula — router · fixture_recommend
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fixture_recommend
...
# Formula — `router · fixture_recommend`
...
| Field | Value |
|-------|-------|
| Name | `router · fixture_recommend` |
| Graph node | `formula.adjusted.calcdispatcher.action.fixture_recommend` |
| Kind | dispatcher_router |
