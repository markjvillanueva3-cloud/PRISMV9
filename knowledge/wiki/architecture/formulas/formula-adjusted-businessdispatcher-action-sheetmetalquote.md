---
title: Formula — router · sheetMetalQuote
type: formula
formula_id: formula.adjusted.businessdispatcher.action.sheetmetalquote
...
# Formula — `router · sheetMetalQuote`
...
| Field | Value |
|-------|-------|
| Name | `router · sheetMetalQuote` |
| Graph node | `formula.adjusted.businessdispatcher.action.sheetmetalquote` |
| Kind | dispatcher_router |
