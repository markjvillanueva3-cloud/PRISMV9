---
title: Formula — router · fcc_check
type: formula
formula_id: formula.adjusted.devdispatcher.action.fcc_check
...
| Field | Value |
|-------|-------|
| Name | `router · fcc_check` |
| Graph node | `formula.adjusted.devdispatcher.action.fcc_check` |
| Kind | dispatcher_router |
