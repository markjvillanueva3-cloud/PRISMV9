---
title: Formula — router · cpm_pert_analyze
type: formula
formula_id: formula.adjusted.devdispatcher.action.cpm_pert_analyze
...
# Formula — `router · cpm_pert_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · cpm_pert_analyze` |
| Graph node | `formula.adjusted.devdispatcher.action.cpm_pert_analyze` |
| Kind | dispatcher_router |
