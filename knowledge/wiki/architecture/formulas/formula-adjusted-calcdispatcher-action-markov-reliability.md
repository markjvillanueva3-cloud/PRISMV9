---
title: Formula — router · markov_reliability
type: formula
formula_id: formula.adjusted.calcdispatcher.action.markov_reliability
...
# Formula — `router · markov_reliability`
...
| Field | Value |
|-------|-------|
| Name | `router · markov_reliability` |
| Graph node | `formula.adjusted.calcdispatcher.action.markov_reliability` |
| Kind | dispatcher_router |
