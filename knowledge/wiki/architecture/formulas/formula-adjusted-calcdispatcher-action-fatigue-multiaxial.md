---
title: Formula — router · fatigue_multiaxial
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fatigue_multiaxial
...
# Formula — `router · fatigue_multiaxial`
...
| Field | Value |
|-------|-------|
| Name | `router · fatigue_multiaxial` |
| Graph node | `formula.adjusted.calcdispatcher.action.fatigue_multiaxial` |
| Kind | dispatcher_router |
