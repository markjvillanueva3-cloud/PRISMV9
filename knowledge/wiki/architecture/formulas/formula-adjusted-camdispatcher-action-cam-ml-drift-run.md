---
title: Formula — router · cam_ml_drift_run
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_ml_drift_run
...
# Formula — `router · cam_ml_drift_run`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_ml_drift_run` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_ml_drift_run` |
| Kind | dispatcher_router |
