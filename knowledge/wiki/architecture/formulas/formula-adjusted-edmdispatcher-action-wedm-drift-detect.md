---
title: Formula — router · wedm_drift_detect
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_drift_detect
...
# Formula — `router · wedm_drift_detect`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_drift_detect` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_drift_detect` |
| Kind | dispatcher_router |
