---
title: Formula — router · machine_match
type: formula
formula_id: formula.adjusted.camdispatcher.action.machine_match
...
| Field | Value |
|-------|-------|
| Name | `router · machine_match` |
| Graph node | `formula.adjusted.camdispatcher.action.machine_match` |
| Kind | dispatcher_router |
