---
title: Formula — router · troubleshoot
type: formula
formula_id: formula.adjusted.calcdispatcher.action.troubleshoot
...
| Field | Value |
|-------|-------|
| Name | `router · troubleshoot` |
| Graph node | `formula.adjusted.calcdispatcher.action.troubleshoot` |
| Kind | dispatcher_router |
