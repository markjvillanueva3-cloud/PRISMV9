---
title: Formula — router · inventory_eoq
type: formula
formula_id: formula.adjusted.businessdispatcher.action.inventory_eoq
...
| Field | Value |
|-------|-------|
| Name | `router · inventory_eoq` |
| Graph node | `formula.adjusted.businessdispatcher.action.inventory_eoq` |
| Kind | dispatcher_router |
