---
title: Formula — router · cool_cryogenic
type: formula
formula_id: formula.adjusted.camdispatcher.action.cool_cryogenic
...
| Field | Value |
|-------|-------|
| Name | `router · cool_cryogenic` |
| Graph node | `formula.adjusted.camdispatcher.action.cool_cryogenic` |
| Kind | dispatcher_router |
