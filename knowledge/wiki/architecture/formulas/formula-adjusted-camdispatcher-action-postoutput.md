---
title: Formula — router · postOutput
type: formula
formula_id: formula.adjusted.camdispatcher.action.postoutput
...
| Field | Value |
|-------|-------|
| Name | `router · postOutput` |
| Graph node | `formula.adjusted.camdispatcher.action.postoutput` |
| Kind | dispatcher_router |
