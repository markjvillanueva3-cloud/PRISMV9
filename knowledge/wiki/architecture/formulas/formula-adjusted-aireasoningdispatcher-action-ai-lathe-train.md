---
title: Formula — router · ai_lathe_train
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.ai_lathe_train
...
| Field | Value |
|-------|-------|
| Name | `router · ai_lathe_train` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.ai_lathe_train` |
| Kind | dispatcher_router |
