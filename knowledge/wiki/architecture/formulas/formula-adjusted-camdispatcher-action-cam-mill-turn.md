---
title: Formula — router · cam_mill_turn
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_mill_turn
...
| Field | Value |
|-------|-------|
| Name | `router · cam_mill_turn` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_mill_turn` |
| Kind | dispatcher_router |
