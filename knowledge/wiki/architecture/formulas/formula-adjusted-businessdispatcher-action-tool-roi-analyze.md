---
title: Formula — router · tool_roi_analyze
type: formula
formula_id: formula.adjusted.businessdispatcher.action.tool_roi_analyze
...
# Formula — `router · tool_roi_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_roi_analyze` |
| Graph node | `formula.adjusted.businessdispatcher.action.tool_roi_analyze` |
| Kind | dispatcher_router |
