---
title: Formula — router · cam_cache_clear
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_cache_clear
...
# Formula — `router · cam_cache_clear`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_cache_clear` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_cache_clear` |
| Kind | dispatcher_router |
