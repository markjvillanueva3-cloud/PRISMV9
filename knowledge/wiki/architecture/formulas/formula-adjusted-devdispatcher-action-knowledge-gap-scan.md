---
title: Formula — router · knowledge_gap_scan
type: formula
formula_id: formula.adjusted.devdispatcher.action.knowledge_gap_scan
...
# Formula — `router · knowledge_gap_scan`
...
| Field | Value |
|-------|-------|
| Name | `router · knowledge_gap_scan` |
| Graph node | `formula.adjusted.devdispatcher.action.knowledge_gap_scan` |
| Kind | dispatcher_router |
