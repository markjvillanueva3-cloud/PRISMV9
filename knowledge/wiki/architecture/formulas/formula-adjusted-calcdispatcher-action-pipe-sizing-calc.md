---
title: Formula — router · pipe_sizing_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.pipe_sizing_calc
...
# Formula — `router · pipe_sizing_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · pipe_sizing_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.pipe_sizing_calc` |
| Kind | dispatcher_router |
