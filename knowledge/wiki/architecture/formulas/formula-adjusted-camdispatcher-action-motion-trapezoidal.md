---
title: Formula — router · motion_trapezoidal
type: formula
formula_id: formula.adjusted.camdispatcher.action.motion_trapezoidal
...
# Formula — `router · motion_trapezoidal`
...
| Field | Value |
|-------|-------|
| Name | `router · motion_trapezoidal` |
| Graph node | `formula.adjusted.camdispatcher.action.motion_trapezoidal` |
| Kind | dispatcher_router |
