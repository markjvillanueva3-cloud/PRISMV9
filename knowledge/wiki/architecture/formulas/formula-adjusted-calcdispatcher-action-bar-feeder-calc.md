---
title: Formula — router · bar_feeder_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bar_feeder_calc
...
# Formula — `router · bar_feeder_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · bar_feeder_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.bar_feeder_calc` |
| Kind | dispatcher_router |
