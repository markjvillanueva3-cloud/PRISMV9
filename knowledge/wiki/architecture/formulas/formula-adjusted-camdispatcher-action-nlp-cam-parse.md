---
title: Formula — router · nlp_cam_parse
type: formula
formula_id: formula.adjusted.camdispatcher.action.nlp_cam_parse
...
| Field | Value |
|-------|-------|
| Name | `router · nlp_cam_parse` |
| Graph node | `formula.adjusted.camdispatcher.action.nlp_cam_parse` |
| Kind | dispatcher_router |
