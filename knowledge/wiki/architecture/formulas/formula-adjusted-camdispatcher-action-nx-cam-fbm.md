---
title: Formula — router · nx_cam_fbm
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_cam_fbm
...
| Field | Value |
|-------|-------|
| Name | `router · nx_cam_fbm` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_cam_fbm` |
| Kind | dispatcher_router |
