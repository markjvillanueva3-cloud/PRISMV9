---
title: Formula — router · svi_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.svi_summary
...
| Field | Value |
|-------|-------|
| Name | `router · svi_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.svi_summary` |
| Kind | dispatcher_router |
