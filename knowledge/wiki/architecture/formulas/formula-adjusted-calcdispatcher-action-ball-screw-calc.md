---
title: Formula — router · ball_screw_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ball_screw_calc
...
# Formula — `router · ball_screw_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · ball_screw_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.ball_screw_calc` |
| Kind | dispatcher_router |
