---
title: Formula — router · step_brep_summary
type: formula
formula_id: formula.adjusted.calcdispatcher.action.step_brep_summary
...
# Formula — `router · step_brep_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · step_brep_summary` |
| Graph node | `formula.adjusted.calcdispatcher.action.step_brep_summary` |
| Kind | dispatcher_router |
