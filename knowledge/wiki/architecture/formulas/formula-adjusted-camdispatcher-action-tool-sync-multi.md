---
title: Formula — router · tool_sync_multi
type: formula
formula_id: formula.adjusted.camdispatcher.action.tool_sync_multi
...
# Formula — `router · tool_sync_multi`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_sync_multi` |
| Graph node | `formula.adjusted.camdispatcher.action.tool_sync_multi` |
| Kind | dispatcher_router |
