---
title: Formula — router · anomaly_classify
type: formula
formula_id: formula.adjusted.calcdispatcher.action.anomaly_classify
...
# Formula — `router · anomaly_classify`
...
| Field | Value |
|-------|-------|
| Name | `router · anomaly_classify` |
| Graph node | `formula.adjusted.calcdispatcher.action.anomaly_classify` |
| Kind | dispatcher_router |
