---
title: Formula — router · latheAGILearning
type: formula
formula_id: formula.adjusted.businessdispatcher.action.latheagilearning
...
# Formula — `router · latheAGILearning`
...
| Field | Value |
|-------|-------|
| Name | `router · latheAGILearning` |
| Graph node | `formula.adjusted.businessdispatcher.action.latheagilearning` |
| Kind | dispatcher_router |
