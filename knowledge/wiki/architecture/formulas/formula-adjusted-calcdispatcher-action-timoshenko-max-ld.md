---
title: Formula — router · timoshenko_max_ld
type: formula
formula_id: formula.adjusted.calcdispatcher.action.timoshenko_max_ld
...
# Formula — `router · timoshenko_max_ld`
...
| Field | Value |
|-------|-------|
| Name | `router · timoshenko_max_ld` |
| Graph node | `formula.adjusted.calcdispatcher.action.timoshenko_max_ld` |
| Kind | dispatcher_router |
