---
title: Formula — router · academy_courses
type: formula
formula_id: formula.adjusted.knowledgedispatcher.action.academy_courses
...
# Formula — `router · academy_courses`
...
| Field | Value |
|-------|-------|
| Name | `router · academy_courses` |
| Graph node | `formula.adjusted.knowledgedispatcher.action.academy_courses` |
| Kind | dispatcher_router |
