---
title: Formula — router · micro
type: formula
formula_id: formula.adjusted.edmdispatcher.action.micro
...
|-------|-------|
| Name | `router · micro` |
| Graph node | `formula.adjusted.edmdispatcher.action.micro` |
| Kind | dispatcher_router |
