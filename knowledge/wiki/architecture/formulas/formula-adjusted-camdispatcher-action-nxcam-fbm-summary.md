---
title: Formula — router · nxcam_fbm_summary
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcam_fbm_summary
...
# Formula — `router · nxcam_fbm_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · nxcam_fbm_summary` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcam_fbm_summary` |
| Kind | dispatcher_router |
