---
title: Formula — router · laser_cut_program
type: formula
formula_id: formula.adjusted.camdispatcher.action.laser_cut_program
...
# Formula — `router · laser_cut_program`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_cut_program` |
| Graph node | `formula.adjusted.camdispatcher.action.laser_cut_program` |
| Kind | dispatcher_router |
