---
title: Formula — router · wedm_gnn_is_stale
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_gnn_is_stale
...
# Formula — `router · wedm_gnn_is_stale`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_gnn_is_stale` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_gnn_is_stale` |
| Kind | dispatcher_router |
