---
title: Formula — router · tool_overhang_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_overhang_calc
...
# Formula — `router · tool_overhang_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_overhang_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_overhang_calc` |
| Kind | dispatcher_router |
