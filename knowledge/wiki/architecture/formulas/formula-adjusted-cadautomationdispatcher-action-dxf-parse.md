---
title: Formula — router · dxf_parse
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.dxf_parse
...
| Field | Value |
|-------|-------|
| Name | `router · dxf_parse` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.dxf_parse` |
| Kind | dispatcher_router |
