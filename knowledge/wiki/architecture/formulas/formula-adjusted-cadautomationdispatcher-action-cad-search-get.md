---
title: Formula — router · cad_search_get
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_search_get
...
| Field | Value |
|-------|-------|
| Name | `router · cad_search_get` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_search_get` |
| Kind | dispatcher_router |
