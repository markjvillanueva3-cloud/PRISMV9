---
title: Formula — router · self_learn_anomaly
type: formula
formula_id: formula.adjusted.camdispatcher.action.self_learn_anomaly
...
# Formula — `router · self_learn_anomaly`
...
| Field | Value |
|-------|-------|
| Name | `router · self_learn_anomaly` |
| Graph node | `formula.adjusted.camdispatcher.action.self_learn_anomaly` |
| Kind | dispatcher_router |
