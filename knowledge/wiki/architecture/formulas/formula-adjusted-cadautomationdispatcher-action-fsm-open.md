---
title: Formula — router · fsm_open
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.fsm_open
...
| Field | Value |
|-------|-------|
| Name | `router · fsm_open` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.fsm_open` |
| Kind | dispatcher_router |
