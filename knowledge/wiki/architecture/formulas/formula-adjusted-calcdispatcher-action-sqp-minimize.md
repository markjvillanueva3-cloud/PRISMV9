---
title: Formula — router · sqp_minimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sqp_minimize
...
| Field | Value |
|-------|-------|
| Name | `router · sqp_minimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.sqp_minimize` |
| Kind | dispatcher_router |
