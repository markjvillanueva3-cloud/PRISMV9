---
title: Formula — router · cad_regen_test
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_regen_test
...
| Field | Value |
|-------|-------|
| Name | `router · cad_regen_test` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_regen_test` |
| Kind | dispatcher_router |
