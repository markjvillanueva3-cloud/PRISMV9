---
title: Formula — router · rtcp_calc
type: formula
formula_id: formula.adjusted.fiveaxisdispatcher.action.rtcp_calc
...
| Field | Value |
|-------|-------|
| Name | `router · rtcp_calc` |
| Graph node | `formula.adjusted.fiveaxisdispatcher.action.rtcp_calc` |
| Kind | dispatcher_router |
