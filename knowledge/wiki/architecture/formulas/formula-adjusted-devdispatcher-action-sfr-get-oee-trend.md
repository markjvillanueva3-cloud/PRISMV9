---
title: Formula — router · sfr_get_oee_trend
type: formula
formula_id: formula.adjusted.devdispatcher.action.sfr_get_oee_trend
...
# Formula — `router · sfr_get_oee_trend`
...
| Field | Value |
|-------|-------|
| Name | `router · sfr_get_oee_trend` |
| Graph node | `formula.adjusted.devdispatcher.action.sfr_get_oee_trend` |
| Kind | dispatcher_router |
