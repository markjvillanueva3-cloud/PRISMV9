---
title: Formula — router · cam_tool_get
type: formula
formula_id: formula.adjusted.integrationdispatcher.action.cam_tool_get
...
| Field | Value |
|-------|-------|
| Name | `router · cam_tool_get` |
| Graph node | `formula.adjusted.integrationdispatcher.action.cam_tool_get` |
| Kind | dispatcher_router |
