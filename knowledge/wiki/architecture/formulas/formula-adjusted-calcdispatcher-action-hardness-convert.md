---
title: Formula — router · hardness_convert
type: formula
formula_id: formula.adjusted.calcdispatcher.action.hardness_convert
...
# Formula — `router · hardness_convert`
...
| Field | Value |
|-------|-------|
| Name | `router · hardness_convert` |
| Graph node | `formula.adjusted.calcdispatcher.action.hardness_convert` |
| Kind | dispatcher_router |
