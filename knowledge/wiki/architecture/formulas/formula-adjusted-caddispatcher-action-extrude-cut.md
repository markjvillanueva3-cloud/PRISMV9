---
title: Formula — router · extrude_cut
type: formula
formula_id: formula.adjusted.caddispatcher.action.extrude_cut
...
| Field | Value |
|-------|-------|
| Name | `router · extrude_cut` |
| Graph node | `formula.adjusted.caddispatcher.action.extrude_cut` |
| Kind | dispatcher_router |
