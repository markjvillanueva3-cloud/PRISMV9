---
title: Formula — router · cad_trial_stats
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_trial_stats
...
# Formula — `router · cad_trial_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_trial_stats` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_trial_stats` |
| Kind | dispatcher_router |
