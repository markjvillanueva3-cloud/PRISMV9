---
title: Formula — router · fem_thermal_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fem_thermal_solve
...
# Formula — `router · fem_thermal_solve`
...
| Field | Value |
|-------|-------|
| Name | `router · fem_thermal_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.fem_thermal_solve` |
| Kind | dispatcher_router |
