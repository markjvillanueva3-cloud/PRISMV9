---
title: Formula — router · cad_geometry
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.cad_geometry
...
| Field | Value |
|-------|-------|
| Name | `router · cad_geometry` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.cad_geometry` |
| Kind | dispatcher_router |
