---
title: Formula — router · assembly_sequence
type: formula
formula_id: formula.adjusted.calcdispatcher.action.assembly_sequence
...
# Formula — `router · assembly_sequence`
...
| Field | Value |
|-------|-------|
| Name | `router · assembly_sequence` |
| Graph node | `formula.adjusted.calcdispatcher.action.assembly_sequence` |
| Kind | dispatcher_router |
