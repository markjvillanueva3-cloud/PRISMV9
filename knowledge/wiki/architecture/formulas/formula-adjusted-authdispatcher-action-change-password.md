---
title: Formula — router · change_password
type: formula
formula_id: formula.adjusted.authdispatcher.action.change_password
...
# Formula — `router · change_password`
...
| Graph node | `formula.adjusted.authdispatcher.action.change_password` |
| Kind | dispatcher_router |
