---
title: Formula — router · total_fires
type: formula
formula_id: formula.adjusted.devdispatcher.action.total_fires
...
| Field | Value |
|-------|-------|
| Name | `router · total_fires` |
| Graph node | `formula.adjusted.devdispatcher.action.total_fires` |
| Kind | dispatcher_router |
