---
title: Formula — router · session_touch
type: formula
formula_id: formula.adjusted.securitydispatcher.action.session_touch
...
| Field | Value |
|-------|-------|
| Name | `router · session_touch` |
| Graph node | `formula.adjusted.securitydispatcher.action.session_touch` |
| Kind | dispatcher_router |
