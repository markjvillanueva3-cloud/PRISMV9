---
title: Formula — router · sci_size_effect
type: formula
formula_id: formula.adjusted.camdispatcher.action.sci_size_effect
...
# Formula — `router · sci_size_effect`
...
| Field | Value |
|-------|-------|
| Name | `router · sci_size_effect` |
| Graph node | `formula.adjusted.camdispatcher.action.sci_size_effect` |
| Kind | dispatcher_router |
