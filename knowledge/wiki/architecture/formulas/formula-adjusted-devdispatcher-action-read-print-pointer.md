---
title: Formula — router · read_print_pointer
type: formula
formula_id: formula.adjusted.devdispatcher.action.read_print_pointer
...
# Formula — `router · read_print_pointer`
...
| Field | Value |
|-------|-------|
| Name | `router · read_print_pointer` |
| Graph node | `formula.adjusted.devdispatcher.action.read_print_pointer` |
| Kind | dispatcher_router |
