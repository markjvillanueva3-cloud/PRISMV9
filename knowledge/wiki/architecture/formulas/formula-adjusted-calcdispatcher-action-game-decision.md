---
title: Formula — router · game_decision
type: formula
formula_id: formula.adjusted.calcdispatcher.action.game_decision
...
| Field | Value |
|-------|-------|
| Name | `router · game_decision` |
| Graph node | `formula.adjusted.calcdispatcher.action.game_decision` |
| Kind | dispatcher_router |
