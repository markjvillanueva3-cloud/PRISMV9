---
title: Formula — router · session_create
type: formula
formula_id: formula.adjusted.securitydispatcher.action.session_create
...
| Field | Value |
|-------|-------|
| Name | `router · session_create` |
| Graph node | `formula.adjusted.securitydispatcher.action.session_create` |
| Kind | dispatcher_router |
