---
title: Formula — router · corner_dynamics
type: formula
formula_id: formula.adjusted.calcdispatcher.action.corner_dynamics
...
# Formula — `router · corner_dynamics`
...
| Field | Value |
|-------|-------|
| Name | `router · corner_dynamics` |
| Graph node | `formula.adjusted.calcdispatcher.action.corner_dynamics` |
| Kind | dispatcher_router |
