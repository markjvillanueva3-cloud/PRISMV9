---
title: Formula — router · f3z_parse
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.f3z_parse
...
| Field | Value |
|-------|-------|
| Name | `router · f3z_parse` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.f3z_parse` |
| Kind | dispatcher_router |
