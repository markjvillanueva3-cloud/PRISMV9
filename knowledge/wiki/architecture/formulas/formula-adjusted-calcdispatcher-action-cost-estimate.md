---
title: Formula — router · cost_estimate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cost_estimate
...
| Field | Value |
|-------|-------|
| Name | `router · cost_estimate` |
| Graph node | `formula.adjusted.calcdispatcher.action.cost_estimate` |
| Kind | dispatcher_router |
