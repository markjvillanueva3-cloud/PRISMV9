---
title: Formula — router · material_compare
type: formula
formula_id: formula.adjusted.calcdispatcher.action.material_compare
...
# Formula — `router · material_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · material_compare` |
| Graph node | `formula.adjusted.calcdispatcher.action.material_compare` |
| Kind | dispatcher_router |
