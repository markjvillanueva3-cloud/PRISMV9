---
title: Formula — router · learning_rank
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.learning_rank
...
| Field | Value |
|-------|-------|
| Name | `router · learning_rank` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.learning_rank` |
| Kind | dispatcher_router |
