---
title: Formula — router · roi_log_outcome
type: formula
formula_id: formula.adjusted.businessdispatcher.action.roi_log_outcome
...
# Formula — `router · roi_log_outcome`
...
| Field | Value |
|-------|-------|
| Name | `router · roi_log_outcome` |
| Graph node | `formula.adjusted.businessdispatcher.action.roi_log_outcome` |
| Kind | dispatcher_router |
