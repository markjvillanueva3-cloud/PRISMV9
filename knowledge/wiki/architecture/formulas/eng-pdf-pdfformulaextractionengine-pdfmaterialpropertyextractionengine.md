---
title: Formula — PDFMaterialPropertyExtractionEngine
type: formula
formula_id: eng.pdf.pdfformulaextractionengine.pdfmaterialpropertyextractionengine
...
# Formula — `PDFMaterialPropertyExtractionEngine`
...
| Field | Value |
|-------|-------|
| Name | `PDFMaterialPropertyExtractionEngine` |
| Graph node | `eng.pdf.pdfformulaextractionengine.pdfmaterialpropertyextractionengine` |
| Kind | pdf.pdfformulaextractionengine_engines |
