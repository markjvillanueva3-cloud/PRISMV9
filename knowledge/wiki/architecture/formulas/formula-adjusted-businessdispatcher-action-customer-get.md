---
title: Formula — router · customer_get
type: formula
formula_id: formula.adjusted.businessdispatcher.action.customer_get
...
| Field | Value |
|-------|-------|
| Name | `router · customer_get` |
| Graph node | `formula.adjusted.businessdispatcher.action.customer_get` |
| Kind | dispatcher_router |
