---
title: Formula — router · eigen_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.eigen_solve
...
| Field | Value |
|-------|-------|
| Name | `router · eigen_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.eigen_solve` |
| Kind | dispatcher_router |
