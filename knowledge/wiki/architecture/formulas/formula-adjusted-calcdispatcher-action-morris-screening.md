---
title: Formula — router · morris_screening
type: formula
formula_id: formula.adjusted.calcdispatcher.action.morris_screening
...
# Formula — `router · morris_screening`
...
| Field | Value |
|-------|-------|
| Name | `router · morris_screening` |
| Graph node | `formula.adjusted.calcdispatcher.action.morris_screening` |
| Kind | dispatcher_router |
