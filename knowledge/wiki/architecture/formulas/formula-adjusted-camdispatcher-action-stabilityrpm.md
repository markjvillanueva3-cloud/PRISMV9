---
title: Formula — router · stabilityRPM
type: formula
formula_id: formula.adjusted.camdispatcher.action.stabilityrpm
...
| Field | Value |
|-------|-------|
| Name | `router · stabilityRPM` |
| Graph node | `formula.adjusted.camdispatcher.action.stabilityrpm` |
| Kind | dispatcher_router |
