---
title: Formula — router · clearance_plane
type: formula
formula_id: formula.adjusted.camdispatcher.action.clearance_plane
...
# Formula — `router · clearance_plane`
...
| Field | Value |
|-------|-------|
| Name | `router · clearance_plane` |
| Graph node | `formula.adjusted.camdispatcher.action.clearance_plane` |
| Kind | dispatcher_router |
