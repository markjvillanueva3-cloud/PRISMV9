---
title: Formula — router · auto_forge
type: formula
formula_id: formula.adjusted.devdispatcher.action.auto_forge
...
| Field | Value |
|-------|-------|
| Name | `router · auto_forge` |
| Graph node | `formula.adjusted.devdispatcher.action.auto_forge` |
| Kind | dispatcher_router |
