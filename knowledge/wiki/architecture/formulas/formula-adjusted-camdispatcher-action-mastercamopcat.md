---
title: Formula — router · mastercamOpCat
type: formula
formula_id: formula.adjusted.camdispatcher.action.mastercamopcat
...
| Field | Value |
|-------|-------|
| Name | `router · mastercamOpCat` |
| Graph node | `formula.adjusted.camdispatcher.action.mastercamopcat` |
| Kind | dispatcher_router |
