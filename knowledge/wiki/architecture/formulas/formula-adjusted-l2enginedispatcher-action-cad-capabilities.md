---
title: Formula — router · cad_capabilities
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.cad_capabilities
...
# Formula — `router · cad_capabilities`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_capabilities` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.cad_capabilities` |
| Kind | dispatcher_router |
