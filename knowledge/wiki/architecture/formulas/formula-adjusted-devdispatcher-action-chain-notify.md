---
title: Formula — router · chain_notify
type: formula
formula_id: formula.adjusted.devdispatcher.action.chain_notify
...
| Field | Value |
|-------|-------|
| Name | `router · chain_notify` |
| Graph node | `formula.adjusted.devdispatcher.action.chain_notify` |
| Kind | dispatcher_router |
