---
title: Formula — router · disk_brake_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.disk_brake_calc
...
# Formula — `router · disk_brake_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · disk_brake_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.disk_brake_calc` |
| Kind | dispatcher_router |
