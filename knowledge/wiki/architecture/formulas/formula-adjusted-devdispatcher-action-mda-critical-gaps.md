---
title: Formula — router · mda_critical_gaps
type: formula
formula_id: formula.adjusted.devdispatcher.action.mda_critical_gaps
...
# Formula — `router · mda_critical_gaps`
...
| Field | Value |
|-------|-------|
| Name | `router · mda_critical_gaps` |
| Graph node | `formula.adjusted.devdispatcher.action.mda_critical_gaps` |
| Kind | dispatcher_router |
