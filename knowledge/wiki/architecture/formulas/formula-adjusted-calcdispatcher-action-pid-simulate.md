---
title: Formula — router · pid_simulate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.pid_simulate
...
| Field | Value |
|-------|-------|
| Name | `router · pid_simulate` |
| Graph node | `formula.adjusted.calcdispatcher.action.pid_simulate` |
| Kind | dispatcher_router |
