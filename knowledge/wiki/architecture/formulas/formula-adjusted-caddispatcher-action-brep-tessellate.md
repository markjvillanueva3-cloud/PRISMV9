---
title: Formula — router · brep_tessellate
type: formula
formula_id: formula.adjusted.caddispatcher.action.brep_tessellate
...
# Formula — `router · brep_tessellate`
...
| Field | Value |
|-------|-------|
| Name | `router · brep_tessellate` |
| Graph node | `formula.adjusted.caddispatcher.action.brep_tessellate` |
| Kind | dispatcher_router |
