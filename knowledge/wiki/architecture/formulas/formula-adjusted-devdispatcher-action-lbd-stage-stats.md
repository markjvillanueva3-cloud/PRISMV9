---
title: Formula — router · lbd_stage_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.lbd_stage_stats
...
# Formula — `router · lbd_stage_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · lbd_stage_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.lbd_stage_stats` |
| Kind | dispatcher_router |
