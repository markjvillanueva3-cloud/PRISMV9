---
title: Formula — router · bprintToAllCads
type: formula
formula_id: formula.adjusted.caddispatcher.action.bprinttoallcads
...
# Formula — `router · bprintToAllCads`
...
| Field | Value |
|-------|-------|
| Name | `router · bprintToAllCads` |
| Graph node | `formula.adjusted.caddispatcher.action.bprinttoallcads` |
| Kind | dispatcher_router |
