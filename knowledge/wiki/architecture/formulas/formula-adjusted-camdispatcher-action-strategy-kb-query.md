---
title: Formula — router · strategy_kb_query
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategy_kb_query
...
# Formula — `router · strategy_kb_query`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_kb_query` |
| Graph node | `formula.adjusted.camdispatcher.action.strategy_kb_query` |
| Kind | dispatcher_router |
