---
title: Formula — router · wedm_online_export
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_online_export
...
# Formula — `router · wedm_online_export`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_online_export` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_online_export` |
| Kind | dispatcher_router |
