---
title: Formula — router · stepNCParser
type: formula
formula_id: formula.adjusted.camdispatcher.action.stepncparser
...
| Field | Value |
|-------|-------|
| Name | `router · stepNCParser` |
| Graph node | `formula.adjusted.camdispatcher.action.stepncparser` |
| Kind | dispatcher_router |
