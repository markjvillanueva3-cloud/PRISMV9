---
title: Formula — router · spline
type: formula
formula_id: formula.adjusted.caddispatcher.action.spline
...
|-------|-------|
| Name | `router · spline` |
| Graph node | `formula.adjusted.caddispatcher.action.spline` |
| Kind | dispatcher_router |
