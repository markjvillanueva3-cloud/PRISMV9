---
title: Formula — router · asset_dep_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.asset_dep_stats
...
# Formula — `router · asset_dep_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · asset_dep_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.asset_dep_stats` |
| Kind | dispatcher_router |
