---
title: Formula — router · state_load
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.state_load
...
| Field | Value |
|-------|-------|
| Name | `router · state_load` |
| Graph node | `formula.adjusted.sessiondispatcher.action.state_load` |
| Kind | dispatcher_router |
