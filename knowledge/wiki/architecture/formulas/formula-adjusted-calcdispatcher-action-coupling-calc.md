---
title: Formula — router · coupling_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.coupling_calc
...
| Field | Value |
|-------|-------|
| Name | `router · coupling_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.coupling_calc` |
| Kind | dispatcher_router |
