---
title: Formula — router · am_thermal_stress
type: formula
formula_id: formula.adjusted.calcdispatcher.action.am_thermal_stress
...
# Formula — `router · am_thermal_stress`
...
| Field | Value |
|-------|-------|
| Name | `router · am_thermal_stress` |
| Graph node | `formula.adjusted.calcdispatcher.action.am_thermal_stress` |
| Kind | dispatcher_router |
