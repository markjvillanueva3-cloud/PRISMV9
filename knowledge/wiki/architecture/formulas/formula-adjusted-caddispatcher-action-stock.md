---
title: Formula — router · stock
type: formula
formula_id: formula.adjusted.caddispatcher.action.stock
...
|-------|-------|
| Name | `router · stock` |
| Graph node | `formula.adjusted.caddispatcher.action.stock` |
| Kind | dispatcher_router |
