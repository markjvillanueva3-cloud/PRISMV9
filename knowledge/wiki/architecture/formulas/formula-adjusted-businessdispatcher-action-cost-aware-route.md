---
title: Formula — router · cost_aware_route
type: formula
formula_id: formula.adjusted.businessdispatcher.action.cost_aware_route
...
# Formula — `router · cost_aware_route`
...
| Field | Value |
|-------|-------|
| Name | `router · cost_aware_route` |
| Graph node | `formula.adjusted.businessdispatcher.action.cost_aware_route` |
| Kind | dispatcher_router |
