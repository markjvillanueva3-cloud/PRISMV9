---
title: Formula — router · machine_cap_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.machine_cap_get
...
# Formula — `router · machine_cap_get`
...
| Field | Value |
|-------|-------|
| Name | `router · machine_cap_get` |
| Graph node | `formula.adjusted.devdispatcher.action.machine_cap_get` |
| Kind | dispatcher_router |
