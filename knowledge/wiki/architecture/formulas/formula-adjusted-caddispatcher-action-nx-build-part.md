---
title: Formula — router · nx_build_part
type: formula
formula_id: formula.adjusted.caddispatcher.action.nx_build_part
...
| Field | Value |
|-------|-------|
| Name | `router · nx_build_part` |
| Graph node | `formula.adjusted.caddispatcher.action.nx_build_part` |
| Kind | dispatcher_router |
