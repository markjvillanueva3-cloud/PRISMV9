---
title: Formula — PDFSourceRegistryEngine
type: formula
formula_id: eng.pdf.pdfformulaextractionengine.pdfsourceregistryengine
...
# Formula — `PDFSourceRegistryEngine`
...
| Field | Value |
|-------|-------|
| Name | `PDFSourceRegistryEngine` |
| Graph node | `eng.pdf.pdfformulaextractionengine.pdfsourceregistryengine` |
| Kind | pdf.pdfformulaextractionengine_engines |
