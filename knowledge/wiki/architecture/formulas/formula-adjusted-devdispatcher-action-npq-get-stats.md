---
title: Formula — router · npq_get_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.npq_get_stats
...
| Field | Value |
|-------|-------|
| Name | `router · npq_get_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.npq_get_stats` |
| Kind | dispatcher_router |
