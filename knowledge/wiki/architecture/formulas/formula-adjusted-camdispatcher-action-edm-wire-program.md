---
title: Formula — router · edm_wire_program
type: formula
formula_id: formula.adjusted.camdispatcher.action.edm_wire_program
...
# Formula — `router · edm_wire_program`
...
| Field | Value |
|-------|-------|
| Name | `router · edm_wire_program` |
| Graph node | `formula.adjusted.camdispatcher.action.edm_wire_program` |
| Kind | dispatcher_router |
