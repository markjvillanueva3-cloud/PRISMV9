---
title: Formula — router · thread
type: formula
formula_id: formula.adjusted.turningdispatcher.action.thread
...
|-------|-------|
| Name | `router · thread` |
| Graph node | `formula.adjusted.turningdispatcher.action.thread` |
| Kind | dispatcher_router |
