---
title: Formula — router · sci_recht_shear
type: formula
formula_id: formula.adjusted.camdispatcher.action.sci_recht_shear
...
# Formula — `router · sci_recht_shear`
...
| Field | Value |
|-------|-------|
| Name | `router · sci_recht_shear` |
| Graph node | `formula.adjusted.camdispatcher.action.sci_recht_shear` |
| Kind | dispatcher_router |
