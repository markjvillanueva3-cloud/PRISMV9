---
title: Formula — router · gcode_compress
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gcode_compress
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_compress` |
| Graph node | `formula.adjusted.calcdispatcher.action.gcode_compress` |
| Kind | dispatcher_router |
