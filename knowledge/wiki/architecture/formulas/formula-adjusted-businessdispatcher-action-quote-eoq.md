---
title: Formula — router · quote_eoq
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quote_eoq
...
| Field | Value |
|-------|-------|
| Name | `router · quote_eoq` |
| Graph node | `formula.adjusted.businessdispatcher.action.quote_eoq` |
| Kind | dispatcher_router |
