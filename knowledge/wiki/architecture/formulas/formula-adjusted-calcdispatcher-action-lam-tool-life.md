---
title: Formula — router · lam_tool_life
type: formula
formula_id: formula.adjusted.calcdispatcher.action.lam_tool_life
...
| Field | Value |
|-------|-------|
| Name | `router · lam_tool_life` |
| Graph node | `formula.adjusted.calcdispatcher.action.lam_tool_life` |
| Kind | dispatcher_router |
