---
title: Formula — router · sheetNesting
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.sheetnesting
...
| Field | Value |
|-------|-------|
| Name | `router · sheetNesting` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.sheetnesting` |
| Kind | dispatcher_router |
