---
title: Formula — router · tophatcasing
type: formula
formula_id: formula.adjusted.camdispatcher.action.tophatcasing
...
| Field | Value |
|-------|-------|
| Name | `router · tophatcasing` |
| Graph node | `formula.adjusted.camdispatcher.action.tophatcasing` |
| Kind | dispatcher_router |
