---
title: Formula — router · physics_verify
type: formula
formula_id: formula.adjusted.calcdispatcher.action.physics_verify
...
| Field | Value |
|-------|-------|
| Name | `router · physics_verify` |
| Graph node | `formula.adjusted.calcdispatcher.action.physics_verify` |
| Kind | dispatcher_router |
