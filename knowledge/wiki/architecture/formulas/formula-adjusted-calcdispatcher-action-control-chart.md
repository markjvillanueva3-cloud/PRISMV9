---
title: Formula — router · control_chart
type: formula
formula_id: formula.adjusted.calcdispatcher.action.control_chart
...
| Field | Value |
|-------|-------|
| Name | `router · control_chart` |
| Graph node | `formula.adjusted.calcdispatcher.action.control_chart` |
| Kind | dispatcher_router |
