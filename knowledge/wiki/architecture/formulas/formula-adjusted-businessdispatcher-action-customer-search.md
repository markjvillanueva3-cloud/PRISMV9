---
title: Formula — router · customer_search
type: formula
formula_id: formula.adjusted.businessdispatcher.action.customer_search
...
# Formula — `router · customer_search`
...
| Field | Value |
|-------|-------|
| Name | `router · customer_search` |
| Graph node | `formula.adjusted.businessdispatcher.action.customer_search` |
| Kind | dispatcher_router |
