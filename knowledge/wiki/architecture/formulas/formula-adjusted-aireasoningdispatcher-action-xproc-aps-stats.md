---
title: Formula — router · xproc_aps_stats
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.xproc_aps_stats
...
# Formula — `router · xproc_aps_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · xproc_aps_stats` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.xproc_aps_stats` |
| Kind | dispatcher_router |
