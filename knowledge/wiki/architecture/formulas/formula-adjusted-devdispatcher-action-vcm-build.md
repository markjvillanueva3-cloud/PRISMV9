---
title: Formula — router · vcm_build
type: formula
formula_id: formula.adjusted.devdispatcher.action.vcm_build
...
| Field | Value |
|-------|-------|
| Name | `router · vcm_build` |
| Graph node | `formula.adjusted.devdispatcher.action.vcm_build` |
| Kind | dispatcher_router |
