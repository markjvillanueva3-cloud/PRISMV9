---
title: Formula — router · wrtl_by_keyword
type: formula
formula_id: formula.adjusted.devdispatcher.action.wrtl_by_keyword
...
# Formula — `router · wrtl_by_keyword`
...
| Field | Value |
|-------|-------|
| Name | `router · wrtl_by_keyword` |
| Graph node | `formula.adjusted.devdispatcher.action.wrtl_by_keyword` |
| Kind | dispatcher_router |
