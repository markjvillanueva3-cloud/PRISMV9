---
title: Formula — router · xproc_fed_gate
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.xproc_fed_gate
...
| Field | Value |
|-------|-------|
| Name | `router · xproc_fed_gate` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.xproc_fed_gate` |
| Kind | dispatcher_router |
