---
title: Formula — router · cv_compare_models
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cv_compare_models
...
# Formula — `router · cv_compare_models`
...
| Field | Value |
|-------|-------|
| Name | `router · cv_compare_models` |
| Graph node | `formula.adjusted.calcdispatcher.action.cv_compare_models` |
| Kind | dispatcher_router |
