---
title: Formula — router · rbd_monte_carlo
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rbd_monte_carlo
...
# Formula — `router · rbd_monte_carlo`
...
| Field | Value |
|-------|-------|
| Name | `router · rbd_monte_carlo` |
| Graph node | `formula.adjusted.calcdispatcher.action.rbd_monte_carlo` |
| Kind | dispatcher_router |
