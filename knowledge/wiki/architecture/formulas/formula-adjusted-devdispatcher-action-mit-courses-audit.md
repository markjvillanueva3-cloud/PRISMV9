---
title: Formula — router · mit_courses_audit
type: formula
formula_id: formula.adjusted.devdispatcher.action.mit_courses_audit
...
# Formula — `router · mit_courses_audit`
...
| Field | Value |
|-------|-------|
| Name | `router · mit_courses_audit` |
| Graph node | `formula.adjusted.devdispatcher.action.mit_courses_audit` |
| Kind | dispatcher_router |
