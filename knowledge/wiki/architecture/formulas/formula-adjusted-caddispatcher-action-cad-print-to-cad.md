---
title: Formula — router · cad_print_to_cad
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_print_to_cad
...
# Formula — `router · cad_print_to_cad`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_print_to_cad` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_print_to_cad` |
| Kind | dispatcher_router |
