---
title: Formula — router · brainstorm
type: formula
formula_id: formula.adjusted.spdispatcher.action.brainstorm
...
| Field | Value |
|-------|-------|
| Name | `router · brainstorm` |
| Graph node | `formula.adjusted.spdispatcher.action.brainstorm` |
| Kind | dispatcher_router |
