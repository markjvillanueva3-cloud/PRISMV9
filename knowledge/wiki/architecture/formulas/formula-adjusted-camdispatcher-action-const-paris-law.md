---
title: Formula — router · const_paris_law
type: formula
formula_id: formula.adjusted.camdispatcher.action.const_paris_law
...
# Formula — `router · const_paris_law`
...
| Field | Value |
|-------|-------|
| Name | `router · const_paris_law` |
| Graph node | `formula.adjusted.camdispatcher.action.const_paris_law` |
| Kind | dispatcher_router |
