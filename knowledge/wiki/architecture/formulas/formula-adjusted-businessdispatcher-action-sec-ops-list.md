---
title: Formula — router · sec_ops_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.sec_ops_list
...
| Field | Value |
|-------|-------|
| Name | `router · sec_ops_list` |
| Graph node | `formula.adjusted.businessdispatcher.action.sec_ops_list` |
| Kind | dispatcher_router |
