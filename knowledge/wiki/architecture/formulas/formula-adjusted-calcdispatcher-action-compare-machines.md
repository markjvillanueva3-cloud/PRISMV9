---
title: Formula — router · compare_machines
type: formula
formula_id: formula.adjusted.calcdispatcher.action.compare_machines
...
# Formula — `router · compare_machines`
...
| Field | Value |
|-------|-------|
| Name | `router · compare_machines` |
| Graph node | `formula.adjusted.calcdispatcher.action.compare_machines` |
| Kind | dispatcher_router |
