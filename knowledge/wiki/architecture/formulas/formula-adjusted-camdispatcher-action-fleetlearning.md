---
title: Formula — router · fleetLearning
type: formula
formula_id: formula.adjusted.camdispatcher.action.fleetlearning
...
| Field | Value |
|-------|-------|
| Name | `router · fleetLearning` |
| Graph node | `formula.adjusted.camdispatcher.action.fleetlearning` |
| Kind | dispatcher_router |
