---
title: Formula — router · cad_thumb_has
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_thumb_has
...
| Field | Value |
|-------|-------|
| Name | `router · cad_thumb_has` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_thumb_has` |
| Kind | dispatcher_router |
