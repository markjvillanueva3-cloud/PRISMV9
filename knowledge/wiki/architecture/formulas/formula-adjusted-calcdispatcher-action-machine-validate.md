---
title: Formula — router · machine_validate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.machine_validate
...
# Formula — `router · machine_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · machine_validate` |
| Graph node | `formula.adjusted.calcdispatcher.action.machine_validate` |
| Kind | dispatcher_router |
