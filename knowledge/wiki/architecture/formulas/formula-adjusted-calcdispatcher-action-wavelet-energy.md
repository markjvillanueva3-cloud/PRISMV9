---
title: Formula — router · wavelet_energy
type: formula
formula_id: formula.adjusted.calcdispatcher.action.wavelet_energy
...
| Field | Value |
|-------|-------|
| Name | `router · wavelet_energy` |
| Graph node | `formula.adjusted.calcdispatcher.action.wavelet_energy` |
| Kind | dispatcher_router |
