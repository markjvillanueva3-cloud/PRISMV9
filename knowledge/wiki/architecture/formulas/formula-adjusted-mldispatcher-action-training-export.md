---
title: Formula — router · training_export
type: formula
formula_id: formula.adjusted.mldispatcher.action.training_export
...
# Formula — `router · training_export`
...
| Field | Value |
|-------|-------|
| Name | `router · training_export` |
| Graph node | `formula.adjusted.mldispatcher.action.training_export` |
| Kind | dispatcher_router |
