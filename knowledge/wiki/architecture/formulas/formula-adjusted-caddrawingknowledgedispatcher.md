---
title: Formula — router · cadDrawingKnowledge
type: formula
formula_id: formula.adjusted.caddrawingknowledgedispatcher
...
# Formula — `router · cadDrawingKnowledge`
...
| Field | Value |
|-------|-------|
| Name | `router · cadDrawingKnowledge` |
| Graph node | `formula.adjusted.caddrawingknowledgedispatcher` |
| Kind | dispatcher_router |
