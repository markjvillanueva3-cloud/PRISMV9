---
title: Formula — router · restore_learning
type: formula
formula_id: formula.adjusted.calcdispatcher.action.restore_learning
...
# Formula — `router · restore_learning`
...
| Field | Value |
|-------|-------|
| Name | `router · restore_learning` |
| Graph node | `formula.adjusted.calcdispatcher.action.restore_learning` |
| Kind | dispatcher_router |
