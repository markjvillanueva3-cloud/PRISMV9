---
title: Formula — router · po_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.po_list
...
|-------|-------|
| Name | `router · po_list` |
| Graph node | `formula.adjusted.businessdispatcher.action.po_list` |
| Kind | dispatcher_router |
