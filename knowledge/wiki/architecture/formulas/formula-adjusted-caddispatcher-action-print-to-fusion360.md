---
title: Formula — router · print_to_fusion360
type: formula
formula_id: formula.adjusted.caddispatcher.action.print_to_fusion360
...
# Formula — `router · print_to_fusion360`
...
| Field | Value |
|-------|-------|
| Name | `router · print_to_fusion360` |
| Graph node | `formula.adjusted.caddispatcher.action.print_to_fusion360` |
| Kind | dispatcher_router |
