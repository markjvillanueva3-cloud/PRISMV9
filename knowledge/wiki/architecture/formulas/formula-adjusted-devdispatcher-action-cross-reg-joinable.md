---
title: Formula — router · cross_reg_joinable
type: formula
formula_id: formula.adjusted.devdispatcher.action.cross_reg_joinable
...
# Formula — `router · cross_reg_joinable`
...
| Field | Value |
|-------|-------|
| Name | `router · cross_reg_joinable` |
| Graph node | `formula.adjusted.devdispatcher.action.cross_reg_joinable` |
| Kind | dispatcher_router |
