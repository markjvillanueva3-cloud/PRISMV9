---
title: Formula — router · jss_job_shop
type: formula
formula_id: formula.adjusted.devdispatcher.action.jss_job_shop
...
| Field | Value |
|-------|-------|
| Name | `router · jss_job_shop` |
| Graph node | `formula.adjusted.devdispatcher.action.jss_job_shop` |
| Kind | dispatcher_router |
