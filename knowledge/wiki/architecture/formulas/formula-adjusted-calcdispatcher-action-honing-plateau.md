---
title: Formula — router · honing_plateau
type: formula
formula_id: formula.adjusted.calcdispatcher.action.honing_plateau
...
| Field | Value |
|-------|-------|
| Name | `router · honing_plateau` |
| Graph node | `formula.adjusted.calcdispatcher.action.honing_plateau` |
| Kind | dispatcher_router |
