---
title: Formula — router · ai_milling_agi
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.ai_milling_agi
...
| Field | Value |
|-------|-------|
| Name | `router · ai_milling_agi` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.ai_milling_agi` |
| Kind | dispatcher_router |
