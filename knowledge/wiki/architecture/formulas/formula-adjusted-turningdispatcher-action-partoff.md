---
title: Formula — router · partoff
type: formula
formula_id: formula.adjusted.turningdispatcher.action.partoff
...
|-------|-------|
| Name | `router · partoff` |
| Graph node | `formula.adjusted.turningdispatcher.action.partoff` |
| Kind | dispatcher_router |
