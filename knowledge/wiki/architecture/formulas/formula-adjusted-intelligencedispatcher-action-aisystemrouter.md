---
title: Formula — router · aiSystemRouter
type: formula
formula_id: formula.adjusted.intelligencedispatcher.action.aisystemrouter
...
| Field | Value |
|-------|-------|
| Name | `router · aiSystemRouter` |
| Graph node | `formula.adjusted.intelligencedispatcher.action.aisystemrouter` |
| Kind | dispatcher_router |
