---
title: Formula — router · dme_can_combine
type: formula
formula_id: formula.adjusted.devdispatcher.action.dme_can_combine
...
# Formula — `router · dme_can_combine`
...
| Field | Value |
|-------|-------|
| Name | `router · dme_can_combine` |
| Graph node | `formula.adjusted.devdispatcher.action.dme_can_combine` |
| Kind | dispatcher_router |
