---
title: Formula — router · dialect_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.dialect_list
...
| Field | Value |
|-------|-------|
| Name | `router · dialect_list` |
| Graph node | `formula.adjusted.camdispatcher.action.dialect_list` |
| Kind | dispatcher_router |
