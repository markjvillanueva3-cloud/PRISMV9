---
title: Formula — router · gap_scan_file
type: formula
formula_id: formula.adjusted.devdispatcher.action.gap_scan_file
...
| Field | Value |
|-------|-------|
| Name | `router · gap_scan_file` |
| Graph node | `formula.adjusted.devdispatcher.action.gap_scan_file` |
| Kind | dispatcher_router |
