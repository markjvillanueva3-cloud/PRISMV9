---
title: Formula — router · cv_leave_one_out
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cv_leave_one_out
...
# Formula — `router · cv_leave_one_out`
...
| Field | Value |
|-------|-------|
| Name | `router · cv_leave_one_out` |
| Graph node | `formula.adjusted.calcdispatcher.action.cv_leave_one_out` |
| Kind | dispatcher_router |
