---
title: Formula — router · mda_by_type
type: formula
formula_id: formula.adjusted.devdispatcher.action.mda_by_type
...
| Field | Value |
|-------|-------|
| Name | `router · mda_by_type` |
| Graph node | `formula.adjusted.devdispatcher.action.mda_by_type` |
| Kind | dispatcher_router |
