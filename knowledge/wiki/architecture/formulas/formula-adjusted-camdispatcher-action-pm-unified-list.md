---
title: Formula — router · pm_unified_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_unified_list
...
# Formula — `router · pm_unified_list`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_unified_list` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_unified_list` |
| Kind | dispatcher_router |
