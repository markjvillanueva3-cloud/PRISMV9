---
title: Formula — router · chip_formation
type: formula
formula_id: formula.adjusted.calcdispatcher.action.chip_formation
...
| Field | Value |
|-------|-------|
| Name | `router · chip_formation` |
| Graph node | `formula.adjusted.calcdispatcher.action.chip_formation` |
| Kind | dispatcher_router |
