---
title: Formula — router · autonomyGate
type: formula
formula_id: formula.adjusted.edmdispatcher.action.autonomygate
...
| Field | Value |
|-------|-------|
| Name | `router · autonomyGate` |
| Graph node | `formula.adjusted.edmdispatcher.action.autonomygate` |
| Kind | dispatcher_router |
