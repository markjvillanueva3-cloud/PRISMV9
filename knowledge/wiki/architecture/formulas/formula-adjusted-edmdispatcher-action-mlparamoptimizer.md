---
title: Formula — router · mlParamOptimizer
type: formula
formula_id: formula.adjusted.edmdispatcher.action.mlparamoptimizer
...
# Formula — `router · mlParamOptimizer`
...
| Field | Value |
|-------|-------|
| Name | `router · mlParamOptimizer` |
| Graph node | `formula.adjusted.edmdispatcher.action.mlparamoptimizer` |
| Kind | dispatcher_router |
