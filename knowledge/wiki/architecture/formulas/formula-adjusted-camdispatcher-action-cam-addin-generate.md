---
title: Formula — router · cam_addin_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_addin_generate
...
# Formula — `router · cam_addin_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_addin_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_addin_generate` |
| Kind | dispatcher_router |
