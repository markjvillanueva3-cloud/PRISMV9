---
title: Formula — router · pm_unified_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_unified_stats
...
# Formula — `router · pm_unified_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_unified_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_unified_stats` |
| Kind | dispatcher_router |
