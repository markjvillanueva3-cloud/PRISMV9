---
title: Formula — router · list_systems
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.list_systems
...
| Field | Value |
|-------|-------|
| Name | `router · list_systems` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.list_systems` |
| Kind | dispatcher_router |
