---
title: Formula — router · cad_index_scan
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_index_scan
...
| Field | Value |
|-------|-------|
| Name | `router · cad_index_scan` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_index_scan` |
| Kind | dispatcher_router |
