---
title: Formula — router · fsm_close
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.fsm_close
...
| Field | Value |
|-------|-------|
| Name | `router · fsm_close` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.fsm_close` |
| Kind | dispatcher_router |
