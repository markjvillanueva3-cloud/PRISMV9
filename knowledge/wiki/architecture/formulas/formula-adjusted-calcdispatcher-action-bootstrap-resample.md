---
title: Formula — router · bootstrap_resample
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bootstrap_resample
...
# Formula — `router · bootstrap_resample`
...
| Field | Value |
|-------|-------|
| Name | `router · bootstrap_resample` |
| Graph node | `formula.adjusted.calcdispatcher.action.bootstrap_resample` |
| Kind | dispatcher_router |
