---
title: Formula — router · calibration_export
type: formula
formula_id: formula.adjusted.calcdispatcher.action.calibration_export
...
# Formula — `router · calibration_export`
...
| Field | Value |
|-------|-------|
| Name | `router · calibration_export` |
| Graph node | `formula.adjusted.calcdispatcher.action.calibration_export` |
| Kind | dispatcher_router |
