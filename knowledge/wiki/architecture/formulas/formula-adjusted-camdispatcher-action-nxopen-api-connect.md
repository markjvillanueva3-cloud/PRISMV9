---
title: Formula — router · nxopen_api_connect
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxopen_api_connect
...
# Formula — `router · nxopen_api_connect`
...
| Field | Value |
|-------|-------|
| Name | `router · nxopen_api_connect` |
| Graph node | `formula.adjusted.camdispatcher.action.nxopen_api_connect` |
| Kind | dispatcher_router |
