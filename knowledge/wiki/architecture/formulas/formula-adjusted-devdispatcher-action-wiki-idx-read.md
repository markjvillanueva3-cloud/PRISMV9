---
title: Formula — router · wiki_idx_read
type: formula
formula_id: formula.adjusted.devdispatcher.action.wiki_idx_read
...
| Field | Value |
|-------|-------|
| Name | `router · wiki_idx_read` |
| Graph node | `formula.adjusted.devdispatcher.action.wiki_idx_read` |
| Kind | dispatcher_router |
