---
title: Formula — router · ai_learn
type: formula
formula_id: formula.adjusted.milldispatcher.action.ai_learn
...
| Field | Value |
|-------|-------|
| Name | `router · ai_learn` |
| Graph node | `formula.adjusted.milldispatcher.action.ai_learn` |
| Kind | dispatcher_router |
