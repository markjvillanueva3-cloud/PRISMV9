---
title: Formula — router · clutch_brake_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.clutch_brake_calc
...
# Formula — `router · clutch_brake_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · clutch_brake_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.clutch_brake_calc` |
| Kind | dispatcher_router |
