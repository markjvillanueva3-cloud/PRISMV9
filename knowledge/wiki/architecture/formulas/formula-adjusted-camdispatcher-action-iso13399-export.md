---
title: Formula — router · iso13399_export
type: formula
formula_id: formula.adjusted.camdispatcher.action.iso13399_export
...
# Formula — `router · iso13399_export`
...
| Field | Value |
|-------|-------|
| Name | `router · iso13399_export` |
| Graph node | `formula.adjusted.camdispatcher.action.iso13399_export` |
| Kind | dispatcher_router |
