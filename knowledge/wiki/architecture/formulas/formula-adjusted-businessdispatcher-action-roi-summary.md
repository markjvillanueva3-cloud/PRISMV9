---
title: Formula — router · roi_summary
type: formula
formula_id: formula.adjusted.businessdispatcher.action.roi_summary
...
| Field | Value |
|-------|-------|
| Name | `router · roi_summary` |
| Graph node | `formula.adjusted.businessdispatcher.action.roi_summary` |
| Kind | dispatcher_router |
