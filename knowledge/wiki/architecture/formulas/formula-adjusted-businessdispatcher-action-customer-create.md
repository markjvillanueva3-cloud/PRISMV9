---
title: Formula — router · customer_create
type: formula
formula_id: formula.adjusted.businessdispatcher.action.customer_create
...
# Formula — `router · customer_create`
...
| Field | Value |
|-------|-------|
| Name | `router · customer_create` |
| Graph node | `formula.adjusted.businessdispatcher.action.customer_create` |
| Kind | dispatcher_router |
