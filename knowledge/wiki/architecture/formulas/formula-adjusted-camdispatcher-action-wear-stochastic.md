---
title: Formula — router · wear_stochastic
type: formula
formula_id: formula.adjusted.camdispatcher.action.wear_stochastic
...
# Formula — `router · wear_stochastic`
...
| Field | Value |
|-------|-------|
| Name | `router · wear_stochastic` |
| Graph node | `formula.adjusted.camdispatcher.action.wear_stochastic` |
| Kind | dispatcher_router |
