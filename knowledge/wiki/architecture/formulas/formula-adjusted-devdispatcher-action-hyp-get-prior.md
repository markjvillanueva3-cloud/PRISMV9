---
title: Formula — router · hyp_get_prior
type: formula
formula_id: formula.adjusted.devdispatcher.action.hyp_get_prior
...
| Field | Value |
|-------|-------|
| Name | `router · hyp_get_prior` |
| Graph node | `formula.adjusted.devdispatcher.action.hyp_get_prior` |
| Kind | dispatcher_router |
