---
title: Formula — router · cse_plan
type: formula
formula_id: formula.adjusted.devdispatcher.action.cse_plan
...
| Field | Value |
|-------|-------|
| Name | `router · cse_plan` |
| Graph node | `formula.adjusted.devdispatcher.action.cse_plan` |
| Kind | dispatcher_router |
