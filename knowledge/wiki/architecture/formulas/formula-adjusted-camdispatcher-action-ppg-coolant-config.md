---
title: Formula — router · ppg_coolant_config
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_coolant_config
...
# Formula — `router · ppg_coolant_config`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_coolant_config` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_coolant_config` |
| Kind | dispatcher_router |
