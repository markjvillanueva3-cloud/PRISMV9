---
title: Formula — router · burnishing_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.burnishing_predict
...
# Formula — `router · burnishing_predict`
...
| Field | Value |
|-------|-------|
| Name | `router · burnishing_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.burnishing_predict` |
| Kind | dispatcher_router |
