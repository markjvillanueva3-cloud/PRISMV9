---
title: Formula — router · pultrusion
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.pultrusion
...
| Field | Value |
|-------|-------|
| Name | `router · pultrusion` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.pultrusion` |
| Kind | dispatcher_router |
