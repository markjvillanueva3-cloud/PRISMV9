---
title: Formula — router · collision
type: formula
formula_id: formula.adjusted.camdispatcher.action.collision
...
| Graph node | `formula.adjusted.camdispatcher.action.collision` |
| Kind | dispatcher_router |
