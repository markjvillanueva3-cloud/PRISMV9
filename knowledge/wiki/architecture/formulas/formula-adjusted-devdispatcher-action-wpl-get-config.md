---
title: Formula — router · wpl_get_config
type: formula
formula_id: formula.adjusted.devdispatcher.action.wpl_get_config
...
| Field | Value |
|-------|-------|
| Name | `router · wpl_get_config` |
| Graph node | `formula.adjusted.devdispatcher.action.wpl_get_config` |
| Kind | dispatcher_router |
