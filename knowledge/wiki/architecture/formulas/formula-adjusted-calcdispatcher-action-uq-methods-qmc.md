---
title: Formula — router · uq_methods_qmc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.uq_methods_qmc
...
| Field | Value |
|-------|-------|
| Name | `router · uq_methods_qmc` |
| Graph node | `formula.adjusted.calcdispatcher.action.uq_methods_qmc` |
| Kind | dispatcher_router |
