---
title: Formula — router · mti_get_statistics
type: formula
formula_id: formula.adjusted.devdispatcher.action.mti_get_statistics
...
# Formula — `router · mti_get_statistics`
...
| Field | Value |
|-------|-------|
| Name | `router · mti_get_statistics` |
| Graph node | `formula.adjusted.devdispatcher.action.mti_get_statistics` |
| Kind | dispatcher_router |
