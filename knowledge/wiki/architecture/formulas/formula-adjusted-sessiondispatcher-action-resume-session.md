---
title: Formula — router · resume_session
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.resume_session
...
| Field | Value |
|-------|-------|
| Name | `router · resume_session` |
| Graph node | `formula.adjusted.sessiondispatcher.action.resume_session` |
| Kind | dispatcher_router |
