---
title: Formula — router · strategyBenchmark
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategybenchmark
...
# Formula — `router · strategyBenchmark`
...
| Field | Value |
|-------|-------|
| Name | `router · strategyBenchmark` |
| Graph node | `formula.adjusted.camdispatcher.action.strategybenchmark` |
| Kind | dispatcher_router |
