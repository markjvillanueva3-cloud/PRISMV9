---
title: Formula — router · strategySequencing
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategysequencing
...
# Formula — `router · strategySequencing`
...
| Field | Value |
|-------|-------|
| Name | `router · strategySequencing` |
| Graph node | `formula.adjusted.camdispatcher.action.strategysequencing` |
| Kind | dispatcher_router |
