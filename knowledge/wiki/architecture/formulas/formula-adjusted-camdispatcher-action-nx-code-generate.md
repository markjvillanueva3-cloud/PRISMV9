---
title: Formula — router · nx_code_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_code_generate
...
# Formula — `router · nx_code_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_code_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_code_generate` |
| Kind | dispatcher_router |
