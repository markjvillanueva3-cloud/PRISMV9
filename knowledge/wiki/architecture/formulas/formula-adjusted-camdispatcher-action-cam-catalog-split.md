---
title: Formula — router · cam_catalog_split
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_catalog_split
...
# Formula — `router · cam_catalog_split`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_catalog_split` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_catalog_split` |
| Kind | dispatcher_router |
