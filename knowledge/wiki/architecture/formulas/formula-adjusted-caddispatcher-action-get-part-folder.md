---
title: Formula — router · get_part_folder
type: formula
formula_id: formula.adjusted.caddispatcher.action.get_part_folder
...
# Formula — `router · get_part_folder`
...
| Field | Value |
|-------|-------|
| Name | `router · get_part_folder` |
| Graph node | `formula.adjusted.caddispatcher.action.get_part_folder` |
| Kind | dispatcher_router |
