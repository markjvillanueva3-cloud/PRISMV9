---
title: Formula — router · wedm_select_wire
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_select_wire
...
# Formula — `router · wedm_select_wire`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_select_wire` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_select_wire` |
| Kind | dispatcher_router |
