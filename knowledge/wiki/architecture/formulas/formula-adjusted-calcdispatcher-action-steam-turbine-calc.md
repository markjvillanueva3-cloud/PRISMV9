---
title: Formula — router · steam_turbine_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.steam_turbine_calc
...
# Formula — `router · steam_turbine_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · steam_turbine_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.steam_turbine_calc` |
| Kind | dispatcher_router |
