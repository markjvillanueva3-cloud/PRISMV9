---
title: Formula — router · plib_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.plib_get
...
| Field | Value |
|-------|-------|
| Name | `router · plib_get` |
| Graph node | `formula.adjusted.devdispatcher.action.plib_get` |
| Kind | dispatcher_router |
