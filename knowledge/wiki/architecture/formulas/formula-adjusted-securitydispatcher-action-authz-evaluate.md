---
title: Formula — router · authz_evaluate
type: formula
formula_id: formula.adjusted.securitydispatcher.action.authz_evaluate
...
| Field | Value |
|-------|-------|
| Name | `router · authz_evaluate` |
| Graph node | `formula.adjusted.securitydispatcher.action.authz_evaluate` |
| Kind | dispatcher_router |
