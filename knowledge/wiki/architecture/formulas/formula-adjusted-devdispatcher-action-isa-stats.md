---
title: Formula — router · isa_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.isa_stats
...
| Field | Value |
|-------|-------|
| Name | `router · isa_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.isa_stats` |
| Kind | dispatcher_router |
