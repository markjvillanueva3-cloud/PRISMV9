---
title: Formula — router · arc_fit
type: formula
formula_id: formula.adjusted.calcdispatcher.action.arc_fit
...
|-------|-------|
| Name | `router · arc_fit` |
| Graph node | `formula.adjusted.calcdispatcher.action.arc_fit` |
| Kind | dispatcher_router |
