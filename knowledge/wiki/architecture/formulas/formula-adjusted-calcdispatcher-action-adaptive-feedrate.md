---
title: Formula — router · adaptive_feedrate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.adaptive_feedrate
...
# Formula — `router · adaptive_feedrate`
...
| Field | Value |
|-------|-------|
| Name | `router · adaptive_feedrate` |
| Graph node | `formula.adjusted.calcdispatcher.action.adaptive_feedrate` |
| Kind | dispatcher_router |
