---
title: Formula — router · spindle_plot_curve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spindle_plot_curve
...
# Formula — `router · spindle_plot_curve`
...
| Field | Value |
|-------|-------|
| Name | `router · spindle_plot_curve` |
| Graph node | `formula.adjusted.calcdispatcher.action.spindle_plot_curve` |
| Kind | dispatcher_router |
