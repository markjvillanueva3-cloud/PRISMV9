---
title: Formula — router · optimizationTier
type: formula
formula_id: formula.adjusted.camdispatcher.action.optimizationtier
...
# Formula — `router · optimizationTier`
...
| Field | Value |
|-------|-------|
| Name | `router · optimizationTier` |
| Graph node | `formula.adjusted.camdispatcher.action.optimizationtier` |
| Kind | dispatcher_router |
