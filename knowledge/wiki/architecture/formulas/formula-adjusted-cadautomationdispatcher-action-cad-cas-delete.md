---
title: Formula — router · cad_cas_delete
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_cas_delete
...
| Field | Value |
|-------|-------|
| Name | `router · cad_cas_delete` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_cas_delete` |
| Kind | dispatcher_router |
