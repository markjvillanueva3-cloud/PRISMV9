---
title: Formula — router · cad_registry_get
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_registry_get
...
# Formula — `router · cad_registry_get`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_registry_get` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_registry_get` |
| Kind | dispatcher_router |
