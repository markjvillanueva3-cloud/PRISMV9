---
title: Formula — router · wpn_classify
type: formula
formula_id: formula.adjusted.devdispatcher.action.wpn_classify
...
| Field | Value |
|-------|-------|
| Name | `router · wpn_classify` |
| Graph node | `formula.adjusted.devdispatcher.action.wpn_classify` |
| Kind | dispatcher_router |
