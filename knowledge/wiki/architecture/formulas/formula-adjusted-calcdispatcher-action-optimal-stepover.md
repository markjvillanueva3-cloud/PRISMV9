---
title: Formula — router · optimal_stepover
type: formula
formula_id: formula.adjusted.calcdispatcher.action.optimal_stepover
...
# Formula — `router · optimal_stepover`
...
| Field | Value |
|-------|-------|
| Name | `router · optimal_stepover` |
| Graph node | `formula.adjusted.calcdispatcher.action.optimal_stepover` |
| Kind | dispatcher_router |
