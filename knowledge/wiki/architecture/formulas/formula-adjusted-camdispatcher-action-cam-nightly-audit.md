---
title: Formula — router · cam_nightly_audit
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_nightly_audit
...
# Formula — `router · cam_nightly_audit`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_nightly_audit` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_nightly_audit` |
| Kind | dispatcher_router |
