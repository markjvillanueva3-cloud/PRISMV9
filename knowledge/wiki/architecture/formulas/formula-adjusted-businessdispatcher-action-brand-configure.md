---
title: Formula — router · brand_configure
type: formula
formula_id: formula.adjusted.businessdispatcher.action.brand_configure
...
# Formula — `router · brand_configure`
...
| Field | Value |
|-------|-------|
| Name | `router · brand_configure` |
| Graph node | `formula.adjusted.businessdispatcher.action.brand_configure` |
| Kind | dispatcher_router |
