---
title: Formula — router · system_snapshot
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.system_snapshot
...
# Formula — `router · system_snapshot`
...
| Field | Value |
|-------|-------|
| Name | `router · system_snapshot` |
| Graph node | `formula.adjusted.sessiondispatcher.action.system_snapshot` |
| Kind | dispatcher_router |
