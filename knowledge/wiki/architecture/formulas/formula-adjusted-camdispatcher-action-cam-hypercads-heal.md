---
title: Formula — router · cam_hyperCADS_heal
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_hypercads_heal
...
# Formula — `router · cam_hyperCADS_heal`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_hyperCADS_heal` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_hypercads_heal` |
| Kind | dispatcher_router |
