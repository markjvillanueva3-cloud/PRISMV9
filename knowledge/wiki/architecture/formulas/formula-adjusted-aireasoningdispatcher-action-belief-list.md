---
title: Formula — router · belief_list
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.belief_list
...
| Field | Value |
|-------|-------|
| Name | `router · belief_list` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.belief_list` |
| Kind | dispatcher_router |
