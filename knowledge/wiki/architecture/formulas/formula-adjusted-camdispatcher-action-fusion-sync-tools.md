---
title: Formula — router · fusion_sync_tools
type: formula
formula_id: formula.adjusted.camdispatcher.action.fusion_sync_tools
...
# Formula — `router · fusion_sync_tools`
...
| Field | Value |
|-------|-------|
| Name | `router · fusion_sync_tools` |
| Graph node | `formula.adjusted.camdispatcher.action.fusion_sync_tools` |
| Kind | dispatcher_router |
