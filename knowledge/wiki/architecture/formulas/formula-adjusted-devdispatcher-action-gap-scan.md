---
title: Formula — router · gap_scan
type: formula
formula_id: formula.adjusted.devdispatcher.action.gap_scan
...
| Field | Value |
|-------|-------|
| Name | `router · gap_scan` |
| Graph node | `formula.adjusted.devdispatcher.action.gap_scan` |
| Kind | dispatcher_router |
