---
title: Formula — router · mda_by_layer
type: formula
formula_id: formula.adjusted.devdispatcher.action.mda_by_layer
...
| Field | Value |
|-------|-------|
| Name | `router · mda_by_layer` |
| Graph node | `formula.adjusted.devdispatcher.action.mda_by_layer` |
| Kind | dispatcher_router |
