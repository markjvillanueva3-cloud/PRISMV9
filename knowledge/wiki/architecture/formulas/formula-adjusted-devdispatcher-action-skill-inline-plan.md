---
title: Formula — router · skill_inline_plan
type: formula
formula_id: formula.adjusted.devdispatcher.action.skill_inline_plan
...
# Formula — `router · skill_inline_plan`
...
| Field | Value |
|-------|-------|
| Name | `router · skill_inline_plan` |
| Graph node | `formula.adjusted.devdispatcher.action.skill_inline_plan` |
| Kind | dispatcher_router |
