---
title: Formula — router · mca_all_holders
type: formula
formula_id: formula.adjusted.devdispatcher.action.mca_all_holders
...
# Formula — `router · mca_all_holders`
...
| Field | Value |
|-------|-------|
| Name | `router · mca_all_holders` |
| Graph node | `formula.adjusted.devdispatcher.action.mca_all_holders` |
| Kind | dispatcher_router |
