---
title: Formula — router · mesh_curvature_all
type: formula
formula_id: formula.adjusted.calcdispatcher.action.mesh_curvature_all
...
# Formula — `router · mesh_curvature_all`
...
| Field | Value |
|-------|-------|
| Name | `router · mesh_curvature_all` |
| Graph node | `formula.adjusted.calcdispatcher.action.mesh_curvature_all` |
| Kind | dispatcher_router |
