---
title: Formula — router · cooling_tower_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cooling_tower_calc
...
# Formula — `router · cooling_tower_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · cooling_tower_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.cooling_tower_calc` |
| Kind | dispatcher_router |
