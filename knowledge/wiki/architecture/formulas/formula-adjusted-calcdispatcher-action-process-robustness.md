---
title: Formula — router · process_robustness
type: formula
formula_id: formula.adjusted.calcdispatcher.action.process_robustness
...
# Formula — `router · process_robustness`
...
| Field | Value |
|-------|-------|
| Name | `router · process_robustness` |
| Graph node | `formula.adjusted.calcdispatcher.action.process_robustness` |
| Kind | dispatcher_router |
