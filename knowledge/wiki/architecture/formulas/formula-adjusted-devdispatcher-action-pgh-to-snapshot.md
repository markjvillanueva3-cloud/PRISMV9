---
title: Formula — router · pgh_to_snapshot
type: formula
formula_id: formula.adjusted.devdispatcher.action.pgh_to_snapshot
...
# Formula — `router · pgh_to_snapshot`
...
| Field | Value |
|-------|-------|
| Name | `router · pgh_to_snapshot` |
| Graph node | `formula.adjusted.devdispatcher.action.pgh_to_snapshot` |
| Kind | dispatcher_router |
