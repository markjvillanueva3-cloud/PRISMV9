---
title: Formula — router · sketch_to_svg
type: formula
formula_id: formula.adjusted.caddispatcher.action.sketch_to_svg
...
| Field | Value |
|-------|-------|
| Name | `router · sketch_to_svg` |
| Graph node | `formula.adjusted.caddispatcher.action.sketch_to_svg` |
| Kind | dispatcher_router |
