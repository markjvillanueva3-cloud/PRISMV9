---
title: Formula — router · aiml_anomaly
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.aiml_anomaly
...
| Field | Value |
|-------|-------|
| Name | `router · aiml_anomaly` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.aiml_anomaly` |
| Kind | dispatcher_router |
