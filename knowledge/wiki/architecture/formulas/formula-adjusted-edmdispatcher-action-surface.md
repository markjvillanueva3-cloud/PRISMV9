---
title: Formula — router · surface
type: formula
formula_id: formula.adjusted.edmdispatcher.action.surface
...
|-------|-------|
| Name | `router · surface` |
| Graph node | `formula.adjusted.edmdispatcher.action.surface` |
| Kind | dispatcher_router |
