---
title: Formula — router · fsm_list
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.fsm_list
...
| Field | Value |
|-------|-------|
| Name | `router · fsm_list` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.fsm_list` |
| Kind | dispatcher_router |
