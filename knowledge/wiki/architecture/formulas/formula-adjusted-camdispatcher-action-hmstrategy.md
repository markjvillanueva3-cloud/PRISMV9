---
title: Formula — router · hmStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmstrategy
...
| Field | Value |
|-------|-------|
| Name | `router · hmStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.hmstrategy` |
| Kind | dispatcher_router |
