---
title: Formula — router · fusion360_execute
type: formula
formula_id: formula.adjusted.caddispatcher.action.fusion360_execute
...
# Formula — `router · fusion360_execute`
...
| Field | Value |
|-------|-------|
| Name | `router · fusion360_execute` |
| Graph node | `formula.adjusted.caddispatcher.action.fusion360_execute` |
| Kind | dispatcher_router |
