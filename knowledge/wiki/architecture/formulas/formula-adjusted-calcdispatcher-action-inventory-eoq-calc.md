---
title: Formula — router · inventory_eoq_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.inventory_eoq_calc
...
# Formula — `router · inventory_eoq_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · inventory_eoq_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.inventory_eoq_calc` |
| Kind | dispatcher_router |
