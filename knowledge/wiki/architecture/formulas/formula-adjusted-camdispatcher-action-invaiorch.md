---
title: Formula — router · invAIOrch
type: formula
formula_id: formula.adjusted.camdispatcher.action.invaiorch
...
| Field | Value |
|-------|-------|
| Name | `router · invAIOrch` |
| Graph node | `formula.adjusted.camdispatcher.action.invaiorch` |
| Kind | dispatcher_router |
