---
title: Formula — router · vibration_modal
type: formula
formula_id: formula.adjusted.calcdispatcher.action.vibration_modal
...
# Formula — `router · vibration_modal`
...
| Field | Value |
|-------|-------|
| Name | `router · vibration_modal` |
| Graph node | `formula.adjusted.calcdispatcher.action.vibration_modal` |
| Kind | dispatcher_router |
