---
title: Formula — router · strips_plan
type: formula
formula_id: formula.adjusted.devdispatcher.action.strips_plan
...
| Field | Value |
|-------|-------|
| Name | `router · strips_plan` |
| Graph node | `formula.adjusted.devdispatcher.action.strips_plan` |
| Kind | dispatcher_router |
