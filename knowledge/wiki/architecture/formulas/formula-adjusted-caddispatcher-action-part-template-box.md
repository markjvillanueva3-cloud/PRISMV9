---
title: Formula — router · part_template_box
type: formula
formula_id: formula.adjusted.caddispatcher.action.part_template_box
...
# Formula — `router · part_template_box`
...
| Field | Value |
|-------|-------|
| Name | `router · part_template_box` |
| Graph node | `formula.adjusted.caddispatcher.action.part_template_box` |
| Kind | dispatcher_router |
