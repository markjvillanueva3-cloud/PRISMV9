---
title: Formula — router · schema_gap_scan
type: formula
formula_id: formula.adjusted.devdispatcher.action.schema_gap_scan
...
# Formula — `router · schema_gap_scan`
...
| Field | Value |
|-------|-------|
| Name | `router · schema_gap_scan` |
| Graph node | `formula.adjusted.devdispatcher.action.schema_gap_scan` |
| Kind | dispatcher_router |
