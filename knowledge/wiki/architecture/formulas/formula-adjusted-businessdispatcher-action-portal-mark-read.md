---
title: Formula — router · portal_mark_read
type: formula
formula_id: formula.adjusted.businessdispatcher.action.portal_mark_read
...
# Formula — `router · portal_mark_read`
...
| Field | Value |
|-------|-------|
| Name | `router · portal_mark_read` |
| Graph node | `formula.adjusted.businessdispatcher.action.portal_mark_read` |
| Kind | dispatcher_router |
