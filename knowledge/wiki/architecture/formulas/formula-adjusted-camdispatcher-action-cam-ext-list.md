---
title: Formula — router · cam_ext_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_ext_list
...
| Field | Value |
|-------|-------|
| Name | `router · cam_ext_list` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_ext_list` |
| Kind | dispatcher_router |
