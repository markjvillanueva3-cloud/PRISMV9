---
title: Formula — router · thermal_peclet
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thermal_peclet
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_peclet` |
| Graph node | `formula.adjusted.calcdispatcher.action.thermal_peclet` |
| Kind | dispatcher_router |
