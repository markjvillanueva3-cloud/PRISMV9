---
title: Formula — router · multivariate_spc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.multivariate_spc
...
# Formula — `router · multivariate_spc`
...
| Field | Value |
|-------|-------|
| Name | `router · multivariate_spc` |
| Graph node | `formula.adjusted.calcdispatcher.action.multivariate_spc` |
| Kind | dispatcher_router |
