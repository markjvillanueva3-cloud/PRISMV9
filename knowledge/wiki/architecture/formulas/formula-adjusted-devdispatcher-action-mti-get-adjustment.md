---
title: Formula — router · mti_get_adjustment
type: formula
formula_id: formula.adjusted.devdispatcher.action.mti_get_adjustment
...
# Formula — `router · mti_get_adjustment`
...
| Field | Value |
|-------|-------|
| Name | `router · mti_get_adjustment` |
| Graph node | `formula.adjusted.devdispatcher.action.mti_get_adjustment` |
| Kind | dispatcher_router |
