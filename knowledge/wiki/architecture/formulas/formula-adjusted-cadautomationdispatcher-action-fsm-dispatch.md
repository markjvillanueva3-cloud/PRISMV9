---
title: Formula — router · fsm_dispatch
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.fsm_dispatch
...
| Field | Value |
|-------|-------|
| Name | `router · fsm_dispatch` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.fsm_dispatch` |
| Kind | dispatcher_router |
