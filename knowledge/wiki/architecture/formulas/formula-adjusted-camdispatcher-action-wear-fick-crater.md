---
title: Formula — router · wear_fick_crater
type: formula
formula_id: formula.adjusted.camdispatcher.action.wear_fick_crater
...
# Formula — `router · wear_fick_crater`
...
| Field | Value |
|-------|-------|
| Name | `router · wear_fick_crater` |
| Graph node | `formula.adjusted.camdispatcher.action.wear_fick_crater` |
| Kind | dispatcher_router |
