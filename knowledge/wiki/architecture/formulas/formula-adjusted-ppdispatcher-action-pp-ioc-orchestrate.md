---
title: Formula — router · pp_ioc_orchestrate
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_ioc_orchestrate
...
# Formula — `router · pp_ioc_orchestrate`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_ioc_orchestrate` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_ioc_orchestrate` |
| Kind | dispatcher_router |
