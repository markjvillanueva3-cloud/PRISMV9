---
title: Formula — router · crys_calculate
type: formula
formula_id: formula.adjusted.devdispatcher.action.crys_calculate
...
| Field | Value |
|-------|-------|
| Name | `router · crys_calculate` |
| Graph node | `formula.adjusted.devdispatcher.action.crys_calculate` |
| Kind | dispatcher_router |
