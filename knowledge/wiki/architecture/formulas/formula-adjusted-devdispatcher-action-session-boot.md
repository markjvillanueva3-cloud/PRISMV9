---
title: Formula — router · session_boot
type: formula
formula_id: formula.adjusted.devdispatcher.action.session_boot
...
| Field | Value |
|-------|-------|
| Name | `router · session_boot` |
| Graph node | `formula.adjusted.devdispatcher.action.session_boot` |
| Kind | dispatcher_router |
