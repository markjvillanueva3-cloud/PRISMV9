---
title: Formula — router · gcode_snippet
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gcode_snippet
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_snippet` |
| Graph node | `formula.adjusted.calcdispatcher.action.gcode_snippet` |
| Kind | dispatcher_router |
