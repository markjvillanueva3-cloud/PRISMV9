---
title: Formula — router · safety_incident
type: formula
formula_id: formula.adjusted.compliancedispatcher.action.safety_incident
...
# Formula — `router · safety_incident`
...
| Field | Value |
|-------|-------|
| Name | `router · safety_incident` |
| Graph node | `formula.adjusted.compliancedispatcher.action.safety_incident` |
| Kind | dispatcher_router |
