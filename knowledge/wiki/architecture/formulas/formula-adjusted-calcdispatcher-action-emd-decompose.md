---
title: Formula — router · emd_decompose
type: formula
formula_id: formula.adjusted.calcdispatcher.action.emd_decompose
...
| Field | Value |
|-------|-------|
| Name | `router · emd_decompose` |
| Graph node | `formula.adjusted.calcdispatcher.action.emd_decompose` |
| Kind | dispatcher_router |
