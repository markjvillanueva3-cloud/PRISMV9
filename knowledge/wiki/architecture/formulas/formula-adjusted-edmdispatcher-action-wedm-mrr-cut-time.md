---
title: Formula — router · wedm_mrr_cut_time
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_mrr_cut_time
...
# Formula — `router · wedm_mrr_cut_time`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_mrr_cut_time` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_mrr_cut_time` |
| Kind | dispatcher_router |
