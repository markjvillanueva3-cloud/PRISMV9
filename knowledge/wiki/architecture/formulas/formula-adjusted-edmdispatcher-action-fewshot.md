---
title: Formula — router · fewShot
type: formula
formula_id: formula.adjusted.edmdispatcher.action.fewshot
...
|-------|-------|
| Name | `router · fewShot` |
| Graph node | `formula.adjusted.edmdispatcher.action.fewshot` |
| Kind | dispatcher_router |
