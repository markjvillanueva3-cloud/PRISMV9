---
title: Formula — router · cot_reason_tree
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.cot_reason_tree
...
# Formula — `router · cot_reason_tree`
...
| Field | Value |
|-------|-------|
| Name | `router · cot_reason_tree` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.cot_reason_tree` |
| Kind | dispatcher_router |
