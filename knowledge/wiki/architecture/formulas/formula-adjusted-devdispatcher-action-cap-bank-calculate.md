---
title: Formula — router · cap_bank_calculate
type: formula
formula_id: formula.adjusted.devdispatcher.action.cap_bank_calculate
...
# Formula — `router · cap_bank_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · cap_bank_calculate` |
| Graph node | `formula.adjusted.devdispatcher.action.cap_bank_calculate` |
| Kind | dispatcher_router |
