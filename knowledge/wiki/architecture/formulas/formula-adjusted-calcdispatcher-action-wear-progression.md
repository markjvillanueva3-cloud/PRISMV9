---
title: Formula — router · wear_progression
type: formula
formula_id: formula.adjusted.calcdispatcher.action.wear_progression
...
# Formula — `router · wear_progression`
...
| Field | Value |
|-------|-------|
| Name | `router · wear_progression` |
| Graph node | `formula.adjusted.calcdispatcher.action.wear_progression` |
| Kind | dispatcher_router |
