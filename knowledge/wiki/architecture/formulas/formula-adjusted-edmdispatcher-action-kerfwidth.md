---
title: Formula — router · kerfWidth
type: formula
formula_id: formula.adjusted.edmdispatcher.action.kerfwidth
...
| Field | Value |
|-------|-------|
| Name | `router · kerfWidth` |
| Graph node | `formula.adjusted.edmdispatcher.action.kerfwidth` |
| Kind | dispatcher_router |
