---
title: Formula — router · tnr_get_g_code
type: formula
formula_id: formula.adjusted.turningdispatcher.action.tnr_get_g_code
...
| Field | Value |
|-------|-------|
| Name | `router · tnr_get_g_code` |
| Graph node | `formula.adjusted.turningdispatcher.action.tnr_get_g_code` |
| Kind | dispatcher_router |
