---
title: Formula — router · pm_5axis_get
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_5axis_get
...
| Field | Value |
|-------|-------|
| Name | `router · pm_5axis_get` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_5axis_get` |
| Kind | dispatcher_router |
