---
title: Formula — router · dispatch_what_if
type: formula
formula_id: formula.adjusted.businessdispatcher.action.dispatch_what_if
...
# Formula — `router · dispatch_what_if`
...
| Field | Value |
|-------|-------|
| Name | `router · dispatch_what_if` |
| Graph node | `formula.adjusted.businessdispatcher.action.dispatch_what_if` |
| Kind | dispatcher_router |
