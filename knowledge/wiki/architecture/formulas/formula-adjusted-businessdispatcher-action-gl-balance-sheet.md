---
title: Formula — router · gl_balance_sheet
type: formula
formula_id: formula.adjusted.businessdispatcher.action.gl_balance_sheet
...
# Formula — `router · gl_balance_sheet`
...
| Field | Value |
|-------|-------|
| Name | `router · gl_balance_sheet` |
| Graph node | `formula.adjusted.businessdispatcher.action.gl_balance_sheet` |
| Kind | dispatcher_router |
