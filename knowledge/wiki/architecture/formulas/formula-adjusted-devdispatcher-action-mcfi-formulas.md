---
title: Formula — router · mcfi_formulas
type: formula
formula_id: formula.adjusted.devdispatcher.action.mcfi_formulas
...
| Field | Value |
|-------|-------|
| Name | `router · mcfi_formulas` |
| Graph node | `formula.adjusted.devdispatcher.action.mcfi_formulas` |
| Kind | dispatcher_router |
