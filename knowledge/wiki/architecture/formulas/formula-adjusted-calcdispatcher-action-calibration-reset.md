---
title: Formula — router · calibration_reset
type: formula
formula_id: formula.adjusted.calcdispatcher.action.calibration_reset
...
# Formula — `router · calibration_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · calibration_reset` |
| Graph node | `formula.adjusted.calcdispatcher.action.calibration_reset` |
| Kind | dispatcher_router |
