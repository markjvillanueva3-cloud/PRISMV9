---
title: Formula — router · cpk_predict
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.cpk_predict
...
| Field | Value |
|-------|-------|
| Name | `router · cpk_predict` |
| Graph node | `formula.adjusted.qualitydispatcher.action.cpk_predict` |
| Kind | dispatcher_router |
