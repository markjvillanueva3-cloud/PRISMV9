---
title: Formula — router · harvest_roi
type: formula
formula_id: formula.adjusted.calcdispatcher.action.harvest_roi
...
| Field | Value |
|-------|-------|
| Name | `router · harvest_roi` |
| Graph node | `formula.adjusted.calcdispatcher.action.harvest_roi` |
| Kind | dispatcher_router |
