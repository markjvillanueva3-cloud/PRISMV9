---
title: Formula — router · timoshenko_compare
type: formula
formula_id: formula.adjusted.calcdispatcher.action.timoshenko_compare
...
# Formula — `router · timoshenko_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · timoshenko_compare` |
| Graph node | `formula.adjusted.calcdispatcher.action.timoshenko_compare` |
| Kind | dispatcher_router |
