---
title: Formula — router · wedm_fewshot_list
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_fewshot_list
...
# Formula — `router · wedm_fewshot_list`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_fewshot_list` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_fewshot_list` |
| Kind | dispatcher_router |
