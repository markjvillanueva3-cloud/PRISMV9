---
title: Formula — router · scr_list
type: formula
formula_id: formula.adjusted.devdispatcher.action.scr_list
...
| Field | Value |
|-------|-------|
| Name | `router · scr_list` |
| Graph node | `formula.adjusted.devdispatcher.action.scr_list` |
| Kind | dispatcher_router |
