---
title: Formula — router · aet_size
type: formula
formula_id: formula.adjusted.devdispatcher.action.aet_size
...
| Field | Value |
|-------|-------|
| Name | `router · aet_size` |
| Graph node | `formula.adjusted.devdispatcher.action.aet_size` |
| Kind | dispatcher_router |
