---
title: Formula — router · sf_autopilot_run
type: formula
formula_id: formula.adjusted.devdispatcher.action.sf_autopilot_run
...
# Formula — `router · sf_autopilot_run`
...
| Field | Value |
|-------|-------|
| Name | `router · sf_autopilot_run` |
| Graph node | `formula.adjusted.devdispatcher.action.sf_autopilot_run` |
| Kind | dispatcher_router |
