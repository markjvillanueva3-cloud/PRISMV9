---
title: Formula — router · pcr_load_dossier
type: formula
formula_id: formula.adjusted.devdispatcher.action.pcr_load_dossier
...
# Formula — `router · pcr_load_dossier`
...
| Field | Value |
|-------|-------|
| Name | `router · pcr_load_dossier` |
| Graph node | `formula.adjusted.devdispatcher.action.pcr_load_dossier` |
| Kind | dispatcher_router |
