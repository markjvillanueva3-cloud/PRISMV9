---
title: Formula — router · dlt_query
type: formula
formula_id: formula.adjusted.devdispatcher.action.dlt_query
...
| Field | Value |
|-------|-------|
| Name | `router · dlt_query` |
| Graph node | `formula.adjusted.devdispatcher.action.dlt_query` |
| Kind | dispatcher_router |
