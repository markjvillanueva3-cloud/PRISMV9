---
title: Formula — router · convex_qp_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.convex_qp_solve
...
# Formula — `router · convex_qp_solve`
...
| Field | Value |
|-------|-------|
| Name | `router · convex_qp_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.convex_qp_solve` |
| Kind | dispatcher_router |
