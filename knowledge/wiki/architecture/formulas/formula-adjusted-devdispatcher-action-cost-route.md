---
title: Formula — router · cost_route
type: formula
formula_id: formula.adjusted.devdispatcher.action.cost_route
...
| Field | Value |
|-------|-------|
| Name | `router · cost_route` |
| Graph node | `formula.adjusted.devdispatcher.action.cost_route` |
| Kind | dispatcher_router |
