---
title: Formula — router · engine_acc_engine
type: formula
formula_id: formula.adjusted.devdispatcher.action.engine_acc_engine
...
# Formula — `router · engine_acc_engine`
...
| Field | Value |
|-------|-------|
| Name | `router · engine_acc_engine` |
| Graph node | `formula.adjusted.devdispatcher.action.engine_acc_engine` |
| Kind | dispatcher_router |
