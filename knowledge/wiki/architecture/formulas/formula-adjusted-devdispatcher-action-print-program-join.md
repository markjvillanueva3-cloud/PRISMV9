---
title: Formula — router · print_program_join
type: formula
formula_id: formula.adjusted.devdispatcher.action.print_program_join
...
# Formula — `router · print_program_join`
...
| Field | Value |
|-------|-------|
| Name | `router · print_program_join` |
| Graph node | `formula.adjusted.devdispatcher.action.print_program_join` |
| Kind | dispatcher_router |
