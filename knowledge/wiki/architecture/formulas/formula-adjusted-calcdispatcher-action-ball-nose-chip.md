---
title: Formula — router · ball_nose_chip
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ball_nose_chip
...
| Field | Value |
|-------|-------|
| Name | `router · ball_nose_chip` |
| Graph node | `formula.adjusted.calcdispatcher.action.ball_nose_chip` |
| Kind | dispatcher_router |
