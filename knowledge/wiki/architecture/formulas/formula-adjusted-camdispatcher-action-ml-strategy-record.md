---
title: Formula — router · ml_strategy_record
type: formula
formula_id: formula.adjusted.camdispatcher.action.ml_strategy_record
...
# Formula — `router · ml_strategy_record`
...
| Field | Value |
|-------|-------|
| Name | `router · ml_strategy_record` |
| Graph node | `formula.adjusted.camdispatcher.action.ml_strategy_record` |
| Kind | dispatcher_router |
