---
title: Formula — router · firmware_check
type: formula
formula_id: formula.adjusted.camdispatcher.action.firmware_check
...
| Field | Value |
|-------|-------|
| Name | `router · firmware_check` |
| Graph node | `formula.adjusted.camdispatcher.action.firmware_check` |
| Kind | dispatcher_router |
