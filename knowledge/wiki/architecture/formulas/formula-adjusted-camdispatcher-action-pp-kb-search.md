---
title: Formula — router · pp_kb_search
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_kb_search
...
| Field | Value |
|-------|-------|
| Name | `router · pp_kb_search` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_kb_search` |
| Kind | dispatcher_router |
