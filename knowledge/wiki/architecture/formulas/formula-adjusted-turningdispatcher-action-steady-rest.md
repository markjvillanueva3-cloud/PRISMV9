---
title: Formula — router · steady_rest
type: formula
formula_id: formula.adjusted.turningdispatcher.action.steady_rest
...
| Field | Value |
|-------|-------|
| Name | `router · steady_rest` |
| Graph node | `formula.adjusted.turningdispatcher.action.steady_rest` |
| Kind | dispatcher_router |
