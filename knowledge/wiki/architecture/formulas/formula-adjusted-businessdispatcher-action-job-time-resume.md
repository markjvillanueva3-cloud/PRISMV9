---
title: Formula — router · job_time_resume
type: formula
formula_id: formula.adjusted.businessdispatcher.action.job_time_resume
...
# Formula — `router · job_time_resume`
...
| Field | Value |
|-------|-------|
| Name | `router · job_time_resume` |
| Graph node | `formula.adjusted.businessdispatcher.action.job_time_resume` |
| Kind | dispatcher_router |
