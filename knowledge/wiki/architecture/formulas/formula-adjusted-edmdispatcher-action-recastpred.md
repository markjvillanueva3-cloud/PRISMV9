---
title: Formula — router · recastPred
type: formula
formula_id: formula.adjusted.edmdispatcher.action.recastpred
...
| Field | Value |
|-------|-------|
| Name | `router · recastPred` |
| Graph node | `formula.adjusted.edmdispatcher.action.recastpred` |
| Kind | dispatcher_router |
