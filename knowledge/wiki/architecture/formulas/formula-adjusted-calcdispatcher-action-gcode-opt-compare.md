---
title: Formula — router · gcode_opt_compare
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gcode_opt_compare
...
# Formula — `router · gcode_opt_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_opt_compare` |
| Graph node | `formula.adjusted.calcdispatcher.action.gcode_opt_compare` |
| Kind | dispatcher_router |
