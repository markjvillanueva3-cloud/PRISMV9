---
title: Formula — router · stochastic_chatter
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stochastic_chatter
...
# Formula — `router · stochastic_chatter`
...
| Field | Value |
|-------|-------|
| Name | `router · stochastic_chatter` |
| Graph node | `formula.adjusted.calcdispatcher.action.stochastic_chatter` |
| Kind | dispatcher_router |
