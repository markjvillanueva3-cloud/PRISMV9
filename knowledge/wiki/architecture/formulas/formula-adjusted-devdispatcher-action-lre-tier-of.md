---
title: Formula — router · lre_tier_of
type: formula
formula_id: formula.adjusted.devdispatcher.action.lre_tier_of
...
| Field | Value |
|-------|-------|
| Name | `router · lre_tier_of` |
| Graph node | `formula.adjusted.devdispatcher.action.lre_tier_of` |
| Kind | dispatcher_router |
