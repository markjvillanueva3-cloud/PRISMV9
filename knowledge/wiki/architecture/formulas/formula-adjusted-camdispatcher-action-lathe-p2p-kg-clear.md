---
title: Formula — router · lathe_p2p_kg_clear
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_p2p_kg_clear
...
# Formula — `router · lathe_p2p_kg_clear`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_p2p_kg_clear` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_p2p_kg_clear` |
| Kind | dispatcher_router |
