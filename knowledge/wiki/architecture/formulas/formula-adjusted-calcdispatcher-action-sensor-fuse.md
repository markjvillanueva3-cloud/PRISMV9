---
title: Formula — router · sensor_fuse
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sensor_fuse
...
| Field | Value |
|-------|-------|
| Name | `router · sensor_fuse` |
| Graph node | `formula.adjusted.calcdispatcher.action.sensor_fuse` |
| Kind | dispatcher_router |
