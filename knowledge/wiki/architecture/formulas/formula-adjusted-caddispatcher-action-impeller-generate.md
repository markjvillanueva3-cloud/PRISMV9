---
title: Formula — router · impeller_generate
type: formula
formula_id: formula.adjusted.caddispatcher.action.impeller_generate
...
# Formula — `router · impeller_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · impeller_generate` |
| Graph node | `formula.adjusted.caddispatcher.action.impeller_generate` |
| Kind | dispatcher_router |
