---
title: Formula — router · report_scrap
type: formula
formula_id: formula.adjusted.businessdispatcher.action.report_scrap
...
| Field | Value |
|-------|-------|
| Name | `router · report_scrap` |
| Graph node | `formula.adjusted.businessdispatcher.action.report_scrap` |
| Kind | dispatcher_router |
