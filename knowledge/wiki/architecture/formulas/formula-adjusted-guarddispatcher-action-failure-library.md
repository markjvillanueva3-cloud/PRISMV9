---
title: Formula — router · failure_library
type: formula
formula_id: formula.adjusted.guarddispatcher.action.failure_library
...
# Formula — `router · failure_library`
...
| Field | Value |
|-------|-------|
| Name | `router · failure_library` |
| Graph node | `formula.adjusted.guarddispatcher.action.failure_library` |
| Kind | dispatcher_router |
