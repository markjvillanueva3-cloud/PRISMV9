---
title: Formula — router · grindAsm
type: formula
formula_id: formula.adjusted.camdispatcher.action.grindasm
...
| Field | Value |
|-------|-------|
| Name | `router · grindAsm` |
| Graph node | `formula.adjusted.camdispatcher.action.grindasm` |
| Kind | dispatcher_router |
