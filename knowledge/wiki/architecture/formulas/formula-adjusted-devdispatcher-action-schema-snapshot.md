---
title: Formula — router · schema_snapshot
type: formula
formula_id: formula.adjusted.devdispatcher.action.schema_snapshot
...
# Formula — `router · schema_snapshot`
...
| Field | Value |
|-------|-------|
| Name | `router · schema_snapshot` |
| Graph node | `formula.adjusted.devdispatcher.action.schema_snapshot` |
| Kind | dispatcher_router |
