---
title: Formula — router · cad_curve
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.cad_curve
...
| Field | Value |
|-------|-------|
| Name | `router · cad_curve` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.cad_curve` |
| Kind | dispatcher_router |
