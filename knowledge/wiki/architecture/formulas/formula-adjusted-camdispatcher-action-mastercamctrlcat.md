---
title: Formula — router · mastercamCtrlCat
type: formula
formula_id: formula.adjusted.camdispatcher.action.mastercamctrlcat
...
# Formula — `router · mastercamCtrlCat`
...
| Field | Value |
|-------|-------|
| Name | `router · mastercamCtrlCat` |
| Graph node | `formula.adjusted.camdispatcher.action.mastercamctrlcat` |
| Kind | dispatcher_router |
