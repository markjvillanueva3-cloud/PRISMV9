---
title: Formula — router · dialect_features
type: formula
formula_id: formula.adjusted.camdispatcher.action.dialect_features
...
# Formula — `router · dialect_features`
...
| Field | Value |
|-------|-------|
| Name | `router · dialect_features` |
| Graph node | `formula.adjusted.camdispatcher.action.dialect_features` |
| Kind | dispatcher_router |
