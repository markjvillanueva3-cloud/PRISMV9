---
title: Formula — router · pillar_list
type: formula
formula_id: formula.adjusted.devdispatcher.action.pillar_list
...
| Field | Value |
|-------|-------|
| Name | `router · pillar_list` |
| Graph node | `formula.adjusted.devdispatcher.action.pillar_list` |
| Kind | dispatcher_router |
