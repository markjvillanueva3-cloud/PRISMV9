---
title: Formula — router · jss_single_machine
type: formula
formula_id: formula.adjusted.devdispatcher.action.jss_single_machine
...
# Formula — `router · jss_single_machine`
...
| Field | Value |
|-------|-------|
| Name | `router · jss_single_machine` |
| Graph node | `formula.adjusted.devdispatcher.action.jss_single_machine` |
| Kind | dispatcher_router |
