---
title: Formula — router · cv_nested
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cv_nested
...
| Field | Value |
|-------|-------|
| Name | `router · cv_nested` |
| Graph node | `formula.adjusted.calcdispatcher.action.cv_nested` |
| Kind | dispatcher_router |
