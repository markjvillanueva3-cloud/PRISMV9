---
title: Formula — router · ellipse
type: formula
formula_id: formula.adjusted.caddispatcher.action.ellipse
...
|-------|-------|
| Name | `router · ellipse` |
| Graph node | `formula.adjusted.caddispatcher.action.ellipse` |
| Kind | dispatcher_router |
