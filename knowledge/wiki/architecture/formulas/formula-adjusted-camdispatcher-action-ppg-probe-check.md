---
title: Formula — router · ppg_probe_check
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_probe_check
...
# Formula — `router · ppg_probe_check`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_probe_check` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_probe_check` |
| Kind | dispatcher_router |
