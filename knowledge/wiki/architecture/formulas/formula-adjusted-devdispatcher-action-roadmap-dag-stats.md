---
title: Formula — router · roadmap_dag_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.roadmap_dag_stats
...
# Formula — `router · roadmap_dag_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · roadmap_dag_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.roadmap_dag_stats` |
| Kind | dispatcher_router |
