---
title: Formula — router · cascade_stats
type: formula
formula_id: formula.adjusted.mldispatcher.action.cascade_stats
...
| Field | Value |
|-------|-------|
| Name | `router · cascade_stats` |
| Graph node | `formula.adjusted.mldispatcher.action.cascade_stats` |
| Kind | dispatcher_router |
