---
title: Formula — router · cross_reg_schema
type: formula
formula_id: formula.adjusted.devdispatcher.action.cross_reg_schema
...
# Formula — `router · cross_reg_schema`
...
| Field | Value |
|-------|-------|
| Name | `router · cross_reg_schema` |
| Graph node | `formula.adjusted.devdispatcher.action.cross_reg_schema` |
| Kind | dispatcher_router |
