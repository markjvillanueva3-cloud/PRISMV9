---
title: Formula — router · ssl_get_setup
type: formula
formula_id: formula.adjusted.devdispatcher.action.ssl_get_setup
...
| Field | Value |
|-------|-------|
| Name | `router · ssl_get_setup` |
| Graph node | `formula.adjusted.devdispatcher.action.ssl_get_setup` |
| Kind | dispatcher_router |
