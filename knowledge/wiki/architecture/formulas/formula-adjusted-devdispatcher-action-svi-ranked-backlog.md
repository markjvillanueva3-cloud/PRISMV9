---
title: Formula — router · svi_ranked_backlog
type: formula
formula_id: formula.adjusted.devdispatcher.action.svi_ranked_backlog
...
# Formula — `router · svi_ranked_backlog`
...
| Field | Value |
|-------|-------|
| Name | `router · svi_ranked_backlog` |
| Graph node | `formula.adjusted.devdispatcher.action.svi_ranked_backlog` |
| Kind | dispatcher_router |
