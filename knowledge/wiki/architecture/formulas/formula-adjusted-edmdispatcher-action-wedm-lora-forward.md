---
title: Formula — router · wedm_lora_forward
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_lora_forward
...
# Formula — `router · wedm_lora_forward`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_lora_forward` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_lora_forward` |
| Kind | dispatcher_router |
