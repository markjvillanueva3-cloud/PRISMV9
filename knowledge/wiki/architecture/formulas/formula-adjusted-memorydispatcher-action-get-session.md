---
title: Formula — router · get_session
type: formula
formula_id: formula.adjusted.memorydispatcher.action.get_session
...
| Field | Value |
|-------|-------|
| Name | `router · get_session` |
| Graph node | `formula.adjusted.memorydispatcher.action.get_session` |
| Kind | dispatcher_router |
