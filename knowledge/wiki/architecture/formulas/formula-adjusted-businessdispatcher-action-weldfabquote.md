---
title: Formula — router · weldFabQuote
type: formula
formula_id: formula.adjusted.businessdispatcher.action.weldfabquote
...
| Field | Value |
|-------|-------|
| Name | `router · weldFabQuote` |
| Graph node | `formula.adjusted.businessdispatcher.action.weldfabquote` |
| Kind | dispatcher_router |
