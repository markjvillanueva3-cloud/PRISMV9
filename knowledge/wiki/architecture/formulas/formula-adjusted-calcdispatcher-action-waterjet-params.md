---
title: Formula — router · waterjet_params
type: formula
formula_id: formula.adjusted.calcdispatcher.action.waterjet_params
...
# Formula — `router · waterjet_params`
...
| Field | Value |
|-------|-------|
| Name | `router · waterjet_params` |
| Graph node | `formula.adjusted.calcdispatcher.action.waterjet_params` |
| Kind | dispatcher_router |
