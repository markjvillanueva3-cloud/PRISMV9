---
title: Formula — router · wpt_active_jobs
type: formula
formula_id: formula.adjusted.devdispatcher.action.wpt_active_jobs
...
# Formula — `router · wpt_active_jobs`
...
| Field | Value |
|-------|-------|
| Name | `router · wpt_active_jobs` |
| Graph node | `formula.adjusted.devdispatcher.action.wpt_active_jobs` |
| Kind | dispatcher_router |
