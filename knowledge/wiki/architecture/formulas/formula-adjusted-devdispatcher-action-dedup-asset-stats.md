---
title: Formula — router · dedup_asset_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.dedup_asset_stats
...
# Formula — `router · dedup_asset_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · dedup_asset_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.dedup_asset_stats` |
| Kind | dispatcher_router |
