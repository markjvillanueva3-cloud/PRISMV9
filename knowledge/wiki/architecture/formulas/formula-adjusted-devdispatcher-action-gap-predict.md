---
title: Formula — router · gap_predict
type: formula
formula_id: formula.adjusted.devdispatcher.action.gap_predict
...
| Field | Value |
|-------|-------|
| Name | `router · gap_predict` |
| Graph node | `formula.adjusted.devdispatcher.action.gap_predict` |
| Kind | dispatcher_router |
