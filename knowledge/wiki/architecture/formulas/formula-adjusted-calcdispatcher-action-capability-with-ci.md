---
title: Formula — router · capability_with_ci
type: formula
formula_id: formula.adjusted.calcdispatcher.action.capability_with_ci
...
# Formula — `router · capability_with_ci`
...
| Field | Value |
|-------|-------|
| Name | `router · capability_with_ci` |
| Graph node | `formula.adjusted.calcdispatcher.action.capability_with_ci` |
| Kind | dispatcher_router |
