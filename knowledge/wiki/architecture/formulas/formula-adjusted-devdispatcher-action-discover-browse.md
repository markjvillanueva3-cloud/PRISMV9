---
title: Formula — router · discover_browse
type: formula
formula_id: formula.adjusted.devdispatcher.action.discover_browse
...
# Formula — `router · discover_browse`
...
| Field | Value |
|-------|-------|
| Name | `router · discover_browse` |
| Graph node | `formula.adjusted.devdispatcher.action.discover_browse` |
| Kind | dispatcher_router |
