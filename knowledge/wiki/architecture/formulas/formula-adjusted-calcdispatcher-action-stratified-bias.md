---
title: Formula — router · stratified_bias
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stratified_bias
...
# Formula — `router · stratified_bias`
...
| Field | Value |
|-------|-------|
| Name | `router · stratified_bias` |
| Graph node | `formula.adjusted.calcdispatcher.action.stratified_bias` |
| Kind | dispatcher_router |
