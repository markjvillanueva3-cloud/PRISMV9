---
title: Formula — router · pillar_gate
type: formula
formula_id: formula.adjusted.devdispatcher.action.pillar_gate
...
| Field | Value |
|-------|-------|
| Name | `router · pillar_gate` |
| Graph node | `formula.adjusted.devdispatcher.action.pillar_gate` |
| Kind | dispatcher_router |
