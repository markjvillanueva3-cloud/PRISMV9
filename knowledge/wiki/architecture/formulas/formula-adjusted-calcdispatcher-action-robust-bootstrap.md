---
title: Formula — router · robust_bootstrap
type: formula
formula_id: formula.adjusted.calcdispatcher.action.robust_bootstrap
...
# Formula — `router · robust_bootstrap`
...
| Field | Value |
|-------|-------|
| Name | `router · robust_bootstrap` |
| Graph node | `formula.adjusted.calcdispatcher.action.robust_bootstrap` |
| Kind | dispatcher_router |
