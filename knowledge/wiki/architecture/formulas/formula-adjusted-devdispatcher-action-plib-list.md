---
title: Formula — router · plib_list
type: formula
formula_id: formula.adjusted.devdispatcher.action.plib_list
...
| Field | Value |
|-------|-------|
| Name | `router · plib_list` |
| Graph node | `formula.adjusted.devdispatcher.action.plib_list` |
| Kind | dispatcher_router |
