---
title: Formula — router · gcode_safety_fix
type: formula
formula_id: formula.adjusted.camdispatcher.action.gcode_safety_fix
...
# Formula — `router · gcode_safety_fix`
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_safety_fix` |
| Graph node | `formula.adjusted.camdispatcher.action.gcode_safety_fix` |
| Kind | dispatcher_router |
