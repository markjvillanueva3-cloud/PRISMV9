---
title: Formula — router · riveted_joint_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.riveted_joint_calc
...
# Formula — `router · riveted_joint_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · riveted_joint_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.riveted_joint_calc` |
| Kind | dispatcher_router |
