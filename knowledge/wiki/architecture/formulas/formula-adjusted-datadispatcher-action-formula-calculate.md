---
title: Formula — router · formula_calculate
type: formula
formula_id: formula.adjusted.datadispatcher.action.formula_calculate
...
# Formula — `router · formula_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · formula_calculate` |
| Graph node | `formula.adjusted.datadispatcher.action.formula_calculate` |
| Kind | dispatcher_router |
