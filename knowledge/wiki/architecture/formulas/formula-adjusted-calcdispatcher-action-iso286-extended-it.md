---
title: Formula — router · iso286_extended_it
type: formula
formula_id: formula.adjusted.calcdispatcher.action.iso286_extended_it
...
# Formula — `router · iso286_extended_it`
...
| Field | Value |
|-------|-------|
| Name | `router · iso286_extended_it` |
| Graph node | `formula.adjusted.calcdispatcher.action.iso286_extended_it` |
| Kind | dispatcher_router |
