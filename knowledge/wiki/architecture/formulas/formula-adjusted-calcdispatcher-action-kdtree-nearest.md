---
title: Formula — router · kdtree_nearest
type: formula
formula_id: formula.adjusted.calcdispatcher.action.kdtree_nearest
...
| Field | Value |
|-------|-------|
| Name | `router · kdtree_nearest` |
| Graph node | `formula.adjusted.calcdispatcher.action.kdtree_nearest` |
| Kind | dispatcher_router |
