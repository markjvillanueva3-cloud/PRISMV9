---
title: Formula — router · gcode_validate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gcode_validate
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_validate` |
| Graph node | `formula.adjusted.calcdispatcher.action.gcode_validate` |
| Kind | dispatcher_router |
