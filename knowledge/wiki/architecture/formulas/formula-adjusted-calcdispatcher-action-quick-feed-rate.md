---
title: Formula — router · quick_feed_rate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.quick_feed_rate
...
# Formula — `router · quick_feed_rate`
...
| Field | Value |
|-------|-------|
| Name | `router · quick_feed_rate` |
| Graph node | `formula.adjusted.calcdispatcher.action.quick_feed_rate` |
| Kind | dispatcher_router |
