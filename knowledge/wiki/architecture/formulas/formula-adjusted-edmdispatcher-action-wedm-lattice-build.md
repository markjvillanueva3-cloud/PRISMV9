---
title: Formula — router · wedm_lattice_build
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_lattice_build
...
# Formula — `router · wedm_lattice_build`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_lattice_build` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_lattice_build` |
| Kind | dispatcher_router |
