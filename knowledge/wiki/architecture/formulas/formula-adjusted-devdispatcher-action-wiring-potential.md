---
title: Formula — router · wiring_potential
type: formula
formula_id: formula.adjusted.devdispatcher.action.wiring_potential
...
# Formula — `router · wiring_potential`
...
| Field | Value |
|-------|-------|
| Name | `router · wiring_potential` |
| Graph node | `formula.adjusted.devdispatcher.action.wiring_potential` |
| Kind | dispatcher_router |
