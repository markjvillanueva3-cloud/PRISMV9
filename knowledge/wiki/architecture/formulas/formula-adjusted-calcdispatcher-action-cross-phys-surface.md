---
title: Formula — router · cross_phys_surface
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cross_phys_surface
...
# Formula — `router · cross_phys_surface`
...
| Field | Value |
|-------|-------|
| Name | `router · cross_phys_surface` |
| Graph node | `formula.adjusted.calcdispatcher.action.cross_phys_surface` |
| Kind | dispatcher_router |
