---
title: Formula — router · quick_thread_pitch
type: formula
formula_id: formula.adjusted.calcdispatcher.action.quick_thread_pitch
...
# Formula — `router · quick_thread_pitch`
...
| Field | Value |
|-------|-------|
| Name | `router · quick_thread_pitch` |
| Graph node | `formula.adjusted.calcdispatcher.action.quick_thread_pitch` |
| Kind | dispatcher_router |
