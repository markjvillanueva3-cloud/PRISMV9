---
title: Formula — router · order_metrics
type: formula
formula_id: formula.adjusted.businessdispatcher.action.order_metrics
...
| Field | Value |
|-------|-------|
| Name | `router · order_metrics` |
| Graph node | `formula.adjusted.businessdispatcher.action.order_metrics` |
| Kind | dispatcher_router |
