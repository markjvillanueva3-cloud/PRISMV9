---
title: Formula — router · catia_kbm_details
type: formula
formula_id: formula.adjusted.camdispatcher.action.catia_kbm_details
...
# Formula — `router · catia_kbm_details`
...
| Field | Value |
|-------|-------|
| Name | `router · catia_kbm_details` |
| Graph node | `formula.adjusted.camdispatcher.action.catia_kbm_details` |
| Kind | dispatcher_router |
