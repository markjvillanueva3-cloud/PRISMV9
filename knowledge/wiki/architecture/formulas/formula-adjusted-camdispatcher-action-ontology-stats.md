---
title: Formula — router · ontology_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.ontology_stats
...
| Field | Value |
|-------|-------|
| Name | `router · ontology_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.ontology_stats` |
| Kind | dispatcher_router |
