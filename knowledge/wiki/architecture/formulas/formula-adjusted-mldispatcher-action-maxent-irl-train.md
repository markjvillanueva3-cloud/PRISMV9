---
title: Formula — router · maxent_irl_train
type: formula
formula_id: formula.adjusted.mldispatcher.action.maxent_irl_train
...
# Formula — `router · maxent_irl_train`
...
| Field | Value |
|-------|-------|
| Name | `router · maxent_irl_train` |
| Graph node | `formula.adjusted.mldispatcher.action.maxent_irl_train` |
| Kind | dispatcher_router |
