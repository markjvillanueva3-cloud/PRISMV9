---
title: Formula — router · edge_case_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.edge_case_summary
...
# Formula — `router · edge_case_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · edge_case_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.edge_case_summary` |
| Kind | dispatcher_router |
