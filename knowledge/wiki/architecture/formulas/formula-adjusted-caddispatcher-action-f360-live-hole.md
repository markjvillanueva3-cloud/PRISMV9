---
title: Formula — router · f360_live_hole
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_hole
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_hole` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_hole` |
| Kind | dispatcher_router |
