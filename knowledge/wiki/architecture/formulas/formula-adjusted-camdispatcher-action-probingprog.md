---
title: Formula — router · probingProg
type: formula
formula_id: formula.adjusted.camdispatcher.action.probingprog
...
| Field | Value |
|-------|-------|
| Name | `router · probingProg` |
| Graph node | `formula.adjusted.camdispatcher.action.probingprog` |
| Kind | dispatcher_router |
