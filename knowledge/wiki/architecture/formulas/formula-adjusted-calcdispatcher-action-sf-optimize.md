---
title: Formula — router · sf_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sf_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · sf_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.sf_optimize` |
| Kind | dispatcher_router |
