---
title: Formula — router · spline_stress_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spline_stress_calc
...
# Formula — `router · spline_stress_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · spline_stress_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.spline_stress_calc` |
| Kind | dispatcher_router |
