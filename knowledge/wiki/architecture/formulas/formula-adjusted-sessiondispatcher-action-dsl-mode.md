---
title: Formula — router · dsl_mode
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.dsl_mode
...
| Field | Value |
|-------|-------|
| Name | `router · dsl_mode` |
| Graph node | `formula.adjusted.sessiondispatcher.action.dsl_mode` |
| Kind | dispatcher_router |
