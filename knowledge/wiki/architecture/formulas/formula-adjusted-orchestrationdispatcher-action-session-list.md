---
title: Formula — router · session_list
type: formula
formula_id: formula.adjusted.orchestrationdispatcher.action.session_list
...
| Field | Value |
|-------|-------|
| Name | `router · session_list` |
| Graph node | `formula.adjusted.orchestrationdispatcher.action.session_list` |
| Kind | dispatcher_router |
