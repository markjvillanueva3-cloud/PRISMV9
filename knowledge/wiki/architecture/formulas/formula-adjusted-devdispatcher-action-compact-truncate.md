---
title: Formula — router · compact_truncate
type: formula
formula_id: formula.adjusted.devdispatcher.action.compact_truncate
...
# Formula — `router · compact_truncate`
...
| Field | Value |
|-------|-------|
| Name | `router · compact_truncate` |
| Graph node | `formula.adjusted.devdispatcher.action.compact_truncate` |
| Kind | dispatcher_router |
