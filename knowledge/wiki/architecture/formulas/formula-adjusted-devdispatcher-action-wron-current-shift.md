---
title: Formula — router · wron_current_shift
type: formula
formula_id: formula.adjusted.devdispatcher.action.wron_current_shift
...
# Formula — `router · wron_current_shift`
...
| Field | Value |
|-------|-------|
| Name | `router · wron_current_shift` |
| Graph node | `formula.adjusted.devdispatcher.action.wron_current_shift` |
| Kind | dispatcher_router |
