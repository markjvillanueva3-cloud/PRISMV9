---
title: Formula — router · valve_design_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.valve_design_calc
...
# Formula — `router · valve_design_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · valve_design_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.valve_design_calc` |
| Kind | dispatcher_router |
