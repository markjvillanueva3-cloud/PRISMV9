---
title: Formula — router · bounds_vc
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.bounds_vc
...
| Field | Value |
|-------|-------|
| Name | `router · bounds_vc` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.bounds_vc` |
| Kind | dispatcher_router |
