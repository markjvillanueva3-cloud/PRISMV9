---
title: Formula — router · peer_audit_tick
type: formula
formula_id: formula.adjusted.devdispatcher.action.peer_audit_tick
...
# Formula — `router · peer_audit_tick`
...
| Field | Value |
|-------|-------|
| Name | `router · peer_audit_tick` |
| Graph node | `formula.adjusted.devdispatcher.action.peer_audit_tick` |
| Kind | dispatcher_router |
