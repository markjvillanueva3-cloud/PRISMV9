---
title: Formula — router · ssl_find_setup
type: formula
formula_id: formula.adjusted.devdispatcher.action.ssl_find_setup
...
| Field | Value |
|-------|-------|
| Name | `router · ssl_find_setup` |
| Graph node | `formula.adjusted.devdispatcher.action.ssl_find_setup` |
| Kind | dispatcher_router |
