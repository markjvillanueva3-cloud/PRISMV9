---
title: Formula — router · financial
type: formula
formula_id: formula.adjusted.businessdispatcher.action.financial
...
| Field | Value |
|-------|-------|
| Name | `router · financial` |
| Graph node | `formula.adjusted.businessdispatcher.action.financial` |
| Kind | dispatcher_router |
