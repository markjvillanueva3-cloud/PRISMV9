---
title: Formula — router · step_analyze
type: formula
formula_id: formula.adjusted.calcdispatcher.action.step_analyze
...
| Field | Value |
|-------|-------|
| Name | `router · step_analyze` |
| Graph node | `formula.adjusted.calcdispatcher.action.step_analyze` |
| Kind | dispatcher_router |
