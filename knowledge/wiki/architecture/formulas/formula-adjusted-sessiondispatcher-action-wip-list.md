---
title: Formula — router · wip_list
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.wip_list
...
| Field | Value |
|-------|-------|
| Name | `router · wip_list` |
| Graph node | `formula.adjusted.sessiondispatcher.action.wip_list` |
| Kind | dispatcher_router |
