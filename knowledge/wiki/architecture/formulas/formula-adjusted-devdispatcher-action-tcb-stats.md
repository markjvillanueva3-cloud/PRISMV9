---
title: Formula — router · tcb_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.tcb_stats
...
| Field | Value |
|-------|-------|
| Name | `router · tcb_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.tcb_stats` |
| Kind | dispatcher_router |
