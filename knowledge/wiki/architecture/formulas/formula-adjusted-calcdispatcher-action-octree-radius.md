---
title: Formula — router · octree_radius
type: formula
formula_id: formula.adjusted.calcdispatcher.action.octree_radius
...
| Field | Value |
|-------|-------|
| Name | `router · octree_radius` |
| Graph node | `formula.adjusted.calcdispatcher.action.octree_radius` |
| Kind | dispatcher_router |
