---
title: Formula — router · belt_drive_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.belt_drive_calc
...
# Formula — `router · belt_drive_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · belt_drive_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.belt_drive_calc` |
| Kind | dispatcher_router |
