---
title: Formula — router · session_end
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.session_end
...
| Field | Value |
|-------|-------|
| Name | `router · session_end` |
| Graph node | `formula.adjusted.sessiondispatcher.action.session_end` |
| Kind | dispatcher_router |
