---
title: Formula — router · cad_trial_ingest
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_trial_ingest
...
# Formula — `router · cad_trial_ingest`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_trial_ingest` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_trial_ingest` |
| Kind | dispatcher_router |
