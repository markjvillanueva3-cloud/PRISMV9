---
title: Formula — router · solid_move
type: formula
formula_id: formula.adjusted.calcdispatcher.action.solid_move
...
| Field | Value |
|-------|-------|
| Name | `router · solid_move` |
| Graph node | `formula.adjusted.calcdispatcher.action.solid_move` |
| Kind | dispatcher_router |
