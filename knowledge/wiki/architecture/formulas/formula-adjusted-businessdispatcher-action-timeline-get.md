---
title: Formula — router · timeline_get
type: formula
formula_id: formula.adjusted.businessdispatcher.action.timeline_get
...
| Field | Value |
|-------|-------|
| Name | `router · timeline_get` |
| Graph node | `formula.adjusted.businessdispatcher.action.timeline_get` |
| Kind | dispatcher_router |
