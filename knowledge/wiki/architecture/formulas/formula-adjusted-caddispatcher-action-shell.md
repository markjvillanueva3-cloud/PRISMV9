---
title: Formula — router · shell
type: formula
formula_id: formula.adjusted.caddispatcher.action.shell
...
|-------|-------|
| Name | `router · shell` |
| Graph node | `formula.adjusted.caddispatcher.action.shell` |
| Kind | dispatcher_router |
