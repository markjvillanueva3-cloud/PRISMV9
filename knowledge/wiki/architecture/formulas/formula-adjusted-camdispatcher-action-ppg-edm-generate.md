---
title: Formula — router · ppg_edm_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_edm_generate
...
# Formula — `router · ppg_edm_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_edm_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_edm_generate` |
| Kind | dispatcher_router |
