---
title: Formula — router · quality_score_read
type: formula
formula_id: formula.adjusted.devdispatcher.action.quality_score_read
...
# Formula — `router · quality_score_read`
...
| Field | Value |
|-------|-------|
| Name | `router · quality_score_read` |
| Graph node | `formula.adjusted.devdispatcher.action.quality_score_read` |
| Kind | dispatcher_router |
