---
title: Formula — router · power_budget
type: formula
formula_id: formula.adjusted.calcdispatcher.action.power_budget
...
| Field | Value |
|-------|-------|
| Name | `router · power_budget` |
| Graph node | `formula.adjusted.calcdispatcher.action.power_budget` |
| Kind | dispatcher_router |
