---
title: Formula — router · nx_tool_drift
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_tool_drift
...
| Field | Value |
|-------|-------|
| Name | `router · nx_tool_drift` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_tool_drift` |
| Kind | dispatcher_router |
