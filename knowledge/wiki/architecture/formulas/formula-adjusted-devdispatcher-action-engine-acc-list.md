---
title: Formula — router · engine_acc_list
type: formula
formula_id: formula.adjusted.devdispatcher.action.engine_acc_list
...
# Formula — `router · engine_acc_list`
...
| Field | Value |
|-------|-------|
| Name | `router · engine_acc_list` |
| Graph node | `formula.adjusted.devdispatcher.action.engine_acc_list` |
| Kind | dispatcher_router |
