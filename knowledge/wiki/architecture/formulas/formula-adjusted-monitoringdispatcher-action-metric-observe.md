---
title: Formula — router · metric_observe
type: formula
formula_id: formula.adjusted.monitoringdispatcher.action.metric_observe
...
| Field | Value |
|-------|-------|
| Name | `router · metric_observe` |
| Graph node | `formula.adjusted.monitoringdispatcher.action.metric_observe` |
| Kind | dispatcher_router |
