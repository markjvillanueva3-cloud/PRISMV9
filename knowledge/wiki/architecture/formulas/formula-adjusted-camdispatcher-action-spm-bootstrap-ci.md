---
title: Formula — router · spm_bootstrap_ci
type: formula
formula_id: formula.adjusted.camdispatcher.action.spm_bootstrap_ci
...
# Formula — `router · spm_bootstrap_ci`
...
| Field | Value |
|-------|-------|
| Name | `router · spm_bootstrap_ci` |
| Graph node | `formula.adjusted.camdispatcher.action.spm_bootstrap_ci` |
| Kind | dispatcher_router |
