---
title: Formula — router · fusLathePostDelta
type: formula
formula_id: formula.adjusted.camdispatcher.action.fuslathepostdelta
...
# Formula — `router · fusLathePostDelta`
...
| Field | Value |
|-------|-------|
| Name | `router · fusLathePostDelta` |
| Graph node | `formula.adjusted.camdispatcher.action.fuslathepostdelta` |
| Kind | dispatcher_router |
