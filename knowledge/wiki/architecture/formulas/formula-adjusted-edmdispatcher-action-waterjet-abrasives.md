---
title: Formula — router · waterjet_abrasives
type: formula
formula_id: formula.adjusted.edmdispatcher.action.waterjet_abrasives
...
# Formula — `router · waterjet_abrasives`
...
| Field | Value |
|-------|-------|
| Name | `router · waterjet_abrasives` |
| Graph node | `formula.adjusted.edmdispatcher.action.waterjet_abrasives` |
| Kind | dispatcher_router |
