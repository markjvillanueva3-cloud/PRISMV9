---
title: Formula — router · session_end_full
type: formula
formula_id: formula.adjusted.spdispatcher.action.session_end_full
...
# Formula — `router · session_end_full`
...
| Field | Value |
|-------|-------|
| Name | `router · session_end_full` |
| Graph node | `formula.adjusted.spdispatcher.action.session_end_full` |
| Kind | dispatcher_router |
