---
title: Formula — router · edge_case_capture
type: formula
formula_id: formula.adjusted.devdispatcher.action.edge_case_capture
...
# Formula — `router · edge_case_capture`
...
| Field | Value |
|-------|-------|
| Name | `router · edge_case_capture` |
| Graph node | `formula.adjusted.devdispatcher.action.edge_case_capture` |
| Kind | dispatcher_router |
