---
title: Formula — router · roughness_convert
type: formula
formula_id: formula.adjusted.calcdispatcher.action.roughness_convert
...
# Formula — `router · roughness_convert`
...
| Field | Value |
|-------|-------|
| Name | `router · roughness_convert` |
| Graph node | `formula.adjusted.calcdispatcher.action.roughness_convert` |
| Kind | dispatcher_router |
