---
title: Formula — router · cross_reg_join
type: formula
formula_id: formula.adjusted.devdispatcher.action.cross_reg_join
...
| Field | Value |
|-------|-------|
| Name | `router · cross_reg_join` |
| Graph node | `formula.adjusted.devdispatcher.action.cross_reg_join` |
| Kind | dispatcher_router |
