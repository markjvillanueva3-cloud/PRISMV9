---
title: Formula — router · audit_log_authz
type: formula
formula_id: formula.adjusted.securitydispatcher.action.audit_log_authz
...
# Formula — `router · audit_log_authz`
...
| Field | Value |
|-------|-------|
| Name | `router · audit_log_authz` |
| Graph node | `formula.adjusted.securitydispatcher.action.audit_log_authz` |
| Kind | dispatcher_router |
