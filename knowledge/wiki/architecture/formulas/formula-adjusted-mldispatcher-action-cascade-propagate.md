---
title: Formula — router · cascade_propagate
type: formula
formula_id: formula.adjusted.mldispatcher.action.cascade_propagate
...
# Formula — `router · cascade_propagate`
...
| Field | Value |
|-------|-------|
| Name | `router · cascade_propagate` |
| Graph node | `formula.adjusted.mldispatcher.action.cascade_propagate` |
| Kind | dispatcher_router |
