---
title: Formula — router · gse_tree
type: formula
formula_id: formula.adjusted.devdispatcher.action.gse_tree
...
| Field | Value |
|-------|-------|
| Name | `router · gse_tree` |
| Graph node | `formula.adjusted.devdispatcher.action.gse_tree` |
| Kind | dispatcher_router |
