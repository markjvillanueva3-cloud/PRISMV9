---
title: Formula — router · wedm_plan_setup
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_plan_setup
...
# Formula — `router · wedm_plan_setup`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_plan_setup` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_plan_setup` |
| Kind | dispatcher_router |
