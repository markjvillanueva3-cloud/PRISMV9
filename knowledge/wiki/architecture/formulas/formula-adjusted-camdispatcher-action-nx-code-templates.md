---
title: Formula — router · nx_code_templates
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_code_templates
...
# Formula — `router · nx_code_templates`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_code_templates` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_code_templates` |
| Kind | dispatcher_router |
