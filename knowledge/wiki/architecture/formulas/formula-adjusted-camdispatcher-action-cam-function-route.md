---
title: Formula — router · cam_function_route
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_function_route
...
# Formula — `router · cam_function_route`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_function_route` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_function_route` |
| Kind | dispatcher_router |
