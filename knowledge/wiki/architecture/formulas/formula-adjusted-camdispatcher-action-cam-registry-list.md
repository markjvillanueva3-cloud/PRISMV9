---
title: Formula — router · cam_registry_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_registry_list
...
# Formula — `router · cam_registry_list`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_registry_list` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_registry_list` |
| Kind | dispatcher_router |
