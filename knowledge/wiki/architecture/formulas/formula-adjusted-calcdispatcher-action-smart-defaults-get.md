---
title: Formula — router · smart_defaults_get
type: formula
formula_id: formula.adjusted.calcdispatcher.action.smart_defaults_get
...
# Formula — `router · smart_defaults_get`
...
| Field | Value |
|-------|-------|
| Name | `router · smart_defaults_get` |
| Graph node | `formula.adjusted.calcdispatcher.action.smart_defaults_get` |
| Kind | dispatcher_router |
