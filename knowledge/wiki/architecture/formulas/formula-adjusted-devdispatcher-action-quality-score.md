---
title: Formula — router · quality_score
type: formula
formula_id: formula.adjusted.devdispatcher.action.quality_score
...
| Field | Value |
|-------|-------|
| Name | `router · quality_score` |
| Graph node | `formula.adjusted.devdispatcher.action.quality_score` |
| Kind | dispatcher_router |
