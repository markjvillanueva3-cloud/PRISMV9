---
title: Formula — router · stats_anova
type: formula
formula_id: formula.adjusted.camdispatcher.action.stats_anova
...
| Field | Value |
|-------|-------|
| Name | `router · stats_anova` |
| Graph node | `formula.adjusted.camdispatcher.action.stats_anova` |
| Kind | dispatcher_router |
