---
title: Formula — router · toolasm
type: formula
formula_id: formula.adjusted.camdispatcher.action.toolasm
...
|-------|-------|
| Name | `router · toolasm` |
| Graph node | `formula.adjusted.camdispatcher.action.toolasm` |
| Kind | dispatcher_router |
