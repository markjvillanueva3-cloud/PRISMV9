---
title: Formula — router · markdown
type: formula
formula_id: formula.adjusted.devdispatcher.action.markdown
...
| Graph node | `formula.adjusted.devdispatcher.action.markdown` |
| Kind | dispatcher_router |
