---
title: Formula — router · bvh_build_stats
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bvh_build_stats
...
# Formula — `router · bvh_build_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · bvh_build_stats` |
| Graph node | `formula.adjusted.calcdispatcher.action.bvh_build_stats` |
| Kind | dispatcher_router |
