---
title: Formula — router · proactive_stats
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.proactive_stats
...
# Formula — `router · proactive_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · proactive_stats` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.proactive_stats` |
| Kind | dispatcher_router |
