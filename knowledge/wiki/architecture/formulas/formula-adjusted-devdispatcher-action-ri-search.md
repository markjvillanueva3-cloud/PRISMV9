---
title: Formula — router · ri_search
type: formula
formula_id: formula.adjusted.devdispatcher.action.ri_search
...
| Field | Value |
|-------|-------|
| Name | `router · ri_search` |
| Graph node | `formula.adjusted.devdispatcher.action.ri_search` |
| Kind | dispatcher_router |
