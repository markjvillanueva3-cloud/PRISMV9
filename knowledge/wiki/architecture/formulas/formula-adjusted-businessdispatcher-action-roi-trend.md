---
title: Formula — router · roi_trend
type: formula
formula_id: formula.adjusted.businessdispatcher.action.roi_trend
...
| Field | Value |
|-------|-------|
| Name | `router · roi_trend` |
| Graph node | `formula.adjusted.businessdispatcher.action.roi_trend` |
| Kind | dispatcher_router |
