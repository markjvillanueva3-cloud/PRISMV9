---
title: Formula — router · test_generate
type: formula
formula_id: formula.adjusted.devdispatcher.action.test_generate
...
| Field | Value |
|-------|-------|
| Name | `router · test_generate` |
| Graph node | `formula.adjusted.devdispatcher.action.test_generate` |
| Kind | dispatcher_router |
