---
title: Formula — router · crosscam_list
type: formula
formula_id: formula.adjusted.toolpathdispatcher.action.crosscam_list
...
| Field | Value |
|-------|-------|
| Name | `router · crosscam_list` |
| Graph node | `formula.adjusted.toolpathdispatcher.action.crosscam_list` |
| Kind | dispatcher_router |
