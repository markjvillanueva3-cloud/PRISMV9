---
title: Formula — router · bolted_joint_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bolted_joint_calc
...
# Formula — `router · bolted_joint_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · bolted_joint_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.bolted_joint_calc` |
| Kind | dispatcher_router |
