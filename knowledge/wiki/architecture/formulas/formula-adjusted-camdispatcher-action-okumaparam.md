---
title: Formula — router · okumaParam
type: formula
formula_id: formula.adjusted.camdispatcher.action.okumaparam
...
| Field | Value |
|-------|-------|
| Name | `router · okumaParam` |
| Graph node | `formula.adjusted.camdispatcher.action.okumaparam` |
| Kind | dispatcher_router |
