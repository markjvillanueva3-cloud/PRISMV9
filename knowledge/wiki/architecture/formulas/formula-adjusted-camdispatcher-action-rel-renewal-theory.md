---
title: Formula — router · rel_renewal_theory
type: formula
formula_id: formula.adjusted.camdispatcher.action.rel_renewal_theory
...
# Formula — `router · rel_renewal_theory`
...
| Field | Value |
|-------|-------|
| Name | `router · rel_renewal_theory` |
| Graph node | `formula.adjusted.camdispatcher.action.rel_renewal_theory` |
| Kind | dispatcher_router |
