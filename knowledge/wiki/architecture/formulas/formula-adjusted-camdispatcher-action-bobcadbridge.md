---
title: Formula — router · bobCADBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.bobcadbridge
...
| Field | Value |
|-------|-------|
| Name | `router · bobCADBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.bobcadbridge` |
| Kind | dispatcher_router |
