---
title: Formula — router · recent_failures
type: formula
formula_id: formula.adjusted.devdispatcher.action.recent_failures
...
# Formula — `router · recent_failures`
...
| Field | Value |
|-------|-------|
| Name | `router · recent_failures` |
| Graph node | `formula.adjusted.devdispatcher.action.recent_failures` |
| Kind | dispatcher_router |
