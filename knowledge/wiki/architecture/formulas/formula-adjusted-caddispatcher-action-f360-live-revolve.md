---
title: Formula — router · f360_live_revolve
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_revolve
...
# Formula — `router · f360_live_revolve`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_revolve` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_revolve` |
| Kind | dispatcher_router |
