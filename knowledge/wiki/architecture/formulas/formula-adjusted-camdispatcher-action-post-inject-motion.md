---
title: Formula — router · post_inject_motion
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_inject_motion
...
# Formula — `router · post_inject_motion`
...
| Field | Value |
|-------|-------|
| Name | `router · post_inject_motion` |
| Graph node | `formula.adjusted.camdispatcher.action.post_inject_motion` |
| Kind | dispatcher_router |
