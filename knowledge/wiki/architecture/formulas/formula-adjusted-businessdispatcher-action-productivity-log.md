---
title: Formula — router · productivity_log
type: formula
formula_id: formula.adjusted.businessdispatcher.action.productivity_log
...
# Formula — `router · productivity_log`
...
| Field | Value |
|-------|-------|
| Name | `router · productivity_log` |
| Graph node | `formula.adjusted.businessdispatcher.action.productivity_log` |
| Kind | dispatcher_router |
