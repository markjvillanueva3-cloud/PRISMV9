---
title: Formula — router · calc_pareto_front
type: formula
formula_id: formula.adjusted.calcdispatcher.action.calc_pareto_front
...
# Formula — `router · calc_pareto_front`
...
| Field | Value |
|-------|-------|
| Name | `router · calc_pareto_front` |
| Graph node | `formula.adjusted.calcdispatcher.action.calc_pareto_front` |
| Kind | dispatcher_router |
