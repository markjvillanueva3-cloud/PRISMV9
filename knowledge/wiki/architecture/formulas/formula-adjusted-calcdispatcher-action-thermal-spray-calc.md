---
title: Formula — router · thermal_spray_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thermal_spray_calc
...
# Formula — `router · thermal_spray_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_spray_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.thermal_spray_calc` |
| Kind | dispatcher_router |
