---
title: Formula — router · raPred
type: formula
formula_id: formula.adjusted.edmdispatcher.action.rapred
...
|-------|-------|
| Name | `router · raPred` |
| Graph node | `formula.adjusted.edmdispatcher.action.rapred` |
| Kind | dispatcher_router |
