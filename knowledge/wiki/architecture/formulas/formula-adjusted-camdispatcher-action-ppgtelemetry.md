---
title: Formula — router · ppgTelemetry
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppgtelemetry
...
| Field | Value |
|-------|-------|
| Name | `router · ppgTelemetry` |
| Graph node | `formula.adjusted.camdispatcher.action.ppgtelemetry` |
| Kind | dispatcher_router |
