---
title: Formula — router · f360Gen
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360gen
...
|-------|-------|
| Name | `router · f360Gen` |
| Graph node | `formula.adjusted.caddispatcher.action.f360gen` |
| Kind | dispatcher_router |
