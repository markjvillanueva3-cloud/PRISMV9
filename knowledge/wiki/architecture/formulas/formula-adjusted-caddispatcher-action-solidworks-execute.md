---
title: Formula — router · solidworks_execute
type: formula
formula_id: formula.adjusted.caddispatcher.action.solidworks_execute
...
# Formula — `router · solidworks_execute`
...
| Field | Value |
|-------|-------|
| Name | `router · solidworks_execute` |
| Graph node | `formula.adjusted.caddispatcher.action.solidworks_execute` |
| Kind | dispatcher_router |
