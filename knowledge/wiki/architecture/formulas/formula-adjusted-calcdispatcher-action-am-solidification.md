---
title: Formula — router · am_solidification
type: formula
formula_id: formula.adjusted.calcdispatcher.action.am_solidification
...
# Formula — `router · am_solidification`
...
| Field | Value |
|-------|-------|
| Name | `router · am_solidification` |
| Graph node | `formula.adjusted.calcdispatcher.action.am_solidification` |
| Kind | dispatcher_router |
