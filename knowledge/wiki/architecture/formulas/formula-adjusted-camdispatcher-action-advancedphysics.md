---
title: Formula — router · advancedPhysics
type: formula
formula_id: formula.adjusted.camdispatcher.action.advancedphysics
...
# Formula — `router · advancedPhysics`
...
| Field | Value |
|-------|-------|
| Name | `router · advancedPhysics` |
| Graph node | `formula.adjusted.camdispatcher.action.advancedphysics` |
| Kind | dispatcher_router |
