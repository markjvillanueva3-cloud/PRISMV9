---
title: Formula — router · gl_trial_balance
type: formula
formula_id: formula.adjusted.businessdispatcher.action.gl_trial_balance
...
# Formula — `router · gl_trial_balance`
...
| Field | Value |
|-------|-------|
| Name | `router · gl_trial_balance` |
| Graph node | `formula.adjusted.businessdispatcher.action.gl_trial_balance` |
| Kind | dispatcher_router |
