---
title: Formula — router · machine_compare
type: formula
formula_id: formula.adjusted.calcdispatcher.action.machine_compare
...
# Formula — `router · machine_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · machine_compare` |
| Graph node | `formula.adjusted.calcdispatcher.action.machine_compare` |
| Kind | dispatcher_router |
