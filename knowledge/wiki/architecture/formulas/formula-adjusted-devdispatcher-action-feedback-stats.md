---
title: Formula — router · feedback_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.feedback_stats
...
| Field | Value |
|-------|-------|
| Name | `router · feedback_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.feedback_stats` |
| Kind | dispatcher_router |
