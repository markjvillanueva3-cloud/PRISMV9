---
title: Formula — router · output_cache_store
type: formula
formula_id: formula.adjusted.devdispatcher.action.output_cache_store
...
# Formula — `router · output_cache_store`
...
| Field | Value |
|-------|-------|
| Name | `router · output_cache_store` |
| Graph node | `formula.adjusted.devdispatcher.action.output_cache_store` |
| Kind | dispatcher_router |
