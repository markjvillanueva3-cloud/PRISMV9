---
title: Formula — router · reporting
type: formula
formula_id: formula.adjusted.businessdispatcher.action.reporting
...
| Field | Value |
|-------|-------|
| Name | `router · reporting` |
| Graph node | `formula.adjusted.businessdispatcher.action.reporting` |
| Kind | dispatcher_router |
