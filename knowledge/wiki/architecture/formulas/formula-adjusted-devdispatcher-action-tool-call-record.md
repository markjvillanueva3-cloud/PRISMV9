---
title: Formula — router · tool_call_record
type: formula
formula_id: formula.adjusted.devdispatcher.action.tool_call_record
...
# Formula — `router · tool_call_record`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_call_record` |
| Graph node | `formula.adjusted.devdispatcher.action.tool_call_record` |
| Kind | dispatcher_router |
