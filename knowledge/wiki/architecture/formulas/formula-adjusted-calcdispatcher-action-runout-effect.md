---
title: Formula — router · runout_effect
type: formula
formula_id: formula.adjusted.calcdispatcher.action.runout_effect
...
| Field | Value |
|-------|-------|
| Name | `router · runout_effect` |
| Graph node | `formula.adjusted.calcdispatcher.action.runout_effect` |
| Kind | dispatcher_router |
