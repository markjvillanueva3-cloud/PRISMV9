---
title: Formula — router · gcode_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gcode_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.gcode_optimize` |
| Kind | dispatcher_router |
