---
title: Formula — router · pp_training_stats
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_training_stats
...
# Formula — `router · pp_training_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_training_stats` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_training_stats` |
| Kind | dispatcher_router |
