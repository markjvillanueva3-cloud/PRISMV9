---
title: Formula — router · wireStress
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wirestress
...
| Field | Value |
|-------|-------|
| Name | `router · wireStress` |
| Graph node | `formula.adjusted.edmdispatcher.action.wirestress` |
| Kind | dispatcher_router |
