---
title: Formula — router · schedule_what_if
type: formula
formula_id: formula.adjusted.businessdispatcher.action.schedule_what_if
...
# Formula — `router · schedule_what_if`
...
| Field | Value |
|-------|-------|
| Name | `router · schedule_what_if` |
| Graph node | `formula.adjusted.businessdispatcher.action.schedule_what_if` |
| Kind | dispatcher_router |
