---
title: Formula — router · okumaTurning
type: formula
formula_id: formula.adjusted.ppdispatcher.action.okumaturning
...
| Field | Value |
|-------|-------|
| Name | `router · okumaTurning` |
| Graph node | `formula.adjusted.ppdispatcher.action.okumaturning` |
| Kind | dispatcher_router |
