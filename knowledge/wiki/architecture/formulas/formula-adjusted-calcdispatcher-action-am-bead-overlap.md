---
title: Formula — router · am_bead_overlap
type: formula
formula_id: formula.adjusted.calcdispatcher.action.am_bead_overlap
...
# Formula — `router · am_bead_overlap`
...
| Field | Value |
|-------|-------|
| Name | `router · am_bead_overlap` |
| Graph node | `formula.adjusted.calcdispatcher.action.am_bead_overlap` |
| Kind | dispatcher_router |
