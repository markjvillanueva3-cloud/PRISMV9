---
title: Formula — router · context_size
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.context_size
...
| Field | Value |
|-------|-------|
| Name | `router · context_size` |
| Graph node | `formula.adjusted.sessiondispatcher.action.context_size` |
| Kind | dispatcher_router |
