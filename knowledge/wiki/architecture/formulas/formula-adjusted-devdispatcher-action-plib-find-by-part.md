---
title: Formula — router · plib_find_by_part
type: formula
formula_id: formula.adjusted.devdispatcher.action.plib_find_by_part
...
# Formula — `router · plib_find_by_part`
...
| Field | Value |
|-------|-------|
| Name | `router · plib_find_by_part` |
| Graph node | `formula.adjusted.devdispatcher.action.plib_find_by_part` |
| Kind | dispatcher_router |
