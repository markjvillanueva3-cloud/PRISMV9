---
title: Formula — router · pipe_stress_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.pipe_stress_calc
...
# Formula — `router · pipe_stress_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · pipe_stress_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.pipe_stress_calc` |
| Kind | dispatcher_router |
