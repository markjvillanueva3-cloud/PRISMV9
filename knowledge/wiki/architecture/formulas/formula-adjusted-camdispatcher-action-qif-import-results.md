---
title: Formula — router · qif_import_results
type: formula
formula_id: formula.adjusted.camdispatcher.action.qif_import_results
...
# Formula — `router · qif_import_results`
...
| Field | Value |
|-------|-------|
| Name | `router · qif_import_results` |
| Graph node | `formula.adjusted.camdispatcher.action.qif_import_results` |
| Kind | dispatcher_router |
