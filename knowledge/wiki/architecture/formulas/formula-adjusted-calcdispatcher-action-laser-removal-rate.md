---
title: Formula — router · laser_removal_rate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.laser_removal_rate
...
# Formula — `router · laser_removal_rate`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_removal_rate` |
| Graph node | `formula.adjusted.calcdispatcher.action.laser_removal_rate` |
| Kind | dispatcher_router |
