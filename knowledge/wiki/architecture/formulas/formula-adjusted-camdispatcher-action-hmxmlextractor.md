---
title: Formula — router · hmXmlExtractor
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmxmlextractor
...
| Field | Value |
|-------|-------|
| Name | `router · hmXmlExtractor` |
| Graph node | `formula.adjusted.camdispatcher.action.hmxmlextractor` |
| Kind | dispatcher_router |
