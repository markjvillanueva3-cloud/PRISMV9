---
title: Formula — router · queue_mm1
type: formula
formula_id: formula.adjusted.calcdispatcher.action.queue_mm1
...
| Field | Value |
|-------|-------|
| Name | `router · queue_mm1` |
| Graph node | `formula.adjusted.calcdispatcher.action.queue_mm1` |
| Kind | dispatcher_router |
