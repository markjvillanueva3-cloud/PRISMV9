---
title: Formula — router · waterjet_materials
type: formula
formula_id: formula.adjusted.edmdispatcher.action.waterjet_materials
...
# Formula — `router · waterjet_materials`
...
| Field | Value |
|-------|-------|
| Name | `router · waterjet_materials` |
| Graph node | `formula.adjusted.edmdispatcher.action.waterjet_materials` |
| Kind | dispatcher_router |
