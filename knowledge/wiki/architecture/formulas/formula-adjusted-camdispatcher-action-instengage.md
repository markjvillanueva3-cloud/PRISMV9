---
title: Formula — router · instEngage
type: formula
formula_id: formula.adjusted.camdispatcher.action.instengage
...
| Field | Value |
|-------|-------|
| Name | `router · instEngage` |
| Graph node | `formula.adjusted.camdispatcher.action.instengage` |
| Kind | dispatcher_router |
