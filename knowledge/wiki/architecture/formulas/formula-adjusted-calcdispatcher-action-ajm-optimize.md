---
title: Formula — router · ajm_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ajm_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · ajm_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.ajm_optimize` |
| Kind | dispatcher_router |
