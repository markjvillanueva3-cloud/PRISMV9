---
title: Formula — router · pr_detect_cycles
type: formula
formula_id: formula.adjusted.devdispatcher.action.pr_detect_cycles
...
# Formula — `router · pr_detect_cycles`
...
| Field | Value |
|-------|-------|
| Name | `router · pr_detect_cycles` |
| Graph node | `formula.adjusted.devdispatcher.action.pr_detect_cycles` |
| Kind | dispatcher_router |
