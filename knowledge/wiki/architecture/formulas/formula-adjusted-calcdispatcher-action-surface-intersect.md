---
title: Formula — router · surface_intersect
type: formula
formula_id: formula.adjusted.calcdispatcher.action.surface_intersect
...
# Formula — `router · surface_intersect`
...
| Field | Value |
|-------|-------|
| Name | `router · surface_intersect` |
| Graph node | `formula.adjusted.calcdispatcher.action.surface_intersect` |
| Kind | dispatcher_router |
