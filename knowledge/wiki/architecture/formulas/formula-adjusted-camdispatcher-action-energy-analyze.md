---
title: Formula — router · energy_analyze
type: formula
formula_id: formula.adjusted.camdispatcher.action.energy_analyze
...
| Field | Value |
|-------|-------|
| Name | `router · energy_analyze` |
| Graph node | `formula.adjusted.camdispatcher.action.energy_analyze` |
| Kind | dispatcher_router |
