---
title: Formula — router · pr_compute_hits
type: formula
formula_id: formula.adjusted.devdispatcher.action.pr_compute_hits
...
# Formula — `router · pr_compute_hits`
...
| Field | Value |
|-------|-------|
| Name | `router · pr_compute_hits` |
| Graph node | `formula.adjusted.devdispatcher.action.pr_compute_hits` |
| Kind | dispatcher_router |
