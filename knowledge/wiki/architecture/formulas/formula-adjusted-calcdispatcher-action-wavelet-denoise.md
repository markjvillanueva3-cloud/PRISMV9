---
title: Formula — router · wavelet_denoise
type: formula
formula_id: formula.adjusted.calcdispatcher.action.wavelet_denoise
...
# Formula — `router · wavelet_denoise`
...
| Field | Value |
|-------|-------|
| Name | `router · wavelet_denoise` |
| Graph node | `formula.adjusted.calcdispatcher.action.wavelet_denoise` |
| Kind | dispatcher_router |
