---
title: Formula — router · cam_smart_tool
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_smart_tool
...
| Field | Value |
|-------|-------|
| Name | `router · cam_smart_tool` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_smart_tool` |
| Kind | dispatcher_router |
