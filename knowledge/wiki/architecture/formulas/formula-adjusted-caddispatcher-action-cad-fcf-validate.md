---
title: Formula — router · cad_fcf_validate
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_fcf_validate
...
# Formula — `router · cad_fcf_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_fcf_validate` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_fcf_validate` |
| Kind | dispatcher_router |
