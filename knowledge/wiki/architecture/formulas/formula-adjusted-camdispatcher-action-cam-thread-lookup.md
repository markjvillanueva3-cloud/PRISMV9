---
title: Formula — router · cam_thread_lookup
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_thread_lookup
...
# Formula — `router · cam_thread_lookup`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_thread_lookup` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_thread_lookup` |
| Kind | dispatcher_router |
