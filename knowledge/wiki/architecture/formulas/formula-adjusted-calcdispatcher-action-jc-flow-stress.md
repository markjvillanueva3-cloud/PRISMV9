---
title: Formula — router · jc_flow_stress
type: formula
formula_id: formula.adjusted.calcdispatcher.action.jc_flow_stress
...
| Field | Value |
|-------|-------|
| Name | `router · jc_flow_stress` |
| Graph node | `formula.adjusted.calcdispatcher.action.jc_flow_stress` |
| Kind | dispatcher_router |
