---
title: Formula — router · wedm_mrr_validate
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_mrr_validate
...
# Formula — `router · wedm_mrr_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_mrr_validate` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_mrr_validate` |
| Kind | dispatcher_router |
