---
title: Formula — router · wedm_lattice_stats
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_lattice_stats
...
# Formula — `router · wedm_lattice_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_lattice_stats` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_lattice_stats` |
| Kind | dispatcher_router |
