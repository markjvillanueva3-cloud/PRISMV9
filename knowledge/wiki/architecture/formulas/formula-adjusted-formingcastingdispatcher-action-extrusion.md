---
title: Formula — router · extrusion
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.extrusion
...
| Field | Value |
|-------|-------|
| Name | `router · extrusion` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.extrusion` |
| Kind | dispatcher_router |
