---
title: Formula — router · cam_lora_select
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_lora_select
...
# Formula — `router · cam_lora_select`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_lora_select` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_lora_select` |
| Kind | dispatcher_router |
