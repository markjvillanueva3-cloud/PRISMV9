---
title: Formula — router · batchSizeStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.batchsizestrategy
...
# Formula — `router · batchSizeStrategy`
...
| Field | Value |
|-------|-------|
| Name | `router · batchSizeStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.batchsizestrategy` |
| Kind | dispatcher_router |
