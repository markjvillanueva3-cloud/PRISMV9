---
title: Formula — router · const_hollomon
type: formula
formula_id: formula.adjusted.camdispatcher.action.const_hollomon
...
| Field | Value |
|-------|-------|
| Name | `router · const_hollomon` |
| Graph node | `formula.adjusted.camdispatcher.action.const_hollomon` |
| Kind | dispatcher_router |
