---
title: Formula — router · grind_uncertainty
type: formula
formula_id: formula.adjusted.camdispatcher.action.grind_uncertainty
...
# Formula — `router · grind_uncertainty`
...
| Field | Value |
|-------|-------|
| Name | `router · grind_uncertainty` |
| Graph node | `formula.adjusted.camdispatcher.action.grind_uncertainty` |
| Kind | dispatcher_router |
