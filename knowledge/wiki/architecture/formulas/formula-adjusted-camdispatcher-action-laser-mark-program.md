---
title: Formula — router · laser_mark_program
type: formula
formula_id: formula.adjusted.camdispatcher.action.laser_mark_program
...
# Formula — `router · laser_mark_program`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_mark_program` |
| Graph node | `formula.adjusted.camdispatcher.action.laser_mark_program` |
| Kind | dispatcher_router |
