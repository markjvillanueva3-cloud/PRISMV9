---
title: Formula — router · tool_crib_checkout
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_crib_checkout
...
# Formula — `router · tool_crib_checkout`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_crib_checkout` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_crib_checkout` |
| Kind | dispatcher_router |
