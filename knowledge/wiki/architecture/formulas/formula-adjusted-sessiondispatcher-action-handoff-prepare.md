---
title: Formula — router · handoff_prepare
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.handoff_prepare
...
# Formula — `router · handoff_prepare`
...
| Field | Value |
|-------|-------|
| Name | `router · handoff_prepare` |
| Graph node | `formula.adjusted.sessiondispatcher.action.handoff_prepare` |
| Kind | dispatcher_router |
