---
title: Formula — router · chain_v2
type: formula
formula_id: formula.adjusted.hookdispatcher.action.chain_v2
...
| Field | Value |
|-------|-------|
| Name | `router · chain_v2` |
| Graph node | `formula.adjusted.hookdispatcher.action.chain_v2` |
| Kind | dispatcher_router |
