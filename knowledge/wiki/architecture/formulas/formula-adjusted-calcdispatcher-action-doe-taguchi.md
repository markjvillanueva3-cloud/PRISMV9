---
title: Formula — router · doe_taguchi
type: formula
formula_id: formula.adjusted.calcdispatcher.action.doe_taguchi
...
| Field | Value |
|-------|-------|
| Name | `router · doe_taguchi` |
| Graph node | `formula.adjusted.calcdispatcher.action.doe_taguchi` |
| Kind | dispatcher_router |
