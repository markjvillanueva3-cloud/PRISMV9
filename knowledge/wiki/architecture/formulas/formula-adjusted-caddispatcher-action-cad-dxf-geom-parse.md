---
title: Formula — router · cad_dxf_geom_parse
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_dxf_geom_parse
...
# Formula — `router · cad_dxf_geom_parse`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_dxf_geom_parse` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_dxf_geom_parse` |
| Kind | dispatcher_router |
