---
title: Formula — router · cps_parse_file
type: formula
formula_id: formula.adjusted.camdispatcher.action.cps_parse_file
...
| Field | Value |
|-------|-------|
| Name | `router · cps_parse_file` |
| Graph node | `formula.adjusted.camdispatcher.action.cps_parse_file` |
| Kind | dispatcher_router |
