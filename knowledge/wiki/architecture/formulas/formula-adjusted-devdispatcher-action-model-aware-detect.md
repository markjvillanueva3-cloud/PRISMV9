---
title: Formula — router · model_aware_detect
type: formula
formula_id: formula.adjusted.devdispatcher.action.model_aware_detect
...
# Formula — `router · model_aware_detect`
...
| Field | Value |
|-------|-------|
| Name | `router · model_aware_detect` |
| Graph node | `formula.adjusted.devdispatcher.action.model_aware_detect` |
| Kind | dispatcher_router |
