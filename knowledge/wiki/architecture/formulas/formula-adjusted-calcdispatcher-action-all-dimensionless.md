---
title: Formula — router · all_dimensionless
type: formula
formula_id: formula.adjusted.calcdispatcher.action.all_dimensionless
...
# Formula — `router · all_dimensionless`
...
| Field | Value |
|-------|-------|
| Name | `router · all_dimensionless` |
| Graph node | `formula.adjusted.calcdispatcher.action.all_dimensionless` |
| Kind | dispatcher_router |
