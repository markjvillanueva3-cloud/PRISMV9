---
title: Formula — router · critical_path
type: formula
formula_id: formula.adjusted.devdispatcher.action.critical_path
...
| Field | Value |
|-------|-------|
| Name | `router · critical_path` |
| Graph node | `formula.adjusted.devdispatcher.action.critical_path` |
| Kind | dispatcher_router |
