---
title: Formula — router · mda_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.mda_summary
...
| Field | Value |
|-------|-------|
| Name | `router · mda_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.mda_summary` |
| Kind | dispatcher_router |
