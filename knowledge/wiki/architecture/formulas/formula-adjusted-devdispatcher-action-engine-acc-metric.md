---
title: Formula — router · engine_acc_metric
type: formula
formula_id: formula.adjusted.devdispatcher.action.engine_acc_metric
...
# Formula — `router · engine_acc_metric`
...
| Field | Value |
|-------|-------|
| Name | `router · engine_acc_metric` |
| Graph node | `formula.adjusted.devdispatcher.action.engine_acc_metric` |
| Kind | dispatcher_router |
