---
title: Formula — router · cv_learning_curve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cv_learning_curve
...
# Formula — `router · cv_learning_curve`
...
| Field | Value |
|-------|-------|
| Name | `router · cv_learning_curve` |
| Graph node | `formula.adjusted.calcdispatcher.action.cv_learning_curve` |
| Kind | dispatcher_router |
