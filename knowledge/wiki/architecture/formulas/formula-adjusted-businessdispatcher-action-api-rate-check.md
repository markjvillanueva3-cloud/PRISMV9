---
title: Formula — router · api_rate_check
type: formula
formula_id: formula.adjusted.businessdispatcher.action.api_rate_check
...
| Field | Value |
|-------|-------|
| Name | `router · api_rate_check` |
| Graph node | `formula.adjusted.businessdispatcher.action.api_rate_check` |
| Kind | dispatcher_router |
