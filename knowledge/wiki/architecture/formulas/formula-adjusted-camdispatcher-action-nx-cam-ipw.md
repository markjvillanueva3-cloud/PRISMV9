---
title: Formula — router · nx_cam_ipw
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_cam_ipw
...
| Field | Value |
|-------|-------|
| Name | `router · nx_cam_ipw` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_cam_ipw` |
| Kind | dispatcher_router |
