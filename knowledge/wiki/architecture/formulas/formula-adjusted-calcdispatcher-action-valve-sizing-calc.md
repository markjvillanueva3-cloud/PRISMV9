---
title: Formula — router · valve_sizing_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.valve_sizing_calc
...
# Formula — `router · valve_sizing_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · valve_sizing_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.valve_sizing_calc` |
| Kind | dispatcher_router |
