---
title: Formula — router · cam_bobcad_connect
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_bobcad_connect
...
# Formula — `router · cam_bobcad_connect`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_bobcad_connect` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_bobcad_connect` |
| Kind | dispatcher_router |
