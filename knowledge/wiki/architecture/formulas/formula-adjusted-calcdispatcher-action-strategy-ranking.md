---
title: Formula — router · strategy_ranking
type: formula
formula_id: formula.adjusted.calcdispatcher.action.strategy_ranking
...
# Formula — `router · strategy_ranking`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_ranking` |
| Graph node | `formula.adjusted.calcdispatcher.action.strategy_ranking` |
| Kind | dispatcher_router |
