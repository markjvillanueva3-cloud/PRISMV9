---
title: Formula — router · open
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.open
...
|-------|-------|
| Name | `router · open` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.open` |
| Kind | dispatcher_router |
