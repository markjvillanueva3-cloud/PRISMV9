---
title: Formula — router · spectrogram
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spectrogram
...
| Field | Value |
|-------|-------|
| Name | `router · spectrogram` |
| Graph node | `formula.adjusted.calcdispatcher.action.spectrogram` |
| Kind | dispatcher_router |
