---
title: Formula — router · ecm_mrr
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ecm_mrr
...
|-------|-------|
| Name | `router · ecm_mrr` |
| Graph node | `formula.adjusted.calcdispatcher.action.ecm_mrr` |
| Kind | dispatcher_router |
