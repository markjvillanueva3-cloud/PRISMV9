---
title: Formula — router · hmCycleCatalog
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmcyclecatalog
...
| Field | Value |
|-------|-------|
| Name | `router · hmCycleCatalog` |
| Graph node | `formula.adjusted.camdispatcher.action.hmcyclecatalog` |
| Kind | dispatcher_router |
