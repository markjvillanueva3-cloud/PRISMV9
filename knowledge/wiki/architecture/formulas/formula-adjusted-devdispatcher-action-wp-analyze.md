---
title: Formula — router · wp_analyze
type: formula
formula_id: formula.adjusted.devdispatcher.action.wp_analyze
...
| Field | Value |
|-------|-------|
| Name | `router · wp_analyze` |
| Graph node | `formula.adjusted.devdispatcher.action.wp_analyze` |
| Kind | dispatcher_router |
