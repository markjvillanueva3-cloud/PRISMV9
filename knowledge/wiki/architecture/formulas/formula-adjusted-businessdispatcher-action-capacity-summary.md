---
title: Formula — router · capacity_summary
type: formula
formula_id: formula.adjusted.businessdispatcher.action.capacity_summary
...
# Formula — `router · capacity_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · capacity_summary` |
| Graph node | `formula.adjusted.businessdispatcher.action.capacity_summary` |
| Kind | dispatcher_router |
