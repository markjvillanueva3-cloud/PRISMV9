---
title: Formula — router · nxcamFBMIndex
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcamfbmindex
...
| Field | Value |
|-------|-------|
| Name | `router · nxcamFBMIndex` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcamfbmindex` |
| Kind | dispatcher_router |
