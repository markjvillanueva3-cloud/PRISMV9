---
title: Formula — router · wedm_dialect_gate
type: formula
formula_id: formula.adjusted.camdispatcher.action.wedm_dialect_gate
...
# Formula — `router · wedm_dialect_gate`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_dialect_gate` |
| Graph node | `formula.adjusted.camdispatcher.action.wedm_dialect_gate` |
| Kind | dispatcher_router |
