---
title: Formula — router · lapping_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.lapping_predict
...
# Formula — `router · lapping_predict`
...
| Field | Value |
|-------|-------|
| Name | `router · lapping_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.lapping_predict` |
| Kind | dispatcher_router |
