---
title: Formula — router · ode_second_order
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ode_second_order
...
# Formula — `router · ode_second_order`
...
| Field | Value |
|-------|-------|
| Name | `router · ode_second_order` |
| Graph node | `formula.adjusted.calcdispatcher.action.ode_second_order` |
| Kind | dispatcher_router |
