---
title: Formula — router · report
type: formula
formula_id: formula.adjusted.cadregressiondispatcher.action.report
...
|-------|-------|
| Name | `router · report` |
| Graph node | `formula.adjusted.cadregressiondispatcher.action.report` |
| Kind | dispatcher_router |
