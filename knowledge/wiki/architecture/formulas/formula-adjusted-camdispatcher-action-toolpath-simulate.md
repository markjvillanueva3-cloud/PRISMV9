---
title: Formula — router · toolpath_simulate
type: formula
formula_id: formula.adjusted.camdispatcher.action.toolpath_simulate
...
# Formula — `router · toolpath_simulate`
...
| Field | Value |
|-------|-------|
| Name | `router · toolpath_simulate` |
| Graph node | `formula.adjusted.camdispatcher.action.toolpath_simulate` |
| Kind | dispatcher_router |
