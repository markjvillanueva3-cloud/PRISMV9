---
title: Formula — router · batch_capacity
type: formula
formula_id: formula.adjusted.businessdispatcher.action.batch_capacity
...
| Field | Value |
|-------|-------|
| Name | `router · batch_capacity` |
| Graph node | `formula.adjusted.businessdispatcher.action.batch_capacity` |
| Kind | dispatcher_router |
