---
title: Formula — router · dxfParser
type: formula
formula_id: formula.adjusted.camdispatcher.action.dxfparser
...
| Field | Value |
|-------|-------|
| Name | `router · dxfParser` |
| Graph node | `formula.adjusted.camdispatcher.action.dxfparser` |
| Kind | dispatcher_router |
