---
title: Formula — router · sca_search_catalog
type: formula
formula_id: formula.adjusted.devdispatcher.action.sca_search_catalog
...
# Formula — `router · sca_search_catalog`
...
| Field | Value |
|-------|-------|
| Name | `router · sca_search_catalog` |
| Graph node | `formula.adjusted.devdispatcher.action.sca_search_catalog` |
| Kind | dispatcher_router |
