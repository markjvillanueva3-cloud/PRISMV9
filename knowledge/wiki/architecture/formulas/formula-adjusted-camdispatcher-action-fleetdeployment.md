---
title: Formula — router · fleetDeployment
type: formula
formula_id: formula.adjusted.camdispatcher.action.fleetdeployment
...
# Formula — `router · fleetDeployment`
...
| Field | Value |
|-------|-------|
| Name | `router · fleetDeployment` |
| Graph node | `formula.adjusted.camdispatcher.action.fleetdeployment` |
| Kind | dispatcher_router |
