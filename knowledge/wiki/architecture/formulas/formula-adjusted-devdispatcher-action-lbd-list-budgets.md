---
title: Formula — router · lbd_list_budgets
type: formula
formula_id: formula.adjusted.devdispatcher.action.lbd_list_budgets
...
# Formula — `router · lbd_list_budgets`
...
| Field | Value |
|-------|-------|
| Name | `router · lbd_list_budgets` |
| Graph node | `formula.adjusted.devdispatcher.action.lbd_list_budgets` |
| Kind | dispatcher_router |
