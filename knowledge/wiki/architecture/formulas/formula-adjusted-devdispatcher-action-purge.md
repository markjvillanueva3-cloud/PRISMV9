---
title: Formula — router · purge
type: formula
formula_id: formula.adjusted.devdispatcher.action.purge
...
|-------|-------|
| Name | `router · purge` |
| Graph node | `formula.adjusted.devdispatcher.action.purge` |
| Kind | dispatcher_router |
