---
title: Formula — router · hobbing_shift
type: formula
formula_id: formula.adjusted.calcdispatcher.action.hobbing_shift
...
| Field | Value |
|-------|-------|
| Name | `router · hobbing_shift` |
| Graph node | `formula.adjusted.calcdispatcher.action.hobbing_shift` |
| Kind | dispatcher_router |
