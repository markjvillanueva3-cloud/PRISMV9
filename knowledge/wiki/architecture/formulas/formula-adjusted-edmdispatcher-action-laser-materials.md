---
title: Formula — router · laser_materials
type: formula
formula_id: formula.adjusted.edmdispatcher.action.laser_materials
...
# Formula — `router · laser_materials`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_materials` |
| Graph node | `formula.adjusted.edmdispatcher.action.laser_materials` |
| Kind | dispatcher_router |
