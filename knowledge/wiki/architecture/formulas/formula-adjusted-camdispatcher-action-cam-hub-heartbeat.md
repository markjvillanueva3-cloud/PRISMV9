---
title: Formula — router · cam_hub_heartbeat
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_hub_heartbeat
...
# Formula — `router · cam_hub_heartbeat`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_hub_heartbeat` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_hub_heartbeat` |
| Kind | dispatcher_router |
