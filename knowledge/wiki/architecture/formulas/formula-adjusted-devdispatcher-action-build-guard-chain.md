---
title: Formula — router · build_guard_chain
type: formula
formula_id: formula.adjusted.devdispatcher.action.build_guard_chain
...
# Formula — `router · build_guard_chain`
...
| Field | Value |
|-------|-------|
| Name | `router · build_guard_chain` |
| Graph node | `formula.adjusted.devdispatcher.action.build_guard_chain` |
| Kind | dispatcher_router |
