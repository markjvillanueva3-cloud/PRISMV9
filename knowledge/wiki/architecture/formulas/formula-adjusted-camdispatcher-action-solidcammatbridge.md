---
title: Formula — router · solidCAMMatBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcammatbridge
...
# Formula — `router · solidCAMMatBridge`
...
| Field | Value |
|-------|-------|
| Name | `router · solidCAMMatBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcammatbridge` |
| Kind | dispatcher_router |
