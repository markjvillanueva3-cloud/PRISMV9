---
title: Formula — router · action_find
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.action_find
...
| Field | Value |
|-------|-------|
| Name | `router · action_find` |
| Graph node | `formula.adjusted.sessiondispatcher.action.action_find` |
| Kind | dispatcher_router |
