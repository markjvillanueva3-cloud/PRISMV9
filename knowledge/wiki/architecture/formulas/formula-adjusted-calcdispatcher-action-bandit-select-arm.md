---
title: Formula — router · bandit_select_arm
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bandit_select_arm
...
# Formula — `router · bandit_select_arm`
...
| Field | Value |
|-------|-------|
| Name | `router · bandit_select_arm` |
| Graph node | `formula.adjusted.calcdispatcher.action.bandit_select_arm` |
| Kind | dispatcher_router |
