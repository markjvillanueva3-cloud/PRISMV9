---
title: Formula — router · grafana_query
type: formula
formula_id: formula.adjusted.monitoringdispatcher.action.grafana_query
...
| Field | Value |
|-------|-------|
| Name | `router · grafana_query` |
| Graph node | `formula.adjusted.monitoringdispatcher.action.grafana_query` |
| Kind | dispatcher_router |
