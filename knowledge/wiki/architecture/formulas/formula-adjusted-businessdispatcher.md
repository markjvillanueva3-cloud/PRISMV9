---
title: Formula — router · business
type: formula
formula_id: formula.adjusted.businessdispatcher
...
| Field | Value |
|-------|-------|
| Name | `router · business` |
| Graph node | `formula.adjusted.businessdispatcher` |
| Kind | dispatcher_router |
