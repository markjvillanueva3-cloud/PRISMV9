---
title: Formula — router · cam_multi_process
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_multi_process
...
# Formula — `router · cam_multi_process`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_multi_process` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_multi_process` |
| Kind | dispatcher_router |
