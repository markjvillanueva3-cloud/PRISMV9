---
title: Formula — router · post_configure
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_configure
...
| Field | Value |
|-------|-------|
| Name | `router · post_configure` |
| Graph node | `formula.adjusted.camdispatcher.action.post_configure` |
| Kind | dispatcher_router |
