---
title: Formula — router · feature_recognize
type: formula
formula_id: formula.adjusted.caddispatcher.action.feature_recognize
...
# Formula — `router · feature_recognize`
...
| Field | Value |
|-------|-------|
| Name | `router · feature_recognize` |
| Graph node | `formula.adjusted.caddispatcher.action.feature_recognize` |
| Kind | dispatcher_router |
