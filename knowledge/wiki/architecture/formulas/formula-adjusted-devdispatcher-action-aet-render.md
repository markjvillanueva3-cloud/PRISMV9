---
title: Formula — router · aet_render
type: formula
formula_id: formula.adjusted.devdispatcher.action.aet_render
...
| Field | Value |
|-------|-------|
| Name | `router · aet_render` |
| Graph node | `formula.adjusted.devdispatcher.action.aet_render` |
| Kind | dispatcher_router |
