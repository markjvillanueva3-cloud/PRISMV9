---
title: Formula — router · harvest_thermo
type: formula
formula_id: formula.adjusted.calcdispatcher.action.harvest_thermo
...
| Field | Value |
|-------|-------|
| Name | `router · harvest_thermo` |
| Graph node | `formula.adjusted.calcdispatcher.action.harvest_thermo` |
| Kind | dispatcher_router |
