---
title: Formula — router · traveler_create
type: formula
formula_id: formula.adjusted.businessdispatcher.action.traveler_create
...
# Formula — `router · traveler_create`
...
| Field | Value |
|-------|-------|
| Name | `router · traveler_create` |
| Graph node | `formula.adjusted.businessdispatcher.action.traveler_create` |
| Kind | dispatcher_router |
