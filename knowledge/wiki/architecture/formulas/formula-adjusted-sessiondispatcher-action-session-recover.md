---
title: Formula — router · session_recover
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.session_recover
...
# Formula — `router · session_recover`
...
| Field | Value |
|-------|-------|
| Name | `router · session_recover` |
| Graph node | `formula.adjusted.sessiondispatcher.action.session_recover` |
| Kind | dispatcher_router |
