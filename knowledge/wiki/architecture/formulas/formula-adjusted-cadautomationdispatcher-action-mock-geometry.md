---
title: Formula — router · mock_geometry
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.mock_geometry
...
| Field | Value |
|-------|-------|
| Name | `router · mock_geometry` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.mock_geometry` |
| Kind | dispatcher_router |
