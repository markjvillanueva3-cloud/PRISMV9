---
title: Formula — router · cam_hub_drain
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_hub_drain
...
| Field | Value |
|-------|-------|
| Name | `router · cam_hub_drain` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_hub_drain` |
| Kind | dispatcher_router |
