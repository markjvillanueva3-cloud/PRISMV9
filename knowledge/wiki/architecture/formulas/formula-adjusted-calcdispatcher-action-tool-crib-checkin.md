---
title: Formula — router · tool_crib_checkin
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_crib_checkin
...
# Formula — `router · tool_crib_checkin`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_crib_checkin` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_crib_checkin` |
| Kind | dispatcher_router |
