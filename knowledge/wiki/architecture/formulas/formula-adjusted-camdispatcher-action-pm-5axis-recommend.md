---
title: Formula — router · pm_5axis_recommend
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_5axis_recommend
...
# Formula — `router · pm_5axis_recommend`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_5axis_recommend` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_5axis_recommend` |
| Kind | dispatcher_router |
