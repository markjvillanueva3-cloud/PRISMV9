---
title: Formula — router · unit_convert_batch
type: formula
formula_id: formula.adjusted.calcdispatcher.action.unit_convert_batch
...
# Formula — `router · unit_convert_batch`
...
| Field | Value |
|-------|-------|
| Name | `router · unit_convert_batch` |
| Graph node | `formula.adjusted.calcdispatcher.action.unit_convert_batch` |
| Kind | dispatcher_router |
