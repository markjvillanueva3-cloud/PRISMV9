---
title: Formula — router · tool_chain_record
type: formula
formula_id: formula.adjusted.devdispatcher.action.tool_chain_record
...
# Formula — `router · tool_chain_record`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_chain_record` |
| Graph node | `formula.adjusted.devdispatcher.action.tool_chain_record` |
| Kind | dispatcher_router |
