---
title: Formula — router · belief_update
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.belief_update
...
| Field | Value |
|-------|-------|
| Name | `router · belief_update` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.belief_update` |
| Kind | dispatcher_router |
