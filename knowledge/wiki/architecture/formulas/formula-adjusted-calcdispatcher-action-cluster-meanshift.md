---
title: Formula — router · cluster_meanshift
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cluster_meanshift
...
# Formula — `router · cluster_meanshift`
...
| Field | Value |
|-------|-------|
| Name | `router · cluster_meanshift` |
| Graph node | `formula.adjusted.calcdispatcher.action.cluster_meanshift` |
| Kind | dispatcher_router |
