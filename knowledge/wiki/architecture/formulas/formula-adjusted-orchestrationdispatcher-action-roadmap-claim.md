---
title: Formula — router · roadmap_claim
type: formula
formula_id: formula.adjusted.orchestrationdispatcher.action.roadmap_claim
...
| Field | Value |
|-------|-------|
| Name | `router · roadmap_claim` |
| Graph node | `formula.adjusted.orchestrationdispatcher.action.roadmap_claim` |
| Kind | dispatcher_router |
