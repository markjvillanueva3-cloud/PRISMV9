---
title: Formula — router · plating_recommend
type: formula
formula_id: formula.adjusted.calcdispatcher.action.plating_recommend
...
# Formula — `router · plating_recommend`
...
| Field | Value |
|-------|-------|
| Name | `router · plating_recommend` |
| Graph node | `formula.adjusted.calcdispatcher.action.plating_recommend` |
| Kind | dispatcher_router |
