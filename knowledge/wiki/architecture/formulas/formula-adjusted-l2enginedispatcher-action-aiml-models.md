---
title: Formula — router · aiml_models
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.aiml_models
...
| Field | Value |
|-------|-------|
| Name | `router · aiml_models` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.aiml_models` |
| Kind | dispatcher_router |
