---
title: Formula — router · tool_call_reset
type: formula
formula_id: formula.adjusted.devdispatcher.action.tool_call_reset
...
# Formula — `router · tool_call_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_call_reset` |
| Graph node | `formula.adjusted.devdispatcher.action.tool_call_reset` |
| Kind | dispatcher_router |
