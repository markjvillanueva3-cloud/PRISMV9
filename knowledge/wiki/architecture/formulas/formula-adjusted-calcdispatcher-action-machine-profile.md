---
title: Formula — router · machine_profile
type: formula
formula_id: formula.adjusted.calcdispatcher.action.machine_profile
...
# Formula — `router · machine_profile`
...
| Field | Value |
|-------|-------|
| Name | `router · machine_profile` |
| Graph node | `formula.adjusted.calcdispatcher.action.machine_profile` |
| Kind | dispatcher_router |
