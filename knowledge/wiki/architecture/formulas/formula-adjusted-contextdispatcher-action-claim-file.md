---
title: Formula — router · claim_file
type: formula
formula_id: formula.adjusted.contextdispatcher.action.claim_file
...
| Field | Value |
|-------|-------|
| Name | `router · claim_file` |
| Graph node | `formula.adjusted.contextdispatcher.action.claim_file` |
| Kind | dispatcher_router |
