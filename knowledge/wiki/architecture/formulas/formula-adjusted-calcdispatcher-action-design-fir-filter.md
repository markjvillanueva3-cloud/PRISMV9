---
title: Formula — router · design_fir_filter
type: formula
formula_id: formula.adjusted.calcdispatcher.action.design_fir_filter
...
# Formula — `router · design_fir_filter`
...
| Field | Value |
|-------|-------|
| Name | `router · design_fir_filter` |
| Graph node | `formula.adjusted.calcdispatcher.action.design_fir_filter` |
| Kind | dispatcher_router |
