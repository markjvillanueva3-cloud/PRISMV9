---
title: Formula — router · cam_recommend
type: formula
formula_id: formula.adjusted.integrationdispatcher.action.cam_recommend
...
| Field | Value |
|-------|-------|
| Name | `router · cam_recommend` |
| Graph node | `formula.adjusted.integrationdispatcher.action.cam_recommend` |
| Kind | dispatcher_router |
