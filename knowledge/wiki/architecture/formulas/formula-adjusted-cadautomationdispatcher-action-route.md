---
title: Formula — router · route
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.route
...
|-------|-------|
| Name | `router · route` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.route` |
| Kind | dispatcher_router |
