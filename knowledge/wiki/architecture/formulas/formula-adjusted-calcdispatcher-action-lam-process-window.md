---
title: Formula — router · lam_process_window
type: formula
formula_id: formula.adjusted.calcdispatcher.action.lam_process_window
...
# Formula — `router · lam_process_window`
...
| Field | Value |
|-------|-------|
| Name | `router · lam_process_window` |
| Graph node | `formula.adjusted.calcdispatcher.action.lam_process_window` |
| Kind | dispatcher_router |
