---
title: Formula — router · tool_roi_analysis
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_roi_analysis
...
# Formula — `router · tool_roi_analysis`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_roi_analysis` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_roi_analysis` |
| Kind | dispatcher_router |
