---
title: Formula — router · postValHardening
type: formula
formula_id: formula.adjusted.camdispatcher.action.postvalhardening
...
# Formula — `router · postValHardening`
...
| Field | Value |
|-------|-------|
| Name | `router · postValHardening` |
| Graph node | `formula.adjusted.camdispatcher.action.postvalhardening` |
| Kind | dispatcher_router |
