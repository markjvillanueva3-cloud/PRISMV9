---
title: Formula — router · jc_params
type: formula
formula_id: formula.adjusted.calcdispatcher.action.jc_params
...
| Field | Value |
|-------|-------|
| Name | `router · jc_params` |
| Graph node | `formula.adjusted.calcdispatcher.action.jc_params` |
| Kind | dispatcher_router |
