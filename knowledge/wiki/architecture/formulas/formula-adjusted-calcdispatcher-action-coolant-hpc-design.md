---
title: Formula — router · coolant_hpc_design
type: formula
formula_id: formula.adjusted.calcdispatcher.action.coolant_hpc_design
...
# Formula — `router · coolant_hpc_design`
...
| Field | Value |
|-------|-------|
| Name | `router · coolant_hpc_design` |
| Graph node | `formula.adjusted.calcdispatcher.action.coolant_hpc_design` |
| Kind | dispatcher_router |
