---
title: Formula — router · extrudeTapered
type: formula
formula_id: formula.adjusted.caddispatcher.action.extrudetapered
...
| Field | Value |
|-------|-------|
| Name | `router · extrudeTapered` |
| Graph node | `formula.adjusted.caddispatcher.action.extrudetapered` |
| Kind | dispatcher_router |
