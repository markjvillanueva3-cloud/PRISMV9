---
title: Formula — router · plating_allowance
type: formula
formula_id: formula.adjusted.calcdispatcher.action.plating_allowance
...
# Formula — `router · plating_allowance`
...
| Field | Value |
|-------|-------|
| Name | `router · plating_allowance` |
| Graph node | `formula.adjusted.calcdispatcher.action.plating_allowance` |
| Kind | dispatcher_router |
