---
title: Formula — router · dfmPipeline
type: formula
formula_id: formula.adjusted.caddispatcher.action.dfmpipeline
...
| Field | Value |
|-------|-------|
| Name | `router · dfmPipeline` |
| Graph node | `formula.adjusted.caddispatcher.action.dfmpipeline` |
| Kind | dispatcher_router |
