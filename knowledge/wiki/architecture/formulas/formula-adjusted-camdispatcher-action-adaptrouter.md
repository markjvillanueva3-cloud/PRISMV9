---
title: Formula — router · adaptRouter
type: formula
formula_id: formula.adjusted.camdispatcher.action.adaptrouter
...
| Field | Value |
|-------|-------|
| Name | `router · adaptRouter` |
| Graph node | `formula.adjusted.camdispatcher.action.adaptrouter` |
| Kind | dispatcher_router |
