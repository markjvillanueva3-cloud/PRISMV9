---
title: Formula — router · rel_cox_hazards
type: formula
formula_id: formula.adjusted.camdispatcher.action.rel_cox_hazards
...
# Formula — `router · rel_cox_hazards`
...
| Field | Value |
|-------|-------|
| Name | `router · rel_cox_hazards` |
| Graph node | `formula.adjusted.camdispatcher.action.rel_cox_hazards` |
| Kind | dispatcher_router |
