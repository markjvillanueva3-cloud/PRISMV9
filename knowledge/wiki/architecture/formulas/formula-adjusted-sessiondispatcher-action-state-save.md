---
title: Formula — router · state_save
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.state_save
...
| Field | Value |
|-------|-------|
| Name | `router · state_save` |
| Graph node | `formula.adjusted.sessiondispatcher.action.state_save` |
| Kind | dispatcher_router |
