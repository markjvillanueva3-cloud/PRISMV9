---
title: Formula — router · iso13399_import
type: formula
formula_id: formula.adjusted.camdispatcher.action.iso13399_import
...
# Formula — `router · iso13399_import`
...
| Field | Value |
|-------|-------|
| Name | `router · iso13399_import` |
| Graph node | `formula.adjusted.camdispatcher.action.iso13399_import` |
| Kind | dispatcher_router |
