---
title: Formula — router · xproc_raps_set
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.xproc_raps_set
...
| Field | Value |
|-------|-------|
| Name | `router · xproc_raps_set` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.xproc_raps_set` |
| Kind | dispatcher_router |
