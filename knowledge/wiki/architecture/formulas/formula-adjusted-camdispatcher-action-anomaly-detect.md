---
title: Formula — router · anomaly_detect
type: formula
formula_id: formula.adjusted.camdispatcher.action.anomaly_detect
...
| Field | Value |
|-------|-------|
| Name | `router · anomaly_detect` |
| Graph node | `formula.adjusted.camdispatcher.action.anomaly_detect` |
| Kind | dispatcher_router |
