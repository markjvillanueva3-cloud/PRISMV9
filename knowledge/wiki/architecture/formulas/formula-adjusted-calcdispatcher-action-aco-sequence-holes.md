---
title: Formula — router · aco_sequence_holes
type: formula
formula_id: formula.adjusted.calcdispatcher.action.aco_sequence_holes
...
# Formula — `router · aco_sequence_holes`
...
| Field | Value |
|-------|-------|
| Name | `router · aco_sequence_holes` |
| Graph node | `formula.adjusted.calcdispatcher.action.aco_sequence_holes` |
| Kind | dispatcher_router |
