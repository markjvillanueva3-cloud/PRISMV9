---
title: Formula — router · auto_fix_promote
type: formula
formula_id: formula.adjusted.devdispatcher.action.auto_fix_promote
...
# Formula — `router · auto_fix_promote`
...
| Field | Value |
|-------|-------|
| Name | `router · auto_fix_promote` |
| Graph node | `formula.adjusted.devdispatcher.action.auto_fix_promote` |
| Kind | dispatcher_router |
