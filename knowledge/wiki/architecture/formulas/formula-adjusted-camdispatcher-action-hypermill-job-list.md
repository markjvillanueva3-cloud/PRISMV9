---
title: Formula — router · hypermill_job_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.hypermill_job_list
...
# Formula — `router · hypermill_job_list`
...
| Field | Value |
|-------|-------|
| Name | `router · hypermill_job_list` |
| Graph node | `formula.adjusted.camdispatcher.action.hypermill_job_list` |
| Kind | dispatcher_router |
