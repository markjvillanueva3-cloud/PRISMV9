---
title: Formula — router · ceramics_fracture
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ceramics_fracture
...
# Formula — `router · ceramics_fracture`
...
| Field | Value |
|-------|-------|
| Name | `router · ceramics_fracture` |
| Graph node | `formula.adjusted.calcdispatcher.action.ceramics_fracture` |
| Kind | dispatcher_router |
