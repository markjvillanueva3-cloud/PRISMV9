---
title: Formula — router · ewcMemory
type: formula
formula_id: formula.adjusted.edmdispatcher.action.ewcmemory
...
| Field | Value |
|-------|-------|
| Name | `router · ewcMemory` |
| Graph node | `formula.adjusted.edmdispatcher.action.ewcmemory` |
| Kind | dispatcher_router |
