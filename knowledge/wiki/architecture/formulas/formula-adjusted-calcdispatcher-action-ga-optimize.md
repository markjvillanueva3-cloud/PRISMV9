---
title: Formula — router · ga_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ga_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · ga_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.ga_optimize` |
| Kind | dispatcher_router |
