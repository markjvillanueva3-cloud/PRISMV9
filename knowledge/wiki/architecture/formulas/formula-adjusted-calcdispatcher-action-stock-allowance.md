---
title: Formula — router · stock_allowance
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stock_allowance
...
# Formula — `router · stock_allowance`
...
| Field | Value |
|-------|-------|
| Name | `router · stock_allowance` |
| Graph node | `formula.adjusted.calcdispatcher.action.stock_allowance` |
| Kind | dispatcher_router |
