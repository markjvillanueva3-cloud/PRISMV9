---
title: Formula — router · swGen
type: formula
formula_id: formula.adjusted.caddispatcher.action.swgen
...
|-------|-------|
| Name | `router · swGen` |
| Graph node | `formula.adjusted.caddispatcher.action.swgen` |
| Kind | dispatcher_router |
