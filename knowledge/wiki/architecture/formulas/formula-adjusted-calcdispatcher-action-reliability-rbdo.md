---
title: Formula — router · reliability_rbdo
type: formula
formula_id: formula.adjusted.calcdispatcher.action.reliability_rbdo
...
# Formula — `router · reliability_rbdo`
...
| Field | Value |
|-------|-------|
| Name | `router · reliability_rbdo` |
| Graph node | `formula.adjusted.calcdispatcher.action.reliability_rbdo` |
| Kind | dispatcher_router |
