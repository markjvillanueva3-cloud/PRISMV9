---
title: Formula — router · xai_lime
type: formula
formula_id: formula.adjusted.calcdispatcher.action.xai_lime
...
| Field | Value |
|-------|-------|
| Name | `router · xai_lime` |
| Graph node | `formula.adjusted.calcdispatcher.action.xai_lime` |
| Kind | dispatcher_router |
