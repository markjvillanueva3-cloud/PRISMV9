---
title: Formula — router · pp_mpg_safety
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_mpg_safety
...
| Field | Value |
|-------|-------|
| Name | `router · pp_mpg_safety` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_mpg_safety` |
| Kind | dispatcher_router |
