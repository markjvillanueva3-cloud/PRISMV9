---
title: Formula — router · cam_ext_search
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_ext_search
...
| Field | Value |
|-------|-------|
| Name | `router · cam_ext_search` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_ext_search` |
| Kind | dispatcher_router |
