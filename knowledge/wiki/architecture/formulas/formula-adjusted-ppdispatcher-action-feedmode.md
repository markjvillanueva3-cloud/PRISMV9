---
title: Formula — router · feedMode
type: formula
formula_id: formula.adjusted.ppdispatcher.action.feedmode
...
| Field | Value |
|-------|-------|
| Name | `router · feedMode` |
| Graph node | `formula.adjusted.ppdispatcher.action.feedmode` |
| Kind | dispatcher_router |
