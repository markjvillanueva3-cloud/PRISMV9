---
title: Formula — router · session_cleanup
type: formula
formula_id: formula.adjusted.securitydispatcher.action.session_cleanup
...
# Formula — `router · session_cleanup`
...
| Field | Value |
|-------|-------|
| Name | `router · session_cleanup` |
| Graph node | `formula.adjusted.securitydispatcher.action.session_cleanup` |
| Kind | dispatcher_router |
