---
title: Formula — router · wedm_graph_query
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_graph_query
...
# Formula — `router · wedm_graph_query`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_graph_query` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_graph_query` |
| Kind | dispatcher_router |
