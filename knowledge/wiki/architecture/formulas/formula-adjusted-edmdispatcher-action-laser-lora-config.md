---
title: Formula — router · laser_lora_config
type: formula
formula_id: formula.adjusted.edmdispatcher.action.laser_lora_config
...
# Formula — `router · laser_lora_config`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_lora_config` |
| Graph node | `formula.adjusted.edmdispatcher.action.laser_lora_config` |
| Kind | dispatcher_router |
