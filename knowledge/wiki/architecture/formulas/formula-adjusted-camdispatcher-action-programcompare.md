---
title: Formula — router · programCompare
type: formula
formula_id: formula.adjusted.camdispatcher.action.programcompare
...
| Field | Value |
|-------|-------|
| Name | `router · programCompare` |
| Graph node | `formula.adjusted.camdispatcher.action.programcompare` |
| Kind | dispatcher_router |
