---
title: Formula — router · vacuumCast
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.vacuumcast
...
| Field | Value |
|-------|-------|
| Name | `router · vacuumCast` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.vacuumcast` |
| Kind | dispatcher_router |
