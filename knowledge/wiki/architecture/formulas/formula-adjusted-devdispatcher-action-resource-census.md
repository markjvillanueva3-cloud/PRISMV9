---
title: Formula — router · resource_census
type: formula
formula_id: formula.adjusted.devdispatcher.action.resource_census
...
# Formula — `router · resource_census`
...
| Field | Value |
|-------|-------|
| Name | `router · resource_census` |
| Graph node | `formula.adjusted.devdispatcher.action.resource_census` |
| Kind | dispatcher_router |
