---
title: Formula — router · thermal_optimize
type: formula
formula_id: formula.adjusted.camdispatcher.action.thermal_optimize
...
# Formula — `router · thermal_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_optimize` |
| Graph node | `formula.adjusted.camdispatcher.action.thermal_optimize` |
| Kind | dispatcher_router |
