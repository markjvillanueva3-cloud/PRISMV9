---
title: Formula — router · fleet_insights
type: formula
formula_id: formula.adjusted.camdispatcher.action.fleet_insights
...
| Field | Value |
|-------|-------|
| Name | `router · fleet_insights` |
| Graph node | `formula.adjusted.camdispatcher.action.fleet_insights` |
| Kind | dispatcher_router |
