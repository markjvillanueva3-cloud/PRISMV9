---
title: Formula — router · nxcam_fbm_get_op
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcam_fbm_get_op
...
# Formula — `router · nxcam_fbm_get_op`
...
| Field | Value |
|-------|-------|
| Name | `router · nxcam_fbm_get_op` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcam_fbm_get_op` |
| Kind | dispatcher_router |
