---
title: Formula — router · icc_export
type: formula
formula_id: formula.adjusted.devdispatcher.action.icc_export
...
| Field | Value |
|-------|-------|
| Name | `router · icc_export` |
| Graph node | `formula.adjusted.devdispatcher.action.icc_export` |
| Kind | dispatcher_router |
