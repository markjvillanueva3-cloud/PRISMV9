---
title: Formula — router · masking_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.masking_calc
...
| Field | Value |
|-------|-------|
| Name | `router · masking_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.masking_calc` |
| Kind | dispatcher_router |
