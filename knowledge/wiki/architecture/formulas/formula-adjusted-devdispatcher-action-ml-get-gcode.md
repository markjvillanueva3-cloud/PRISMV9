---
title: Formula — router · ml_get_gcode
type: formula
formula_id: formula.adjusted.devdispatcher.action.ml_get_gcode
...
| Field | Value |
|-------|-------|
| Name | `router · ml_get_gcode` |
| Graph node | `formula.adjusted.devdispatcher.action.ml_get_gcode` |
| Kind | dispatcher_router |
