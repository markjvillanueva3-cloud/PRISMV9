---
title: Formula — router · feedback_query
type: formula
formula_id: formula.adjusted.devdispatcher.action.feedback_query
...
| Field | Value |
|-------|-------|
| Name | `router · feedback_query` |
| Graph node | `formula.adjusted.devdispatcher.action.feedback_query` |
| Kind | dispatcher_router |
