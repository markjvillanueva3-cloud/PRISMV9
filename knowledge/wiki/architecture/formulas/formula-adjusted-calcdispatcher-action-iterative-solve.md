---
title: Formula — router · iterative_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.iterative_solve
...
# Formula — `router · iterative_solve`
...
| Field | Value |
|-------|-------|
| Name | `router · iterative_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.iterative_solve` |
| Kind | dispatcher_router |
