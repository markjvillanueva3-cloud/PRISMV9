---
title: Formula — router · cam_analyze_op
type: formula
formula_id: formula.adjusted.integrationdispatcher.action.cam_analyze_op
...
| Field | Value |
|-------|-------|
| Name | `router · cam_analyze_op` |
| Graph node | `formula.adjusted.integrationdispatcher.action.cam_analyze_op` |
| Kind | dispatcher_router |
