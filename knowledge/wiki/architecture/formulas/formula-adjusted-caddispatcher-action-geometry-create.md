---
title: Formula — router · geometry_create
type: formula
formula_id: formula.adjusted.caddispatcher.action.geometry_create
...
# Formula — `router · geometry_create`
...
| Field | Value |
|-------|-------|
| Name | `router · geometry_create` |
| Graph node | `formula.adjusted.caddispatcher.action.geometry_create` |
| Kind | dispatcher_router |
