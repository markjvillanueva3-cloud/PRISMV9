---
title: Formula — router · counterbore
type: formula
formula_id: formula.adjusted.camdispatcher.action.counterbore
...
| Field | Value |
|-------|-------|
| Name | `router · counterbore` |
| Graph node | `formula.adjusted.camdispatcher.action.counterbore` |
| Kind | dispatcher_router |
