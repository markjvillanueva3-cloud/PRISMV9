---
title: Formula — router · test_generate_read
type: formula
formula_id: formula.adjusted.devdispatcher.action.test_generate_read
...
# Formula — `router · test_generate_read`
...
| Field | Value |
|-------|-------|
| Name | `router · test_generate_read` |
| Graph node | `formula.adjusted.devdispatcher.action.test_generate_read` |
| Kind | dispatcher_router |
