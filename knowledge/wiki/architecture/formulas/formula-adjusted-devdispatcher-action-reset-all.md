---
title: Formula — router · reset_all
type: formula
formula_id: formula.adjusted.devdispatcher.action.reset_all
...
| Field | Value |
|-------|-------|
| Name | `router · reset_all` |
| Graph node | `formula.adjusted.devdispatcher.action.reset_all` |
| Kind | dispatcher_router |
