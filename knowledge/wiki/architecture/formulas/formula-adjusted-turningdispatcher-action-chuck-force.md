---
title: Formula — router · chuck_force
type: formula
formula_id: formula.adjusted.turningdispatcher.action.chuck_force
...
| Field | Value |
|-------|-------|
| Name | `router · chuck_force` |
| Graph node | `formula.adjusted.turningdispatcher.action.chuck_force` |
| Kind | dispatcher_router |
