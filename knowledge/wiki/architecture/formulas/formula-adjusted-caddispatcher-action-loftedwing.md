---
title: Formula — router · loftedWing
type: formula
formula_id: formula.adjusted.caddispatcher.action.loftedwing
...
| Field | Value |
|-------|-------|
| Name | `router · loftedWing` |
| Graph node | `formula.adjusted.caddispatcher.action.loftedwing` |
| Kind | dispatcher_router |
