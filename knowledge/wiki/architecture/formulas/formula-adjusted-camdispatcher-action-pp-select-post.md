---
title: Formula — router · pp_select_post
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_select_post
...
| Field | Value |
|-------|-------|
| Name | `router · pp_select_post` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_select_post` |
| Kind | dispatcher_router |
