---
title: Formula — router · role_assign
type: formula
formula_id: formula.adjusted.authdispatcher.action.role_assign
...
| Field | Value |
|-------|-------|
| Name | `router · role_assign` |
| Graph node | `formula.adjusted.authdispatcher.action.role_assign` |
| Kind | dispatcher_router |
