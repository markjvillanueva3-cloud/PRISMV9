---
title: Formula — router · honing_design
type: formula
formula_id: formula.adjusted.calcdispatcher.action.honing_design
...
| Field | Value |
|-------|-------|
| Name | `router · honing_design` |
| Graph node | `formula.adjusted.calcdispatcher.action.honing_design` |
| Kind | dispatcher_router |
