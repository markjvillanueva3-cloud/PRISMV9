---
title: Formula — router · postPipeline
type: formula
formula_id: formula.adjusted.camdispatcher.action.postpipeline
...
| Field | Value |
|-------|-------|
| Name | `router · postPipeline` |
| Graph node | `formula.adjusted.camdispatcher.action.postpipeline` |
| Kind | dispatcher_router |
