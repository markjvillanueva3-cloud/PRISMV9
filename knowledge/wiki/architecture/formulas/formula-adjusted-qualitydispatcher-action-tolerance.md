---
title: Formula — router · tolerance
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.tolerance
...
| Field | Value |
|-------|-------|
| Name | `router · tolerance` |
| Graph node | `formula.adjusted.qualitydispatcher.action.tolerance` |
| Kind | dispatcher_router |
