---
title: Formula — router · bash_classify
type: formula
formula_id: formula.adjusted.devdispatcher.action.bash_classify
...
| Field | Value |
|-------|-------|
| Name | `router · bash_classify` |
| Graph node | `formula.adjusted.devdispatcher.action.bash_classify` |
| Kind | dispatcher_router |
