---
title: Formula — router · cam_esprit_connect
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_esprit_connect
...
# Formula — `router · cam_esprit_connect`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_esprit_connect` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_esprit_connect` |
| Kind | dispatcher_router |
