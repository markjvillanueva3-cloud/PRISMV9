---
title: Formula — router · nxcamMillingIndex
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcammillingindex
...
# Formula — `router · nxcamMillingIndex`
...
| Field | Value |
|-------|-------|
| Name | `router · nxcamMillingIndex` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcammillingindex` |
| Kind | dispatcher_router |
