---
title: Formula — router · cad_thumb_list
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_thumb_list
...
| Field | Value |
|-------|-------|
| Name | `router · cad_thumb_list` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_thumb_list` |
| Kind | dispatcher_router |
