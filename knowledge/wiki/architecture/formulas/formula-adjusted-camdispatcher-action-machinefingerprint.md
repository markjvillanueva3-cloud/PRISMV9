---
title: Formula — router · machineFingerprint
type: formula
formula_id: formula.adjusted.camdispatcher.action.machinefingerprint
...
# Formula — `router · machineFingerprint`
...
| Field | Value |
|-------|-------|
| Name | `router · machineFingerprint` |
| Graph node | `formula.adjusted.camdispatcher.action.machinefingerprint` |
| Kind | dispatcher_router |
