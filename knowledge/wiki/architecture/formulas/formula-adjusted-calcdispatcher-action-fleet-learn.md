---
title: Formula — router · fleet_learn
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fleet_learn
...
| Field | Value |
|-------|-------|
| Name | `router · fleet_learn` |
| Graph node | `formula.adjusted.calcdispatcher.action.fleet_learn` |
| Kind | dispatcher_router |
