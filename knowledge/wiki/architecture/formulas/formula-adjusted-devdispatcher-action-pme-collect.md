---
title: Formula — router · pme_collect
type: formula
formula_id: formula.adjusted.devdispatcher.action.pme_collect
...
| Field | Value |
|-------|-------|
| Name | `router · pme_collect` |
| Graph node | `formula.adjusted.devdispatcher.action.pme_collect` |
| Kind | dispatcher_router |
