---
title: Formula — router · face_mill_select
type: formula
formula_id: formula.adjusted.caddispatcher.action.face_mill_select
...
# Formula — `router · face_mill_select`
...
| Field | Value |
|-------|-------|
| Name | `router · face_mill_select` |
| Graph node | `formula.adjusted.caddispatcher.action.face_mill_select` |
| Kind | dispatcher_router |
