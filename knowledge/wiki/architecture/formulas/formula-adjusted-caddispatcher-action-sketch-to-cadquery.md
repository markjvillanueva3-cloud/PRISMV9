---
title: Formula — router · sketch_to_cadquery
type: formula
formula_id: formula.adjusted.caddispatcher.action.sketch_to_cadquery
...
# Formula — `router · sketch_to_cadquery`
...
| Field | Value |
|-------|-------|
| Name | `router · sketch_to_cadquery` |
| Graph node | `formula.adjusted.caddispatcher.action.sketch_to_cadquery` |
| Kind | dispatcher_router |
