---
title: Formula — router · inference_chain
type: formula
formula_id: formula.adjusted.calcdispatcher.action.inference_chain
...
# Formula — `router · inference_chain`
...
| Field | Value |
|-------|-------|
| Name | `router · inference_chain` |
| Graph node | `formula.adjusted.calcdispatcher.action.inference_chain` |
| Kind | dispatcher_router |
