---
title: Formula — router · acc_volumetric
type: formula
formula_id: formula.adjusted.camdispatcher.action.acc_volumetric
...
| Field | Value |
|-------|-------|
| Name | `router · acc_volumetric` |
| Graph node | `formula.adjusted.camdispatcher.action.acc_volumetric` |
| Kind | dispatcher_router |
