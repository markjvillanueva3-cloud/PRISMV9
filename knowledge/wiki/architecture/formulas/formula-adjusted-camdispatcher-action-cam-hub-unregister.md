---
title: Formula — router · cam_hub_unregister
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_hub_unregister
...
# Formula — `router · cam_hub_unregister`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_hub_unregister` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_hub_unregister` |
| Kind | dispatcher_router |
