---
title: Formula — router · edm_micro_program
type: formula
formula_id: formula.adjusted.camdispatcher.action.edm_micro_program
...
# Formula — `router · edm_micro_program`
...
| Field | Value |
|-------|-------|
| Name | `router · edm_micro_program` |
| Graph node | `formula.adjusted.camdispatcher.action.edm_micro_program` |
| Kind | dispatcher_router |
