---
title: Formula — router · get_geometry
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.get_geometry
...
| Field | Value |
|-------|-------|
| Name | `router · get_geometry` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.get_geometry` |
| Kind | dispatcher_router |
