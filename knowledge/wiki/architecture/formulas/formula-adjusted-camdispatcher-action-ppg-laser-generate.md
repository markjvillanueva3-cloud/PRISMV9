---
title: Formula — router · ppg_laser_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_laser_generate
...
# Formula — `router · ppg_laser_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_laser_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_laser_generate` |
| Kind | dispatcher_router |
