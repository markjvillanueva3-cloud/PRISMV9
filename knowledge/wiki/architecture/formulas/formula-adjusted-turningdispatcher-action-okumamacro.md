---
title: Formula — router · okumaMacro
type: formula
formula_id: formula.adjusted.turningdispatcher.action.okumamacro
...
| Field | Value |
|-------|-------|
| Name | `router · okumaMacro` |
| Graph node | `formula.adjusted.turningdispatcher.action.okumamacro` |
| Kind | dispatcher_router |
