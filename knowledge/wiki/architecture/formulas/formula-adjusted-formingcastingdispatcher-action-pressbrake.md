---
title: Formula — router · pressBrake
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.pressbrake
...
| Field | Value |
|-------|-------|
| Name | `router · pressBrake` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.pressbrake` |
| Kind | dispatcher_router |
