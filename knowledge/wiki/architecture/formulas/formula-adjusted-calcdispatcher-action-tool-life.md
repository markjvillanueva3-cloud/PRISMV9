---
title: Formula — router · tool_life
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_life
...
| Field | Value |
|-------|-------|
| Name | `router · tool_life` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_life` |
| Kind | dispatcher_router |
