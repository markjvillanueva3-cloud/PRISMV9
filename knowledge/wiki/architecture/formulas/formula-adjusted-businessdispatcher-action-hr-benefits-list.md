---
title: Formula — router · hr_benefits_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_benefits_list
...
# Formula — `router · hr_benefits_list`
...
| Field | Value |
|-------|-------|
| Name | `router · hr_benefits_list` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_benefits_list` |
| Kind | dispatcher_router |
