---
title: Formula — router · cam_hub_route
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_hub_route
...
| Field | Value |
|-------|-------|
| Name | `router · cam_hub_route` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_hub_route` |
| Kind | dispatcher_router |
