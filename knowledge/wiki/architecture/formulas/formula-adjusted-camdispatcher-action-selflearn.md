---
title: Formula — router · selfLearn
type: formula
formula_id: formula.adjusted.camdispatcher.action.selflearn
...
| Field | Value |
|-------|-------|
| Name | `router · selfLearn` |
| Graph node | `formula.adjusted.camdispatcher.action.selflearn` |
| Kind | dispatcher_router |
