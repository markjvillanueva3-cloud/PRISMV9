---
title: Formula — router · probe_report
type: formula
formula_id: formula.adjusted.calcdispatcher.action.probe_report
...
| Field | Value |
|-------|-------|
| Name | `router · probe_report` |
| Graph node | `formula.adjusted.calcdispatcher.action.probe_report` |
| Kind | dispatcher_router |
