---
title: Formula — router · cam_deep_systems
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_deep_systems
...
# Formula — `router · cam_deep_systems`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_deep_systems` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_deep_systems` |
| Kind | dispatcher_router |
