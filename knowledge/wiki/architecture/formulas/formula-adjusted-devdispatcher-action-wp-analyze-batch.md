---
title: Formula — router · wp_analyze_batch
type: formula
formula_id: formula.adjusted.devdispatcher.action.wp_analyze_batch
...
# Formula — `router · wp_analyze_batch`
...
| Field | Value |
|-------|-------|
| Name | `router · wp_analyze_batch` |
| Graph node | `formula.adjusted.devdispatcher.action.wp_analyze_batch` |
| Kind | dispatcher_router |
