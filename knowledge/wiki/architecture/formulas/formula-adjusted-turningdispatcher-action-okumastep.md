---
title: Formula — router · okumaStep
type: formula
formula_id: formula.adjusted.turningdispatcher.action.okumastep
...
| Field | Value |
|-------|-------|
| Name | `router · okumaStep` |
| Graph node | `formula.adjusted.turningdispatcher.action.okumastep` |
| Kind | dispatcher_router |
