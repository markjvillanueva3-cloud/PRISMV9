---
title: Formula — router · token_budget
type: formula
formula_id: formula.adjusted.devdispatcher.action.token_budget
...
| Field | Value |
|-------|-------|
| Name | `router · token_budget` |
| Graph node | `formula.adjusted.devdispatcher.action.token_budget` |
| Kind | dispatcher_router |
