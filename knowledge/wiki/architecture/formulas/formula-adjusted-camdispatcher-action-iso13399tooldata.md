---
title: Formula — router · iso13399ToolData
type: formula
formula_id: formula.adjusted.camdispatcher.action.iso13399tooldata
...
# Formula — `router · iso13399ToolData`
...
| Field | Value |
|-------|-------|
| Name | `router · iso13399ToolData` |
| Graph node | `formula.adjusted.camdispatcher.action.iso13399tooldata` |
| Kind | dispatcher_router |
