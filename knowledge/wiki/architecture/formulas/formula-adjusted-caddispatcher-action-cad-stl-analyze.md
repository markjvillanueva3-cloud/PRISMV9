---
title: Formula — router · cad_stl_analyze
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_stl_analyze
...
# Formula — `router · cad_stl_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_stl_analyze` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_stl_analyze` |
| Kind | dispatcher_router |
