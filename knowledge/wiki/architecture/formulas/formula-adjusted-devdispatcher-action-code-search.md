---
title: Formula — router · code_search
type: formula
formula_id: formula.adjusted.devdispatcher.action.code_search
...
| Field | Value |
|-------|-------|
| Name | `router · code_search` |
| Graph node | `formula.adjusted.devdispatcher.action.code_search` |
| Kind | dispatcher_router |
