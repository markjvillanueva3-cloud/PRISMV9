---
title: Formula — router · laser_weld_program
type: formula
formula_id: formula.adjusted.camdispatcher.action.laser_weld_program
...
# Formula — `router · laser_weld_program`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_weld_program` |
| Graph node | `formula.adjusted.camdispatcher.action.laser_weld_program` |
| Kind | dispatcher_router |
