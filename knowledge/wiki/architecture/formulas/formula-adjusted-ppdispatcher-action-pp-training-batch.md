---
title: Formula — router · pp_training_batch
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_training_batch
...
# Formula — `router · pp_training_batch`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_training_batch` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_training_batch` |
| Kind | dispatcher_router |
