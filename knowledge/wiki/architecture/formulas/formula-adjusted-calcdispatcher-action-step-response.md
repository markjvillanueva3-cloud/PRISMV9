---
title: Formula — router · step_response
type: formula
formula_id: formula.adjusted.calcdispatcher.action.step_response
...
| Field | Value |
|-------|-------|
| Name | `router · step_response` |
| Graph node | `formula.adjusted.calcdispatcher.action.step_response` |
| Kind | dispatcher_router |
