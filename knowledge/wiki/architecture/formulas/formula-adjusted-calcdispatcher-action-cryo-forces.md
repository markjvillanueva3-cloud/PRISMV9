---
title: Formula — router · cryo_forces
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cryo_forces
...
| Field | Value |
|-------|-------|
| Name | `router · cryo_forces` |
| Graph node | `formula.adjusted.calcdispatcher.action.cryo_forces` |
| Kind | dispatcher_router |
