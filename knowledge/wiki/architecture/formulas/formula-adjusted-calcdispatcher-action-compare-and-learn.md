---
title: Formula — router · compare_and_learn
type: formula
formula_id: formula.adjusted.calcdispatcher.action.compare_and_learn
...
# Formula — `router · compare_and_learn`
...
| Field | Value |
|-------|-------|
| Name | `router · compare_and_learn` |
| Graph node | `formula.adjusted.calcdispatcher.action.compare_and_learn` |
| Kind | dispatcher_router |
