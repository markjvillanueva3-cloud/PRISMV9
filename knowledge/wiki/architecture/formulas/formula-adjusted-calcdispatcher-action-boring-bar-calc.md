---
title: Formula — router · boring_bar_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.boring_bar_calc
...
# Formula — `router · boring_bar_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · boring_bar_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.boring_bar_calc` |
| Kind | dispatcher_router |
