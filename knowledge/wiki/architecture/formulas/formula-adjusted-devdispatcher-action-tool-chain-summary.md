---
title: Formula — router · tool_chain_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.tool_chain_summary
...
# Formula — `router · tool_chain_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_chain_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.tool_chain_summary` |
| Kind | dispatcher_router |
