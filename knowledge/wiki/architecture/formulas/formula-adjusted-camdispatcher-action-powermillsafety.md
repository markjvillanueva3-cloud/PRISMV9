---
title: Formula — router · powerMillSafety
type: formula
formula_id: formula.adjusted.camdispatcher.action.powermillsafety
...
# Formula — `router · powerMillSafety`
...
| Field | Value |
|-------|-------|
| Name | `router · powerMillSafety` |
| Graph node | `formula.adjusted.camdispatcher.action.powermillsafety` |
| Kind | dispatcher_router |
