---
title: Formula — router · otel_get_config
type: formula
formula_id: formula.adjusted.devdispatcher.action.otel_get_config
...
# Formula — `router · otel_get_config`
...
| Field | Value |
|-------|-------|
| Name | `router · otel_get_config` |
| Graph node | `formula.adjusted.devdispatcher.action.otel_get_config` |
| Kind | dispatcher_router |
