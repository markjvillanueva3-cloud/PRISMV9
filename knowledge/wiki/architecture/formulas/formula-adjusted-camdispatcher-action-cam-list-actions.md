---
title: Formula — router · cam_list_actions
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_list_actions
...
# Formula — `router · cam_list_actions`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_list_actions` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_list_actions` |
| Kind | dispatcher_router |
