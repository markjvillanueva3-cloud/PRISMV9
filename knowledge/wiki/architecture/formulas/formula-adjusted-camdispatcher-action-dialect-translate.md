---
title: Formula — router · dialect_translate
type: formula
formula_id: formula.adjusted.camdispatcher.action.dialect_translate
...
# Formula — `router · dialect_translate`
...
| Field | Value |
|-------|-------|
| Name | `router · dialect_translate` |
| Graph node | `formula.adjusted.camdispatcher.action.dialect_translate` |
| Kind | dispatcher_router |
