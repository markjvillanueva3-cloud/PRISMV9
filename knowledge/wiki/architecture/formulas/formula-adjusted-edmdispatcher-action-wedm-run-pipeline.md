---
title: Formula — router · wedm_run_pipeline
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_run_pipeline
...
# Formula — `router · wedm_run_pipeline`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_run_pipeline` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_run_pipeline` |
| Kind | dispatcher_router |
