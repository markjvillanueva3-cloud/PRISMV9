---
title: Formula — router · turning_profile_od
type: formula
formula_id: formula.adjusted.camdispatcher.action.turning_profile_od
...
# Formula — `router · turning_profile_od`
...
| Field | Value |
|-------|-------|
| Name | `router · turning_profile_od` |
| Graph node | `formula.adjusted.camdispatcher.action.turning_profile_od` |
| Kind | dispatcher_router |
