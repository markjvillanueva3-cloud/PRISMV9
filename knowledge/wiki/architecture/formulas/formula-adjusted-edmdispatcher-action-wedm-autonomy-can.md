---
title: Formula — router · wedm_autonomy_can
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_autonomy_can
...
# Formula — `router · wedm_autonomy_can`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_autonomy_can` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_autonomy_can` |
| Kind | dispatcher_router |
