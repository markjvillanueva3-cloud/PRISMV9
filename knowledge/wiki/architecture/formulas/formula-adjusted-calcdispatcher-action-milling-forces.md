---
title: Formula — router · milling_forces
type: formula
formula_id: formula.adjusted.calcdispatcher.action.milling_forces
...
| Field | Value |
|-------|-------|
| Name | `router · milling_forces` |
| Graph node | `formula.adjusted.calcdispatcher.action.milling_forces` |
| Kind | dispatcher_router |
