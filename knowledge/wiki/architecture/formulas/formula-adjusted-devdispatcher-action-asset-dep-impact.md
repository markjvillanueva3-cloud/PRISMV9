---
title: Formula — router · asset_dep_impact
type: formula
formula_id: formula.adjusted.devdispatcher.action.asset_dep_impact
...
# Formula — `router · asset_dep_impact`
...
| Field | Value |
|-------|-------|
| Name | `router · asset_dep_impact` |
| Graph node | `formula.adjusted.devdispatcher.action.asset_dep_impact` |
| Kind | dispatcher_router |
