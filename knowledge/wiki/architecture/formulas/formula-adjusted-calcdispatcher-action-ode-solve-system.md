---
title: Formula — router · ode_solve_system
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ode_solve_system
...
# Formula — `router · ode_solve_system`
...
| Field | Value |
|-------|-------|
| Name | `router · ode_solve_system` |
| Graph node | `formula.adjusted.calcdispatcher.action.ode_solve_system` |
| Kind | dispatcher_router |
