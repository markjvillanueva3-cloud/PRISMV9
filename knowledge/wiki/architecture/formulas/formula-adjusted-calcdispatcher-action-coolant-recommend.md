---
title: Formula — router · coolant_recommend
type: formula
formula_id: formula.adjusted.calcdispatcher.action.coolant_recommend
...
# Formula — `router · coolant_recommend`
...
| Field | Value |
|-------|-------|
| Name | `router · coolant_recommend` |
| Graph node | `formula.adjusted.calcdispatcher.action.coolant_recommend` |
| Kind | dispatcher_router |
