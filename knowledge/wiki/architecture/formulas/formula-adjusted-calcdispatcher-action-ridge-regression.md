---
title: Formula — router · ridge_regression
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ridge_regression
...
# Formula — `router · ridge_regression`
...
| Field | Value |
|-------|-------|
| Name | `router · ridge_regression` |
| Graph node | `formula.adjusted.calcdispatcher.action.ridge_regression` |
| Kind | dispatcher_router |
