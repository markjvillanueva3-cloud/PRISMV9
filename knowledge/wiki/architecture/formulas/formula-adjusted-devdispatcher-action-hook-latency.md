---
title: Formula — router · hook_latency
type: formula
formula_id: formula.adjusted.devdispatcher.action.hook_latency
...
| Field | Value |
|-------|-------|
| Name | `router · hook_latency` |
| Graph node | `formula.adjusted.devdispatcher.action.hook_latency` |
| Kind | dispatcher_router |
