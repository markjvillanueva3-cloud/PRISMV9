---
title: Formula — router · failure_mode_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.failure_mode_get
...
# Formula — `router · failure_mode_get`
...
| Field | Value |
|-------|-------|
| Name | `router · failure_mode_get` |
| Graph node | `formula.adjusted.devdispatcher.action.failure_mode_get` |
| Kind | dispatcher_router |
