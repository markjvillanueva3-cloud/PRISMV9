---
title: Formula — router · doc_render
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.doc_render
...
| Field | Value |
|-------|-------|
| Name | `router · doc_render` |
| Graph node | `formula.adjusted.sessiondispatcher.action.doc_render` |
| Kind | dispatcher_router |
