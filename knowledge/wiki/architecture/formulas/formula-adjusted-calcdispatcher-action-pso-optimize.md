---
title: Formula — router · pso_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.pso_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · pso_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.pso_optimize` |
| Kind | dispatcher_router |
