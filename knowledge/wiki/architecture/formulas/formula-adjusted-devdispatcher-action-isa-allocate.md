---
title: Formula — router · isa_allocate
type: formula
formula_id: formula.adjusted.devdispatcher.action.isa_allocate
...
| Field | Value |
|-------|-------|
| Name | `router · isa_allocate` |
| Graph node | `formula.adjusted.devdispatcher.action.isa_allocate` |
| Kind | dispatcher_router |
