---
title: Formula — router · catiaStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.catiastrategy
...
| Field | Value |
|-------|-------|
| Name | `router · catiaStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.catiastrategy` |
| Kind | dispatcher_router |
