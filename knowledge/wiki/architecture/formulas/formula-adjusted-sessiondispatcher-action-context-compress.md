---
title: Formula — router · context_compress
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.context_compress
...
# Formula — `router · context_compress`
...
| Field | Value |
|-------|-------|
| Name | `router · context_compress` |
| Graph node | `formula.adjusted.sessiondispatcher.action.context_compress` |
| Kind | dispatcher_router |
