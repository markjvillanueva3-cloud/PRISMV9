---
title: Formula — router · cam_ai_validate
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_ai_validate
...
# Formula — `router · cam_ai_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_ai_validate` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_ai_validate` |
| Kind | dispatcher_router |
