---
title: Formula — router · safety_gate_open
type: formula
formula_id: formula.adjusted.guarddispatcher.action.safety_gate_open
...
# Formula — `router · safety_gate_open`
...
| Field | Value |
|-------|-------|
| Name | `router · safety_gate_open` |
| Graph node | `formula.adjusted.guarddispatcher.action.safety_gate_open` |
| Kind | dispatcher_router |
