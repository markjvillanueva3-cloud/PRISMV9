---
title: Formula — router · thin_wall_support
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thin_wall_support
...
# Formula — `router · thin_wall_support`
...
| Field | Value |
|-------|-------|
| Name | `router · thin_wall_support` |
| Graph node | `formula.adjusted.calcdispatcher.action.thin_wall_support` |
| Kind | dispatcher_router |
