---
title: Formula — router · dfm_suggest
type: formula
formula_id: formula.adjusted.camdispatcher.action.dfm_suggest
...
| Field | Value |
|-------|-------|
| Name | `router · dfm_suggest` |
| Graph node | `formula.adjusted.camdispatcher.action.dfm_suggest` |
| Kind | dispatcher_router |
