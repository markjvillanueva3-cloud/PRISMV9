---
title: Formula — router · ttro_run
type: formula
formula_id: formula.adjusted.devdispatcher.action.ttro_run
...
| Field | Value |
|-------|-------|
| Name | `router · ttro_run` |
| Graph node | `formula.adjusted.devdispatcher.action.ttro_run` |
| Kind | dispatcher_router |
