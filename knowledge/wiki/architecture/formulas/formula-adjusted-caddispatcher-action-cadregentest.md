---
title: Formula — router · cadRegenTest
type: formula
formula_id: formula.adjusted.caddispatcher.action.cadregentest
...
| Field | Value |
|-------|-------|
| Name | `router · cadRegenTest` |
| Graph node | `formula.adjusted.caddispatcher.action.cadregentest` |
| Kind | dispatcher_router |
