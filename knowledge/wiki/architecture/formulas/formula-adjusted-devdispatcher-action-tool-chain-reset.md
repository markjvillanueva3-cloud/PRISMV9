---
title: Formula — router · tool_chain_reset
type: formula
formula_id: formula.adjusted.devdispatcher.action.tool_chain_reset
...
# Formula — `router · tool_chain_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_chain_reset` |
| Graph node | `formula.adjusted.devdispatcher.action.tool_chain_reset` |
| Kind | dispatcher_router |
