---
title: Formula — router · miner_sn_curve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.miner_sn_curve
...
| Field | Value |
|-------|-------|
| Name | `router · miner_sn_curve` |
| Graph node | `formula.adjusted.calcdispatcher.action.miner_sn_curve` |
| Kind | dispatcher_router |
