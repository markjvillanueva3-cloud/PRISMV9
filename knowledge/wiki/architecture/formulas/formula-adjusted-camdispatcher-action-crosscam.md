---
title: Formula — router · crossCAM
type: formula
formula_id: formula.adjusted.camdispatcher.action.crosscam
...
| Field | Value |
|-------|-------|
| Name | `router · crossCAM` |
| Graph node | `formula.adjusted.camdispatcher.action.crosscam` |
| Kind | dispatcher_router |
