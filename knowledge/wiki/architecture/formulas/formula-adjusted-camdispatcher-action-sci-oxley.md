---
title: Formula — router · sci_oxley
type: formula
formula_id: formula.adjusted.camdispatcher.action.sci_oxley
...
| Field | Value |
|-------|-------|
| Name | `router · sci_oxley` |
| Graph node | `formula.adjusted.camdispatcher.action.sci_oxley` |
| Kind | dispatcher_router |
