---
title: Formula — router · electrode
type: formula
formula_id: formula.adjusted.edmdispatcher.action.electrode
...
| Field | Value |
|-------|-------|
| Name | `router · electrode` |
| Graph node | `formula.adjusted.edmdispatcher.action.electrode` |
| Kind | dispatcher_router |
