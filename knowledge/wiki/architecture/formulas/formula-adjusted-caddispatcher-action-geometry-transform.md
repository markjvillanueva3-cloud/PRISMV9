---
title: Formula — router · geometry_transform
type: formula
formula_id: formula.adjusted.caddispatcher.action.geometry_transform
...
# Formula — `router · geometry_transform`
...
| Field | Value |
|-------|-------|
| Name | `router · geometry_transform` |
| Graph node | `formula.adjusted.caddispatcher.action.geometry_transform` |
| Kind | dispatcher_router |
