---
title: Formula — router · acc_thermal_error
type: formula
formula_id: formula.adjusted.camdispatcher.action.acc_thermal_error
...
# Formula — `router · acc_thermal_error`
...
| Field | Value |
|-------|-------|
| Name | `router · acc_thermal_error` |
| Graph node | `formula.adjusted.camdispatcher.action.acc_thermal_error` |
| Kind | dispatcher_router |
