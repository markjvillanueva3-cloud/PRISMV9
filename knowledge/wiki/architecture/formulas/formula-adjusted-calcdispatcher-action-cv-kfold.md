---
title: Formula — router · cv_kfold
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cv_kfold
...
| Field | Value |
|-------|-------|
| Name | `router · cv_kfold` |
| Graph node | `formula.adjusted.calcdispatcher.action.cv_kfold` |
| Kind | dispatcher_router |
