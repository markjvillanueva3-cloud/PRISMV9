---
title: Formula — router · mastercamAddInGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.mastercamaddingen
...
# Formula — `router · mastercamAddInGen`
...
| Field | Value |
|-------|-------|
| Name | `router · mastercamAddInGen` |
| Graph node | `formula.adjusted.camdispatcher.action.mastercamaddingen` |
| Kind | dispatcher_router |
