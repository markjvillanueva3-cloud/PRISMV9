---
title: Formula — router · safetyEscalation
type: formula
formula_id: formula.adjusted.camdispatcher.action.safetyescalation
...
# Formula — `router · safetyEscalation`
...
| Field | Value |
|-------|-------|
| Name | `router · safetyEscalation` |
| Graph node | `formula.adjusted.camdispatcher.action.safetyescalation` |
| Kind | dispatcher_router |
