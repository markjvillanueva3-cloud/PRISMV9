---
title: Formula — router · stochRouter
type: formula
formula_id: formula.adjusted.camdispatcher.action.stochrouter
...
| Field | Value |
|-------|-------|
| Name | `router · stochRouter` |
| Graph node | `formula.adjusted.camdispatcher.action.stochrouter` |
| Kind | dispatcher_router |
