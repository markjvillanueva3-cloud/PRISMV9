---
title: Formula — router · gapVoltage
type: formula
formula_id: formula.adjusted.edmdispatcher.action.gapvoltage
...
| Field | Value |
|-------|-------|
| Name | `router · gapVoltage` |
| Graph node | `formula.adjusted.edmdispatcher.action.gapvoltage` |
| Kind | dispatcher_router |
