---
title: Formula — router · gcode_opt_analyze
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gcode_opt_analyze
...
# Formula — `router · gcode_opt_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_opt_analyze` |
| Graph node | `formula.adjusted.calcdispatcher.action.gcode_opt_analyze` |
| Kind | dispatcher_router |
