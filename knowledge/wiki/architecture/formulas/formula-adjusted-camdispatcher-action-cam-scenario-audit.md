---
title: Formula — router · cam_scenario_audit
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_scenario_audit
...
# Formula — `router · cam_scenario_audit`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_scenario_audit` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_scenario_audit` |
| Kind | dispatcher_router |
