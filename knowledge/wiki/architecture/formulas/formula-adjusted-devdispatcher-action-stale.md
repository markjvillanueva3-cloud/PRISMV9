---
title: Formula — router · stale
type: formula
formula_id: formula.adjusted.devdispatcher.action.stale
...
|-------|-------|
| Name | `router · stale` |
| Graph node | `formula.adjusted.devdispatcher.action.stale` |
| Kind | dispatcher_router |
