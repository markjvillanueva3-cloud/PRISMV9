---
title: Formula — router · consistency_clear
type: formula
formula_id: formula.adjusted.calcdispatcher.action.consistency_clear
...
# Formula — `router · consistency_clear`
...
| Field | Value |
|-------|-------|
| Name | `router · consistency_clear` |
| Graph node | `formula.adjusted.calcdispatcher.action.consistency_clear` |
| Kind | dispatcher_router |
