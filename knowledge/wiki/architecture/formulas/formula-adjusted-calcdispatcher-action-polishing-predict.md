---
title: Formula — router · polishing_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.polishing_predict
...
# Formula — `router · polishing_predict`
...
| Field | Value |
|-------|-------|
| Name | `router · polishing_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.polishing_predict` |
| Kind | dispatcher_router |
