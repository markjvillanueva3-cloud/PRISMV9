---
title: Formula — router · milestone_skip
type: formula
formula_id: formula.adjusted.businessdispatcher.action.milestone_skip
...
| Field | Value |
|-------|-------|
| Name | `router · milestone_skip` |
| Graph node | `formula.adjusted.businessdispatcher.action.milestone_skip` |
| Kind | dispatcher_router |
