---
title: Formula — router · algorithm_info
type: formula
formula_id: formula.adjusted.calcdispatcher.action.algorithm_info
...
| Field | Value |
|-------|-------|
| Name | `router · algorithm_info` |
| Graph node | `formula.adjusted.calcdispatcher.action.algorithm_info` |
| Kind | dispatcher_router |
