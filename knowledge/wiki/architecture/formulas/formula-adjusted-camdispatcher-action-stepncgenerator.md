---
title: Formula — router · stepNCGenerator
type: formula
formula_id: formula.adjusted.camdispatcher.action.stepncgenerator
...
# Formula — `router · stepNCGenerator`
...
| Field | Value |
|-------|-------|
| Name | `router · stepNCGenerator` |
| Graph node | `formula.adjusted.camdispatcher.action.stepncgenerator` |
| Kind | dispatcher_router |
