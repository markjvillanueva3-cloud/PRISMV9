---
title: Formula — router · mcSPC
type: formula
formula_id: formula.adjusted.camdispatcher.action.mcspc
...
|-------|-------|
| Name | `router · mcSPC` |
| Graph node | `formula.adjusted.camdispatcher.action.mcspc` |
| Kind | dispatcher_router |
