---
title: Formula — router · fleet_transfer
type: formula
formula_id: formula.adjusted.camdispatcher.action.fleet_transfer
...
| Field | Value |
|-------|-------|
| Name | `router · fleet_transfer` |
| Graph node | `formula.adjusted.camdispatcher.action.fleet_transfer` |
| Kind | dispatcher_router |
