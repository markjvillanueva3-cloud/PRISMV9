---
title: Formula — router · file_write
type: formula
formula_id: formula.adjusted.devdispatcher.action.file_write
...
| Field | Value |
|-------|-------|
| Name | `router · file_write` |
| Graph node | `formula.adjusted.devdispatcher.action.file_write` |
| Kind | dispatcher_router |
