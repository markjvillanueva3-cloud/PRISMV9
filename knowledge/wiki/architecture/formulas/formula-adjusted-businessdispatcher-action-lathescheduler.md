---
title: Formula — router · latheScheduler
type: formula
formula_id: formula.adjusted.businessdispatcher.action.lathescheduler
...
| Field | Value |
|-------|-------|
| Name | `router · latheScheduler` |
| Graph node | `formula.adjusted.businessdispatcher.action.lathescheduler` |
| Kind | dispatcher_router |
