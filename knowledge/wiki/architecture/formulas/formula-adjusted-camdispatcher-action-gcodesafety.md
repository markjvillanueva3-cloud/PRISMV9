---
title: Formula — router · gcodeSafety
type: formula
formula_id: formula.adjusted.camdispatcher.action.gcodesafety
...
| Field | Value |
|-------|-------|
| Name | `router · gcodeSafety` |
| Graph node | `formula.adjusted.camdispatcher.action.gcodesafety` |
| Kind | dispatcher_router |
