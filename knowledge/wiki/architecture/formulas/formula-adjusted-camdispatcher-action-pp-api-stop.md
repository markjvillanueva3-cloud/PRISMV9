---
title: Formula — router · pp_api_stop
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_api_stop
...
| Field | Value |
|-------|-------|
| Name | `router · pp_api_stop` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_api_stop` |
| Kind | dispatcher_router |
