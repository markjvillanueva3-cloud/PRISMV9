---
title: Formula — router · pattern_stats
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.pattern_stats
...
| Field | Value |
|-------|-------|
| Name | `router · pattern_stats` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.pattern_stats` |
| Kind | dispatcher_router |
