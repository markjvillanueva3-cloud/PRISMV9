---
title: Formula — router · skill_chain
type: formula
formula_id: formula.adjusted.skillscriptdispatcher.action.skill_chain
...
| Field | Value |
|-------|-------|
| Name | `router · skill_chain` |
| Graph node | `formula.adjusted.skillscriptdispatcher.action.skill_chain` |
| Kind | dispatcher_router |
