---
title: Formula — router · cam_addin_ui_panel
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_addin_ui_panel
...
# Formula — `router · cam_addin_ui_panel`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_addin_ui_panel` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_addin_ui_panel` |
| Kind | dispatcher_router |
