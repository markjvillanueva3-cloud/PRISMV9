---
title: Formula — router · thermal_fourier_1d
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thermal_fourier_1d
...
# Formula — `router · thermal_fourier_1d`
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_fourier_1d` |
| Graph node | `formula.adjusted.calcdispatcher.action.thermal_fourier_1d` |
| Kind | dispatcher_router |
