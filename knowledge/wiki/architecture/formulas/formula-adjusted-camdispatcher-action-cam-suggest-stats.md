---
title: Formula — router · cam_suggest_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_suggest_stats
...
# Formula — `router · cam_suggest_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_suggest_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_suggest_stats` |
| Kind | dispatcher_router |
