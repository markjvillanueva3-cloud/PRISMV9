---
title: Formula — router · dispatch_remove
type: formula
formula_id: formula.adjusted.businessdispatcher.action.dispatch_remove
...
# Formula — `router · dispatch_remove`
...
| Field | Value |
|-------|-------|
| Name | `router · dispatch_remove` |
| Graph node | `formula.adjusted.businessdispatcher.action.dispatch_remove` |
| Kind | dispatcher_router |
