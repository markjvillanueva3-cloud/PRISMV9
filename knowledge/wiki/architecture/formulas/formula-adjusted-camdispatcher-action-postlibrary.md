---
title: Formula — router · postLibrary
type: formula
formula_id: formula.adjusted.camdispatcher.action.postlibrary
...
| Field | Value |
|-------|-------|
| Name | `router · postLibrary` |
| Graph node | `formula.adjusted.camdispatcher.action.postlibrary` |
| Kind | dispatcher_router |
