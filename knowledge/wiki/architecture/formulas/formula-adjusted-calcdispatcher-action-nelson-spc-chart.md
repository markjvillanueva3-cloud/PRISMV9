---
title: Formula — router · nelson_spc_chart
type: formula
formula_id: formula.adjusted.calcdispatcher.action.nelson_spc_chart
...
# Formula — `router · nelson_spc_chart`
...
| Field | Value |
|-------|-------|
| Name | `router · nelson_spc_chart` |
| Graph node | `formula.adjusted.calcdispatcher.action.nelson_spc_chart` |
| Kind | dispatcher_router |
