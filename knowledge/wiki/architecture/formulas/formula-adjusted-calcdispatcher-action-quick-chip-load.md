---
title: Formula — router · quick_chip_load
type: formula
formula_id: formula.adjusted.calcdispatcher.action.quick_chip_load
...
# Formula — `router · quick_chip_load`
...
| Field | Value |
|-------|-------|
| Name | `router · quick_chip_load` |
| Graph node | `formula.adjusted.calcdispatcher.action.quick_chip_load` |
| Kind | dispatcher_router |
