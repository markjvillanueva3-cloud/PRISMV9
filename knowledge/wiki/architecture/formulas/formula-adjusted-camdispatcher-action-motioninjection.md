---
title: Formula — router · motionInjection
type: formula
formula_id: formula.adjusted.camdispatcher.action.motioninjection
...
# Formula — `router · motionInjection`
...
| Field | Value |
|-------|-------|
| Name | `router · motionInjection` |
| Graph node | `formula.adjusted.camdispatcher.action.motioninjection` |
| Kind | dispatcher_router |
