---
title: Formula — router · jacobian_5axis
type: formula
formula_id: formula.adjusted.calcdispatcher.action.jacobian_5axis
...
| Field | Value |
|-------|-------|
| Name | `router · jacobian_5axis` |
| Graph node | `formula.adjusted.calcdispatcher.action.jacobian_5axis` |
| Kind | dispatcher_router |
