---
title: Formula — router · bottleneck_dbr
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bottleneck_dbr
...
| Field | Value |
|-------|-------|
| Name | `router · bottleneck_dbr` |
| Graph node | `formula.adjusted.calcdispatcher.action.bottleneck_dbr` |
| Kind | dispatcher_router |
