---
title: Formula — router · hard_turn_decide
type: formula
formula_id: formula.adjusted.turningdispatcher.action.hard_turn_decide
...
# Formula — `router · hard_turn_decide`
...
| Field | Value |
|-------|-------|
| Name | `router · hard_turn_decide` |
| Graph node | `formula.adjusted.turningdispatcher.action.hard_turn_decide` |
| Kind | dispatcher_router |
