---
title: Formula — router · hook_registry
type: formula
formula_id: formula.adjusted.devdispatcher.action.hook_registry
...
| Field | Value |
|-------|-------|
| Name | `router · hook_registry` |
| Graph node | `formula.adjusted.devdispatcher.action.hook_registry` |
| Kind | dispatcher_router |
