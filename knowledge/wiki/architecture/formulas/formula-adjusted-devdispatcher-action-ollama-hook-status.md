---
title: Formula — router · ollama_hook_status
type: formula
formula_id: formula.adjusted.devdispatcher.action.ollama_hook_status
...
# Formula — `router · ollama_hook_status`
...
| Field | Value |
|-------|-------|
| Name | `router · ollama_hook_status` |
| Graph node | `formula.adjusted.devdispatcher.action.ollama_hook_status` |
| Kind | dispatcher_router |
