---
title: Formula — router · pp_run_full
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_run_full
...
| Field | Value |
|-------|-------|
| Name | `router · pp_run_full` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_run_full` |
| Kind | dispatcher_router |
