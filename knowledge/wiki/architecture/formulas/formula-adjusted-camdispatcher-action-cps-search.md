---
title: Formula — router · cps_search
type: formula
formula_id: formula.adjusted.camdispatcher.action.cps_search
...
| Field | Value |
|-------|-------|
| Name | `router · cps_search` |
| Graph node | `formula.adjusted.camdispatcher.action.cps_search` |
| Kind | dispatcher_router |
