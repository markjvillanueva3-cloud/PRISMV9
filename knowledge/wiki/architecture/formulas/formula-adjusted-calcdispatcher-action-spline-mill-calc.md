---
title: Formula — router · spline_mill_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spline_mill_calc
...
# Formula — `router · spline_mill_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · spline_mill_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.spline_mill_calc` |
| Kind | dispatcher_router |
