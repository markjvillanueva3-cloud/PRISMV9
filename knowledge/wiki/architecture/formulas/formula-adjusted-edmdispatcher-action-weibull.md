---
title: Formula — router · weibull
type: formula
formula_id: formula.adjusted.edmdispatcher.action.weibull
...
|-------|-------|
| Name | `router · weibull` |
| Graph node | `formula.adjusted.edmdispatcher.action.weibull` |
| Kind | dispatcher_router |
