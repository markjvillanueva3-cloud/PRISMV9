---
title: Formula — router · mesh_offset
type: formula
formula_id: formula.adjusted.calcdispatcher.action.mesh_offset
...
| Field | Value |
|-------|-------|
| Name | `router · mesh_offset` |
| Graph node | `formula.adjusted.calcdispatcher.action.mesh_offset` |
| Kind | dispatcher_router |
