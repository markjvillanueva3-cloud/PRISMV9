---
title: Formula — router · ofm_calculate
type: formula
formula_id: formula.adjusted.devdispatcher.action.ofm_calculate
...
| Field | Value |
|-------|-------|
| Name | `router · ofm_calculate` |
| Graph node | `formula.adjusted.devdispatcher.action.ofm_calculate` |
| Kind | dispatcher_router |
