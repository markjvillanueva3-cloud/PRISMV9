---
title: Formula — router · mfa_setup
type: formula
formula_id: formula.adjusted.authdispatcher.action.mfa_setup
...
| Field | Value |
|-------|-------|
| Name | `router · mfa_setup` |
| Graph node | `formula.adjusted.authdispatcher.action.mfa_setup` |
| Kind | dispatcher_router |
