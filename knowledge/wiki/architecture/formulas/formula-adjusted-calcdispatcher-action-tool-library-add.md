---
title: Formula — router · tool_library_add
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_library_add
...
# Formula — `router · tool_library_add`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_library_add` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_library_add` |
| Kind | dispatcher_router |
