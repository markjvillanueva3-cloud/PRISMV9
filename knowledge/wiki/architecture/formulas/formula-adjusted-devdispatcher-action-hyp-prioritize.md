---
title: Formula — router · hyp_prioritize
type: formula
formula_id: formula.adjusted.devdispatcher.action.hyp_prioritize
...
| Field | Value |
|-------|-------|
| Name | `router · hyp_prioritize` |
| Graph node | `formula.adjusted.devdispatcher.action.hyp_prioritize` |
| Kind | dispatcher_router |
