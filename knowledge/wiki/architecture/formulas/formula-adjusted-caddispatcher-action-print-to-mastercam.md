---
title: Formula — router · print_to_mastercam
type: formula
formula_id: formula.adjusted.caddispatcher.action.print_to_mastercam
...
# Formula — `router · print_to_mastercam`
...
| Field | Value |
|-------|-------|
| Name | `router · print_to_mastercam` |
| Graph node | `formula.adjusted.caddispatcher.action.print_to_mastercam` |
| Kind | dispatcher_router |
