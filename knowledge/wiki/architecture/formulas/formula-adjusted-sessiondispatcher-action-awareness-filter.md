---
title: Formula — router · awareness_filter
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.awareness_filter
...
# Formula — `router · awareness_filter`
...
| Field | Value |
|-------|-------|
| Name | `router · awareness_filter` |
| Graph node | `formula.adjusted.sessiondispatcher.action.awareness_filter` |
| Kind | dispatcher_router |
