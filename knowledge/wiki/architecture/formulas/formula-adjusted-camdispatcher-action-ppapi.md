---
title: Formula — router · ppAPI
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppapi
...
|-------|-------|
| Name | `router · ppAPI` |
| Graph node | `formula.adjusted.camdispatcher.action.ppapi` |
| Kind | dispatcher_router |
