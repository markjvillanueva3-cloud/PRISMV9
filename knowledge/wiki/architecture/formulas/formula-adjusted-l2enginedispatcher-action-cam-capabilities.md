---
title: Formula — router · cam_capabilities
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.cam_capabilities
...
# Formula — `router · cam_capabilities`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_capabilities` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.cam_capabilities` |
| Kind | dispatcher_router |
