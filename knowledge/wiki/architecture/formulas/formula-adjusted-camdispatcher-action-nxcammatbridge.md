---
title: Formula — router · nxCAMMatBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcammatbridge
...
| Field | Value |
|-------|-------|
| Name | `router · nxCAMMatBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcammatbridge` |
| Kind | dispatcher_router |
