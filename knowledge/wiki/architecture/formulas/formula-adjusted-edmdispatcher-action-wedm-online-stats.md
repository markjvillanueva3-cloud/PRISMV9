---
title: Formula — router · wedm_online_stats
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_online_stats
...
# Formula — `router · wedm_online_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_online_stats` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_online_stats` |
| Kind | dispatcher_router |
