---
title: Formula — router · am_melt_pool
type: formula
formula_id: formula.adjusted.calcdispatcher.action.am_melt_pool
...
| Field | Value |
|-------|-------|
| Name | `router · am_melt_pool` |
| Graph node | `formula.adjusted.calcdispatcher.action.am_melt_pool` |
| Kind | dispatcher_router |
