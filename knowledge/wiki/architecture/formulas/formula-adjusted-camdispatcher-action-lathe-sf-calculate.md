---
title: Formula — router · lathe_sf_calculate
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_sf_calculate
...
# Formula — `router · lathe_sf_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_sf_calculate` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_sf_calculate` |
| Kind | dispatcher_router |
