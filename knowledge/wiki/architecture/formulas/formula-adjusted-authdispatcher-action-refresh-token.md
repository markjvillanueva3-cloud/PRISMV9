---
title: Formula — router · refresh_token
type: formula
formula_id: formula.adjusted.authdispatcher.action.refresh_token
...
| Field | Value |
|-------|-------|
| Name | `router · refresh_token` |
| Graph node | `formula.adjusted.authdispatcher.action.refresh_token` |
| Kind | dispatcher_router |
