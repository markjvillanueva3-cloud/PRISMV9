---
title: Formula — router · probe_wcs_setup
type: formula
formula_id: formula.adjusted.camdispatcher.action.probe_wcs_setup
...
# Formula — `router · probe_wcs_setup`
...
| Field | Value |
|-------|-------|
| Name | `router · probe_wcs_setup` |
| Graph node | `formula.adjusted.camdispatcher.action.probe_wcs_setup` |
| Kind | dispatcher_router |
