---
title: Formula — router · cimatronStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.cimatronstrategy
...
# Formula — `router · cimatronStrategy`
...
| Field | Value |
|-------|-------|
| Name | `router · cimatronStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.cimatronstrategy` |
| Kind | dispatcher_router |
