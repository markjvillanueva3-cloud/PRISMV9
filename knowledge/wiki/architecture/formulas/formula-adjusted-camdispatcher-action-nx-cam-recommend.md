---
title: Formula — router · nx_cam_recommend
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_cam_recommend
...
# Formula — `router · nx_cam_recommend`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_cam_recommend` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_cam_recommend` |
| Kind | dispatcher_router |
