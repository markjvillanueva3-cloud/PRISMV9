---
title: Formula — router · nx_execute
type: formula
formula_id: formula.adjusted.caddispatcher.action.nx_execute
...
| Field | Value |
|-------|-------|
| Name | `router · nx_execute` |
| Graph node | `formula.adjusted.caddispatcher.action.nx_execute` |
| Kind | dispatcher_router |
