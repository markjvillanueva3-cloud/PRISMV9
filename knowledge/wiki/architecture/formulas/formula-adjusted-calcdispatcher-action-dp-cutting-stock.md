---
title: Formula — router · dp_cutting_stock
type: formula
formula_id: formula.adjusted.calcdispatcher.action.dp_cutting_stock
...
# Formula — `router · dp_cutting_stock`
...
| Field | Value |
|-------|-------|
| Name | `router · dp_cutting_stock` |
| Graph node | `formula.adjusted.calcdispatcher.action.dp_cutting_stock` |
| Kind | dispatcher_router |
