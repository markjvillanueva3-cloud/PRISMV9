---
title: Formula — router · chamfer_calculate
type: formula
formula_id: formula.adjusted.cncopsdispatcher.action.chamfer_calculate
...
# Formula — `router · chamfer_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · chamfer_calculate` |
| Graph node | `formula.adjusted.cncopsdispatcher.action.chamfer_calculate` |
| Kind | dispatcher_router |
