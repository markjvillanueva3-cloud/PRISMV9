---
title: Formula — router · nx_generate_script
type: formula
formula_id: formula.adjusted.caddispatcher.action.nx_generate_script
...
# Formula — `router · nx_generate_script`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_generate_script` |
| Graph node | `formula.adjusted.caddispatcher.action.nx_generate_script` |
| Kind | dispatcher_router |
