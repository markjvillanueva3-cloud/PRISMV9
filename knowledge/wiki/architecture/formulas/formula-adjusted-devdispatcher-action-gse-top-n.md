---
title: Formula — router · gse_top_n
type: formula
formula_id: formula.adjusted.devdispatcher.action.gse_top_n
...
| Field | Value |
|-------|-------|
| Name | `router · gse_top_n` |
| Graph node | `formula.adjusted.devdispatcher.action.gse_top_n` |
| Kind | dispatcher_router |
