---
title: Formula — router · test_gap_scan
type: formula
formula_id: formula.adjusted.devdispatcher.action.test_gap_scan
...
| Field | Value |
|-------|-------|
| Name | `router · test_gap_scan` |
| Graph node | `formula.adjusted.devdispatcher.action.test_gap_scan` |
| Kind | dispatcher_router |
