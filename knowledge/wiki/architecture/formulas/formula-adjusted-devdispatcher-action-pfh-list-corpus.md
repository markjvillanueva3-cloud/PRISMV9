---
title: Formula — router · pfh_list_corpus
type: formula
formula_id: formula.adjusted.devdispatcher.action.pfh_list_corpus
...
# Formula — `router · pfh_list_corpus`
...
| Field | Value |
|-------|-------|
| Name | `router · pfh_list_corpus` |
| Graph node | `formula.adjusted.devdispatcher.action.pfh_list_corpus` |
| Kind | dispatcher_router |
