---
title: Formula — router · cam_multicam_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_multicam_list
...
# Formula — `router · cam_multicam_list`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_multicam_list` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_multicam_list` |
| Kind | dispatcher_router |
