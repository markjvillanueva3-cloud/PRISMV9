---
title: Formula — router · spc_imr_chart
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spc_imr_chart
...
| Field | Value |
|-------|-------|
| Name | `router · spc_imr_chart` |
| Graph node | `formula.adjusted.calcdispatcher.action.spc_imr_chart` |
| Kind | dispatcher_router |
