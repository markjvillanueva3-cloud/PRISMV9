---
title: Formula — router · z_level_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.z_level_optimize
...
# Formula — `router · z_level_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · z_level_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.z_level_optimize` |
| Kind | dispatcher_router |
