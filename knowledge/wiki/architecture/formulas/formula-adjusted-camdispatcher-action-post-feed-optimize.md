---
title: Formula — router · post_feed_optimize
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_feed_optimize
...
# Formula — `router · post_feed_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · post_feed_optimize` |
| Graph node | `formula.adjusted.camdispatcher.action.post_feed_optimize` |
| Kind | dispatcher_router |
