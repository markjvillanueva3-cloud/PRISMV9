---
title: Formula — router · fem_truss_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fem_truss_solve
...
# Formula — `router · fem_truss_solve`
...
| Field | Value |
|-------|-------|
| Name | `router · fem_truss_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.fem_truss_solve` |
| Kind | dispatcher_router |
