---
title: Formula — router · sle_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sle_predict
...
| Field | Value |
|-------|-------|
| Name | `router · sle_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.sle_predict` |
| Kind | dispatcher_router |
