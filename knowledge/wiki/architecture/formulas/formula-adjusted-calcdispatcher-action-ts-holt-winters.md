---
title: Formula — router · ts_holt_winters
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ts_holt_winters
...
# Formula — `router · ts_holt_winters`
...
| Field | Value |
|-------|-------|
| Name | `router · ts_holt_winters` |
| Graph node | `formula.adjusted.calcdispatcher.action.ts_holt_winters` |
| Kind | dispatcher_router |
