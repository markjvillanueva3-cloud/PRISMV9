---
title: Formula — router · brazing_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.brazing_calc
...
| Field | Value |
|-------|-------|
| Name | `router · brazing_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.brazing_calc` |
| Kind | dispatcher_router |
