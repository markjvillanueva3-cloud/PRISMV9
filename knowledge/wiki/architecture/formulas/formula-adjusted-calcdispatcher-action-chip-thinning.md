---
title: Formula — router · chip_thinning
type: formula
formula_id: formula.adjusted.calcdispatcher.action.chip_thinning
...
| Field | Value |
|-------|-------|
| Name | `router · chip_thinning` |
| Graph node | `formula.adjusted.calcdispatcher.action.chip_thinning` |
| Kind | dispatcher_router |
