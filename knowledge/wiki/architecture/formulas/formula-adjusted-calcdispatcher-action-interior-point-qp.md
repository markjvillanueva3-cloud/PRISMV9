---
title: Formula — router · interior_point_qp
type: formula
formula_id: formula.adjusted.calcdispatcher.action.interior_point_qp
...
# Formula — `router · interior_point_qp`
...
| Field | Value |
|-------|-------|
| Name | `router · interior_point_qp` |
| Graph node | `formula.adjusted.calcdispatcher.action.interior_point_qp` |
| Kind | dispatcher_router |
