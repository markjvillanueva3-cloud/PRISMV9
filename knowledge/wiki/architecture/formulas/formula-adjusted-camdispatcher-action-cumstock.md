---
title: Formula — router · cumStock
type: formula
formula_id: formula.adjusted.camdispatcher.action.cumstock
...
| Field | Value |
|-------|-------|
| Name | `router · cumStock` |
| Graph node | `formula.adjusted.camdispatcher.action.cumstock` |
| Kind | dispatcher_router |
