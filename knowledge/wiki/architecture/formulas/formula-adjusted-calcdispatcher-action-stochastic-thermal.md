---
title: Formula — router · stochastic_thermal
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stochastic_thermal
...
# Formula — `router · stochastic_thermal`
...
| Field | Value |
|-------|-------|
| Name | `router · stochastic_thermal` |
| Graph node | `formula.adjusted.calcdispatcher.action.stochastic_thermal` |
| Kind | dispatcher_router |
