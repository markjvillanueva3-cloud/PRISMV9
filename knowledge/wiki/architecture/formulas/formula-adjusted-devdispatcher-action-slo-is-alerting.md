---
title: Formula — router · slo_is_alerting
type: formula
formula_id: formula.adjusted.devdispatcher.action.slo_is_alerting
...
# Formula — `router · slo_is_alerting`
...
| Field | Value |
|-------|-------|
| Name | `router · slo_is_alerting` |
| Graph node | `formula.adjusted.devdispatcher.action.slo_is_alerting` |
| Kind | dispatcher_router |
