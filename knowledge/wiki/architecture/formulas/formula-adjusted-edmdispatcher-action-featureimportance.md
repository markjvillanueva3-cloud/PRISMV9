---
title: Formula — router · featureImportance
type: formula
formula_id: formula.adjusted.edmdispatcher.action.featureimportance
...
# Formula — `router · featureImportance`
...
| Field | Value |
|-------|-------|
| Name | `router · featureImportance` |
| Graph node | `formula.adjusted.edmdispatcher.action.featureimportance` |
| Kind | dispatcher_router |
