---
title: Formula — router · tebisStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.tebisstrategy
...
| Field | Value |
|-------|-------|
| Name | `router · tebisStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.tebisstrategy` |
| Kind | dispatcher_router |
