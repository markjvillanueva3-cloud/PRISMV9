---
title: Formula — router · daily_brief_get
type: formula
formula_id: formula.adjusted.memorydispatcher.action.daily_brief_get
...
# Formula — `router · daily_brief_get`
...
| Field | Value |
|-------|-------|
| Name | `router · daily_brief_get` |
| Graph node | `formula.adjusted.memorydispatcher.action.daily_brief_get` |
| Kind | dispatcher_router |
