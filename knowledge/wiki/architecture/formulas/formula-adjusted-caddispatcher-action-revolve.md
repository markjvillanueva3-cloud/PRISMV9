---
title: Formula — router · revolve
type: formula
formula_id: formula.adjusted.caddispatcher.action.revolve
...
|-------|-------|
| Name | `router · revolve` |
| Graph node | `formula.adjusted.caddispatcher.action.revolve` |
| Kind | dispatcher_router |
