---
title: Formula — router · cool_tsc_pressure
type: formula
formula_id: formula.adjusted.camdispatcher.action.cool_tsc_pressure
...
# Formula — `router · cool_tsc_pressure`
...
| Field | Value |
|-------|-------|
| Name | `router · cool_tsc_pressure` |
| Graph node | `formula.adjusted.camdispatcher.action.cool_tsc_pressure` |
| Kind | dispatcher_router |
