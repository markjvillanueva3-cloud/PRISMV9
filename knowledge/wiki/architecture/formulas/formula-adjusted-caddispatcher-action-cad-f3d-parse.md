---
title: Formula — router · cad_f3d_parse
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_f3d_parse
...
| Field | Value |
|-------|-------|
| Name | `router · cad_f3d_parse` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_f3d_parse` |
| Kind | dispatcher_router |
