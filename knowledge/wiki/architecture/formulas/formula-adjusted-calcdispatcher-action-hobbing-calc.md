---
title: Formula — router · hobbing_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.hobbing_calc
...
| Field | Value |
|-------|-------|
| Name | `router · hobbing_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.hobbing_calc` |
| Kind | dispatcher_router |
