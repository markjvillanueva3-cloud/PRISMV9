---
title: Formula — router · damper_design_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.damper_design_calc
...
# Formula — `router · damper_design_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · damper_design_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.damper_design_calc` |
| Kind | dispatcher_router |
