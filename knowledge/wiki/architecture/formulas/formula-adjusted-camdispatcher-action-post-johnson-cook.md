---
title: Formula — router · post_johnson_cook
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_johnson_cook
...
# Formula — `router · post_johnson_cook`
...
| Field | Value |
|-------|-------|
| Name | `router · post_johnson_cook` |
| Graph node | `formula.adjusted.camdispatcher.action.post_johnson_cook` |
| Kind | dispatcher_router |
