---
title: Formula — router · tool_find_optimal
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_find_optimal
...
# Formula — `router · tool_find_optimal`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_find_optimal` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_find_optimal` |
| Kind | dispatcher_router |
