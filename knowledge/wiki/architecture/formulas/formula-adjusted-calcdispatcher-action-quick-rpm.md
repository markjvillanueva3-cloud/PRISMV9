---
title: Formula — router · quick_rpm
type: formula
formula_id: formula.adjusted.calcdispatcher.action.quick_rpm
...
| Field | Value |
|-------|-------|
| Name | `router · quick_rpm` |
| Graph node | `formula.adjusted.calcdispatcher.action.quick_rpm` |
| Kind | dispatcher_router |
