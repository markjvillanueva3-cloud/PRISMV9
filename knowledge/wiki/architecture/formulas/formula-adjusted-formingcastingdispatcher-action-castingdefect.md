---
title: Formula — router · castingDefect
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.castingdefect
...
| Field | Value |
|-------|-------|
| Name | `router · castingDefect` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.castingdefect` |
| Kind | dispatcher_router |
