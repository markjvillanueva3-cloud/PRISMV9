---
title: Formula — router · cam_predict_scan
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_predict_scan
...
# Formula — `router · cam_predict_scan`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_predict_scan` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_predict_scan` |
| Kind | dispatcher_router |
