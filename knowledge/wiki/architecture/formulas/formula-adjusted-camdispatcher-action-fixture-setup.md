---
title: Formula — router · fixture_setup
type: formula
formula_id: formula.adjusted.camdispatcher.action.fixture_setup
...
| Field | Value |
|-------|-------|
| Name | `router · fixture_setup` |
| Graph node | `formula.adjusted.camdispatcher.action.fixture_setup` |
| Kind | dispatcher_router |
