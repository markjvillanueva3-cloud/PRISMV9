---
title: Formula — router · bolt_torque_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bolt_torque_calc
...
# Formula — `router · bolt_torque_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · bolt_torque_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.bolt_torque_calc` |
| Kind | dispatcher_router |
