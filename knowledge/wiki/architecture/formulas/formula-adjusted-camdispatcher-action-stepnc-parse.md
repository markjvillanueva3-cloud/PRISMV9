---
title: Formula — router · stepnc_parse
type: formula
formula_id: formula.adjusted.camdispatcher.action.stepnc_parse
...
| Field | Value |
|-------|-------|
| Name | `router · stepnc_parse` |
| Graph node | `formula.adjusted.camdispatcher.action.stepnc_parse` |
| Kind | dispatcher_router |
