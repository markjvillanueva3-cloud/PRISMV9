---
title: Formula — router · post_sidecar_build
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_sidecar_build
...
# Formula — `router · post_sidecar_build`
...
| Field | Value |
|-------|-------|
| Name | `router · post_sidecar_build` |
| Graph node | `formula.adjusted.camdispatcher.action.post_sidecar_build` |
| Kind | dispatcher_router |
