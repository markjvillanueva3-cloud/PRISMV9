---
title: Formula — router · session_validate
type: formula
formula_id: formula.adjusted.securitydispatcher.action.session_validate
...
# Formula — `router · session_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · session_validate` |
| Graph node | `formula.adjusted.securitydispatcher.action.session_validate` |
| Kind | dispatcher_router |
