---
title: Formula — router · job_create
type: formula
formula_id: formula.adjusted.businessdispatcher.action.job_create
...
| Field | Value |
|-------|-------|
| Name | `router · job_create` |
| Graph node | `formula.adjusted.businessdispatcher.action.job_create` |
| Kind | dispatcher_router |
