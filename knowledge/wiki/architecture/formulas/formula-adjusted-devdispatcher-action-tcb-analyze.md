---
title: Formula — router · tcb_analyze
type: formula
formula_id: formula.adjusted.devdispatcher.action.tcb_analyze
...
| Field | Value |
|-------|-------|
| Name | `router · tcb_analyze` |
| Graph node | `formula.adjusted.devdispatcher.action.tcb_analyze` |
| Kind | dispatcher_router |
