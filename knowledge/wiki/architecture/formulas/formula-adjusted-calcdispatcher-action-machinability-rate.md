---
title: Formula — router · machinability_rate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.machinability_rate
...
# Formula — `router · machinability_rate`
...
| Field | Value |
|-------|-------|
| Name | `router · machinability_rate` |
| Graph node | `formula.adjusted.calcdispatcher.action.machinability_rate` |
| Kind | dispatcher_router |
