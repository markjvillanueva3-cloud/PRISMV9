---
title: Formula — router · sdk_get_tip
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sdk_get_tip
...
| Field | Value |
|-------|-------|
| Name | `router · sdk_get_tip` |
| Graph node | `formula.adjusted.calcdispatcher.action.sdk_get_tip` |
| Kind | dispatcher_router |
