---
title: Formula — router · inventory
type: formula
formula_id: formula.adjusted.businessdispatcher.action.inventory
...
| Graph node | `formula.adjusted.businessdispatcher.action.inventory` |
| Kind | dispatcher_router |
