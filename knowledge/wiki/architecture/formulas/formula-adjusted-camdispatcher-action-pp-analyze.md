---
title: Formula — router · pp_analyze
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_analyze
...
| Field | Value |
|-------|-------|
| Name | `router · pp_analyze` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_analyze` |
| Kind | dispatcher_router |
