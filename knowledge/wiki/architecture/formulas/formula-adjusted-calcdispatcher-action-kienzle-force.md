---
title: Formula — router · kienzle_force
type: formula
formula_id: formula.adjusted.calcdispatcher.action.kienzle_force
...
| Field | Value |
|-------|-------|
| Name | `router · kienzle_force` |
| Graph node | `formula.adjusted.calcdispatcher.action.kienzle_force` |
| Kind | dispatcher_router |
