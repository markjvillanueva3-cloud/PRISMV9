---
title: Formula — router · traveler_scan
type: formula
formula_id: formula.adjusted.businessdispatcher.action.traveler_scan
...
| Field | Value |
|-------|-------|
| Name | `router · traveler_scan` |
| Graph node | `formula.adjusted.businessdispatcher.action.traveler_scan` |
| Kind | dispatcher_router |
