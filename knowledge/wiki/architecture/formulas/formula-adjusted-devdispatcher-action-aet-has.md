---
title: Formula — router · aet_has
type: formula
formula_id: formula.adjusted.devdispatcher.action.aet_has
...
|-------|-------|
| Name | `router · aet_has` |
| Graph node | `formula.adjusted.devdispatcher.action.aet_has` |
| Kind | dispatcher_router |
