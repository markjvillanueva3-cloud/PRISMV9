---
title: Formula — router · pm_finishing_get
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_finishing_get
...
# Formula — `router · pm_finishing_get`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_finishing_get` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_finishing_get` |
| Kind | dispatcher_router |
