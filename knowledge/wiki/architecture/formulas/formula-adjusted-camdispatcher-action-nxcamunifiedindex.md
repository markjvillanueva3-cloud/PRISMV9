---
title: Formula — router · nxcamUnifiedIndex
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcamunifiedindex
...
# Formula — `router · nxcamUnifiedIndex`
...
| Field | Value |
|-------|-------|
| Name | `router · nxcamUnifiedIndex` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcamunifiedindex` |
| Kind | dispatcher_router |
