---
title: Formula — router · aiml_cluster
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.aiml_cluster
...
| Field | Value |
|-------|-------|
| Name | `router · aiml_cluster` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.aiml_cluster` |
| Kind | dispatcher_router |
