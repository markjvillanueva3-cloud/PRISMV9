---
title: Formula — router · regression_gmm_em
type: formula
formula_id: formula.adjusted.calcdispatcher.action.regression_gmm_em
...
# Formula — `router · regression_gmm_em`
...
| Field | Value |
|-------|-------|
| Name | `router · regression_gmm_em` |
| Graph node | `formula.adjusted.calcdispatcher.action.regression_gmm_em` |
| Kind | dispatcher_router |
