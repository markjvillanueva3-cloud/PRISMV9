---
title: Formula — router · part_create
type: formula
formula_id: formula.adjusted.caddispatcher.action.part_create
...
| Field | Value |
|-------|-------|
| Name | `router · part_create` |
| Graph node | `formula.adjusted.caddispatcher.action.part_create` |
| Kind | dispatcher_router |
