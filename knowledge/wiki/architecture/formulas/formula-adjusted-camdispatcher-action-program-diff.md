---
title: Formula — router · program_diff
type: formula
formula_id: formula.adjusted.camdispatcher.action.program_diff
...
| Field | Value |
|-------|-------|
| Name | `router · program_diff` |
| Graph node | `formula.adjusted.camdispatcher.action.program_diff` |
| Kind | dispatcher_router |
