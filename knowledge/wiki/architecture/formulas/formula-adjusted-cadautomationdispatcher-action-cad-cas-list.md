---
title: Formula — router · cad_cas_list
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_cas_list
...
| Field | Value |
|-------|-------|
| Name | `router · cad_cas_list` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_cas_list` |
| Kind | dispatcher_router |
