---
title: Formula — router · voronoi_diagram
type: formula
formula_id: formula.adjusted.calcdispatcher.action.voronoi_diagram
...
# Formula — `router · voronoi_diagram`
...
| Field | Value |
|-------|-------|
| Name | `router · voronoi_diagram` |
| Graph node | `formula.adjusted.calcdispatcher.action.voronoi_diagram` |
| Kind | dispatcher_router |
