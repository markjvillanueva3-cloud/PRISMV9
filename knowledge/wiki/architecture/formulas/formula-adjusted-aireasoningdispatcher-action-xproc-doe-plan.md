---
title: Formula — router · xproc_doe_plan
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.xproc_doe_plan
...
| Field | Value |
|-------|-------|
| Name | `router · xproc_doe_plan` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.xproc_doe_plan` |
| Kind | dispatcher_router |
