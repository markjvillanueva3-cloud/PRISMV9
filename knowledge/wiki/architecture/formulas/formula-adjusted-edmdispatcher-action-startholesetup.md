---
title: Formula — router · startHoleSetup
type: formula
formula_id: formula.adjusted.edmdispatcher.action.startholesetup
...
| Field | Value |
|-------|-------|
| Name | `router · startHoleSetup` |
| Graph node | `formula.adjusted.edmdispatcher.action.startholesetup` |
| Kind | dispatcher_router |
