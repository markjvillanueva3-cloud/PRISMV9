---
title: Formula — router · reaming_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.reaming_calc
...
| Field | Value |
|-------|-------|
| Name | `router · reaming_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.reaming_calc` |
| Kind | dispatcher_router |
