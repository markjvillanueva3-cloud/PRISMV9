---
title: Formula — router · authz_get_stats
type: formula
formula_id: formula.adjusted.securitydispatcher.action.authz_get_stats
...
# Formula — `router · authz_get_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · authz_get_stats` |
| Graph node | `formula.adjusted.securitydispatcher.action.authz_get_stats` |
| Kind | dispatcher_router |
