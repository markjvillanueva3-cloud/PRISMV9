---
title: Formula — router · lathe_inv_alerts
type: formula
formula_id: formula.adjusted.businessdispatcher.action.lathe_inv_alerts
...
# Formula — `router · lathe_inv_alerts`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_inv_alerts` |
| Graph node | `formula.adjusted.businessdispatcher.action.lathe_inv_alerts` |
| Kind | dispatcher_router |
