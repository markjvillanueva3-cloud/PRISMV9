---
title: Formula — router · roi_report
type: formula
formula_id: formula.adjusted.businessdispatcher.action.roi_report
...
| Field | Value |
|-------|-------|
| Name | `router · roi_report` |
| Graph node | `formula.adjusted.businessdispatcher.action.roi_report` |
| Kind | dispatcher_router |
