---
title: Formula — router · tool_route
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.tool_route
...
| Field | Value |
|-------|-------|
| Name | `router · tool_route` |
| Graph node | `formula.adjusted.sessiondispatcher.action.tool_route` |
| Kind | dispatcher_router |
