---
title: Formula — router · mcfi_get_course
type: formula
formula_id: formula.adjusted.devdispatcher.action.mcfi_get_course
...
# Formula — `router · mcfi_get_course`
...
| Field | Value |
|-------|-------|
| Name | `router · mcfi_get_course` |
| Graph node | `formula.adjusted.devdispatcher.action.mcfi_get_course` |
| Kind | dispatcher_router |
