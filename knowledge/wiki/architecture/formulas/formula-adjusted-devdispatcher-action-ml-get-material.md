---
title: Formula — router · ml_get_material
type: formula
formula_id: formula.adjusted.devdispatcher.action.ml_get_material
...
# Formula — `router · ml_get_material`
...
| Field | Value |
|-------|-------|
| Name | `router · ml_get_material` |
| Graph node | `formula.adjusted.devdispatcher.action.ml_get_material` |
| Kind | dispatcher_router |
