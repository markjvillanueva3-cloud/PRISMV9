---
title: Formula — router · type_flow_trace
type: formula
formula_id: formula.adjusted.devdispatcher.action.type_flow_trace
...
# Formula — `router · type_flow_trace`
...
| Field | Value |
|-------|-------|
| Name | `router · type_flow_trace` |
| Graph node | `formula.adjusted.devdispatcher.action.type_flow_trace` |
| Kind | dispatcher_router |
