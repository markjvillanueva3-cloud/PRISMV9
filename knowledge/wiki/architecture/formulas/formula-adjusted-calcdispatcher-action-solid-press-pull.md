---
title: Formula — router · solid_press_pull
type: formula
formula_id: formula.adjusted.calcdispatcher.action.solid_press_pull
...
# Formula — `router · solid_press_pull`
...
| Field | Value |
|-------|-------|
| Name | `router · solid_press_pull` |
| Graph node | `formula.adjusted.calcdispatcher.action.solid_press_pull` |
| Kind | dispatcher_router |
