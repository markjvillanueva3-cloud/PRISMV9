---
title: Formula — router · lathe_inv_get
type: formula
formula_id: formula.adjusted.businessdispatcher.action.lathe_inv_get
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_inv_get` |
| Graph node | `formula.adjusted.businessdispatcher.action.lathe_inv_get` |
| Kind | dispatcher_router |
