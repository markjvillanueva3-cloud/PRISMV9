---
title: Formula — router · cam_suggest_apply
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_suggest_apply
...
# Formula — `router · cam_suggest_apply`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_suggest_apply` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_suggest_apply` |
| Kind | dispatcher_router |
