---
title: Formula — router · mca_vendor_trust
type: formula
formula_id: formula.adjusted.devdispatcher.action.mca_vendor_trust
...
# Formula — `router · mca_vendor_trust`
...
| Field | Value |
|-------|-------|
| Name | `router · mca_vendor_trust` |
| Graph node | `formula.adjusted.devdispatcher.action.mca_vendor_trust` |
| Kind | dispatcher_router |
