---
title: Formula — router · rollback_plan
type: formula
formula_id: formula.adjusted.devdispatcher.action.rollback_plan
...
| Field | Value |
|-------|-------|
| Name | `router · rollback_plan` |
| Graph node | `formula.adjusted.devdispatcher.action.rollback_plan` |
| Kind | dispatcher_router |
