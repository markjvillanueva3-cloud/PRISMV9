---
title: Formula — router · mit_courses_filter
type: formula
formula_id: formula.adjusted.devdispatcher.action.mit_courses_filter
...
# Formula — `router · mit_courses_filter`
...
| Field | Value |
|-------|-------|
| Name | `router · mit_courses_filter` |
| Graph node | `formula.adjusted.devdispatcher.action.mit_courses_filter` |
| Kind | dispatcher_router |
