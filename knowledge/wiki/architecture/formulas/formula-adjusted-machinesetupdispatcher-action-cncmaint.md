---
title: Formula — router · cncMaint
type: formula
formula_id: formula.adjusted.machinesetupdispatcher.action.cncmaint
...
| Field | Value |
|-------|-------|
| Name | `router · cncMaint` |
| Graph node | `formula.adjusted.machinesetupdispatcher.action.cncmaint` |
| Kind | dispatcher_router |
