---
title: Formula — router · feedback_scrap
type: formula
formula_id: formula.adjusted.devdispatcher.action.feedback_scrap
...
| Field | Value |
|-------|-------|
| Name | `router · feedback_scrap` |
| Graph node | `formula.adjusted.devdispatcher.action.feedback_scrap` |
| Kind | dispatcher_router |
