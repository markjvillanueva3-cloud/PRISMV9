---
title: Formula — router · pca_analyze
type: formula
formula_id: formula.adjusted.calcdispatcher.action.pca_analyze
...
| Field | Value |
|-------|-------|
| Name | `router · pca_analyze` |
| Graph node | `formula.adjusted.calcdispatcher.action.pca_analyze` |
| Kind | dispatcher_router |
