---
title: Formula — router · dme_minimize
type: formula
formula_id: formula.adjusted.devdispatcher.action.dme_minimize
...
| Field | Value |
|-------|-------|
| Name | `router · dme_minimize` |
| Graph node | `formula.adjusted.devdispatcher.action.dme_minimize` |
| Kind | dispatcher_router |
