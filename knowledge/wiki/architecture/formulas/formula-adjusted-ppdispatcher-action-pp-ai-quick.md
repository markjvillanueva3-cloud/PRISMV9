---
title: Formula — router · pp_ai_quick
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_ai_quick
...
| Field | Value |
|-------|-------|
| Name | `router · pp_ai_quick` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_ai_quick` |
| Kind | dispatcher_router |
