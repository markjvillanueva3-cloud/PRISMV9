---
title: Formula — router · close
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.close
...
|-------|-------|
| Name | `router · close` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.close` |
| Kind | dispatcher_router |
