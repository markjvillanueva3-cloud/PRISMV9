---
title: Formula — router · ppg_check_envelope
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_check_envelope
...
# Formula — `router · ppg_check_envelope`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_check_envelope` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_check_envelope` |
| Kind | dispatcher_router |
