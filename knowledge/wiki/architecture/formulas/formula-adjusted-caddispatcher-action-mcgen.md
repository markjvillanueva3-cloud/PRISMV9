---
title: Formula — router · mcGen
type: formula
formula_id: formula.adjusted.caddispatcher.action.mcgen
...
|-------|-------|
| Name | `router · mcGen` |
| Graph node | `formula.adjusted.caddispatcher.action.mcgen` |
| Kind | dispatcher_router |
