---
title: Formula — router · hmMetricCfg
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmmetriccfg
...
| Field | Value |
|-------|-------|
| Name | `router · hmMetricCfg` |
| Graph node | `formula.adjusted.camdispatcher.action.hmmetriccfg` |
| Kind | dispatcher_router |
