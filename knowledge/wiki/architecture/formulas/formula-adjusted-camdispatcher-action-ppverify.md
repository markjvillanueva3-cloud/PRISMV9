---
title: Formula — router · ppVerify
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppverify
...
| Field | Value |
|-------|-------|
| Name | `router · ppVerify` |
| Graph node | `formula.adjusted.camdispatcher.action.ppverify` |
| Kind | dispatcher_router |
