---
title: Formula — router · cadPipeline
type: formula
formula_id: formula.adjusted.caddispatcher.action.cadpipeline
...
| Field | Value |
|-------|-------|
| Name | `router · cadPipeline` |
| Graph node | `formula.adjusted.caddispatcher.action.cadpipeline` |
| Kind | dispatcher_router |
