---
title: Formula — router · probing
type: formula
formula_id: formula.adjusted.camdispatcher.action.probing
...
|-------|-------|
| Name | `router · probing` |
| Graph node | `formula.adjusted.camdispatcher.action.probing` |
| Kind | dispatcher_router |
