---
title: Formula — router · dfm_report
type: formula
formula_id: formula.adjusted.camdispatcher.action.dfm_report
...
| Field | Value |
|-------|-------|
| Name | `router · dfm_report` |
| Graph node | `formula.adjusted.camdispatcher.action.dfm_report` |
| Kind | dispatcher_router |
