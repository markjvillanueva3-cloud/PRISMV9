---
title: Formula — router · api_health
type: formula
formula_id: formula.adjusted.businessdispatcher.action.api_health
...
| Field | Value |
|-------|-------|
| Name | `router · api_health` |
| Graph node | `formula.adjusted.businessdispatcher.action.api_health` |
| Kind | dispatcher_router |
