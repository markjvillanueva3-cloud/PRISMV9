---
title: Formula — router · hmStrategyReg
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmstrategyreg
...
| Field | Value |
|-------|-------|
| Name | `router · hmStrategyReg` |
| Graph node | `formula.adjusted.camdispatcher.action.hmstrategyreg` |
| Kind | dispatcher_router |
