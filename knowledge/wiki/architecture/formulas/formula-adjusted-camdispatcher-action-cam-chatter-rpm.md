---
title: Formula — router · cam_chatter_rpm
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_chatter_rpm
...
# Formula — `router · cam_chatter_rpm`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_chatter_rpm` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_chatter_rpm` |
| Kind | dispatcher_router |
