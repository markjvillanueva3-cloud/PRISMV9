---
title: Formula — router · chain_drive_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.chain_drive_calc
...
# Formula — `router · chain_drive_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · chain_drive_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.chain_drive_calc` |
| Kind | dispatcher_router |
