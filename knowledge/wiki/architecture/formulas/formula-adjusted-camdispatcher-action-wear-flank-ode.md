---
title: Formula — router · wear_flank_ode
type: formula
formula_id: formula.adjusted.camdispatcher.action.wear_flank_ode
...
| Field | Value |
|-------|-------|
| Name | `router · wear_flank_ode` |
| Graph node | `formula.adjusted.camdispatcher.action.wear_flank_ode` |
| Kind | dispatcher_router |
