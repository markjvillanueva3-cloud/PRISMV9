---
title: Formula — router · tco_compare
type: formula
formula_id: formula.adjusted.camdispatcher.action.tco_compare
...
| Field | Value |
|-------|-------|
| Name | `router · tco_compare` |
| Graph node | `formula.adjusted.camdispatcher.action.tco_compare` |
| Kind | dispatcher_router |
