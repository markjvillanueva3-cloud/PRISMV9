---
title: Formula — router · edmPostProcessor
type: formula
formula_id: formula.adjusted.camdispatcher.action.edmpostprocessor
...
# Formula — `router · edmPostProcessor`
...
| Field | Value |
|-------|-------|
| Name | `router · edmPostProcessor` |
| Graph node | `formula.adjusted.camdispatcher.action.edmpostprocessor` |
| Kind | dispatcher_router |
