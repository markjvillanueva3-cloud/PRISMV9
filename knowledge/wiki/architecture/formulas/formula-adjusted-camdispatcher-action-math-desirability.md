---
title: Formula — router · math_desirability
type: formula
formula_id: formula.adjusted.camdispatcher.action.math_desirability
...
# Formula — `router · math_desirability`
...
| Field | Value |
|-------|-------|
| Name | `router · math_desirability` |
| Graph node | `formula.adjusted.camdispatcher.action.math_desirability` |
| Kind | dispatcher_router |
