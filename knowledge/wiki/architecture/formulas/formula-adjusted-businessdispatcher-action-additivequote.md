---
title: Formula — router · additiveQuote
type: formula
formula_id: formula.adjusted.businessdispatcher.action.additivequote
...
| Field | Value |
|-------|-------|
| Name | `router · additiveQuote` |
| Graph node | `formula.adjusted.businessdispatcher.action.additivequote` |
| Kind | dispatcher_router |
