---
title: Formula — router · cad_fcstd_parse
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_fcstd_parse
...
# Formula — `router · cad_fcstd_parse`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_fcstd_parse` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_fcstd_parse` |
| Kind | dispatcher_router |
