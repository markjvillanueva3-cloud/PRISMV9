---
title: Formula — router · energy
type: formula
formula_id: formula.adjusted.camdispatcher.action.energy
...
|-------|-------|
| Name | `router · energy` |
| Graph node | `formula.adjusted.camdispatcher.action.energy` |
| Kind | dispatcher_router |
