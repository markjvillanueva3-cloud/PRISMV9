---
title: Formula — router · keyway_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.keyway_calc
...
| Field | Value |
|-------|-------|
| Name | `router · keyway_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.keyway_calc` |
| Kind | dispatcher_router |
