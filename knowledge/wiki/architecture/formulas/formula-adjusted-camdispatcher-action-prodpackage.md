---
title: Formula — router · prodPackage
type: formula
formula_id: formula.adjusted.camdispatcher.action.prodpackage
...
| Field | Value |
|-------|-------|
| Name | `router · prodPackage` |
| Graph node | `formula.adjusted.camdispatcher.action.prodpackage` |
| Kind | dispatcher_router |
