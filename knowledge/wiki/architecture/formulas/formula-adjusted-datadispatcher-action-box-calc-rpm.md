---
title: Formula — router · box_calc_rpm
type: formula
formula_id: formula.adjusted.datadispatcher.action.box_calc_rpm
...
| Field | Value |
|-------|-------|
| Name | `router · box_calc_rpm` |
| Graph node | `formula.adjusted.datadispatcher.action.box_calc_rpm` |
| Kind | dispatcher_router |
