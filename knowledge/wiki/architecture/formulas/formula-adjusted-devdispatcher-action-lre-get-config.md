---
title: Formula — router · lre_get_config
type: formula
formula_id: formula.adjusted.devdispatcher.action.lre_get_config
...
| Field | Value |
|-------|-------|
| Name | `router · lre_get_config` |
| Graph node | `formula.adjusted.devdispatcher.action.lre_get_config` |
| Kind | dispatcher_router |
