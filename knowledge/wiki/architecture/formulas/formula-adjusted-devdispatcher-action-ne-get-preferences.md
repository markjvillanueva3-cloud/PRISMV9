---
title: Formula — router · ne_get_preferences
type: formula
formula_id: formula.adjusted.devdispatcher.action.ne_get_preferences
...
# Formula — `router · ne_get_preferences`
...
| Field | Value |
|-------|-------|
| Name | `router · ne_get_preferences` |
| Graph node | `formula.adjusted.devdispatcher.action.ne_get_preferences` |
| Kind | dispatcher_router |
