---
title: Formula — router · cam_param_optimize
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_param_optimize
...
# Formula — `router · cam_param_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_param_optimize` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_param_optimize` |
| Kind | dispatcher_router |
