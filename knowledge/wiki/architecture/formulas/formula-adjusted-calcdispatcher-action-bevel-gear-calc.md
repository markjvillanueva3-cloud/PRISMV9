---
title: Formula — router · bevel_gear_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bevel_gear_calc
...
# Formula — `router · bevel_gear_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · bevel_gear_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.bevel_gear_calc` |
| Kind | dispatcher_router |
