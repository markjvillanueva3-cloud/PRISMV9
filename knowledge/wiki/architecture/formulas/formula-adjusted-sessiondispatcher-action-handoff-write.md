---
title: Formula — router · handoff_write
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.handoff_write
...
| Field | Value |
|-------|-------|
| Name | `router · handoff_write` |
| Graph node | `formula.adjusted.sessiondispatcher.action.handoff_write` |
| Kind | dispatcher_router |
