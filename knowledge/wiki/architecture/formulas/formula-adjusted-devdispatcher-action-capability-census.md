---
title: Formula — router · capability_census
type: formula
formula_id: formula.adjusted.devdispatcher.action.capability_census
...
# Formula — `router · capability_census`
...
| Field | Value |
|-------|-------|
| Name | `router · capability_census` |
| Graph node | `formula.adjusted.devdispatcher.action.capability_census` |
| Kind | dispatcher_router |
