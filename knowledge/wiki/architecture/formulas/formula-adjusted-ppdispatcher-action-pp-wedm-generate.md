---
title: Formula — router · pp_wedm_generate
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_wedm_generate
...
# Formula — `router · pp_wedm_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_wedm_generate` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_wedm_generate` |
| Kind | dispatcher_router |
