---
title: Formula — router · tool_chain_string
type: formula
formula_id: formula.adjusted.devdispatcher.action.tool_chain_string
...
# Formula — `router · tool_chain_string`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_chain_string` |
| Graph node | `formula.adjusted.devdispatcher.action.tool_chain_string` |
| Kind | dispatcher_router |
