---
title: Formula — router · solidCAMAddInGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcamaddingen
...
# Formula — `router · solidCAMAddInGen`
...
| Field | Value |
|-------|-------|
| Name | `router · solidCAMAddInGen` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcamaddingen` |
| Kind | dispatcher_router |
