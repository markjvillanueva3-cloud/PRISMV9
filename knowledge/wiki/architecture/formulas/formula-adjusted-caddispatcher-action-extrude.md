---
title: Formula — router · extrude
type: formula
formula_id: formula.adjusted.caddispatcher.action.extrude
...
|-------|-------|
| Name | `router · extrude` |
| Graph node | `formula.adjusted.caddispatcher.action.extrude` |
| Kind | dispatcher_router |
