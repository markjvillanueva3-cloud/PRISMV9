---
title: Formula — router · gibbsCAMStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.gibbscamstrategy
...
# Formula — `router · gibbsCAMStrategy`
...
| Field | Value |
|-------|-------|
| Name | `router · gibbsCAMStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.gibbscamstrategy` |
| Kind | dispatcher_router |
