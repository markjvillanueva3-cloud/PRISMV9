---
title: Formula — router · mdof_stability
type: formula
formula_id: formula.adjusted.calcdispatcher.action.mdof_stability
...
| Field | Value |
|-------|-------|
| Name | `router · mdof_stability` |
| Graph node | `formula.adjusted.calcdispatcher.action.mdof_stability` |
| Kind | dispatcher_router |
