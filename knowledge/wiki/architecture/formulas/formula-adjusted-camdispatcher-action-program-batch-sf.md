---
title: Formula — router · program_batch_sf
type: formula
formula_id: formula.adjusted.camdispatcher.action.program_batch_sf
...
# Formula — `router · program_batch_sf`
...
| Field | Value |
|-------|-------|
| Name | `router · program_batch_sf` |
| Graph node | `formula.adjusted.camdispatcher.action.program_batch_sf` |
| Kind | dispatcher_router |
