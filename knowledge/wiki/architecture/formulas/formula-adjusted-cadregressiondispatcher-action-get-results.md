---
title: Formula — router · get_results
type: formula
formula_id: formula.adjusted.cadregressiondispatcher.action.get_results
...
| Field | Value |
|-------|-------|
| Name | `router · get_results` |
| Graph node | `formula.adjusted.cadregressiondispatcher.action.get_results` |
| Kind | dispatcher_router |
