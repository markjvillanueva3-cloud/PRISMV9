---
title: Formula — router · monitorSurface
type: formula
formula_id: formula.adjusted.edmdispatcher.action.monitorsurface
...
| Field | Value |
|-------|-------|
| Name | `router · monitorSurface` |
| Graph node | `formula.adjusted.edmdispatcher.action.monitorsurface` |
| Kind | dispatcher_router |
