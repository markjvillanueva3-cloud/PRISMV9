---
title: Formula — router · wedm_estimate_cost
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_estimate_cost
...
# Formula — `router · wedm_estimate_cost`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_estimate_cost` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_estimate_cost` |
| Kind | dispatcher_router |
