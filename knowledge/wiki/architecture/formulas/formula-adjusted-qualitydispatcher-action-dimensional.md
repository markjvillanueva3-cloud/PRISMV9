---
title: Formula — router · dimensional
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.dimensional
...
| Field | Value |
|-------|-------|
| Name | `router · dimensional` |
| Graph node | `formula.adjusted.qualitydispatcher.action.dimensional` |
| Kind | dispatcher_router |
