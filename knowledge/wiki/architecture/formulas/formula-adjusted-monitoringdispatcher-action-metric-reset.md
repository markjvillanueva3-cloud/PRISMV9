---
title: Formula — router · metric_reset
type: formula
formula_id: formula.adjusted.monitoringdispatcher.action.metric_reset
...
| Field | Value |
|-------|-------|
| Name | `router · metric_reset` |
| Graph node | `formula.adjusted.monitoringdispatcher.action.metric_reset` |
| Kind | dispatcher_router |
