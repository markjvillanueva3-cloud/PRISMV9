---
title: Formula — router · wron_list_swaps
type: formula
formula_id: formula.adjusted.devdispatcher.action.wron_list_swaps
...
# Formula — `router · wron_list_swaps`
...
| Field | Value |
|-------|-------|
| Name | `router · wron_list_swaps` |
| Graph node | `formula.adjusted.devdispatcher.action.wron_list_swaps` |
| Kind | dispatcher_router |
