---
title: Formula — router · pp_api_start
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_api_start
...
| Field | Value |
|-------|-------|
| Name | `router · pp_api_start` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_api_start` |
| Kind | dispatcher_router |
