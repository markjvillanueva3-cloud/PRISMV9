---
title: Formula — router · mesh_import
type: formula
formula_id: formula.adjusted.caddispatcher.action.mesh_import
...
| Field | Value |
|-------|-------|
| Name | `router · mesh_import` |
| Graph node | `formula.adjusted.caddispatcher.action.mesh_import` |
| Kind | dispatcher_router |
