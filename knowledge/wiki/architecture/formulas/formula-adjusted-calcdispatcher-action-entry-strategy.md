---
title: Formula — router · entry_strategy
type: formula
formula_id: formula.adjusted.calcdispatcher.action.entry_strategy
...
| Field | Value |
|-------|-------|
| Name | `router · entry_strategy` |
| Graph node | `formula.adjusted.calcdispatcher.action.entry_strategy` |
| Kind | dispatcher_router |
