---
title: Formula — router · cutting_force_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cutting_force_calc
...
# Formula — `router · cutting_force_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · cutting_force_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.cutting_force_calc` |
| Kind | dispatcher_router |
