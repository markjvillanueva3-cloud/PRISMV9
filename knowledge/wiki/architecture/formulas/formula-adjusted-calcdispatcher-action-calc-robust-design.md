---
title: Formula — router · calc_robust_design
type: formula
formula_id: formula.adjusted.calcdispatcher.action.calc_robust_design
...
# Formula — `router · calc_robust_design`
...
| Field | Value |
|-------|-------|
| Name | `router · calc_robust_design` |
| Graph node | `formula.adjusted.calcdispatcher.action.calc_robust_design` |
| Kind | dispatcher_router |
