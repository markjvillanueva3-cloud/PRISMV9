---
title: Formula — router · cool_reynolds_flow
type: formula
formula_id: formula.adjusted.camdispatcher.action.cool_reynolds_flow
...
# Formula — `router · cool_reynolds_flow`
...
| Field | Value |
|-------|-------|
| Name | `router · cool_reynolds_flow` |
| Graph node | `formula.adjusted.camdispatcher.action.cool_reynolds_flow` |
| Kind | dispatcher_router |
