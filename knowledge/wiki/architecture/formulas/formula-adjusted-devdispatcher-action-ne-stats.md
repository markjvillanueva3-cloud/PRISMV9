---
title: Formula — router · ne_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.ne_stats
...
| Field | Value |
|-------|-------|
| Name | `router · ne_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.ne_stats` |
| Kind | dispatcher_router |
