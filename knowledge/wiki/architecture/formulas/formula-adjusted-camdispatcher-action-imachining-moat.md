---
title: Formula — router · imachining_moat
type: formula
formula_id: formula.adjusted.camdispatcher.action.imachining_moat
...
# Formula — `router · imachining_moat`
...
| Field | Value |
|-------|-------|
| Name | `router · imachining_moat` |
| Graph node | `formula.adjusted.camdispatcher.action.imachining_moat` |
| Kind | dispatcher_router |
