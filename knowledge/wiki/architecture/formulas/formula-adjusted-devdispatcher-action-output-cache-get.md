---
title: Formula — router · output_cache_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.output_cache_get
...
# Formula — `router · output_cache_get`
...
| Field | Value |
|-------|-------|
| Name | `router · output_cache_get` |
| Graph node | `formula.adjusted.devdispatcher.action.output_cache_get` |
| Kind | dispatcher_router |
