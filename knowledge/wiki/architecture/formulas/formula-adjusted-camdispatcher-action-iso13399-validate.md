---
title: Formula — router · iso13399_validate
type: formula
formula_id: formula.adjusted.camdispatcher.action.iso13399_validate
...
# Formula — `router · iso13399_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · iso13399_validate` |
| Graph node | `formula.adjusted.camdispatcher.action.iso13399_validate` |
| Kind | dispatcher_router |
