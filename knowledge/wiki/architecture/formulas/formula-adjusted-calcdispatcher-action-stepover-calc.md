---
title: Formula — router · stepover_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stepover_calc
...
| Field | Value |
|-------|-------|
| Name | `router · stepover_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.stepover_calc` |
| Kind | dispatcher_router |
