---
title: Formula — router · spline_joint_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spline_joint_calc
...
# Formula — `router · spline_joint_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · spline_joint_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.spline_joint_calc` |
| Kind | dispatcher_router |
