---
title: Formula — router · thermal_trigger
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thermal_trigger
...
# Formula — `router · thermal_trigger`
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_trigger` |
| Graph node | `formula.adjusted.calcdispatcher.action.thermal_trigger` |
| Kind | dispatcher_router |
