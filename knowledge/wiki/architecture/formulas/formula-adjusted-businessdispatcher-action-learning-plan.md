---
title: Formula — router · learning_plan
type: formula
formula_id: formula.adjusted.businessdispatcher.action.learning_plan
...
| Field | Value |
|-------|-------|
| Name | `router · learning_plan` |
| Graph node | `formula.adjusted.businessdispatcher.action.learning_plan` |
| Kind | dispatcher_router |
