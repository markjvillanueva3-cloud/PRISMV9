---
title: Formula — router · live_tool
type: formula
formula_id: formula.adjusted.turningdispatcher.action.live_tool
...
| Field | Value |
|-------|-------|
| Name | `router · live_tool` |
| Graph node | `formula.adjusted.turningdispatcher.action.live_tool` |
| Kind | dispatcher_router |
