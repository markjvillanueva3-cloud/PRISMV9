---
title: Formula — router · pmRoughingIndex
type: formula
formula_id: formula.adjusted.camdispatcher.action.pmroughingindex
...
# Formula — `router · pmRoughingIndex`
...
| Field | Value |
|-------|-------|
| Name | `router · pmRoughingIndex` |
| Graph node | `formula.adjusted.camdispatcher.action.pmroughingindex` |
| Kind | dispatcher_router |
