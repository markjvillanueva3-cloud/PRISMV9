---
title: Formula — router · authz_get_role
type: formula
formula_id: formula.adjusted.securitydispatcher.action.authz_get_role
...
| Field | Value |
|-------|-------|
| Name | `router · authz_get_role` |
| Graph node | `formula.adjusted.securitydispatcher.action.authz_get_role` |
| Kind | dispatcher_router |
