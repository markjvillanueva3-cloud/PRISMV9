---
title: Formula — router · cadArchiveJoinAug
type: formula
formula_id: formula.adjusted.caddispatcher.action.cadarchivejoinaug
...
# Formula — `router · cadArchiveJoinAug`
...
| Field | Value |
|-------|-------|
| Name | `router · cadArchiveJoinAug` |
| Graph node | `formula.adjusted.caddispatcher.action.cadarchivejoinaug` |
| Kind | dispatcher_router |
