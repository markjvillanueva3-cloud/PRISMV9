---
title: Formula — router · wedm_lora_create
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_lora_create
...
# Formula — `router · wedm_lora_create`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_lora_create` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_lora_create` |
| Kind | dispatcher_router |
