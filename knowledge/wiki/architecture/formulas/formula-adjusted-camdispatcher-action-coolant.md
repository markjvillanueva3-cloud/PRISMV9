---
title: Formula — router · coolant
type: formula
formula_id: formula.adjusted.camdispatcher.action.coolant
...
|-------|-------|
| Name | `router · coolant` |
| Graph node | `formula.adjusted.camdispatcher.action.coolant` |
| Kind | dispatcher_router |
