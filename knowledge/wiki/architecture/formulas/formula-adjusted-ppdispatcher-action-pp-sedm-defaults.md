---
title: Formula — router · pp_sedm_defaults
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_sedm_defaults
...
# Formula — `router · pp_sedm_defaults`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_sedm_defaults` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_sedm_defaults` |
| Kind | dispatcher_router |
