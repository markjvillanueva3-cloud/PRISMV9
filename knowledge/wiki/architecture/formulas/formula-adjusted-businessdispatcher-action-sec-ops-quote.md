---
title: Formula — router · sec_ops_quote
type: formula
formula_id: formula.adjusted.businessdispatcher.action.sec_ops_quote
...
| Field | Value |
|-------|-------|
| Name | `router · sec_ops_quote` |
| Graph node | `formula.adjusted.businessdispatcher.action.sec_ops_quote` |
| Kind | dispatcher_router |
