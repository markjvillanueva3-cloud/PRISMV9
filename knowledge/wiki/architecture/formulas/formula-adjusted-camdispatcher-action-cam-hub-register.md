---
title: Formula — router · cam_hub_register
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_hub_register
...
# Formula — `router · cam_hub_register`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_hub_register` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_hub_register` |
| Kind | dispatcher_router |
