---
title: Formula — router · belief_query
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.belief_query
...
| Field | Value |
|-------|-------|
| Name | `router · belief_query` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.belief_query` |
| Kind | dispatcher_router |
