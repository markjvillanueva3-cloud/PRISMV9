---
title: Formula — router · nx_material_lookup
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_material_lookup
...
# Formula — `router · nx_material_lookup`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_material_lookup` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_material_lookup` |
| Kind | dispatcher_router |
