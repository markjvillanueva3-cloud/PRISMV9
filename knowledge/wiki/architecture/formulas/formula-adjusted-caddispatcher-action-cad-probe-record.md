---
title: Formula — router · cad_probe_record
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_probe_record
...
# Formula — `router · cad_probe_record`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_probe_record` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_probe_record` |
| Kind | dispatcher_router |
