---
title: Formula — router · gap_scan_read
type: formula
formula_id: formula.adjusted.devdispatcher.action.gap_scan_read
...
| Field | Value |
|-------|-------|
| Name | `router · gap_scan_read` |
| Graph node | `formula.adjusted.devdispatcher.action.gap_scan_read` |
| Kind | dispatcher_router |
