---
title: Formula — router · quality
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.quality
...
|-------|-------|
| Name | `router · quality` |
| Graph node | `formula.adjusted.qualitydispatcher.action.quality` |
| Kind | dispatcher_router |
