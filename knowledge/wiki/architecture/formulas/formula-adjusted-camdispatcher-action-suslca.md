---
title: Formula — router · susLCA
type: formula
formula_id: formula.adjusted.camdispatcher.action.suslca
...
|-------|-------|
| Name | `router · susLCA` |
| Graph node | `formula.adjusted.camdispatcher.action.suslca` |
| Kind | dispatcher_router |
