---
title: Formula — router · dlt_validate
type: formula
formula_id: formula.adjusted.devdispatcher.action.dlt_validate
...
| Field | Value |
|-------|-------|
| Name | `router · dlt_validate` |
| Graph node | `formula.adjusted.devdispatcher.action.dlt_validate` |
| Kind | dispatcher_router |
