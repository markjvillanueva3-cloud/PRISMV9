---
title: Formula — router · thinWireDerate
type: formula
formula_id: formula.adjusted.edmdispatcher.action.thinwirederate
...
| Field | Value |
|-------|-------|
| Name | `router · thinWireDerate` |
| Graph node | `formula.adjusted.edmdispatcher.action.thinwirederate` |
| Kind | dispatcher_router |
