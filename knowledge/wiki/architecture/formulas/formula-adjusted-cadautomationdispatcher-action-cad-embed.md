---
title: Formula — router · cad_embed
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_embed
...
| Field | Value |
|-------|-------|
| Name | `router · cad_embed` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_embed` |
| Kind | dispatcher_router |
