---
title: Formula — router · milestone_delete
type: formula
formula_id: formula.adjusted.businessdispatcher.action.milestone_delete
...
# Formula — `router · milestone_delete`
...
| Field | Value |
|-------|-------|
| Name | `router · milestone_delete` |
| Graph node | `formula.adjusted.businessdispatcher.action.milestone_delete` |
| Kind | dispatcher_router |
