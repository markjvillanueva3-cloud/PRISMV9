---
title: Formula — router · wireDraw
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.wiredraw
...
| Field | Value |
|-------|-------|
| Name | `router · wireDraw` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.wiredraw` |
| Kind | dispatcher_router |
