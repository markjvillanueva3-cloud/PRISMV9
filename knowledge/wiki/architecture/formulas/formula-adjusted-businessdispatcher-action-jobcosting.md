---
title: Formula — router · jobCosting
type: formula
formula_id: formula.adjusted.businessdispatcher.action.jobcosting
...
| Field | Value |
|-------|-------|
| Name | `router · jobCosting` |
| Graph node | `formula.adjusted.businessdispatcher.action.jobcosting` |
| Kind | dispatcher_router |
