---
title: Formula — router · analytics_record
type: formula
formula_id: formula.adjusted.businessdispatcher.action.analytics_record
...
# Formula — `router · analytics_record`
...
| Field | Value |
|-------|-------|
| Name | `router · analytics_record` |
| Graph node | `formula.adjusted.businessdispatcher.action.analytics_record` |
| Kind | dispatcher_router |
