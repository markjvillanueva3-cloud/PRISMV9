---
title: Formula — router · postLibraryCatalog
type: formula
formula_id: formula.adjusted.camdispatcher.action.postlibrarycatalog
...
# Formula — `router · postLibraryCatalog`
...
| Field | Value |
|-------|-------|
| Name | `router · postLibraryCatalog` |
| Graph node | `formula.adjusted.camdispatcher.action.postlibrarycatalog` |
| Kind | dispatcher_router |
