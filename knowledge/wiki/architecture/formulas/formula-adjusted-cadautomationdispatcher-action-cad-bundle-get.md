---
title: Formula — router · cad_bundle_get
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_bundle_get
...
| Field | Value |
|-------|-------|
| Name | `router · cad_bundle_get` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_bundle_get` |
| Kind | dispatcher_router |
