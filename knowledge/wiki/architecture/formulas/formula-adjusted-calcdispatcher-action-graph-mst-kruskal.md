---
title: Formula — router · graph_mst_kruskal
type: formula
formula_id: formula.adjusted.calcdispatcher.action.graph_mst_kruskal
...
# Formula — `router · graph_mst_kruskal`
...
| Field | Value |
|-------|-------|
| Name | `router · graph_mst_kruskal` |
| Graph node | `formula.adjusted.calcdispatcher.action.graph_mst_kruskal` |
| Kind | dispatcher_router |
