---
title: Formula — router · impeller_validate
type: formula
formula_id: formula.adjusted.caddispatcher.action.impeller_validate
...
# Formula — `router · impeller_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · impeller_validate` |
| Graph node | `formula.adjusted.caddispatcher.action.impeller_validate` |
| Kind | dispatcher_router |
