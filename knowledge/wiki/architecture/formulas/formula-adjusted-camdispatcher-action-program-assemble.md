---
title: Formula — router · program_assemble
type: formula
formula_id: formula.adjusted.camdispatcher.action.program_assemble
...
# Formula — `router · program_assemble`
...
| Field | Value |
|-------|-------|
| Name | `router · program_assemble` |
| Graph node | `formula.adjusted.camdispatcher.action.program_assemble` |
| Kind | dispatcher_router |
