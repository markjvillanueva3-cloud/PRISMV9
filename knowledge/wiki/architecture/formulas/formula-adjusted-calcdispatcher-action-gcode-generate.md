---
title: Formula — router · gcode_generate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gcode_generate
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_generate` |
| Graph node | `formula.adjusted.calcdispatcher.action.gcode_generate` |
| Kind | dispatcher_router |
