---
title: Formula — router · dfm_analyze
type: formula
formula_id: formula.adjusted.caddispatcher.action.dfm_analyze
...
| Field | Value |
|-------|-------|
| Name | `router · dfm_analyze` |
| Graph node | `formula.adjusted.caddispatcher.action.dfm_analyze` |
| Kind | dispatcher_router |
