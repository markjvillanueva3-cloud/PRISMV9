---
title: Formula — router · action_search
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.action_search
...
| Field | Value |
|-------|-------|
| Name | `router · action_search` |
| Graph node | `formula.adjusted.sessiondispatcher.action.action_search` |
| Kind | dispatcher_router |
