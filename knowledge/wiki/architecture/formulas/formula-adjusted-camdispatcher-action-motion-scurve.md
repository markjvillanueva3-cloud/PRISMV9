---
title: Formula — router · motion_scurve
type: formula
formula_id: formula.adjusted.camdispatcher.action.motion_scurve
...
| Field | Value |
|-------|-------|
| Name | `router · motion_scurve` |
| Graph node | `formula.adjusted.camdispatcher.action.motion_scurve` |
| Kind | dispatcher_router |
