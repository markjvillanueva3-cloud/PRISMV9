---
title: Formula — router · aiReasoning
type: formula
formula_id: formula.adjusted.aireasoningdispatcher
...
| Field | Value |
|-------|-------|
| Name | `router · aiReasoning` |
| Graph node | `formula.adjusted.aireasoningdispatcher` |
| Kind | dispatcher_router |
