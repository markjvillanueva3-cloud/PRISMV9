---
title: Formula — router · assembly_position
type: formula
formula_id: formula.adjusted.caddispatcher.action.assembly_position
...
# Formula — `router · assembly_position`
...
| Field | Value |
|-------|-------|
| Name | `router · assembly_position` |
| Graph node | `formula.adjusted.caddispatcher.action.assembly_position` |
| Kind | dispatcher_router |
