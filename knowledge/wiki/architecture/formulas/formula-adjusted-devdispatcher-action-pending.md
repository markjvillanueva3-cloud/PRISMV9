---
title: Formula — router · pending
type: formula
formula_id: formula.adjusted.devdispatcher.action.pending
...
|-------|-------|
| Name | `router · pending` |
| Graph node | `formula.adjusted.devdispatcher.action.pending` |
| Kind | dispatcher_router |
