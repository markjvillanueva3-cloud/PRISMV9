---
title: Formula — router · post_chip_thinning
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_chip_thinning
...
# Formula — `router · post_chip_thinning`
...
| Field | Value |
|-------|-------|
| Name | `router · post_chip_thinning` |
| Graph node | `formula.adjusted.camdispatcher.action.post_chip_thinning` |
| Kind | dispatcher_router |
