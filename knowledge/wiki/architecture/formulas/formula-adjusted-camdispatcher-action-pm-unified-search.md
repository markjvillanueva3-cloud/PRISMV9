---
title: Formula — router · pm_unified_search
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_unified_search
...
# Formula — `router · pm_unified_search`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_unified_search` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_unified_search` |
| Kind | dispatcher_router |
