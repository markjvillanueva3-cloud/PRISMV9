---
title: Formula — router · f360_live_sketch
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_sketch
...
# Formula — `router · f360_live_sketch`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_sketch` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_sketch` |
| Kind | dispatcher_router |
