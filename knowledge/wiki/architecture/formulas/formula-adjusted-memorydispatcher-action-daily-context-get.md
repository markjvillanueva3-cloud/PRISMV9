---
title: Formula — router · daily_context_get
type: formula
formula_id: formula.adjusted.memorydispatcher.action.daily_context_get
...
# Formula — `router · daily_context_get`
...
| Field | Value |
|-------|-------|
| Name | `router · daily_context_get` |
| Graph node | `formula.adjusted.memorydispatcher.action.daily_context_get` |
| Kind | dispatcher_router |
