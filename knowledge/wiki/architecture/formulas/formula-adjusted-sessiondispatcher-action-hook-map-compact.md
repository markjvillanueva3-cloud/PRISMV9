---
title: Formula — router · hook_map_compact
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.hook_map_compact
...
# Formula — `router · hook_map_compact`
...
| Field | Value |
|-------|-------|
| Name | `router · hook_map_compact` |
| Graph node | `formula.adjusted.sessiondispatcher.action.hook_map_compact` |
| Kind | dispatcher_router |
