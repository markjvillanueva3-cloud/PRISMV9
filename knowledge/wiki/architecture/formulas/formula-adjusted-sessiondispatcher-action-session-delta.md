---
title: Formula — router · session_delta
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.session_delta
...
| Field | Value |
|-------|-------|
| Name | `router · session_delta` |
| Graph node | `formula.adjusted.sessiondispatcher.action.session_delta` |
| Kind | dispatcher_router |
