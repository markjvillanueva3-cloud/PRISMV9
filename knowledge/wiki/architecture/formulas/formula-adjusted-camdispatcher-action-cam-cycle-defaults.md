---
title: Formula — router · cam_cycle_defaults
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_cycle_defaults
...
# Formula — `router · cam_cycle_defaults`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_cycle_defaults` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_cycle_defaults` |
| Kind | dispatcher_router |
