---
title: Formula — router · aco_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.aco_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · aco_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.aco_optimize` |
| Kind | dispatcher_router |
