---
title: Formula — router · import_learning
type: formula
formula_id: formula.adjusted.calcdispatcher.action.import_learning
...
# Formula — `router · import_learning`
...
| Field | Value |
|-------|-------|
| Name | `router · import_learning` |
| Graph node | `formula.adjusted.calcdispatcher.action.import_learning` |
| Kind | dispatcher_router |
