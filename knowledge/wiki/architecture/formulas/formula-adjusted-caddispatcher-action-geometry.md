---
title: Formula — router · geometry
type: formula
formula_id: formula.adjusted.caddispatcher.action.geometry
...
| Graph node | `formula.adjusted.caddispatcher.action.geometry` |
| Kind | dispatcher_router |
