---
title: Formula — router · pso_minimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.pso_minimize
...
| Field | Value |
|-------|-------|
| Name | `router · pso_minimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.pso_minimize` |
| Kind | dispatcher_router |
