---
title: Formula — router · geoCompare
type: formula
formula_id: formula.adjusted.caddispatcher.action.geocompare
...
| Field | Value |
|-------|-------|
| Name | `router · geoCompare` |
| Graph node | `formula.adjusted.caddispatcher.action.geocompare` |
| Kind | dispatcher_router |
