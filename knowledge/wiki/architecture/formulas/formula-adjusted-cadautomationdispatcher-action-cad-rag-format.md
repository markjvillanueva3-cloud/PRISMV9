---
title: Formula — router · cad_rag_format
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_rag_format
...
| Field | Value |
|-------|-------|
| Name | `router · cad_rag_format` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_rag_format` |
| Kind | dispatcher_router |
