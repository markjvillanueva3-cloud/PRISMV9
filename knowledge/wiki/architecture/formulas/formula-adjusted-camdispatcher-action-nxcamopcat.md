---
title: Formula — router · nxCAMOpCat
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcamopcat
...
| Field | Value |
|-------|-------|
| Name | `router · nxCAMOpCat` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcamopcat` |
| Kind | dispatcher_router |
