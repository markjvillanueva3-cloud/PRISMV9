---
title: Formula — router · dfm_quick
type: formula
formula_id: formula.adjusted.caddispatcher.action.dfm_quick
...
| Field | Value |
|-------|-------|
| Name | `router · dfm_quick` |
| Graph node | `formula.adjusted.caddispatcher.action.dfm_quick` |
| Kind | dispatcher_router |
