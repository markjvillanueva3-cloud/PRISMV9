---
title: Formula — router · fs_navigate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fs_navigate
...
| Field | Value |
|-------|-------|
| Name | `router · fs_navigate` |
| Graph node | `formula.adjusted.calcdispatcher.action.fs_navigate` |
| Kind | dispatcher_router |
