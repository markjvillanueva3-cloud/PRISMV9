---
title: Formula — router · actualCost
type: formula
formula_id: formula.adjusted.businessdispatcher.action.actualcost
...
| Field | Value |
|-------|-------|
| Name | `router · actualCost` |
| Graph node | `formula.adjusted.businessdispatcher.action.actualcost` |
| Kind | dispatcher_router |
