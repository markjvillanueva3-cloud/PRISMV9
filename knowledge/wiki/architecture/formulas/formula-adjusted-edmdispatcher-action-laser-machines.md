---
title: Formula — router · laser_machines
type: formula
formula_id: formula.adjusted.edmdispatcher.action.laser_machines
...
| Field | Value |
|-------|-------|
| Name | `router · laser_machines` |
| Graph node | `formula.adjusted.edmdispatcher.action.laser_machines` |
| Kind | dispatcher_router |
