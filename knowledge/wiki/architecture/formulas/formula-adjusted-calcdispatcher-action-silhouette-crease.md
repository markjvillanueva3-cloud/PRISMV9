---
title: Formula — router · silhouette_crease
type: formula
formula_id: formula.adjusted.calcdispatcher.action.silhouette_crease
...
# Formula — `router · silhouette_crease`
...
| Field | Value |
|-------|-------|
| Name | `router · silhouette_crease` |
| Graph node | `formula.adjusted.calcdispatcher.action.silhouette_crease` |
| Kind | dispatcher_router |
