---
title: Formula — router · voxel_init
type: formula
formula_id: formula.adjusted.calcdispatcher.action.voxel_init
...
| Field | Value |
|-------|-------|
| Name | `router · voxel_init` |
| Graph node | `formula.adjusted.calcdispatcher.action.voxel_init` |
| Kind | dispatcher_router |
