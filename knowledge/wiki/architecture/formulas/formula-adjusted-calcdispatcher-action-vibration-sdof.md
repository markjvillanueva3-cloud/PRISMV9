---
title: Formula — router · vibration_sdof
type: formula
formula_id: formula.adjusted.calcdispatcher.action.vibration_sdof
...
| Field | Value |
|-------|-------|
| Name | `router · vibration_sdof` |
| Graph node | `formula.adjusted.calcdispatcher.action.vibration_sdof` |
| Kind | dispatcher_router |
