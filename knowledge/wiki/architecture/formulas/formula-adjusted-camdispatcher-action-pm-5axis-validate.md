---
title: Formula — router · pm_5axis_validate
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_5axis_validate
...
# Formula — `router · pm_5axis_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_5axis_validate` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_5axis_validate` |
| Kind | dispatcher_router |
