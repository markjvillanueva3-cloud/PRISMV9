---
title: Formula — router · cycleTimeEst
type: formula
formula_id: formula.adjusted.camdispatcher.action.cycletimeest
...
| Field | Value |
|-------|-------|
| Name | `router · cycleTimeEst` |
| Graph node | `formula.adjusted.camdispatcher.action.cycletimeest` |
| Kind | dispatcher_router |
