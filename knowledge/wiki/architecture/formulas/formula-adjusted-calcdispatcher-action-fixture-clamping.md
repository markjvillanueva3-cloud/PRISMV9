---
title: Formula — router · fixture_clamping
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fixture_clamping
...
# Formula — `router · fixture_clamping`
...
| Field | Value |
|-------|-------|
| Name | `router · fixture_clamping` |
| Graph node | `formula.adjusted.calcdispatcher.action.fixture_clamping` |
| Kind | dispatcher_router |
