---
title: Formula — router · thermal_expansion
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thermal_expansion
...
# Formula — `router · thermal_expansion`
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_expansion` |
| Graph node | `formula.adjusted.calcdispatcher.action.thermal_expansion` |
| Kind | dispatcher_router |
