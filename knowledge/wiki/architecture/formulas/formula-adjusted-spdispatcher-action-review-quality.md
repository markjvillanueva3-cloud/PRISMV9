---
title: Formula — router · review_quality
type: formula
formula_id: formula.adjusted.spdispatcher.action.review_quality
...
| Field | Value |
|-------|-------|
| Name | `router · review_quality` |
| Graph node | `formula.adjusted.spdispatcher.action.review_quality` |
| Kind | dispatcher_router |
