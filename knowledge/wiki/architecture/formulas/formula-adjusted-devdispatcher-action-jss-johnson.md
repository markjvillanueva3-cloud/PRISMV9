---
title: Formula — router · jss_johnson
type: formula
formula_id: formula.adjusted.devdispatcher.action.jss_johnson
...
| Field | Value |
|-------|-------|
| Name | `router · jss_johnson` |
| Graph node | `formula.adjusted.devdispatcher.action.jss_johnson` |
| Kind | dispatcher_router |
