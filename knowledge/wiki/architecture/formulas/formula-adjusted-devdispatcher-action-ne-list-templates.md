---
title: Formula — router · ne_list_templates
type: formula
formula_id: formula.adjusted.devdispatcher.action.ne_list_templates
...
# Formula — `router · ne_list_templates`
...
| Field | Value |
|-------|-------|
| Name | `router · ne_list_templates` |
| Graph node | `formula.adjusted.devdispatcher.action.ne_list_templates` |
| Kind | dispatcher_router |
