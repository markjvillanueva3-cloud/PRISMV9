---
title: Formula — router · setupSheet
type: formula
formula_id: formula.adjusted.camdispatcher.action.setupsheet
...
| Field | Value |
|-------|-------|
| Name | `router · setupSheet` |
| Graph node | `formula.adjusted.camdispatcher.action.setupsheet` |
| Kind | dispatcher_router |
