---
title: Formula — router · fleet_aggregate
type: formula
formula_id: formula.adjusted.camdispatcher.action.fleet_aggregate
...
# Formula — `router · fleet_aggregate`
...
| Field | Value |
|-------|-------|
| Name | `router · fleet_aggregate` |
| Graph node | `formula.adjusted.camdispatcher.action.fleet_aggregate` |
| Kind | dispatcher_router |
