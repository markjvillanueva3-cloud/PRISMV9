---
title: Formula — router · post_get_presets
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_get_presets
...
# Formula — `router · post_get_presets`
...
| Field | Value |
|-------|-------|
| Name | `router · post_get_presets` |
| Graph node | `formula.adjusted.camdispatcher.action.post_get_presets` |
| Kind | dispatcher_router |
