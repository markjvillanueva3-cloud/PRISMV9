---
title: Formula — router · tool_call_analyze
type: formula
formula_id: formula.adjusted.devdispatcher.action.tool_call_analyze
...
# Formula — `router · tool_call_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_call_analyze` |
| Graph node | `formula.adjusted.devdispatcher.action.tool_call_analyze` |
| Kind | dispatcher_router |
