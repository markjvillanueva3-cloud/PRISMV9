---
title: Formula — router · chip_load
type: formula
formula_id: formula.adjusted.calcdispatcher.action.chip_load
...
| Field | Value |
|-------|-------|
| Name | `router · chip_load` |
| Graph node | `formula.adjusted.calcdispatcher.action.chip_load` |
| Kind | dispatcher_router |
