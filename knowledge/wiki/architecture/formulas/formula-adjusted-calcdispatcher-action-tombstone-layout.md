---
title: Formula — router · tombstone_layout
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tombstone_layout
...
# Formula — `router · tombstone_layout`
...
| Field | Value |
|-------|-------|
| Name | `router · tombstone_layout` |
| Graph node | `formula.adjusted.calcdispatcher.action.tombstone_layout` |
| Kind | dispatcher_router |
