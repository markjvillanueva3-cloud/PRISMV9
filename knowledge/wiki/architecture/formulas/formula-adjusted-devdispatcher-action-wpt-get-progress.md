---
title: Formula — router · wpt_get_progress
type: formula
formula_id: formula.adjusted.devdispatcher.action.wpt_get_progress
...
# Formula — `router · wpt_get_progress`
...
| Field | Value |
|-------|-------|
| Name | `router · wpt_get_progress` |
| Graph node | `formula.adjusted.devdispatcher.action.wpt_get_progress` |
| Kind | dispatcher_router |
