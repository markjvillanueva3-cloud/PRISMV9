---
title: Formula — router · cam_cost_feature
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_cost_feature
...
# Formula — `router · cam_cost_feature`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_cost_feature` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_cost_feature` |
| Kind | dispatcher_router |
