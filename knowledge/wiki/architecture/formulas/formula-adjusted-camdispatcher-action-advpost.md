---
title: Formula — router · advPost
type: formula
formula_id: formula.adjusted.camdispatcher.action.advpost
...
|-------|-------|
| Name | `router · advPost` |
| Graph node | `formula.adjusted.camdispatcher.action.advpost` |
| Kind | dispatcher_router |
