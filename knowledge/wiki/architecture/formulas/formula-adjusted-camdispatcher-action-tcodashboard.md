---
title: Formula — router · tcoDashboard
type: formula
formula_id: formula.adjusted.camdispatcher.action.tcodashboard
...
| Field | Value |
|-------|-------|
| Name | `router · tcoDashboard` |
| Graph node | `formula.adjusted.camdispatcher.action.tcodashboard` |
| Kind | dispatcher_router |
