---
title: Formula — router · printToEsprit
type: formula
formula_id: formula.adjusted.caddispatcher.action.printtoesprit
...
| Field | Value |
|-------|-------|
| Name | `router · printToEsprit` |
| Graph node | `formula.adjusted.caddispatcher.action.printtoesprit` |
| Kind | dispatcher_router |
