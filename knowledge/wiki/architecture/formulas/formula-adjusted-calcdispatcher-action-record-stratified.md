---
title: Formula — router · record_stratified
type: formula
formula_id: formula.adjusted.calcdispatcher.action.record_stratified
...
# Formula — `router · record_stratified`
...
| Field | Value |
|-------|-------|
| Name | `router · record_stratified` |
| Graph node | `formula.adjusted.calcdispatcher.action.record_stratified` |
| Kind | dispatcher_router |
