---
title: Formula — router · fda_get_signature
type: formula
formula_id: formula.adjusted.devdispatcher.action.fda_get_signature
...
# Formula — `router · fda_get_signature`
...
| Field | Value |
|-------|-------|
| Name | `router · fda_get_signature` |
| Graph node | `formula.adjusted.devdispatcher.action.fda_get_signature` |
| Kind | dispatcher_router |
