---
title: Formula — router · sketch_create
type: formula
formula_id: formula.adjusted.caddispatcher.action.sketch_create
...
| Field | Value |
|-------|-------|
| Name | `router · sketch_create` |
| Graph node | `formula.adjusted.caddispatcher.action.sketch_create` |
| Kind | dispatcher_router |
