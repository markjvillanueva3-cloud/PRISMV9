---
title: Formula — router · hmMultiAxis
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmmultiaxis
...
| Field | Value |
|-------|-------|
| Name | `router · hmMultiAxis` |
| Graph node | `formula.adjusted.camdispatcher.action.hmmultiaxis` |
| Kind | dispatcher_router |
