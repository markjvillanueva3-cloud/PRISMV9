---
title: Formula — router · dedup_bloom_check
type: formula
formula_id: formula.adjusted.devdispatcher.action.dedup_bloom_check
...
# Formula — `router · dedup_bloom_check`
...
| Field | Value |
|-------|-------|
| Name | `router · dedup_bloom_check` |
| Graph node | `formula.adjusted.devdispatcher.action.dedup_bloom_check` |
| Kind | dispatcher_router |
