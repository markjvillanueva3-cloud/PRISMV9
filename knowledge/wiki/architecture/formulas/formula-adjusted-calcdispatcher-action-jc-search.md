---
title: Formula — router · jc_search
type: formula
formula_id: formula.adjusted.calcdispatcher.action.jc_search
...
| Field | Value |
|-------|-------|
| Name | `router · jc_search` |
| Graph node | `formula.adjusted.calcdispatcher.action.jc_search` |
| Kind | dispatcher_router |
