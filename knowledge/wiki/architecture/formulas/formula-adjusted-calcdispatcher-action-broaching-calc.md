---
title: Formula — router · broaching_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.broaching_calc
...
| Field | Value |
|-------|-------|
| Name | `router · broaching_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.broaching_calc` |
| Kind | dispatcher_router |
