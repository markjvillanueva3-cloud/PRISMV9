---
title: Formula — router · corpus_build_index
type: formula
formula_id: formula.adjusted.caddispatcher.action.corpus_build_index
...
# Formula — `router · corpus_build_index`
...
| Field | Value |
|-------|-------|
| Name | `router · corpus_build_index` |
| Graph node | `formula.adjusted.caddispatcher.action.corpus_build_index` |
| Kind | dispatcher_router |
