---
title: Formula — router · fit_analysis
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fit_analysis
...
| Field | Value |
|-------|-------|
| Name | `router · fit_analysis` |
| Graph node | `formula.adjusted.calcdispatcher.action.fit_analysis` |
| Kind | dispatcher_router |
