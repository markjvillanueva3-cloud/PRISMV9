---
title: Formula — router · employee_search
type: formula
formula_id: formula.adjusted.businessdispatcher.action.employee_search
...
# Formula — `router · employee_search`
...
| Field | Value |
|-------|-------|
| Name | `router · employee_search` |
| Graph node | `formula.adjusted.businessdispatcher.action.employee_search` |
| Kind | dispatcher_router |
