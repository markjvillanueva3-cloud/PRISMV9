---
title: Formula — router · anomaly_guard
type: formula
formula_id: formula.adjusted.calcdispatcher.action.anomaly_guard
...
| Field | Value |
|-------|-------|
| Name | `router · anomaly_guard` |
| Graph node | `formula.adjusted.calcdispatcher.action.anomaly_guard` |
| Kind | dispatcher_router |
