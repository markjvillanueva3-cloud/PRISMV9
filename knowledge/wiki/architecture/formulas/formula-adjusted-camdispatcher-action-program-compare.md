---
title: Formula — router · program_compare
type: formula
formula_id: formula.adjusted.camdispatcher.action.program_compare
...
# Formula — `router · program_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · program_compare` |
| Graph node | `formula.adjusted.camdispatcher.action.program_compare` |
| Kind | dispatcher_router |
