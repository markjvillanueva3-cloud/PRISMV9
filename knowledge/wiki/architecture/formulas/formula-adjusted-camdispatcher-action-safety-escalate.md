---
title: Formula — router · safety_escalate
type: formula
formula_id: formula.adjusted.camdispatcher.action.safety_escalate
...
# Formula — `router · safety_escalate`
...
| Field | Value |
|-------|-------|
| Name | `router · safety_escalate` |
| Graph node | `formula.adjusted.camdispatcher.action.safety_escalate` |
| Kind | dispatcher_router |
