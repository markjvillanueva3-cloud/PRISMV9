---
title: Formula — router · pdf_pipeline_read
type: formula
formula_id: formula.adjusted.devdispatcher.action.pdf_pipeline_read
...
# Formula — `router · pdf_pipeline_read`
...
| Field | Value |
|-------|-------|
| Name | `router · pdf_pipeline_read` |
| Graph node | `formula.adjusted.devdispatcher.action.pdf_pipeline_read` |
| Kind | dispatcher_router |
