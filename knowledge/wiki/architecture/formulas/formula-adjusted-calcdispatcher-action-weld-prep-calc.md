---
title: Formula — router · weld_prep_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.weld_prep_calc
...
| Field | Value |
|-------|-------|
| Name | `router · weld_prep_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.weld_prep_calc` |
| Kind | dispatcher_router |
