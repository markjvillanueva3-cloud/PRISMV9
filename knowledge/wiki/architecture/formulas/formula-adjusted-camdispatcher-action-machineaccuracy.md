---
title: Formula — router · machineAccuracy
type: formula
formula_id: formula.adjusted.camdispatcher.action.machineaccuracy
...
# Formula — `router · machineAccuracy`
...
| Field | Value |
|-------|-------|
| Name | `router · machineAccuracy` |
| Graph node | `formula.adjusted.camdispatcher.action.machineaccuracy` |
| Kind | dispatcher_router |
