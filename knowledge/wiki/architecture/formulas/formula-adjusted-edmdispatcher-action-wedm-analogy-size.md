---
title: Formula — router · wedm_analogy_size
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_analogy_size
...
# Formula — `router · wedm_analogy_size`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_analogy_size` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_analogy_size` |
| Kind | dispatcher_router |
