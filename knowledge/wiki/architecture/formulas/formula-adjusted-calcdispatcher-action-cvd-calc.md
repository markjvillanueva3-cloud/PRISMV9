---
title: Formula — router · cvd_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cvd_calc
...
| Field | Value |
|-------|-------|
| Name | `router · cvd_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.cvd_calc` |
| Kind | dispatcher_router |
