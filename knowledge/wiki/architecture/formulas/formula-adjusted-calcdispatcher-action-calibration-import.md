---
title: Formula — router · calibration_import
type: formula
formula_id: formula.adjusted.calcdispatcher.action.calibration_import
...
# Formula — `router · calibration_import`
...
| Field | Value |
|-------|-------|
| Name | `router · calibration_import` |
| Graph node | `formula.adjusted.calcdispatcher.action.calibration_import` |
| Kind | dispatcher_router |
