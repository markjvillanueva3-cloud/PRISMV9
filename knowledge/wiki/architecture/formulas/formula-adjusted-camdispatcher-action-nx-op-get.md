---
title: Formula — router · nx_op_get
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_op_get
...
| Field | Value |
|-------|-------|
| Name | `router · nx_op_get` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_op_get` |
| Kind | dispatcher_router |
