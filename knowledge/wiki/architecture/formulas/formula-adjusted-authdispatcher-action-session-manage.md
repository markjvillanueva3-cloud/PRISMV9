---
title: Formula — router · session_manage
type: formula
formula_id: formula.adjusted.authdispatcher.action.session_manage
...
| Field | Value |
|-------|-------|
| Name | `router · session_manage` |
| Graph node | `formula.adjusted.authdispatcher.action.session_manage` |
| Kind | dispatcher_router |
