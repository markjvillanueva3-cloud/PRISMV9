---
title: Formula — router · nxCAMStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcamstrategy
...
| Field | Value |
|-------|-------|
| Name | `router · nxCAMStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcamstrategy` |
| Kind | dispatcher_router |
