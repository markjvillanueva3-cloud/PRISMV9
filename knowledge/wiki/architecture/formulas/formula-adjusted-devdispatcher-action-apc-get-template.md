---
title: Formula — router · apc_get_template
type: formula
formula_id: formula.adjusted.devdispatcher.action.apc_get_template
...
# Formula — `router · apc_get_template`
...
| Field | Value |
|-------|-------|
| Name | `router · apc_get_template` |
| Graph node | `formula.adjusted.devdispatcher.action.apc_get_template` |
| Kind | dispatcher_router |
