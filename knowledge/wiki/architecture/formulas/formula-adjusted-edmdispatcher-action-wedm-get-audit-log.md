---
title: Formula — router · wedm_get_audit_log
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_get_audit_log
...
# Formula — `router · wedm_get_audit_log`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_get_audit_log` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_get_audit_log` |
| Kind | dispatcher_router |
