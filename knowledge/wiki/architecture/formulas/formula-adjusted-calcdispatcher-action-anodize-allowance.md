---
title: Formula — router · anodize_allowance
type: formula
formula_id: formula.adjusted.calcdispatcher.action.anodize_allowance
...
# Formula — `router · anodize_allowance`
...
| Field | Value |
|-------|-------|
| Name | `router · anodize_allowance` |
| Graph node | `formula.adjusted.calcdispatcher.action.anodize_allowance` |
| Kind | dispatcher_router |
