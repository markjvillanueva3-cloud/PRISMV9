---
title: Formula — router · timeline_add
type: formula
formula_id: formula.adjusted.businessdispatcher.action.timeline_add
...
| Field | Value |
|-------|-------|
| Name | `router · timeline_add` |
| Graph node | `formula.adjusted.businessdispatcher.action.timeline_add` |
| Kind | dispatcher_router |
