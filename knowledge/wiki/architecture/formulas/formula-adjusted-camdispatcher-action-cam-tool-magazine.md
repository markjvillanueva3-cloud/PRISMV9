---
title: Formula — router · cam_tool_magazine
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_tool_magazine
...
# Formula — `router · cam_tool_magazine`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_tool_magazine` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_tool_magazine` |
| Kind | dispatcher_router |
