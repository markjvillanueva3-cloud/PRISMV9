---
title: Formula — router · postTaxonomy
type: formula
formula_id: formula.adjusted.camdispatcher.action.posttaxonomy
...
| Field | Value |
|-------|-------|
| Name | `router · postTaxonomy` |
| Graph node | `formula.adjusted.camdispatcher.action.posttaxonomy` |
| Kind | dispatcher_router |
