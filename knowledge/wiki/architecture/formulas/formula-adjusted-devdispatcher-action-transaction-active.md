---
title: Formula — router · transaction_active
type: formula
formula_id: formula.adjusted.devdispatcher.action.transaction_active
...
# Formula — `router · transaction_active`
...
| Field | Value |
|-------|-------|
| Name | `router · transaction_active` |
| Graph node | `formula.adjusted.devdispatcher.action.transaction_active` |
| Kind | dispatcher_router |
