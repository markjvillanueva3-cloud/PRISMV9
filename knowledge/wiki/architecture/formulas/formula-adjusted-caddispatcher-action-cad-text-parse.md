---
title: Formula — router · cad_text_parse
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_text_parse
...
| Field | Value |
|-------|-------|
| Name | `router · cad_text_parse` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_text_parse` |
| Kind | dispatcher_router |
