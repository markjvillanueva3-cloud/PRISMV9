---
title: Formula — router · tool_sync_drift
type: formula
formula_id: formula.adjusted.camdispatcher.action.tool_sync_drift
...
# Formula — `router · tool_sync_drift`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_sync_drift` |
| Graph node | `formula.adjusted.camdispatcher.action.tool_sync_drift` |
| Kind | dispatcher_router |
