---
title: Formula — router · string
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.string
...
|-------|-------|
| Name | `router · string` |
| Graph node | `formula.adjusted.sessiondispatcher.action.string` |
| Kind | dispatcher_router |
