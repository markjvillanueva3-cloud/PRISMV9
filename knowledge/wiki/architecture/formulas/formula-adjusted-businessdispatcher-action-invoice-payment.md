---
title: Formula — router · invoice_payment
type: formula
formula_id: formula.adjusted.businessdispatcher.action.invoice_payment
...
# Formula — `router · invoice_payment`
...
| Field | Value |
|-------|-------|
| Name | `router · invoice_payment` |
| Graph node | `formula.adjusted.businessdispatcher.action.invoice_payment` |
| Kind | dispatcher_router |
