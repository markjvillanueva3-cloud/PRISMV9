---
title: Formula — router · cam_tooltip_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_tooltip_stats
...
# Formula — `router · cam_tooltip_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_tooltip_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_tooltip_stats` |
| Kind | dispatcher_router |
