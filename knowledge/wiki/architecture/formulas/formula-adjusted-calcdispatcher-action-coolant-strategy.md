---
title: Formula — router · coolant_strategy
type: formula
formula_id: formula.adjusted.calcdispatcher.action.coolant_strategy
...
# Formula — `router · coolant_strategy`
...
| Field | Value |
|-------|-------|
| Name | `router · coolant_strategy` |
| Graph node | `formula.adjusted.calcdispatcher.action.coolant_strategy` |
| Kind | dispatcher_router |
