---
title: Formula — router · taperTurning
type: formula
formula_id: formula.adjusted.cncopsdispatcher.action.taperturning
...
| Field | Value |
|-------|-------|
| Name | `router · taperTurning` |
| Graph node | `formula.adjusted.cncopsdispatcher.action.taperturning` |
| Kind | dispatcher_router |
