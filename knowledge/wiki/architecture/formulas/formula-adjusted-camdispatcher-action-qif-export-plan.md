---
title: Formula — router · qif_export_plan
type: formula
formula_id: formula.adjusted.camdispatcher.action.qif_export_plan
...
# Formula — `router · qif_export_plan`
...
| Field | Value |
|-------|-------|
| Name | `router · qif_export_plan` |
| Graph node | `formula.adjusted.camdispatcher.action.qif_export_plan` |
| Kind | dispatcher_router |
