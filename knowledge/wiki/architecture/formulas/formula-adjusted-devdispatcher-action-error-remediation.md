---
title: Formula — router · error_remediation
type: formula
formula_id: formula.adjusted.devdispatcher.action.error_remediation
...
# Formula — `router · error_remediation`
...
| Field | Value |
|-------|-------|
| Name | `router · error_remediation` |
| Graph node | `formula.adjusted.devdispatcher.action.error_remediation` |
| Kind | dispatcher_router |
