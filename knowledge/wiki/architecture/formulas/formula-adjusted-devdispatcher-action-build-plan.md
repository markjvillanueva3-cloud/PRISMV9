---
title: Formula — router · build_plan
type: formula
formula_id: formula.adjusted.devdispatcher.action.build_plan
...
| Field | Value |
|-------|-------|
| Name | `router · build_plan` |
| Graph node | `formula.adjusted.devdispatcher.action.build_plan` |
| Kind | dispatcher_router |
