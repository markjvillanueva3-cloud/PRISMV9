---
title: Formula — router · cam_dl_decide
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_dl_decide
...
| Field | Value |
|-------|-------|
| Name | `router · cam_dl_decide` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_dl_decide` |
| Kind | dispatcher_router |
