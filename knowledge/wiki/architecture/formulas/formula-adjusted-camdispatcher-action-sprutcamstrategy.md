---
title: Formula — router · sprutCAMStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.sprutcamstrategy
...
# Formula — `router · sprutCAMStrategy`
...
| Field | Value |
|-------|-------|
| Name | `router · sprutCAMStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.sprutcamstrategy` |
| Kind | dispatcher_router |
