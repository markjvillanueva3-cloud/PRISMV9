---
title: Formula — router · workflow_pending
type: formula
formula_id: formula.adjusted.businessdispatcher.action.workflow_pending
...
# Formula — `router · workflow_pending`
...
| Field | Value |
|-------|-------|
| Name | `router · workflow_pending` |
| Graph node | `formula.adjusted.businessdispatcher.action.workflow_pending` |
| Kind | dispatcher_router |
