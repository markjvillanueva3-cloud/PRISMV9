---
title: Formula — router · poll_all
type: formula
formula_id: formula.adjusted.devdispatcher.action.poll_all
...
| Field | Value |
|-------|-------|
| Name | `router · poll_all` |
| Graph node | `formula.adjusted.devdispatcher.action.poll_all` |
| Kind | dispatcher_router |
