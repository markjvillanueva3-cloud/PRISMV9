---
title: Formula — router · mcfi_algorithms
type: formula
formula_id: formula.adjusted.devdispatcher.action.mcfi_algorithms
...
# Formula — `router · mcfi_algorithms`
...
| Field | Value |
|-------|-------|
| Name | `router · mcfi_algorithms` |
| Graph node | `formula.adjusted.devdispatcher.action.mcfi_algorithms` |
| Kind | dispatcher_router |
