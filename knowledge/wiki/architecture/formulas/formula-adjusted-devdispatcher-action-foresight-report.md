---
title: Formula — router · foresight_report
type: formula
formula_id: formula.adjusted.devdispatcher.action.foresight_report
...
# Formula — `router · foresight_report`
...
| Field | Value |
|-------|-------|
| Name | `router · foresight_report` |
| Graph node | `formula.adjusted.devdispatcher.action.foresight_report` |
| Kind | dispatcher_router |
