---
title: Formula — router · reorient_reset
type: formula
formula_id: formula.adjusted.devdispatcher.action.reorient_reset
...
| Field | Value |
|-------|-------|
| Name | `router · reorient_reset` |
| Graph node | `formula.adjusted.devdispatcher.action.reorient_reset` |
| Kind | dispatcher_router |
