---
title: Formula — router · stale_segment_mark
type: formula
formula_id: formula.adjusted.devdispatcher.action.stale_segment_mark
...
# Formula — `router · stale_segment_mark`
...
| Field | Value |
|-------|-------|
| Name | `router · stale_segment_mark` |
| Graph node | `formula.adjusted.devdispatcher.action.stale_segment_mark` |
| Kind | dispatcher_router |
