---
title: Formula — router · output_cache_reset
type: formula
formula_id: formula.adjusted.devdispatcher.action.output_cache_reset
...
# Formula — `router · output_cache_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · output_cache_reset` |
| Graph node | `formula.adjusted.devdispatcher.action.output_cache_reset` |
| Kind | dispatcher_router |
