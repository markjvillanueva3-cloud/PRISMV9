---
title: Formula — router · state_rollback
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.state_rollback
...
| Field | Value |
|-------|-------|
| Name | `router · state_rollback` |
| Graph node | `formula.adjusted.sessiondispatcher.action.state_rollback` |
| Kind | dispatcher_router |
