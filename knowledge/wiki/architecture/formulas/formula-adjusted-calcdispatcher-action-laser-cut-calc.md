---
title: Formula — router · laser_cut_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.laser_cut_calc
...
| Field | Value |
|-------|-------|
| Name | `router · laser_cut_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.laser_cut_calc` |
| Kind | dispatcher_router |
