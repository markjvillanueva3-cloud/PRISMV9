---
title: Formula — router · gse_active_count
type: formula
formula_id: formula.adjusted.devdispatcher.action.gse_active_count
...
# Formula — `router · gse_active_count`
...
| Field | Value |
|-------|-------|
| Name | `router · gse_active_count` |
| Graph node | `formula.adjusted.devdispatcher.action.gse_active_count` |
| Kind | dispatcher_router |
