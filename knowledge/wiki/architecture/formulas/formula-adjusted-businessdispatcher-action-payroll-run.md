---
title: Formula — router · payroll_run
type: formula
formula_id: formula.adjusted.businessdispatcher.action.payroll_run
...
| Field | Value |
|-------|-------|
| Name | `router · payroll_run` |
| Graph node | `formula.adjusted.businessdispatcher.action.payroll_run` |
| Kind | dispatcher_router |
