---
title: Formula — router · cam_func_route
type: formula
formula_id: formula.adjusted.camfunctiondispatcher.action.cam_func_route
...
| Field | Value |
|-------|-------|
| Name | `router · cam_func_route` |
| Graph node | `formula.adjusted.camfunctiondispatcher.action.cam_func_route` |
| Kind | dispatcher_router |
