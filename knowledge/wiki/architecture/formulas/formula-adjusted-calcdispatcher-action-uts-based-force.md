---
title: Formula — router · uts_based_force
type: formula
formula_id: formula.adjusted.calcdispatcher.action.uts_based_force
...
# Formula — `router · uts_based_force`
...
| Field | Value |
|-------|-------|
| Name | `router · uts_based_force` |
| Graph node | `formula.adjusted.calcdispatcher.action.uts_based_force` |
| Kind | dispatcher_router |
