---
title: Formula — router · scheduling
type: formula
formula_id: formula.adjusted.businessdispatcher.action.scheduling
...
| Field | Value |
|-------|-------|
| Name | `router · scheduling` |
| Graph node | `formula.adjusted.businessdispatcher.action.scheduling` |
| Kind | dispatcher_router |
