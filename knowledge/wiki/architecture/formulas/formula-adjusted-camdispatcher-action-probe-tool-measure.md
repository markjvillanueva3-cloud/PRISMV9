---
title: Formula — router · probe_tool_measure
type: formula
formula_id: formula.adjusted.camdispatcher.action.probe_tool_measure
...
# Formula — `router · probe_tool_measure`
...
| Field | Value |
|-------|-------|
| Name | `router · probe_tool_measure` |
| Graph node | `formula.adjusted.camdispatcher.action.probe_tool_measure` |
| Kind | dispatcher_router |
