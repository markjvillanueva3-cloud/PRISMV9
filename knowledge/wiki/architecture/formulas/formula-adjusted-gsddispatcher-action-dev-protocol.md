---
title: Formula — router · dev_protocol
type: formula
formula_id: formula.adjusted.gsddispatcher.action.dev_protocol
...
| Field | Value |
|-------|-------|
| Name | `router · dev_protocol` |
| Graph node | `formula.adjusted.gsddispatcher.action.dev_protocol` |
| Kind | dispatcher_router |
