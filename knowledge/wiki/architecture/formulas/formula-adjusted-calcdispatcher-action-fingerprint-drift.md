---
title: Formula — router · fingerprint_drift
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fingerprint_drift
...
# Formula — `router · fingerprint_drift`
...
| Field | Value |
|-------|-------|
| Name | `router · fingerprint_drift` |
| Graph node | `formula.adjusted.calcdispatcher.action.fingerprint_drift` |
| Kind | dispatcher_router |
