---
title: Formula — router · thread_mill_params
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thread_mill_params
...
# Formula — `router · thread_mill_params`
...
| Field | Value |
|-------|-------|
| Name | `router · thread_mill_params` |
| Graph node | `formula.adjusted.calcdispatcher.action.thread_mill_params` |
| Kind | dispatcher_router |
