---
title: Formula — router · wavelet_transform
type: formula
formula_id: formula.adjusted.calcdispatcher.action.wavelet_transform
...
# Formula — `router · wavelet_transform`
...
| Field | Value |
|-------|-------|
| Name | `router · wavelet_transform` |
| Graph node | `formula.adjusted.calcdispatcher.action.wavelet_transform` |
| Kind | dispatcher_router |
