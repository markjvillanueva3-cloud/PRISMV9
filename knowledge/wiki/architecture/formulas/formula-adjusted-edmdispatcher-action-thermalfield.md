---
title: Formula — router · thermalField
type: formula
formula_id: formula.adjusted.edmdispatcher.action.thermalfield
...
| Field | Value |
|-------|-------|
| Name | `router · thermalField` |
| Graph node | `formula.adjusted.edmdispatcher.action.thermalfield` |
| Kind | dispatcher_router |
