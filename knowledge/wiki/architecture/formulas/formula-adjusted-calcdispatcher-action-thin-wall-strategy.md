---
title: Formula — router · thin_wall_strategy
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thin_wall_strategy
...
# Formula — `router · thin_wall_strategy`
...
| Field | Value |
|-------|-------|
| Name | `router · thin_wall_strategy` |
| Graph node | `formula.adjusted.calcdispatcher.action.thin_wall_strategy` |
| Kind | dispatcher_router |
