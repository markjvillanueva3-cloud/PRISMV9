---
title: Formula — router · auto_wiring_scan
type: formula
formula_id: formula.adjusted.devdispatcher.action.auto_wiring_scan
...
# Formula — `router · auto_wiring_scan`
...
| Field | Value |
|-------|-------|
| Name | `router · auto_wiring_scan` |
| Graph node | `formula.adjusted.devdispatcher.action.auto_wiring_scan` |
| Kind | dispatcher_router |
