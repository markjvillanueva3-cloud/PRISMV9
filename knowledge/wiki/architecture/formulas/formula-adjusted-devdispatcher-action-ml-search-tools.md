---
title: Formula — router · ml_search_tools
type: formula
formula_id: formula.adjusted.devdispatcher.action.ml_search_tools
...
# Formula — `router · ml_search_tools`
...
| Field | Value |
|-------|-------|
| Name | `router · ml_search_tools` |
| Graph node | `formula.adjusted.devdispatcher.action.ml_search_tools` |
| Kind | dispatcher_router |
