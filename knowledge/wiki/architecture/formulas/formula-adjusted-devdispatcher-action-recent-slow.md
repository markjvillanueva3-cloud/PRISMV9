---
title: Formula — router · recent_slow
type: formula
formula_id: formula.adjusted.devdispatcher.action.recent_slow
...
| Field | Value |
|-------|-------|
| Name | `router · recent_slow` |
| Graph node | `formula.adjusted.devdispatcher.action.recent_slow` |
| Kind | dispatcher_router |
