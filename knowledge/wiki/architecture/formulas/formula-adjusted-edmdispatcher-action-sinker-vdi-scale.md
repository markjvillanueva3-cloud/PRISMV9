---
title: Formula — router · sinker_vdi_scale
type: formula
formula_id: formula.adjusted.edmdispatcher.action.sinker_vdi_scale
...
# Formula — `router · sinker_vdi_scale`
...
| Field | Value |
|-------|-------|
| Name | `router · sinker_vdi_scale` |
| Graph node | `formula.adjusted.edmdispatcher.action.sinker_vdi_scale` |
| Kind | dispatcher_router |
