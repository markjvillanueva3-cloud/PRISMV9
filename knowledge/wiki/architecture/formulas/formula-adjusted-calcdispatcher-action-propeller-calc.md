---
title: Formula — router · propeller_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.propeller_calc
...
| Field | Value |
|-------|-------|
| Name | `router · propeller_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.propeller_calc` |
| Kind | dispatcher_router |
