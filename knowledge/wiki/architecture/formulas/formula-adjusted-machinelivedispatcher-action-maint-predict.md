---
title: Formula — router · maint_predict
type: formula
formula_id: formula.adjusted.machinelivedispatcher.action.maint_predict
...
| Field | Value |
|-------|-------|
| Name | `router · maint_predict` |
| Graph node | `formula.adjusted.machinelivedispatcher.action.maint_predict` |
| Kind | dispatcher_router |
