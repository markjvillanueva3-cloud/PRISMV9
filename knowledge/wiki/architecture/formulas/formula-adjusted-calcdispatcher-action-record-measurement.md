---
title: Formula — router · record_measurement
type: formula
formula_id: formula.adjusted.calcdispatcher.action.record_measurement
...
# Formula — `router · record_measurement`
...
| Field | Value |
|-------|-------|
| Name | `router · record_measurement` |
| Graph node | `formula.adjusted.calcdispatcher.action.record_measurement` |
| Kind | dispatcher_router |
