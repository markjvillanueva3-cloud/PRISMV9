---
title: Formula — router · harvest_piezo
type: formula
formula_id: formula.adjusted.calcdispatcher.action.harvest_piezo
...
| Field | Value |
|-------|-------|
| Name | `router · harvest_piezo` |
| Graph node | `formula.adjusted.calcdispatcher.action.harvest_piezo` |
| Kind | dispatcher_router |
