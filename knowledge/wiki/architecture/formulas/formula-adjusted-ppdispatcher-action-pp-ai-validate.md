---
title: Formula — router · pp_ai_validate
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_ai_validate
...
| Field | Value |
|-------|-------|
| Name | `router · pp_ai_validate` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_ai_validate` |
| Kind | dispatcher_router |
