---
title: Formula — router · osc_list_hot_jobs
type: formula
formula_id: formula.adjusted.devdispatcher.action.osc_list_hot_jobs
...
# Formula — `router · osc_list_hot_jobs`
...
| Field | Value |
|-------|-------|
| Name | `router · osc_list_hot_jobs` |
| Graph node | `formula.adjusted.devdispatcher.action.osc_list_hot_jobs` |
| Kind | dispatcher_router |
