---
title: Formula — router · physics_fusion
type: formula
formula_id: formula.adjusted.calcdispatcher.action.physics_fusion
...
| Field | Value |
|-------|-------|
| Name | `router · physics_fusion` |
| Graph node | `formula.adjusted.calcdispatcher.action.physics_fusion` |
| Kind | dispatcher_router |
