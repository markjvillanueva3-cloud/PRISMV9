---
title: Formula — router · flywheel_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.flywheel_calc
...
| Field | Value |
|-------|-------|
| Name | `router · flywheel_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.flywheel_calc` |
| Kind | dispatcher_router |
