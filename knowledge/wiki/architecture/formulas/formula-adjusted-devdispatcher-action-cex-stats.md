---
title: Formula — router · cex_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.cex_stats
...
| Field | Value |
|-------|-------|
| Name | `router · cex_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.cex_stats` |
| Kind | dispatcher_router |
