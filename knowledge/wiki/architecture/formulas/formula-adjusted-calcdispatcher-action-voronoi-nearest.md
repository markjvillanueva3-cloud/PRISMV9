---
title: Formula — router · voronoi_nearest
type: formula
formula_id: formula.adjusted.calcdispatcher.action.voronoi_nearest
...
# Formula — `router · voronoi_nearest`
...
| Field | Value |
|-------|-------|
| Name | `router · voronoi_nearest` |
| Graph node | `formula.adjusted.calcdispatcher.action.voronoi_nearest` |
| Kind | dispatcher_router |
