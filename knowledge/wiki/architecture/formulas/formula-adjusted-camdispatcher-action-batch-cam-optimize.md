---
title: Formula — router · batch_cam_optimize
type: formula
formula_id: formula.adjusted.camdispatcher.action.batch_cam_optimize
...
# Formula — `router · batch_cam_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · batch_cam_optimize` |
| Graph node | `formula.adjusted.camdispatcher.action.batch_cam_optimize` |
| Kind | dispatcher_router |
