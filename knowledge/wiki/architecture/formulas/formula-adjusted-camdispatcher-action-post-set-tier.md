---
title: Formula — router · post_set_tier
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_set_tier
...
| Field | Value |
|-------|-------|
| Name | `router · post_set_tier` |
| Graph node | `formula.adjusted.camdispatcher.action.post_set_tier` |
| Kind | dispatcher_router |
