---
title: Formula — router · cad_design_plan
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_design_plan
...
# Formula — `router · cad_design_plan`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_design_plan` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_design_plan` |
| Kind | dispatcher_router |
