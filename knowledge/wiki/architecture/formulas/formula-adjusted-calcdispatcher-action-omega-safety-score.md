---
title: Formula — router · omega_safety_score
type: formula
formula_id: formula.adjusted.calcdispatcher.action.omega_safety_score
...
# Formula — `router · omega_safety_score`
...
| Field | Value |
|-------|-------|
| Name | `router · omega_safety_score` |
| Graph node | `formula.adjusted.calcdispatcher.action.omega_safety_score` |
| Kind | dispatcher_router |
