---
title: Formula — router · constant_chip_load
type: formula
formula_id: formula.adjusted.calcdispatcher.action.constant_chip_load
...
# Formula — `router · constant_chip_load`
...
| Field | Value |
|-------|-------|
| Name | `router · constant_chip_load` |
| Graph node | `formula.adjusted.calcdispatcher.action.constant_chip_load` |
| Kind | dispatcher_router |
