---
title: Formula — router · scr_recommend
type: formula
formula_id: formula.adjusted.devdispatcher.action.scr_recommend
...
| Field | Value |
|-------|-------|
| Name | `router · scr_recommend` |
| Graph node | `formula.adjusted.devdispatcher.action.scr_recommend` |
| Kind | dispatcher_router |
