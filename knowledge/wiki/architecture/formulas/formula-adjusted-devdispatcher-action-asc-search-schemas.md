---
title: Formula — router · asc_search_schemas
type: formula
formula_id: formula.adjusted.devdispatcher.action.asc_search_schemas
...
# Formula — `router · asc_search_schemas`
...
| Field | Value |
|-------|-------|
| Name | `router · asc_search_schemas` |
| Graph node | `formula.adjusted.devdispatcher.action.asc_search_schemas` |
| Kind | dispatcher_router |
