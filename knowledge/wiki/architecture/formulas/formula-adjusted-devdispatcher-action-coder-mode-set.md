---
title: Formula — router · coder_mode_set
type: formula
formula_id: formula.adjusted.devdispatcher.action.coder_mode_set
...
| Field | Value |
|-------|-------|
| Name | `router · coder_mode_set` |
| Graph node | `formula.adjusted.devdispatcher.action.coder_mode_set` |
| Kind | dispatcher_router |
