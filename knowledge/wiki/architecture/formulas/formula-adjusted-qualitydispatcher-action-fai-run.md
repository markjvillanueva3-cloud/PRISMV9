---
title: Formula — router · fai_run
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.fai_run
...
|-------|-------|
| Name | `router · fai_run` |
| Graph node | `formula.adjusted.qualitydispatcher.action.fai_run` |
| Kind | dispatcher_router |
