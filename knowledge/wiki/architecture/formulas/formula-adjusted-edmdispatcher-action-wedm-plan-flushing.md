---
title: Formula — router · wedm_plan_flushing
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_plan_flushing
...
# Formula — `router · wedm_plan_flushing`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_plan_flushing` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_plan_flushing` |
| Kind | dispatcher_router |
