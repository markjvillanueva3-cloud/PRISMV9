---
title: Formula — router · wedm_gnn_save
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_gnn_save
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_gnn_save` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_gnn_save` |
| Kind | dispatcher_router |
