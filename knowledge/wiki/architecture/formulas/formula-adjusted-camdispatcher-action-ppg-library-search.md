---
title: Formula — router · ppg_library_search
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_library_search
...
# Formula — `router · ppg_library_search`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_library_search` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_library_search` |
| Kind | dispatcher_router |
