---
title: Formula — router · gdt_stackup
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gdt_stackup
...
| Field | Value |
|-------|-------|
| Name | `router · gdt_stackup` |
| Graph node | `formula.adjusted.calcdispatcher.action.gdt_stackup` |
| Kind | dispatcher_router |
