---
title: Formula — router · powerMillCtrlCat
type: formula
formula_id: formula.adjusted.camdispatcher.action.powermillctrlcat
...
# Formula — `router · powerMillCtrlCat`
...
| Field | Value |
|-------|-------|
| Name | `router · powerMillCtrlCat` |
| Graph node | `formula.adjusted.camdispatcher.action.powermillctrlcat` |
| Kind | dispatcher_router |
