---
title: Formula — router · api_webhook_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.api_webhook_list
...
# Formula — `router · api_webhook_list`
...
| Field | Value |
|-------|-------|
| Name | `router · api_webhook_list` |
| Graph node | `formula.adjusted.businessdispatcher.action.api_webhook_list` |
| Kind | dispatcher_router |
