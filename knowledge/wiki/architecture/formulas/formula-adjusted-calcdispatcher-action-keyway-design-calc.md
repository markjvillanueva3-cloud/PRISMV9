---
title: Formula — router · keyway_design_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.keyway_design_calc
...
# Formula — `router · keyway_design_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · keyway_design_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.keyway_design_calc` |
| Kind | dispatcher_router |
