---
title: Formula — router · peer_query
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.peer_query
...
| Field | Value |
|-------|-------|
| Name | `router · peer_query` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.peer_query` |
| Kind | dispatcher_router |
