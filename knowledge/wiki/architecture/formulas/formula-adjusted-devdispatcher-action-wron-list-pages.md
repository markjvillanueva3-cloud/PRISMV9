---
title: Formula — router · wron_list_pages
type: formula
formula_id: formula.adjusted.devdispatcher.action.wron_list_pages
...
# Formula — `router · wron_list_pages`
...
| Field | Value |
|-------|-------|
| Name | `router · wron_list_pages` |
| Graph node | `formula.adjusted.devdispatcher.action.wron_list_pages` |
| Kind | dispatcher_router |
