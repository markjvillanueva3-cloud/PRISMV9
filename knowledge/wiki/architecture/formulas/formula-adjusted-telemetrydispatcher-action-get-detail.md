---
title: Formula — router · get_detail
type: formula
formula_id: formula.adjusted.telemetrydispatcher.action.get_detail
...
| Field | Value |
|-------|-------|
| Name | `router · get_detail` |
| Graph node | `formula.adjusted.telemetrydispatcher.action.get_detail` |
| Kind | dispatcher_router |
