---
title: Formula — router · inventorGen
type: formula
formula_id: formula.adjusted.caddispatcher.action.inventorgen
...
| Field | Value |
|-------|-------|
| Name | `router · inventorGen` |
| Graph node | `formula.adjusted.caddispatcher.action.inventorgen` |
| Kind | dispatcher_router |
