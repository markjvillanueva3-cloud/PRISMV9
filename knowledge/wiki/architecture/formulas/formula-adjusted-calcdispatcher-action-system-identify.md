---
title: Formula — router · system_identify
type: formula
formula_id: formula.adjusted.calcdispatcher.action.system_identify
...
# Formula — `router · system_identify`
...
| Field | Value |
|-------|-------|
| Name | `router · system_identify` |
| Graph node | `formula.adjusted.calcdispatcher.action.system_identify` |
| Kind | dispatcher_router |
