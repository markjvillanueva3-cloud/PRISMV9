---
title: Formula — router · cad_rag_stats
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_rag_stats
...
| Field | Value |
|-------|-------|
| Name | `router · cad_rag_stats` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_rag_stats` |
| Kind | dispatcher_router |
