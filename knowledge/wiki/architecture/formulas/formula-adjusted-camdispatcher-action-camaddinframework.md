---
title: Formula — router · camAddInFramework
type: formula
formula_id: formula.adjusted.camdispatcher.action.camaddinframework
...
# Formula — `router · camAddInFramework`
...
| Field | Value |
|-------|-------|
| Name | `router · camAddInFramework` |
| Graph node | `formula.adjusted.camdispatcher.action.camaddinframework` |
| Kind | dispatcher_router |
