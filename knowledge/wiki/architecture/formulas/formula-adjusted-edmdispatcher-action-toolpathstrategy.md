---
title: Formula — router · toolpathStrategy
type: formula
formula_id: formula.adjusted.edmdispatcher.action.toolpathstrategy
...
# Formula — `router · toolpathStrategy`
...
| Field | Value |
|-------|-------|
| Name | `router · toolpathStrategy` |
| Graph node | `formula.adjusted.edmdispatcher.action.toolpathstrategy` |
| Kind | dispatcher_router |
