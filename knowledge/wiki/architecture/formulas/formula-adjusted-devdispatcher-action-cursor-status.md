---
title: Formula — router · cursor_status
type: formula
formula_id: formula.adjusted.devdispatcher.action.cursor_status
...
| Field | Value |
|-------|-------|
| Name | `router · cursor_status` |
| Graph node | `formula.adjusted.devdispatcher.action.cursor_status` |
| Kind | dispatcher_router |
