---
title: Formula — router · reliability_system
type: formula
formula_id: formula.adjusted.calcdispatcher.action.reliability_system
...
# Formula — `router · reliability_system`
...
| Field | Value |
|-------|-------|
| Name | `router · reliability_system` |
| Graph node | `formula.adjusted.calcdispatcher.action.reliability_system` |
| Kind | dispatcher_router |
