---
title: Formula — router · f360_live_pattern
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_pattern
...
# Formula — `router · f360_live_pattern`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_pattern` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_pattern` |
| Kind | dispatcher_router |
