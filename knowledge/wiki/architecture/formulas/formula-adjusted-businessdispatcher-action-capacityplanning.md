---
title: Formula — router · capacityPlanning
type: formula
formula_id: formula.adjusted.businessdispatcher.action.capacityplanning
...
# Formula — `router · capacityPlanning`
...
| Field | Value |
|-------|-------|
| Name | `router · capacityPlanning` |
| Graph node | `formula.adjusted.businessdispatcher.action.capacityplanning` |
| Kind | dispatcher_router |
