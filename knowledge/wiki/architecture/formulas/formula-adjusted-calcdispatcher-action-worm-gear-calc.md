---
title: Formula — router · worm_gear_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.worm_gear_calc
...
| Field | Value |
|-------|-------|
| Name | `router · worm_gear_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.worm_gear_calc` |
| Kind | dispatcher_router |
