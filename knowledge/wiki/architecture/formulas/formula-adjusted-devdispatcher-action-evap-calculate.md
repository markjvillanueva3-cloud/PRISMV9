---
title: Formula — router · evap_calculate
type: formula
formula_id: formula.adjusted.devdispatcher.action.evap_calculate
...
| Field | Value |
|-------|-------|
| Name | `router · evap_calculate` |
| Graph node | `formula.adjusted.devdispatcher.action.evap_calculate` |
| Kind | dispatcher_router |
