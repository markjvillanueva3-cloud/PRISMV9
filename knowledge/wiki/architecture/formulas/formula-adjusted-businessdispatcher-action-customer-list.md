---
title: Formula — router · customer_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.customer_list
...
| Field | Value |
|-------|-------|
| Name | `router · customer_list` |
| Graph node | `formula.adjusted.businessdispatcher.action.customer_list` |
| Kind | dispatcher_router |
