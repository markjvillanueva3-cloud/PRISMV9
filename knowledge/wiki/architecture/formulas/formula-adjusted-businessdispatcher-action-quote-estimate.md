---
title: Formula — router · quote_estimate
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quote_estimate
...
| Field | Value |
|-------|-------|
| Name | `router · quote_estimate` |
| Graph node | `formula.adjusted.businessdispatcher.action.quote_estimate` |
| Kind | dispatcher_router |
