---
title: Formula — router · employee_update
type: formula
formula_id: formula.adjusted.businessdispatcher.action.employee_update
...
# Formula — `router · employee_update`
...
| Field | Value |
|-------|-------|
| Name | `router · employee_update` |
| Graph node | `formula.adjusted.businessdispatcher.action.employee_update` |
| Kind | dispatcher_router |
