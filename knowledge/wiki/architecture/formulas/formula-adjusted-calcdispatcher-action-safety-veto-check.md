---
title: Formula — router · safety_veto_check
type: formula
formula_id: formula.adjusted.calcdispatcher.action.safety_veto_check
...
# Formula — `router · safety_veto_check`
...
| Field | Value |
|-------|-------|
| Name | `router · safety_veto_check` |
| Graph node | `formula.adjusted.calcdispatcher.action.safety_veto_check` |
| Kind | dispatcher_router |
