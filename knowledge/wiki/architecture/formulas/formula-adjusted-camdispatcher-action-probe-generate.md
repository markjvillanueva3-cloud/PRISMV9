---
title: Formula — router · probe_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.probe_generate
...
| Field | Value |
|-------|-------|
| Name | `router · probe_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.probe_generate` |
| Kind | dispatcher_router |
