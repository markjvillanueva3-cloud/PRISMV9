---
title: Formula — router · session_revoke
type: formula
formula_id: formula.adjusted.securitydispatcher.action.session_revoke
...
| Field | Value |
|-------|-------|
| Name | `router · session_revoke` |
| Graph node | `formula.adjusted.securitydispatcher.action.session_revoke` |
| Kind | dispatcher_router |
