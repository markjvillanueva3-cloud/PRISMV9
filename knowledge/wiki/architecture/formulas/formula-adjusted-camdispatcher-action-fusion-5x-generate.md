---
title: Formula — router · fusion_5x_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.fusion_5x_generate
...
# Formula — `router · fusion_5x_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · fusion_5x_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.fusion_5x_generate` |
| Kind | dispatcher_router |
