---
title: Formula — router · sf_compare
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sf_compare
...
| Field | Value |
|-------|-------|
| Name | `router · sf_compare` |
| Graph node | `formula.adjusted.calcdispatcher.action.sf_compare` |
| Kind | dispatcher_router |
