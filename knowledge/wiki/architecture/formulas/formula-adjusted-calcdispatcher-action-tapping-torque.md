---
title: Formula — router · tapping_torque
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tapping_torque
...
| Field | Value |
|-------|-------|
| Name | `router · tapping_torque` |
| Graph node | `formula.adjusted.calcdispatcher.action.tapping_torque` |
| Kind | dispatcher_router |
