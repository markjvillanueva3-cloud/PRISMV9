---
title: Formula — router · singularity_detect
type: formula
formula_id: formula.adjusted.calcdispatcher.action.singularity_detect
...
# Formula — `router · singularity_detect`
...
| Field | Value |
|-------|-------|
| Name | `router · singularity_detect` |
| Graph node | `formula.adjusted.calcdispatcher.action.singularity_detect` |
| Kind | dispatcher_router |
