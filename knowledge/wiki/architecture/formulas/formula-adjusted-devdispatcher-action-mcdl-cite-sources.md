---
title: Formula — router · mcdl_cite_sources
type: formula
formula_id: formula.adjusted.devdispatcher.action.mcdl_cite_sources
...
# Formula — `router · mcdl_cite_sources`
...
| Field | Value |
|-------|-------|
| Name | `router · mcdl_cite_sources` |
| Graph node | `formula.adjusted.devdispatcher.action.mcdl_cite_sources` |
| Kind | dispatcher_router |
