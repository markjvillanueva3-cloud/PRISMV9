---
title: Formula — router · lathe_po_build
type: formula
formula_id: formula.adjusted.businessdispatcher.action.lathe_po_build
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_po_build` |
| Graph node | `formula.adjusted.businessdispatcher.action.lathe_po_build` |
| Kind | dispatcher_router |
