---
title: Formula — router · turbine_blade_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.turbine_blade_calc
...
# Formula — `router · turbine_blade_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · turbine_blade_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.turbine_blade_calc` |
| Kind | dispatcher_router |
