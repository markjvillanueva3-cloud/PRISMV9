---
title: Formula — router · am_scan_strategy
type: formula
formula_id: formula.adjusted.calcdispatcher.action.am_scan_strategy
...
# Formula — `router · am_scan_strategy`
...
| Field | Value |
|-------|-------|
| Name | `router · am_scan_strategy` |
| Graph node | `formula.adjusted.calcdispatcher.action.am_scan_strategy` |
| Kind | dispatcher_router |
