---
title: Formula — router · graph_scc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.graph_scc
...
| Field | Value |
|-------|-------|
| Name | `router · graph_scc` |
| Graph node | `formula.adjusted.calcdispatcher.action.graph_scc` |
| Kind | dispatcher_router |
