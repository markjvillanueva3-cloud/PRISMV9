---
title: Formula — router · postVersioning
type: formula
formula_id: formula.adjusted.camdispatcher.action.postversioning
...
| Field | Value |
|-------|-------|
| Name | `router · postVersioning` |
| Graph node | `formula.adjusted.camdispatcher.action.postversioning` |
| Kind | dispatcher_router |
