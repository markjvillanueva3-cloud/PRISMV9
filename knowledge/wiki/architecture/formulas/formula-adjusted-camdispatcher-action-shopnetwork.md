---
title: Formula — router · shopNetwork
type: formula
formula_id: formula.adjusted.camdispatcher.action.shopnetwork
...
| Field | Value |
|-------|-------|
| Name | `router · shopNetwork` |
| Graph node | `formula.adjusted.camdispatcher.action.shopnetwork` |
| Kind | dispatcher_router |
