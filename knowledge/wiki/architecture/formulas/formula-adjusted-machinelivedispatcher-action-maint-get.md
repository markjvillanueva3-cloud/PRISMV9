---
title: Formula — router · maint_get
type: formula
formula_id: formula.adjusted.machinelivedispatcher.action.maint_get
...
| Field | Value |
|-------|-------|
| Name | `router · maint_get` |
| Graph node | `formula.adjusted.machinelivedispatcher.action.maint_get` |
| Kind | dispatcher_router |
