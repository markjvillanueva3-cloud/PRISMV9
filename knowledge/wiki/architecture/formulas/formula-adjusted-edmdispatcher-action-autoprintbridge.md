---
title: Formula — router · autoPrintBridge
type: formula
formula_id: formula.adjusted.edmdispatcher.action.autoprintbridge
...
# Formula — `router · autoPrintBridge`
...
| Field | Value |
|-------|-------|
| Name | `router · autoPrintBridge` |
| Graph node | `formula.adjusted.edmdispatcher.action.autoprintbridge` |
| Kind | dispatcher_router |
