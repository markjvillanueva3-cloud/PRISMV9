---
title: Formula — router · latheSFShop
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathesfshop
...
| Field | Value |
|-------|-------|
| Name | `router · latheSFShop` |
| Graph node | `formula.adjusted.camdispatcher.action.lathesfshop` |
| Kind | dispatcher_router |
