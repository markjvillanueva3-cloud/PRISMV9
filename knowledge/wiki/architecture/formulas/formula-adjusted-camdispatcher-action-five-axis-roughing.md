---
title: Formula — router · five_axis_roughing
type: formula
formula_id: formula.adjusted.camdispatcher.action.five_axis_roughing
...
# Formula — `router · five_axis_roughing`
...
| Field | Value |
|-------|-------|
| Name | `router · five_axis_roughing` |
| Graph node | `formula.adjusted.camdispatcher.action.five_axis_roughing` |
| Kind | dispatcher_router |
