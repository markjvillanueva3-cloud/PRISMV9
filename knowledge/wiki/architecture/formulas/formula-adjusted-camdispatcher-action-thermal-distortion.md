---
title: Formula — router · thermal_distortion
type: formula
formula_id: formula.adjusted.camdispatcher.action.thermal_distortion
...
# Formula — `router · thermal_distortion`
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_distortion` |
| Graph node | `formula.adjusted.camdispatcher.action.thermal_distortion` |
| Kind | dispatcher_router |
