---
title: Formula — router · scallop
type: formula
formula_id: formula.adjusted.calcdispatcher.action.scallop
...
|-------|-------|
| Name | `router · scallop` |
| Graph node | `formula.adjusted.calcdispatcher.action.scallop` |
| Kind | dispatcher_router |
