---
title: Formula — router · rsg_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.rsg_get
...
|-------|-------|
| Name | `router · rsg_get` |
| Graph node | `formula.adjusted.devdispatcher.action.rsg_get` |
| Kind | dispatcher_router |
