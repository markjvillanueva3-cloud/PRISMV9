---
title: Formula — router · peer_get
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.peer_get
...
| Field | Value |
|-------|-------|
| Name | `router · peer_get` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.peer_get` |
| Kind | dispatcher_router |
