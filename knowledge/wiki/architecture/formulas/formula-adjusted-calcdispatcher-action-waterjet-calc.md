---
title: Formula — router · waterjet_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.waterjet_calc
...
| Field | Value |
|-------|-------|
| Name | `router · waterjet_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.waterjet_calc` |
| Kind | dispatcher_router |
