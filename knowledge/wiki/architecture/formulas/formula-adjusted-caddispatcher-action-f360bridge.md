---
title: Formula — router · f360Bridge
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360bridge
...
| Field | Value |
|-------|-------|
| Name | `router · f360Bridge` |
| Graph node | `formula.adjusted.caddispatcher.action.f360bridge` |
| Kind | dispatcher_router |
