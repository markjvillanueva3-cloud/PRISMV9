---
title: Formula — router · topSolidStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.topsolidstrategy
...
# Formula — `router · topSolidStrategy`
...
| Field | Value |
|-------|-------|
| Name | `router · topSolidStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.topsolidstrategy` |
| Kind | dispatcher_router |
