---
title: Formula — router · state_diff
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.state_diff
...
| Field | Value |
|-------|-------|
| Name | `router · state_diff` |
| Graph node | `formula.adjusted.sessiondispatcher.action.state_diff` |
| Kind | dispatcher_router |
