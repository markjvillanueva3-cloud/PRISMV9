---
title: Formula — router · lathe_order_get
type: formula
formula_id: formula.adjusted.businessdispatcher.action.lathe_order_get
...
# Formula — `router · lathe_order_get`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_order_get` |
| Graph node | `formula.adjusted.businessdispatcher.action.lathe_order_get` |
| Kind | dispatcher_router |
