---
title: Formula — router · categorize
type: formula
formula_id: formula.adjusted.camdispatcher.action.categorize
...
| Field | Value |
|-------|-------|
| Name | `router · categorize` |
| Graph node | `formula.adjusted.camdispatcher.action.categorize` |
| Kind | dispatcher_router |
