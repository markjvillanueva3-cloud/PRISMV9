---
title: Formula — router · heat_treat_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.heat_treat_predict
...
# Formula — `router · heat_treat_predict`
...
| Field | Value |
|-------|-------|
| Name | `router · heat_treat_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.heat_treat_predict` |
| Kind | dispatcher_router |
