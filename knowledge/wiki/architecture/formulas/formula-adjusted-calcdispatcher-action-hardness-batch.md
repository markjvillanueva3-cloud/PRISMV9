---
title: Formula — router · hardness_batch
type: formula
formula_id: formula.adjusted.calcdispatcher.action.hardness_batch
...
| Field | Value |
|-------|-------|
| Name | `router · hardness_batch` |
| Graph node | `formula.adjusted.calcdispatcher.action.hardness_batch` |
| Kind | dispatcher_router |
