---
title: Formula — router · saasAPI
type: formula
formula_id: formula.adjusted.businessdispatcher.action.saasapi
...
|-------|-------|
| Name | `router · saasAPI` |
| Graph node | `formula.adjusted.businessdispatcher.action.saasapi` |
| Kind | dispatcher_router |
