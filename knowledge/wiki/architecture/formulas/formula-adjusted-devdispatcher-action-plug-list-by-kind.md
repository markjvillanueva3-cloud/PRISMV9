---
title: Formula — router · plug_list_by_kind
type: formula
formula_id: formula.adjusted.devdispatcher.action.plug_list_by_kind
...
# Formula — `router · plug_list_by_kind`
...
| Field | Value |
|-------|-------|
| Name | `router · plug_list_by_kind` |
| Graph node | `formula.adjusted.devdispatcher.action.plug_list_by_kind` |
| Kind | dispatcher_router |
