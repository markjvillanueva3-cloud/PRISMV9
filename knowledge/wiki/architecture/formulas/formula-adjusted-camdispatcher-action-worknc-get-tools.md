---
title: Formula — router · worknc_get_tools
type: formula
formula_id: formula.adjusted.camdispatcher.action.worknc_get_tools
...
# Formula — `router · worknc_get_tools`
...
| Field | Value |
|-------|-------|
| Name | `router · worknc_get_tools` |
| Graph node | `formula.adjusted.camdispatcher.action.worknc_get_tools` |
| Kind | dispatcher_router |
