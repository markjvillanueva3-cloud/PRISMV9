---
title: Formula — router · pmUnifiedIndex
type: formula
formula_id: formula.adjusted.camdispatcher.action.pmunifiedindex
...
| Field | Value |
|-------|-------|
| Name | `router · pmUnifiedIndex` |
| Graph node | `formula.adjusted.camdispatcher.action.pmunifiedindex` |
| Kind | dispatcher_router |
