---
title: Formula — router · ncsimul_import
type: formula
formula_id: formula.adjusted.camdispatcher.action.ncsimul_import
...
| Field | Value |
|-------|-------|
| Name | `router · ncsimul_import` |
| Graph node | `formula.adjusted.camdispatcher.action.ncsimul_import` |
| Kind | dispatcher_router |
