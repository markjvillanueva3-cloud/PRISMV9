---
title: Formula — router · fillet_preview
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fillet_preview
...
| Field | Value |
|-------|-------|
| Name | `router · fillet_preview` |
| Graph node | `formula.adjusted.calcdispatcher.action.fillet_preview` |
| Kind | dispatcher_router |
