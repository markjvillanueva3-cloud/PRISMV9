---
title: Formula — router · ncsimulBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.ncsimulbridge
...
| Field | Value |
|-------|-------|
| Name | `router · ncsimulBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.ncsimulbridge` |
| Kind | dispatcher_router |
