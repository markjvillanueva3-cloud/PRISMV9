---
title: Formula — router · cadRegistry
type: formula
formula_id: formula.adjusted.caddispatcher.action.cadregistry
...
| Field | Value |
|-------|-------|
| Name | `router · cadRegistry` |
| Graph node | `formula.adjusted.caddispatcher.action.cadregistry` |
| Kind | dispatcher_router |
