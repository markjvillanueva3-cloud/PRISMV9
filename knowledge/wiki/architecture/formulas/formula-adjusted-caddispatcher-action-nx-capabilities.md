---
title: Formula — router · nx_capabilities
type: formula
formula_id: formula.adjusted.caddispatcher.action.nx_capabilities
...
# Formula — `router · nx_capabilities`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_capabilities` |
| Graph node | `formula.adjusted.caddispatcher.action.nx_capabilities` |
| Kind | dispatcher_router |
