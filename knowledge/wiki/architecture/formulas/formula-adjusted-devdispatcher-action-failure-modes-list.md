---
title: Formula — router · failure_modes_list
type: formula
formula_id: formula.adjusted.devdispatcher.action.failure_modes_list
...
# Formula — `router · failure_modes_list`
...
| Field | Value |
|-------|-------|
| Name | `router · failure_modes_list` |
| Graph node | `formula.adjusted.devdispatcher.action.failure_modes_list` |
| Kind | dispatcher_router |
