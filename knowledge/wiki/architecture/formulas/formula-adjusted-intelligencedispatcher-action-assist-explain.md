---
title: Formula — router · assist_explain
type: formula
formula_id: formula.adjusted.intelligencedispatcher.action.assist_explain
...
| Field | Value |
|-------|-------|
| Name | `router · assist_explain` |
| Graph node | `formula.adjusted.intelligencedispatcher.action.assist_explain` |
| Kind | dispatcher_router |
