---
title: Formula — router · matrix_factorize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.matrix_factorize
...
# Formula — `router · matrix_factorize`
...
| Field | Value |
|-------|-------|
| Name | `router · matrix_factorize` |
| Graph node | `formula.adjusted.calcdispatcher.action.matrix_factorize` |
| Kind | dispatcher_router |
