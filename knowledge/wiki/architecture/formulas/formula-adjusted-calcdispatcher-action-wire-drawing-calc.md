---
title: Formula — router · wire_drawing_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.wire_drawing_calc
...
# Formula — `router · wire_drawing_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · wire_drawing_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.wire_drawing_calc` |
| Kind | dispatcher_router |
