---
title: Formula — router · powermill_op_get
type: formula
formula_id: formula.adjusted.camdispatcher.action.powermill_op_get
...
# Formula — `router · powermill_op_get`
...
| Field | Value |
|-------|-------|
| Name | `router · powermill_op_get` |
| Graph node | `formula.adjusted.camdispatcher.action.powermill_op_get` |
| Kind | dispatcher_router |
