---
title: Formula — router · cad_registry_scan
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_registry_scan
...
# Formula — `router · cad_registry_scan`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_registry_scan` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_registry_scan` |
| Kind | dispatcher_router |
