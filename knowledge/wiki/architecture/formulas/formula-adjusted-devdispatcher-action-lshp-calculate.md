---
title: Formula — router · lshp_calculate
type: formula
formula_id: formula.adjusted.devdispatcher.action.lshp_calculate
...
| Field | Value |
|-------|-------|
| Name | `router · lshp_calculate` |
| Graph node | `formula.adjusted.devdispatcher.action.lshp_calculate` |
| Kind | dispatcher_router |
