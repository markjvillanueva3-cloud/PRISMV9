---
title: Formula — router · whiteLabelConfig
type: formula
formula_id: formula.adjusted.businessdispatcher.action.whitelabelconfig
...
# Formula — `router · whiteLabelConfig`
...
| Field | Value |
|-------|-------|
| Name | `router · whiteLabelConfig` |
| Graph node | `formula.adjusted.businessdispatcher.action.whitelabelconfig` |
| Kind | dispatcher_router |
