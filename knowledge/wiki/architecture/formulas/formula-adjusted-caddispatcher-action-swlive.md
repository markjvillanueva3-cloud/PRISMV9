---
title: Formula — router · swLive
type: formula
formula_id: formula.adjusted.caddispatcher.action.swlive
...
|-------|-------|
| Name | `router · swLive` |
| Graph node | `formula.adjusted.caddispatcher.action.swlive` |
| Kind | dispatcher_router |
