---
title: Formula — router · ahp_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ahp_calc
...
| Field | Value |
|-------|-------|
| Name | `router · ahp_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.ahp_calc` |
| Kind | dispatcher_router |
