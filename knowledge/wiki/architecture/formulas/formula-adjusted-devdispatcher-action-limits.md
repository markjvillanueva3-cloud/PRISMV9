---
title: Formula — router · limits
type: formula
formula_id: formula.adjusted.devdispatcher.action.limits
...
|-------|-------|
| Name | `router · limits` |
| Graph node | `formula.adjusted.devdispatcher.action.limits` |
| Kind | dispatcher_router |
