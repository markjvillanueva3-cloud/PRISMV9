---
title: Formula — router · overlay_preview
type: formula
formula_id: formula.adjusted.devdispatcher.action.overlay_preview
...
# Formula — `router · overlay_preview`
...
| Field | Value |
|-------|-------|
| Name | `router · overlay_preview` |
| Graph node | `formula.adjusted.devdispatcher.action.overlay_preview` |
| Kind | dispatcher_router |
