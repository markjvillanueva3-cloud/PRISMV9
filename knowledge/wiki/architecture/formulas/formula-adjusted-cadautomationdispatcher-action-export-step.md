---
title: Formula — router · export_step
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.export_step
...
| Field | Value |
|-------|-------|
| Name | `router · export_step` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.export_step` |
| Kind | dispatcher_router |
