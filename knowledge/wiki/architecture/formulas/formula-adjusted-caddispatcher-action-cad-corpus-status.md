---
title: Formula — router · cad_corpus_status
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_corpus_status
...
# Formula — `router · cad_corpus_status`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_corpus_status` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_corpus_status` |
| Kind | dispatcher_router |
