---
title: Formula — router · maint_status
type: formula
formula_id: formula.adjusted.machinelivedispatcher.action.maint_status
...
| Field | Value |
|-------|-------|
| Name | `router · maint_status` |
| Graph node | `formula.adjusted.machinelivedispatcher.action.maint_status` |
| Kind | dispatcher_router |
