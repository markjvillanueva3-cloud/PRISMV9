---
title: Formula — router · bvh_raycast
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bvh_raycast
...
| Field | Value |
|-------|-------|
| Name | `router · bvh_raycast` |
| Graph node | `formula.adjusted.calcdispatcher.action.bvh_raycast` |
| Kind | dispatcher_router |
