---
title: Formula — router · silhouette_extract
type: formula
formula_id: formula.adjusted.calcdispatcher.action.silhouette_extract
...
# Formula — `router · silhouette_extract`
...
| Field | Value |
|-------|-------|
| Name | `router · silhouette_extract` |
| Graph node | `formula.adjusted.calcdispatcher.action.silhouette_extract` |
| Kind | dispatcher_router |
