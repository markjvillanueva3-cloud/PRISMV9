---
title: Formula — router · pr_compute_scores
type: formula
formula_id: formula.adjusted.devdispatcher.action.pr_compute_scores
...
# Formula — `router · pr_compute_scores`
...
| Field | Value |
|-------|-------|
| Name | `router · pr_compute_scores` |
| Graph node | `formula.adjusted.devdispatcher.action.pr_compute_scores` |
| Kind | dispatcher_router |
