---
title: Formula — router · learningPath
type: formula
formula_id: formula.adjusted.businessdispatcher.action.learningpath
...
| Field | Value |
|-------|-------|
| Name | `router · learningPath` |
| Graph node | `formula.adjusted.businessdispatcher.action.learningpath` |
| Kind | dispatcher_router |
