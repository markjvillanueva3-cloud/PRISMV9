---
title: Formula — router · tcb_reset
type: formula
formula_id: formula.adjusted.devdispatcher.action.tcb_reset
...
| Field | Value |
|-------|-------|
| Name | `router · tcb_reset` |
| Graph node | `formula.adjusted.devdispatcher.action.tcb_reset` |
| Kind | dispatcher_router |
