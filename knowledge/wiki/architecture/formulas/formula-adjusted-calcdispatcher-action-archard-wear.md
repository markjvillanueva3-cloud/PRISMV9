---
title: Formula — router · archard_wear
type: formula
formula_id: formula.adjusted.calcdispatcher.action.archard_wear
...
| Field | Value |
|-------|-------|
| Name | `router · archard_wear` |
| Graph node | `formula.adjusted.calcdispatcher.action.archard_wear` |
| Kind | dispatcher_router |
