---
title: Formula — router · sensor_validate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sensor_validate
...
# Formula — `router · sensor_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · sensor_validate` |
| Graph node | `formula.adjusted.calcdispatcher.action.sensor_validate` |
| Kind | dispatcher_router |
