---
title: Formula — router · nxcamTurningIndex
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcamturningindex
...
# Formula — `router · nxcamTurningIndex`
...
| Field | Value |
|-------|-------|
| Name | `router · nxcamTurningIndex` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcamturningindex` |
| Kind | dispatcher_router |
