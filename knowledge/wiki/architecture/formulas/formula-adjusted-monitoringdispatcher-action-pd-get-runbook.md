---
title: Formula — router · pd_get_runbook
type: formula
formula_id: formula.adjusted.monitoringdispatcher.action.pd_get_runbook
...
| Field | Value |
|-------|-------|
| Name | `router · pd_get_runbook` |
| Graph node | `formula.adjusted.monitoringdispatcher.action.pd_get_runbook` |
| Kind | dispatcher_router |
