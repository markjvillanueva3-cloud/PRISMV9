---
title: Formula — router · equipmentAsset
type: formula
formula_id: formula.adjusted.businessdispatcher.action.equipmentasset
...
| Field | Value |
|-------|-------|
| Name | `router · equipmentAsset` |
| Graph node | `formula.adjusted.businessdispatcher.action.equipmentasset` |
| Kind | dispatcher_router |
