---
title: Formula — router · cross_reg_paths
type: formula
formula_id: formula.adjusted.devdispatcher.action.cross_reg_paths
...
# Formula — `router · cross_reg_paths`
...
| Field | Value |
|-------|-------|
| Name | `router · cross_reg_paths` |
| Graph node | `formula.adjusted.devdispatcher.action.cross_reg_paths` |
| Kind | dispatcher_router |
