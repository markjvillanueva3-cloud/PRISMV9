---
title: Formula — router · cutting_force
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cutting_force
...
| Field | Value |
|-------|-------|
| Name | `router · cutting_force` |
| Graph node | `formula.adjusted.calcdispatcher.action.cutting_force` |
| Kind | dispatcher_router |
