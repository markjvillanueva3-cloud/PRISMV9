---
title: Formula — router · assembly_bom
type: formula
formula_id: formula.adjusted.caddispatcher.action.assembly_bom
...
| Field | Value |
|-------|-------|
| Name | `router · assembly_bom` |
| Graph node | `formula.adjusted.caddispatcher.action.assembly_bom` |
| Kind | dispatcher_router |
