---
title: Formula — router · algorithm_list
type: formula
formula_id: formula.adjusted.calcdispatcher.action.algorithm_list
...
| Field | Value |
|-------|-------|
| Name | `router · algorithm_list` |
| Graph node | `formula.adjusted.calcdispatcher.action.algorithm_list` |
| Kind | dispatcher_router |
