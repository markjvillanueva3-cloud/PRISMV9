---
title: Formula — router · highSpeedMachining
type: formula
formula_id: formula.adjusted.ppdispatcher.action.highspeedmachining
...
# Formula — `router · highSpeedMachining`
...
| Field | Value |
|-------|-------|
| Name | `router · highSpeedMachining` |
| Graph node | `formula.adjusted.ppdispatcher.action.highspeedmachining` |
| Kind | dispatcher_router |
