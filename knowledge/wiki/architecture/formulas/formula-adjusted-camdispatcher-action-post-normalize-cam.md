---
title: Formula — router · post_normalize_cam
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_normalize_cam
...
# Formula — `router · post_normalize_cam`
...
| Field | Value |
|-------|-------|
| Name | `router · post_normalize_cam` |
| Graph node | `formula.adjusted.camdispatcher.action.post_normalize_cam` |
| Kind | dispatcher_router |
