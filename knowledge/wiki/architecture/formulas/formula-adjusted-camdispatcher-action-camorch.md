---
title: Formula — router · camOrch
type: formula
formula_id: formula.adjusted.camdispatcher.action.camorch
...
|-------|-------|
| Name | `router · camOrch` |
| Graph node | `formula.adjusted.camdispatcher.action.camorch` |
| Kind | dispatcher_router |
