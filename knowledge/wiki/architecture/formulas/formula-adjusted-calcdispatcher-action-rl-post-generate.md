---
title: Formula — router · rl_post_generate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rl_post_generate
...
# Formula — `router · rl_post_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · rl_post_generate` |
| Graph node | `formula.adjusted.calcdispatcher.action.rl_post_generate` |
| Kind | dispatcher_router |
