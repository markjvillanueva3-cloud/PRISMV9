---
title: Formula — router · employee
type: formula
formula_id: formula.adjusted.businessdispatcher.action.employee
...
| Graph node | `formula.adjusted.businessdispatcher.action.employee` |
| Kind | dispatcher_router |
