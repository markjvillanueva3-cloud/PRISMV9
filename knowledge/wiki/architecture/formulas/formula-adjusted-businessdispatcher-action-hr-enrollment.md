---
title: Formula — router · hr_enrollment
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_enrollment
...
| Field | Value |
|-------|-------|
| Name | `router · hr_enrollment` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_enrollment` |
| Kind | dispatcher_router |
