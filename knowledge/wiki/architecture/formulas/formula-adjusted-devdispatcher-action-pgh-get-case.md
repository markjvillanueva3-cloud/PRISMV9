---
title: Formula — router · pgh_get_case
type: formula
formula_id: formula.adjusted.devdispatcher.action.pgh_get_case
...
| Field | Value |
|-------|-------|
| Name | `router · pgh_get_case` |
| Graph node | `formula.adjusted.devdispatcher.action.pgh_get_case` |
| Kind | dispatcher_router |
