---
title: Formula — router · health_check
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.health_check
...
| Field | Value |
|-------|-------|
| Name | `router · health_check` |
| Graph node | `formula.adjusted.sessiondispatcher.action.health_check` |
| Kind | dispatcher_router |
