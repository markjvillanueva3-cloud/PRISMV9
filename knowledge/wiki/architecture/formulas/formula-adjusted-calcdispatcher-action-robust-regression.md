---
title: Formula — router · robust_regression
type: formula
formula_id: formula.adjusted.calcdispatcher.action.robust_regression
...
# Formula — `router · robust_regression`
...
| Field | Value |
|-------|-------|
| Name | `router · robust_regression` |
| Graph node | `formula.adjusted.calcdispatcher.action.robust_regression` |
| Kind | dispatcher_router |
