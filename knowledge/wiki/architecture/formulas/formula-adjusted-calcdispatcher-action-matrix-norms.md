---
title: Formula — router · matrix_norms
type: formula
formula_id: formula.adjusted.calcdispatcher.action.matrix_norms
...
| Field | Value |
|-------|-------|
| Name | `router · matrix_norms` |
| Graph node | `formula.adjusted.calcdispatcher.action.matrix_norms` |
| Kind | dispatcher_router |
