---
title: Formula — router · export_learning
type: formula
formula_id: formula.adjusted.calcdispatcher.action.export_learning
...
# Formula — `router · export_learning`
...
| Field | Value |
|-------|-------|
| Name | `router · export_learning` |
| Graph node | `formula.adjusted.calcdispatcher.action.export_learning` |
| Kind | dispatcher_router |
