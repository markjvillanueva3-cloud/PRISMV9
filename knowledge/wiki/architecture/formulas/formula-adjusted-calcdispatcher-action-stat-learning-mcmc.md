---
title: Formula — router · stat_learning_mcmc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stat_learning_mcmc
...
# Formula — `router · stat_learning_mcmc`
...
| Field | Value |
|-------|-------|
| Name | `router · stat_learning_mcmc` |
| Graph node | `formula.adjusted.calcdispatcher.action.stat_learning_mcmc` |
| Kind | dispatcher_router |
