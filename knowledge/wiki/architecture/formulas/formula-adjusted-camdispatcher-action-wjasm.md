---
title: Formula — router · wjAsm
type: formula
formula_id: formula.adjusted.camdispatcher.action.wjasm
...
|-------|-------|
| Name | `router · wjAsm` |
| Graph node | `formula.adjusted.camdispatcher.action.wjasm` |
| Kind | dispatcher_router |
