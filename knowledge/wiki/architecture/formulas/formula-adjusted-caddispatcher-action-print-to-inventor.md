---
title: Formula — router · print_to_inventor
type: formula
formula_id: formula.adjusted.caddispatcher.action.print_to_inventor
...
# Formula — `router · print_to_inventor`
...
| Field | Value |
|-------|-------|
| Name | `router · print_to_inventor` |
| Graph node | `formula.adjusted.caddispatcher.action.print_to_inventor` |
| Kind | dispatcher_router |
