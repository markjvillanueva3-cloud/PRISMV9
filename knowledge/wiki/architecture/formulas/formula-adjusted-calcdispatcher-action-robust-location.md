---
title: Formula — router · robust_location
type: formula
formula_id: formula.adjusted.calcdispatcher.action.robust_location
...
# Formula — `router · robust_location`
...
| Field | Value |
|-------|-------|
| Name | `router · robust_location` |
| Graph node | `formula.adjusted.calcdispatcher.action.robust_location` |
| Kind | dispatcher_router |
