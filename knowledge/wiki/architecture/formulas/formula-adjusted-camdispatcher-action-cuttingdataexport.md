---
title: Formula — router · cuttingDataExport
type: formula
formula_id: formula.adjusted.camdispatcher.action.cuttingdataexport
...
# Formula — `router · cuttingDataExport`
...
| Field | Value |
|-------|-------|
| Name | `router · cuttingDataExport` |
| Graph node | `formula.adjusted.camdispatcher.action.cuttingdataexport` |
| Kind | dispatcher_router |
