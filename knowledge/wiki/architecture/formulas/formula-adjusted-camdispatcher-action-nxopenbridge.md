---
title: Formula — router · nxOpenBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxopenbridge
...
| Field | Value |
|-------|-------|
| Name | `router · nxOpenBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.nxopenbridge` |
| Kind | dispatcher_router |
