---
title: Formula — router · fda_is_validated
type: formula
formula_id: formula.adjusted.devdispatcher.action.fda_is_validated
...
# Formula — `router · fda_is_validated`
...
| Field | Value |
|-------|-------|
| Name | `router · fda_is_validated` |
| Graph node | `formula.adjusted.devdispatcher.action.fda_is_validated` |
| Kind | dispatcher_router |
