---
title: Formula — router · chamfer
type: formula
formula_id: formula.adjusted.caddispatcher.action.chamfer
...
|-------|-------|
| Name | `router · chamfer` |
| Graph node | `formula.adjusted.caddispatcher.action.chamfer` |
| Kind | dispatcher_router |
