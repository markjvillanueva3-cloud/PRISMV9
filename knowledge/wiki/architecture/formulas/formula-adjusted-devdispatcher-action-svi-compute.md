---
title: Formula — router · svi_compute
type: formula
formula_id: formula.adjusted.devdispatcher.action.svi_compute
...
| Field | Value |
|-------|-------|
| Name | `router · svi_compute` |
| Graph node | `formula.adjusted.devdispatcher.action.svi_compute` |
| Kind | dispatcher_router |
