---
title: Formula — router · causal_analyze
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.causal_analyze
...
| Field | Value |
|-------|-------|
| Name | `router · causal_analyze` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.causal_analyze` |
| Kind | dispatcher_router |
