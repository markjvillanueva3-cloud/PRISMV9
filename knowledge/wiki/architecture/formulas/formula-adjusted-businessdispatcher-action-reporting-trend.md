---
title: Formula — router · reporting_trend
type: formula
formula_id: formula.adjusted.businessdispatcher.action.reporting_trend
...
# Formula — `router · reporting_trend`
...
| Field | Value |
|-------|-------|
| Name | `router · reporting_trend` |
| Graph node | `formula.adjusted.businessdispatcher.action.reporting_trend` |
| Kind | dispatcher_router |
