---
title: Formula — router · turning_force
type: formula
formula_id: formula.adjusted.calcdispatcher.action.turning_force
...
| Field | Value |
|-------|-------|
| Name | `router · turning_force` |
| Graph node | `formula.adjusted.calcdispatcher.action.turning_force` |
| Kind | dispatcher_router |
