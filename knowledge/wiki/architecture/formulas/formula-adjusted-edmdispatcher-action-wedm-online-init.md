---
title: Formula — router · wedm_online_init
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_online_init
...
# Formula — `router · wedm_online_init`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_online_init` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_online_init` |
| Kind | dispatcher_router |
