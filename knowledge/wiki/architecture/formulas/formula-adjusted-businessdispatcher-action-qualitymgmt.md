---
title: Formula — router · qualityMgmt
type: formula
formula_id: formula.adjusted.businessdispatcher.action.qualitymgmt
...
| Field | Value |
|-------|-------|
| Name | `router · qualityMgmt` |
| Graph node | `formula.adjusted.businessdispatcher.action.qualitymgmt` |
| Kind | dispatcher_router |
