---
title: Formula — router · ppg_manifest
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_manifest
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_manifest` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_manifest` |
| Kind | dispatcher_router |
