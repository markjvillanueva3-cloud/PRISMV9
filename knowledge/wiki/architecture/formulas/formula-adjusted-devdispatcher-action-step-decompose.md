---
title: Formula — router · step_decompose
type: formula
formula_id: formula.adjusted.devdispatcher.action.step_decompose
...
| Field | Value |
|-------|-------|
| Name | `router · step_decompose` |
| Graph node | `formula.adjusted.devdispatcher.action.step_decompose` |
| Kind | dispatcher_router |
