---
title: Formula — router · lathe_p2p_kg_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_p2p_kg_stats
...
# Formula — `router · lathe_p2p_kg_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_p2p_kg_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_p2p_kg_stats` |
| Kind | dispatcher_router |
