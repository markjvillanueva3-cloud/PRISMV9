---
title: Formula — router · pm5AxisIndex
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm5axisindex
...
| Field | Value |
|-------|-------|
| Name | `router · pm5AxisIndex` |
| Graph node | `formula.adjusted.camdispatcher.action.pm5axisindex` |
| Kind | dispatcher_router |
