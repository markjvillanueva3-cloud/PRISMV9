---
title: Formula — router · rollingMill
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.rollingmill
...
| Field | Value |
|-------|-------|
| Name | `router · rollingMill` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.rollingmill` |
| Kind | dispatcher_router |
