---
title: Formula — router · pfh_evaluate_batch
type: formula
formula_id: formula.adjusted.devdispatcher.action.pfh_evaluate_batch
...
# Formula — `router · pfh_evaluate_batch`
...
| Field | Value |
|-------|-------|
| Name | `router · pfh_evaluate_batch` |
| Graph node | `formula.adjusted.devdispatcher.action.pfh_evaluate_batch` |
| Kind | dispatcher_router |
