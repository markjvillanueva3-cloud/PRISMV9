---
title: Formula — router · program_for_print
type: formula
formula_id: formula.adjusted.devdispatcher.action.program_for_print
...
# Formula — `router · program_for_print`
...
| Field | Value |
|-------|-------|
| Name | `router · program_for_print` |
| Graph node | `formula.adjusted.devdispatcher.action.program_for_print` |
| Kind | dispatcher_router |
