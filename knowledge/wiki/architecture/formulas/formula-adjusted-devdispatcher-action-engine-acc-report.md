---
title: Formula — router · engine_acc_report
type: formula
formula_id: formula.adjusted.devdispatcher.action.engine_acc_report
...
# Formula — `router · engine_acc_report`
...
| Field | Value |
|-------|-------|
| Name | `router · engine_acc_report` |
| Graph node | `formula.adjusted.devdispatcher.action.engine_acc_report` |
| Kind | dispatcher_router |
