---
title: Formula — router · wireTensionOpt
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wiretensionopt
...
| Field | Value |
|-------|-------|
| Name | `router · wireTensionOpt` |
| Graph node | `formula.adjusted.edmdispatcher.action.wiretensionopt` |
| Kind | dispatcher_router |
