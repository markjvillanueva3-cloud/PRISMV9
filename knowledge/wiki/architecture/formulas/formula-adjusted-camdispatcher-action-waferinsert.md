---
title: Formula — router · waferinsert
type: formula
formula_id: formula.adjusted.camdispatcher.action.waferinsert
...
| Field | Value |
|-------|-------|
| Name | `router · waferinsert` |
| Graph node | `formula.adjusted.camdispatcher.action.waferinsert` |
| Kind | dispatcher_router |
