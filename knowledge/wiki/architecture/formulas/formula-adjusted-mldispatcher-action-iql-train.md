---
title: Formula — router · iql_train
type: formula
formula_id: formula.adjusted.mldispatcher.action.iql_train
...
| Field | Value |
|-------|-------|
| Name | `router · iql_train` |
| Graph node | `formula.adjusted.mldispatcher.action.iql_train` |
| Kind | dispatcher_router |
