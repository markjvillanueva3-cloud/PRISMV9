---
title: Formula — router · audit_trail
type: formula
formula_id: formula.adjusted.compliancedispatcher.action.audit_trail
...
| Field | Value |
|-------|-------|
| Name | `router · audit_trail` |
| Graph node | `formula.adjusted.compliancedispatcher.action.audit_trail` |
| Kind | dispatcher_router |
