---
title: Formula — router · print_for_program
type: formula
formula_id: formula.adjusted.devdispatcher.action.print_for_program
...
# Formula — `router · print_for_program`
...
| Field | Value |
|-------|-------|
| Name | `router · print_for_program` |
| Graph node | `formula.adjusted.devdispatcher.action.print_for_program` |
| Kind | dispatcher_router |
