---
title: Formula — router · cryo_roi
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cryo_roi
...
| Field | Value |
|-------|-------|
| Name | `router · cryo_roi` |
| Graph node | `formula.adjusted.calcdispatcher.action.cryo_roi` |
| Kind | dispatcher_router |
