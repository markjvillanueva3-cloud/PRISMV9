---
title: Formula — router · rl_create_agent
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rl_create_agent
...
# Formula — `router · rl_create_agent`
...
| Field | Value |
|-------|-------|
| Name | `router · rl_create_agent` |
| Graph node | `formula.adjusted.calcdispatcher.action.rl_create_agent` |
| Kind | dispatcher_router |
