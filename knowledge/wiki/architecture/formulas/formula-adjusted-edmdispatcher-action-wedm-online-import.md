---
title: Formula — router · wedm_online_import
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_online_import
...
# Formula — `router · wedm_online_import`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_online_import` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_online_import` |
| Kind | dispatcher_router |
