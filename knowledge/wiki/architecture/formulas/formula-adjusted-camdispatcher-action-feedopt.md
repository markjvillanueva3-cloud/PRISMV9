---
title: Formula — router · feedOpt
type: formula
formula_id: formula.adjusted.camdispatcher.action.feedopt
...
|-------|-------|
| Name | `router · feedOpt` |
| Graph node | `formula.adjusted.camdispatcher.action.feedopt` |
| Kind | dispatcher_router |
