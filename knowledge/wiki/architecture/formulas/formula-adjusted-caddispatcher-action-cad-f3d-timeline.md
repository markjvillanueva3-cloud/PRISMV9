---
title: Formula — router · cad_f3d_timeline
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_f3d_timeline
...
# Formula — `router · cad_f3d_timeline`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_f3d_timeline` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_f3d_timeline` |
| Kind | dispatcher_router |
