---
title: Formula — router · rollback_verify
type: formula
formula_id: formula.adjusted.devdispatcher.action.rollback_verify
...
# Formula — `router · rollback_verify`
...
| Field | Value |
|-------|-------|
| Name | `router · rollback_verify` |
| Graph node | `formula.adjusted.devdispatcher.action.rollback_verify` |
| Kind | dispatcher_router |
