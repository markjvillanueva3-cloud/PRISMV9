---
title: Formula — router · jobLifecycle
type: formula
formula_id: formula.adjusted.businessdispatcher.action.joblifecycle
...
| Field | Value |
|-------|-------|
| Name | `router · jobLifecycle` |
| Graph node | `formula.adjusted.businessdispatcher.action.joblifecycle` |
| Kind | dispatcher_router |
