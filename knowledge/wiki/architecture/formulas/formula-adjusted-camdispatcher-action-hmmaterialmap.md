---
title: Formula — router · hmMaterialMap
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmmaterialmap
...
| Field | Value |
|-------|-------|
| Name | `router · hmMaterialMap` |
| Graph node | `formula.adjusted.camdispatcher.action.hmmaterialmap` |
| Kind | dispatcher_router |
