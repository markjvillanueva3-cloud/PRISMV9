---
title: Formula — router · fillet_variable
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fillet_variable
...
# Formula — `router · fillet_variable`
...
| Field | Value |
|-------|-------|
| Name | `router · fillet_variable` |
| Graph node | `formula.adjusted.calcdispatcher.action.fillet_variable` |
| Kind | dispatcher_router |
