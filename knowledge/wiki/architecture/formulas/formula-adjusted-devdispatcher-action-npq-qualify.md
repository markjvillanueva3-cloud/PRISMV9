---
title: Formula — router · npq_qualify
type: formula
formula_id: formula.adjusted.devdispatcher.action.npq_qualify
...
| Field | Value |
|-------|-------|
| Name | `router · npq_qualify` |
| Graph node | `formula.adjusted.devdispatcher.action.npq_qualify` |
| Kind | dispatcher_router |
