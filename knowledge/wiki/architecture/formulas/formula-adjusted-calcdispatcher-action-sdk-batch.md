---
title: Formula — router · sdk_batch
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sdk_batch
...
| Field | Value |
|-------|-------|
| Name | `router · sdk_batch` |
| Graph node | `formula.adjusted.calcdispatcher.action.sdk_batch` |
| Kind | dispatcher_router |
