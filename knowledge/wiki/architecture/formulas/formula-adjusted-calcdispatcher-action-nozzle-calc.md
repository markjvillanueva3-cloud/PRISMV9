---
title: Formula — router · nozzle_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.nozzle_calc
...
| Field | Value |
|-------|-------|
| Name | `router · nozzle_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.nozzle_calc` |
| Kind | dispatcher_router |
