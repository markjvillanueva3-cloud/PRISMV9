---
title: Formula — router · sparkErosion
type: formula
formula_id: formula.adjusted.edmdispatcher.action.sparkerosion
...
| Field | Value |
|-------|-------|
| Name | `router · sparkErosion` |
| Graph node | `formula.adjusted.edmdispatcher.action.sparkerosion` |
| Kind | dispatcher_router |
