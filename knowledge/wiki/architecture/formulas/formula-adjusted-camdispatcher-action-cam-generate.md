---
title: Formula — router · cam_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_generate
...
| Field | Value |
|-------|-------|
| Name | `router · cam_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_generate` |
| Kind | dispatcher_router |
