---
title: Formula — router · wrtl_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.wrtl_stats
...
| Field | Value |
|-------|-------|
| Name | `router · wrtl_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.wrtl_stats` |
| Kind | dispatcher_router |
