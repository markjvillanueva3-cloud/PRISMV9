---
title: Formula — router · assist_safety
type: formula
formula_id: formula.adjusted.intelligencedispatcher.action.assist_safety
...
| Field | Value |
|-------|-------|
| Name | `router · assist_safety` |
| Graph node | `formula.adjusted.intelligencedispatcher.action.assist_safety` |
| Kind | dispatcher_router |
