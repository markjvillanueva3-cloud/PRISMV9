---
title: Formula — router · auto_fix_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.auto_fix_summary
...
# Formula — `router · auto_fix_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · auto_fix_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.auto_fix_summary` |
| Kind | dispatcher_router |
