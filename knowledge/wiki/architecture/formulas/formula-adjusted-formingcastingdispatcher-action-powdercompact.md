---
title: Formula — router · powderCompact
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.powdercompact
...
| Field | Value |
|-------|-------|
| Name | `router · powderCompact` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.powdercompact` |
| Kind | dispatcher_router |
