---
title: Formula — router · plug_list
type: formula
formula_id: formula.adjusted.devdispatcher.action.plug_list
...
| Field | Value |
|-------|-------|
| Name | `router · plug_list` |
| Graph node | `formula.adjusted.devdispatcher.action.plug_list` |
| Kind | dispatcher_router |
