---
title: Formula — router · slo_get_status
type: formula
formula_id: formula.adjusted.devdispatcher.action.slo_get_status
...
| Field | Value |
|-------|-------|
| Name | `router · slo_get_status` |
| Graph node | `formula.adjusted.devdispatcher.action.slo_get_status` |
| Kind | dispatcher_router |
