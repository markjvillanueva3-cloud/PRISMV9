---
title: Formula — router · exit_strategy
type: formula
formula_id: formula.adjusted.calcdispatcher.action.exit_strategy
...
| Field | Value |
|-------|-------|
| Name | `router · exit_strategy` |
| Graph node | `formula.adjusted.calcdispatcher.action.exit_strategy` |
| Kind | dispatcher_router |
