---
title: Formula — router · rbe_get_runbook
type: formula
formula_id: formula.adjusted.devdispatcher.action.rbe_get_runbook
...
# Formula — `router · rbe_get_runbook`
...
| Field | Value |
|-------|-------|
| Name | `router · rbe_get_runbook` |
| Graph node | `formula.adjusted.devdispatcher.action.rbe_get_runbook` |
| Kind | dispatcher_router |
