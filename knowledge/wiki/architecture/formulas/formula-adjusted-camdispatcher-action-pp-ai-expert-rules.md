---
title: Formula — router · pp_ai_expert_rules
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_ai_expert_rules
...
# Formula — `router · pp_ai_expert_rules`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_ai_expert_rules` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_ai_expert_rules` |
| Kind | dispatcher_router |
