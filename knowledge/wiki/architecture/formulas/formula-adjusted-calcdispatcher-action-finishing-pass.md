---
title: Formula — router · finishing_pass
type: formula
formula_id: formula.adjusted.calcdispatcher.action.finishing_pass
...
| Field | Value |
|-------|-------|
| Name | `router · finishing_pass` |
| Graph node | `formula.adjusted.calcdispatcher.action.finishing_pass` |
| Kind | dispatcher_router |
