---
title: Formula — router · rbd_redundancy
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rbd_redundancy
...
| Field | Value |
|-------|-------|
| Name | `router · rbd_redundancy` |
| Graph node | `formula.adjusted.calcdispatcher.action.rbd_redundancy` |
| Kind | dispatcher_router |
