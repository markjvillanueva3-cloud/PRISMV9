---
title: Formula — router · power_torque
type: formula
formula_id: formula.adjusted.calcdispatcher.action.power_torque
...
| Field | Value |
|-------|-------|
| Name | `router · power_torque` |
| Graph node | `formula.adjusted.calcdispatcher.action.power_torque` |
| Kind | dispatcher_router |
