---
title: Formula — router · post_validate_full
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_validate_full
...
# Formula — `router · post_validate_full`
...
| Field | Value |
|-------|-------|
| Name | `router · post_validate_full` |
| Graph node | `formula.adjusted.camdispatcher.action.post_validate_full` |
| Kind | dispatcher_router |
