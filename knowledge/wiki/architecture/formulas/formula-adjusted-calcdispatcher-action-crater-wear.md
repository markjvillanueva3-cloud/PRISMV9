---
title: Formula — router · crater_wear
type: formula
formula_id: formula.adjusted.calcdispatcher.action.crater_wear
...
| Field | Value |
|-------|-------|
| Name | `router · crater_wear` |
| Graph node | `formula.adjusted.calcdispatcher.action.crater_wear` |
| Kind | dispatcher_router |
