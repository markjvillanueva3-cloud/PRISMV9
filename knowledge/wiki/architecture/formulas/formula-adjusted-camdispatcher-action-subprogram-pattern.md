---
title: Formula — router · subprogram_pattern
type: formula
formula_id: formula.adjusted.camdispatcher.action.subprogram_pattern
...
# Formula — `router · subprogram_pattern`
...
| Field | Value |
|-------|-------|
| Name | `router · subprogram_pattern` |
| Graph node | `formula.adjusted.camdispatcher.action.subprogram_pattern` |
| Kind | dispatcher_router |
