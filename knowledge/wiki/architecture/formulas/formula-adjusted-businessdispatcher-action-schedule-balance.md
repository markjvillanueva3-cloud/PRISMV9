---
title: Formula — router · schedule_balance
type: formula
formula_id: formula.adjusted.businessdispatcher.action.schedule_balance
...
# Formula — `router · schedule_balance`
...
| Field | Value |
|-------|-------|
| Name | `router · schedule_balance` |
| Graph node | `formula.adjusted.businessdispatcher.action.schedule_balance` |
| Kind | dispatcher_router |
