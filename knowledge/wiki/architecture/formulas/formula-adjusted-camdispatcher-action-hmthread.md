---
title: Formula — router · hmThread
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmthread
...
| Field | Value |
|-------|-------|
| Name | `router · hmThread` |
| Graph node | `formula.adjusted.camdispatcher.action.hmthread` |
| Kind | dispatcher_router |
