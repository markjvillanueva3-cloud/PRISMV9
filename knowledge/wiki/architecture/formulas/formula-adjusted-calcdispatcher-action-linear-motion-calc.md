---
title: Formula — router · linear_motion_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.linear_motion_calc
...
# Formula — `router · linear_motion_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · linear_motion_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.linear_motion_calc` |
| Kind | dispatcher_router |
