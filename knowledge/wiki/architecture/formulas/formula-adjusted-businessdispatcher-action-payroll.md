---
title: Formula — router · payroll
type: formula
formula_id: formula.adjusted.businessdispatcher.action.payroll
...
|-------|-------|
| Name | `router · payroll` |
| Graph node | `formula.adjusted.businessdispatcher.action.payroll` |
| Kind | dispatcher_router |
