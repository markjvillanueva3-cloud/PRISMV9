---
title: Formula — router · cam_agi_route
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_agi_route
...
| Field | Value |
|-------|-------|
| Name | `router · cam_agi_route` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_agi_route` |
| Kind | dispatcher_router |
