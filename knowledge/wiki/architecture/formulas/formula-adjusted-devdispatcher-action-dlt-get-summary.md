---
title: Formula — router · dlt_get_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.dlt_get_summary
...
# Formula — `router · dlt_get_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · dlt_get_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.dlt_get_summary` |
| Kind | dispatcher_router |
