---
title: Formula — router · fem_bar_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fem_bar_solve
...
| Field | Value |
|-------|-------|
| Name | `router · fem_bar_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.fem_bar_solve` |
| Kind | dispatcher_router |
