---
title: Formula — router · fillet_edges
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fillet_edges
...
| Field | Value |
|-------|-------|
| Name | `router · fillet_edges` |
| Graph node | `formula.adjusted.calcdispatcher.action.fillet_edges` |
| Kind | dispatcher_router |
