---
title: Formula — router · mca_catalog_paths
type: formula
formula_id: formula.adjusted.devdispatcher.action.mca_catalog_paths
...
# Formula — `router · mca_catalog_paths`
...
| Field | Value |
|-------|-------|
| Name | `router · mca_catalog_paths` |
| Graph node | `formula.adjusted.devdispatcher.action.mca_catalog_paths` |
| Kind | dispatcher_router |
