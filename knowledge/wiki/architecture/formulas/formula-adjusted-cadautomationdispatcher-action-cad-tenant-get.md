---
title: Formula — router · cad_tenant_get
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_tenant_get
...
| Field | Value |
|-------|-------|
| Name | `router · cad_tenant_get` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_tenant_get` |
| Kind | dispatcher_router |
