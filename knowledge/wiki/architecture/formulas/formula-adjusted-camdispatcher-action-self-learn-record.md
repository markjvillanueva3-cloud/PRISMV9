---
title: Formula — router · self_learn_record
type: formula
formula_id: formula.adjusted.camdispatcher.action.self_learn_record
...
# Formula — `router · self_learn_record`
...
| Field | Value |
|-------|-------|
| Name | `router · self_learn_record` |
| Graph node | `formula.adjusted.camdispatcher.action.self_learn_record` |
| Kind | dispatcher_router |
