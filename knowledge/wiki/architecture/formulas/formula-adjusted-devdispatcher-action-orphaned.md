---
title: Formula — router · orphaned
type: formula
formula_id: formula.adjusted.devdispatcher.action.orphaned
...
| Field | Value |
|-------|-------|
| Name | `router · orphaned` |
| Graph node | `formula.adjusted.devdispatcher.action.orphaned` |
| Kind | dispatcher_router |
