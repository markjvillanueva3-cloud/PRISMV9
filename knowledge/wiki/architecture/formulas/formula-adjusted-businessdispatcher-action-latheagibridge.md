---
title: Formula — router · latheAGIBridge
type: formula
formula_id: formula.adjusted.businessdispatcher.action.latheagibridge
...
| Field | Value |
|-------|-------|
| Name | `router · latheAGIBridge` |
| Graph node | `formula.adjusted.businessdispatcher.action.latheagibridge` |
| Kind | dispatcher_router |
