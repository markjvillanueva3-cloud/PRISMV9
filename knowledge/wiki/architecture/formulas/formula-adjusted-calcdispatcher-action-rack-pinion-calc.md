---
title: Formula — router · rack_pinion_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rack_pinion_calc
...
# Formula — `router · rack_pinion_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · rack_pinion_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.rack_pinion_calc` |
| Kind | dispatcher_router |
