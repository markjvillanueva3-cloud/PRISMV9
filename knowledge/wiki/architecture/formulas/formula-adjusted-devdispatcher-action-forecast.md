---
title: Formula — router · forecast
type: formula
formula_id: formula.adjusted.devdispatcher.action.forecast
...
| Field | Value |
|-------|-------|
| Name | `router · forecast` |
| Graph node | `formula.adjusted.devdispatcher.action.forecast` |
| Kind | dispatcher_router |
