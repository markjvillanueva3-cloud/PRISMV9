---
title: Formula — router · multi_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.multi_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · multi_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.multi_optimize` |
| Kind | dispatcher_router |
