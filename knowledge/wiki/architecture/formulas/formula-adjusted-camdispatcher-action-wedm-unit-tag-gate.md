---
title: Formula — router · wedm_unit_tag_gate
type: formula
formula_id: formula.adjusted.camdispatcher.action.wedm_unit_tag_gate
...
# Formula — `router · wedm_unit_tag_gate`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_unit_tag_gate` |
| Graph node | `formula.adjusted.camdispatcher.action.wedm_unit_tag_gate` |
| Kind | dispatcher_router |
