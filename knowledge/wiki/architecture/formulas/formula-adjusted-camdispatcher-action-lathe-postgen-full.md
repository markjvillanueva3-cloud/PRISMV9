---
title: Formula — router · lathe_postgen_full
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_postgen_full
...
# Formula — `router · lathe_postgen_full`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_postgen_full` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_postgen_full` |
| Kind | dispatcher_router |
