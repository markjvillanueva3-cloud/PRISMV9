---
title: Formula — router · catiaSafety
type: formula
formula_id: formula.adjusted.camdispatcher.action.catiasafety
...
| Field | Value |
|-------|-------|
| Name | `router · catiaSafety` |
| Graph node | `formula.adjusted.camdispatcher.action.catiasafety` |
| Kind | dispatcher_router |
