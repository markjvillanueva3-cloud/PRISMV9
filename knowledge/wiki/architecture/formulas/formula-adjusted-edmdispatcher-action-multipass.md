---
title: Formula — router · multiPass
type: formula
formula_id: formula.adjusted.edmdispatcher.action.multipass
...
| Field | Value |
|-------|-------|
| Name | `router · multiPass` |
| Graph node | `formula.adjusted.edmdispatcher.action.multipass` |
| Kind | dispatcher_router |
