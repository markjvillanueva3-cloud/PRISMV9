---
title: Formula — router · file_read_report
type: formula
formula_id: formula.adjusted.devdispatcher.action.file_read_report
...
# Formula — `router · file_read_report`
...
| Field | Value |
|-------|-------|
| Name | `router · file_read_report` |
| Graph node | `formula.adjusted.devdispatcher.action.file_read_report` |
| Kind | dispatcher_router |
