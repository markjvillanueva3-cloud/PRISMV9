---
title: Formula — router · calibration_status
type: formula
formula_id: formula.adjusted.calcdispatcher.action.calibration_status
...
# Formula — `router · calibration_status`
...
| Field | Value |
|-------|-------|
| Name | `router · calibration_status` |
| Graph node | `formula.adjusted.calcdispatcher.action.calibration_status` |
| Kind | dispatcher_router |
