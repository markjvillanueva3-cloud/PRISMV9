---
title: Formula — router · cad_trial_patterns
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_trial_patterns
...
# Formula — `router · cad_trial_patterns`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_trial_patterns` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_trial_patterns` |
| Kind | dispatcher_router |
