---
title: Formula — router · spm_sprt
type: formula
formula_id: formula.adjusted.camdispatcher.action.spm_sprt
...
| Field | Value |
|-------|-------|
| Name | `router · spm_sprt` |
| Graph node | `formula.adjusted.camdispatcher.action.spm_sprt` |
| Kind | dispatcher_router |
