---
title: Formula — router · program_cycle_time
type: formula
formula_id: formula.adjusted.camdispatcher.action.program_cycle_time
...
# Formula — `router · program_cycle_time`
...
| Field | Value |
|-------|-------|
| Name | `router · program_cycle_time` |
| Graph node | `formula.adjusted.camdispatcher.action.program_cycle_time` |
| Kind | dispatcher_router |
