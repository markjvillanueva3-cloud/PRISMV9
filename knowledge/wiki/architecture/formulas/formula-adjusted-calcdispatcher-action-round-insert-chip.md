---
title: Formula — router · round_insert_chip
type: formula
formula_id: formula.adjusted.calcdispatcher.action.round_insert_chip
...
# Formula — `router · round_insert_chip`
...
| Field | Value |
|-------|-------|
| Name | `router · round_insert_chip` |
| Graph node | `formula.adjusted.calcdispatcher.action.round_insert_chip` |
| Kind | dispatcher_router |
