---
title: Formula — router · toolpath
type: formula
formula_id: formula.adjusted.camdispatcher.action.toolpath
...
| Field | Value |
|-------|-------|
| Name | `router · toolpath` |
| Graph node | `formula.adjusted.camdispatcher.action.toolpath` |
| Kind | dispatcher_router |
