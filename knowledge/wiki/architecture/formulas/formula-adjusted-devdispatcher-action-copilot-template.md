---
title: Formula — router · copilot_template
type: formula
formula_id: formula.adjusted.devdispatcher.action.copilot_template
...
# Formula — `router · copilot_template`
...
| Field | Value |
|-------|-------|
| Name | `router · copilot_template` |
| Graph node | `formula.adjusted.devdispatcher.action.copilot_template` |
| Kind | dispatcher_router |
