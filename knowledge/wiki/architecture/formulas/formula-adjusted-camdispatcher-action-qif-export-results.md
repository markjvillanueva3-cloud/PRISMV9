---
title: Formula — router · qif_export_results
type: formula
formula_id: formula.adjusted.camdispatcher.action.qif_export_results
...
# Formula — `router · qif_export_results`
...
| Field | Value |
|-------|-------|
| Name | `router · qif_export_results` |
| Graph node | `formula.adjusted.camdispatcher.action.qif_export_results` |
| Kind | dispatcher_router |
