---
title: Formula — router · cam_ext_recommend
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_ext_recommend
...
# Formula — `router · cam_ext_recommend`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_ext_recommend` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_ext_recommend` |
| Kind | dispatcher_router |
