---
title: Formula — router · calc_gage_rr
type: formula
formula_id: formula.adjusted.calcdispatcher.action.calc_gage_rr
...
| Field | Value |
|-------|-------|
| Name | `router · calc_gage_rr` |
| Graph node | `formula.adjusted.calcdispatcher.action.calc_gage_rr` |
| Kind | dispatcher_router |
