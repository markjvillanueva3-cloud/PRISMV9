---
title: Formula — router · tool_safe_limits
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_safe_limits
...
# Formula — `router · tool_safe_limits`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_safe_limits` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_safe_limits` |
| Kind | dispatcher_router |
