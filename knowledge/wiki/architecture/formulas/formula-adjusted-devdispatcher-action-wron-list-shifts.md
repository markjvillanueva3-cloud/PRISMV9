---
title: Formula — router · wron_list_shifts
type: formula
formula_id: formula.adjusted.devdispatcher.action.wron_list_shifts
...
# Formula — `router · wron_list_shifts`
...
| Field | Value |
|-------|-------|
| Name | `router · wron_list_shifts` |
| Graph node | `formula.adjusted.devdispatcher.action.wron_list_shifts` |
| Kind | dispatcher_router |
