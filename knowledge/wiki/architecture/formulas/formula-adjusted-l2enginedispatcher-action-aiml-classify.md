---
title: Formula — router · aiml_classify
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.aiml_classify
...
| Field | Value |
|-------|-------|
| Name | `router · aiml_classify` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.aiml_classify` |
| Kind | dispatcher_router |
