---
title: Formula — router · quote_revise
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quote_revise
...
| Field | Value |
|-------|-------|
| Name | `router · quote_revise` |
| Graph node | `formula.adjusted.businessdispatcher.action.quote_revise` |
| Kind | dispatcher_router |
