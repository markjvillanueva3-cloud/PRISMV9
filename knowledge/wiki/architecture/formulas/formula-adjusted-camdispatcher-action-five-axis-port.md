---
title: Formula — router · five_axis_port
type: formula
formula_id: formula.adjusted.camdispatcher.action.five_axis_port
...
| Field | Value |
|-------|-------|
| Name | `router · five_axis_port` |
| Graph node | `formula.adjusted.camdispatcher.action.five_axis_port` |
| Kind | dispatcher_router |
