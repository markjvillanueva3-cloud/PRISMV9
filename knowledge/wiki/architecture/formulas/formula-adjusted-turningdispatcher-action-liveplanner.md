---
title: Formula — router · livePlanner
type: formula
formula_id: formula.adjusted.turningdispatcher.action.liveplanner
...
| Field | Value |
|-------|-------|
| Name | `router · livePlanner` |
| Graph node | `formula.adjusted.turningdispatcher.action.liveplanner` |
| Kind | dispatcher_router |
