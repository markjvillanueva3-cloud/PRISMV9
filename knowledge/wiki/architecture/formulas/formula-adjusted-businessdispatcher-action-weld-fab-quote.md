---
title: Formula — router · weld_fab_quote
type: formula
formula_id: formula.adjusted.businessdispatcher.action.weld_fab_quote
...
| Field | Value |
|-------|-------|
| Name | `router · weld_fab_quote` |
| Graph node | `formula.adjusted.businessdispatcher.action.weld_fab_quote` |
| Kind | dispatcher_router |
