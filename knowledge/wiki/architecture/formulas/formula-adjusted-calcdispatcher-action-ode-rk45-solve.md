---
title: Formula — router · ode_rk45_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ode_rk45_solve
...
| Field | Value |
|-------|-------|
| Name | `router · ode_rk45_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.ode_rk45_solve` |
| Kind | dispatcher_router |
