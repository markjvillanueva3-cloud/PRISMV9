---
title: Formula — router · quick_resume
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.quick_resume
...
| Field | Value |
|-------|-------|
| Name | `router · quick_resume` |
| Graph node | `formula.adjusted.sessiondispatcher.action.quick_resume` |
| Kind | dispatcher_router |
