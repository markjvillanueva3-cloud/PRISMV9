---
title: Formula — router · solid_scale
type: formula
formula_id: formula.adjusted.calcdispatcher.action.solid_scale
...
| Field | Value |
|-------|-------|
| Name | `router · solid_scale` |
| Graph node | `formula.adjusted.calcdispatcher.action.solid_scale` |
| Kind | dispatcher_router |
