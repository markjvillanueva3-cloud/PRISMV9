---
title: Formula — router · moat_calculate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.moat_calculate
...
| Field | Value |
|-------|-------|
| Name | `router · moat_calculate` |
| Graph node | `formula.adjusted.calcdispatcher.action.moat_calculate` |
| Kind | dispatcher_router |
