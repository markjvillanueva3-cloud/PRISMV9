---
title: Formula — router · list_open
type: formula
formula_id: formula.adjusted.devdispatcher.action.list_open
...
| Field | Value |
|-------|-------|
| Name | `router · list_open` |
| Graph node | `formula.adjusted.devdispatcher.action.list_open` |
| Kind | dispatcher_router |
