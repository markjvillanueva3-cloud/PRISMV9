---
title: Formula — router · machineRateDb
type: formula
formula_id: formula.adjusted.businessdispatcher.action.machineratedb
...
| Field | Value |
|-------|-------|
| Name | `router · machineRateDb` |
| Graph node | `formula.adjusted.businessdispatcher.action.machineratedb` |
| Kind | dispatcher_router |
