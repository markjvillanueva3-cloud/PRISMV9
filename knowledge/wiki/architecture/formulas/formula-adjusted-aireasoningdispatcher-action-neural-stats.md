---
title: Formula — router · neural_stats
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.neural_stats
...
| Field | Value |
|-------|-------|
| Name | `router · neural_stats` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.neural_stats` |
| Kind | dispatcher_router |
