---
title: Formula — router · soft_jaw_design
type: formula
formula_id: formula.adjusted.calcdispatcher.action.soft_jaw_design
...
# Formula — `router · soft_jaw_design`
...
| Field | Value |
|-------|-------|
| Name | `router · soft_jaw_design` |
| Graph node | `formula.adjusted.calcdispatcher.action.soft_jaw_design` |
| Kind | dispatcher_router |
