---
title: Formula — router · mastercam_execute
type: formula
formula_id: formula.adjusted.caddispatcher.action.mastercam_execute
...
# Formula — `router · mastercam_execute`
...
| Field | Value |
|-------|-------|
| Name | `router · mastercam_execute` |
| Graph node | `formula.adjusted.caddispatcher.action.mastercam_execute` |
| Kind | dispatcher_router |
