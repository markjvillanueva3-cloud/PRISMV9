---
title: Formula — router · cam_lora_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_lora_list
...
| Field | Value |
|-------|-------|
| Name | `router · cam_lora_list` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_lora_list` |
| Kind | dispatcher_router |
