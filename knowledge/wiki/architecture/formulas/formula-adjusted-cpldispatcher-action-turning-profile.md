---
title: Formula — router · turning_profile
type: formula
formula_id: formula.adjusted.cpldispatcher.action.turning_profile
...
# Formula — `router · turning_profile`
...
| Field | Value |
|-------|-------|
| Name | `router · turning_profile` |
| Graph node | `formula.adjusted.cpldispatcher.action.turning_profile` |
| Kind | dispatcher_router |
