---
title: Formula — router · sfc_safety
type: formula
formula_id: formula.adjusted.productdispatcher.action.sfc_safety
...
| Field | Value |
|-------|-------|
| Name | `router · sfc_safety` |
| Graph node | `formula.adjusted.productdispatcher.action.sfc_safety` |
| Kind | dispatcher_router |
