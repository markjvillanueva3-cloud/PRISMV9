---
title: Formula — router · cpkPredictionGate
type: formula
formula_id: formula.adjusted.camdispatcher.action.cpkpredictiongate
...
# Formula — `router · cpkPredictionGate`
...
| Field | Value |
|-------|-------|
| Name | `router · cpkPredictionGate` |
| Graph node | `formula.adjusted.camdispatcher.action.cpkpredictiongate` |
| Kind | dispatcher_router |
