---
title: Formula — router · solidCAMOpCat
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcamopcat
...
| Field | Value |
|-------|-------|
| Name | `router · solidCAMOpCat` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcamopcat` |
| Kind | dispatcher_router |
