---
title: Formula — router · moo_nsga2
type: formula
formula_id: formula.adjusted.calcdispatcher.action.moo_nsga2
...
| Field | Value |
|-------|-------|
| Name | `router · moo_nsga2` |
| Graph node | `formula.adjusted.calcdispatcher.action.moo_nsga2` |
| Kind | dispatcher_router |
