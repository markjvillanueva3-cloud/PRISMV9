---
title: Formula — router · ajm_nozzle_wear
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ajm_nozzle_wear
...
# Formula — `router · ajm_nozzle_wear`
...
| Field | Value |
|-------|-------|
| Name | `router · ajm_nozzle_wear` |
| Graph node | `formula.adjusted.calcdispatcher.action.ajm_nozzle_wear` |
| Kind | dispatcher_router |
