---
title: Formula — router · wedm_weibull_fit
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_weibull_fit
...
# Formula — `router · wedm_weibull_fit`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_weibull_fit` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_weibull_fit` |
| Kind | dispatcher_router |
