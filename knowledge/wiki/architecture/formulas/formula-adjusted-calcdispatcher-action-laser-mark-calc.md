---
title: Formula — router · laser_mark_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.laser_mark_calc
...
# Formula — `router · laser_mark_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_mark_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.laser_mark_calc` |
| Kind | dispatcher_router |
