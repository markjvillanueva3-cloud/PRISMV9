---
title: Formula — router · calc_queue_theory
type: formula
formula_id: formula.adjusted.calcdispatcher.action.calc_queue_theory
...
# Formula — `router · calc_queue_theory`
...
| Field | Value |
|-------|-------|
| Name | `router · calc_queue_theory` |
| Graph node | `formula.adjusted.calcdispatcher.action.calc_queue_theory` |
| Kind | dispatcher_router |
