---
title: Formula — router · sdk_check_safety
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sdk_check_safety
...
# Formula — `router · sdk_check_safety`
...
| Field | Value |
|-------|-------|
| Name | `router · sdk_check_safety` |
| Graph node | `formula.adjusted.calcdispatcher.action.sdk_check_safety` |
| Kind | dispatcher_router |
