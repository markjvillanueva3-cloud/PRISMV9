---
title: Formula — router · anomalyDetection
type: formula
formula_id: formula.adjusted.camdispatcher.action.anomalydetection
...
# Formula — `router · anomalyDetection`
...
| Field | Value |
|-------|-------|
| Name | `router · anomalyDetection` |
| Graph node | `formula.adjusted.camdispatcher.action.anomalydetection` |
| Kind | dispatcher_router |
