---
title: Formula — router · shot_peen_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.shot_peen_calc
...
| Field | Value |
|-------|-------|
| Name | `router · shot_peen_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.shot_peen_calc` |
| Kind | dispatcher_router |
