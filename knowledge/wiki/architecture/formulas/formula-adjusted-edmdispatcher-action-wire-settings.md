---
title: Formula — router · wire_settings
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wire_settings
...
| Field | Value |
|-------|-------|
| Name | `router · wire_settings` |
| Graph node | `formula.adjusted.edmdispatcher.action.wire_settings` |
| Kind | dispatcher_router |
