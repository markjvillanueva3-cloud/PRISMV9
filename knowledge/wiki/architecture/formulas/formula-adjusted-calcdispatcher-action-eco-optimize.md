---
title: Formula — router · eco_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.eco_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · eco_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.eco_optimize` |
| Kind | dispatcher_router |
