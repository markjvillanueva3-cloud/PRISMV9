---
title: Formula — router · edit_impact_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.edit_impact_stats
...
# Formula — `router · edit_impact_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · edit_impact_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.edit_impact_stats` |
| Kind | dispatcher_router |
