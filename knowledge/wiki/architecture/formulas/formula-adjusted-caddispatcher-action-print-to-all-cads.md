---
title: Formula — router · print_to_all_cads
type: formula
formula_id: formula.adjusted.caddispatcher.action.print_to_all_cads
...
# Formula — `router · print_to_all_cads`
...
| Field | Value |
|-------|-------|
| Name | `router · print_to_all_cads` |
| Graph node | `formula.adjusted.caddispatcher.action.print_to_all_cads` |
| Kind | dispatcher_router |
