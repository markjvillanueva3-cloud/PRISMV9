---
title: Formula — router · kde_2d
type: formula
formula_id: formula.adjusted.calcdispatcher.action.kde_2d
...
|-------|-------|
| Name | `router · kde_2d` |
| Graph node | `formula.adjusted.calcdispatcher.action.kde_2d` |
| Kind | dispatcher_router |
