---
title: Formula — router · gse_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.gse_get
...
|-------|-------|
| Name | `router · gse_get` |
| Graph node | `formula.adjusted.devdispatcher.action.gse_get` |
| Kind | dispatcher_router |
