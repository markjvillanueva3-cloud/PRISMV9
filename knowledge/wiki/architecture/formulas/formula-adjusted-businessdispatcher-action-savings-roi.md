---
title: Formula — router · savings_roi
type: formula
formula_id: formula.adjusted.businessdispatcher.action.savings_roi
...
| Field | Value |
|-------|-------|
| Name | `router · savings_roi` |
| Graph node | `formula.adjusted.businessdispatcher.action.savings_roi` |
| Kind | dispatcher_router |
