---
title: Formula — router · nxCAMToolBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcamtoolbridge
...
# Formula — `router · nxCAMToolBridge`
...
| Field | Value |
|-------|-------|
| Name | `router · nxCAMToolBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcamtoolbridge` |
| Kind | dispatcher_router |
