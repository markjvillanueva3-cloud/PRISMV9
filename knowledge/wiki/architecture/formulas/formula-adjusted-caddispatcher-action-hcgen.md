---
title: Formula — router · hcGen
type: formula
formula_id: formula.adjusted.caddispatcher.action.hcgen
...
|-------|-------|
| Name | `router · hcGen` |
| Graph node | `formula.adjusted.caddispatcher.action.hcgen` |
| Kind | dispatcher_router |
