---
title: Formula — router · wedm_mrr_calculate
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_mrr_calculate
...
# Formula — `router · wedm_mrr_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_mrr_calculate` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_mrr_calculate` |
| Kind | dispatcher_router |
