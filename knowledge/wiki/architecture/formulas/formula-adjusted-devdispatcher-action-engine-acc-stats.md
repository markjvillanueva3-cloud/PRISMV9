---
title: Formula — router · engine_acc_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.engine_acc_stats
...
# Formula — `router · engine_acc_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · engine_acc_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.engine_acc_stats` |
| Kind | dispatcher_router |
