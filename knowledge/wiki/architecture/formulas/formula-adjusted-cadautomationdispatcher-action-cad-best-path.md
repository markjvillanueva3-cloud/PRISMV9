---
title: Formula — router · cad_best_path
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_best_path
...
| Field | Value |
|-------|-------|
| Name | `router · cad_best_path` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_best_path` |
| Kind | dispatcher_router |
