---
title: Formula — router · stochastic_wrap_mc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stochastic_wrap_mc
...
# Formula — `router · stochastic_wrap_mc`
...
| Field | Value |
|-------|-------|
| Name | `router · stochastic_wrap_mc` |
| Graph node | `formula.adjusted.calcdispatcher.action.stochastic_wrap_mc` |
| Kind | dispatcher_router |
