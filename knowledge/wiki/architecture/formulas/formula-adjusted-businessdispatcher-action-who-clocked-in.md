---
title: Formula — router · who_clocked_in
type: formula
formula_id: formula.adjusted.businessdispatcher.action.who_clocked_in
...
| Field | Value |
|-------|-------|
| Name | `router · who_clocked_in` |
| Graph node | `formula.adjusted.businessdispatcher.action.who_clocked_in` |
| Kind | dispatcher_router |
