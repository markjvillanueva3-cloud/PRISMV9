---
title: Formula — router · solidcamCodeGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcamcodegen
...
# Formula — `router · solidcamCodeGen`
...
| Field | Value |
|-------|-------|
| Name | `router · solidcamCodeGen` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcamcodegen` |
| Kind | dispatcher_router |
