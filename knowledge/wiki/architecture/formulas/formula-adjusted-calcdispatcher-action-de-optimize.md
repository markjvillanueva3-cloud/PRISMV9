---
title: Formula — router · de_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.de_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · de_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.de_optimize` |
| Kind | dispatcher_router |
