---
title: Formula — router · nxcam_safety_rules
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcam_safety_rules
...
# Formula — `router · nxcam_safety_rules`
...
| Field | Value |
|-------|-------|
| Name | `router · nxcam_safety_rules` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcam_safety_rules` |
| Kind | dispatcher_router |
