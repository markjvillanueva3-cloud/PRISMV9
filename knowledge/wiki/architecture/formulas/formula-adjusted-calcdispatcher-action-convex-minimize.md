---
title: Formula — router · convex_minimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.convex_minimize
...
# Formula — `router · convex_minimize`
...
| Field | Value |
|-------|-------|
| Name | `router · convex_minimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.convex_minimize` |
| Kind | dispatcher_router |
