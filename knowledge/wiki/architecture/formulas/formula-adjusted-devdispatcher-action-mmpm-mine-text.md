---
title: Formula — router · mmpm_mine_text
type: formula
formula_id: formula.adjusted.devdispatcher.action.mmpm_mine_text
...
| Field | Value |
|-------|-------|
| Name | `router · mmpm_mine_text` |
| Graph node | `formula.adjusted.devdispatcher.action.mmpm_mine_text` |
| Kind | dispatcher_router |
