---
title: Formula — router · anodizing_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.anodizing_calc
...
| Field | Value |
|-------|-------|
| Name | `router · anodizing_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.anodizing_calc` |
| Kind | dispatcher_router |
