---
title: Formula — router · cot_explain
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.cot_explain
...
| Field | Value |
|-------|-------|
| Name | `router · cot_explain` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.cot_explain` |
| Kind | dispatcher_router |
