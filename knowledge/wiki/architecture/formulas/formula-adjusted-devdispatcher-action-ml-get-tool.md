---
title: Formula — router · ml_get_tool
type: formula
formula_id: formula.adjusted.devdispatcher.action.ml_get_tool
...
| Field | Value |
|-------|-------|
| Name | `router · ml_get_tool` |
| Graph node | `formula.adjusted.devdispatcher.action.ml_get_tool` |
| Kind | dispatcher_router |
