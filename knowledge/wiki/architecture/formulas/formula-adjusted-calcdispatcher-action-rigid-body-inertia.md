---
title: Formula — router · rigid_body_inertia
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rigid_body_inertia
...
# Formula — `router · rigid_body_inertia`
...
| Field | Value |
|-------|-------|
| Name | `router · rigid_body_inertia` |
| Graph node | `formula.adjusted.calcdispatcher.action.rigid_body_inertia` |
| Kind | dispatcher_router |
