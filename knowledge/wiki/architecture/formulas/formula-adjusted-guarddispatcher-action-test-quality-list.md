---
title: Formula — router · test_quality_list
type: formula
formula_id: formula.adjusted.guarddispatcher.action.test_quality_list
...
# Formula — `router · test_quality_list`
...
| Field | Value |
|-------|-------|
| Name | `router · test_quality_list` |
| Graph node | `formula.adjusted.guarddispatcher.action.test_quality_list` |
| Kind | dispatcher_router |
