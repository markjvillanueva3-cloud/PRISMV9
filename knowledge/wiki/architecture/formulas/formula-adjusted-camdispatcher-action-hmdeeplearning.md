---
title: Formula — router · hmDeepLearning
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmdeeplearning
...
| Field | Value |
|-------|-------|
| Name | `router · hmDeepLearning` |
| Graph node | `formula.adjusted.camdispatcher.action.hmdeeplearning` |
| Kind | dispatcher_router |
