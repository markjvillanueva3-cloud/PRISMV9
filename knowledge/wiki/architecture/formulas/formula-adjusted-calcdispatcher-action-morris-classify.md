---
title: Formula — router · morris_classify
type: formula
formula_id: formula.adjusted.calcdispatcher.action.morris_classify
...
# Formula — `router · morris_classify`
...
| Field | Value |
|-------|-------|
| Name | `router · morris_classify` |
| Graph node | `formula.adjusted.calcdispatcher.action.morris_classify` |
| Kind | dispatcher_router |
