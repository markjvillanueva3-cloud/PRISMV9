---
title: Formula — router · queue_mmc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.queue_mmc
...
| Field | Value |
|-------|-------|
| Name | `router · queue_mmc` |
| Graph node | `formula.adjusted.calcdispatcher.action.queue_mmc` |
| Kind | dispatcher_router |
