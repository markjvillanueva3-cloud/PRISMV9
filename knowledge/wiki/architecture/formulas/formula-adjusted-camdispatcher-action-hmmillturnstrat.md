---
title: Formula — router · hmMillTurnStrat
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmmillturnstrat
...
# Formula — `router · hmMillTurnStrat`
...
| Field | Value |
|-------|-------|
| Name | `router · hmMillTurnStrat` |
| Graph node | `formula.adjusted.camdispatcher.action.hmmillturnstrat` |
| Kind | dispatcher_router |
