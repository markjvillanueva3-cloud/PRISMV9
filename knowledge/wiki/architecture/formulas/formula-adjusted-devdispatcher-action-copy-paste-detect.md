---
title: Formula — router · copy_paste_detect
type: formula
formula_id: formula.adjusted.devdispatcher.action.copy_paste_detect
...
# Formula — `router · copy_paste_detect`
...
| Field | Value |
|-------|-------|
| Name | `router · copy_paste_detect` |
| Graph node | `formula.adjusted.devdispatcher.action.copy_paste_detect` |
| Kind | dispatcher_router |
