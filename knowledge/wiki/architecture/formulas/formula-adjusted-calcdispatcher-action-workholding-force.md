---
title: Formula — router · workholding_force
type: formula
formula_id: formula.adjusted.calcdispatcher.action.workholding_force
...
# Formula — `router · workholding_force`
...
| Field | Value |
|-------|-------|
| Name | `router · workholding_force` |
| Graph node | `formula.adjusted.calcdispatcher.action.workholding_force` |
| Kind | dispatcher_router |
