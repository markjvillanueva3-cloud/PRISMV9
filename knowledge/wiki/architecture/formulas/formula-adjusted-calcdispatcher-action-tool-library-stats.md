---
title: Formula — router · tool_library_stats
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_library_stats
...
# Formula — `router · tool_library_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_library_stats` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_library_stats` |
| Kind | dispatcher_router |
