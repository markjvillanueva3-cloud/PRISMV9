---
title: Formula — router · thermoform
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.thermoform
...
| Field | Value |
|-------|-------|
| Name | `router · thermoform` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.thermoform` |
| Kind | dispatcher_router |
