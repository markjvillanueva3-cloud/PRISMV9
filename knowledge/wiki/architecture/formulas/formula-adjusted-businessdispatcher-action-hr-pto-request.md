---
title: Formula — router · hr_pto_request
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_pto_request
...
| Field | Value |
|-------|-------|
| Name | `router · hr_pto_request` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_pto_request` |
| Kind | dispatcher_router |
