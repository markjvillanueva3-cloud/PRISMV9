---
title: Formula — router · order_log_time
type: formula
formula_id: formula.adjusted.businessdispatcher.action.order_log_time
...
| Field | Value |
|-------|-------|
| Name | `router · order_log_time` |
| Graph node | `formula.adjusted.businessdispatcher.action.order_log_time` |
| Kind | dispatcher_router |
