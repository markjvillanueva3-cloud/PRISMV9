---
title: Formula — router · stats_oee
type: formula
formula_id: formula.adjusted.camdispatcher.action.stats_oee
...
| Field | Value |
|-------|-------|
| Name | `router · stats_oee` |
| Graph node | `formula.adjusted.camdispatcher.action.stats_oee` |
| Kind | dispatcher_router |
