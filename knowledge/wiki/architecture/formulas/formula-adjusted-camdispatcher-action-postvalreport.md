---
title: Formula — router · postValReport
type: formula
formula_id: formula.adjusted.camdispatcher.action.postvalreport
...
| Field | Value |
|-------|-------|
| Name | `router · postValReport` |
| Graph node | `formula.adjusted.camdispatcher.action.postvalreport` |
| Kind | dispatcher_router |
