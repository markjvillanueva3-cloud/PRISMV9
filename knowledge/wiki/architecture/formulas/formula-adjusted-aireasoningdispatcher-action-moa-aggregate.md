---
title: Formula — router · moa_aggregate
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.moa_aggregate
...
| Field | Value |
|-------|-------|
| Name | `router · moa_aggregate` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.moa_aggregate` |
| Kind | dispatcher_router |
