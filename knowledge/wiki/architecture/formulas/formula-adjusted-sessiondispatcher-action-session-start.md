---
title: Formula — router · session_start
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.session_start
...
| Field | Value |
|-------|-------|
| Name | `router · session_start` |
| Graph node | `formula.adjusted.sessiondispatcher.action.session_start` |
| Kind | dispatcher_router |
