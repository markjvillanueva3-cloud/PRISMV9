---
title: Formula — router · cam_cache_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_cache_stats
...
# Formula — `router · cam_cache_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_cache_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_cache_stats` |
| Kind | dispatcher_router |
