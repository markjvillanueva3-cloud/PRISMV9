---
title: Formula — router · wedm_check_spec
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_check_spec
...
# Formula — `router · wedm_check_spec`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_check_spec` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_check_spec` |
| Kind | dispatcher_router |
