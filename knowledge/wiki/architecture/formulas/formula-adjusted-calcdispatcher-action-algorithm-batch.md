---
title: Formula — router · algorithm_batch
type: formula
formula_id: formula.adjusted.calcdispatcher.action.algorithm_batch
...
# Formula — `router · algorithm_batch`
...
| Field | Value |
|-------|-------|
| Name | `router · algorithm_batch` |
| Graph node | `formula.adjusted.calcdispatcher.action.algorithm_batch` |
| Kind | dispatcher_router |
