---
title: Formula — router · financial_npv
type: formula
formula_id: formula.adjusted.businessdispatcher.action.financial_npv
...
| Field | Value |
|-------|-------|
| Name | `router · financial_npv` |
| Graph node | `formula.adjusted.businessdispatcher.action.financial_npv` |
| Kind | dispatcher_router |
