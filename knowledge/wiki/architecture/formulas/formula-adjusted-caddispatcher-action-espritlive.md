---
title: Formula — router · espritLive
type: formula
formula_id: formula.adjusted.caddispatcher.action.espritlive
...
| Field | Value |
|-------|-------|
| Name | `router · espritLive` |
| Graph node | `formula.adjusted.caddispatcher.action.espritlive` |
| Kind | dispatcher_router |
