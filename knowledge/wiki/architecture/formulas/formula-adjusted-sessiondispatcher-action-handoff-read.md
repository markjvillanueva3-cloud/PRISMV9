---
title: Formula — router · handoff_read
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.handoff_read
...
| Field | Value |
|-------|-------|
| Name | `router · handoff_read` |
| Graph node | `formula.adjusted.sessiondispatcher.action.handoff_read` |
| Kind | dispatcher_router |
