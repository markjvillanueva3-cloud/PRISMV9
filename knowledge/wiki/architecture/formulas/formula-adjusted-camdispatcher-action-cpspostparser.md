---
title: Formula — router · cpsPostParser
type: formula
formula_id: formula.adjusted.camdispatcher.action.cpspostparser
...
| Field | Value |
|-------|-------|
| Name | `router · cpsPostParser` |
| Graph node | `formula.adjusted.camdispatcher.action.cpspostparser` |
| Kind | dispatcher_router |
