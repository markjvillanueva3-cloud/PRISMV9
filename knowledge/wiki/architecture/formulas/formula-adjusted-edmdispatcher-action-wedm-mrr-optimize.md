---
title: Formula — router · wedm_mrr_optimize
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_mrr_optimize
...
# Formula — `router · wedm_mrr_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_mrr_optimize` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_mrr_optimize` |
| Kind | dispatcher_router |
