---
title: Formula — router · quote_abc_cost
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quote_abc_cost
...
| Field | Value |
|-------|-------|
| Name | `router · quote_abc_cost` |
| Graph node | `formula.adjusted.businessdispatcher.action.quote_abc_cost` |
| Kind | dispatcher_router |
