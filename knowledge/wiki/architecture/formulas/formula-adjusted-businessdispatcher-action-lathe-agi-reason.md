---
title: Formula — router · lathe_agi_reason
type: formula
formula_id: formula.adjusted.businessdispatcher.action.lathe_agi_reason
...
# Formula — `router · lathe_agi_reason`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_agi_reason` |
| Graph node | `formula.adjusted.businessdispatcher.action.lathe_agi_reason` |
| Kind | dispatcher_router |
