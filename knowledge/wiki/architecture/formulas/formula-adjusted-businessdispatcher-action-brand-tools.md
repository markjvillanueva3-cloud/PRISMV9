---
title: Formula — router · brand_tools
type: formula
formula_id: formula.adjusted.businessdispatcher.action.brand_tools
...
| Field | Value |
|-------|-------|
| Name | `router · brand_tools` |
| Graph node | `formula.adjusted.businessdispatcher.action.brand_tools` |
| Kind | dispatcher_router |
