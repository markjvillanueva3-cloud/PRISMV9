---
title: Formula — router · pfh_to_snapshot
type: formula
formula_id: formula.adjusted.devdispatcher.action.pfh_to_snapshot
...
# Formula — `router · pfh_to_snapshot`
...
| Field | Value |
|-------|-------|
| Name | `router · pfh_to_snapshot` |
| Graph node | `formula.adjusted.devdispatcher.action.pfh_to_snapshot` |
| Kind | dispatcher_router |
