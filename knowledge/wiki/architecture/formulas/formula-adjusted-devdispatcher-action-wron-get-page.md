---
title: Formula — router · wron_get_page
type: formula
formula_id: formula.adjusted.devdispatcher.action.wron_get_page
...
| Field | Value |
|-------|-------|
| Name | `router · wron_get_page` |
| Graph node | `formula.adjusted.devdispatcher.action.wron_get_page` |
| Kind | dispatcher_router |
