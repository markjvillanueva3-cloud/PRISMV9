---
title: Formula — router · svd_decompose
type: formula
formula_id: formula.adjusted.calcdispatcher.action.svd_decompose
...
| Field | Value |
|-------|-------|
| Name | `router · svd_decompose` |
| Graph node | `formula.adjusted.calcdispatcher.action.svd_decompose` |
| Kind | dispatcher_router |
