---
title: Formula — router · post_monte_carlo
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_monte_carlo
...
# Formula — `router · post_monte_carlo`
...
| Field | Value |
|-------|-------|
| Name | `router · post_monte_carlo` |
| Graph node | `formula.adjusted.camdispatcher.action.post_monte_carlo` |
| Kind | dispatcher_router |
