---
title: Formula — router · multiCam
type: formula
formula_id: formula.adjusted.camdispatcher.action.multicam
...
| Field | Value |
|-------|-------|
| Name | `router · multiCam` |
| Graph node | `formula.adjusted.camdispatcher.action.multicam` |
| Kind | dispatcher_router |
