---
title: Formula — router · printToSolidWorks
type: formula
formula_id: formula.adjusted.caddispatcher.action.printtosolidworks
...
# Formula — `router · printToSolidWorks`
...
| Field | Value |
|-------|-------|
| Name | `router · printToSolidWorks` |
| Graph node | `formula.adjusted.caddispatcher.action.printtosolidworks` |
| Kind | dispatcher_router |
