---
title: Formula — router · lathe_sf_explain
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_sf_explain
...
# Formula — `router · lathe_sf_explain`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_sf_explain` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_sf_explain` |
| Kind | dispatcher_router |
