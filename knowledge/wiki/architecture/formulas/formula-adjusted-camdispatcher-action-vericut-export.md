---
title: Formula — router · vericut_export
type: formula
formula_id: formula.adjusted.camdispatcher.action.vericut_export
...
| Field | Value |
|-------|-------|
| Name | `router · vericut_export` |
| Graph node | `formula.adjusted.camdispatcher.action.vericut_export` |
| Kind | dispatcher_router |
