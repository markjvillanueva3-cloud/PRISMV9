---
title: Formula — router · roi_log
type: formula
formula_id: formula.adjusted.businessdispatcher.action.roi_log
...
|-------|-------|
| Name | `router · roi_log` |
| Graph node | `formula.adjusted.businessdispatcher.action.roi_log` |
| Kind | dispatcher_router |
