---
title: Formula — router · rev_idx_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.rev_idx_stats
...
| Field | Value |
|-------|-------|
| Name | `router · rev_idx_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.rev_idx_stats` |
| Kind | dispatcher_router |
