---
title: Formula — router · fixture_layout_321
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fixture_layout_321
...
# Formula — `router · fixture_layout_321`
...
| Field | Value |
|-------|-------|
| Name | `router · fixture_layout_321` |
| Graph node | `formula.adjusted.calcdispatcher.action.fixture_layout_321` |
| Kind | dispatcher_router |
