---
title: Formula — router · tube_forming_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tube_forming_calc
...
# Formula — `router · tube_forming_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · tube_forming_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.tube_forming_calc` |
| Kind | dispatcher_router |
