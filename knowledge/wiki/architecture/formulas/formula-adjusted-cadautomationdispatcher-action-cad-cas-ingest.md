---
title: Formula — router · cad_cas_ingest
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_cas_ingest
...
| Field | Value |
|-------|-------|
| Name | `router · cad_cas_ingest` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_cas_ingest` |
| Kind | dispatcher_router |
