---
title: Formula — router · tool_job_cost
type: formula
formula_id: formula.adjusted.businessdispatcher.action.tool_job_cost
...
| Field | Value |
|-------|-------|
| Name | `router · tool_job_cost` |
| Graph node | `formula.adjusted.businessdispatcher.action.tool_job_cost` |
| Kind | dispatcher_router |
