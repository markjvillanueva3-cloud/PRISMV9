---
title: Formula — router · dfm_check
type: formula
formula_id: formula.adjusted.caddispatcher.action.dfm_check
...
| Field | Value |
|-------|-------|
| Name | `router · dfm_check` |
| Graph node | `formula.adjusted.caddispatcher.action.dfm_check` |
| Kind | dispatcher_router |
