---
title: Formula — router · solidcamSafety
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcamsafety
...
| Field | Value |
|-------|-------|
| Name | `router · solidcamSafety` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcamsafety` |
| Kind | dispatcher_router |
