---
title: Formula — router · rolling_mill_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rolling_mill_calc
...
# Formula — `router · rolling_mill_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · rolling_mill_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.rolling_mill_calc` |
| Kind | dispatcher_router |
