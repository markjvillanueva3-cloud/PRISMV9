---
title: Formula — router · job_time_stop
type: formula
formula_id: formula.adjusted.businessdispatcher.action.job_time_stop
...
| Field | Value |
|-------|-------|
| Name | `router · job_time_stop` |
| Graph node | `formula.adjusted.businessdispatcher.action.job_time_stop` |
| Kind | dispatcher_router |
