---
title: Formula — router · wedm_plan_passes
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_plan_passes
...
# Formula — `router · wedm_plan_passes`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_plan_passes` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_plan_passes` |
| Kind | dispatcher_router |
