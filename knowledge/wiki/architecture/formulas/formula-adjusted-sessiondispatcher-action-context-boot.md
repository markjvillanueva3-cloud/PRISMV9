---
title: Formula — router · context_boot
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.context_boot
...
| Field | Value |
|-------|-------|
| Name | `router · context_boot` |
| Graph node | `formula.adjusted.sessiondispatcher.action.context_boot` |
| Kind | dispatcher_router |
