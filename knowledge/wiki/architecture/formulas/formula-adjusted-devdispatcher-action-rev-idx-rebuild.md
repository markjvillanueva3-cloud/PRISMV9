---
title: Formula — router · rev_idx_rebuild
type: formula
formula_id: formula.adjusted.devdispatcher.action.rev_idx_rebuild
...
# Formula — `router · rev_idx_rebuild`
...
| Field | Value |
|-------|-------|
| Name | `router · rev_idx_rebuild` |
| Graph node | `formula.adjusted.devdispatcher.action.rev_idx_rebuild` |
| Kind | dispatcher_router |
