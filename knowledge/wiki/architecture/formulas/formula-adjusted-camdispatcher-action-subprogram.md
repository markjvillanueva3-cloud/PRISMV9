---
title: Formula — router · subprogram
type: formula
formula_id: formula.adjusted.camdispatcher.action.subprogram
...
| Field | Value |
|-------|-------|
| Name | `router · subprogram` |
| Graph node | `formula.adjusted.camdispatcher.action.subprogram` |
| Kind | dispatcher_router |
