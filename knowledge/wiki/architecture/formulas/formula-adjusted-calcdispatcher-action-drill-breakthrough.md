---
title: Formula — router · drill_breakthrough
type: formula
formula_id: formula.adjusted.calcdispatcher.action.drill_breakthrough
...
# Formula — `router · drill_breakthrough`
...
| Field | Value |
|-------|-------|
| Name | `router · drill_breakthrough` |
| Graph node | `formula.adjusted.calcdispatcher.action.drill_breakthrough` |
| Kind | dispatcher_router |
