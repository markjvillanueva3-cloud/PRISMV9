---
title: Formula — router · mca_feature_vector
type: formula
formula_id: formula.adjusted.devdispatcher.action.mca_feature_vector
...
# Formula — `router · mca_feature_vector`
...
| Field | Value |
|-------|-------|
| Name | `router · mca_feature_vector` |
| Graph node | `formula.adjusted.devdispatcher.action.mca_feature_vector` |
| Kind | dispatcher_router |
