---
title: Formula — router · pp_resolve_context
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_resolve_context
...
# Formula — `router · pp_resolve_context`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_resolve_context` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_resolve_context` |
| Kind | dispatcher_router |
