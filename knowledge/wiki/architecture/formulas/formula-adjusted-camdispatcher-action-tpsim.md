---
title: Formula — router · tpSim
type: formula
formula_id: formula.adjusted.camdispatcher.action.tpsim
...
|-------|-------|
| Name | `router · tpSim` |
| Graph node | `formula.adjusted.camdispatcher.action.tpsim` |
| Kind | dispatcher_router |
