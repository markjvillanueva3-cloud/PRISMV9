---
title: Formula — router · heat_conduction_1d
type: formula
formula_id: formula.adjusted.calcdispatcher.action.heat_conduction_1d
...
# Formula — `router · heat_conduction_1d`
...
| Field | Value |
|-------|-------|
| Name | `router · heat_conduction_1d` |
| Graph node | `formula.adjusted.calcdispatcher.action.heat_conduction_1d` |
| Kind | dispatcher_router |
