---
title: Formula — router · cascade
type: formula
formula_id: formula.adjusted.mldispatcher.action.cascade
...
|-------|-------|
| Name | `router · cascade` |
| Graph node | `formula.adjusted.mldispatcher.action.cascade` |
| Kind | dispatcher_router |
