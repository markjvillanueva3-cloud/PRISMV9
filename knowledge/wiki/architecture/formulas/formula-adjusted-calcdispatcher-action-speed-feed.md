---
title: Formula — router · speed_feed
type: formula
formula_id: formula.adjusted.calcdispatcher.action.speed_feed
...
| Field | Value |
|-------|-------|
| Name | `router · speed_feed` |
| Graph node | `formula.adjusted.calcdispatcher.action.speed_feed` |
| Kind | dispatcher_router |
