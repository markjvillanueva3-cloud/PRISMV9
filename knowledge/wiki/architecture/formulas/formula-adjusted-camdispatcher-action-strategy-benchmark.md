---
title: Formula — router · strategy_benchmark
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategy_benchmark
...
# Formula — `router · strategy_benchmark`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_benchmark` |
| Graph node | `formula.adjusted.camdispatcher.action.strategy_benchmark` |
| Kind | dispatcher_router |
