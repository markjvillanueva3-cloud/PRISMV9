---
title: Formula — router · steady
type: formula
formula_id: formula.adjusted.turningdispatcher.action.steady
...
|-------|-------|
| Name | `router · steady` |
| Graph node | `formula.adjusted.turningdispatcher.action.steady` |
| Kind | dispatcher_router |
