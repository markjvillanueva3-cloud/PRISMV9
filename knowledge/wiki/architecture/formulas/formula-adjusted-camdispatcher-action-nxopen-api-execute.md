---
title: Formula — router · nxopen_api_execute
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxopen_api_execute
...
# Formula — `router · nxopen_api_execute`
...
| Field | Value |
|-------|-------|
| Name | `router · nxopen_api_execute` |
| Graph node | `formula.adjusted.camdispatcher.action.nxopen_api_execute` |
| Kind | dispatcher_router |
