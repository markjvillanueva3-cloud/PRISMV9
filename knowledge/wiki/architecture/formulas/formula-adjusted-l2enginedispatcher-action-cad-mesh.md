---
title: Formula — router · cad_mesh
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.cad_mesh
...
| Field | Value |
|-------|-------|
| Name | `router · cad_mesh` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.cad_mesh` |
| Kind | dispatcher_router |
