---
title: Formula — router · cam_collision
type: formula
formula_id: formula.adjusted.l2enginedispatcher.action.cam_collision
...
| Field | Value |
|-------|-------|
| Name | `router · cam_collision` |
| Graph node | `formula.adjusted.l2enginedispatcher.action.cam_collision` |
| Kind | dispatcher_router |
