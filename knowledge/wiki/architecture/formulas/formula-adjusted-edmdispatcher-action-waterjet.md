---
title: Formula — router · waterjet
type: formula
formula_id: formula.adjusted.edmdispatcher.action.waterjet
...
| Field | Value |
|-------|-------|
| Name | `router · waterjet` |
| Graph node | `formula.adjusted.edmdispatcher.action.waterjet` |
| Kind | dispatcher_router |
