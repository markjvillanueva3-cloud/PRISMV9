---
title: Formula — router · torque
type: formula
formula_id: formula.adjusted.calcdispatcher.action.torque
...
|-------|-------|
| Name | `router · torque` |
| Graph node | `formula.adjusted.calcdispatcher.action.torque` |
| Kind | dispatcher_router |
