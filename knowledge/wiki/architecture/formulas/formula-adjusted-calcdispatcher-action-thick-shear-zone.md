---
title: Formula — router · thick_shear_zone
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thick_shear_zone
...
# Formula — `router · thick_shear_zone`
...
| Field | Value |
|-------|-------|
| Name | `router · thick_shear_zone` |
| Graph node | `formula.adjusted.calcdispatcher.action.thick_shear_zone` |
| Kind | dispatcher_router |
