---
title: Formula — router · roi_events
type: formula
formula_id: formula.adjusted.businessdispatcher.action.roi_events
...
| Field | Value |
|-------|-------|
| Name | `router · roi_events` |
| Graph node | `formula.adjusted.businessdispatcher.action.roi_events` |
| Kind | dispatcher_router |
