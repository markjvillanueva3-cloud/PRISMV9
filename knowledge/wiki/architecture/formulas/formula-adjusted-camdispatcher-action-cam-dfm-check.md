---
title: Formula — router · cam_dfm_check
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_dfm_check
...
| Field | Value |
|-------|-------|
| Name | `router · cam_dfm_check` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_dfm_check` |
| Kind | dispatcher_router |
