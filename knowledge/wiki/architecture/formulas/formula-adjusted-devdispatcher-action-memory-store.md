---
title: Formula — router · memory_store
type: formula
formula_id: formula.adjusted.devdispatcher.action.memory_store
...
| Field | Value |
|-------|-------|
| Name | `router · memory_store` |
| Graph node | `formula.adjusted.devdispatcher.action.memory_store` |
| Kind | dispatcher_router |
