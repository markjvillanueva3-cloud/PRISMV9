---
title: Formula — router · ppg_probe_inspect
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_probe_inspect
...
# Formula — `router · ppg_probe_inspect`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_probe_inspect` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_probe_inspect` |
| Kind | dispatcher_router |
