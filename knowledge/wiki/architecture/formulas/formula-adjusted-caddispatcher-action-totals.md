---
title: Formula — router · totals
type: formula
formula_id: formula.adjusted.caddispatcher.action.totals
...
|-------|-------|
| Name | `router · totals` |
| Graph node | `formula.adjusted.caddispatcher.action.totals` |
| Kind | dispatcher_router |
