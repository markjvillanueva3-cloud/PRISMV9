---
title: Formula — router · iges_summary
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.iges_summary
...
| Field | Value |
|-------|-------|
| Name | `router · iges_summary` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.iges_summary` |
| Kind | dispatcher_router |
