---
title: Formula — router · ml_stats_gibbs
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ml_stats_gibbs
...
| Field | Value |
|-------|-------|
| Name | `router · ml_stats_gibbs` |
| Graph node | `formula.adjusted.calcdispatcher.action.ml_stats_gibbs` |
| Kind | dispatcher_router |
