---
title: Formula — router · simulate_build
type: formula
formula_id: formula.adjusted.devdispatcher.action.simulate_build
...
| Field | Value |
|-------|-------|
| Name | `router · simulate_build` |
| Graph node | `formula.adjusted.devdispatcher.action.simulate_build` |
| Kind | dispatcher_router |
