---
title: Formula — router · wear_notch
type: formula
formula_id: formula.adjusted.camdispatcher.action.wear_notch
...
| Field | Value |
|-------|-------|
| Name | `router · wear_notch` |
| Graph node | `formula.adjusted.camdispatcher.action.wear_notch` |
| Kind | dispatcher_router |
