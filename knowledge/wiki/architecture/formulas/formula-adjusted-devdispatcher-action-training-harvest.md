---
title: Formula — router · training_harvest
type: formula
formula_id: formula.adjusted.devdispatcher.action.training_harvest
...
# Formula — `router · training_harvest`
...
| Field | Value |
|-------|-------|
| Name | `router · training_harvest` |
| Graph node | `formula.adjusted.devdispatcher.action.training_harvest` |
| Kind | dispatcher_router |
