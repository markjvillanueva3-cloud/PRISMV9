---
title: Formula — router · cad_kg_build
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_kg_build
...
| Field | Value |
|-------|-------|
| Name | `router · cad_kg_build` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_kg_build` |
| Kind | dispatcher_router |
