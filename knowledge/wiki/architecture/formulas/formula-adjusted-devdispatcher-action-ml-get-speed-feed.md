---
title: Formula — router · ml_get_speed_feed
type: formula
formula_id: formula.adjusted.devdispatcher.action.ml_get_speed_feed
...
# Formula — `router · ml_get_speed_feed`
...
| Field | Value |
|-------|-------|
| Name | `router · ml_get_speed_feed` |
| Graph node | `formula.adjusted.devdispatcher.action.ml_get_speed_feed` |
| Kind | dispatcher_router |
