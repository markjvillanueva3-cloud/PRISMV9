---
title: Formula — router · cam_predict_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_predict_stats
...
# Formula — `router · cam_predict_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_predict_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_predict_stats` |
| Kind | dispatcher_router |
