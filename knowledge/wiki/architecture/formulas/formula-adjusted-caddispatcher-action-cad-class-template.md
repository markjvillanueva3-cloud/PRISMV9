---
title: Formula — router · cad_class_template
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_class_template
...
# Formula — `router · cad_class_template`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_class_template` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_class_template` |
| Kind | dispatcher_router |
