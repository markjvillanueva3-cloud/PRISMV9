---
title: Formula — router · wpl_get_max_ton
type: formula
formula_id: formula.adjusted.devdispatcher.action.wpl_get_max_ton
...
# Formula — `router · wpl_get_max_ton`
...
| Field | Value |
|-------|-------|
| Name | `router · wpl_get_max_ton` |
| Graph node | `formula.adjusted.devdispatcher.action.wpl_get_max_ton` |
| Kind | dispatcher_router |
