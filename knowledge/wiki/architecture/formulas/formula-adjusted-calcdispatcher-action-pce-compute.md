---
title: Formula — router · pce_compute
type: formula
formula_id: formula.adjusted.calcdispatcher.action.pce_compute
...
| Field | Value |
|-------|-------|
| Name | `router · pce_compute` |
| Graph node | `formula.adjusted.calcdispatcher.action.pce_compute` |
| Kind | dispatcher_router |
