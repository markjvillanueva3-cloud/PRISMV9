---
title: Formula — router · tool_route_best
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.tool_route_best
...
# Formula — `router · tool_route_best`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_route_best` |
| Graph node | `formula.adjusted.sessiondispatcher.action.tool_route_best` |
| Kind | dispatcher_router |
