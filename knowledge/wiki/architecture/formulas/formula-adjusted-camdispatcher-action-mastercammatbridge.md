---
title: Formula — router · mastercamMatBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.mastercammatbridge
...
# Formula — `router · mastercamMatBridge`
...
| Field | Value |
|-------|-------|
| Name | `router · mastercamMatBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.mastercammatbridge` |
| Kind | dispatcher_router |
