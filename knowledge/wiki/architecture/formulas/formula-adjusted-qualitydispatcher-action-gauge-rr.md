---
title: Formula — router · gauge_rr
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.gauge_rr
...
| Field | Value |
|-------|-------|
| Name | `router · gauge_rr` |
| Graph node | `formula.adjusted.qualitydispatcher.action.gauge_rr` |
| Kind | dispatcher_router |
