---
title: Formula — router · invAutoBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.invautobridge
...
| Field | Value |
|-------|-------|
| Name | `router · invAutoBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.invautobridge` |
| Kind | dispatcher_router |
