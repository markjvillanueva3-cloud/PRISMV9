---
title: Formula — router · compact_table
type: formula
formula_id: formula.adjusted.devdispatcher.action.compact_table
...
| Field | Value |
|-------|-------|
| Name | `router · compact_table` |
| Graph node | `formula.adjusted.devdispatcher.action.compact_table` |
| Kind | dispatcher_router |
