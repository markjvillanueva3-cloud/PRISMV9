---
title: Formula — router · ml_search_gcodes
type: formula
formula_id: formula.adjusted.devdispatcher.action.ml_search_gcodes
...
# Formula — `router · ml_search_gcodes`
...
| Field | Value |
|-------|-------|
| Name | `router · ml_search_gcodes` |
| Graph node | `formula.adjusted.devdispatcher.action.ml_search_gcodes` |
| Kind | dispatcher_router |
