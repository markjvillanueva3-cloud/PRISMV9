---
title: Formula — router · payroll_pay_stub
type: formula
formula_id: formula.adjusted.businessdispatcher.action.payroll_pay_stub
...
# Formula — `router · payroll_pay_stub`
...
| Field | Value |
|-------|-------|
| Name | `router · payroll_pay_stub` |
| Graph node | `formula.adjusted.businessdispatcher.action.payroll_pay_stub` |
| Kind | dispatcher_router |
