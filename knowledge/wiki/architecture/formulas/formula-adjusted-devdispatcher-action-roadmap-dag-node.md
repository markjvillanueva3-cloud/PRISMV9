---
title: Formula — router · roadmap_dag_node
type: formula
formula_id: formula.adjusted.devdispatcher.action.roadmap_dag_node
...
# Formula — `router · roadmap_dag_node`
...
| Field | Value |
|-------|-------|
| Name | `router · roadmap_dag_node` |
| Graph node | `formula.adjusted.devdispatcher.action.roadmap_dag_node` |
| Kind | dispatcher_router |
