---
title: Formula — router · damping_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.damping_optimize
...
# Formula — `router · damping_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · damping_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.damping_optimize` |
| Kind | dispatcher_router |
