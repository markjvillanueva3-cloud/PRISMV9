---
title: Formula — router · sch_compact
type: formula
formula_id: formula.adjusted.devdispatcher.action.sch_compact
...
| Field | Value |
|-------|-------|
| Name | `router · sch_compact` |
| Graph node | `formula.adjusted.devdispatcher.action.sch_compact` |
| Kind | dispatcher_router |
