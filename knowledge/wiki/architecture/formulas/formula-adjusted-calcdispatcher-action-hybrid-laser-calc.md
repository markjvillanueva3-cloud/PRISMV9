---
title: Formula — router · hybrid_laser_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.hybrid_laser_calc
...
# Formula — `router · hybrid_laser_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · hybrid_laser_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.hybrid_laser_calc` |
| Kind | dispatcher_router |
