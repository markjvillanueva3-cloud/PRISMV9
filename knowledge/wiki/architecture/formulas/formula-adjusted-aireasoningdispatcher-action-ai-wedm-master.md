---
title: Formula — router · ai_wedm_master
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.ai_wedm_master
...
| Field | Value |
|-------|-------|
| Name | `router · ai_wedm_master` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.ai_wedm_master` |
| Kind | dispatcher_router |
