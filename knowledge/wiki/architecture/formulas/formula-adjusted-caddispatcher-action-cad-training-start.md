---
title: Formula — router · cad_training_start
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_training_start
...
# Formula — `router · cad_training_start`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_training_start` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_training_start` |
| Kind | dispatcher_router |
