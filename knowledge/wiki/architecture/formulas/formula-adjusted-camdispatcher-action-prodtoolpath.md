---
title: Formula — router · prodToolpath
type: formula
formula_id: formula.adjusted.camdispatcher.action.prodtoolpath
...
| Field | Value |
|-------|-------|
| Name | `router · prodToolpath` |
| Graph node | `formula.adjusted.camdispatcher.action.prodtoolpath` |
| Kind | dispatcher_router |
