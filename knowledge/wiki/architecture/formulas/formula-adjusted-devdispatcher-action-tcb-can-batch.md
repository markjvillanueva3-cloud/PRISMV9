---
title: Formula — router · tcb_can_batch
type: formula
formula_id: formula.adjusted.devdispatcher.action.tcb_can_batch
...
| Field | Value |
|-------|-------|
| Name | `router · tcb_can_batch` |
| Graph node | `formula.adjusted.devdispatcher.action.tcb_can_batch` |
| Kind | dispatcher_router |
