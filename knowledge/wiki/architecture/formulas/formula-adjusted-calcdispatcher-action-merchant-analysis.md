---
title: Formula — router · merchant_analysis
type: formula
formula_id: formula.adjusted.calcdispatcher.action.merchant_analysis
...
# Formula — `router · merchant_analysis`
...
| Field | Value |
|-------|-------|
| Name | `router · merchant_analysis` |
| Graph node | `formula.adjusted.calcdispatcher.action.merchant_analysis` |
| Kind | dispatcher_router |
