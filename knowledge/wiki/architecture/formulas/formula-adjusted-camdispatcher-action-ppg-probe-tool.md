---
title: Formula — router · ppg_probe_tool
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_probe_tool
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_probe_tool` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_probe_tool` |
| Kind | dispatcher_router |
