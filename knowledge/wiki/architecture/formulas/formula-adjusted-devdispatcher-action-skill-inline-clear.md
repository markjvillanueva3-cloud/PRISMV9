---
title: Formula — router · skill_inline_clear
type: formula
formula_id: formula.adjusted.devdispatcher.action.skill_inline_clear
...
# Formula — `router · skill_inline_clear`
...
| Field | Value |
|-------|-------|
| Name | `router · skill_inline_clear` |
| Graph node | `formula.adjusted.devdispatcher.action.skill_inline_clear` |
| Kind | dispatcher_router |
