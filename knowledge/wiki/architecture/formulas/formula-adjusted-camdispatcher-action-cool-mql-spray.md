---
title: Formula — router · cool_mql_spray
type: formula
formula_id: formula.adjusted.camdispatcher.action.cool_mql_spray
...
| Field | Value |
|-------|-------|
| Name | `router · cool_mql_spray` |
| Graph node | `formula.adjusted.camdispatcher.action.cool_mql_spray` |
| Kind | dispatcher_router |
