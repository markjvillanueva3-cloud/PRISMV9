---
title: Formula — router · gse_current
type: formula
formula_id: formula.adjusted.devdispatcher.action.gse_current
...
| Field | Value |
|-------|-------|
| Name | `router · gse_current` |
| Graph node | `formula.adjusted.devdispatcher.action.gse_current` |
| Kind | dispatcher_router |
