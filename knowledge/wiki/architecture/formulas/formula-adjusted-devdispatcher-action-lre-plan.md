---
title: Formula — router · lre_plan
type: formula
formula_id: formula.adjusted.devdispatcher.action.lre_plan
...
| Field | Value |
|-------|-------|
| Name | `router · lre_plan` |
| Graph node | `formula.adjusted.devdispatcher.action.lre_plan` |
| Kind | dispatcher_router |
