---
title: Formula — router · ollama_cam_query
type: formula
formula_id: formula.adjusted.camdispatcher.action.ollama_cam_query
...
# Formula — `router · ollama_cam_query`
...
| Field | Value |
|-------|-------|
| Name | `router · ollama_cam_query` |
| Graph node | `formula.adjusted.camdispatcher.action.ollama_cam_query` |
| Kind | dispatcher_router |
