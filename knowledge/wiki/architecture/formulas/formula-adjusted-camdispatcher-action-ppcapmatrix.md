---
title: Formula — router · ppCapMatrix
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppcapmatrix
...
| Field | Value |
|-------|-------|
| Name | `router · ppCapMatrix` |
| Graph node | `formula.adjusted.camdispatcher.action.ppcapmatrix` |
| Kind | dispatcher_router |
