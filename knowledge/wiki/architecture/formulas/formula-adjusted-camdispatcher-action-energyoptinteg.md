---
title: Formula — router · energyOptInteg
type: formula
formula_id: formula.adjusted.camdispatcher.action.energyoptinteg
...
| Field | Value |
|-------|-------|
| Name | `router · energyOptInteg` |
| Graph node | `formula.adjusted.camdispatcher.action.energyoptinteg` |
| Kind | dispatcher_router |
