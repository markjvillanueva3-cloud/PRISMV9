---
title: Formula — router · robustOpt
type: formula
formula_id: formula.adjusted.turningdispatcher.action.robustopt
...
| Field | Value |
|-------|-------|
| Name | `router · robustOpt` |
| Graph node | `formula.adjusted.turningdispatcher.action.robustopt` |
| Kind | dispatcher_router |
