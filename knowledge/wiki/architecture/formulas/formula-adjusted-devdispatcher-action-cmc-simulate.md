---
title: Formula — router · cmc_simulate
type: formula
formula_id: formula.adjusted.devdispatcher.action.cmc_simulate
...
| Field | Value |
|-------|-------|
| Name | `router · cmc_simulate` |
| Graph node | `formula.adjusted.devdispatcher.action.cmc_simulate` |
| Kind | dispatcher_router |
