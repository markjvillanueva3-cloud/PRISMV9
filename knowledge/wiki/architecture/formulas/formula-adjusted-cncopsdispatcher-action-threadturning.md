---
title: Formula — router · threadTurning
type: formula
formula_id: formula.adjusted.cncopsdispatcher.action.threadturning
...
| Field | Value |
|-------|-------|
| Name | `router · threadTurning` |
| Graph node | `formula.adjusted.cncopsdispatcher.action.threadturning` |
| Kind | dispatcher_router |
