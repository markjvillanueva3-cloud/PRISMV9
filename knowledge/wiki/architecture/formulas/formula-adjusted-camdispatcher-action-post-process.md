---
title: Formula — router · post_process
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_process
...
| Field | Value |
|-------|-------|
| Name | `router · post_process` |
| Graph node | `formula.adjusted.camdispatcher.action.post_process` |
| Kind | dispatcher_router |
