---
title: Formula — router · productivity
type: formula
formula_id: formula.adjusted.calcdispatcher.action.productivity
...
| Field | Value |
|-------|-------|
| Name | `router · productivity` |
| Graph node | `formula.adjusted.calcdispatcher.action.productivity` |
| Kind | dispatcher_router |
