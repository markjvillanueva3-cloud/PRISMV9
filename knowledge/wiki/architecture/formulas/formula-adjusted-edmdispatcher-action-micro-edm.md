---
title: Formula — router · micro_edm
type: formula
formula_id: formula.adjusted.edmdispatcher.action.micro_edm
...
| Field | Value |
|-------|-------|
| Name | `router · micro_edm` |
| Graph node | `formula.adjusted.edmdispatcher.action.micro_edm` |
| Kind | dispatcher_router |
