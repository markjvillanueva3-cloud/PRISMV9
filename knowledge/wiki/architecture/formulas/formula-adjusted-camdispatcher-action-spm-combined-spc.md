---
title: Formula — router · spm_combined_spc
type: formula
formula_id: formula.adjusted.camdispatcher.action.spm_combined_spc
...
# Formula — `router · spm_combined_spc`
...
| Field | Value |
|-------|-------|
| Name | `router · spm_combined_spc` |
| Graph node | `formula.adjusted.camdispatcher.action.spm_combined_spc` |
| Kind | dispatcher_router |
