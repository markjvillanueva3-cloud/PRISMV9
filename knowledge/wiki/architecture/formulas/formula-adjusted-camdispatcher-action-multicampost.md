---
title: Formula — router · multiCamPost
type: formula
formula_id: formula.adjusted.camdispatcher.action.multicampost
...
| Field | Value |
|-------|-------|
| Name | `router · multiCamPost` |
| Graph node | `formula.adjusted.camdispatcher.action.multicampost` |
| Kind | dispatcher_router |
