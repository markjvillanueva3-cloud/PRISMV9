---
title: Formula — router · post_multichannel
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_multichannel
...
# Formula — `router · post_multichannel`
...
| Field | Value |
|-------|-------|
| Name | `router · post_multichannel` |
| Graph node | `formula.adjusted.camdispatcher.action.post_multichannel` |
| Kind | dispatcher_router |
