---
title: Formula — router · cam_lora_predict
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_lora_predict
...
# Formula — `router · cam_lora_predict`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_lora_predict` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_lora_predict` |
| Kind | dispatcher_router |
