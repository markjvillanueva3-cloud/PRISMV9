---
title: Formula — router · post_detect_intent
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_detect_intent
...
# Formula — `router · post_detect_intent`
...
| Field | Value |
|-------|-------|
| Name | `router · post_detect_intent` |
| Graph node | `formula.adjusted.camdispatcher.action.post_detect_intent` |
| Kind | dispatcher_router |
