---
title: Formula — router · purchasing
type: formula
formula_id: formula.adjusted.businessdispatcher.action.purchasing
...
| Field | Value |
|-------|-------|
| Name | `router · purchasing` |
| Graph node | `formula.adjusted.businessdispatcher.action.purchasing` |
| Kind | dispatcher_router |
