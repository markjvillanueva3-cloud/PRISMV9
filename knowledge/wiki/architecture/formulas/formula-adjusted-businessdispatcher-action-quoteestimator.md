---
title: Formula — router · quoteEstimator
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quoteestimator
...
| Field | Value |
|-------|-------|
| Name | `router · quoteEstimator` |
| Graph node | `formula.adjusted.businessdispatcher.action.quoteestimator` |
| Kind | dispatcher_router |
