---
title: Formula — router · lre_classify
type: formula
formula_id: formula.adjusted.devdispatcher.action.lre_classify
...
| Field | Value |
|-------|-------|
| Name | `router · lre_classify` |
| Graph node | `formula.adjusted.devdispatcher.action.lre_classify` |
| Kind | dispatcher_router |
