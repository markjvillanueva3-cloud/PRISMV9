---
title: Formula — router · firstPiece
type: formula
formula_id: formula.adjusted.turningdispatcher.action.firstpiece
...
| Field | Value |
|-------|-------|
| Name | `router · firstPiece` |
| Graph node | `formula.adjusted.turningdispatcher.action.firstpiece` |
| Kind | dispatcher_router |
