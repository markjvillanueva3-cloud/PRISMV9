---
title: Formula — router · subprogram_call
type: formula
formula_id: formula.adjusted.camdispatcher.action.subprogram_call
...
# Formula — `router · subprogram_call`
...
| Field | Value |
|-------|-------|
| Name | `router · subprogram_call` |
| Graph node | `formula.adjusted.camdispatcher.action.subprogram_call` |
| Kind | dispatcher_router |
