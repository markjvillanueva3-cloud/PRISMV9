---
title: Formula — router · coolant_validate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.coolant_validate
...
# Formula — `router · coolant_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · coolant_validate` |
| Graph node | `formula.adjusted.calcdispatcher.action.coolant_validate` |
| Kind | dispatcher_router |
