---
title: Formula — router · build
type: formula
formula_id: formula.adjusted.devdispatcher.action.build
...
|-------|-------|
| Name | `router · build` |
| Graph node | `formula.adjusted.devdispatcher.action.build` |
| Kind | dispatcher_router |
