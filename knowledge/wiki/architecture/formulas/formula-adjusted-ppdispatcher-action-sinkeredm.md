---
title: Formula — router · sinkerEDM
type: formula
formula_id: formula.adjusted.ppdispatcher.action.sinkeredm
...
| Field | Value |
|-------|-------|
| Name | `router · sinkerEDM` |
| Graph node | `formula.adjusted.ppdispatcher.action.sinkeredm` |
| Kind | dispatcher_router |
