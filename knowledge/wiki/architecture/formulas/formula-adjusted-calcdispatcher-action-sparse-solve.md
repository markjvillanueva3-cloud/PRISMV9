---
title: Formula — router · sparse_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sparse_solve
...
| Field | Value |
|-------|-------|
| Name | `router · sparse_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.sparse_solve` |
| Kind | dispatcher_router |
