---
title: Formula — router · superalloy_analyze
type: formula
formula_id: formula.adjusted.calcdispatcher.action.superalloy_analyze
...
# Formula — `router · superalloy_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · superalloy_analyze` |
| Graph node | `formula.adjusted.calcdispatcher.action.superalloy_analyze` |
| Kind | dispatcher_router |
