---
title: Formula — router · dispatch_reorder
type: formula
formula_id: formula.adjusted.businessdispatcher.action.dispatch_reorder
...
# Formula — `router · dispatch_reorder`
...
| Field | Value |
|-------|-------|
| Name | `router · dispatch_reorder` |
| Graph node | `formula.adjusted.businessdispatcher.action.dispatch_reorder` |
| Kind | dispatcher_router |
