---
title: Formula — router · wireDeflection
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wiredeflection
...
| Field | Value |
|-------|-------|
| Name | `router · wireDeflection` |
| Graph node | `formula.adjusted.edmdispatcher.action.wiredeflection` |
| Kind | dispatcher_router |
