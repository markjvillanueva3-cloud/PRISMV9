---
title: Formula — router · ai_lathe_reason
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.ai_lathe_reason
...
# Formula — `router · ai_lathe_reason`
...
| Field | Value |
|-------|-------|
| Name | `router · ai_lathe_reason` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.ai_lathe_reason` |
| Kind | dispatcher_router |
