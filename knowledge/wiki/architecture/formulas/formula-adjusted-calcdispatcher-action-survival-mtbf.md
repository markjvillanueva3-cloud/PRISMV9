---
title: Formula — router · survival_mtbf
type: formula
formula_id: formula.adjusted.calcdispatcher.action.survival_mtbf
...
| Field | Value |
|-------|-------|
| Name | `router · survival_mtbf` |
| Graph node | `formula.adjusted.calcdispatcher.action.survival_mtbf` |
| Kind | dispatcher_router |
