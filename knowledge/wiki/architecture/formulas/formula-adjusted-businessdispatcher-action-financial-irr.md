---
title: Formula — router · financial_irr
type: formula
formula_id: formula.adjusted.businessdispatcher.action.financial_irr
...
| Field | Value |
|-------|-------|
| Name | `router · financial_irr` |
| Graph node | `formula.adjusted.businessdispatcher.action.financial_irr` |
| Kind | dispatcher_router |
