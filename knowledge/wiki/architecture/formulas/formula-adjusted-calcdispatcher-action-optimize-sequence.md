---
title: Formula — router · optimize_sequence
type: formula
formula_id: formula.adjusted.calcdispatcher.action.optimize_sequence
...
# Formula — `router · optimize_sequence`
...
| Field | Value |
|-------|-------|
| Name | `router · optimize_sequence` |
| Graph node | `formula.adjusted.calcdispatcher.action.optimize_sequence` |
| Kind | dispatcher_router |
