---
title: Formula — router · blowMold
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.blowmold
...
| Field | Value |
|-------|-------|
| Name | `router · blowMold` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.blowmold` |
| Kind | dispatcher_router |
