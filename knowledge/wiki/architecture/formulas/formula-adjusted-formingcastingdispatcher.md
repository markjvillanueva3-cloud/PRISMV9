---
title: Formula — router · formingCasting
type: formula
formula_id: formula.adjusted.formingcastingdispatcher
...
| Field | Value |
|-------|-------|
| Name | `router · formingCasting` |
| Graph node | `formula.adjusted.formingcastingdispatcher` |
| Kind | dispatcher_router |
