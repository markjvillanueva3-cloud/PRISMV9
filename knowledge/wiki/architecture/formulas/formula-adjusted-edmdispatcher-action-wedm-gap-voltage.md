---
title: Formula — router · wedm_gap_voltage
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_gap_voltage
...
# Formula — `router · wedm_gap_voltage`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_gap_voltage` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_gap_voltage` |
| Kind | dispatcher_router |
