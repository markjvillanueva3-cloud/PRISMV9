---
title: Formula — router · mlStrategyRanker
type: formula
formula_id: formula.adjusted.camdispatcher.action.mlstrategyranker
...
# Formula — `router · mlStrategyRanker`
...
| Field | Value |
|-------|-------|
| Name | `router · mlStrategyRanker` |
| Graph node | `formula.adjusted.camdispatcher.action.mlstrategyranker` |
| Kind | dispatcher_router |
