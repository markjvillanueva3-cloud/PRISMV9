---
title: Formula — router · output_cache_find
type: formula
formula_id: formula.adjusted.devdispatcher.action.output_cache_find
...
# Formula — `router · output_cache_find`
...
| Field | Value |
|-------|-------|
| Name | `router · output_cache_find` |
| Graph node | `formula.adjusted.devdispatcher.action.output_cache_find` |
| Kind | dispatcher_router |
