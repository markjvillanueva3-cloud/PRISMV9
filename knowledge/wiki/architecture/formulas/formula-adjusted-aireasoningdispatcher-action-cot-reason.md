---
title: Formula — router · cot_reason
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.cot_reason
...
| Field | Value |
|-------|-------|
| Name | `router · cot_reason` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.cot_reason` |
| Kind | dispatcher_router |
