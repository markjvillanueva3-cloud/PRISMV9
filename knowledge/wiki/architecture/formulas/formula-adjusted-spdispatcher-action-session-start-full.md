---
title: Formula — router · session_start_full
type: formula
formula_id: formula.adjusted.spdispatcher.action.session_start_full
...
# Formula — `router · session_start_full`
...
| Field | Value |
|-------|-------|
| Name | `router · session_start_full` |
| Graph node | `formula.adjusted.spdispatcher.action.session_start_full` |
| Kind | dispatcher_router |
