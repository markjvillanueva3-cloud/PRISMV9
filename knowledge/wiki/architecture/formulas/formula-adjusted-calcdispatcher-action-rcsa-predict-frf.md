---
title: Formula — router · rcsa_predict_frf
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rcsa_predict_frf
...
# Formula — `router · rcsa_predict_frf`
...
| Field | Value |
|-------|-------|
| Name | `router · rcsa_predict_frf` |
| Graph node | `formula.adjusted.calcdispatcher.action.rcsa_predict_frf` |
| Kind | dispatcher_router |
