---
title: Formula — router · cam_5axis_convert
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_5axis_convert
...
# Formula — `router · cam_5axis_convert`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_5axis_convert` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_5axis_convert` |
| Kind | dispatcher_router |
