---
title: Formula — router · cam_feedback_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_feedback_stats
...
# Formula — `router · cam_feedback_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_feedback_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_feedback_stats` |
| Kind | dispatcher_router |
