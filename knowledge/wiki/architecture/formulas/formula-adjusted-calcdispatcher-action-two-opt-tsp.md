---
title: Formula — router · two_opt_tsp
type: formula
formula_id: formula.adjusted.calcdispatcher.action.two_opt_tsp
...
| Field | Value |
|-------|-------|
| Name | `router · two_opt_tsp` |
| Graph node | `formula.adjusted.calcdispatcher.action.two_opt_tsp` |
| Kind | dispatcher_router |
