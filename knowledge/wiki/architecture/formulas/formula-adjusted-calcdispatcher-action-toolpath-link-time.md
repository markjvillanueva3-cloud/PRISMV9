---
title: Formula — router · toolpath_link_time
type: formula
formula_id: formula.adjusted.calcdispatcher.action.toolpath_link_time
...
# Formula — `router · toolpath_link_time`
...
| Field | Value |
|-------|-------|
| Name | `router · toolpath_link_time` |
| Graph node | `formula.adjusted.calcdispatcher.action.toolpath_link_time` |
| Kind | dispatcher_router |
