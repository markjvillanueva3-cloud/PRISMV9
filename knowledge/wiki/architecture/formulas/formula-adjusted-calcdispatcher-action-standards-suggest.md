---
title: Formula — router · standards_suggest
type: formula
formula_id: formula.adjusted.calcdispatcher.action.standards_suggest
...
# Formula — `router · standards_suggest`
...
| Field | Value |
|-------|-------|
| Name | `router · standards_suggest` |
| Graph node | `formula.adjusted.calcdispatcher.action.standards_suggest` |
| Kind | dispatcher_router |
