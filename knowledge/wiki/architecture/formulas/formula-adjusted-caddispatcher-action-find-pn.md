---
title: Formula — router · find_pn
type: formula
formula_id: formula.adjusted.caddispatcher.action.find_pn
...
|-------|-------|
| Name | `router · find_pn` |
| Graph node | `formula.adjusted.caddispatcher.action.find_pn` |
| Kind | dispatcher_router |
