---
title: Formula — router · cad_pipeline_clear
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_pipeline_clear
...
# Formula — `router · cad_pipeline_clear`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_pipeline_clear` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_pipeline_clear` |
| Kind | dispatcher_router |
