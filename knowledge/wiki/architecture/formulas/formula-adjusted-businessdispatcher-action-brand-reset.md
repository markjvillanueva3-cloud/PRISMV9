---
title: Formula — router · brand_reset
type: formula
formula_id: formula.adjusted.businessdispatcher.action.brand_reset
...
| Field | Value |
|-------|-------|
| Name | `router · brand_reset` |
| Graph node | `formula.adjusted.businessdispatcher.action.brand_reset` |
| Kind | dispatcher_router |
