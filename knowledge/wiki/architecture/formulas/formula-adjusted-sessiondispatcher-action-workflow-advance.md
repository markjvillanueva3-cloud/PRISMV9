---
title: Formula — router · workflow_advance
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.workflow_advance
...
# Formula — `router · workflow_advance`
...
| Field | Value |
|-------|-------|
| Name | `router · workflow_advance` |
| Graph node | `formula.adjusted.sessiondispatcher.action.workflow_advance` |
| Kind | dispatcher_router |
