---
title: Formula — router · batch_cam_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.batch_cam_generate
...
# Formula — `router · batch_cam_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · batch_cam_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.batch_cam_generate` |
| Kind | dispatcher_router |
