---
title: Formula — router · laser_lora_state
type: formula
formula_id: formula.adjusted.edmdispatcher.action.laser_lora_state
...
# Formula — `router · laser_lora_state`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_lora_state` |
| Graph node | `formula.adjusted.edmdispatcher.action.laser_lora_state` |
| Kind | dispatcher_router |
