---
title: Formula — router · spring
type: formula
formula_id: formula.adjusted.caddispatcher.action.spring
...
|-------|-------|
| Name | `router · spring` |
| Graph node | `formula.adjusted.caddispatcher.action.spring` |
| Kind | dispatcher_router |
