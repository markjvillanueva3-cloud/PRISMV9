---
title: Formula — router · get_progress
type: formula
formula_id: formula.adjusted.cadregressiondispatcher.action.get_progress
...
| Field | Value |
|-------|-------|
| Name | `router · get_progress` |
| Graph node | `formula.adjusted.cadregressiondispatcher.action.get_progress` |
| Kind | dispatcher_router |
