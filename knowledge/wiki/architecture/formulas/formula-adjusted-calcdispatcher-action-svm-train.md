---
title: Formula — router · svm_train
type: formula
formula_id: formula.adjusted.calcdispatcher.action.svm_train
...
| Field | Value |
|-------|-------|
| Name | `router · svm_train` |
| Graph node | `formula.adjusted.calcdispatcher.action.svm_train` |
| Kind | dispatcher_router |
