---
title: Formula — router · dq_validate_batch
type: formula
formula_id: formula.adjusted.devdispatcher.action.dq_validate_batch
...
# Formula — `router · dq_validate_batch`
...
| Field | Value |
|-------|-------|
| Name | `router · dq_validate_batch` |
| Graph node | `formula.adjusted.devdispatcher.action.dq_validate_batch` |
| Kind | dispatcher_router |
