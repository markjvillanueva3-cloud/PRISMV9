---
title: Formula — router · cross_phys_upqi
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cross_phys_upqi
...
# Formula — `router · cross_phys_upqi`
...
| Field | Value |
|-------|-------|
| Name | `router · cross_phys_upqi` |
| Graph node | `formula.adjusted.calcdispatcher.action.cross_phys_upqi` |
| Kind | dispatcher_router |
