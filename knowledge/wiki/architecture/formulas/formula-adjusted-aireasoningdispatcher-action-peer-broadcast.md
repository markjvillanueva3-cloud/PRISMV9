---
title: Formula — router · peer_broadcast
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.peer_broadcast
...
| Field | Value |
|-------|-------|
| Name | `router · peer_broadcast` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.peer_broadcast` |
| Kind | dispatcher_router |
