---
title: Formula — router · sci_chip_breaking
type: formula
formula_id: formula.adjusted.camdispatcher.action.sci_chip_breaking
...
# Formula — `router · sci_chip_breaking`
...
| Field | Value |
|-------|-------|
| Name | `router · sci_chip_breaking` |
| Graph node | `formula.adjusted.camdispatcher.action.sci_chip_breaking` |
| Kind | dispatcher_router |
