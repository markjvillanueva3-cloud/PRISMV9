---
title: Formula — router · edm_sinker_program
type: formula
formula_id: formula.adjusted.camdispatcher.action.edm_sinker_program
...
# Formula — `router · edm_sinker_program`
...
| Field | Value |
|-------|-------|
| Name | `router · edm_sinker_program` |
| Graph node | `formula.adjusted.camdispatcher.action.edm_sinker_program` |
| Kind | dispatcher_router |
