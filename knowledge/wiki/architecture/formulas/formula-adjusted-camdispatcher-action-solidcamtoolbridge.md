---
title: Formula — router · solidCAMToolBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcamtoolbridge
...
# Formula — `router · solidCAMToolBridge`
...
| Field | Value |
|-------|-------|
| Name | `router · solidCAMToolBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcamtoolbridge` |
| Kind | dispatcher_router |
