---
title: Formula — router · noise_level_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.noise_level_calc
...
# Formula — `router · noise_level_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · noise_level_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.noise_level_calc` |
| Kind | dispatcher_router |
