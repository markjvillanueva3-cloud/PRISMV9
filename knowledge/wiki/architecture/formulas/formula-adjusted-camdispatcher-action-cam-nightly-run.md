---
title: Formula — router · cam_nightly_run
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_nightly_run
...
# Formula — `router · cam_nightly_run`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_nightly_run` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_nightly_run` |
| Kind | dispatcher_router |
