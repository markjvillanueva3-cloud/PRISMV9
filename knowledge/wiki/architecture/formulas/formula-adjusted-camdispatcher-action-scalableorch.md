---
title: Formula — router · scalableOrch
type: formula
formula_id: formula.adjusted.camdispatcher.action.scalableorch
...
| Field | Value |
|-------|-------|
| Name | `router · scalableOrch` |
| Graph node | `formula.adjusted.camdispatcher.action.scalableorch` |
| Kind | dispatcher_router |
