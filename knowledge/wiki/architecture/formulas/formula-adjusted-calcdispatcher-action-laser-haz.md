---
title: Formula — router · laser_haz
type: formula
formula_id: formula.adjusted.calcdispatcher.action.laser_haz
...
| Field | Value |
|-------|-------|
| Name | `router · laser_haz` |
| Graph node | `formula.adjusted.calcdispatcher.action.laser_haz` |
| Kind | dispatcher_router |
