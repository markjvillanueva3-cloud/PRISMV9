---
title: Formula — router · quick_cutting_time
type: formula
formula_id: formula.adjusted.calcdispatcher.action.quick_cutting_time
...
# Formula — `router · quick_cutting_time`
...
| Field | Value |
|-------|-------|
| Name | `router · quick_cutting_time` |
| Graph node | `formula.adjusted.calcdispatcher.action.quick_cutting_time` |
| Kind | dispatcher_router |
