---
title: Formula — router · stochastic_route
type: formula
formula_id: formula.adjusted.camdispatcher.action.stochastic_route
...
# Formula — `router · stochastic_route`
...
| Field | Value |
|-------|-------|
| Name | `router · stochastic_route` |
| Graph node | `formula.adjusted.camdispatcher.action.stochastic_route` |
| Kind | dispatcher_router |
