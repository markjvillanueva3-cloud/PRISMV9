---
title: Formula — router · cad_cas_verify
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_cas_verify
...
| Field | Value |
|-------|-------|
| Name | `router · cad_cas_verify` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_cas_verify` |
| Kind | dispatcher_router |
