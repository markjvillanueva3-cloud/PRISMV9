---
title: Formula — router · turningProfile
type: formula
formula_id: formula.adjusted.camdispatcher.action.turningprofile
...
| Field | Value |
|-------|-------|
| Name | `router · turningProfile` |
| Graph node | `formula.adjusted.camdispatcher.action.turningprofile` |
| Kind | dispatcher_router |
