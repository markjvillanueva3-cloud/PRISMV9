---
title: Formula — router · offsetComp
type: formula
formula_id: formula.adjusted.turningdispatcher.action.offsetcomp
...
| Field | Value |
|-------|-------|
| Name | `router · offsetComp` |
| Graph node | `formula.adjusted.turningdispatcher.action.offsetcomp` |
| Kind | dispatcher_router |
