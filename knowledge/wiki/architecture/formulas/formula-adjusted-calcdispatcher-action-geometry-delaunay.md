---
title: Formula — router · geometry_delaunay
type: formula
formula_id: formula.adjusted.calcdispatcher.action.geometry_delaunay
...
# Formula — `router · geometry_delaunay`
...
| Field | Value |
|-------|-------|
| Name | `router · geometry_delaunay` |
| Graph node | `formula.adjusted.calcdispatcher.action.geometry_delaunay` |
| Kind | dispatcher_router |
