---
title: Formula — router · sdk_suggest_tool
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sdk_suggest_tool
...
# Formula — `router · sdk_suggest_tool`
...
| Field | Value |
|-------|-------|
| Name | `router · sdk_suggest_tool` |
| Graph node | `formula.adjusted.calcdispatcher.action.sdk_suggest_tool` |
| Kind | dispatcher_router |
