---
title: Formula — router · token_ledger_reset
type: formula
formula_id: formula.adjusted.devdispatcher.action.token_ledger_reset
...
# Formula — `router · token_ledger_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · token_ledger_reset` |
| Graph node | `formula.adjusted.devdispatcher.action.token_ledger_reset` |
| Kind | dispatcher_router |
