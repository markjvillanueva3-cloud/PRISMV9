---
title: Formula — router · interpret_numbers
type: formula
formula_id: formula.adjusted.calcdispatcher.action.interpret_numbers
...
# Formula — `router · interpret_numbers`
...
| Field | Value |
|-------|-------|
| Name | `router · interpret_numbers` |
| Graph node | `formula.adjusted.calcdispatcher.action.interpret_numbers` |
| Kind | dispatcher_router |
