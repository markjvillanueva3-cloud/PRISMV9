---
title: Formula — router · ball_end_mill_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ball_end_mill_calc
...
# Formula — `router · ball_end_mill_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · ball_end_mill_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.ball_end_mill_calc` |
| Kind | dispatcher_router |
