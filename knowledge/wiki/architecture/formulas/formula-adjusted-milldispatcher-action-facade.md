---
title: Formula — router · facade
type: formula
formula_id: formula.adjusted.milldispatcher.action.facade
...
|-------|-------|
| Name | `router · facade` |
| Graph node | `formula.adjusted.milldispatcher.action.facade` |
| Kind | dispatcher_router |
