---
title: Formula — router · pipeline
type: formula
formula_id: formula.adjusted.camdispatcher.action.pipeline
...
| Graph node | `formula.adjusted.camdispatcher.action.pipeline` |
| Kind | dispatcher_router |
