---
title: Formula — router · mrrPhysics
type: formula
formula_id: formula.adjusted.edmdispatcher.action.mrrphysics
...
| Field | Value |
|-------|-------|
| Name | `router · mrrPhysics` |
| Graph node | `formula.adjusted.edmdispatcher.action.mrrphysics` |
| Kind | dispatcher_router |
