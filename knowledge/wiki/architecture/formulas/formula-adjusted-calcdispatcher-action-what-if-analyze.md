---
title: Formula — router · what_if_analyze
type: formula
formula_id: formula.adjusted.calcdispatcher.action.what_if_analyze
...
# Formula — `router · what_if_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · what_if_analyze` |
| Graph node | `formula.adjusted.calcdispatcher.action.what_if_analyze` |
| Kind | dispatcher_router |
