---
title: Formula — router · cad_cam_handoff
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_cam_handoff
...
# Formula — `router · cad_cam_handoff`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_cam_handoff` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_cam_handoff` |
| Kind | dispatcher_router |
