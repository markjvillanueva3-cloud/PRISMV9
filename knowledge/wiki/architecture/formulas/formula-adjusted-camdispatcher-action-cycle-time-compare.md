---
title: Formula — router · cycle_time_compare
type: formula
formula_id: formula.adjusted.camdispatcher.action.cycle_time_compare
...
# Formula — `router · cycle_time_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · cycle_time_compare` |
| Graph node | `formula.adjusted.camdispatcher.action.cycle_time_compare` |
| Kind | dispatcher_router |
