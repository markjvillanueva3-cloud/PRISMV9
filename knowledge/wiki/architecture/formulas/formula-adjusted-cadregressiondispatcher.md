---
title: Formula — router · cadRegression
type: formula
formula_id: formula.adjusted.cadregressiondispatcher
...
| Field | Value |
|-------|-------|
| Name | `router · cadRegression` |
| Graph node | `formula.adjusted.cadregressiondispatcher` |
| Kind | dispatcher_router |
