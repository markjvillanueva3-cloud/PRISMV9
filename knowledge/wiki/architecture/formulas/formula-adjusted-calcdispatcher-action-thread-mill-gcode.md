---
title: Formula — router · thread_mill_gcode
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thread_mill_gcode
...
# Formula — `router · thread_mill_gcode`
...
| Field | Value |
|-------|-------|
| Name | `router · thread_mill_gcode` |
| Graph node | `formula.adjusted.calcdispatcher.action.thread_mill_gcode` |
| Kind | dispatcher_router |
