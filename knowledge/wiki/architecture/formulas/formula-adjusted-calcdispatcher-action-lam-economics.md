---
title: Formula — router · lam_economics
type: formula
formula_id: formula.adjusted.calcdispatcher.action.lam_economics
...
| Field | Value |
|-------|-------|
| Name | `router · lam_economics` |
| Graph node | `formula.adjusted.calcdispatcher.action.lam_economics` |
| Kind | dispatcher_router |
