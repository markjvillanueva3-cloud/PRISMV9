---
title: Formula — router · rigid_body_impact
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rigid_body_impact
...
# Formula — `router · rigid_body_impact`
...
| Field | Value |
|-------|-------|
| Name | `router · rigid_body_impact` |
| Graph node | `formula.adjusted.calcdispatcher.action.rigid_body_impact` |
| Kind | dispatcher_router |
