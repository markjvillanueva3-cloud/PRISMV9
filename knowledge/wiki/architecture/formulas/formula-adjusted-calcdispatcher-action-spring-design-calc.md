---
title: Formula — router · spring_design_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spring_design_calc
...
# Formula — `router · spring_design_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · spring_design_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.spring_design_calc` |
| Kind | dispatcher_router |
