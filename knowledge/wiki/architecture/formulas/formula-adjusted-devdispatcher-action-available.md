---
title: Formula — router · available
type: formula
formula_id: formula.adjusted.devdispatcher.action.available
...
| Graph node | `formula.adjusted.devdispatcher.action.available` |
| Kind | dispatcher_router |
