---
title: Formula — router · pm_unified_get
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_unified_get
...
| Field | Value |
|-------|-------|
| Name | `router · pm_unified_get` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_unified_get` |
| Kind | dispatcher_router |
