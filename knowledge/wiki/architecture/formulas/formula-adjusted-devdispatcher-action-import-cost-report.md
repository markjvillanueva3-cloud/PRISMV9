---
title: Formula — router · import_cost_report
type: formula
formula_id: formula.adjusted.devdispatcher.action.import_cost_report
...
# Formula — `router · import_cost_report`
...
| Field | Value |
|-------|-------|
| Name | `router · import_cost_report` |
| Graph node | `formula.adjusted.devdispatcher.action.import_cost_report` |
| Kind | dispatcher_router |
