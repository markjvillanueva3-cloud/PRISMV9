---
title: Formula — router · network_flow_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.network_flow_calc
...
# Formula — `router · network_flow_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · network_flow_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.network_flow_calc` |
| Kind | dispatcher_router |
