---
title: Formula — router · ollama_hook_config
type: formula
formula_id: formula.adjusted.devdispatcher.action.ollama_hook_config
...
# Formula — `router · ollama_hook_config`
...
| Field | Value |
|-------|-------|
| Name | `router · ollama_hook_config` |
| Graph node | `formula.adjusted.devdispatcher.action.ollama_hook_config` |
| Kind | dispatcher_router |
