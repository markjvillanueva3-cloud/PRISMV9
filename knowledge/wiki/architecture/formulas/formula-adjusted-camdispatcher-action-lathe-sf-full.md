---
title: Formula — router · lathe_sf_full
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_sf_full
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_sf_full` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_sf_full` |
| Kind | dispatcher_router |
