---
title: Formula — router · rel_wiener_rul
type: formula
formula_id: formula.adjusted.camdispatcher.action.rel_wiener_rul
...
| Field | Value |
|-------|-------|
| Name | `router · rel_wiener_rul` |
| Graph node | `formula.adjusted.camdispatcher.action.rel_wiener_rul` |
| Kind | dispatcher_router |
