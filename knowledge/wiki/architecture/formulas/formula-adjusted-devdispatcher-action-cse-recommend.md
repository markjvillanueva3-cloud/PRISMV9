---
title: Formula — router · cse_recommend
type: formula
formula_id: formula.adjusted.devdispatcher.action.cse_recommend
...
| Field | Value |
|-------|-------|
| Name | `router · cse_recommend` |
| Graph node | `formula.adjusted.devdispatcher.action.cse_recommend` |
| Kind | dispatcher_router |
