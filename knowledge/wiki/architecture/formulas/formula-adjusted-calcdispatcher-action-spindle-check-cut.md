---
title: Formula — router · spindle_check_cut
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spindle_check_cut
...
# Formula — `router · spindle_check_cut`
...
| Field | Value |
|-------|-------|
| Name | `router · spindle_check_cut` |
| Graph node | `formula.adjusted.calcdispatcher.action.spindle_check_cut` |
| Kind | dispatcher_router |
