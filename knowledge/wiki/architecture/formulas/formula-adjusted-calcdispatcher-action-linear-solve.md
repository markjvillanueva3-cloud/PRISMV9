---
title: Formula — router · linear_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.linear_solve
...
| Field | Value |
|-------|-------|
| Name | `router · linear_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.linear_solve` |
| Kind | dispatcher_router |
