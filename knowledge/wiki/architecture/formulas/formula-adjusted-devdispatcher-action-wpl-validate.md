---
title: Formula — router · wpl_validate
type: formula
formula_id: formula.adjusted.devdispatcher.action.wpl_validate
...
| Field | Value |
|-------|-------|
| Name | `router · wpl_validate` |
| Graph node | `formula.adjusted.devdispatcher.action.wpl_validate` |
| Kind | dispatcher_router |
