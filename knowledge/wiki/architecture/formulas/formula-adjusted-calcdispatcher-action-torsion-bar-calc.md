---
title: Formula — router · torsion_bar_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.torsion_bar_calc
...
# Formula — `router · torsion_bar_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · torsion_bar_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.torsion_bar_calc` |
| Kind | dispatcher_router |
