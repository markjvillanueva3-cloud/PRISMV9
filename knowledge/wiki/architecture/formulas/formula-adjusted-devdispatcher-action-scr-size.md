---
title: Formula — router · scr_size
type: formula
formula_id: formula.adjusted.devdispatcher.action.scr_size
...
| Field | Value |
|-------|-------|
| Name | `router · scr_size` |
| Graph node | `formula.adjusted.devdispatcher.action.scr_size` |
| Kind | dispatcher_router |
