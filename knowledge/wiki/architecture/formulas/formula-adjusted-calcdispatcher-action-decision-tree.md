---
title: Formula — router · decision_tree
type: formula
formula_id: formula.adjusted.calcdispatcher.action.decision_tree
...
| Field | Value |
|-------|-------|
| Name | `router · decision_tree` |
| Graph node | `formula.adjusted.calcdispatcher.action.decision_tree` |
| Kind | dispatcher_router |
