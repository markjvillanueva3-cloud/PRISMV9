---
title: Formula — router · bias_correct
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.bias_correct
...
| Field | Value |
|-------|-------|
| Name | `router · bias_correct` |
| Graph node | `formula.adjusted.qualitydispatcher.action.bias_correct` |
| Kind | dispatcher_router |
