---
title: Formula — router · cycle_time
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cycle_time
...
| Field | Value |
|-------|-------|
| Name | `router · cycle_time` |
| Graph node | `formula.adjusted.calcdispatcher.action.cycle_time` |
| Kind | dispatcher_router |
