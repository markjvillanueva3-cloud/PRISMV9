---
title: Formula — router · wedm_gnn_load
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_gnn_load
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_gnn_load` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_gnn_load` |
| Kind | dispatcher_router |
