---
title: Formula — router · lathe_g71_type
type: formula
formula_id: formula.adjusted.turningdispatcher.action.lathe_g71_type
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_g71_type` |
| Graph node | `formula.adjusted.turningdispatcher.action.lathe_g71_type` |
| Kind | dispatcher_router |
