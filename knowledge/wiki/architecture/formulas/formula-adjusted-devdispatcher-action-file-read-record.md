---
title: Formula — router · file_read_record
type: formula
formula_id: formula.adjusted.devdispatcher.action.file_read_record
...
# Formula — `router · file_read_record`
...
| Field | Value |
|-------|-------|
| Name | `router · file_read_record` |
| Graph node | `formula.adjusted.devdispatcher.action.file_read_record` |
| Kind | dispatcher_router |
