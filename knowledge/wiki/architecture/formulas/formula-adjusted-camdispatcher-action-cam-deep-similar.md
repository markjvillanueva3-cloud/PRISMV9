---
title: Formula — router · cam_deep_similar
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_deep_similar
...
# Formula — `router · cam_deep_similar`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_deep_similar` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_deep_similar` |
| Kind | dispatcher_router |
