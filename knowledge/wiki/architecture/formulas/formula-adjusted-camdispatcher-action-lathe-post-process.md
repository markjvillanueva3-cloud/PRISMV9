---
title: Formula — router · lathe_post_process
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_post_process
...
# Formula — `router · lathe_post_process`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_post_process` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_post_process` |
| Kind | dispatcher_router |
