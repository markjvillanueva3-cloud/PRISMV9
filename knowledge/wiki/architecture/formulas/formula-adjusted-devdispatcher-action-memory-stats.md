---
title: Formula — router · memory_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.memory_stats
...
| Field | Value |
|-------|-------|
| Name | `router · memory_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.memory_stats` |
| Kind | dispatcher_router |
