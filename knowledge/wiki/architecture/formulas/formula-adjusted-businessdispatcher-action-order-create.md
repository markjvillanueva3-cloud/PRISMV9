---
title: Formula — router · order_create
type: formula
formula_id: formula.adjusted.businessdispatcher.action.order_create
...
| Field | Value |
|-------|-------|
| Name | `router · order_create` |
| Graph node | `formula.adjusted.businessdispatcher.action.order_create` |
| Kind | dispatcher_router |
