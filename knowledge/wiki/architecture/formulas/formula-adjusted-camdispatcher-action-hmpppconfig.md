---
title: Formula — router · hmPPPConfig
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmpppconfig
...
| Field | Value |
|-------|-------|
| Name | `router · hmPPPConfig` |
| Graph node | `formula.adjusted.camdispatcher.action.hmpppconfig` |
| Kind | dispatcher_router |
