---
title: Formula — router · aet_list_codes
type: formula
formula_id: formula.adjusted.devdispatcher.action.aet_list_codes
...
| Field | Value |
|-------|-------|
| Name | `router · aet_list_codes` |
| Graph node | `formula.adjusted.devdispatcher.action.aet_list_codes` |
| Kind | dispatcher_router |
