---
title: Formula — router · ramping_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ramping_calc
...
| Field | Value |
|-------|-------|
| Name | `router · ramping_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.ramping_calc` |
| Kind | dispatcher_router |
