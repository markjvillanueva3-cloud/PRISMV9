---
title: Formula — router · multi_process_cost
type: formula
formula_id: formula.adjusted.camdispatcher.action.multi_process_cost
...
# Formula — `router · multi_process_cost`
...
| Field | Value |
|-------|-------|
| Name | `router · multi_process_cost` |
| Graph node | `formula.adjusted.camdispatcher.action.multi_process_cost` |
| Kind | dispatcher_router |
