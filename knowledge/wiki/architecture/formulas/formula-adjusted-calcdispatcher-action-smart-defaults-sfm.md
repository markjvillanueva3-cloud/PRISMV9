---
title: Formula — router · smart_defaults_sfm
type: formula
formula_id: formula.adjusted.calcdispatcher.action.smart_defaults_sfm
...
# Formula — `router · smart_defaults_sfm`
...
| Field | Value |
|-------|-------|
| Name | `router · smart_defaults_sfm` |
| Graph node | `formula.adjusted.calcdispatcher.action.smart_defaults_sfm` |
| Kind | dispatcher_router |
