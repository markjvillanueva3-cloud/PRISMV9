---
title: Formula — router · controllerDialect
type: formula
formula_id: formula.adjusted.camdispatcher.action.controllerdialect
...
# Formula — `router · controllerDialect`
...
| Field | Value |
|-------|-------|
| Name | `router · controllerDialect` |
| Graph node | `formula.adjusted.camdispatcher.action.controllerdialect` |
| Kind | dispatcher_router |
