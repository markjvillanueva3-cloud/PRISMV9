---
title: Formula — router · espritStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.espritstrategy
...
| Field | Value |
|-------|-------|
| Name | `router · espritStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.espritstrategy` |
| Kind | dispatcher_router |
