---
title: Formula — router · asc_get_schema
type: formula
formula_id: formula.adjusted.devdispatcher.action.asc_get_schema
...
| Field | Value |
|-------|-------|
| Name | `router · asc_get_schema` |
| Graph node | `formula.adjusted.devdispatcher.action.asc_get_schema` |
| Kind | dispatcher_router |
