---
title: Formula — router · workflow_start
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.workflow_start
...
| Field | Value |
|-------|-------|
| Name | `router · workflow_start` |
| Graph node | `formula.adjusted.sessiondispatcher.action.workflow_start` |
| Kind | dispatcher_router |
