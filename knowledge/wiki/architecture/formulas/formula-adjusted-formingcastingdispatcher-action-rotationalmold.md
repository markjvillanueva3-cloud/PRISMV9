---
title: Formula — router · rotationalMold
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.rotationalmold
...
| Field | Value |
|-------|-------|
| Name | `router · rotationalMold` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.rotationalmold` |
| Kind | dispatcher_router |
