---
title: Formula — router · wearPhysics
type: formula
formula_id: formula.adjusted.camdispatcher.action.wearphysics
...
| Field | Value |
|-------|-------|
| Name | `router · wearPhysics` |
| Graph node | `formula.adjusted.camdispatcher.action.wearphysics` |
| Kind | dispatcher_router |
