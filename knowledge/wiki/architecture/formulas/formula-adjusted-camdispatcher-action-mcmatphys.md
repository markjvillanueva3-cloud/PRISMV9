---
title: Formula — router · mcMatPhys
type: formula
formula_id: formula.adjusted.camdispatcher.action.mcmatphys
...
| Field | Value |
|-------|-------|
| Name | `router · mcMatPhys` |
| Graph node | `formula.adjusted.camdispatcher.action.mcmatphys` |
| Kind | dispatcher_router |
