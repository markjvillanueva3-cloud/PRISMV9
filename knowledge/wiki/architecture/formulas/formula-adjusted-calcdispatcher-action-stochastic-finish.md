---
title: Formula — router · stochastic_finish
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stochastic_finish
...
# Formula — `router · stochastic_finish`
...
| Field | Value |
|-------|-------|
| Name | `router · stochastic_finish` |
| Graph node | `formula.adjusted.calcdispatcher.action.stochastic_finish` |
| Kind | dispatcher_router |
