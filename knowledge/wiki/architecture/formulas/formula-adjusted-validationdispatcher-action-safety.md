---
title: Formula — router · safety
type: formula
formula_id: formula.adjusted.validationdispatcher.action.safety
...
|-------|-------|
| Name | `router · safety` |
| Graph node | `formula.adjusted.validationdispatcher.action.safety` |
| Kind | dispatcher_router |
