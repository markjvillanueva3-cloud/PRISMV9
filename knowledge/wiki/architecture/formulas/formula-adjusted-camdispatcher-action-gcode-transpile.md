---
title: Formula — router · gcode_transpile
type: formula
formula_id: formula.adjusted.camdispatcher.action.gcode_transpile
...
# Formula — `router · gcode_transpile`
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_transpile` |
| Graph node | `formula.adjusted.camdispatcher.action.gcode_transpile` |
| Kind | dispatcher_router |
