---
title: Formula — router · reliability
type: formula
formula_id: formula.adjusted.camdispatcher.action.reliability
...
| Field | Value |
|-------|-------|
| Name | `router · reliability` |
| Graph node | `formula.adjusted.camdispatcher.action.reliability` |
| Kind | dispatcher_router |
