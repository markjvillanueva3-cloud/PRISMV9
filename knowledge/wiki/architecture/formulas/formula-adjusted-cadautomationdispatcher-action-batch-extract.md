---
title: Formula — router · batch_extract
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.batch_extract
...
| Field | Value |
|-------|-------|
| Name | `router · batch_extract` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.batch_extract` |
| Kind | dispatcher_router |
