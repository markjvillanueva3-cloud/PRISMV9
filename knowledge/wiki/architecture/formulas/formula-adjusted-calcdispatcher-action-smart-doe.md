---
title: Formula — router · smart_doe
type: formula
formula_id: formula.adjusted.calcdispatcher.action.smart_doe
...
| Field | Value |
|-------|-------|
| Name | `router · smart_doe` |
| Graph node | `formula.adjusted.calcdispatcher.action.smart_doe` |
| Kind | dispatcher_router |
