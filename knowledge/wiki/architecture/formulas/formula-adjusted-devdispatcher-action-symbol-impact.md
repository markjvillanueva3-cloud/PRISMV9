---
title: Formula — router · symbol_impact
type: formula
formula_id: formula.adjusted.devdispatcher.action.symbol_impact
...
| Field | Value |
|-------|-------|
| Name | `router · symbol_impact` |
| Graph node | `formula.adjusted.devdispatcher.action.symbol_impact` |
| Kind | dispatcher_router |
