---
title: Formula — router · post_setup_sheet
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_setup_sheet
...
# Formula — `router · post_setup_sheet`
...
| Field | Value |
|-------|-------|
| Name | `router · post_setup_sheet` |
| Graph node | `formula.adjusted.camdispatcher.action.post_setup_sheet` |
| Kind | dispatcher_router |
