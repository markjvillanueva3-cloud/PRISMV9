---
title: Formula — router · swAutoBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.swautobridge
...
| Field | Value |
|-------|-------|
| Name | `router · swAutoBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.swautobridge` |
| Kind | dispatcher_router |
