---
title: Formula — router · post_set_options
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_set_options
...
# Formula — `router · post_set_options`
...
| Field | Value |
|-------|-------|
| Name | `router · post_set_options` |
| Graph node | `formula.adjusted.camdispatcher.action.post_set_options` |
| Kind | dispatcher_router |
