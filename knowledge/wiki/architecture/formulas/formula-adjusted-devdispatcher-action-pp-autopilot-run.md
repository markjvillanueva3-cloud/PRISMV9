---
title: Formula — router · pp_autopilot_run
type: formula
formula_id: formula.adjusted.devdispatcher.action.pp_autopilot_run
...
# Formula — `router · pp_autopilot_run`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_autopilot_run` |
| Graph node | `formula.adjusted.devdispatcher.action.pp_autopilot_run` |
| Kind | dispatcher_router |
