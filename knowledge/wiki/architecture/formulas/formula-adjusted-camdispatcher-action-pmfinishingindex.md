---
title: Formula — router · pmFinishingIndex
type: formula
formula_id: formula.adjusted.camdispatcher.action.pmfinishingindex
...
# Formula — `router · pmFinishingIndex`
...
| Field | Value |
|-------|-------|
| Name | `router · pmFinishingIndex` |
| Graph node | `formula.adjusted.camdispatcher.action.pmfinishingindex` |
| Kind | dispatcher_router |
