---
title: Formula — router · machine_cap_find
type: formula
formula_id: formula.adjusted.devdispatcher.action.machine_cap_find
...
# Formula — `router · machine_cap_find`
...
| Field | Value |
|-------|-------|
| Name | `router · machine_cap_find` |
| Graph node | `formula.adjusted.devdispatcher.action.machine_cap_find` |
| Kind | dispatcher_router |
