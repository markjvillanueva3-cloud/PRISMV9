---
title: Formula — router · ziegler_nichols
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ziegler_nichols
...
# Formula — `router · ziegler_nichols`
...
| Field | Value |
|-------|-------|
| Name | `router · ziegler_nichols` |
| Graph node | `formula.adjusted.calcdispatcher.action.ziegler_nichols` |
| Kind | dispatcher_router |
