---
title: Formula — router · coolant_flow_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.coolant_flow_calc
...
# Formula — `router · coolant_flow_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · coolant_flow_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.coolant_flow_calc` |
| Kind | dispatcher_router |
