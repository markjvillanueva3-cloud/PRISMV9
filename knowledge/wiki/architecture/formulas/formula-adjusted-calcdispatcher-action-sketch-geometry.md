---
title: Formula — router · sketch_geometry
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sketch_geometry
...
# Formula — `router · sketch_geometry`
...
| Field | Value |
|-------|-------|
| Name | `router · sketch_geometry` |
| Graph node | `formula.adjusted.calcdispatcher.action.sketch_geometry` |
| Kind | dispatcher_router |
