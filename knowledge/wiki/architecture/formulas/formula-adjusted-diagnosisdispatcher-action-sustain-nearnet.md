---
title: Formula — router · sustain_nearnet
type: formula
formula_id: formula.adjusted.diagnosisdispatcher.action.sustain_nearnet
...
# Formula — `router · sustain_nearnet`
...
| Field | Value |
|-------|-------|
| Name | `router · sustain_nearnet` |
| Graph node | `formula.adjusted.diagnosisdispatcher.action.sustain_nearnet` |
| Kind | dispatcher_router |
