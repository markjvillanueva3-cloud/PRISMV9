---
title: Formula — router · safetyShield
type: formula
formula_id: formula.adjusted.mldispatcher.action.safetyshield
...
| Field | Value |
|-------|-------|
| Name | `router · safetyShield` |
| Graph node | `formula.adjusted.mldispatcher.action.safetyshield` |
| Kind | dispatcher_router |
