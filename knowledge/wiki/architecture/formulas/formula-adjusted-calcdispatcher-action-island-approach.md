---
title: Formula — router · island_approach
type: formula
formula_id: formula.adjusted.calcdispatcher.action.island_approach
...
# Formula — `router · island_approach`
...
| Field | Value |
|-------|-------|
| Name | `router · island_approach` |
| Graph node | `formula.adjusted.calcdispatcher.action.island_approach` |
| Kind | dispatcher_router |
