---
title: Formula — router · energy_compare
type: formula
formula_id: formula.adjusted.calcdispatcher.action.energy_compare
...
| Field | Value |
|-------|-------|
| Name | `router · energy_compare` |
| Graph node | `formula.adjusted.calcdispatcher.action.energy_compare` |
| Kind | dispatcher_router |
