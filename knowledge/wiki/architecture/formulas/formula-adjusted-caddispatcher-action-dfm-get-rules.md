---
title: Formula — router · dfm_get_rules
type: formula
formula_id: formula.adjusted.caddispatcher.action.dfm_get_rules
...
| Field | Value |
|-------|-------|
| Name | `router · dfm_get_rules` |
| Graph node | `formula.adjusted.caddispatcher.action.dfm_get_rules` |
| Kind | dispatcher_router |
