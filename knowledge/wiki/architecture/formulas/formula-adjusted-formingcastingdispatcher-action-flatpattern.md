---
title: Formula — router · flatPattern
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.flatpattern
...
| Field | Value |
|-------|-------|
| Name | `router · flatPattern` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.flatpattern` |
| Kind | dispatcher_router |
