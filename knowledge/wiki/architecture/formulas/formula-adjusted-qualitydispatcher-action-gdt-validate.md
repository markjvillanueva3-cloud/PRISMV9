---
title: Formula — router · gdt_validate
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.gdt_validate
...
| Field | Value |
|-------|-------|
| Name | `router · gdt_validate` |
| Graph node | `formula.adjusted.qualitydispatcher.action.gdt_validate` |
| Kind | dispatcher_router |
