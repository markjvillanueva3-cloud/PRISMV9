---
title: Formula — router · cutting_data_list
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cutting_data_list
...
# Formula — `router · cutting_data_list`
...
| Field | Value |
|-------|-------|
| Name | `router · cutting_data_list` |
| Graph node | `formula.adjusted.calcdispatcher.action.cutting_data_list` |
| Kind | dispatcher_router |
