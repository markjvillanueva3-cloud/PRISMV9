---
title: Formula — router · sketch_analyze
type: formula
formula_id: formula.adjusted.caddispatcher.action.sketch_analyze
...
| Field | Value |
|-------|-------|
| Name | `router · sketch_analyze` |
| Graph node | `formula.adjusted.caddispatcher.action.sketch_analyze` |
| Kind | dispatcher_router |
