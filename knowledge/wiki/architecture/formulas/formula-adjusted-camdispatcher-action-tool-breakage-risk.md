---
title: Formula — router · tool_breakage_risk
type: formula
formula_id: formula.adjusted.camdispatcher.action.tool_breakage_risk
...
# Formula — `router · tool_breakage_risk`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_breakage_risk` |
| Graph node | `formula.adjusted.camdispatcher.action.tool_breakage_risk` |
| Kind | dispatcher_router |
