---
title: Formula — router · okuma_parse_macro
type: formula
formula_id: formula.adjusted.camdispatcher.action.okuma_parse_macro
...
# Formula — `router · okuma_parse_macro`
...
| Field | Value |
|-------|-------|
| Name | `router · okuma_parse_macro` |
| Graph node | `formula.adjusted.camdispatcher.action.okuma_parse_macro` |
| Kind | dispatcher_router |
