---
title: Formula — router · five_axis_tcpc
type: formula
formula_id: formula.adjusted.camdispatcher.action.five_axis_tcpc
...
| Field | Value |
|-------|-------|
| Name | `router · five_axis_tcpc` |
| Graph node | `formula.adjusted.camdispatcher.action.five_axis_tcpc` |
| Kind | dispatcher_router |
