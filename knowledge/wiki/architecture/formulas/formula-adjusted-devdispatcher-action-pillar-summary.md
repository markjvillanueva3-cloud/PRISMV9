---
title: Formula — router · pillar_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.pillar_summary
...
| Field | Value |
|-------|-------|
| Name | `router · pillar_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.pillar_summary` |
| Kind | dispatcher_router |
