---
title: Formula — router · stampingDie
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.stampingdie
...
| Field | Value |
|-------|-------|
| Name | `router · stampingDie` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.stampingdie` |
| Kind | dispatcher_router |
