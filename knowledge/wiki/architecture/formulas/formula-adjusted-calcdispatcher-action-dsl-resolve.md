---
title: Formula — router · dsl_resolve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.dsl_resolve
...
| Field | Value |
|-------|-------|
| Name | `router · dsl_resolve` |
| Graph node | `formula.adjusted.calcdispatcher.action.dsl_resolve` |
| Kind | dispatcher_router |
