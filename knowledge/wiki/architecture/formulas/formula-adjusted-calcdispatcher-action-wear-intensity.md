---
title: Formula — router · wear_intensity
type: formula
formula_id: formula.adjusted.calcdispatcher.action.wear_intensity
...
| Field | Value |
|-------|-------|
| Name | `router · wear_intensity` |
| Graph node | `formula.adjusted.calcdispatcher.action.wear_intensity` |
| Kind | dispatcher_router |
