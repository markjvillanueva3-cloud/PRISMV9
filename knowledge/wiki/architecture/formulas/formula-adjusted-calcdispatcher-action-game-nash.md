---
title: Formula — router · game_nash
type: formula
formula_id: formula.adjusted.calcdispatcher.action.game_nash
...
| Field | Value |
|-------|-------|
| Name | `router · game_nash` |
| Graph node | `formula.adjusted.calcdispatcher.action.game_nash` |
| Kind | dispatcher_router |
