---
title: Formula — router · catiaCodeGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.catiacodegen
...
| Field | Value |
|-------|-------|
| Name | `router · catiaCodeGen` |
| Graph node | `formula.adjusted.camdispatcher.action.catiacodegen` |
| Kind | dispatcher_router |
