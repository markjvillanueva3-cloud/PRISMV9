---
title: Formula — router · carburizing_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.carburizing_calc
...
# Formula — `router · carburizing_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · carburizing_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.carburizing_calc` |
| Kind | dispatcher_router |
