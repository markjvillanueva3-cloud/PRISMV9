---
title: Formula — router · quoting
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quoting
...
|-------|-------|
| Name | `router · quoting` |
| Graph node | `formula.adjusted.businessdispatcher.action.quoting` |
| Kind | dispatcher_router |
