---
title: Formula — router · async_dispatch
type: formula
formula_id: formula.adjusted.devdispatcher.action.async_dispatch
...
| Field | Value |
|-------|-------|
| Name | `router · async_dispatch` |
| Graph node | `formula.adjusted.devdispatcher.action.async_dispatch` |
| Kind | dispatcher_router |
