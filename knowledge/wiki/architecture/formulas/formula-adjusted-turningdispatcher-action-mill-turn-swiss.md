---
title: Formula — router · mill_turn_swiss
type: formula
formula_id: formula.adjusted.turningdispatcher.action.mill_turn_swiss
...
# Formula — `router · mill_turn_swiss`
...
| Field | Value |
|-------|-------|
| Name | `router · mill_turn_swiss` |
| Graph node | `formula.adjusted.turningdispatcher.action.mill_turn_swiss` |
| Kind | dispatcher_router |
