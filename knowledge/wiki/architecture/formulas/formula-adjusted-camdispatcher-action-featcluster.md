---
title: Formula — router · featCluster
type: formula
formula_id: formula.adjusted.camdispatcher.action.featcluster
...
| Field | Value |
|-------|-------|
| Name | `router · featCluster` |
| Graph node | `formula.adjusted.camdispatcher.action.featcluster` |
| Kind | dispatcher_router |
