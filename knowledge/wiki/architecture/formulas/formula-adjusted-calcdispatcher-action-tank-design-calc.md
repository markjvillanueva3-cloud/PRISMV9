---
title: Formula — router · tank_design_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tank_design_calc
...
# Formula — `router · tank_design_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · tank_design_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.tank_design_calc` |
| Kind | dispatcher_router |
