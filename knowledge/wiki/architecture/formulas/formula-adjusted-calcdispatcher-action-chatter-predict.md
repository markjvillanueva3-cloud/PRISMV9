---
title: Formula — router · chatter_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.chatter_predict
...
# Formula — `router · chatter_predict`
...
| Field | Value |
|-------|-------|
| Name | `router · chatter_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.chatter_predict` |
| Kind | dispatcher_router |
