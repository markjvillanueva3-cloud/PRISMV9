---
title: Formula — router · failureForensics
type: formula
formula_id: formula.adjusted.diagnosisdispatcher.action.failureforensics
...
# Formula — `router · failureForensics`
...
| Field | Value |
|-------|-------|
| Name | `router · failureForensics` |
| Graph node | `formula.adjusted.diagnosisdispatcher.action.failureforensics` |
| Kind | dispatcher_router |
