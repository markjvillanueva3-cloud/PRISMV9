---
title: Formula — router · latheAGISafety
type: formula
formula_id: formula.adjusted.businessdispatcher.action.latheagisafety
...
| Field | Value |
|-------|-------|
| Name | `router · latheAGISafety` |
| Graph node | `formula.adjusted.businessdispatcher.action.latheagisafety` |
| Kind | dispatcher_router |
