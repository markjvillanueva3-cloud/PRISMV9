---
title: Formula — router · transferLearning
type: formula
formula_id: formula.adjusted.edmdispatcher.action.transferlearning
...
# Formula — `router · transferLearning`
...
| Field | Value |
|-------|-------|
| Name | `router · transferLearning` |
| Graph node | `formula.adjusted.edmdispatcher.action.transferlearning` |
| Kind | dispatcher_router |
