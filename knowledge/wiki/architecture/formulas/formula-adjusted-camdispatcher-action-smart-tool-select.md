---
title: Formula — router · smart_tool_select
type: formula
formula_id: formula.adjusted.camdispatcher.action.smart_tool_select
...
# Formula — `router · smart_tool_select`
...
| Field | Value |
|-------|-------|
| Name | `router · smart_tool_select` |
| Graph node | `formula.adjusted.camdispatcher.action.smart_tool_select` |
| Kind | dispatcher_router |
