---
title: Formula — router · machineMatcher
type: formula
formula_id: formula.adjusted.camdispatcher.action.machinematcher
...
| Field | Value |
|-------|-------|
| Name | `router · machineMatcher` |
| Graph node | `formula.adjusted.camdispatcher.action.machinematcher` |
| Kind | dispatcher_router |
