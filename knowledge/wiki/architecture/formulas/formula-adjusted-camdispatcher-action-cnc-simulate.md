---
title: Formula — router · cnc_simulate
type: formula
formula_id: formula.adjusted.camdispatcher.action.cnc_simulate
...
| Field | Value |
|-------|-------|
| Name | `router · cnc_simulate` |
| Graph node | `formula.adjusted.camdispatcher.action.cnc_simulate` |
| Kind | dispatcher_router |
