---
title: Formula — router · bar_pull
type: formula
formula_id: formula.adjusted.turningdispatcher.action.bar_pull
...
| Field | Value |
|-------|-------|
| Name | `router · bar_pull` |
| Graph node | `formula.adjusted.turningdispatcher.action.bar_pull` |
| Kind | dispatcher_router |
