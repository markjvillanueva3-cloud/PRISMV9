---
title: Formula — router · sinker_recommend
type: formula
formula_id: formula.adjusted.edmdispatcher.action.sinker_recommend
...
# Formula — `router · sinker_recommend`
...
| Field | Value |
|-------|-------|
| Name | `router · sinker_recommend` |
| Graph node | `formula.adjusted.edmdispatcher.action.sinker_recommend` |
| Kind | dispatcher_router |
