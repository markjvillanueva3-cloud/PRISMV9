---
title: Formula — router · batch_sequence
type: formula
formula_id: formula.adjusted.businessdispatcher.action.batch_sequence
...
| Field | Value |
|-------|-------|
| Name | `router · batch_sequence` |
| Graph node | `formula.adjusted.businessdispatcher.action.batch_sequence` |
| Kind | dispatcher_router |
