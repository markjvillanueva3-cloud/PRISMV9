---
title: Formula — router · engagement
type: formula
formula_id: formula.adjusted.calcdispatcher.action.engagement
...
| Graph node | `formula.adjusted.calcdispatcher.action.engagement` |
| Kind | dispatcher_router |
