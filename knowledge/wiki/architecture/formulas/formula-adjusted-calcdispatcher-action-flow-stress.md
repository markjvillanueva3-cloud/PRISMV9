---
title: Formula — router · flow_stress
type: formula
formula_id: formula.adjusted.calcdispatcher.action.flow_stress
...
| Field | Value |
|-------|-------|
| Name | `router · flow_stress` |
| Graph node | `formula.adjusted.calcdispatcher.action.flow_stress` |
| Kind | dispatcher_router |
