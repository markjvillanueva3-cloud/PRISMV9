---
title: Formula — router · feedback_record
type: formula
formula_id: formula.adjusted.devdispatcher.action.feedback_record
...
# Formula — `router · feedback_record`
...
| Field | Value |
|-------|-------|
| Name | `router · feedback_record` |
| Graph node | `formula.adjusted.devdispatcher.action.feedback_record` |
| Kind | dispatcher_router |
