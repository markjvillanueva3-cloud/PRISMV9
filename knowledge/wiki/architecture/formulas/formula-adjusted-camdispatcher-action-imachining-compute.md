---
title: Formula — router · imachining_compute
type: formula
formula_id: formula.adjusted.camdispatcher.action.imachining_compute
...
# Formula — `router · imachining_compute`
...
| Field | Value |
|-------|-------|
| Name | `router · imachining_compute` |
| Graph node | `formula.adjusted.camdispatcher.action.imachining_compute` |
| Kind | dispatcher_router |
