---
title: Formula — router · vericutBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.vericutbridge
...
| Field | Value |
|-------|-------|
| Name | `router · vericutBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.vericutbridge` |
| Kind | dispatcher_router |
