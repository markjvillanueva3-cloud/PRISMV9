---
title: Formula — router · casting_dfm
type: formula
formula_id: formula.adjusted.businessdispatcher.action.casting_dfm
...
| Field | Value |
|-------|-------|
| Name | `router · casting_dfm` |
| Graph node | `formula.adjusted.businessdispatcher.action.casting_dfm` |
| Kind | dispatcher_router |
