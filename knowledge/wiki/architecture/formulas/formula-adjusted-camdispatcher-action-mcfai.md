---
title: Formula — router · mcFAI
type: formula
formula_id: formula.adjusted.camdispatcher.action.mcfai
...
|-------|-------|
| Name | `router · mcFAI` |
| Graph node | `formula.adjusted.camdispatcher.action.mcfai` |
| Kind | dispatcher_router |
