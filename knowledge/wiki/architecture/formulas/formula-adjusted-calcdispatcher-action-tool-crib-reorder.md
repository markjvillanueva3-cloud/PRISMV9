---
title: Formula — router · tool_crib_reorder
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_crib_reorder
...
# Formula — `router · tool_crib_reorder`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_crib_reorder` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_crib_reorder` |
| Kind | dispatcher_router |
