---
title: Formula — PDFHighlightExtractorEngine
type: formula
formula_id: eng.pdf.pdfformulaextractionengine.pdfhighlightextractorengine
...
# Formula — `PDFHighlightExtractorEngine`
...
| Field | Value |
|-------|-------|
| Name | `PDFHighlightExtractorEngine` |
| Graph node | `eng.pdf.pdfformulaextractionengine.pdfhighlightextractorengine` |
| Kind | pdf.pdfformulaextractionengine_engines |
