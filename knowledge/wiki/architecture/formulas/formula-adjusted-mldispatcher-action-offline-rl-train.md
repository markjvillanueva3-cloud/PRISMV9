---
title: Formula — router · offline_rl_train
type: formula
formula_id: formula.adjusted.mldispatcher.action.offline_rl_train
...
# Formula — `router · offline_rl_train`
...
| Field | Value |
|-------|-------|
| Name | `router · offline_rl_train` |
| Graph node | `formula.adjusted.mldispatcher.action.offline_rl_train` |
| Kind | dispatcher_router |
