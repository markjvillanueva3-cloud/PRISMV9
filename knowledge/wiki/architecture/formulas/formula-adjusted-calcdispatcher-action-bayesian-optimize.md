---
title: Formula — router · bayesian_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bayesian_optimize
...
# Formula — `router · bayesian_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · bayesian_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.bayesian_optimize` |
| Kind | dispatcher_router |
