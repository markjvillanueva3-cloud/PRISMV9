---
title: Formula — router · rbd_analyze_system
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rbd_analyze_system
...
# Formula — `router · rbd_analyze_system`
...
| Field | Value |
|-------|-------|
| Name | `router · rbd_analyze_system` |
| Graph node | `formula.adjusted.calcdispatcher.action.rbd_analyze_system` |
| Kind | dispatcher_router |
