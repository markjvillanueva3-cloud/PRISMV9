---
title: Formula — router · time_series_smooth
type: formula
formula_id: formula.adjusted.calcdispatcher.action.time_series_smooth
...
# Formula — `router · time_series_smooth`
...
| Field | Value |
|-------|-------|
| Name | `router · time_series_smooth` |
| Graph node | `formula.adjusted.calcdispatcher.action.time_series_smooth` |
| Kind | dispatcher_router |
