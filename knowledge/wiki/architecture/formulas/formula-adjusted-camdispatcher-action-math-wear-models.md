---
title: Formula — router · math_wear_models
type: formula
formula_id: formula.adjusted.camdispatcher.action.math_wear_models
...
# Formula — `router · math_wear_models`
...
| Field | Value |
|-------|-------|
| Name | `router · math_wear_models` |
| Graph node | `formula.adjusted.camdispatcher.action.math_wear_models` |
| Kind | dispatcher_router |
