---
title: Formula — router · skill_inline_top
type: formula
formula_id: formula.adjusted.devdispatcher.action.skill_inline_top
...
# Formula — `router · skill_inline_top`
...
| Field | Value |
|-------|-------|
| Name | `router · skill_inline_top` |
| Graph node | `formula.adjusted.devdispatcher.action.skill_inline_top` |
| Kind | dispatcher_router |
