---
title: Formula — router · mfgStats
type: formula
formula_id: formula.adjusted.camdispatcher.action.mfgstats
...
| Field | Value |
|-------|-------|
| Name | `router · mfgStats` |
| Graph node | `formula.adjusted.camdispatcher.action.mfgstats` |
| Kind | dispatcher_router |
