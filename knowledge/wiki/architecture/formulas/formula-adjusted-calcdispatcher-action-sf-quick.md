---
title: Formula — router · sf_quick
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sf_quick
...
| Field | Value |
|-------|-------|
| Name | `router · sf_quick` |
| Graph node | `formula.adjusted.calcdispatcher.action.sf_quick` |
| Kind | dispatcher_router |
