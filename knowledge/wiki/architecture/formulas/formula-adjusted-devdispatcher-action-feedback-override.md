---
title: Formula — router · feedback_override
type: formula
formula_id: formula.adjusted.devdispatcher.action.feedback_override
...
# Formula — `router · feedback_override`
...
| Field | Value |
|-------|-------|
| Name | `router · feedback_override` |
| Graph node | `formula.adjusted.devdispatcher.action.feedback_override` |
| Kind | dispatcher_router |
