---
title: Formula — router · twin_create
type: formula
formula_id: formula.adjusted.calcdispatcher.action.twin_create
...
| Field | Value |
|-------|-------|
| Name | `router · twin_create` |
| Graph node | `formula.adjusted.calcdispatcher.action.twin_create` |
| Kind | dispatcher_router |
