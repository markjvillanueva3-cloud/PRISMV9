---
title: Formula — router · cad_cas_get
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.cad_cas_get
...
| Field | Value |
|-------|-------|
| Name | `router · cad_cas_get` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.cad_cas_get` |
| Kind | dispatcher_router |
