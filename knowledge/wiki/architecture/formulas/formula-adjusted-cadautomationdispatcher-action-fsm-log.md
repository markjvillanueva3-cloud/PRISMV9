---
title: Formula — router · fsm_log
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.fsm_log
...
|-------|-------|
| Name | `router · fsm_log` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.fsm_log` |
| Kind | dispatcher_router |
