---
title: Formula — router · copilot_suggest
type: formula
formula_id: formula.adjusted.devdispatcher.action.copilot_suggest
...
# Formula — `router · copilot_suggest`
...
| Field | Value |
|-------|-------|
| Name | `router · copilot_suggest` |
| Graph node | `formula.adjusted.devdispatcher.action.copilot_suggest` |
| Kind | dispatcher_router |
