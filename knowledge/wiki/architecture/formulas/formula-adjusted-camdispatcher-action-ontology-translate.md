---
title: Formula — router · ontology_translate
type: formula
formula_id: formula.adjusted.camdispatcher.action.ontology_translate
...
# Formula — `router · ontology_translate`
...
| Field | Value |
|-------|-------|
| Name | `router · ontology_translate` |
| Graph node | `formula.adjusted.camdispatcher.action.ontology_translate` |
| Kind | dispatcher_router |
