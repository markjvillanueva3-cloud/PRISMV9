---
title: Formula — router · params_calculate
type: formula
formula_id: formula.adjusted.toolpathdispatcher.action.params_calculate
...
# Formula — `router · params_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · params_calculate` |
| Graph node | `formula.adjusted.toolpathdispatcher.action.params_calculate` |
| Kind | dispatcher_router |
