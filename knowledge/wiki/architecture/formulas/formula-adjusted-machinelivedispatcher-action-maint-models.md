---
title: Formula — router · maint_models
type: formula
formula_id: formula.adjusted.machinelivedispatcher.action.maint_models
...
| Field | Value |
|-------|-------|
| Name | `router · maint_models` |
| Graph node | `formula.adjusted.machinelivedispatcher.action.maint_models` |
| Kind | dispatcher_router |
