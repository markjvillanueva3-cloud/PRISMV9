---
title: Formula — router · solidcam_25d_index
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcam_25d_index
...
# Formula — `router · solidcam_25d_index`
...
| Field | Value |
|-------|-------|
| Name | `router · solidcam_25d_index` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcam_25d_index` |
| Kind | dispatcher_router |
