---
title: Formula — router · cadCorpusOrch
type: formula
formula_id: formula.adjusted.caddispatcher.action.cadcorpusorch
...
| Field | Value |
|-------|-------|
| Name | `router · cadCorpusOrch` |
| Graph node | `formula.adjusted.caddispatcher.action.cadcorpusorch` |
| Kind | dispatcher_router |
