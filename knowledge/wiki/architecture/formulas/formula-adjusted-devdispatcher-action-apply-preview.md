---
title: Formula — router · apply_preview
type: formula
formula_id: formula.adjusted.devdispatcher.action.apply_preview
...
| Field | Value |
|-------|-------|
| Name | `router · apply_preview` |
| Graph node | `formula.adjusted.devdispatcher.action.apply_preview` |
| Kind | dispatcher_router |
