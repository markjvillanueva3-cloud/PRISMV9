---
title: Formula — router · blisk
type: formula
formula_id: formula.adjusted.caddispatcher.action.blisk
...
|-------|-------|
| Name | `router · blisk` |
| Graph node | `formula.adjusted.caddispatcher.action.blisk` |
| Kind | dispatcher_router |
