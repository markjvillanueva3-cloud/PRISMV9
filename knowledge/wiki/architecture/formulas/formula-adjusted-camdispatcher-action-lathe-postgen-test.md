---
title: Formula — router · lathe_postgen_test
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_postgen_test
...
# Formula — `router · lathe_postgen_test`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_postgen_test` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_postgen_test` |
| Kind | dispatcher_router |
