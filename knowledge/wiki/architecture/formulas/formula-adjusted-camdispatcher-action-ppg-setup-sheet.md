---
title: Formula — router · ppg_setup_sheet
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_setup_sheet
...
# Formula — `router · ppg_setup_sheet`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_setup_sheet` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_setup_sheet` |
| Kind | dispatcher_router |
