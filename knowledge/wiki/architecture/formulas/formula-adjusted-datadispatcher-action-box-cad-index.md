---
title: Formula — router · box_cad_index
type: formula
formula_id: formula.adjusted.datadispatcher.action.box_cad_index
...
| Field | Value |
|-------|-------|
| Name | `router · box_cad_index` |
| Graph node | `formula.adjusted.datadispatcher.action.box_cad_index` |
| Kind | dispatcher_router |
