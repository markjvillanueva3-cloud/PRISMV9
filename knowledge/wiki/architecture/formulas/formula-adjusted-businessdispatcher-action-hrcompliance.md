---
title: Formula — router · hrCompliance
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hrcompliance
...
| Field | Value |
|-------|-------|
| Name | `router · hrCompliance` |
| Graph node | `formula.adjusted.businessdispatcher.action.hrcompliance` |
| Kind | dispatcher_router |
