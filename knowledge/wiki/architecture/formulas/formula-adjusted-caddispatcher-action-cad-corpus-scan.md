---
title: Formula — router · cad_corpus_scan
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_corpus_scan
...
# Formula — `router · cad_corpus_scan`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_corpus_scan` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_corpus_scan` |
| Kind | dispatcher_router |
