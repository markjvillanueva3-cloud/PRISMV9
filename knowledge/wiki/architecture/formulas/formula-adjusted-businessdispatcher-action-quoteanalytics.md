---
title: Formula — router · quoteAnalytics
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quoteanalytics
...
| Field | Value |
|-------|-------|
| Name | `router · quoteAnalytics` |
| Graph node | `formula.adjusted.businessdispatcher.action.quoteanalytics` |
| Kind | dispatcher_router |
