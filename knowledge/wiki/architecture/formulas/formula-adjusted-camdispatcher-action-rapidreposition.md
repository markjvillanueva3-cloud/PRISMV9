---
title: Formula — router · rapidReposition
type: formula
formula_id: formula.adjusted.camdispatcher.action.rapidreposition
...
# Formula — `router · rapidReposition`
...
| Field | Value |
|-------|-------|
| Name | `router · rapidReposition` |
| Graph node | `formula.adjusted.camdispatcher.action.rapidreposition` |
| Kind | dispatcher_router |
