---
title: Formula — router · okuma_defaults
type: formula
formula_id: formula.adjusted.camdispatcher.action.okuma_defaults
...
| Field | Value |
|-------|-------|
| Name | `router · okuma_defaults` |
| Graph node | `formula.adjusted.camdispatcher.action.okuma_defaults` |
| Kind | dispatcher_router |
