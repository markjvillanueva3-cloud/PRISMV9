---
title: Formula — router · voronoi_relax
type: formula
formula_id: formula.adjusted.calcdispatcher.action.voronoi_relax
...
| Field | Value |
|-------|-------|
| Name | `router · voronoi_relax` |
| Graph node | `formula.adjusted.calcdispatcher.action.voronoi_relax` |
| Kind | dispatcher_router |
