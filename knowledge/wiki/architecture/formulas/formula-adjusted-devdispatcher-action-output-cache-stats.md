---
title: Formula — router · output_cache_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.output_cache_stats
...
# Formula — `router · output_cache_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · output_cache_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.output_cache_stats` |
| Kind | dispatcher_router |
