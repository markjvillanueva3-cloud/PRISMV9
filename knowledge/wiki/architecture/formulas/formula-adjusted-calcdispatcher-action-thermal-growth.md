---
title: Formula — router · thermal_growth
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thermal_growth
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_growth` |
| Graph node | `formula.adjusted.calcdispatcher.action.thermal_growth` |
| Kind | dispatcher_router |
