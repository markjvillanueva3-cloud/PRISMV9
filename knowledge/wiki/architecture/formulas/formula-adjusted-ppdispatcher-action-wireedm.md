---
title: Formula — router · wireEDM
type: formula
formula_id: formula.adjusted.ppdispatcher.action.wireedm
...
|-------|-------|
| Name | `router · wireEDM` |
| Graph node | `formula.adjusted.ppdispatcher.action.wireedm` |
| Kind | dispatcher_router |
