---
title: Formula — router · hr_training_add
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_training_add
...
# Formula — `router · hr_training_add`
...
| Field | Value |
|-------|-------|
| Name | `router · hr_training_add` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_training_add` |
| Kind | dispatcher_router |
