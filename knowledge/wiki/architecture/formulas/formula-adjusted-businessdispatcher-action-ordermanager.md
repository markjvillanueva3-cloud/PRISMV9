---
title: Formula — router · orderManager
type: formula
formula_id: formula.adjusted.businessdispatcher.action.ordermanager
...
| Field | Value |
|-------|-------|
| Name | `router · orderManager` |
| Graph node | `formula.adjusted.businessdispatcher.action.ordermanager` |
| Kind | dispatcher_router |
