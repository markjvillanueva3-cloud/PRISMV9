---
title: Formula — router · inventor_execute
type: formula
formula_id: formula.adjusted.caddispatcher.action.inventor_execute
...
# Formula — `router · inventor_execute`
...
| Field | Value |
|-------|-------|
| Name | `router · inventor_execute` |
| Graph node | `formula.adjusted.caddispatcher.action.inventor_execute` |
| Kind | dispatcher_router |
