---
title: Formula — router · pillar_score
type: formula
formula_id: formula.adjusted.devdispatcher.action.pillar_score
...
| Field | Value |
|-------|-------|
| Name | `router · pillar_score` |
| Graph node | `formula.adjusted.devdispatcher.action.pillar_score` |
| Kind | dispatcher_router |
