---
title: Formula — router · conv_budget_reset
type: formula
formula_id: formula.adjusted.devdispatcher.action.conv_budget_reset
...
# Formula — `router · conv_budget_reset`
...
| Field | Value |
|-------|-------|
| Name | `router · conv_budget_reset` |
| Graph node | `formula.adjusted.devdispatcher.action.conv_budget_reset` |
| Kind | dispatcher_router |
