---
title: Formula — router · neural_route
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.neural_route
...
| Field | Value |
|-------|-------|
| Name | `router · neural_route` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.neural_route` |
| Kind | dispatcher_router |
