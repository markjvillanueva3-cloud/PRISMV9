---
title: Formula — router · fatigue_sn_curve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fatigue_sn_curve
...
# Formula — `router · fatigue_sn_curve`
...
| Field | Value |
|-------|-------|
| Name | `router · fatigue_sn_curve` |
| Graph node | `formula.adjusted.calcdispatcher.action.fatigue_sn_curve` |
| Kind | dispatcher_router |
