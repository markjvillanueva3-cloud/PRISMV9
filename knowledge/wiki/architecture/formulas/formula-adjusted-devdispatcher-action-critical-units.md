---
title: Formula — router · critical_units
type: formula
formula_id: formula.adjusted.devdispatcher.action.critical_units
...
| Field | Value |
|-------|-------|
| Name | `router · critical_units` |
| Graph node | `formula.adjusted.devdispatcher.action.critical_units` |
| Kind | dispatcher_router |
