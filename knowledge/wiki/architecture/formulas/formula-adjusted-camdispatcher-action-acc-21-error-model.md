---
title: Formula — router · acc_21_error_model
type: formula
formula_id: formula.adjusted.camdispatcher.action.acc_21_error_model
...
# Formula — `router · acc_21_error_model`
...
| Field | Value |
|-------|-------|
| Name | `router · acc_21_error_model` |
| Graph node | `formula.adjusted.camdispatcher.action.acc_21_error_model` |
| Kind | dispatcher_router |
