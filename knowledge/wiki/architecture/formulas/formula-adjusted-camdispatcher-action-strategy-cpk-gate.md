---
title: Formula — router · strategy_cpk_gate
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategy_cpk_gate
...
# Formula — `router · strategy_cpk_gate`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_cpk_gate` |
| Graph node | `formula.adjusted.camdispatcher.action.strategy_cpk_gate` |
| Kind | dispatcher_router |
