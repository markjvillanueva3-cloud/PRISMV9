---
title: Formula — router · sf_resolve_tool
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sf_resolve_tool
...
# Formula — `router · sf_resolve_tool`
...
| Field | Value |
|-------|-------|
| Name | `router · sf_resolve_tool` |
| Graph node | `formula.adjusted.calcdispatcher.action.sf_resolve_tool` |
| Kind | dispatcher_router |
