---
title: Formula — router · authz_list_roles
type: formula
formula_id: formula.adjusted.securitydispatcher.action.authz_list_roles
...
# Formula — `router · authz_list_roles`
...
| Field | Value |
|-------|-------|
| Name | `router · authz_list_roles` |
| Graph node | `formula.adjusted.securitydispatcher.action.authz_list_roles` |
| Kind | dispatcher_router |
