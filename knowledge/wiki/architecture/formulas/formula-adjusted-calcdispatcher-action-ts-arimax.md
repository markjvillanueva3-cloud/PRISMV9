---
title: Formula — router · ts_arimax
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ts_arimax
...
| Field | Value |
|-------|-------|
| Name | `router · ts_arimax` |
| Graph node | `formula.adjusted.calcdispatcher.action.ts_arimax` |
| Kind | dispatcher_router |
