---
title: Formula — router · pr_analyze_graph
type: formula
formula_id: formula.adjusted.devdispatcher.action.pr_analyze_graph
...
# Formula — `router · pr_analyze_graph`
...
| Field | Value |
|-------|-------|
| Name | `router · pr_analyze_graph` |
| Graph node | `formula.adjusted.devdispatcher.action.pr_analyze_graph` |
| Kind | dispatcher_router |
