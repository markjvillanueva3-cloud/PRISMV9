---
title: Formula — router · ontology_list_cams
type: formula
formula_id: formula.adjusted.camdispatcher.action.ontology_list_cams
...
# Formula — `router · ontology_list_cams`
...
| Field | Value |
|-------|-------|
| Name | `router · ontology_list_cams` |
| Graph node | `formula.adjusted.camdispatcher.action.ontology_list_cams` |
| Kind | dispatcher_router |
