---
title: Formula — router · cert_track_tool
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cert_track_tool
...
# Formula — `router · cert_track_tool`
...
| Field | Value |
|-------|-------|
| Name | `router · cert_track_tool` |
| Graph node | `formula.adjusted.calcdispatcher.action.cert_track_tool` |
| Kind | dispatcher_router |
