---
title: Formula — router · skill_audit
type: formula
formula_id: formula.adjusted.devdispatcher.action.skill_audit
...
| Field | Value |
|-------|-------|
| Name | `router · skill_audit` |
| Graph node | `formula.adjusted.devdispatcher.action.skill_audit` |
| Kind | dispatcher_router |
