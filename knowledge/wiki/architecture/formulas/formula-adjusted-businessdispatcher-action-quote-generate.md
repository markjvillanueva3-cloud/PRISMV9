---
title: Formula — router · quote_generate
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quote_generate
...
| Field | Value |
|-------|-------|
| Name | `router · quote_generate` |
| Graph node | `formula.adjusted.businessdispatcher.action.quote_generate` |
| Kind | dispatcher_router |
