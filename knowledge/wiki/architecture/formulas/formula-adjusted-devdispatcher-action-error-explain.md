---
title: Formula — router · error_explain
type: formula
formula_id: formula.adjusted.devdispatcher.action.error_explain
...
| Field | Value |
|-------|-------|
| Name | `router · error_explain` |
| Graph node | `formula.adjusted.devdispatcher.action.error_explain` |
| Kind | dispatcher_router |
