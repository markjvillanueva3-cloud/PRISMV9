---
title: Formula — router · hybrid_ml_physics
type: formula
formula_id: formula.adjusted.calcdispatcher.action.hybrid_ml_physics
...
# Formula — `router · hybrid_ml_physics`
...
| Field | Value |
|-------|-------|
| Name | `router · hybrid_ml_physics` |
| Graph node | `formula.adjusted.calcdispatcher.action.hybrid_ml_physics` |
| Kind | dispatcher_router |
