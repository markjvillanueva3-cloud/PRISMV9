---
title: Formula — router · energy_optimize
type: formula
formula_id: formula.adjusted.camdispatcher.action.energy_optimize
...
# Formula — `router · energy_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · energy_optimize` |
| Graph node | `formula.adjusted.camdispatcher.action.energy_optimize` |
| Kind | dispatcher_router |
