---
title: Formula — router · machine_recommend
type: formula
formula_id: formula.adjusted.calcdispatcher.action.machine_recommend
...
# Formula — `router · machine_recommend`
...
| Field | Value |
|-------|-------|
| Name | `router · machine_recommend` |
| Graph node | `formula.adjusted.calcdispatcher.action.machine_recommend` |
| Kind | dispatcher_router |
