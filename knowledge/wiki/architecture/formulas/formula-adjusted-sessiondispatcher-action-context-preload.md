---
title: Formula — router · context_preload
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.context_preload
...
# Formula — `router · context_preload`
...
| Field | Value |
|-------|-------|
| Name | `router · context_preload` |
| Graph node | `formula.adjusted.sessiondispatcher.action.context_preload` |
| Kind | dispatcher_router |
