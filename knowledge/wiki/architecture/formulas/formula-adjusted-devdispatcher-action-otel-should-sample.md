---
title: Formula — router · otel_should_sample
type: formula
formula_id: formula.adjusted.devdispatcher.action.otel_should_sample
...
# Formula — `router · otel_should_sample`
...
| Field | Value |
|-------|-------|
| Name | `router · otel_should_sample` |
| Graph node | `formula.adjusted.devdispatcher.action.otel_should_sample` |
| Kind | dispatcher_router |
