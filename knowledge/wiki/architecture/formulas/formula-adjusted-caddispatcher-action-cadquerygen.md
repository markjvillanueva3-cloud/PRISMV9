---
title: Formula — router · cadQueryGen
type: formula
formula_id: formula.adjusted.caddispatcher.action.cadquerygen
...
| Field | Value |
|-------|-------|
| Name | `router · cadQueryGen` |
| Graph node | `formula.adjusted.caddispatcher.action.cadquerygen` |
| Kind | dispatcher_router |
