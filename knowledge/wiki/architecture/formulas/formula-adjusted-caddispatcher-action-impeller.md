---
title: Formula — router · impeller
type: formula
formula_id: formula.adjusted.caddispatcher.action.impeller
...
| Field | Value |
|-------|-------|
| Name | `router · impeller` |
| Graph node | `formula.adjusted.caddispatcher.action.impeller` |
| Kind | dispatcher_router |
