---
title: Formula — router · cam_post_dashboard
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_post_dashboard
...
# Formula — `router · cam_post_dashboard`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_post_dashboard` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_post_dashboard` |
| Kind | dispatcher_router |
