---
title: Formula — router · trochoidal
type: formula
formula_id: formula.adjusted.calcdispatcher.action.trochoidal
...
| Field | Value |
|-------|-------|
| Name | `router · trochoidal` |
| Graph node | `formula.adjusted.calcdispatcher.action.trochoidal` |
| Kind | dispatcher_router |
