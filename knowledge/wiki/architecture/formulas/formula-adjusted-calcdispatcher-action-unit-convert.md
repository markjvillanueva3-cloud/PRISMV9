---
title: Formula — router · unit_convert
type: formula
formula_id: formula.adjusted.calcdispatcher.action.unit_convert
...
| Field | Value |
|-------|-------|
| Name | `router · unit_convert` |
| Graph node | `formula.adjusted.calcdispatcher.action.unit_convert` |
| Kind | dispatcher_router |
