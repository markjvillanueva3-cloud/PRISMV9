---
title: Formula — router · training_assemble
type: formula
formula_id: formula.adjusted.mldispatcher.action.training_assemble
...
# Formula — `router · training_assemble`
...
| Field | Value |
|-------|-------|
| Name | `router · training_assemble` |
| Graph node | `formula.adjusted.mldispatcher.action.training_assemble` |
| Kind | dispatcher_router |
