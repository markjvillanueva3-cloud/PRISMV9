---
title: Formula — router · kinematics_fk
type: formula
formula_id: formula.adjusted.calcdispatcher.action.kinematics_fk
...
| Field | Value |
|-------|-------|
| Name | `router · kinematics_fk` |
| Graph node | `formula.adjusted.calcdispatcher.action.kinematics_fk` |
| Kind | dispatcher_router |
