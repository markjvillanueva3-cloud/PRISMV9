---
title: Formula — router · session_extend
type: formula
formula_id: formula.adjusted.securitydispatcher.action.session_extend
...
| Field | Value |
|-------|-------|
| Name | `router · session_extend` |
| Graph node | `formula.adjusted.securitydispatcher.action.session_extend` |
| Kind | dispatcher_router |
