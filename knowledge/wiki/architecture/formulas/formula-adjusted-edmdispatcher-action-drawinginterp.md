---
title: Formula — router · drawingInterp
type: formula
formula_id: formula.adjusted.edmdispatcher.action.drawinginterp
...
| Field | Value |
|-------|-------|
| Name | `router · drawingInterp` |
| Graph node | `formula.adjusted.edmdispatcher.action.drawinginterp` |
| Kind | dispatcher_router |
