---
title: Formula — router · loraAdapter
type: formula
formula_id: formula.adjusted.edmdispatcher.action.loraadapter
...
| Field | Value |
|-------|-------|
| Name | `router · loraAdapter` |
| Graph node | `formula.adjusted.edmdispatcher.action.loraadapter` |
| Kind | dispatcher_router |
