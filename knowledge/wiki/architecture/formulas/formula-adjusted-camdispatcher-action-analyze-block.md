---
title: Formula — router · analyze_block
type: formula
formula_id: formula.adjusted.camdispatcher.action.analyze_block
...
| Field | Value |
|-------|-------|
| Name | `router · analyze_block` |
| Graph node | `formula.adjusted.camdispatcher.action.analyze_block` |
| Kind | dispatcher_router |
