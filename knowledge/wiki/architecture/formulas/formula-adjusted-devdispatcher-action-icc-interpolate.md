---
title: Formula — router · icc_interpolate
type: formula
formula_id: formula.adjusted.devdispatcher.action.icc_interpolate
...
# Formula — `router · icc_interpolate`
...
| Field | Value |
|-------|-------|
| Name | `router · icc_interpolate` |
| Graph node | `formula.adjusted.devdispatcher.action.icc_interpolate` |
| Kind | dispatcher_router |
