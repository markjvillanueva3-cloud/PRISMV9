---
title: Formula — router · fai_disposition
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.fai_disposition
...
# Formula — `router · fai_disposition`
...
| Field | Value |
|-------|-------|
| Name | `router · fai_disposition` |
| Graph node | `formula.adjusted.qualitydispatcher.action.fai_disposition` |
| Kind | dispatcher_router |
