---
title: Formula — router · hr_enroll
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_enroll
...
| Field | Value |
|-------|-------|
| Name | `router · hr_enroll` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_enroll` |
| Kind | dispatcher_router |
