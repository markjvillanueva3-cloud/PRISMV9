---
title: Formula — router · catia_ai_get_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.catia_ai_get_stats
...
# Formula — `router · catia_ai_get_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · catia_ai_get_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.catia_ai_get_stats` |
| Kind | dispatcher_router |
