---
title: Formula — PDFTableExtractionEngine
type: formula
formula_id: eng.pdf.pdfformulaextractionengine.pdftableextractionengine
...
# Formula — `PDFTableExtractionEngine`
...
| Field | Value |
|-------|-------|
| Name | `PDFTableExtractionEngine` |
| Graph node | `eng.pdf.pdfformulaextractionengine.pdftableextractionengine` |
| Kind | pdf.pdfformulaextractionengine_engines |
