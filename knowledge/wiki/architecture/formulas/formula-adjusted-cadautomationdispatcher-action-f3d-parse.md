---
title: Formula — router · f3d_parse
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.f3d_parse
...
| Field | Value |
|-------|-------|
| Name | `router · f3d_parse` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.f3d_parse` |
| Kind | dispatcher_router |
