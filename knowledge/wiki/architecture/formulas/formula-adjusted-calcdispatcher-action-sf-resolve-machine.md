---
title: Formula — router · sf_resolve_machine
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sf_resolve_machine
...
# Formula — `router · sf_resolve_machine`
...
| Field | Value |
|-------|-------|
| Name | `router · sf_resolve_machine` |
| Graph node | `formula.adjusted.calcdispatcher.action.sf_resolve_machine` |
| Kind | dispatcher_router |
