---
title: Formula — router · hr_dashboard
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_dashboard
...
| Field | Value |
|-------|-------|
| Name | `router · hr_dashboard` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_dashboard` |
| Kind | dispatcher_router |
