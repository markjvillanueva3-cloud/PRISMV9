---
title: Formula — router · icc_find_similar
type: formula
formula_id: formula.adjusted.devdispatcher.action.icc_find_similar
...
# Formula — `router · icc_find_similar`
...
| Field | Value |
|-------|-------|
| Name | `router · icc_find_similar` |
| Graph node | `formula.adjusted.devdispatcher.action.icc_find_similar` |
| Kind | dispatcher_router |
