---
title: Formula — router · catiaAddInGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.catiaaddingen
...
| Field | Value |
|-------|-------|
| Name | `router · catiaAddInGen` |
| Graph node | `formula.adjusted.camdispatcher.action.catiaaddingen` |
| Kind | dispatcher_router |
