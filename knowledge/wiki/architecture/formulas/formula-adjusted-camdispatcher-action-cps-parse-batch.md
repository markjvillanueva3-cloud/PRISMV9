---
title: Formula — router · cps_parse_batch
type: formula
formula_id: formula.adjusted.camdispatcher.action.cps_parse_batch
...
# Formula — `router · cps_parse_batch`
...
| Field | Value |
|-------|-------|
| Name | `router · cps_parse_batch` |
| Graph node | `formula.adjusted.camdispatcher.action.cps_parse_batch` |
| Kind | dispatcher_router |
