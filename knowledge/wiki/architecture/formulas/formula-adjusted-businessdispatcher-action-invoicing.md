---
title: Formula — router · invoicing
type: formula
formula_id: formula.adjusted.businessdispatcher.action.invoicing
...
| Field | Value |
|-------|-------|
| Name | `router · invoicing` |
| Graph node | `formula.adjusted.businessdispatcher.action.invoicing` |
| Kind | dispatcher_router |
