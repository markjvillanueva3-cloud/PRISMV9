---
title: Formula — router · safety_veto_all
type: formula
formula_id: formula.adjusted.calcdispatcher.action.safety_veto_all
...
# Formula — `router · safety_veto_all`
...
| Field | Value |
|-------|-------|
| Name | `router · safety_veto_all` |
| Graph node | `formula.adjusted.calcdispatcher.action.safety_veto_all` |
| Kind | dispatcher_router |
