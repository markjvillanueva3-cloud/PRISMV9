---
title: Formula — router · metric_gauge
type: formula
formula_id: formula.adjusted.monitoringdispatcher.action.metric_gauge
...
| Field | Value |
|-------|-------|
| Name | `router · metric_gauge` |
| Graph node | `formula.adjusted.monitoringdispatcher.action.metric_gauge` |
| Kind | dispatcher_router |
