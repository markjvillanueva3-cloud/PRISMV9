---
title: Formula — router · f360_live_shell
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_shell
...
# Formula — `router · f360_live_shell`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_shell` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_shell` |
| Kind | dispatcher_router |
