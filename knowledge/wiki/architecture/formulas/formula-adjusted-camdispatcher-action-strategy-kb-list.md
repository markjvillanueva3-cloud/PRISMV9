---
title: Formula — router · strategy_kb_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategy_kb_list
...
# Formula — `router · strategy_kb_list`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_kb_list` |
| Graph node | `formula.adjusted.camdispatcher.action.strategy_kb_list` |
| Kind | dispatcher_router |
