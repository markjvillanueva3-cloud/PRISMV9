---
title: Formula — router · brand_tips
type: formula
formula_id: formula.adjusted.businessdispatcher.action.brand_tips
...
| Field | Value |
|-------|-------|
| Name | `router · brand_tips` |
| Graph node | `formula.adjusted.businessdispatcher.action.brand_tips` |
| Kind | dispatcher_router |
