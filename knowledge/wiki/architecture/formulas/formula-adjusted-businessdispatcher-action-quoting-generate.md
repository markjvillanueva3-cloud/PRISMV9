---
title: Formula — router · quoting_generate
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quoting_generate
...
# Formula — `router · quoting_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · quoting_generate` |
| Graph node | `formula.adjusted.businessdispatcher.action.quoting_generate` |
| Kind | dispatcher_router |
