---
title: Formula — router · diagnosis
type: formula
formula_id: formula.adjusted.diagnosisdispatcher
...
| Field | Value |
|-------|-------|
| Name | `router · diagnosis` |
| Graph node | `formula.adjusted.diagnosisdispatcher` |
| Kind | dispatcher_router |
