---
title: Formula — router · comment_delete
type: formula
formula_id: formula.adjusted.businessdispatcher.action.comment_delete
...
| Field | Value |
|-------|-------|
| Name | `router · comment_delete` |
| Graph node | `formula.adjusted.businessdispatcher.action.comment_delete` |
| Kind | dispatcher_router |
