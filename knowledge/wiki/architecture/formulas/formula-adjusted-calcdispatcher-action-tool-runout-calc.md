---
title: Formula — router · tool_runout_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_runout_calc
...
# Formula — `router · tool_runout_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_runout_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_runout_calc` |
| Kind | dispatcher_router |
