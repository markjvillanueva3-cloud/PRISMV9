---
title: Formula — router · context_health
type: formula
formula_id: formula.adjusted.devdispatcher.action.context_health
...
| Field | Value |
|-------|-------|
| Name | `router · context_health` |
| Graph node | `formula.adjusted.devdispatcher.action.context_health` |
| Kind | dispatcher_router |
