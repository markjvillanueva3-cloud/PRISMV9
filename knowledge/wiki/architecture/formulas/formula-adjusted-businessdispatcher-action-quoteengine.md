---
title: Formula — router · quoteEngine
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quoteengine
...
| Field | Value |
|-------|-------|
| Name | `router · quoteEngine` |
| Graph node | `formula.adjusted.businessdispatcher.action.quoteengine` |
| Kind | dispatcher_router |
