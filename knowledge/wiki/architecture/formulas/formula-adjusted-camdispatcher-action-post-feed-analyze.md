---
title: Formula — router · post_feed_analyze
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_feed_analyze
...
# Formula — `router · post_feed_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · post_feed_analyze` |
| Graph node | `formula.adjusted.camdispatcher.action.post_feed_analyze` |
| Kind | dispatcher_router |
