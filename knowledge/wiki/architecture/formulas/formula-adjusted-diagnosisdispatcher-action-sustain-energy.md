---
title: Formula — router · sustain_energy
type: formula
formula_id: formula.adjusted.diagnosisdispatcher.action.sustain_energy
...
| Field | Value |
|-------|-------|
| Name | `router · sustain_energy` |
| Graph node | `formula.adjusted.diagnosisdispatcher.action.sustain_energy` |
| Kind | dispatcher_router |
