---
title: Formula — router · lp_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.lp_solve
...
| Field | Value |
|-------|-------|
| Name | `router · lp_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.lp_solve` |
| Kind | dispatcher_router |
