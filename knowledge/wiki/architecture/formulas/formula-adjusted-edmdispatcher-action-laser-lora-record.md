---
title: Formula — router · laser_lora_record
type: formula
formula_id: formula.adjusted.edmdispatcher.action.laser_lora_record
...
# Formula — `router · laser_lora_record`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_lora_record` |
| Graph node | `formula.adjusted.edmdispatcher.action.laser_lora_record` |
| Kind | dispatcher_router |
