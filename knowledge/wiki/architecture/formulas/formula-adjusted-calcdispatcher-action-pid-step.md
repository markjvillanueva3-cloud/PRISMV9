---
title: Formula — router · pid_step
type: formula
formula_id: formula.adjusted.calcdispatcher.action.pid_step
...
| Field | Value |
|-------|-------|
| Name | `router · pid_step` |
| Graph node | `formula.adjusted.calcdispatcher.action.pid_step` |
| Kind | dispatcher_router |
