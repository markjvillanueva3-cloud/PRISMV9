---
title: Formula — router · ode_solve
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ode_solve
...
| Field | Value |
|-------|-------|
| Name | `router · ode_solve` |
| Graph node | `formula.adjusted.calcdispatcher.action.ode_solve` |
| Kind | dispatcher_router |
