---
title: Formula — router · cpsParser
type: formula
formula_id: formula.adjusted.camdispatcher.action.cpsparser
...
| Field | Value |
|-------|-------|
| Name | `router · cpsParser` |
| Graph node | `formula.adjusted.camdispatcher.action.cpsparser` |
| Kind | dispatcher_router |
