---
title: Formula — router · backplot_parse
type: formula
formula_id: formula.adjusted.calcdispatcher.action.backplot_parse
...
| Field | Value |
|-------|-------|
| Name | `router · backplot_parse` |
| Graph node | `formula.adjusted.calcdispatcher.action.backplot_parse` |
| Kind | dispatcher_router |
