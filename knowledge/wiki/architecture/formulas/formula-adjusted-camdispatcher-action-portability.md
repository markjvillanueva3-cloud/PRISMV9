---
title: Formula — router · portability
type: formula
formula_id: formula.adjusted.camdispatcher.action.portability
...
| Field | Value |
|-------|-------|
| Name | `router · portability` |
| Graph node | `formula.adjusted.camdispatcher.action.portability` |
| Kind | dispatcher_router |
