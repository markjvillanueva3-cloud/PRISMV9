---
title: Formula — router · engageAdapt
type: formula
formula_id: formula.adjusted.camdispatcher.action.engageadapt
...
| Field | Value |
|-------|-------|
| Name | `router · engageAdapt` |
| Graph node | `formula.adjusted.camdispatcher.action.engageadapt` |
| Kind | dispatcher_router |
