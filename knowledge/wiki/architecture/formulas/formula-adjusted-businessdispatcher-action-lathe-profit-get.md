---
title: Formula — router · lathe_profit_get
type: formula
formula_id: formula.adjusted.businessdispatcher.action.lathe_profit_get
...
# Formula — `router · lathe_profit_get`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_profit_get` |
| Graph node | `formula.adjusted.businessdispatcher.action.lathe_profit_get` |
| Kind | dispatcher_router |
