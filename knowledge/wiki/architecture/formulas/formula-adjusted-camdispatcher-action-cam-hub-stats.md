---
title: Formula — router · cam_hub_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_hub_stats
...
| Field | Value |
|-------|-------|
| Name | `router · cam_hub_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_hub_stats` |
| Kind | dispatcher_router |
