---
title: Formula — router · granulation_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.granulation_calc
...
# Formula — `router · granulation_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · granulation_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.granulation_calc` |
| Kind | dispatcher_router |
