---
title: Formula — PDFBlueprintDimensionExtractorEngine
type: formula
formula_id: eng.pdf.pdfformulaextractionengine.pdfblueprintdimensionextractorengine
...
| Field | Value |
|-------|-------|
| Name | `PDFBlueprintDimensionExtractorEngine` |
| Graph node | `eng.pdf.pdfformulaextractionengine.pdfblueprintdimensionextractorengine` |
| Kind | pdf.pdfformulaextractionengine_engines |
