---
title: Formula — router · pso_maximize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.pso_maximize
...
| Field | Value |
|-------|-------|
| Name | `router · pso_maximize` |
| Graph node | `formula.adjusted.calcdispatcher.action.pso_maximize` |
| Kind | dispatcher_router |
