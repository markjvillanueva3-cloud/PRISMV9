---
title: Formula — router · oee_calc
type: formula
formula_id: formula.adjusted.automationdispatcher.action.oee_calc
...
| Field | Value |
|-------|-------|
| Name | `router · oee_calc` |
| Graph node | `formula.adjusted.automationdispatcher.action.oee_calc` |
| Kind | dispatcher_router |
