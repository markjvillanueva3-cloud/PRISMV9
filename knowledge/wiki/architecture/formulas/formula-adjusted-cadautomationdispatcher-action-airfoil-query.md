---
title: Formula — router · airfoil_query
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.airfoil_query
...
| Field | Value |
|-------|-------|
| Name | `router · airfoil_query` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.airfoil_query` |
| Kind | dispatcher_router |
