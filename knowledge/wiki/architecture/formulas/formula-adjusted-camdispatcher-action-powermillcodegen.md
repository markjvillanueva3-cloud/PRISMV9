---
title: Formula — router · powerMillCodeGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.powermillcodegen
...
# Formula — `router · powerMillCodeGen`
...
| Field | Value |
|-------|-------|
| Name | `router · powerMillCodeGen` |
| Graph node | `formula.adjusted.camdispatcher.action.powermillcodegen` |
| Kind | dispatcher_router |
