---
title: Formula — router · deflection
type: formula
formula_id: formula.adjusted.calcdispatcher.action.deflection
...
| Field | Value |
|-------|-------|
| Name | `router · deflection` |
| Graph node | `formula.adjusted.calcdispatcher.action.deflection` |
| Kind | dispatcher_router |
