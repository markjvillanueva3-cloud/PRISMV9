---
title: Formula — router · hmExtractionOrch
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmextractionorch
...
# Formula — `router · hmExtractionOrch`
...
| Field | Value |
|-------|-------|
| Name | `router · hmExtractionOrch` |
| Graph node | `formula.adjusted.camdispatcher.action.hmextractionorch` |
| Kind | dispatcher_router |
