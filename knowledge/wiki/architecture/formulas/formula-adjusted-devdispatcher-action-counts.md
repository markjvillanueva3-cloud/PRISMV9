---
title: Formula — router · counts
type: formula
formula_id: formula.adjusted.devdispatcher.action.counts
...
|-------|-------|
| Name | `router · counts` |
| Graph node | `formula.adjusted.devdispatcher.action.counts` |
| Kind | dispatcher_router |
