---
title: Formula — router · campaign_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.campaign_optimize
...
# Formula — `router · campaign_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · campaign_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.campaign_optimize` |
| Kind | dispatcher_router |
