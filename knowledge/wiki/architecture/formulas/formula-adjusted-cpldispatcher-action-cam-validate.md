---
title: Formula — router · cam_validate
type: formula
formula_id: formula.adjusted.cpldispatcher.action.cam_validate
...
| Field | Value |
|-------|-------|
| Name | `router · cam_validate` |
| Graph node | `formula.adjusted.cpldispatcher.action.cam_validate` |
| Kind | dispatcher_router |
