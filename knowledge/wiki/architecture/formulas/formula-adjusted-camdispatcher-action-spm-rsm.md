---
title: Formula — router · spm_rsm
type: formula
formula_id: formula.adjusted.camdispatcher.action.spm_rsm
...
|-------|-------|
| Name | `router · spm_rsm` |
| Graph node | `formula.adjusted.camdispatcher.action.spm_rsm` |
| Kind | dispatcher_router |
