---
title: Formula — router · aco_solve_tsp
type: formula
formula_id: formula.adjusted.calcdispatcher.action.aco_solve_tsp
...
| Field | Value |
|-------|-------|
| Name | `router · aco_solve_tsp` |
| Graph node | `formula.adjusted.calcdispatcher.action.aco_solve_tsp` |
| Kind | dispatcher_router |
