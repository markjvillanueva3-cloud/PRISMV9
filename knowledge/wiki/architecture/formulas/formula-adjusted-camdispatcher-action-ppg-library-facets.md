---
title: Formula — router · ppg_library_facets
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_library_facets
...
# Formula — `router · ppg_library_facets`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_library_facets` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_library_facets` |
| Kind | dispatcher_router |
