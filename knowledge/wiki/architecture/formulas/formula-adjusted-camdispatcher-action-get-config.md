---
title: Formula — router · get_config
type: formula
formula_id: formula.adjusted.camdispatcher.action.get_config
...
| Graph node | `formula.adjusted.camdispatcher.action.get_config` |
| Kind | dispatcher_router |
