---
title: Formula — router · game_zero_sum
type: formula
formula_id: formula.adjusted.calcdispatcher.action.game_zero_sum
...
| Field | Value |
|-------|-------|
| Name | `router · game_zero_sum` |
| Graph node | `formula.adjusted.calcdispatcher.action.game_zero_sum` |
| Kind | dispatcher_router |
