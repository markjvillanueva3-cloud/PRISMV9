---
title: Formula — router · physics_transfer
type: formula
formula_id: formula.adjusted.calcdispatcher.action.physics_transfer
...
# Formula — `router · physics_transfer`
...
| Field | Value |
|-------|-------|
| Name | `router · physics_transfer` |
| Graph node | `formula.adjusted.calcdispatcher.action.physics_transfer` |
| Kind | dispatcher_router |
