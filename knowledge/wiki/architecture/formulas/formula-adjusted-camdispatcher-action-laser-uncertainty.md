---
title: Formula — router · laser_uncertainty
type: formula
formula_id: formula.adjusted.camdispatcher.action.laser_uncertainty
...
# Formula — `router · laser_uncertainty`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_uncertainty` |
| Graph node | `formula.adjusted.camdispatcher.action.laser_uncertainty` |
| Kind | dispatcher_router |
