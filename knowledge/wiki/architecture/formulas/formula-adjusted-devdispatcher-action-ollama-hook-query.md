---
title: Formula — router · ollama_hook_query
type: formula
formula_id: formula.adjusted.devdispatcher.action.ollama_hook_query
...
# Formula — `router · ollama_hook_query`
...
| Field | Value |
|-------|-------|
| Name | `router · ollama_hook_query` |
| Graph node | `formula.adjusted.devdispatcher.action.ollama_hook_query` |
| Kind | dispatcher_router |
