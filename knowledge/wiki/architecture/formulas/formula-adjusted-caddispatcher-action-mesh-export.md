---
title: Formula — router · mesh_export
type: formula
formula_id: formula.adjusted.caddispatcher.action.mesh_export
...
| Field | Value |
|-------|-------|
| Name | `router · mesh_export` |
| Graph node | `formula.adjusted.caddispatcher.action.mesh_export` |
| Kind | dispatcher_router |
