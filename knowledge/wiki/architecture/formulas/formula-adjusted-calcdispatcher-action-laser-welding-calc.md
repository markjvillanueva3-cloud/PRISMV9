---
title: Formula — router · laser_welding_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.laser_welding_calc
...
# Formula — `router · laser_welding_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_welding_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.laser_welding_calc` |
| Kind | dispatcher_router |
