---
title: Formula — router · stock_update
type: formula
formula_id: formula.adjusted.camdispatcher.action.stock_update
...
| Field | Value |
|-------|-------|
| Name | `router · stock_update` |
| Graph node | `formula.adjusted.camdispatcher.action.stock_update` |
| Kind | dispatcher_router |
