---
title: Formula — router · clock_in
type: formula
formula_id: formula.adjusted.businessdispatcher.action.clock_in
...
| Field | Value |
|-------|-------|
| Name | `router · clock_in` |
| Graph node | `formula.adjusted.businessdispatcher.action.clock_in` |
| Kind | dispatcher_router |
