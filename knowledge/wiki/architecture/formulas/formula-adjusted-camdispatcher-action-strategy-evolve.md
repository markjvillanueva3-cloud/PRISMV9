---
title: Formula — router · strategy_evolve
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategy_evolve
...
# Formula — `router · strategy_evolve`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_evolve` |
| Graph node | `formula.adjusted.camdispatcher.action.strategy_evolve` |
| Kind | dispatcher_router |
