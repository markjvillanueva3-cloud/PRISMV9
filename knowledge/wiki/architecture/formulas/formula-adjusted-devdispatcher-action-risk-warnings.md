---
title: Formula — router · risk_warnings
type: formula
formula_id: formula.adjusted.devdispatcher.action.risk_warnings
...
| Field | Value |
|-------|-------|
| Name | `router · risk_warnings` |
| Graph node | `formula.adjusted.devdispatcher.action.risk_warnings` |
| Kind | dispatcher_router |
