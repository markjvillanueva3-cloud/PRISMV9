---
title: Formula — router · pp_sedm_generate
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_sedm_generate
...
# Formula — `router · pp_sedm_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_sedm_generate` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_sedm_generate` |
| Kind | dispatcher_router |
