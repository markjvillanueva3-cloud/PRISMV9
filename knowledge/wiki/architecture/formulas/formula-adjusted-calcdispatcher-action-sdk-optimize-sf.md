---
title: Formula — router · sdk_optimize_sf
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sdk_optimize_sf
...
# Formula — `router · sdk_optimize_sf`
...
| Field | Value |
|-------|-------|
| Name | `router · sdk_optimize_sf` |
| Graph node | `formula.adjusted.calcdispatcher.action.sdk_optimize_sf` |
| Kind | dispatcher_router |
