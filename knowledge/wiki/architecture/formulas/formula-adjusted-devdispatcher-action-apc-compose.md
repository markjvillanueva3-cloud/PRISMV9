---
title: Formula — router · apc_compose
type: formula
formula_id: formula.adjusted.devdispatcher.action.apc_compose
...
| Field | Value |
|-------|-------|
| Name | `router · apc_compose` |
| Graph node | `formula.adjusted.devdispatcher.action.apc_compose` |
| Kind | dispatcher_router |
