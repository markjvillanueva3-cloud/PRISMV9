---
title: Formula — router · test_smoke
type: formula
formula_id: formula.adjusted.devdispatcher.action.test_smoke
...
| Field | Value |
|-------|-------|
| Name | `router · test_smoke` |
| Graph node | `formula.adjusted.devdispatcher.action.test_smoke` |
| Kind | dispatcher_router |
