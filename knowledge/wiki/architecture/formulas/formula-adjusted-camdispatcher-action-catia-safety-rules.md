---
title: Formula — router · catia_safety_rules
type: formula
formula_id: formula.adjusted.camdispatcher.action.catia_safety_rules
...
# Formula — `router · catia_safety_rules`
...
| Field | Value |
|-------|-------|
| Name | `router · catia_safety_rules` |
| Graph node | `formula.adjusted.camdispatcher.action.catia_safety_rules` |
| Kind | dispatcher_router |
