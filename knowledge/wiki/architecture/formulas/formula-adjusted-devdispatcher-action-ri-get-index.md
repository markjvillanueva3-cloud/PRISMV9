---
title: Formula — router · ri_get_index
type: formula
formula_id: formula.adjusted.devdispatcher.action.ri_get_index
...
| Field | Value |
|-------|-------|
| Name | `router · ri_get_index` |
| Graph node | `formula.adjusted.devdispatcher.action.ri_get_index` |
| Kind | dispatcher_router |
