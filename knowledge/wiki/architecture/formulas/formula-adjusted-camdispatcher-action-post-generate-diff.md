---
title: Formula — router · post_generate_diff
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_generate_diff
...
# Formula — `router · post_generate_diff`
...
| Field | Value |
|-------|-------|
| Name | `router · post_generate_diff` |
| Graph node | `formula.adjusted.camdispatcher.action.post_generate_diff` |
| Kind | dispatcher_router |
