---
title: Formula — router · wron_snapshot
type: formula
formula_id: formula.adjusted.devdispatcher.action.wron_snapshot
...
| Field | Value |
|-------|-------|
| Name | `router · wron_snapshot` |
| Graph node | `formula.adjusted.devdispatcher.action.wron_snapshot` |
| Kind | dispatcher_router |
