---
title: Formula — router · solidcam_op_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcam_op_list
...
# Formula — `router · solidcam_op_list`
...
| Field | Value |
|-------|-------|
| Name | `router · solidcam_op_list` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcam_op_list` |
| Kind | dispatcher_router |
