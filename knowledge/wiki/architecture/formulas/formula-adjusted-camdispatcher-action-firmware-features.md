---
title: Formula — router · firmware_features
type: formula
formula_id: formula.adjusted.camdispatcher.action.firmware_features
...
# Formula — `router · firmware_features`
...
| Field | Value |
|-------|-------|
| Name | `router · firmware_features` |
| Graph node | `formula.adjusted.camdispatcher.action.firmware_features` |
| Kind | dispatcher_router |
