---
title: Formula — router · sci_oblique
type: formula
formula_id: formula.adjusted.camdispatcher.action.sci_oblique
...
| Field | Value |
|-------|-------|
| Name | `router · sci_oblique` |
| Graph node | `formula.adjusted.camdispatcher.action.sci_oblique` |
| Kind | dispatcher_router |
