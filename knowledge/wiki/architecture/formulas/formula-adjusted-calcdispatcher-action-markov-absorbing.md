---
title: Formula — router · markov_absorbing
type: formula
formula_id: formula.adjusted.calcdispatcher.action.markov_absorbing
...
# Formula — `router · markov_absorbing`
...
| Field | Value |
|-------|-------|
| Name | `router · markov_absorbing` |
| Graph node | `formula.adjusted.calcdispatcher.action.markov_absorbing` |
| Kind | dispatcher_router |
