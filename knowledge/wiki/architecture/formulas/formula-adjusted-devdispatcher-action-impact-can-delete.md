---
title: Formula — router · impact_can_delete
type: formula
formula_id: formula.adjusted.devdispatcher.action.impact_can_delete
...
# Formula — `router · impact_can_delete`
...
| Field | Value |
|-------|-------|
| Name | `router · impact_can_delete` |
| Graph node | `formula.adjusted.devdispatcher.action.impact_can_delete` |
| Kind | dispatcher_router |
