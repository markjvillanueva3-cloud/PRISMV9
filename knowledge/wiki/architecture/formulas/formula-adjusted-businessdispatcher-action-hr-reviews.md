---
title: Formula — router · hr_reviews
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_reviews
...
| Field | Value |
|-------|-------|
| Name | `router · hr_reviews` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_reviews` |
| Kind | dispatcher_router |
