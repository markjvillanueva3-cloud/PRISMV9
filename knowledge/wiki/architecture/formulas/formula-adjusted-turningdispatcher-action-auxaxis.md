---
title: Formula — router · auxAxis
type: formula
formula_id: formula.adjusted.turningdispatcher.action.auxaxis
...
|-------|-------|
| Name | `router · auxAxis` |
| Graph node | `formula.adjusted.turningdispatcher.action.auxaxis` |
| Kind | dispatcher_router |
