---
title: Formula — router · cad_index_diff
type: formula
formula_id: formula.adjusted.cadregressiondispatcher.action.cad_index_diff
...
| Field | Value |
|-------|-------|
| Name | `router · cad_index_diff` |
| Graph node | `formula.adjusted.cadregressiondispatcher.action.cad_index_diff` |
| Kind | dispatcher_router |
