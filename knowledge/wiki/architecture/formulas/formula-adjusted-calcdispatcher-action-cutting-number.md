---
title: Formula — router · cutting_number
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cutting_number
...
| Field | Value |
|-------|-------|
| Name | `router · cutting_number` |
| Graph node | `formula.adjusted.calcdispatcher.action.cutting_number` |
| Kind | dispatcher_router |
