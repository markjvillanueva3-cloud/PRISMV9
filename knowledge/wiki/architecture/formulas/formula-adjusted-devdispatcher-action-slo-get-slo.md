---
title: Formula — router · slo_get_slo
type: formula
formula_id: formula.adjusted.devdispatcher.action.slo_get_slo
...
| Field | Value |
|-------|-------|
| Name | `router · slo_get_slo` |
| Graph node | `formula.adjusted.devdispatcher.action.slo_get_slo` |
| Kind | dispatcher_router |
