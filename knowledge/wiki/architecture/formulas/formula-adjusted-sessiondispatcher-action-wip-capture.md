---
title: Formula — router · wip_capture
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.wip_capture
...
| Field | Value |
|-------|-------|
| Name | `router · wip_capture` |
| Graph node | `formula.adjusted.sessiondispatcher.action.wip_capture` |
| Kind | dispatcher_router |
