---
title: Formula — router · setup_sheet_tools
type: formula
formula_id: formula.adjusted.camdispatcher.action.setup_sheet_tools
...
# Formula — `router · setup_sheet_tools`
...
| Field | Value |
|-------|-------|
| Name | `router · setup_sheet_tools` |
| Graph node | `formula.adjusted.camdispatcher.action.setup_sheet_tools` |
| Kind | dispatcher_router |
