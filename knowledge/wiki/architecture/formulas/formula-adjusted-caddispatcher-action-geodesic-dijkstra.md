---
title: Formula — router · geodesic_dijkstra
type: formula
formula_id: formula.adjusted.caddispatcher.action.geodesic_dijkstra
...
# Formula — `router · geodesic_dijkstra`
...
| Field | Value |
|-------|-------|
| Name | `router · geodesic_dijkstra` |
| Graph node | `formula.adjusted.caddispatcher.action.geodesic_dijkstra` |
| Kind | dispatcher_router |
