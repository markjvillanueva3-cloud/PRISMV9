---
title: Formula — router · monitoring
type: formula
formula_id: formula.adjusted.monitoringdispatcher
...
| Graph node | `formula.adjusted.monitoringdispatcher` |
| Kind | dispatcher_router |
