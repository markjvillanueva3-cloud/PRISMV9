---
title: Formula — router · sheet_cut_order
type: formula
formula_id: formula.adjusted.camdispatcher.action.sheet_cut_order
...
# Formula — `router · sheet_cut_order`
...
| Field | Value |
|-------|-------|
| Name | `router · sheet_cut_order` |
| Graph node | `formula.adjusted.camdispatcher.action.sheet_cut_order` |
| Kind | dispatcher_router |
