---
title: Formula — router · prodBatchOpt
type: formula
formula_id: formula.adjusted.camdispatcher.action.prodbatchopt
...
| Field | Value |
|-------|-------|
| Name | `router · prodBatchOpt` |
| Graph node | `formula.adjusted.camdispatcher.action.prodbatchopt` |
| Kind | dispatcher_router |
