---
title: Formula — router · secondaryOps
type: formula
formula_id: formula.adjusted.businessdispatcher.action.secondaryops
...
| Field | Value |
|-------|-------|
| Name | `router · secondaryOps` |
| Graph node | `formula.adjusted.businessdispatcher.action.secondaryops` |
| Kind | dispatcher_router |
