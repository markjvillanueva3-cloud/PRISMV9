---
title: Formula — router · state_checkpoint
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.state_checkpoint
...
# Formula — `router · state_checkpoint`
...
| Field | Value |
|-------|-------|
| Name | `router · state_checkpoint` |
| Graph node | `formula.adjusted.sessiondispatcher.action.state_checkpoint` |
| Kind | dispatcher_router |
