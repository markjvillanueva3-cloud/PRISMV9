---
title: Formula — router · tailstock
type: formula
formula_id: formula.adjusted.turningdispatcher.action.tailstock
...
| Field | Value |
|-------|-------|
| Name | `router · tailstock` |
| Graph node | `formula.adjusted.turningdispatcher.action.tailstock` |
| Kind | dispatcher_router |
