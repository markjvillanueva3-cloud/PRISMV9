---
title: Formula — router · replan_evaluate
type: formula
formula_id: formula.adjusted.devdispatcher.action.replan_evaluate
...
# Formula — `router · replan_evaluate`
...
| Field | Value |
|-------|-------|
| Name | `router · replan_evaluate` |
| Graph node | `formula.adjusted.devdispatcher.action.replan_evaluate` |
| Kind | dispatcher_router |
