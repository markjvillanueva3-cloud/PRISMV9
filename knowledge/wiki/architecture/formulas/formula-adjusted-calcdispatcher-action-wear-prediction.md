---
title: Formula — router · wear_prediction
type: formula
formula_id: formula.adjusted.calcdispatcher.action.wear_prediction
...
# Formula — `router · wear_prediction`
...
| Field | Value |
|-------|-------|
| Name | `router · wear_prediction` |
| Graph node | `formula.adjusted.calcdispatcher.action.wear_prediction` |
| Kind | dispatcher_router |
