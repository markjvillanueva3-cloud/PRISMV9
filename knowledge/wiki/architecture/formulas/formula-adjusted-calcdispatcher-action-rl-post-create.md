---
title: Formula — router · rl_post_create
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rl_post_create
...
| Field | Value |
|-------|-------|
| Name | `router · rl_post_create` |
| Graph node | `formula.adjusted.calcdispatcher.action.rl_post_create` |
| Kind | dispatcher_router |
