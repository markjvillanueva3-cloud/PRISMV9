---
title: Formula — router · cuttingMath
type: formula
formula_id: formula.adjusted.camdispatcher.action.cuttingmath
...
| Field | Value |
|-------|-------|
| Name | `router · cuttingMath` |
| Graph node | `formula.adjusted.camdispatcher.action.cuttingmath` |
| Kind | dispatcher_router |
