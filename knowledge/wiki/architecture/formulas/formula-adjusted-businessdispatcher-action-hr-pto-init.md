---
title: Formula — router · hr_pto_init
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_pto_init
...
| Field | Value |
|-------|-------|
| Name | `router · hr_pto_init` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_pto_init` |
| Kind | dispatcher_router |
