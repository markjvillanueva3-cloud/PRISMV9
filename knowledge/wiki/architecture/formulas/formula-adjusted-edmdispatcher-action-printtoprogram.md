---
title: Formula — router · printToProgram
type: formula
formula_id: formula.adjusted.edmdispatcher.action.printtoprogram
...
| Field | Value |
|-------|-------|
| Name | `router · printToProgram` |
| Graph node | `formula.adjusted.edmdispatcher.action.printtoprogram` |
| Kind | dispatcher_router |
