---
title: Formula — router · quote_calibrate
type: formula
formula_id: formula.adjusted.businessdispatcher.action.quote_calibrate
...
# Formula — `router · quote_calibrate`
...
| Field | Value |
|-------|-------|
| Name | `router · quote_calibrate` |
| Graph node | `formula.adjusted.businessdispatcher.action.quote_calibrate` |
| Kind | dispatcher_router |
