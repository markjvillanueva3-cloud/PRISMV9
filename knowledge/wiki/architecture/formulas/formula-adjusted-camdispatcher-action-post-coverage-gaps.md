---
title: Formula — router · post_coverage_gaps
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_coverage_gaps
...
# Formula — `router · post_coverage_gaps`
...
| Field | Value |
|-------|-------|
| Name | `router · post_coverage_gaps` |
| Graph node | `formula.adjusted.camdispatcher.action.post_coverage_gaps` |
| Kind | dispatcher_router |
