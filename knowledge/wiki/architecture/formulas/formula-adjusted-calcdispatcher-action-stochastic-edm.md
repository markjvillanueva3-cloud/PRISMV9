---
title: Formula — router · stochastic_edm
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stochastic_edm
...
| Field | Value |
|-------|-------|
| Name | `router · stochastic_edm` |
| Graph node | `formula.adjusted.calcdispatcher.action.stochastic_edm` |
| Kind | dispatcher_router |
