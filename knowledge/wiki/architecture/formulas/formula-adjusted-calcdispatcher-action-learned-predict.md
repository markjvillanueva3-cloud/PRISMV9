---
title: Formula — router · learned_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.learned_predict
...
# Formula — `router · learned_predict`
...
| Field | Value |
|-------|-------|
| Name | `router · learned_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.learned_predict` |
| Kind | dispatcher_router |
