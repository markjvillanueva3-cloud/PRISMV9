---
title: Formula — router · f360_auto_program
type: formula
formula_id: formula.adjusted.camdispatcher.action.f360_auto_program
...
# Formula — `router · f360_auto_program`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_auto_program` |
| Graph node | `formula.adjusted.camdispatcher.action.f360_auto_program` |
| Kind | dispatcher_router |
