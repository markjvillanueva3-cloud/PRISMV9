---
title: Formula — router · workflow_submit
type: formula
formula_id: formula.adjusted.businessdispatcher.action.workflow_submit
...
# Formula — `router · workflow_submit`
...
| Field | Value |
|-------|-------|
| Name | `router · workflow_submit` |
| Graph node | `formula.adjusted.businessdispatcher.action.workflow_submit` |
| Kind | dispatcher_router |
