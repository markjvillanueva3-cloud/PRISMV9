---
title: Formula — router · build_debrief
type: formula
formula_id: formula.adjusted.devdispatcher.action.build_debrief
...
| Field | Value |
|-------|-------|
| Name | `router · build_debrief` |
| Graph node | `formula.adjusted.devdispatcher.action.build_debrief` |
| Kind | dispatcher_router |
