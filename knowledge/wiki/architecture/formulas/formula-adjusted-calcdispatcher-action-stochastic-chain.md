---
title: Formula — router · stochastic_chain
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stochastic_chain
...
# Formula — `router · stochastic_chain`
...
| Field | Value |
|-------|-------|
| Name | `router · stochastic_chain` |
| Graph node | `formula.adjusted.calcdispatcher.action.stochastic_chain` |
| Kind | dispatcher_router |
