---
title: Formula — router · disclose_shape
type: formula
formula_id: formula.adjusted.devdispatcher.action.disclose_shape
...
| Field | Value |
|-------|-------|
| Name | `router · disclose_shape` |
| Graph node | `formula.adjusted.devdispatcher.action.disclose_shape` |
| Kind | dispatcher_router |
