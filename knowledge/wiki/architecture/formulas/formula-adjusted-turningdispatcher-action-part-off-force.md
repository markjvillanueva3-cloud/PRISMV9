---
title: Formula — router · part_off_force
type: formula
formula_id: formula.adjusted.turningdispatcher.action.part_off_force
...
| Field | Value |
|-------|-------|
| Name | `router · part_off_force` |
| Graph node | `formula.adjusted.turningdispatcher.action.part_off_force` |
| Kind | dispatcher_router |
