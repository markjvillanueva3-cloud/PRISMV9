---
title: Formula — router · plan_assembly
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.plan_assembly
...
| Field | Value |
|-------|-------|
| Name | `router · plan_assembly` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.plan_assembly` |
| Kind | dispatcher_router |
