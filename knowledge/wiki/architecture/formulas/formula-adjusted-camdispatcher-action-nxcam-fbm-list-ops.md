---
title: Formula — router · nxcam_fbm_list_ops
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcam_fbm_list_ops
...
# Formula — `router · nxcam_fbm_list_ops`
...
| Field | Value |
|-------|-------|
| Name | `router · nxcam_fbm_list_ops` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcam_fbm_list_ops` |
| Kind | dispatcher_router |
