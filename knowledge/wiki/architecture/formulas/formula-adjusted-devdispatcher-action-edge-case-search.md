---
title: Formula — router · edge_case_search
type: formula
formula_id: formula.adjusted.devdispatcher.action.edge_case_search
...
# Formula — `router · edge_case_search`
...
| Field | Value |
|-------|-------|
| Name | `router · edge_case_search` |
| Graph node | `formula.adjusted.devdispatcher.action.edge_case_search` |
| Kind | dispatcher_router |
