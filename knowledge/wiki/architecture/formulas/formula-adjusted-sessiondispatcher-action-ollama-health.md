---
title: Formula — router · ollama_health
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.ollama_health
...
| Field | Value |
|-------|-------|
| Name | `router · ollama_health` |
| Graph node | `formula.adjusted.sessiondispatcher.action.ollama_health` |
| Kind | dispatcher_router |
