---
title: Formula — router · decisionExplainer
type: formula
formula_id: formula.adjusted.ppdispatcher.action.decisionexplainer
...
# Formula — `router · decisionExplainer`
...
| Field | Value |
|-------|-------|
| Name | `router · decisionExplainer` |
| Graph node | `formula.adjusted.ppdispatcher.action.decisionexplainer` |
| Kind | dispatcher_router |
