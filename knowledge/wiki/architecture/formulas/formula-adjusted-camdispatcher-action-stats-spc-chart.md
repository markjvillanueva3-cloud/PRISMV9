---
title: Formula — router · stats_spc_chart
type: formula
formula_id: formula.adjusted.camdispatcher.action.stats_spc_chart
...
# Formula — `router · stats_spc_chart`
...
| Field | Value |
|-------|-------|
| Name | `router · stats_spc_chart` |
| Graph node | `formula.adjusted.camdispatcher.action.stats_spc_chart` |
| Kind | dispatcher_router |
