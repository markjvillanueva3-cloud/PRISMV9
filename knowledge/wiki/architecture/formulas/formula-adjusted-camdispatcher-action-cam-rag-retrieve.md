---
title: Formula — router · cam_rag_retrieve
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_rag_retrieve
...
# Formula — `router · cam_rag_retrieve`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_rag_retrieve` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_rag_retrieve` |
| Kind | dispatcher_router |
