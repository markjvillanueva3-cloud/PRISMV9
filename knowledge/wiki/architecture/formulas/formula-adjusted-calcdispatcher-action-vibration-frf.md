---
title: Formula — router · vibration_frf
type: formula
formula_id: formula.adjusted.calcdispatcher.action.vibration_frf
...
| Field | Value |
|-------|-------|
| Name | `router · vibration_frf` |
| Graph node | `formula.adjusted.calcdispatcher.action.vibration_frf` |
| Kind | dispatcher_router |
