---
title: Formula — router · machine_cap_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.machine_cap_stats
...
# Formula — `router · machine_cap_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · machine_cap_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.machine_cap_stats` |
| Kind | dispatcher_router |
