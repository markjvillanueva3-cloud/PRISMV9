---
title: Formula — router · workNCStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.workncstrategy
...
| Field | Value |
|-------|-------|
| Name | `router · workNCStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.workncstrategy` |
| Kind | dispatcher_router |
