---
title: Formula — router · invoice_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.invoice_list
...
| Field | Value |
|-------|-------|
| Name | `router · invoice_list` |
| Graph node | `formula.adjusted.businessdispatcher.action.invoice_list` |
| Kind | dispatcher_router |
