---
title: Formula — router · lattice
type: formula
formula_id: formula.adjusted.edmdispatcher.action.lattice
...
|-------|-------|
| Name | `router · lattice` |
| Graph node | `formula.adjusted.edmdispatcher.action.lattice` |
| Kind | dispatcher_router |
