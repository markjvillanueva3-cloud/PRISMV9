---
title: Formula — router · voronoi_delaunay
type: formula
formula_id: formula.adjusted.calcdispatcher.action.voronoi_delaunay
...
# Formula — `router · voronoi_delaunay`
...
| Field | Value |
|-------|-------|
| Name | `router · voronoi_delaunay` |
| Graph node | `formula.adjusted.calcdispatcher.action.voronoi_delaunay` |
| Kind | dispatcher_router |
