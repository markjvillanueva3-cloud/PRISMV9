---
title: Formula — router · dominant_frequency
type: formula
formula_id: formula.adjusted.calcdispatcher.action.dominant_frequency
...
# Formula — `router · dominant_frequency`
...
| Field | Value |
|-------|-------|
| Name | `router · dominant_frequency` |
| Graph node | `formula.adjusted.calcdispatcher.action.dominant_frequency` |
| Kind | dispatcher_router |
