---
title: Formula — router · cadTrialLearn
type: formula
formula_id: formula.adjusted.caddispatcher.action.cadtriallearn
...
| Field | Value |
|-------|-------|
| Name | `router · cadTrialLearn` |
| Graph node | `formula.adjusted.caddispatcher.action.cadtriallearn` |
| Kind | dispatcher_router |
