---
title: Formula — router · energy_add_to_cost
type: formula
formula_id: formula.adjusted.camdispatcher.action.energy_add_to_cost
...
# Formula — `router · energy_add_to_cost`
...
| Field | Value |
|-------|-------|
| Name | `router · energy_add_to_cost` |
| Graph node | `formula.adjusted.camdispatcher.action.energy_add_to_cost` |
| Kind | dispatcher_router |
