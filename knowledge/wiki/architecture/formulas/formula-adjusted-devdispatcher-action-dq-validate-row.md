---
title: Formula — router · dq_validate_row
type: formula
formula_id: formula.adjusted.devdispatcher.action.dq_validate_row
...
# Formula — `router · dq_validate_row`
...
| Field | Value |
|-------|-------|
| Name | `router · dq_validate_row` |
| Graph node | `formula.adjusted.devdispatcher.action.dq_validate_row` |
| Kind | dispatcher_router |
