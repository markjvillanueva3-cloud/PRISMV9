---
title: Formula — router · transpiler
type: formula
formula_id: formula.adjusted.camdispatcher.action.transpiler
...
| Field | Value |
|-------|-------|
| Name | `router · transpiler` |
| Graph node | `formula.adjusted.camdispatcher.action.transpiler` |
| Kind | dispatcher_router |
