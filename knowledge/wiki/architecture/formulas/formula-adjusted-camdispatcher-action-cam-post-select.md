---
title: Formula — router · cam_post_select
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_post_select
...
# Formula — `router · cam_post_select`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_post_select` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_post_select` |
| Kind | dispatcher_router |
