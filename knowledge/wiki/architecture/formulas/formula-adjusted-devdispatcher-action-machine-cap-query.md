---
title: Formula — router · machine_cap_query
type: formula
formula_id: formula.adjusted.devdispatcher.action.machine_cap_query
...
# Formula — `router · machine_cap_query`
...
| Field | Value |
|-------|-------|
| Name | `router · machine_cap_query` |
| Graph node | `formula.adjusted.devdispatcher.action.machine_cap_query` |
| Kind | dispatcher_router |
