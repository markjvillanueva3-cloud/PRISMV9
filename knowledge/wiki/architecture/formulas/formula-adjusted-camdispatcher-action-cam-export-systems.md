---
title: Formula — router · cam_export_systems
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_export_systems
...
# Formula — `router · cam_export_systems`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_export_systems` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_export_systems` |
| Kind | dispatcher_router |
