---
title: Formula — router · tool_wear_rate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_wear_rate
...
| Field | Value |
|-------|-------|
| Name | `router · tool_wear_rate` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_wear_rate` |
| Kind | dispatcher_router |
