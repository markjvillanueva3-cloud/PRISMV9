---
title: Formula — router · pp_reoptimize
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_reoptimize
...
| Field | Value |
|-------|-------|
| Name | `router · pp_reoptimize` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_reoptimize` |
| Kind | dispatcher_router |
