---
title: Formula — router · workholding_verify
type: formula
formula_id: formula.adjusted.camdispatcher.action.workholding_verify
...
# Formula — `router · workholding_verify`
...
| Field | Value |
|-------|-------|
| Name | `router · workholding_verify` |
| Graph node | `formula.adjusted.camdispatcher.action.workholding_verify` |
| Kind | dispatcher_router |
