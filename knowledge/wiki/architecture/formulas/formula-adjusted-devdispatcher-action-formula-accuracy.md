---
title: Formula — router · formula_accuracy
type: formula
formula_id: formula.adjusted.devdispatcher.action.formula_accuracy
...
# Formula — `router · formula_accuracy`
...
| Field | Value |
|-------|-------|
| Name | `router · formula_accuracy` |
| Graph node | `formula.adjusted.devdispatcher.action.formula_accuracy` |
| Kind | dispatcher_router |
