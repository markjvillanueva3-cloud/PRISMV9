---
title: Formula — router · corner_feed
type: formula
formula_id: formula.adjusted.calcdispatcher.action.corner_feed
...
| Field | Value |
|-------|-------|
| Name | `router · corner_feed` |
| Graph node | `formula.adjusted.calcdispatcher.action.corner_feed` |
| Kind | dispatcher_router |
