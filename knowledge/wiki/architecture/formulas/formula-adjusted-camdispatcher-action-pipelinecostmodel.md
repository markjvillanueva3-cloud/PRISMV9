---
title: Formula — router · pipelineCostModel
type: formula
formula_id: formula.adjusted.camdispatcher.action.pipelinecostmodel
...
# Formula — `router · pipelineCostModel`
...
| Field | Value |
|-------|-------|
| Name | `router · pipelineCostModel` |
| Graph node | `formula.adjusted.camdispatcher.action.pipelinecostmodel` |
| Kind | dispatcher_router |
