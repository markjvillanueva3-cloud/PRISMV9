---
title: Formula — router · spec_html_render
type: formula
formula_id: formula.adjusted.devdispatcher.action.spec_html_render
...
# Formula — `router · spec_html_render`
...
| Field | Value |
|-------|-------|
| Name | `router · spec_html_render` |
| Graph node | `formula.adjusted.devdispatcher.action.spec_html_render` |
| Kind | dispatcher_router |
