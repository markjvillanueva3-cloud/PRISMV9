---
title: Formula — router · strategyEvolution
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategyevolution
...
# Formula — `router · strategyEvolution`
...
| Field | Value |
|-------|-------|
| Name | `router · strategyEvolution` |
| Graph node | `formula.adjusted.camdispatcher.action.strategyevolution` |
| Kind | dispatcher_router |
