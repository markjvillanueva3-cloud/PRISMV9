---
title: Formula — router · cam_export
type: formula
formula_id: formula.adjusted.integrationdispatcher.action.cam_export
...
| Field | Value |
|-------|-------|
| Name | `router · cam_export` |
| Graph node | `formula.adjusted.integrationdispatcher.action.cam_export` |
| Kind | dispatcher_router |
