---
title: Formula — router · auto_detect_format
type: formula
formula_id: formula.adjusted.camdispatcher.action.auto_detect_format
...
# Formula — `router · auto_detect_format`
...
| Field | Value |
|-------|-------|
| Name | `router · auto_detect_format` |
| Graph node | `formula.adjusted.camdispatcher.action.auto_detect_format` |
| Kind | dispatcher_router |
