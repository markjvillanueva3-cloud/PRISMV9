---
title: Formula — router · lineByLine
type: formula
formula_id: formula.adjusted.camdispatcher.action.linebyline
...
| Field | Value |
|-------|-------|
| Name | `router · lineByLine` |
| Graph node | `formula.adjusted.camdispatcher.action.linebyline` |
| Kind | dispatcher_router |
