---
title: Formula — router · insertLife
type: formula
formula_id: formula.adjusted.turningdispatcher.action.insertlife
...
| Field | Value |
|-------|-------|
| Name | `router · insertLife` |
| Graph node | `formula.adjusted.turningdispatcher.action.insertlife` |
| Kind | dispatcher_router |
