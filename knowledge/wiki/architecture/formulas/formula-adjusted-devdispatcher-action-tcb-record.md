---
title: Formula — router · tcb_record
type: formula
formula_id: formula.adjusted.devdispatcher.action.tcb_record
...
| Field | Value |
|-------|-------|
| Name | `router · tcb_record` |
| Graph node | `formula.adjusted.devdispatcher.action.tcb_record` |
| Kind | dispatcher_router |
