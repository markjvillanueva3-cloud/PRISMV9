---
title: Formula — router · cam_post_encode
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_post_encode
...
# Formula — `router · cam_post_encode`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_post_encode` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_post_encode` |
| Kind | dispatcher_router |
