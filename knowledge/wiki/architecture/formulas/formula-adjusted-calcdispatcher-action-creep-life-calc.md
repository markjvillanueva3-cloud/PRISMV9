---
title: Formula — router · creep_life_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.creep_life_calc
...
# Formula — `router · creep_life_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · creep_life_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.creep_life_calc` |
| Kind | dispatcher_router |
