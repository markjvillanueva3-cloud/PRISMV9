---
title: Formula — router · hmMatPhysBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmmatphysbridge
...
# Formula — `router · hmMatPhysBridge`
...
| Field | Value |
|-------|-------|
| Name | `router · hmMatPhysBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.hmmatphysbridge` |
| Kind | dispatcher_router |
