---
title: Formula — router · pp_di_constraints
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_di_constraints
...
# Formula — `router · pp_di_constraints`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_di_constraints` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_di_constraints` |
| Kind | dispatcher_router |
