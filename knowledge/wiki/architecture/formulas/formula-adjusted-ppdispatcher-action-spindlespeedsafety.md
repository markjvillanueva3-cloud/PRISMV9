---
title: Formula — router · spindleSpeedSafety
type: formula
formula_id: formula.adjusted.ppdispatcher.action.spindlespeedsafety
...
# Formula — `router · spindleSpeedSafety`
...
| Field | Value |
|-------|-------|
| Name | `router · spindleSpeedSafety` |
| Graph node | `formula.adjusted.ppdispatcher.action.spindlespeedsafety` |
| Kind | dispatcher_router |
