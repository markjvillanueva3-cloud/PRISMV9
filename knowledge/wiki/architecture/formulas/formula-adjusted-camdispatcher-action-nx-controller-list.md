---
title: Formula — router · nx_controller_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_controller_list
...
# Formula — `router · nx_controller_list`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_controller_list` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_controller_list` |
| Kind | dispatcher_router |
