---
title: Formula — router · cmaes_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cmaes_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · cmaes_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.cmaes_optimize` |
| Kind | dispatcher_router |
