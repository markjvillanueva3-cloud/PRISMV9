---
title: Formula — router · thin_wall_params
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thin_wall_params
...
# Formula — `router · thin_wall_params`
...
| Field | Value |
|-------|-------|
| Name | `router · thin_wall_params` |
| Graph node | `formula.adjusted.calcdispatcher.action.thin_wall_params` |
| Kind | dispatcher_router |
