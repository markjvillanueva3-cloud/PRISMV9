---
title: Formula — router · probeGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.probegen
...
| Field | Value |
|-------|-------|
| Name | `router · probeGen` |
| Graph node | `formula.adjusted.camdispatcher.action.probegen` |
| Kind | dispatcher_router |
