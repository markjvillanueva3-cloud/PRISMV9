---
title: Formula — router · hmSafety
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmsafety
...
| Field | Value |
|-------|-------|
| Name | `router · hmSafety` |
| Graph node | `formula.adjusted.camdispatcher.action.hmsafety` |
| Kind | dispatcher_router |
