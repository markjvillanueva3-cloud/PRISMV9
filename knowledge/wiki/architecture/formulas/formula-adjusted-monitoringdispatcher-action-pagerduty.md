---
title: Formula — router · pagerDuty
type: formula
formula_id: formula.adjusted.monitoringdispatcher.action.pagerduty
...
| Field | Value |
|-------|-------|
| Name | `router · pagerDuty` |
| Graph node | `formula.adjusted.monitoringdispatcher.action.pagerduty` |
| Kind | dispatcher_router |
