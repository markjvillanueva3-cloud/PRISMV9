---
title: Formula — router · spm_pca_monitoring
type: formula
formula_id: formula.adjusted.camdispatcher.action.spm_pca_monitoring
...
# Formula — `router · spm_pca_monitoring`
...
| Field | Value |
|-------|-------|
| Name | `router · spm_pca_monitoring` |
| Graph node | `formula.adjusted.camdispatcher.action.spm_pca_monitoring` |
| Kind | dispatcher_router |
