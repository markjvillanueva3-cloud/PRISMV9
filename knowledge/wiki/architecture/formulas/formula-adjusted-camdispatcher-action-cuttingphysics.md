---
title: Formula — router · cuttingPhysics
type: formula
formula_id: formula.adjusted.camdispatcher.action.cuttingphysics
...
| Field | Value |
|-------|-------|
| Name | `router · cuttingPhysics` |
| Graph node | `formula.adjusted.camdispatcher.action.cuttingphysics` |
| Kind | dispatcher_router |
