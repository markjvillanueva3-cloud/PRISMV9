---
title: Formula — router · ppg_coolant_modes
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_coolant_modes
...
# Formula — `router · ppg_coolant_modes`
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_coolant_modes` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_coolant_modes` |
| Kind | dispatcher_router |
