---
title: Formula — router · live_tool_plan
type: formula
formula_id: formula.adjusted.turningdispatcher.action.live_tool_plan
...
| Field | Value |
|-------|-------|
| Name | `router · live_tool_plan` |
| Graph node | `formula.adjusted.turningdispatcher.action.live_tool_plan` |
| Kind | dispatcher_router |
