---
title: Formula — router · hypoid_gear_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.hypoid_gear_calc
...
# Formula — `router · hypoid_gear_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · hypoid_gear_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.hypoid_gear_calc` |
| Kind | dispatcher_router |
