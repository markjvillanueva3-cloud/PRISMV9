---
title: Formula — router · wre_explain
type: formula
formula_id: formula.adjusted.devdispatcher.action.wre_explain
...
| Field | Value |
|-------|-------|
| Name | `router · wre_explain` |
| Graph node | `formula.adjusted.devdispatcher.action.wre_explain` |
| Kind | dispatcher_router |
