---
title: Formula — router · assembler
type: formula
formula_id: formula.adjusted.camdispatcher.action.assembler
...
| Field | Value |
|-------|-------|
| Name | `router · assembler` |
| Graph node | `formula.adjusted.camdispatcher.action.assembler` |
| Kind | dispatcher_router |
