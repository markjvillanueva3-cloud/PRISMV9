---
title: Formula — router · accounting_audit
type: formula
formula_id: formula.adjusted.businessdispatcher.action.accounting_audit
...
# Formula — `router · accounting_audit`
...
| Field | Value |
|-------|-------|
| Name | `router · accounting_audit` |
| Graph node | `formula.adjusted.businessdispatcher.action.accounting_audit` |
| Kind | dispatcher_router |
