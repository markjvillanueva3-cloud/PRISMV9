---
title: Formula — router · laserWaterjetPost
type: formula
formula_id: formula.adjusted.camdispatcher.action.laserwaterjetpost
...
# Formula — `router · laserWaterjetPost`
...
| Field | Value |
|-------|-------|
| Name | `router · laserWaterjetPost` |
| Graph node | `formula.adjusted.camdispatcher.action.laserwaterjetpost` |
| Kind | dispatcher_router |
