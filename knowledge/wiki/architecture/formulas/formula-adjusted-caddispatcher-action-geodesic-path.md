---
title: Formula — router · geodesic_path
type: formula
formula_id: formula.adjusted.caddispatcher.action.geodesic_path
...
| Field | Value |
|-------|-------|
| Name | `router · geodesic_path` |
| Graph node | `formula.adjusted.caddispatcher.action.geodesic_path` |
| Kind | dispatcher_router |
