---
title: Formula — router · anomaly_relearn
type: formula
formula_id: formula.adjusted.calcdispatcher.action.anomaly_relearn
...
# Formula — `router · anomaly_relearn`
...
| Field | Value |
|-------|-------|
| Name | `router · anomaly_relearn` |
| Graph node | `formula.adjusted.calcdispatcher.action.anomaly_relearn` |
| Kind | dispatcher_router |
