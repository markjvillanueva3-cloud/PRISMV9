---
title: Formula — router · tco_savings
type: formula
formula_id: formula.adjusted.camdispatcher.action.tco_savings
...
| Field | Value |
|-------|-------|
| Name | `router · tco_savings` |
| Graph node | `formula.adjusted.camdispatcher.action.tco_savings` |
| Kind | dispatcher_router |
