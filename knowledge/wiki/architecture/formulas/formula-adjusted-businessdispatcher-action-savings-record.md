---
title: Formula — router · savings_record
type: formula
formula_id: formula.adjusted.businessdispatcher.action.savings_record
...
| Field | Value |
|-------|-------|
| Name | `router · savings_record` |
| Graph node | `formula.adjusted.businessdispatcher.action.savings_record` |
| Kind | dispatcher_router |
