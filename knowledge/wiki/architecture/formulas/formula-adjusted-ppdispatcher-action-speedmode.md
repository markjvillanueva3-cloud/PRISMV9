---
title: Formula — router · speedMode
type: formula
formula_id: formula.adjusted.ppdispatcher.action.speedmode
...
| Field | Value |
|-------|-------|
| Name | `router · speedMode` |
| Graph node | `formula.adjusted.ppdispatcher.action.speedmode` |
| Kind | dispatcher_router |
