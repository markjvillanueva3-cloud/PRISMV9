---
title: Formula — router · chatter_detect
type: formula
formula_id: formula.adjusted.calcdispatcher.action.chatter_detect
...
| Field | Value |
|-------|-------|
| Name | `router · chatter_detect` |
| Graph node | `formula.adjusted.calcdispatcher.action.chatter_detect` |
| Kind | dispatcher_router |
