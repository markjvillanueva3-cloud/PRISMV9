---
title: Formula — router · acc_abbe_offset
type: formula
formula_id: formula.adjusted.camdispatcher.action.acc_abbe_offset
...
# Formula — `router · acc_abbe_offset`
...
| Field | Value |
|-------|-------|
| Name | `router · acc_abbe_offset` |
| Graph node | `formula.adjusted.camdispatcher.action.acc_abbe_offset` |
| Kind | dispatcher_router |
