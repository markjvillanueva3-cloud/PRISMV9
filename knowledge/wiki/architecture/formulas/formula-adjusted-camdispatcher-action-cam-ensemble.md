---
title: Formula — router · cam_ensemble
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_ensemble
...
| Field | Value |
|-------|-------|
| Name | `router · cam_ensemble` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_ensemble` |
| Kind | dispatcher_router |
