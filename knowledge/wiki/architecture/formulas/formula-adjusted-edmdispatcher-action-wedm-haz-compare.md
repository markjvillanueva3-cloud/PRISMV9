---
title: Formula — router · wedm_haz_compare
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_haz_compare
...
# Formula — `router · wedm_haz_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_haz_compare` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_haz_compare` |
| Kind | dispatcher_router |
