---
title: Formula — router · by_tier
type: formula
formula_id: formula.adjusted.devdispatcher.action.by_tier
...
|-------|-------|
| Name | `router · by_tier` |
| Graph node | `formula.adjusted.devdispatcher.action.by_tier` |
| Kind | dispatcher_router |
