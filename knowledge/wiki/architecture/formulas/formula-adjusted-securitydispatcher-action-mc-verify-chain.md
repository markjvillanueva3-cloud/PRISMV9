---
title: Formula — router · mc_verify_chain
type: formula
formula_id: formula.adjusted.securitydispatcher.action.mc_verify_chain
...
# Formula — `router · mc_verify_chain`
...
| Field | Value |
|-------|-------|
| Name | `router · mc_verify_chain` |
| Graph node | `formula.adjusted.securitydispatcher.action.mc_verify_chain` |
| Kind | dispatcher_router |
