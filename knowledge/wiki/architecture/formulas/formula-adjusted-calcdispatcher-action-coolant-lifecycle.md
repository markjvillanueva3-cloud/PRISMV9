---
title: Formula — router · coolant_lifecycle
type: formula
formula_id: formula.adjusted.calcdispatcher.action.coolant_lifecycle
...
# Formula — `router · coolant_lifecycle`
...
| Field | Value |
|-------|-------|
| Name | `router · coolant_lifecycle` |
| Graph node | `formula.adjusted.calcdispatcher.action.coolant_lifecycle` |
| Kind | dispatcher_router |
