---
title: Formula — router · compact_kv_pairs
type: formula
formula_id: formula.adjusted.devdispatcher.action.compact_kv_pairs
...
# Formula — `router · compact_kv_pairs`
...
| Field | Value |
|-------|-------|
| Name | `router · compact_kv_pairs` |
| Graph node | `formula.adjusted.devdispatcher.action.compact_kv_pairs` |
| Kind | dispatcher_router |
