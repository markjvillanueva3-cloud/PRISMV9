---
title: Formula — router · capability_predict
type: formula
formula_id: formula.adjusted.calcdispatcher.action.capability_predict
...
# Formula — `router · capability_predict`
...
| Field | Value |
|-------|-------|
| Name | `router · capability_predict` |
| Graph node | `formula.adjusted.calcdispatcher.action.capability_predict` |
| Kind | dispatcher_router |
