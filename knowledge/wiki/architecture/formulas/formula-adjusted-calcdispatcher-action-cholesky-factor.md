---
title: Formula — router · cholesky_factor
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cholesky_factor
...
# Formula — `router · cholesky_factor`
...
| Field | Value |
|-------|-------|
| Name | `router · cholesky_factor` |
| Graph node | `formula.adjusted.calcdispatcher.action.cholesky_factor` |
| Kind | dispatcher_router |
