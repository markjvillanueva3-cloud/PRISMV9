---
title: Formula — router · wedm_predict_ra_v2
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_predict_ra_v2
...
# Formula — `router · wedm_predict_ra_v2`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_predict_ra_v2` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_predict_ra_v2` |
| Kind | dispatcher_router |
