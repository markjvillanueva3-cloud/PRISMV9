---
title: Formula — router · triage
type: formula
formula_id: formula.adjusted.cadregressiondispatcher.action.triage
...
|-------|-------|
| Name | `router · triage` |
| Graph node | `formula.adjusted.cadregressiondispatcher.action.triage` |
| Kind | dispatcher_router |
