---
title: Formula — router · customerMgmt
type: formula
formula_id: formula.adjusted.businessdispatcher.action.customermgmt
...
| Field | Value |
|-------|-------|
| Name | `router · customerMgmt` |
| Graph node | `formula.adjusted.businessdispatcher.action.customermgmt` |
| Kind | dispatcher_router |
