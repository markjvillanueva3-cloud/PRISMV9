---
title: Formula — router · anchor_claim
type: formula
formula_id: formula.adjusted.devdispatcher.action.anchor_claim
...
| Field | Value |
|-------|-------|
| Name | `router · anchor_claim` |
| Graph node | `formula.adjusted.devdispatcher.action.anchor_claim` |
| Kind | dispatcher_router |
