---
title: Formula — router · jc_list
type: formula
formula_id: formula.adjusted.calcdispatcher.action.jc_list
...
|-------|-------|
| Name | `router · jc_list` |
| Graph node | `formula.adjusted.calcdispatcher.action.jc_list` |
| Kind | dispatcher_router |
