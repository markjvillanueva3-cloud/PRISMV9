---
title: Formula — router · tool_start_usage
type: formula
formula_id: formula.adjusted.businessdispatcher.action.tool_start_usage
...
# Formula — `router · tool_start_usage`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_start_usage` |
| Graph node | `formula.adjusted.businessdispatcher.action.tool_start_usage` |
| Kind | dispatcher_router |
