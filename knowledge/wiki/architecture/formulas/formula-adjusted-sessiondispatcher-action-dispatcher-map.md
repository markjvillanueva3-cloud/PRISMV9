---
title: Formula — router · dispatcher_map
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.dispatcher_map
...
| Field | Value |
|-------|-------|
| Name | `router · dispatcher_map` |
| Graph node | `formula.adjusted.sessiondispatcher.action.dispatcher_map` |
| Kind | dispatcher_router |
