---
title: Formula — router · cam_tribal_lookup
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_tribal_lookup
...
# Formula — `router · cam_tribal_lookup`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_tribal_lookup` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_tribal_lookup` |
| Kind | dispatcher_router |
