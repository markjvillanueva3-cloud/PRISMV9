---
title: Formula — router · filter_press_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.filter_press_calc
...
# Formula — `router · filter_press_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · filter_press_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.filter_press_calc` |
| Kind | dispatcher_router |
