---
title: Formula — router · pp_mst_cross_cam
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_mst_cross_cam
...
# Formula — `router · pp_mst_cross_cam`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_mst_cross_cam` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_mst_cross_cam` |
| Kind | dispatcher_router |
