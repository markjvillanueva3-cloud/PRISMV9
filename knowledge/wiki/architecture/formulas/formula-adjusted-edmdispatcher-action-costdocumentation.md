---
title: Formula — router · costDocumentation
type: formula
formula_id: formula.adjusted.edmdispatcher.action.costdocumentation
...
# Formula — `router · costDocumentation`
...
| Field | Value |
|-------|-------|
| Name | `router · costDocumentation` |
| Graph node | `formula.adjusted.edmdispatcher.action.costdocumentation` |
| Kind | dispatcher_router |
