---
title: Formula — router · cps_map_batch
type: formula
formula_id: formula.adjusted.camdispatcher.action.cps_map_batch
...
| Field | Value |
|-------|-------|
| Name | `router · cps_map_batch` |
| Graph node | `formula.adjusted.camdispatcher.action.cps_map_batch` |
| Kind | dispatcher_router |
