---
title: Formula — router · training_audit
type: formula
formula_id: formula.adjusted.devdispatcher.action.training_audit
...
| Field | Value |
|-------|-------|
| Name | `router · training_audit` |
| Graph node | `formula.adjusted.devdispatcher.action.training_audit` |
| Kind | dispatcher_router |
