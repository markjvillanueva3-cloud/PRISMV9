---
title: Formula — router · fillet
type: formula
formula_id: formula.adjusted.caddispatcher.action.fillet
...
|-------|-------|
| Name | `router · fillet` |
| Graph node | `formula.adjusted.caddispatcher.action.fillet` |
| Kind | dispatcher_router |
