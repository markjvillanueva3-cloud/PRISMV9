---
title: Formula — router · assembly_add_mate
type: formula
formula_id: formula.adjusted.caddispatcher.action.assembly_add_mate
...
# Formula — `router · assembly_add_mate`
...
| Field | Value |
|-------|-------|
| Name | `router · assembly_add_mate` |
| Graph node | `formula.adjusted.caddispatcher.action.assembly_add_mate` |
| Kind | dispatcher_router |
