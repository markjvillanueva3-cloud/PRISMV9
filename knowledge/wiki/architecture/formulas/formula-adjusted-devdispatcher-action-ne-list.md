---
title: Formula — router · ne_list
type: formula
formula_id: formula.adjusted.devdispatcher.action.ne_list
...
|-------|-------|
| Name | `router · ne_list` |
| Graph node | `formula.adjusted.devdispatcher.action.ne_list` |
| Kind | dispatcher_router |
