---
title: Formula — router · batch_group
type: formula
formula_id: formula.adjusted.businessdispatcher.action.batch_group
...
| Field | Value |
|-------|-------|
| Name | `router · batch_group` |
| Graph node | `formula.adjusted.businessdispatcher.action.batch_group` |
| Kind | dispatcher_router |
