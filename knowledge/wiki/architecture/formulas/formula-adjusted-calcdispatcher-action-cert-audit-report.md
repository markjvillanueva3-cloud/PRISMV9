---
title: Formula — router · cert_audit_report
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cert_audit_report
...
# Formula — `router · cert_audit_report`
...
| Field | Value |
|-------|-------|
| Name | `router · cert_audit_report` |
| Graph node | `formula.adjusted.calcdispatcher.action.cert_audit_report` |
| Kind | dispatcher_router |
