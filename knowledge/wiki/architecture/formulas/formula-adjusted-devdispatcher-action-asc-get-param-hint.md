---
title: Formula — router · asc_get_param_hint
type: formula
formula_id: formula.adjusted.devdispatcher.action.asc_get_param_hint
...
# Formula — `router · asc_get_param_hint`
...
| Field | Value |
|-------|-------|
| Name | `router · asc_get_param_hint` |
| Graph node | `formula.adjusted.devdispatcher.action.asc_get_param_hint` |
| Kind | dispatcher_router |
