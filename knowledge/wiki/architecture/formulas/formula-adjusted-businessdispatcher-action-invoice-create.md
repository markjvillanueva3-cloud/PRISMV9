---
title: Formula — router · invoice_create
type: formula
formula_id: formula.adjusted.businessdispatcher.action.invoice_create
...
| Field | Value |
|-------|-------|
| Name | `router · invoice_create` |
| Graph node | `formula.adjusted.businessdispatcher.action.invoice_create` |
| Kind | dispatcher_router |
