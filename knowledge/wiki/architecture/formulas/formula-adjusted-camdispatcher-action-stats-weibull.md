---
title: Formula — router · stats_weibull
type: formula
formula_id: formula.adjusted.camdispatcher.action.stats_weibull
...
| Field | Value |
|-------|-------|
| Name | `router · stats_weibull` |
| Graph node | `formula.adjusted.camdispatcher.action.stats_weibull` |
| Kind | dispatcher_router |
