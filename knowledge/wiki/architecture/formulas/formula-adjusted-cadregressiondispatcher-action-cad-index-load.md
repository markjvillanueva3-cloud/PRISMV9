---
title: Formula — router · cad_index_load
type: formula
formula_id: formula.adjusted.cadregressiondispatcher.action.cad_index_load
...
| Field | Value |
|-------|-------|
| Name | `router · cad_index_load` |
| Graph node | `formula.adjusted.cadregressiondispatcher.action.cad_index_load` |
| Kind | dispatcher_router |
