---
title: Formula — router · part_library_stats
type: formula
formula_id: formula.adjusted.caddispatcher.action.part_library_stats
...
# Formula — `router · part_library_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · part_library_stats` |
| Graph node | `formula.adjusted.caddispatcher.action.part_library_stats` |
| Kind | dispatcher_router |
