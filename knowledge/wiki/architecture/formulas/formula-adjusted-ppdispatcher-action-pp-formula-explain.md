---
title: Formula — router · pp_formula_explain
type: formula
formula_id: formula.adjusted.ppdispatcher.action.pp_formula_explain
...
# Formula — `router · pp_formula_explain`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_formula_explain` |
| Graph node | `formula.adjusted.ppdispatcher.action.pp_formula_explain` |
| Kind | dispatcher_router |
