---
title: Formula — router · mca_search
type: formula
formula_id: formula.adjusted.devdispatcher.action.mca_search
...
| Field | Value |
|-------|-------|
| Name | `router · mca_search` |
| Graph node | `formula.adjusted.devdispatcher.action.mca_search` |
| Kind | dispatcher_router |
