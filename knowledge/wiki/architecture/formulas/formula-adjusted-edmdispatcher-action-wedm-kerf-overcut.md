---
title: Formula — router · wedm_kerf_overcut
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_kerf_overcut
...
# Formula — `router · wedm_kerf_overcut`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_kerf_overcut` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_kerf_overcut` |
| Kind | dispatcher_router |
