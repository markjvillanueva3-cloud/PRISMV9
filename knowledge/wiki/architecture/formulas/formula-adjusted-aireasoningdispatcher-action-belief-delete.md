---
title: Formula — router · belief_delete
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.belief_delete
...
| Field | Value |
|-------|-------|
| Name | `router · belief_delete` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.belief_delete` |
| Kind | dispatcher_router |
