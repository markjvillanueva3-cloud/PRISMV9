---
title: Formula — router · wear_analyze
type: formula
formula_id: formula.adjusted.camdispatcher.action.wear_analyze
...
| Field | Value |
|-------|-------|
| Name | `router · wear_analyze` |
| Graph node | `formula.adjusted.camdispatcher.action.wear_analyze` |
| Kind | dispatcher_router |
