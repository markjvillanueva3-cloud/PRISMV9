---
title: Formula — router · maintenance_plan
type: formula
formula_id: formula.adjusted.calcdispatcher.action.maintenance_plan
...
# Formula — `router · maintenance_plan`
...
| Field | Value |
|-------|-------|
| Name | `router · maintenance_plan` |
| Graph node | `formula.adjusted.calcdispatcher.action.maintenance_plan` |
| Kind | dispatcher_router |
