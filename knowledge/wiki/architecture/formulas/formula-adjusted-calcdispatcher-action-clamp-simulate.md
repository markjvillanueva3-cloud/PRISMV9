---
title: Formula — router · clamp_simulate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.clamp_simulate
...
| Field | Value |
|-------|-------|
| Name | `router · clamp_simulate` |
| Graph node | `formula.adjusted.calcdispatcher.action.clamp_simulate` |
| Kind | dispatcher_router |
