---
title: Formula — router · nx_ai_orchestrate
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_ai_orchestrate
...
# Formula — `router · nx_ai_orchestrate`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_ai_orchestrate` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_ai_orchestrate` |
| Kind | dispatcher_router |
