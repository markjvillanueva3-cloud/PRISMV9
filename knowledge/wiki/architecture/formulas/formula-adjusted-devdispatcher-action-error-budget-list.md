---
title: Formula — router · error_budget_list
type: formula
formula_id: formula.adjusted.devdispatcher.action.error_budget_list
...
# Formula — `router · error_budget_list`
...
| Field | Value |
|-------|-------|
| Name | `router · error_budget_list` |
| Graph node | `formula.adjusted.devdispatcher.action.error_budget_list` |
| Kind | dispatcher_router |
