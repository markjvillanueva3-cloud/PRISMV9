---
title: Formula — router · cam_systems
type: formula
formula_id: formula.adjusted.integrationdispatcher.action.cam_systems
...
| Field | Value |
|-------|-------|
| Name | `router · cam_systems` |
| Graph node | `formula.adjusted.integrationdispatcher.action.cam_systems` |
| Kind | dispatcher_router |
