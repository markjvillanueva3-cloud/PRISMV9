---
title: Formula — router · vcm_queue
type: formula
formula_id: formula.adjusted.devdispatcher.action.vcm_queue
...
| Field | Value |
|-------|-------|
| Name | `router · vcm_queue` |
| Graph node | `formula.adjusted.devdispatcher.action.vcm_queue` |
| Kind | dispatcher_router |
