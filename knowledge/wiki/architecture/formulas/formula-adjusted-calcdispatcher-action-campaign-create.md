---
title: Formula — router · campaign_create
type: formula
formula_id: formula.adjusted.calcdispatcher.action.campaign_create
...
# Formula — `router · campaign_create`
...
| Field | Value |
|-------|-------|
| Name | `router · campaign_create` |
| Graph node | `formula.adjusted.calcdispatcher.action.campaign_create` |
| Kind | dispatcher_router |
