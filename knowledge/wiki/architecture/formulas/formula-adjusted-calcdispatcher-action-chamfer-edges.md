---
title: Formula — router · chamfer_edges
type: formula
formula_id: formula.adjusted.calcdispatcher.action.chamfer_edges
...
| Field | Value |
|-------|-------|
| Name | `router · chamfer_edges` |
| Graph node | `formula.adjusted.calcdispatcher.action.chamfer_edges` |
| Kind | dispatcher_router |
