---
title: Formula — router · troubleshoot_start
type: formula
formula_id: formula.adjusted.calcdispatcher.action.troubleshoot_start
...
# Formula — `router · troubleshoot_start`
...
| Field | Value |
|-------|-------|
| Name | `router · troubleshoot_start` |
| Graph node | `formula.adjusted.calcdispatcher.action.troubleshoot_start` |
| Kind | dispatcher_router |
