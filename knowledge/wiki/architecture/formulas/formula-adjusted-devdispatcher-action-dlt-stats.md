---
title: Formula — router · dlt_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.dlt_stats
...
| Field | Value |
|-------|-------|
| Name | `router · dlt_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.dlt_stats` |
| Kind | dispatcher_router |
