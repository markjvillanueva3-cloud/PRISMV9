---
title: Formula — router · moonshot_invoke
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.moonshot_invoke
...
# Formula — `router · moonshot_invoke`
...
| Field | Value |
|-------|-------|
| Name | `router · moonshot_invoke` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.moonshot_invoke` |
| Kind | dispatcher_router |
