---
title: Formula — router · jss_critical_path
type: formula
formula_id: formula.adjusted.devdispatcher.action.jss_critical_path
...
# Formula — `router · jss_critical_path`
...
| Field | Value |
|-------|-------|
| Name | `router · jss_critical_path` |
| Graph node | `formula.adjusted.devdispatcher.action.jss_critical_path` |
| Kind | dispatcher_router |
