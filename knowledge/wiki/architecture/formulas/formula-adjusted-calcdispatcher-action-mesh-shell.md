---
title: Formula — router · mesh_shell
type: formula
formula_id: formula.adjusted.calcdispatcher.action.mesh_shell
...
| Field | Value |
|-------|-------|
| Name | `router · mesh_shell` |
| Graph node | `formula.adjusted.calcdispatcher.action.mesh_shell` |
| Kind | dispatcher_router |
