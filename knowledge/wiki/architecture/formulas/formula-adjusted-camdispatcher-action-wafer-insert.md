---
title: Formula — router · wafer_insert
type: formula
formula_id: formula.adjusted.camdispatcher.action.wafer_insert
...
| Field | Value |
|-------|-------|
| Name | `router · wafer_insert` |
| Graph node | `formula.adjusted.camdispatcher.action.wafer_insert` |
| Kind | dispatcher_router |
