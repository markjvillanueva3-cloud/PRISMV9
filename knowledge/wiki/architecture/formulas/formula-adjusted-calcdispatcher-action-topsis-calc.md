---
title: Formula — router · topsis_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.topsis_calc
...
| Field | Value |
|-------|-------|
| Name | `router · topsis_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.topsis_calc` |
| Kind | dispatcher_router |
