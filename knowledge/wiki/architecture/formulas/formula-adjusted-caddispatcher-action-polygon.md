---
title: Formula — router · polygon
type: formula
formula_id: formula.adjusted.caddispatcher.action.polygon
...
|-------|-------|
| Name | `router · polygon` |
| Graph node | `formula.adjusted.caddispatcher.action.polygon` |
| Kind | dispatcher_router |
