---
title: Formula — router · gcode_envelope
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gcode_envelope
...
| Field | Value |
|-------|-------|
| Name | `router · gcode_envelope` |
| Graph node | `formula.adjusted.calcdispatcher.action.gcode_envelope` |
| Kind | dispatcher_router |
