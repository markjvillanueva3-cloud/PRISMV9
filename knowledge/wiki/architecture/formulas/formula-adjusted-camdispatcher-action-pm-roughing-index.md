---
title: Formula — router · pm_roughing_index
type: formula
formula_id: formula.adjusted.camdispatcher.action.pm_roughing_index
...
# Formula — `router · pm_roughing_index`
...
| Field | Value |
|-------|-------|
| Name | `router · pm_roughing_index` |
| Graph node | `formula.adjusted.camdispatcher.action.pm_roughing_index` |
| Kind | dispatcher_router |
