---
title: Formula — router · strategy_kb_stats
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategy_kb_stats
...
# Formula — `router · strategy_kb_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_kb_stats` |
| Graph node | `formula.adjusted.camdispatcher.action.strategy_kb_stats` |
| Kind | dispatcher_router |
