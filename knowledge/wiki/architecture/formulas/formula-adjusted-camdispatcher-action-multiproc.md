---
title: Formula — router · multiProc
type: formula
formula_id: formula.adjusted.camdispatcher.action.multiproc
...
| Field | Value |
|-------|-------|
| Name | `router · multiProc` |
| Graph node | `formula.adjusted.camdispatcher.action.multiproc` |
| Kind | dispatcher_router |
