---
title: Formula — router · context_pressure
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.context_pressure
...
# Formula — `router · context_pressure`
...
| Field | Value |
|-------|-------|
| Name | `router · context_pressure` |
| Graph node | `formula.adjusted.sessiondispatcher.action.context_pressure` |
| Kind | dispatcher_router |
