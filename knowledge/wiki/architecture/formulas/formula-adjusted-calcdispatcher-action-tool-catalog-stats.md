---
title: Formula — router · tool_catalog_stats
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tool_catalog_stats
...
# Formula — `router · tool_catalog_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_catalog_stats` |
| Graph node | `formula.adjusted.calcdispatcher.action.tool_catalog_stats` |
| Kind | dispatcher_router |
