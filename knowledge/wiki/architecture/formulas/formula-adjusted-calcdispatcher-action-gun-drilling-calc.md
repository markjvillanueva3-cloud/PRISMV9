---
title: Formula — router · gun_drilling_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.gun_drilling_calc
...
# Formula — `router · gun_drilling_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · gun_drilling_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.gun_drilling_calc` |
| Kind | dispatcher_router |
