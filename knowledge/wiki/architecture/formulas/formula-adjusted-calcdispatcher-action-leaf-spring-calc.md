---
title: Formula — router · leaf_spring_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.leaf_spring_calc
...
# Formula — `router · leaf_spring_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · leaf_spring_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.leaf_spring_calc` |
| Kind | dispatcher_router |
