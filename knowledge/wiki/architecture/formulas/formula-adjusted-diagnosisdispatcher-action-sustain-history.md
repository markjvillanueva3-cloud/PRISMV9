---
title: Formula — router · sustain_history
type: formula
formula_id: formula.adjusted.diagnosisdispatcher.action.sustain_history
...
# Formula — `router · sustain_history`
...
| Field | Value |
|-------|-------|
| Name | `router · sustain_history` |
| Graph node | `formula.adjusted.diagnosisdispatcher.action.sustain_history` |
| Kind | dispatcher_router |
