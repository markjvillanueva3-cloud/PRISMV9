---
title: Formula — router · tubeForm
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.tubeform
...
| Field | Value |
|-------|-------|
| Name | `router · tubeForm` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.tubeform` |
| Kind | dispatcher_router |
