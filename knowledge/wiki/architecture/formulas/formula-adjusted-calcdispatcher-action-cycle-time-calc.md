---
title: Formula — router · cycle_time_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cycle_time_calc
...
# Formula — `router · cycle_time_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · cycle_time_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.cycle_time_calc` |
| Kind | dispatcher_router |
