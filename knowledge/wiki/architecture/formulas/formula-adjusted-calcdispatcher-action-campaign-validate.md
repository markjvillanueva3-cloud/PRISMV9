---
title: Formula — router · campaign_validate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.campaign_validate
...
# Formula — `router · campaign_validate`
...
| Field | Value |
|-------|-------|
| Name | `router · campaign_validate` |
| Graph node | `formula.adjusted.calcdispatcher.action.campaign_validate` |
| Kind | dispatcher_router |
