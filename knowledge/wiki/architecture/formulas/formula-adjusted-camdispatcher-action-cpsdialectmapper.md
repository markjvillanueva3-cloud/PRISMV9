---
title: Formula — router · cpsDialectMapper
type: formula
formula_id: formula.adjusted.camdispatcher.action.cpsdialectmapper
...
# Formula — `router · cpsDialectMapper`
...
| Field | Value |
|-------|-------|
| Name | `router · cpsDialectMapper` |
| Graph node | `formula.adjusted.camdispatcher.action.cpsdialectmapper` |
| Kind | dispatcher_router |
