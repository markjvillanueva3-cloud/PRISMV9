---
title: Formula — router · box_parse_wedm
type: formula
formula_id: formula.adjusted.datadispatcher.action.box_parse_wedm
...
| Field | Value |
|-------|-------|
| Name | `router · box_parse_wedm` |
| Graph node | `formula.adjusted.datadispatcher.action.box_parse_wedm` |
| Kind | dispatcher_router |
