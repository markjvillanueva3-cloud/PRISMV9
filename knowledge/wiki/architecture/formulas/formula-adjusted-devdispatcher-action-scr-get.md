---
title: Formula — router · scr_get
type: formula
formula_id: formula.adjusted.devdispatcher.action.scr_get
...
|-------|-------|
| Name | `router · scr_get` |
| Graph node | `formula.adjusted.devdispatcher.action.scr_get` |
| Kind | dispatcher_router |
