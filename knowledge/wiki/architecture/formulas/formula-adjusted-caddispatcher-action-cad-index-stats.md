---
title: Formula — router · cad_index_stats
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_index_stats
...
# Formula — `router · cad_index_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_index_stats` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_index_stats` |
| Kind | dispatcher_router |
