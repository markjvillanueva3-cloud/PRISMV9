---
title: Formula — router · hr_review_create
type: formula
formula_id: formula.adjusted.businessdispatcher.action.hr_review_create
...
# Formula — `router · hr_review_create`
...
| Field | Value |
|-------|-------|
| Name | `router · hr_review_create` |
| Graph node | `formula.adjusted.businessdispatcher.action.hr_review_create` |
| Kind | dispatcher_router |
