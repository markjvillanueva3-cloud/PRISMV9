---
title: Formula — router · kde_estimate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.kde_estimate
...
| Field | Value |
|-------|-------|
| Name | `router · kde_estimate` |
| Graph node | `formula.adjusted.calcdispatcher.action.kde_estimate` |
| Kind | dispatcher_router |
