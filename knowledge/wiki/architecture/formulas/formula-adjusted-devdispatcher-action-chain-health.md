---
title: Formula — router · chain_health
type: formula
formula_id: formula.adjusted.devdispatcher.action.chain_health
...
| Field | Value |
|-------|-------|
| Name | `router · chain_health` |
| Graph node | `formula.adjusted.devdispatcher.action.chain_health` |
| Kind | dispatcher_router |
