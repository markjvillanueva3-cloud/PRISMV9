---
title: Formula — router · wip_restore
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.wip_restore
...
| Field | Value |
|-------|-------|
| Name | `router · wip_restore` |
| Graph node | `formula.adjusted.sessiondispatcher.action.wip_restore` |
| Kind | dispatcher_router |
