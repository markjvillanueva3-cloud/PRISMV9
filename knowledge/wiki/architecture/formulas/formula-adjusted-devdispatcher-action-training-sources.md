---
title: Formula — router · training_sources
type: formula
formula_id: formula.adjusted.devdispatcher.action.training_sources
...
# Formula — `router · training_sources`
...
| Field | Value |
|-------|-------|
| Name | `router · training_sources` |
| Graph node | `formula.adjusted.devdispatcher.action.training_sources` |
| Kind | dispatcher_router |
