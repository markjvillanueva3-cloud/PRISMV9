---
title: Formula — router · mastercam_op_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.mastercam_op_list
...
# Formula — `router · mastercam_op_list`
...
| Field | Value |
|-------|-------|
| Name | `router · mastercam_op_list` |
| Graph node | `formula.adjusted.camdispatcher.action.mastercam_op_list` |
| Kind | dispatcher_router |
