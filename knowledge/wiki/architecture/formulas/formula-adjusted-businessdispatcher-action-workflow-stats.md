---
title: Formula — router · workflow_stats
type: formula
formula_id: formula.adjusted.businessdispatcher.action.workflow_stats
...
| Field | Value |
|-------|-------|
| Name | `router · workflow_stats` |
| Graph node | `formula.adjusted.businessdispatcher.action.workflow_stats` |
| Kind | dispatcher_router |
