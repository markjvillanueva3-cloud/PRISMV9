---
title: Formula — router · post_verify_safety
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_verify_safety
...
# Formula — `router · post_verify_safety`
...
| Field | Value |
|-------|-------|
| Name | `router · post_verify_safety` |
| Graph node | `formula.adjusted.camdispatcher.action.post_verify_safety` |
| Kind | dispatcher_router |
