---
title: Formula — router · cam_ext_flagship
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_ext_flagship
...
# Formula — `router · cam_ext_flagship`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_ext_flagship` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_ext_flagship` |
| Kind | dispatcher_router |
