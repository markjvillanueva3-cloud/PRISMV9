---
title: Formula — router · stepover
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stepover
...
| Field | Value |
|-------|-------|
| Name | `router · stepover` |
| Graph node | `formula.adjusted.calcdispatcher.action.stepover` |
| Kind | dispatcher_router |
