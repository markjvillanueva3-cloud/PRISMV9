---
title: Formula — router · mastercamStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.mastercamstrategy
...
# Formula — `router · mastercamStrategy`
...
| Field | Value |
|-------|-------|
| Name | `router · mastercamStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.mastercamstrategy` |
| Kind | dispatcher_router |
