---
title: Formula — router · transfer_gp
type: formula
formula_id: formula.adjusted.calcdispatcher.action.transfer_gp
...
| Field | Value |
|-------|-------|
| Name | `router · transfer_gp` |
| Graph node | `formula.adjusted.calcdispatcher.action.transfer_gp` |
| Kind | dispatcher_router |
