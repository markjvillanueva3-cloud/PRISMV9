---
title: Formula — router · printToHyperMill
type: formula
formula_id: formula.adjusted.camdispatcher.action.printtohypermill
...
# Formula — `router · printToHyperMill`
...
| Field | Value |
|-------|-------|
| Name | `router · printToHyperMill` |
| Graph node | `formula.adjusted.camdispatcher.action.printtohypermill` |
| Kind | dispatcher_router |
