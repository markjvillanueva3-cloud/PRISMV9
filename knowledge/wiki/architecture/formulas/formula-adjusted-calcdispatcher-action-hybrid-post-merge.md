---
title: Formula — router · hybrid_post_merge
type: formula
formula_id: formula.adjusted.calcdispatcher.action.hybrid_post_merge
...
# Formula — `router · hybrid_post_merge`
...
| Field | Value |
|-------|-------|
| Name | `router · hybrid_post_merge` |
| Graph node | `formula.adjusted.calcdispatcher.action.hybrid_post_merge` |
| Kind | dispatcher_router |
