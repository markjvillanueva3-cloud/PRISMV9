---
title: Formula — router · nxCAMAddInGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcamaddingen
...
| Field | Value |
|-------|-------|
| Name | `router · nxCAMAddInGen` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcamaddingen` |
| Kind | dispatcher_router |
