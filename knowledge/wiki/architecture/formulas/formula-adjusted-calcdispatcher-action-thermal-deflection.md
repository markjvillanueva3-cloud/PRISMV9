---
title: Formula — router · thermal_deflection
type: formula
formula_id: formula.adjusted.calcdispatcher.action.thermal_deflection
...
# Formula — `router · thermal_deflection`
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_deflection` |
| Graph node | `formula.adjusted.calcdispatcher.action.thermal_deflection` |
| Kind | dispatcher_router |
