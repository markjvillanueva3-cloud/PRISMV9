---
title: Formula — router · qif_import_plan
type: formula
formula_id: formula.adjusted.camdispatcher.action.qif_import_plan
...
# Formula — `router · qif_import_plan`
...
| Field | Value |
|-------|-------|
| Name | `router · qif_import_plan` |
| Graph node | `formula.adjusted.camdispatcher.action.qif_import_plan` |
| Kind | dispatcher_router |
