---
title: Formula — router · bobCADStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.bobcadstrategy
...
| Field | Value |
|-------|-------|
| Name | `router · bobCADStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.bobcadstrategy` |
| Kind | dispatcher_router |
