---
title: Formula — router · nesting_optimize
type: formula
formula_id: formula.adjusted.camdispatcher.action.nesting_optimize
...
# Formula — `router · nesting_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · nesting_optimize` |
| Graph node | `formula.adjusted.camdispatcher.action.nesting_optimize` |
| Kind | dispatcher_router |
