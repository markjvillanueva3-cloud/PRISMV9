---
title: Formula — router · list_recent_ticks
type: formula
formula_id: formula.adjusted.devdispatcher.action.list_recent_ticks
...
# Formula — `router · list_recent_ticks`
...
| Field | Value |
|-------|-------|
| Name | `router · list_recent_ticks` |
| Graph node | `formula.adjusted.devdispatcher.action.list_recent_ticks` |
| Kind | dispatcher_router |
