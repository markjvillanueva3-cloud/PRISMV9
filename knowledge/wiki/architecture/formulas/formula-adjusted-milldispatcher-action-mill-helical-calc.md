---
title: Formula — router · mill_helical_calc
type: formula
formula_id: formula.adjusted.milldispatcher.action.mill_helical_calc
...
# Formula — `router · mill_helical_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · mill_helical_calc` |
| Graph node | `formula.adjusted.milldispatcher.action.mill_helical_calc` |
| Kind | dispatcher_router |
