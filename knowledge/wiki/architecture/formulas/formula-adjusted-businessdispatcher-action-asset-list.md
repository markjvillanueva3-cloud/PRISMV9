---
title: Formula — router · asset_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.asset_list
...
| Field | Value |
|-------|-------|
| Name | `router · asset_list` |
| Graph node | `formula.adjusted.businessdispatcher.action.asset_list` |
| Kind | dispatcher_router |
