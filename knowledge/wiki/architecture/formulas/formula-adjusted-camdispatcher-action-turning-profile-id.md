---
title: Formula — router · turning_profile_id
type: formula
formula_id: formula.adjusted.camdispatcher.action.turning_profile_id
...
# Formula — `router · turning_profile_id`
...
| Field | Value |
|-------|-------|
| Name | `router · turning_profile_id` |
| Graph node | `formula.adjusted.camdispatcher.action.turning_profile_id` |
| Kind | dispatcher_router |
