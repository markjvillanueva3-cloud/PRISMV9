---
title: Formula — router · postDownload
type: formula
formula_id: formula.adjusted.camdispatcher.action.postdownload
...
| Field | Value |
|-------|-------|
| Name | `router · postDownload` |
| Graph node | `formula.adjusted.camdispatcher.action.postdownload` |
| Kind | dispatcher_router |
