---
title: Formula — router · pgh_is_quarantined
type: formula
formula_id: formula.adjusted.devdispatcher.action.pgh_is_quarantined
...
# Formula — `router · pgh_is_quarantined`
...
| Field | Value |
|-------|-------|
| Name | `router · pgh_is_quarantined` |
| Graph node | `formula.adjusted.devdispatcher.action.pgh_is_quarantined` |
| Kind | dispatcher_router |
