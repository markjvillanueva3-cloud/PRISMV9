---
title: Formula — router · pgh_list_golden
type: formula
formula_id: formula.adjusted.devdispatcher.action.pgh_list_golden
...
# Formula — `router · pgh_list_golden`
...
| Field | Value |
|-------|-------|
| Name | `router · pgh_list_golden` |
| Graph node | `formula.adjusted.devdispatcher.action.pgh_list_golden` |
| Kind | dispatcher_router |
