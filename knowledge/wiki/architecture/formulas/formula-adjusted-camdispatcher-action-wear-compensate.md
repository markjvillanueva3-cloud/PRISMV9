---
title: Formula — router · wear_compensate
type: formula
formula_id: formula.adjusted.camdispatcher.action.wear_compensate
...
# Formula — `router · wear_compensate`
...
| Field | Value |
|-------|-------|
| Name | `router · wear_compensate` |
| Graph node | `formula.adjusted.camdispatcher.action.wear_compensate` |
| Kind | dispatcher_router |
