---
title: Formula — router · wpn_get_prototypes
type: formula
formula_id: formula.adjusted.devdispatcher.action.wpn_get_prototypes
...
# Formula — `router · wpn_get_prototypes`
...
| Field | Value |
|-------|-------|
| Name | `router · wpn_get_prototypes` |
| Graph node | `formula.adjusted.devdispatcher.action.wpn_get_prototypes` |
| Kind | dispatcher_router |
