---
title: Formula — router · permission_check
type: formula
formula_id: formula.adjusted.authdispatcher.action.permission_check
...
# Formula — `router · permission_check`
...
| Field | Value |
|-------|-------|
| Name | `router · permission_check` |
| Graph node | `formula.adjusted.authdispatcher.action.permission_check` |
| Kind | dispatcher_router |
