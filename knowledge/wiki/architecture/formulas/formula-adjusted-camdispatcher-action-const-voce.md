---
title: Formula — router · const_voce
type: formula
formula_id: formula.adjusted.camdispatcher.action.const_voce
...
| Field | Value |
|-------|-------|
| Name | `router · const_voce` |
| Graph node | `formula.adjusted.camdispatcher.action.const_voce` |
| Kind | dispatcher_router |
