---
title: Formula — router · cps_map_dialect
type: formula
formula_id: formula.adjusted.camdispatcher.action.cps_map_dialect
...
# Formula — `router · cps_map_dialect`
...
| Field | Value |
|-------|-------|
| Name | `router · cps_map_dialect` |
| Graph node | `formula.adjusted.camdispatcher.action.cps_map_dialect` |
| Kind | dispatcher_router |
