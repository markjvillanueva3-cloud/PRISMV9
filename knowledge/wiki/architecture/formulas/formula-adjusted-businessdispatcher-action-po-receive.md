---
title: Formula — router · po_receive
type: formula
formula_id: formula.adjusted.businessdispatcher.action.po_receive
...
| Field | Value |
|-------|-------|
| Name | `router · po_receive` |
| Graph node | `formula.adjusted.businessdispatcher.action.po_receive` |
| Kind | dispatcher_router |
