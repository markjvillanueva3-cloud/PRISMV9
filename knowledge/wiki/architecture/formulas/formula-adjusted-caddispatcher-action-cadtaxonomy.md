---
title: Formula — router · cadTaxonomy
type: formula
formula_id: formula.adjusted.caddispatcher.action.cadtaxonomy
...
| Field | Value |
|-------|-------|
| Name | `router · cadTaxonomy` |
| Graph node | `formula.adjusted.caddispatcher.action.cadtaxonomy` |
| Kind | dispatcher_router |
