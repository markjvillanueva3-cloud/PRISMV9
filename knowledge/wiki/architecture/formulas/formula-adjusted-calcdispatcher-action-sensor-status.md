---
title: Formula — router · sensor_status
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sensor_status
...
| Field | Value |
|-------|-------|
| Name | `router · sensor_status` |
| Graph node | `formula.adjusted.calcdispatcher.action.sensor_status` |
| Kind | dispatcher_router |
