---
title: Formula — router · pcr_restore
type: formula
formula_id: formula.adjusted.devdispatcher.action.pcr_restore
...
| Field | Value |
|-------|-------|
| Name | `router · pcr_restore` |
| Graph node | `formula.adjusted.devdispatcher.action.pcr_restore` |
| Kind | dispatcher_router |
