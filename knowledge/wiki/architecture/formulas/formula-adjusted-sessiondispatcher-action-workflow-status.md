---
title: Formula — router · workflow_status
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.workflow_status
...
# Formula — `router · workflow_status`
...
| Field | Value |
|-------|-------|
| Name | `router · workflow_status` |
| Graph node | `formula.adjusted.sessiondispatcher.action.workflow_status` |
| Kind | dispatcher_router |
