---
title: Formula — router · auth_health
type: formula
formula_id: formula.adjusted.infradispatcher.action.auth_health
...
| Field | Value |
|-------|-------|
| Name | `router · auth_health` |
| Graph node | `formula.adjusted.infradispatcher.action.auth_health` |
| Kind | dispatcher_router |
