---
title: Formula — router · bore_finishing
type: formula
formula_id: formula.adjusted.calcdispatcher.action.bore_finishing
...
| Field | Value |
|-------|-------|
| Name | `router · bore_finishing` |
| Graph node | `formula.adjusted.calcdispatcher.action.bore_finishing` |
| Kind | dispatcher_router |
