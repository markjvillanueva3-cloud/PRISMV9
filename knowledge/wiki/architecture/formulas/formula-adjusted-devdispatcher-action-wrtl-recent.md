---
title: Formula — router · wrtl_recent
type: formula
formula_id: formula.adjusted.devdispatcher.action.wrtl_recent
...
| Field | Value |
|-------|-------|
| Name | `router · wrtl_recent` |
| Graph node | `formula.adjusted.devdispatcher.action.wrtl_recent` |
| Kind | dispatcher_router |
