---
title: Formula — router · post_ab_compare
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_ab_compare
...
# Formula — `router · post_ab_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · post_ab_compare` |
| Graph node | `formula.adjusted.camdispatcher.action.post_ab_compare` |
| Kind | dispatcher_router |
