---
title: Formula — router · acc_ball_bar
type: formula
formula_id: formula.adjusted.camdispatcher.action.acc_ball_bar
...
| Field | Value |
|-------|-------|
| Name | `router · acc_ball_bar` |
| Graph node | `formula.adjusted.camdispatcher.action.acc_ball_bar` |
| Kind | dispatcher_router |
