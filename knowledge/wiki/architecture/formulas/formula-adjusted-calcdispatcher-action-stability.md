---
title: Formula — router · stability
type: formula
formula_id: formula.adjusted.calcdispatcher.action.stability
...
| Field | Value |
|-------|-------|
| Name | `router · stability` |
| Graph node | `formula.adjusted.calcdispatcher.action.stability` |
| Kind | dispatcher_router |
