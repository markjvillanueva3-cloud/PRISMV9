---
title: Formula — router · corner_feed_adjust
type: formula
formula_id: formula.adjusted.calcdispatcher.action.corner_feed_adjust
...
# Formula — `router · corner_feed_adjust`
...
| Field | Value |
|-------|-------|
| Name | `router · corner_feed_adjust` |
| Graph node | `formula.adjusted.calcdispatcher.action.corner_feed_adjust` |
| Kind | dispatcher_router |
