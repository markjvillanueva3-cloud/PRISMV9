---
title: Formula — router · me_status
type: formula
formula_id: formula.adjusted.devdispatcher.action.me_status
...
| Field | Value |
|-------|-------|
| Name | `router · me_status` |
| Graph node | `formula.adjusted.devdispatcher.action.me_status` |
| Kind | dispatcher_router |
