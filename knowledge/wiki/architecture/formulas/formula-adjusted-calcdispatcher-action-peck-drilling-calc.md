---
title: Formula — router · peck_drilling_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.peck_drilling_calc
...
# Formula — `router · peck_drilling_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · peck_drilling_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.peck_drilling_calc` |
| Kind | dispatcher_router |
