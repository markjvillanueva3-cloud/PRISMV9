---
title: Formula — router · powerMillAddInGen
type: formula
formula_id: formula.adjusted.camdispatcher.action.powermilladdingen
...
# Formula — `router · powerMillAddInGen`
...
| Field | Value |
|-------|-------|
| Name | `router · powerMillAddInGen` |
| Graph node | `formula.adjusted.camdispatcher.action.powermilladdingen` |
| Kind | dispatcher_router |
