---
title: Formula — router · strategy_kb_best
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategy_kb_best
...
# Formula — `router · strategy_kb_best`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_kb_best` |
| Graph node | `formula.adjusted.camdispatcher.action.strategy_kb_best` |
| Kind | dispatcher_router |
