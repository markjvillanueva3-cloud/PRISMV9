---
title: Formula — router · poll_one
type: formula
formula_id: formula.adjusted.devdispatcher.action.poll_one
...
| Field | Value |
|-------|-------|
| Name | `router · poll_one` |
| Graph node | `formula.adjusted.devdispatcher.action.poll_one` |
| Kind | dispatcher_router |
