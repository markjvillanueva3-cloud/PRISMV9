---
title: Formula — router · blisk_validate
type: formula
formula_id: formula.adjusted.caddispatcher.action.blisk_validate
...
| Field | Value |
|-------|-------|
| Name | `router · blisk_validate` |
| Graph node | `formula.adjusted.caddispatcher.action.blisk_validate` |
| Kind | dispatcher_router |
