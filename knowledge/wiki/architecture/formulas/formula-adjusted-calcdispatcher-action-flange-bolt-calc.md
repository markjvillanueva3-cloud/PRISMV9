---
title: Formula — router · flange_bolt_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.flange_bolt_calc
...
# Formula — `router · flange_bolt_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · flange_bolt_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.flange_bolt_calc` |
| Kind | dispatcher_router |
