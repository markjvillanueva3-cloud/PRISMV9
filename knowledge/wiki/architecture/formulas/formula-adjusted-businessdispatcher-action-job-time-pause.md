---
title: Formula — router · job_time_pause
type: formula
formula_id: formula.adjusted.businessdispatcher.action.job_time_pause
...
| Field | Value |
|-------|-------|
| Name | `router · job_time_pause` |
| Graph node | `formula.adjusted.businessdispatcher.action.job_time_pause` |
| Kind | dispatcher_router |
