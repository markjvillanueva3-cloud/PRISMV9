---
title: Formula — router · fiveAxis
type: formula
formula_id: formula.adjusted.camdispatcher.action.fiveaxis
...
| Field | Value |
|-------|-------|
| Name | `router · fiveAxis` |
| Graph node | `formula.adjusted.camdispatcher.action.fiveaxis` |
| Kind | dispatcher_router |
