---
title: Formula — router · anchor_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.anchor_stats
...
| Field | Value |
|-------|-------|
| Name | `router · anchor_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.anchor_stats` |
| Kind | dispatcher_router |
