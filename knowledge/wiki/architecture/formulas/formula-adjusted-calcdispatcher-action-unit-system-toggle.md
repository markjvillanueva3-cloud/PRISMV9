---
title: Formula — router · unit_system_toggle
type: formula
formula_id: formula.adjusted.calcdispatcher.action.unit_system_toggle
...
# Formula — `router · unit_system_toggle`
...
| Field | Value |
|-------|-------|
| Name | `router · unit_system_toggle` |
| Graph node | `formula.adjusted.calcdispatcher.action.unit_system_toggle` |
| Kind | dispatcher_router |
