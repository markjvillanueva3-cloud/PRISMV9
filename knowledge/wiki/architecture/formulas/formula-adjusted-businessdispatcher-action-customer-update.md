---
title: Formula — router · customer_update
type: formula
formula_id: formula.adjusted.businessdispatcher.action.customer_update
...
# Formula — `router · customer_update`
...
| Field | Value |
|-------|-------|
| Name | `router · customer_update` |
| Graph node | `formula.adjusted.businessdispatcher.action.customer_update` |
| Kind | dispatcher_router |
