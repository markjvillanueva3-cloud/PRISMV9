---
title: Formula — router · countersink_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.countersink_calc
...
# Formula — `router · countersink_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · countersink_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.countersink_calc` |
| Kind | dispatcher_router |
