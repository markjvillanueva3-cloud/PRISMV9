---
title: Formula — router · assembly_create
type: formula
formula_id: formula.adjusted.caddispatcher.action.assembly_create
...
# Formula — `router · assembly_create`
...
| Field | Value |
|-------|-------|
| Name | `router · assembly_create` |
| Graph node | `formula.adjusted.caddispatcher.action.assembly_create` |
| Kind | dispatcher_router |
