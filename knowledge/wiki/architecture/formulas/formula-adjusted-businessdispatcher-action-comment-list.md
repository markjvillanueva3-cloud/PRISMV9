---
title: Formula — router · comment_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.comment_list
...
| Field | Value |
|-------|-------|
| Name | `router · comment_list` |
| Graph node | `formula.adjusted.businessdispatcher.action.comment_list` |
| Kind | dispatcher_router |
