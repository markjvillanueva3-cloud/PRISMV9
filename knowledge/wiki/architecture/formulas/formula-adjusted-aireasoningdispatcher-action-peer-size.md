---
title: Formula — router · peer_size
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.peer_size
...
| Field | Value |
|-------|-------|
| Name | `router · peer_size` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.peer_size` |
| Kind | dispatcher_router |
