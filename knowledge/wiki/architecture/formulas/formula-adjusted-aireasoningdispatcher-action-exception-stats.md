---
title: Formula — router · exception_stats
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.exception_stats
...
# Formula — `router · exception_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · exception_stats` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.exception_stats` |
| Kind | dispatcher_router |
