---
title: Formula — router · edm_uncertainty
type: formula
formula_id: formula.adjusted.camdispatcher.action.edm_uncertainty
...
# Formula — `router · edm_uncertainty`
...
| Field | Value |
|-------|-------|
| Name | `router · edm_uncertainty` |
| Graph node | `formula.adjusted.camdispatcher.action.edm_uncertainty` |
| Kind | dispatcher_router |
