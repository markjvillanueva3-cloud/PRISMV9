---
title: Formula — router · powerMillMatBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.powermillmatbridge
...
# Formula — `router · powerMillMatBridge`
...
| Field | Value |
|-------|-------|
| Name | `router · powerMillMatBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.powermillmatbridge` |
| Kind | dispatcher_router |
