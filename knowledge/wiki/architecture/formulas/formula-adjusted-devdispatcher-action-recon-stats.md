---
title: Formula — router · recon_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.recon_stats
...
| Field | Value |
|-------|-------|
| Name | `router · recon_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.recon_stats` |
| Kind | dispatcher_router |
