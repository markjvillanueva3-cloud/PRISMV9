---
title: Formula — router · ppg_prove_out
type: formula
formula_id: formula.adjusted.camdispatcher.action.ppg_prove_out
...
| Field | Value |
|-------|-------|
| Name | `router · ppg_prove_out` |
| Graph node | `formula.adjusted.camdispatcher.action.ppg_prove_out` |
| Kind | dispatcher_router |
