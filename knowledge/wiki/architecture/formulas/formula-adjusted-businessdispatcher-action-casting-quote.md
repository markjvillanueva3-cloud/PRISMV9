---
title: Formula — router · casting_quote
type: formula
formula_id: formula.adjusted.businessdispatcher.action.casting_quote
...
| Field | Value |
|-------|-------|
| Name | `router · casting_quote` |
| Graph node | `formula.adjusted.businessdispatcher.action.casting_quote` |
| Kind | dispatcher_router |
