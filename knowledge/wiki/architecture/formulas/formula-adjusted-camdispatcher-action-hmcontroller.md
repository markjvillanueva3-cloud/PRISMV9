---
title: Formula — router · hmController
type: formula
formula_id: formula.adjusted.camdispatcher.action.hmcontroller
...
| Field | Value |
|-------|-------|
| Name | `router · hmController` |
| Graph node | `formula.adjusted.camdispatcher.action.hmcontroller` |
| Kind | dispatcher_router |
