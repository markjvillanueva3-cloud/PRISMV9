---
title: Formula — router · vcm_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.vcm_summary
...
| Field | Value |
|-------|-------|
| Name | `router · vcm_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.vcm_summary` |
| Kind | dispatcher_router |
