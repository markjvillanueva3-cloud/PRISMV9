---
title: Formula — router · instant_quote
type: formula
formula_id: formula.adjusted.businessdispatcher.action.instant_quote
...
| Field | Value |
|-------|-------|
| Name | `router · instant_quote` |
| Graph node | `formula.adjusted.businessdispatcher.action.instant_quote` |
| Kind | dispatcher_router |
