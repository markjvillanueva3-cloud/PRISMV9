---
title: Formula — router · validate_entry
type: formula
formula_id: formula.adjusted.calcdispatcher.action.validate_entry
...
| Field | Value |
|-------|-------|
| Name | `router · validate_entry` |
| Graph node | `formula.adjusted.calcdispatcher.action.validate_entry` |
| Kind | dispatcher_router |
