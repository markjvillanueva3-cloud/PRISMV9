---
title: Formula — router · reorient_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.reorient_stats
...
| Field | Value |
|-------|-------|
| Name | `router · reorient_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.reorient_stats` |
| Kind | dispatcher_router |
