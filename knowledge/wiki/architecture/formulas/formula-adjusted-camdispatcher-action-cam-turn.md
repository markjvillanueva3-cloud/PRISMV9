---
title: Formula — router · cam_turn
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_turn
...
| Field | Value |
|-------|-------|
| Name | `router · cam_turn` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_turn` |
| Kind | dispatcher_router |
