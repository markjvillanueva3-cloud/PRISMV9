---
title: Formula — router · context_expand
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.context_expand
...
| Field | Value |
|-------|-------|
| Name | `router · context_expand` |
| Graph node | `formula.adjusted.sessiondispatcher.action.context_expand` |
| Kind | dispatcher_router |
