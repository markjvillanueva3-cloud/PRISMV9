---
title: Formula — router · sinker_calculate
type: formula
formula_id: formula.adjusted.edmdispatcher.action.sinker_calculate
...
# Formula — `router · sinker_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · sinker_calculate` |
| Graph node | `formula.adjusted.edmdispatcher.action.sinker_calculate` |
| Kind | dispatcher_router |
