---
title: Formula — router · keyway_stress_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.keyway_stress_calc
...
# Formula — `router · keyway_stress_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · keyway_stress_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.keyway_stress_calc` |
| Kind | dispatcher_router |
