---
title: Formula — router · wedm_estimate_time
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_estimate_time
...
# Formula — `router · wedm_estimate_time`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_estimate_time` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_estimate_time` |
| Kind | dispatcher_router |
