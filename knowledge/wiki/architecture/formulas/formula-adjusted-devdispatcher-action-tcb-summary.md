---
title: Formula — router · tcb_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.tcb_summary
...
| Field | Value |
|-------|-------|
| Name | `router · tcb_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.tcb_summary` |
| Kind | dispatcher_router |
