---
title: Formula — router · latheSFCalc
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathesfcalc
...
| Field | Value |
|-------|-------|
| Name | `router · latheSFCalc` |
| Graph node | `formula.adjusted.camdispatcher.action.lathesfcalc` |
| Kind | dispatcher_router |
