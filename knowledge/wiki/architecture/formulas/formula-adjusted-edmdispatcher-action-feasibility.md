---
title: Formula — router · feasibility
type: formula
formula_id: formula.adjusted.edmdispatcher.action.feasibility
...
| Field | Value |
|-------|-------|
| Name | `router · feasibility` |
| Graph node | `formula.adjusted.edmdispatcher.action.feasibility` |
| Kind | dispatcher_router |
