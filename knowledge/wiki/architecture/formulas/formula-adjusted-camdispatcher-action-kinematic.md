---
title: Formula — router · kinematic
type: formula
formula_id: formula.adjusted.camdispatcher.action.kinematic
...
| Field | Value |
|-------|-------|
| Name | `router · kinematic` |
| Graph node | `formula.adjusted.camdispatcher.action.kinematic` |
| Kind | dispatcher_router |
