---
title: Formula — router · po_create
type: formula
formula_id: formula.adjusted.businessdispatcher.action.po_create
...
| Field | Value |
|-------|-------|
| Name | `router · po_create` |
| Graph node | `formula.adjusted.businessdispatcher.action.po_create` |
| Kind | dispatcher_router |
