---
title: Formula — router · soldering_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.soldering_calc
...
| Field | Value |
|-------|-------|
| Name | `router · soldering_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.soldering_calc` |
| Kind | dispatcher_router |
