---
title: Formula — router · sustain_coolant
type: formula
formula_id: formula.adjusted.diagnosisdispatcher.action.sustain_coolant
...
# Formula — `router · sustain_coolant`
...
| Field | Value |
|-------|-------|
| Name | `router · sustain_coolant` |
| Graph node | `formula.adjusted.diagnosisdispatcher.action.sustain_coolant` |
| Kind | dispatcher_router |
