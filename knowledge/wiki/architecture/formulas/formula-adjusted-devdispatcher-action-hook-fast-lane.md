---
title: Formula — router · hook_fast_lane
type: formula
formula_id: formula.adjusted.devdispatcher.action.hook_fast_lane
...
| Field | Value |
|-------|-------|
| Name | `router · hook_fast_lane` |
| Graph node | `formula.adjusted.devdispatcher.action.hook_fast_lane` |
| Kind | dispatcher_router |
