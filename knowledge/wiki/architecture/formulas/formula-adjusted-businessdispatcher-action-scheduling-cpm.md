---
title: Formula — router · scheduling_cpm
type: formula
formula_id: formula.adjusted.businessdispatcher.action.scheduling_cpm
...
| Field | Value |
|-------|-------|
| Name | `router · scheduling_cpm` |
| Graph node | `formula.adjusted.businessdispatcher.action.scheduling_cpm` |
| Kind | dispatcher_router |
