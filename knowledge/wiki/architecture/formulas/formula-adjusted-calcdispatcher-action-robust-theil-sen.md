---
title: Formula — router · robust_theil_sen
type: formula
formula_id: formula.adjusted.calcdispatcher.action.robust_theil_sen
...
# Formula — `router · robust_theil_sen`
...
| Field | Value |
|-------|-------|
| Name | `router · robust_theil_sen` |
| Graph node | `formula.adjusted.calcdispatcher.action.robust_theil_sen` |
| Kind | dispatcher_router |
