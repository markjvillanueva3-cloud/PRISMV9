---
title: Formula — router · stats_gage_rr
type: formula
formula_id: formula.adjusted.camdispatcher.action.stats_gage_rr
...
| Field | Value |
|-------|-------|
| Name | `router · stats_gage_rr` |
| Graph node | `formula.adjusted.camdispatcher.action.stats_gage_rr` |
| Kind | dispatcher_router |
