---
title: Formula — router · lathe_bore_dwell
type: formula
formula_id: formula.adjusted.turningdispatcher.action.lathe_bore_dwell
...
# Formula — `router · lathe_bore_dwell`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_bore_dwell` |
| Graph node | `formula.adjusted.turningdispatcher.action.lathe_bore_dwell` |
| Kind | dispatcher_router |
