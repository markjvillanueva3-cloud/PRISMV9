---
title: Formula — router · toolChangeOpt
type: formula
formula_id: formula.adjusted.camdispatcher.action.toolchangeopt
...
| Field | Value |
|-------|-------|
| Name | `router · toolChangeOpt` |
| Graph node | `formula.adjusted.camdispatcher.action.toolchangeopt` |
| Kind | dispatcher_router |
