---
title: Formula — router · conv_budget_record
type: formula
formula_id: formula.adjusted.devdispatcher.action.conv_budget_record
...
# Formula — `router · conv_budget_record`
...
| Field | Value |
|-------|-------|
| Name | `router · conv_budget_record` |
| Graph node | `formula.adjusted.devdispatcher.action.conv_budget_record` |
| Kind | dispatcher_router |
