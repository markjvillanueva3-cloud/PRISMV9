---
title: Formula — router · gap_scan_batch
type: formula
formula_id: formula.adjusted.devdispatcher.action.gap_scan_batch
...
| Field | Value |
|-------|-------|
| Name | `router · gap_scan_batch` |
| Graph node | `formula.adjusted.devdispatcher.action.gap_scan_batch` |
| Kind | dispatcher_router |
