---
title: Formula — router · golden_section
type: formula
formula_id: formula.adjusted.calcdispatcher.action.golden_section
...
| Field | Value |
|-------|-------|
| Name | `router · golden_section` |
| Graph node | `formula.adjusted.calcdispatcher.action.golden_section` |
| Kind | dispatcher_router |
