---
title: Formula — router · printToInventorHSM
type: formula
formula_id: formula.adjusted.camdispatcher.action.printtoinventorhsm
...
# Formula — `router · printToInventorHSM`
...
| Field | Value |
|-------|-------|
| Name | `router · printToInventorHSM` |
| Graph node | `formula.adjusted.camdispatcher.action.printtoinventorhsm` |
| Kind | dispatcher_router |
