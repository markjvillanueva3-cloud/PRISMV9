---
title: Formula — router · sensor_simulate
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sensor_simulate
...
# Formula — `router · sensor_simulate`
...
| Field | Value |
|-------|-------|
| Name | `router · sensor_simulate` |
| Graph node | `formula.adjusted.calcdispatcher.action.sensor_simulate` |
| Kind | dispatcher_router |
