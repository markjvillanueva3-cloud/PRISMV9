---
title: Formula — router · wedm_record_job
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_record_job
...
# Formula — `router · wedm_record_job`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_record_job` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_record_job` |
| Kind | dispatcher_router |
