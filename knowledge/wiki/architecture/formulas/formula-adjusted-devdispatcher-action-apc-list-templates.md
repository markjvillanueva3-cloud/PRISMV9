---
title: Formula — router · apc_list_templates
type: formula
formula_id: formula.adjusted.devdispatcher.action.apc_list_templates
...
# Formula — `router · apc_list_templates`
...
| Field | Value |
|-------|-------|
| Name | `router · apc_list_templates` |
| Graph node | `formula.adjusted.devdispatcher.action.apc_list_templates` |
| Kind | dispatcher_router |
