---
title: Formula — router · cam_ml_train_lora
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_ml_train_lora
...
# Formula — `router · cam_ml_train_lora`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_ml_train_lora` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_ml_train_lora` |
| Kind | dispatcher_router |
