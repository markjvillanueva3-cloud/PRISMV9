---
title: Formula — router · employee_create
type: formula
formula_id: formula.adjusted.businessdispatcher.action.employee_create
...
# Formula — `router · employee_create`
...
| Field | Value |
|-------|-------|
| Name | `router · employee_create` |
| Graph node | `formula.adjusted.businessdispatcher.action.employee_create` |
| Kind | dispatcher_router |
