---
title: Formula — router · maint_schedule
type: formula
formula_id: formula.adjusted.machinelivedispatcher.action.maint_schedule
...
| Field | Value |
|-------|-------|
| Name | `router · maint_schedule` |
| Graph node | `formula.adjusted.machinelivedispatcher.action.maint_schedule` |
| Kind | dispatcher_router |
