---
title: Formula — router · okumaManualTips
type: formula
formula_id: formula.adjusted.turningdispatcher.action.okumamanualtips
...
# Formula — `router · okumaManualTips`
...
| Field | Value |
|-------|-------|
| Name | `router · okumaManualTips` |
| Graph node | `formula.adjusted.turningdispatcher.action.okumamanualtips` |
| Kind | dispatcher_router |
