---
title: Formula — router · quality_dashboard
type: formula
formula_id: formula.adjusted.devdispatcher.action.quality_dashboard
...
# Formula — `router · quality_dashboard`
...
| Field | Value |
|-------|-------|
| Name | `router · quality_dashboard` |
| Graph node | `formula.adjusted.devdispatcher.action.quality_dashboard` |
| Kind | dispatcher_router |
