---
title: Formula — router · batch_validate
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.batch_validate
...
| Field | Value |
|-------|-------|
| Name | `router · batch_validate` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.batch_validate` |
| Kind | dispatcher_router |
