---
title: Formula — router · stats_regression
type: formula
formula_id: formula.adjusted.camdispatcher.action.stats_regression
...
# Formula — `router · stats_regression`
...
| Field | Value |
|-------|-------|
| Name | `router · stats_regression` |
| Graph node | `formula.adjusted.camdispatcher.action.stats_regression` |
| Kind | dispatcher_router |
