---
title: Formula — router · job_summary
type: formula
formula_id: formula.adjusted.businessdispatcher.action.job_summary
...
| Field | Value |
|-------|-------|
| Name | `router · job_summary` |
| Graph node | `formula.adjusted.businessdispatcher.action.job_summary` |
| Kind | dispatcher_router |
