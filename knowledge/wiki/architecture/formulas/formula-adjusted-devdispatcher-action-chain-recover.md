---
title: Formula — router · chain_recover
type: formula
formula_id: formula.adjusted.devdispatcher.action.chain_recover
...
| Field | Value |
|-------|-------|
| Name | `router · chain_recover` |
| Graph node | `formula.adjusted.devdispatcher.action.chain_recover` |
| Kind | dispatcher_router |
