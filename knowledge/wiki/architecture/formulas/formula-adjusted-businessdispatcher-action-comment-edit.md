---
title: Formula — router · comment_edit
type: formula
formula_id: formula.adjusted.businessdispatcher.action.comment_edit
...
| Field | Value |
|-------|-------|
| Name | `router · comment_edit` |
| Graph node | `formula.adjusted.businessdispatcher.action.comment_edit` |
| Kind | dispatcher_router |
