---
title: Formula — router · batch_unwired
type: formula
formula_id: formula.adjusted.devdispatcher.action.batch_unwired
...
| Field | Value |
|-------|-------|
| Name | `router · batch_unwired` |
| Graph node | `formula.adjusted.devdispatcher.action.batch_unwired` |
| Kind | dispatcher_router |
