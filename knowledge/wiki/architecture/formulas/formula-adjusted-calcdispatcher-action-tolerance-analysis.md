---
title: Formula — router · tolerance_analysis
type: formula
formula_id: formula.adjusted.calcdispatcher.action.tolerance_analysis
...
# Formula — `router · tolerance_analysis`
...
| Field | Value |
|-------|-------|
| Name | `router · tolerance_analysis` |
| Graph node | `formula.adjusted.calcdispatcher.action.tolerance_analysis` |
| Kind | dispatcher_router |
