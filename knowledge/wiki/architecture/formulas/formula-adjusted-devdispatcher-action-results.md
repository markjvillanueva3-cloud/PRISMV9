---
title: Formula — router · results
type: formula
formula_id: formula.adjusted.devdispatcher.action.results
...
|-------|-------|
| Name | `router · results` |
| Graph node | `formula.adjusted.devdispatcher.action.results` |
| Kind | dispatcher_router |
