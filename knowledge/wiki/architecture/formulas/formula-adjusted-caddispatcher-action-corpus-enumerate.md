---
title: Formula — router · corpus_enumerate
type: formula
formula_id: formula.adjusted.caddispatcher.action.corpus_enumerate
...
# Formula — `router · corpus_enumerate`
...
| Field | Value |
|-------|-------|
| Name | `router · corpus_enumerate` |
| Graph node | `formula.adjusted.caddispatcher.action.corpus_enumerate` |
| Kind | dispatcher_router |
