---
title: Formula — router · rbd_importance
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rbd_importance
...
| Field | Value |
|-------|-------|
| Name | `router · rbd_importance` |
| Graph node | `formula.adjusted.calcdispatcher.action.rbd_importance` |
| Kind | dispatcher_router |
