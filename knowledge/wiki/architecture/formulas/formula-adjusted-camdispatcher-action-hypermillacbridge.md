---
title: Formula — router · hyperMillACBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.hypermillacbridge
...
# Formula — `router · hyperMillACBridge`
...
| Field | Value |
|-------|-------|
| Name | `router · hyperMillACBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.hypermillacbridge` |
| Kind | dispatcher_router |
