---
title: Formula — router · motion_look_ahead
type: formula
formula_id: formula.adjusted.camdispatcher.action.motion_look_ahead
...
# Formula — `router · motion_look_ahead`
...
| Field | Value |
|-------|-------|
| Name | `router · motion_look_ahead` |
| Graph node | `formula.adjusted.camdispatcher.action.motion_look_ahead` |
| Kind | dispatcher_router |
