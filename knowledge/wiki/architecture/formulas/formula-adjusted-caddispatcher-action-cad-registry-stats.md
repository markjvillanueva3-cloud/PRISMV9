---
title: Formula — router · cad_registry_stats
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_registry_stats
...
# Formula — `router · cad_registry_stats`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_registry_stats` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_registry_stats` |
| Kind | dispatcher_router |
