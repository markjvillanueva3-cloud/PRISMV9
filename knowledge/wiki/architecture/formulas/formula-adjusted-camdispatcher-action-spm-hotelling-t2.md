---
title: Formula — router · spm_hotelling_t2
type: formula
formula_id: formula.adjusted.camdispatcher.action.spm_hotelling_t2
...
# Formula — `router · spm_hotelling_t2`
...
| Field | Value |
|-------|-------|
| Name | `router · spm_hotelling_t2` |
| Graph node | `formula.adjusted.camdispatcher.action.spm_hotelling_t2` |
| Kind | dispatcher_router |
