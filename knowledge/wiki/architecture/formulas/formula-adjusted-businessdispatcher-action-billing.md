---
title: Formula — router · billing
type: formula
formula_id: formula.adjusted.businessdispatcher.action.billing
...
|-------|-------|
| Name | `router · billing` |
| Graph node | `formula.adjusted.businessdispatcher.action.billing` |
| Kind | dispatcher_router |
