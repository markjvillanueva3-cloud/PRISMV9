---
title: Formula — router · electrode_design
type: formula
formula_id: formula.adjusted.edmdispatcher.action.electrode_design
...
# Formula — `router · electrode_design`
...
| Field | Value |
|-------|-------|
| Name | `router · electrode_design` |
| Graph node | `formula.adjusted.edmdispatcher.action.electrode_design` |
| Kind | dispatcher_router |
