---
title: Formula — router · solidCAMStrategy
type: formula
formula_id: formula.adjusted.camdispatcher.action.solidcamstrategy
...
# Formula — `router · solidCAMStrategy`
...
| Field | Value |
|-------|-------|
| Name | `router · solidCAMStrategy` |
| Graph node | `formula.adjusted.camdispatcher.action.solidcamstrategy` |
| Kind | dispatcher_router |
