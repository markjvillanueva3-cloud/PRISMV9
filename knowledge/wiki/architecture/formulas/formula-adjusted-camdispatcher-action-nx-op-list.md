---
title: Formula — router · nx_op_list
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_op_list
...
| Field | Value |
|-------|-------|
| Name | `router · nx_op_list` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_op_list` |
| Kind | dispatcher_router |
