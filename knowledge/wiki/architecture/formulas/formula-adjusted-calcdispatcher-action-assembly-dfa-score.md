---
title: Formula — router · assembly_dfa_score
type: formula
formula_id: formula.adjusted.calcdispatcher.action.assembly_dfa_score
...
# Formula — `router · assembly_dfa_score`
...
| Field | Value |
|-------|-------|
| Name | `router · assembly_dfa_score` |
| Graph node | `formula.adjusted.calcdispatcher.action.assembly_dfa_score` |
| Kind | dispatcher_router |
