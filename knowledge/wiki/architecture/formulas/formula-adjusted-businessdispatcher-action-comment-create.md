---
title: Formula — router · comment_create
type: formula
formula_id: formula.adjusted.businessdispatcher.action.comment_create
...
| Field | Value |
|-------|-------|
| Name | `router · comment_create` |
| Graph node | `formula.adjusted.businessdispatcher.action.comment_create` |
| Kind | dispatcher_router |
