---
title: Formula — router · calc_sampling_plan
type: formula
formula_id: formula.adjusted.calcdispatcher.action.calc_sampling_plan
...
# Formula — `router · calc_sampling_plan`
...
| Field | Value |
|-------|-------|
| Name | `router · calc_sampling_plan` |
| Graph node | `formula.adjusted.calcdispatcher.action.calc_sampling_plan` |
| Kind | dispatcher_router |
