---
title: Formula — router · sus_eco_efficiency
type: formula
formula_id: formula.adjusted.camdispatcher.action.sus_eco_efficiency
...
# Formula — `router · sus_eco_efficiency`
...
| Field | Value |
|-------|-------|
| Name | `router · sus_eco_efficiency` |
| Graph node | `formula.adjusted.camdispatcher.action.sus_eco_efficiency` |
| Kind | dispatcher_router |
