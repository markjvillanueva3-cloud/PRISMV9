---
title: Formula — router · arc_fit_kasa
type: formula
formula_id: formula.adjusted.calcdispatcher.action.arc_fit_kasa
...
| Field | Value |
|-------|-------|
| Name | `router · arc_fit_kasa` |
| Graph node | `formula.adjusted.calcdispatcher.action.arc_fit_kasa` |
| Kind | dispatcher_router |
