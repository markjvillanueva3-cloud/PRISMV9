---
title: Formula — router · nxcam_fbm_index
type: formula
formula_id: formula.adjusted.camdispatcher.action.nxcam_fbm_index
...
# Formula — `router · nxcam_fbm_index`
...
| Field | Value |
|-------|-------|
| Name | `router · nxcam_fbm_index` |
| Graph node | `formula.adjusted.camdispatcher.action.nxcam_fbm_index` |
| Kind | dispatcher_router |
