---
title: Formula — router · imachining_wizard
type: formula
formula_id: formula.adjusted.camdispatcher.action.imachining_wizard
...
# Formula — `router · imachining_wizard`
...
| Field | Value |
|-------|-------|
| Name | `router · imachining_wizard` |
| Graph node | `formula.adjusted.camdispatcher.action.imachining_wizard` |
| Kind | dispatcher_router |
