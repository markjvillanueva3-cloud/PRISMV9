---
title: Formula — router · register
type: formula
formula_id: formula.adjusted.authdispatcher.action.register
...
| Graph node | `formula.adjusted.authdispatcher.action.register` |
| Kind | dispatcher_router |
