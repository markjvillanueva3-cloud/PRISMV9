---
title: Formula — router · honing_calculate
type: formula
formula_id: formula.adjusted.cncopsdispatcher.action.honing_calculate
...
# Formula — `router · honing_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · honing_calculate` |
| Graph node | `formula.adjusted.cncopsdispatcher.action.honing_calculate` |
| Kind | dispatcher_router |
