---
title: Formula — router · qifIntegration
type: formula
formula_id: formula.adjusted.camdispatcher.action.qifintegration
...
| Field | Value |
|-------|-------|
| Name | `router · qifIntegration` |
| Graph node | `formula.adjusted.camdispatcher.action.qifintegration` |
| Kind | dispatcher_router |
