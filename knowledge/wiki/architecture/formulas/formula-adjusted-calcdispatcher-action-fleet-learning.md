---
title: Formula — router · fleet_learning
type: formula
formula_id: formula.adjusted.calcdispatcher.action.fleet_learning
...
| Field | Value |
|-------|-------|
| Name | `router · fleet_learning` |
| Graph node | `formula.adjusted.calcdispatcher.action.fleet_learning` |
| Kind | dispatcher_router |
