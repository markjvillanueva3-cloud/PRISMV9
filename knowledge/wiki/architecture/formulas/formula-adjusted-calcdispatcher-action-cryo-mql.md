---
title: Formula — router · cryo_mql
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cryo_mql
...
| Field | Value |
|-------|-------|
| Name | `router · cryo_mql` |
| Graph node | `formula.adjusted.calcdispatcher.action.cryo_mql` |
| Kind | dispatcher_router |
