---
title: Formula — router · cascade_pending
type: formula
formula_id: formula.adjusted.mldispatcher.action.cascade_pending
...
# Formula — `router · cascade_pending`
...
| Field | Value |
|-------|-------|
| Name | `router · cascade_pending` |
| Graph node | `formula.adjusted.mldispatcher.action.cascade_pending` |
| Kind | dispatcher_router |
