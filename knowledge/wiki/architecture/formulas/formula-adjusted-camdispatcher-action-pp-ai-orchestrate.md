---
title: Formula — router · pp_ai_orchestrate
type: formula
formula_id: formula.adjusted.camdispatcher.action.pp_ai_orchestrate
...
# Formula — `router · pp_ai_orchestrate`
...
| Field | Value |
|-------|-------|
| Name | `router · pp_ai_orchestrate` |
| Graph node | `formula.adjusted.camdispatcher.action.pp_ai_orchestrate` |
| Kind | dispatcher_router |
