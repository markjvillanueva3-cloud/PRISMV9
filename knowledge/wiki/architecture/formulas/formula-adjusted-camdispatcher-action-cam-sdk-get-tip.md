---
title: Formula — router · cam_sdk_get_tip
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_sdk_get_tip
...
# Formula — `router · cam_sdk_get_tip`
...
| Field | Value |
|-------|-------|
| Name | `router · cam_sdk_get_tip` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_sdk_get_tip` |
| Kind | dispatcher_router |
