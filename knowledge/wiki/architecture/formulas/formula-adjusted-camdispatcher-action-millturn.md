---
title: Formula — router · millTurn
type: formula
formula_id: formula.adjusted.camdispatcher.action.millturn
...
| Field | Value |
|-------|-------|
| Name | `router · millTurn` |
| Graph node | `formula.adjusted.camdispatcher.action.millturn` |
| Kind | dispatcher_router |
