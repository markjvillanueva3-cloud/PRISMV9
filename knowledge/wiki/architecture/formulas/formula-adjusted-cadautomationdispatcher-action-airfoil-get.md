---
title: Formula — router · airfoil_get
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.airfoil_get
...
| Field | Value |
|-------|-------|
| Name | `router · airfoil_get` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.airfoil_get` |
| Kind | dispatcher_router |
