---
title: Formula — router · order_list
type: formula
formula_id: formula.adjusted.businessdispatcher.action.order_list
...
| Graph node | `formula.adjusted.businessdispatcher.action.order_list` |
| Kind | dispatcher_router |
