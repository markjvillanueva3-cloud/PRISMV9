---
title: Formula — router · sustain_report
type: formula
formula_id: formula.adjusted.diagnosisdispatcher.action.sustain_report
...
| Field | Value |
|-------|-------|
| Name | `router · sustain_report` |
| Graph node | `formula.adjusted.diagnosisdispatcher.action.sustain_report` |
| Kind | dispatcher_router |
