---
title: Formula — router · wedm_plan_tabs
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_plan_tabs
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_plan_tabs` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_plan_tabs` |
| Kind | dispatcher_router |
