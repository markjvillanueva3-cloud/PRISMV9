---
title: Formula — router · toolUsage
type: formula
formula_id: formula.adjusted.businessdispatcher.action.toolusage
...
| Field | Value |
|-------|-------|
| Name | `router · toolUsage` |
| Graph node | `formula.adjusted.businessdispatcher.action.toolusage` |
| Kind | dispatcher_router |
