---
title: Formula — router · spc_cpk
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spc_cpk
...
|-------|-------|
| Name | `router · spc_cpk` |
| Graph node | `formula.adjusted.calcdispatcher.action.spc_cpk` |
| Kind | dispatcher_router |
