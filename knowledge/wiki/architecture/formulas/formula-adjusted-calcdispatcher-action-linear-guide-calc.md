---
title: Formula — router · linear_guide_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.linear_guide_calc
...
# Formula — `router · linear_guide_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · linear_guide_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.linear_guide_calc` |
| Kind | dispatcher_router |
