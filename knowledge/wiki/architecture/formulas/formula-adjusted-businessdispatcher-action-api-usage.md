---
title: Formula — router · api_usage
type: formula
formula_id: formula.adjusted.businessdispatcher.action.api_usage
...
| Field | Value |
|-------|-------|
| Name | `router · api_usage` |
| Graph node | `formula.adjusted.businessdispatcher.action.api_usage` |
| Kind | dispatcher_router |
