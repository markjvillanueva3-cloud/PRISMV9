---
title: Formula — router · ode_stability
type: formula
formula_id: formula.adjusted.calcdispatcher.action.ode_stability
...
| Field | Value |
|-------|-------|
| Name | `router · ode_stability` |
| Graph node | `formula.adjusted.calcdispatcher.action.ode_stability` |
| Kind | dispatcher_router |
