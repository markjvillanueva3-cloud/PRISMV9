---
title: Formula — router · okuma_step_parse
type: formula
formula_id: formula.adjusted.turningdispatcher.action.okuma_step_parse
...
# Formula — `router · okuma_step_parse`
...
| Field | Value |
|-------|-------|
| Name | `router · okuma_step_parse` |
| Graph node | `formula.adjusted.turningdispatcher.action.okuma_step_parse` |
| Kind | dispatcher_router |
