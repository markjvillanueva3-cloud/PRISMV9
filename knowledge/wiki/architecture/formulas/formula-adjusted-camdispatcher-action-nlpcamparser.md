---
title: Formula — router · nlpCAMParser
type: formula
formula_id: formula.adjusted.camdispatcher.action.nlpcamparser
...
| Field | Value |
|-------|-------|
| Name | `router · nlpCAMParser` |
| Graph node | `formula.adjusted.camdispatcher.action.nlpcamparser` |
| Kind | dispatcher_router |
