---
title: Formula — router · worknc_parse_nc
type: formula
formula_id: formula.adjusted.camdispatcher.action.worknc_parse_nc
...
# Formula — `router · worknc_parse_nc`
...
| Field | Value |
|-------|-------|
| Name | `router · worknc_parse_nc` |
| Graph node | `formula.adjusted.camdispatcher.action.worknc_parse_nc` |
| Kind | dispatcher_router |
