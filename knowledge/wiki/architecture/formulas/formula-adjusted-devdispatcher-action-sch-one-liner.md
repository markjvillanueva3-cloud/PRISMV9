---
title: Formula — router · sch_one_liner
type: formula
formula_id: formula.adjusted.devdispatcher.action.sch_one_liner
...
| Field | Value |
|-------|-------|
| Name | `router · sch_one_liner` |
| Graph node | `formula.adjusted.devdispatcher.action.sch_one_liner` |
| Kind | dispatcher_router |
