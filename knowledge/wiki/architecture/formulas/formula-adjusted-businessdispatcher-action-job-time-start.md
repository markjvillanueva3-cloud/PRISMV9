---
title: Formula — router · job_time_start
type: formula
formula_id: formula.adjusted.businessdispatcher.action.job_time_start
...
| Field | Value |
|-------|-------|
| Name | `router · job_time_start` |
| Graph node | `formula.adjusted.businessdispatcher.action.job_time_start` |
| Kind | dispatcher_router |
