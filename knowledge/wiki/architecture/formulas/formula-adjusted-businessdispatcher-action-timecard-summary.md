---
title: Formula — router · timecard_summary
type: formula
formula_id: formula.adjusted.businessdispatcher.action.timecard_summary
...
# Formula — `router · timecard_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · timecard_summary` |
| Graph node | `formula.adjusted.businessdispatcher.action.timecard_summary` |
| Kind | dispatcher_router |
