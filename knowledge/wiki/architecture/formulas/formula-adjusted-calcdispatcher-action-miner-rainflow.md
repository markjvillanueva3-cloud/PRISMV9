---
title: Formula — router · miner_rainflow
type: formula
formula_id: formula.adjusted.calcdispatcher.action.miner_rainflow
...
| Field | Value |
|-------|-------|
| Name | `router · miner_rainflow` |
| Graph node | `formula.adjusted.calcdispatcher.action.miner_rainflow` |
| Kind | dispatcher_router |
