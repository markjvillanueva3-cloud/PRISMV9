---
title: Formula — router · clock_out
type: formula
formula_id: formula.adjusted.businessdispatcher.action.clock_out
...
| Field | Value |
|-------|-------|
| Name | `router · clock_out` |
| Graph node | `formula.adjusted.businessdispatcher.action.clock_out` |
| Kind | dispatcher_router |
