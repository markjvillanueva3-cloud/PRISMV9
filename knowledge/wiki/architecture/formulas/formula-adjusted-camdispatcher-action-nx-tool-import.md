---
title: Formula — router · nx_tool_import
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_tool_import
...
| Field | Value |
|-------|-------|
| Name | `router · nx_tool_import` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_tool_import` |
| Kind | dispatcher_router |
