---
title: Formula — router · sa_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.sa_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · sa_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.sa_optimize` |
| Kind | dispatcher_router |
