---
title: Formula — router · pgh_evaluate
type: formula
formula_id: formula.adjusted.devdispatcher.action.pgh_evaluate
...
| Field | Value |
|-------|-------|
| Name | `router · pgh_evaluate` |
| Graph node | `formula.adjusted.devdispatcher.action.pgh_evaluate` |
| Kind | dispatcher_router |
