---
title: Formula — router · permutation_paired
type: formula
formula_id: formula.adjusted.calcdispatcher.action.permutation_paired
...
# Formula — `router · permutation_paired`
...
| Field | Value |
|-------|-------|
| Name | `router · permutation_paired` |
| Graph node | `formula.adjusted.calcdispatcher.action.permutation_paired` |
| Kind | dispatcher_router |
