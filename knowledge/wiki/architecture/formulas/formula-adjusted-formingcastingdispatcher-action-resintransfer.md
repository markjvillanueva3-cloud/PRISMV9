---
title: Formula — router · resinTransfer
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.resintransfer
...
| Field | Value |
|-------|-------|
| Name | `router · resinTransfer` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.resintransfer` |
| Kind | dispatcher_router |
