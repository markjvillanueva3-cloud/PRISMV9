---
title: Formula — router · workflow_cancel
type: formula
formula_id: formula.adjusted.businessdispatcher.action.workflow_cancel
...
# Formula — `router · workflow_cancel`
...
| Field | Value |
|-------|-------|
| Name | `router · workflow_cancel` |
| Graph node | `formula.adjusted.businessdispatcher.action.workflow_cancel` |
| Kind | dispatcher_router |
