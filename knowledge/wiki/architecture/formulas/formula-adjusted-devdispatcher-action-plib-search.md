---
title: Formula — router · plib_search
type: formula
formula_id: formula.adjusted.devdispatcher.action.plib_search
...
| Field | Value |
|-------|-------|
| Name | `router · plib_search` |
| Graph node | `formula.adjusted.devdispatcher.action.plib_search` |
| Kind | dispatcher_router |
