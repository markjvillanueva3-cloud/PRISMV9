---
title: Formula — router · traveler_get
type: formula
formula_id: formula.adjusted.businessdispatcher.action.traveler_get
...
| Field | Value |
|-------|-------|
| Name | `router · traveler_get` |
| Graph node | `formula.adjusted.businessdispatcher.action.traveler_get` |
| Kind | dispatcher_router |
