---
title: Formula — router · topology_homology
type: formula
formula_id: formula.adjusted.calcdispatcher.action.topology_homology
...
# Formula — `router · topology_homology`
...
| Field | Value |
|-------|-------|
| Name | `router · topology_homology` |
| Graph node | `formula.adjusted.calcdispatcher.action.topology_homology` |
| Kind | dispatcher_router |
