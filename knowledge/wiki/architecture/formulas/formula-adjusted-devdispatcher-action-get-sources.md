---
title: Formula — router · get_sources
type: formula
formula_id: formula.adjusted.devdispatcher.action.get_sources
...
| Field | Value |
|-------|-------|
| Name | `router · get_sources` |
| Graph node | `formula.adjusted.devdispatcher.action.get_sources` |
| Kind | dispatcher_router |
