---
title: Formula — router · kdtree_radius
type: formula
formula_id: formula.adjusted.calcdispatcher.action.kdtree_radius
...
| Field | Value |
|-------|-------|
| Name | `router · kdtree_radius` |
| Graph node | `formula.adjusted.calcdispatcher.action.kdtree_radius` |
| Kind | dispatcher_router |
