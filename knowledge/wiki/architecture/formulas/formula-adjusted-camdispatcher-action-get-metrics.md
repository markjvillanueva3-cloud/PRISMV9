---
title: Formula — router · get_metrics
type: formula
formula_id: formula.adjusted.camdispatcher.action.get_metrics
...
| Field | Value |
|-------|-------|
| Name | `router · get_metrics` |
| Graph node | `formula.adjusted.camdispatcher.action.get_metrics` |
| Kind | dispatcher_router |
