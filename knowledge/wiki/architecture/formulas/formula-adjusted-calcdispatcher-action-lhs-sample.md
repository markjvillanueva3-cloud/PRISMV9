---
title: Formula — router · lhs_sample
type: formula
formula_id: formula.adjusted.calcdispatcher.action.lhs_sample
...
| Field | Value |
|-------|-------|
| Name | `router · lhs_sample` |
| Graph node | `formula.adjusted.calcdispatcher.action.lhs_sample` |
| Kind | dispatcher_router |
