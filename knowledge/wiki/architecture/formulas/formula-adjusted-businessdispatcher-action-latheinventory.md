---
title: Formula — router · latheInventory
type: formula
formula_id: formula.adjusted.businessdispatcher.action.latheinventory
...
| Field | Value |
|-------|-------|
| Name | `router · latheInventory` |
| Graph node | `formula.adjusted.businessdispatcher.action.latheinventory` |
| Kind | dispatcher_router |
