---
title: Formula — router · probe_inspection
type: formula
formula_id: formula.adjusted.camdispatcher.action.probe_inspection
...
# Formula — `router · probe_inspection`
...
| Field | Value |
|-------|-------|
| Name | `router · probe_inspection` |
| Graph node | `formula.adjusted.camdispatcher.action.probe_inspection` |
| Kind | dispatcher_router |
