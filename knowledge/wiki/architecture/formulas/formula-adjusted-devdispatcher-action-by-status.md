---
title: Formula — router · by_status
type: formula
formula_id: formula.adjusted.devdispatcher.action.by_status
...
| Field | Value |
|-------|-------|
| Name | `router · by_status` |
| Graph node | `formula.adjusted.devdispatcher.action.by_status` |
| Kind | dispatcher_router |
