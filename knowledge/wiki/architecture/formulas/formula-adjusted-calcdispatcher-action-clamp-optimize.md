---
title: Formula — router · clamp_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.clamp_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · clamp_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.clamp_optimize` |
| Kind | dispatcher_router |
