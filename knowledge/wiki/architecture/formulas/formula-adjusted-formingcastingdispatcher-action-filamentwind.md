---
title: Formula — router · filamentWind
type: formula
formula_id: formula.adjusted.formingcastingdispatcher.action.filamentwind
...
| Field | Value |
|-------|-------|
| Name | `router · filamentWind` |
| Graph node | `formula.adjusted.formingcastingdispatcher.action.filamentwind` |
| Kind | dispatcher_router |
