---
title: Formula — router · qr_factorize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.qr_factorize
...
| Field | Value |
|-------|-------|
| Name | `router · qr_factorize` |
| Graph node | `formula.adjusted.calcdispatcher.action.qr_factorize` |
| Kind | dispatcher_router |
