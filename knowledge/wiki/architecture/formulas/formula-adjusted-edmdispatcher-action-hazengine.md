---
title: Formula — router · hazEngine
type: formula
formula_id: formula.adjusted.edmdispatcher.action.hazengine
...
| Field | Value |
|-------|-------|
| Name | `router · hazEngine` |
| Graph node | `formula.adjusted.edmdispatcher.action.hazengine` |
| Kind | dispatcher_router |
