---
title: Formula — router · hertz_contact_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.hertz_contact_calc
...
# Formula — `router · hertz_contact_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · hertz_contact_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.hertz_contact_calc` |
| Kind | dispatcher_router |
