---
title: Formula — router · sinker_materials
type: formula
formula_id: formula.adjusted.edmdispatcher.action.sinker_materials
...
# Formula — `router · sinker_materials`
...
| Field | Value |
|-------|-------|
| Name | `router · sinker_materials` |
| Graph node | `formula.adjusted.edmdispatcher.action.sinker_materials` |
| Kind | dispatcher_router |
