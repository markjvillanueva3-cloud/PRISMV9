---
title: Formula — router · strategy_perf_top
type: formula
formula_id: formula.adjusted.camdispatcher.action.strategy_perf_top
...
# Formula — `router · strategy_perf_top`
...
| Field | Value |
|-------|-------|
| Name | `router · strategy_perf_top` |
| Graph node | `formula.adjusted.camdispatcher.action.strategy_perf_top` |
| Kind | dispatcher_router |
