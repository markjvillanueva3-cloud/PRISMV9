---
title: Formula — router · tool_roi_compare
type: formula
formula_id: formula.adjusted.businessdispatcher.action.tool_roi_compare
...
# Formula — `router · tool_roi_compare`
...
| Field | Value |
|-------|-------|
| Name | `router · tool_roi_compare` |
| Graph node | `formula.adjusted.businessdispatcher.action.tool_roi_compare` |
| Kind | dispatcher_router |
