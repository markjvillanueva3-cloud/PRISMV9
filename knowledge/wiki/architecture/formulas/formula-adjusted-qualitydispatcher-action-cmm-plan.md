---
title: Formula — router · cmm_plan
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.cmm_plan
...
| Field | Value |
|-------|-------|
| Name | `router · cmm_plan` |
| Graph node | `formula.adjusted.qualitydispatcher.action.cmm_plan` |
| Kind | dispatcher_router |
