---
title: Formula — router · f360_live_extrude
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_extrude
...
# Formula — `router · f360_live_extrude`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_extrude` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_extrude` |
| Kind | dispatcher_router |
