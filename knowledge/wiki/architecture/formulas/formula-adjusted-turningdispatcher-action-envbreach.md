---
title: Formula — router · envBreach
type: formula
formula_id: formula.adjusted.turningdispatcher.action.envbreach
...
| Field | Value |
|-------|-------|
| Name | `router · envBreach` |
| Graph node | `formula.adjusted.turningdispatcher.action.envbreach` |
| Kind | dispatcher_router |
