---
title: Formula — router · spc_xbar_r_chart
type: formula
formula_id: formula.adjusted.calcdispatcher.action.spc_xbar_r_chart
...
# Formula — `router · spc_xbar_r_chart`
...
| Field | Value |
|-------|-------|
| Name | `router · spc_xbar_r_chart` |
| Graph node | `formula.adjusted.calcdispatcher.action.spc_xbar_r_chart` |
| Kind | dispatcher_router |
