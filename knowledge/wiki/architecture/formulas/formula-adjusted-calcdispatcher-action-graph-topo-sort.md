---
title: Formula — router · graph_topo_sort
type: formula
formula_id: formula.adjusted.calcdispatcher.action.graph_topo_sort
...
# Formula — `router · graph_topo_sort`
...
| Field | Value |
|-------|-------|
| Name | `router · graph_topo_sort` |
| Graph node | `formula.adjusted.calcdispatcher.action.graph_topo_sort` |
| Kind | dispatcher_router |
