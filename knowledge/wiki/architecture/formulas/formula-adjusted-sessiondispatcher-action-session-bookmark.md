---
title: Formula — router · session_bookmark
type: formula
formula_id: formula.adjusted.sessiondispatcher.action.session_bookmark
...
# Formula — `router · session_bookmark`
...
| Field | Value |
|-------|-------|
| Name | `router · session_bookmark` |
| Graph node | `formula.adjusted.sessiondispatcher.action.session_bookmark` |
| Kind | dispatcher_router |
