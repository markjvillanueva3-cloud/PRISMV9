---
title: Formula — router · compact_compact
type: formula
formula_id: formula.adjusted.devdispatcher.action.compact_compact
...
# Formula — `router · compact_compact`
...
| Field | Value |
|-------|-------|
| Name | `router · compact_compact` |
| Graph node | `formula.adjusted.devdispatcher.action.compact_compact` |
| Kind | dispatcher_router |
