---
title: Formula — router · mcmc_sample
type: formula
formula_id: formula.adjusted.calcdispatcher.action.mcmc_sample
...
| Field | Value |
|-------|-------|
| Name | `router · mcmc_sample` |
| Graph node | `formula.adjusted.calcdispatcher.action.mcmc_sample` |
| Kind | dispatcher_router |
