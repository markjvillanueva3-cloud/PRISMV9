---
title: Formula — router · mcMatBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.mcmatbridge
...
| Field | Value |
|-------|-------|
| Name | `router · mcMatBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.mcmatbridge` |
| Kind | dispatcher_router |
