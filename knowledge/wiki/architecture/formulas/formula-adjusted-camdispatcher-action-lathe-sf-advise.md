---
title: Formula — router · lathe_sf_advise
type: formula
formula_id: formula.adjusted.camdispatcher.action.lathe_sf_advise
...
# Formula — `router · lathe_sf_advise`
...
| Field | Value |
|-------|-------|
| Name | `router · lathe_sf_advise` |
| Graph node | `formula.adjusted.camdispatcher.action.lathe_sf_advise` |
| Kind | dispatcher_router |
