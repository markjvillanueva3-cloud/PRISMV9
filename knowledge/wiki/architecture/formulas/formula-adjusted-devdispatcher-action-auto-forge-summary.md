---
title: Formula — router · auto_forge_summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.auto_forge_summary
...
# Formula — `router · auto_forge_summary`
...
| Field | Value |
|-------|-------|
| Name | `router · auto_forge_summary` |
| Graph node | `formula.adjusted.devdispatcher.action.auto_forge_summary` |
| Kind | dispatcher_router |
