---
title: Formula — router · post_inject_hsm
type: formula
formula_id: formula.adjusted.camdispatcher.action.post_inject_hsm
...
# Formula — `router · post_inject_hsm`
...
| Field | Value |
|-------|-------|
| Name | `router · post_inject_hsm` |
| Graph node | `formula.adjusted.camdispatcher.action.post_inject_hsm` |
| Kind | dispatcher_router |
