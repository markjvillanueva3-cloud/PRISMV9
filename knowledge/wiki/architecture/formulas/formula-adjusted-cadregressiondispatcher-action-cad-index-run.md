---
title: Formula — router · cad_index_run
type: formula
formula_id: formula.adjusted.cadregressiondispatcher.action.cad_index_run
...
| Field | Value |
|-------|-------|
| Name | `router · cad_index_run` |
| Graph node | `formula.adjusted.cadregressiondispatcher.action.cad_index_run` |
| Kind | dispatcher_router |
