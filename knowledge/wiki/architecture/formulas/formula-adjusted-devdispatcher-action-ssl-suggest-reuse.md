---
title: Formula — router · ssl_suggest_reuse
type: formula
formula_id: formula.adjusted.devdispatcher.action.ssl_suggest_reuse
...
# Formula — `router · ssl_suggest_reuse`
...
| Field | Value |
|-------|-------|
| Name | `router · ssl_suggest_reuse` |
| Graph node | `formula.adjusted.devdispatcher.action.ssl_suggest_reuse` |
| Kind | dispatcher_router |
