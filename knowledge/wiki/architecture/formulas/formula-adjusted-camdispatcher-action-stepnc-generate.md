---
title: Formula — router · stepnc_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.stepnc_generate
...
# Formula — `router · stepnc_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · stepnc_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.stepnc_generate` |
| Kind | dispatcher_router |
