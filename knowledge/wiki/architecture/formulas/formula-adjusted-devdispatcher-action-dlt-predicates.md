---
title: Formula — router · dlt_predicates
type: formula
formula_id: formula.adjusted.devdispatcher.action.dlt_predicates
...
| Field | Value |
|-------|-------|
| Name | `router · dlt_predicates` |
| Graph node | `formula.adjusted.devdispatcher.action.dlt_predicates` |
| Kind | dispatcher_router |
