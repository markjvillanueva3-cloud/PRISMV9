---
title: Formula — router · balance_grade
type: formula
formula_id: formula.adjusted.calcdispatcher.action.balance_grade
...
| Field | Value |
|-------|-------|
| Name | `router · balance_grade` |
| Graph node | `formula.adjusted.calcdispatcher.action.balance_grade` |
| Kind | dispatcher_router |
