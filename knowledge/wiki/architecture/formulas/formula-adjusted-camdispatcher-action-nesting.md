---
title: Formula — router · nesting
type: formula
formula_id: formula.adjusted.camdispatcher.action.nesting
...
|-------|-------|
| Name | `router · nesting` |
| Graph node | `formula.adjusted.camdispatcher.action.nesting` |
| Kind | dispatcher_router |
