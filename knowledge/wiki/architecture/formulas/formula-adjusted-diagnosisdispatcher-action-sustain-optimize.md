---
title: Formula — router · sustain_optimize
type: formula
formula_id: formula.adjusted.diagnosisdispatcher.action.sustain_optimize
...
# Formula — `router · sustain_optimize`
...
| Field | Value |
|-------|-------|
| Name | `router · sustain_optimize` |
| Graph node | `formula.adjusted.diagnosisdispatcher.action.sustain_optimize` |
| Kind | dispatcher_router |
