---
title: Formula — router · rbd_availability
type: formula
formula_id: formula.adjusted.calcdispatcher.action.rbd_availability
...
# Formula — `router · rbd_availability`
...
| Field | Value |
|-------|-------|
| Name | `router · rbd_availability` |
| Graph node | `formula.adjusted.calcdispatcher.action.rbd_availability` |
| Kind | dispatcher_router |
