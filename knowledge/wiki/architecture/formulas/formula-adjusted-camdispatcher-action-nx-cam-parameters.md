---
title: Formula — router · nx_cam_parameters
type: formula
formula_id: formula.adjusted.camdispatcher.action.nx_cam_parameters
...
# Formula — `router · nx_cam_parameters`
...
| Field | Value |
|-------|-------|
| Name | `router · nx_cam_parameters` |
| Graph node | `formula.adjusted.camdispatcher.action.nx_cam_parameters` |
| Kind | dispatcher_router |
