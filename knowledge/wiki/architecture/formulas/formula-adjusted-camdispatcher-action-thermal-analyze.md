---
title: Formula — router · thermal_analyze
type: formula
formula_id: formula.adjusted.camdispatcher.action.thermal_analyze
...
# Formula — `router · thermal_analyze`
...
| Field | Value |
|-------|-------|
| Name | `router · thermal_analyze` |
| Graph node | `formula.adjusted.camdispatcher.action.thermal_analyze` |
| Kind | dispatcher_router |
