---
title: Formula — router · cam_agi_reason
type: formula
formula_id: formula.adjusted.camdispatcher.action.cam_agi_reason
...
| Field | Value |
|-------|-------|
| Name | `router · cam_agi_reason` |
| Graph node | `formula.adjusted.camdispatcher.action.cam_agi_reason` |
| Kind | dispatcher_router |
