---
title: Formula — router · toolpath_generate
type: formula
formula_id: formula.adjusted.camdispatcher.action.toolpath_generate
...
# Formula — `router · toolpath_generate`
...
| Field | Value |
|-------|-------|
| Name | `router · toolpath_generate` |
| Graph node | `formula.adjusted.camdispatcher.action.toolpath_generate` |
| Kind | dispatcher_router |
