---
title: Formula — router · cost_optimize
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cost_optimize
...
| Field | Value |
|-------|-------|
| Name | `router · cost_optimize` |
| Graph node | `formula.adjusted.calcdispatcher.action.cost_optimize` |
| Kind | dispatcher_router |
