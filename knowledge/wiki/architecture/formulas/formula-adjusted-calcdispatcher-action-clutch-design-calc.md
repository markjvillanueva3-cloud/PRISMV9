---
title: Formula — router · clutch_design_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.clutch_design_calc
...
# Formula — `router · clutch_design_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · clutch_design_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.clutch_design_calc` |
| Kind | dispatcher_router |
