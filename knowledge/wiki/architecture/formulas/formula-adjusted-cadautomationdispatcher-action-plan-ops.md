---
title: Formula — router · plan_ops
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.plan_ops
...
| Field | Value |
|-------|-------|
| Name | `router · plan_ops` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.plan_ops` |
| Kind | dispatcher_router |
