---
title: Formula — router · gt_regression_gate
type: formula
formula_id: formula.adjusted.caddispatcher.action.gt_regression_gate
...
# Formula — `router · gt_regression_gate`
...
| Field | Value |
|-------|-------|
| Name | `router · gt_regression_gate` |
| Graph node | `formula.adjusted.caddispatcher.action.gt_regression_gate` |
| Kind | dispatcher_router |
