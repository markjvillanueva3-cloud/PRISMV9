---
title: Formula — router · wedm_ewc_schedule
type: formula
formula_id: formula.adjusted.edmdispatcher.action.wedm_ewc_schedule
...
# Formula — `router · wedm_ewc_schedule`
...
| Field | Value |
|-------|-------|
| Name | `router · wedm_ewc_schedule` |
| Graph node | `formula.adjusted.edmdispatcher.action.wedm_ewc_schedule` |
| Kind | dispatcher_router |
