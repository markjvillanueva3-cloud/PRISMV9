---
title: Formula — router · laser_calculate
type: formula
formula_id: formula.adjusted.edmdispatcher.action.laser_calculate
...
# Formula — `router · laser_calculate`
...
| Field | Value |
|-------|-------|
| Name | `router · laser_calculate` |
| Graph node | `formula.adjusted.edmdispatcher.action.laser_calculate` |
| Kind | dispatcher_router |
