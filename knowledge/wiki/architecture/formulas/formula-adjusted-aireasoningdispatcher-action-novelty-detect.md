---
title: Formula — router · novelty_detect
type: formula
formula_id: formula.adjusted.aireasoningdispatcher.action.novelty_detect
...
| Field | Value |
|-------|-------|
| Name | `router · novelty_detect` |
| Graph node | `formula.adjusted.aireasoningdispatcher.action.novelty_detect` |
| Kind | dispatcher_router |
