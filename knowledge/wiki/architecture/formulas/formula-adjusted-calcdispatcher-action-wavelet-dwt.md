---
title: Formula — router · wavelet_dwt
type: formula
formula_id: formula.adjusted.calcdispatcher.action.wavelet_dwt
...
| Field | Value |
|-------|-------|
| Name | `router · wavelet_dwt` |
| Graph node | `formula.adjusted.calcdispatcher.action.wavelet_dwt` |
| Kind | dispatcher_router |
