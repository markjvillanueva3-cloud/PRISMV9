---
title: Formula — router · jobOutcome
type: formula
formula_id: formula.adjusted.edmdispatcher.action.joboutcome
...
| Field | Value |
|-------|-------|
| Name | `router · jobOutcome` |
| Graph node | `formula.adjusted.edmdispatcher.action.joboutcome` |
| Kind | dispatcher_router |
