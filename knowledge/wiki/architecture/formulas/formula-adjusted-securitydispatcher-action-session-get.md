---
title: Formula — router · session_get
type: formula
formula_id: formula.adjusted.securitydispatcher.action.session_get
...
| Field | Value |
|-------|-------|
| Name | `router · session_get` |
| Graph node | `formula.adjusted.securitydispatcher.action.session_get` |
| Kind | dispatcher_router |
