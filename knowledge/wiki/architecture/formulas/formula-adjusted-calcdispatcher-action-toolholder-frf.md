---
title: Formula — router · toolholder_frf
type: formula
formula_id: formula.adjusted.calcdispatcher.action.toolholder_frf
...
| Field | Value |
|-------|-------|
| Name | `router · toolholder_frf` |
| Graph node | `formula.adjusted.calcdispatcher.action.toolholder_frf` |
| Kind | dispatcher_router |
