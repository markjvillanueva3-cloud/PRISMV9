---
title: Formula — router · spc_calculate
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.spc_calculate
...
| Field | Value |
|-------|-------|
| Name | `router · spc_calculate` |
| Graph node | `formula.adjusted.qualitydispatcher.action.spc_calculate` |
| Kind | dispatcher_router |
