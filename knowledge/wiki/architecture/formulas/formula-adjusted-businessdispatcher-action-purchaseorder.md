---
title: Formula — router · purchaseOrder
type: formula
formula_id: formula.adjusted.businessdispatcher.action.purchaseorder
...
| Field | Value |
|-------|-------|
| Name | `router · purchaseOrder` |
| Graph node | `formula.adjusted.businessdispatcher.action.purchaseorder` |
| Kind | dispatcher_router |
