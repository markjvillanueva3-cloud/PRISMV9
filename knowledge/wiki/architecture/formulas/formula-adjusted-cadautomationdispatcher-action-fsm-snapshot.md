---
title: Formula — router · fsm_snapshot
type: formula
formula_id: formula.adjusted.cadautomationdispatcher.action.fsm_snapshot
...
| Field | Value |
|-------|-------|
| Name | `router · fsm_snapshot` |
| Graph node | `formula.adjusted.cadautomationdispatcher.action.fsm_snapshot` |
| Kind | dispatcher_router |
