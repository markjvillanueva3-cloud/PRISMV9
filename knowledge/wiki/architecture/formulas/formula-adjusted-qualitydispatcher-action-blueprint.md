---
title: Formula — router · blueprint
type: formula
formula_id: formula.adjusted.qualitydispatcher.action.blueprint
...
| Field | Value |
|-------|-------|
| Name | `router · blueprint` |
| Graph node | `formula.adjusted.qualitydispatcher.action.blueprint` |
| Kind | dispatcher_router |
