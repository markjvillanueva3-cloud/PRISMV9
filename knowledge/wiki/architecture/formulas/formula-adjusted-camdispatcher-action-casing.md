---
title: Formula — router · casing
type: formula
formula_id: formula.adjusted.camdispatcher.action.casing
...
|-------|-------|
| Name | `router · casing` |
| Graph node | `formula.adjusted.camdispatcher.action.casing` |
| Kind | dispatcher_router |
