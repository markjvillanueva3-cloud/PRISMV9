---
title: Formula — router · cse_categorize
type: formula
formula_id: formula.adjusted.devdispatcher.action.cse_categorize
...
| Field | Value |
|-------|-------|
| Name | `router · cse_categorize` |
| Graph node | `formula.adjusted.devdispatcher.action.cse_categorize` |
| Kind | dispatcher_router |
