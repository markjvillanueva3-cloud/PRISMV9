---
title: Formula — router · f360_live_new_doc
type: formula
formula_id: formula.adjusted.caddispatcher.action.f360_live_new_doc
...
# Formula — `router · f360_live_new_doc`
...
| Field | Value |
|-------|-------|
| Name | `router · f360_live_new_doc` |
| Graph node | `formula.adjusted.caddispatcher.action.f360_live_new_doc` |
| Kind | dispatcher_router |
