---
title: Formula — router · cad_pmi_extract
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_pmi_extract
...
# Formula — `router · cad_pmi_extract`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_pmi_extract` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_pmi_extract` |
| Kind | dispatcher_router |
