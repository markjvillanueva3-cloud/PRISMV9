---
title: Formula — router · cluster_kmedoids
type: formula
formula_id: formula.adjusted.calcdispatcher.action.cluster_kmedoids
...
# Formula — `router · cluster_kmedoids`
...
| Field | Value |
|-------|-------|
| Name | `router · cluster_kmedoids` |
| Graph node | `formula.adjusted.calcdispatcher.action.cluster_kmedoids` |
| Kind | dispatcher_router |
