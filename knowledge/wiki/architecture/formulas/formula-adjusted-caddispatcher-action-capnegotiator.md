---
title: Formula — router · capNegotiator
type: formula
formula_id: formula.adjusted.caddispatcher.action.capnegotiator
...
| Field | Value |
|-------|-------|
| Name | `router · capNegotiator` |
| Graph node | `formula.adjusted.caddispatcher.action.capnegotiator` |
| Kind | dispatcher_router |
