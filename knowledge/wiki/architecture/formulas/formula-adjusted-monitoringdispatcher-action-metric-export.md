---
title: Formula — router · metric_export
type: formula
formula_id: formula.adjusted.monitoringdispatcher.action.metric_export
...
| Field | Value |
|-------|-------|
| Name | `router · metric_export` |
| Graph node | `formula.adjusted.monitoringdispatcher.action.metric_export` |
| Kind | dispatcher_router |
