---
title: Formula — router · cad_f3d_parse_f3z
type: formula
formula_id: formula.adjusted.caddispatcher.action.cad_f3d_parse_f3z
...
# Formula — `router · cad_f3d_parse_f3z`
...
| Field | Value |
|-------|-------|
| Name | `router · cad_f3d_parse_f3z` |
| Graph node | `formula.adjusted.caddispatcher.action.cad_f3d_parse_f3z` |
| Kind | dispatcher_router |
