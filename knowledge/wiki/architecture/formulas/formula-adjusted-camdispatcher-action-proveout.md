---
title: Formula — router · proveOut
type: formula
formula_id: formula.adjusted.camdispatcher.action.proveout
...
| Field | Value |
|-------|-------|
| Name | `router · proveOut` |
| Graph node | `formula.adjusted.camdispatcher.action.proveout` |
| Kind | dispatcher_router |
