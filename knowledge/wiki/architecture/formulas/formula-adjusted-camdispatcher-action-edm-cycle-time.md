---
title: Formula — router · edm_cycle_time
type: formula
formula_id: formula.adjusted.camdispatcher.action.edm_cycle_time
...
| Field | Value |
|-------|-------|
| Name | `router · edm_cycle_time` |
| Graph node | `formula.adjusted.camdispatcher.action.edm_cycle_time` |
| Kind | dispatcher_router |
