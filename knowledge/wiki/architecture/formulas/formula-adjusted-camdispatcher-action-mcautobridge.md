---
title: Formula — router · mcAutoBridge
type: formula
formula_id: formula.adjusted.camdispatcher.action.mcautobridge
...
| Field | Value |
|-------|-------|
| Name | `router · mcAutoBridge` |
| Graph node | `formula.adjusted.camdispatcher.action.mcautobridge` |
| Kind | dispatcher_router |
