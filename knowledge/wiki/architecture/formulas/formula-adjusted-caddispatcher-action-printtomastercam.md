---
title: Formula — router · printToMastercam
type: formula
formula_id: formula.adjusted.caddispatcher.action.printtomastercam
...
# Formula — `router · printToMastercam`
...
| Field | Value |
|-------|-------|
| Name | `router · printToMastercam` |
| Graph node | `formula.adjusted.caddispatcher.action.printtomastercam` |
| Kind | dispatcher_router |
