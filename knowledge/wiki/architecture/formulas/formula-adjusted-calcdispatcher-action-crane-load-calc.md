---
title: Formula — router · crane_load_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.crane_load_calc
...
# Formula — `router · crane_load_calc`
...
| Field | Value |
|-------|-------|
| Name | `router · crane_load_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.crane_load_calc` |
| Kind | dispatcher_router |
