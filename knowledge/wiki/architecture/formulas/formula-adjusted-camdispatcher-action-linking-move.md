---
title: Formula — router · linking_move
type: formula
formula_id: formula.adjusted.camdispatcher.action.linking_move
...
| Field | Value |
|-------|-------|
| Name | `router · linking_move` |
| Graph node | `formula.adjusted.camdispatcher.action.linking_move` |
| Kind | dispatcher_router |
