---
title: Formula — router · edm_wire_calc
type: formula
formula_id: formula.adjusted.calcdispatcher.action.edm_wire_calc
...
| Field | Value |
|-------|-------|
| Name | `router · edm_wire_calc` |
| Graph node | `formula.adjusted.calcdispatcher.action.edm_wire_calc` |
| Kind | dispatcher_router |
