---
title: Formula — router · tool_end_usage
type: formula
formula_id: formula.adjusted.businessdispatcher.action.tool_end_usage
...
| Field | Value |
|-------|-------|
| Name | `router · tool_end_usage` |
| Graph node | `formula.adjusted.businessdispatcher.action.tool_end_usage` |
| Kind | dispatcher_router |
