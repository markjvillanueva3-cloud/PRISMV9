---
title: Formula — router · nl_cam_command
type: formula
formula_id: formula.adjusted.cpldispatcher.action.nl_cam_command
...
| Field | Value |
|-------|-------|
| Name | `router · nl_cam_command` |
| Graph node | `formula.adjusted.cpldispatcher.action.nl_cam_command` |
| Kind | dispatcher_router |
