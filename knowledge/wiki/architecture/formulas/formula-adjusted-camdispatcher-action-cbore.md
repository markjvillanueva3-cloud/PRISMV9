---
title: Formula — router · cbore
type: formula
formula_id: formula.adjusted.camdispatcher.action.cbore
...
|-------|-------|
| Name | `router · cbore` |
| Graph node | `formula.adjusted.camdispatcher.action.cbore` |
| Kind | dispatcher_router |
