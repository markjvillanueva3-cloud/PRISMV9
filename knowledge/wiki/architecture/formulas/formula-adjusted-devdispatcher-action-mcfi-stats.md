---
title: Formula — router · mcfi_stats
type: formula
formula_id: formula.adjusted.devdispatcher.action.mcfi_stats
...
| Field | Value |
|-------|-------|
| Name | `router · mcfi_stats` |
| Graph node | `formula.adjusted.devdispatcher.action.mcfi_stats` |
| Kind | dispatcher_router |
