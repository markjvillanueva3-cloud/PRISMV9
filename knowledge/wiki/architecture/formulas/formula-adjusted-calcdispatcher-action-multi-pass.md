---
title: Formula — router · multi_pass
type: formula
formula_id: formula.adjusted.calcdispatcher.action.multi_pass
...
| Field | Value |
|-------|-------|
| Name | `router · multi_pass` |
| Graph node | `formula.adjusted.calcdispatcher.action.multi_pass` |
| Kind | dispatcher_router |
