---
title: Formula — router · gse_all
type: formula
formula_id: formula.adjusted.devdispatcher.action.gse_all
...
|-------|-------|
| Name | `router · gse_all` |
| Graph node | `formula.adjusted.devdispatcher.action.gse_all` |
| Kind | dispatcher_router |
