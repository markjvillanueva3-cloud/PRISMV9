---
title: Formula — router · summary
type: formula
formula_id: formula.adjusted.devdispatcher.action.summary
...
|-------|-------|
| Name | `router · summary` |
| Graph node | `formula.adjusted.devdispatcher.action.summary` |
| Kind | dispatcher_router |
