...
(session roll-up). Sits next to the existing F3 [[telemetry-engine]] but
...
Real owner: hotel slot. See [[reference-acp-ms6-closeout-2026-05-23]].

## Related

[[ACP-MS6]] · [[automation-chain]] · [[telemetry-engine]] · [[prism_telemetry]] · [[reference-acp-ms6-closeout-2026-05-23]] · [[reference-h8-misattribution-2026-05-20]] · [[feedback-conflict-fork-rule]] · [[feedback-psn-definition]]
