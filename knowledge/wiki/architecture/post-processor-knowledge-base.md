...
- **Alarms (2,588 / 13 controllers):** `src/data/controller-alarm-database.json`. **Underused synergy:** alarm-aware post-gen (cross-check emitted G/M vs known controller alarms) is NOT yet wired into the pipeline P5 safety phase — high-value future build.
...
4. **Alarms** ⚠ — `controller-alarm-database.json` (2,588 / 13 ctrl) NOT wired into pipeline P5 (alarm-aware post-gen gap).
