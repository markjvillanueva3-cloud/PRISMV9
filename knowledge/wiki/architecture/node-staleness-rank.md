...
**Status:** stub-placeholder. Auto-created 2026-05-20 by U-SAF-C2 (SYSTEM-AWARENESS-FRESHNESS-MS0 Phase 2) to resolve a broken `[[node-staleness-rank]]` wikilink found in the awareness baseline audit.
...
```
grep -rn '\[\[node-staleness-rank\]\]' H:/prism --include='*.md' --include='*.mjs' --include='*.ts'
```
