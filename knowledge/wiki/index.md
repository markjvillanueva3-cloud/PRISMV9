...
Last refreshed: 2026-06-10 — 1256 catalog entries (metadata stamp by regen-wiki-index-meta; entry bodies unchanged).
...
<!-- ARCH-ENGINES-START -->
- engines under `other`: 874 entries — see `knowledge/wiki/architecture/engines/other/`
...
- engines under `dev`: 100 entries — see `knowledge/wiki/architecture/engines/dev/`
- engines under `ai`: 93 entries — see `knowledge/wiki/architecture/engines/ai/`
- engines under `cam`: 76 entries — see `knowledge/wiki/architecture/engines/cam/`
- engines under `cad`: 67 entries — see `knowledge/wiki/architecture/engines/cad/`
...
- engines under `adaptive`: 26 entries — see `knowledge/wiki/architecture/engines/adaptive/`
- engines under `milling`: 26 entries — see `knowledge/wiki/architecture/engines/milling/`
- engines under `shop`: 23 entries — see `knowledge/wiki/architecture/engines/shop/`
...
- engines under `session`: 21 entries — see `knowledge/wiki/architecture/engines/session/`
- engines under `post`: 20 entries — see `knowledge/wiki/architecture/engines/post/`
- engines under `turning`: 19 entries — see `knowledge/wiki/architecture/engines/turning/`
...
- engines under `registry`: 17 entries — see `knowledge/wiki/architecture/engines/registry/`
...
- engines under `quoting`: 3 entries — see `knowledge/wiki/architecture/engines/quoting/`
...
<!-- ARCH-TESTS-START -->
_Total: 4747 per-test wiki entries across 270 groups — see [[tests-index]]._
