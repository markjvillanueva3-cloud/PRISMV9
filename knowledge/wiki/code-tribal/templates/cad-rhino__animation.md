---
title: "CAD function template — rhino / animation"
software: rhino
function: animation
...
# CAD function template — rhino / animation

**Software:** `rhino` · **Function category:** `animation`
**Source:** aggregated from 1 video tribal tips across 1 unique tutorial videos.

## Canonical prompt pattern

When a chat asks "do <animation> in <rhino>" or invokes [[tribal-by-domain-inject]] with domain=cad matching, this template surfaces.
...
This template is consumed by the assembly-generation AI when it needs to synthesize `animation` operations in `rhino`. The aggregated tips act as few-shot priors. Closed-loop flow:
