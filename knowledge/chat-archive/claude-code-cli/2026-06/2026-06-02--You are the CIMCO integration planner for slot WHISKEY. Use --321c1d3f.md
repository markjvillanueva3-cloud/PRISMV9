...
title: "You are the CIMCO integration planner for slot WHISKEY. Use the capability brief"
date: "2026-06-02"
first_ts: "2026-06-02T15:16:03.917Z"
last_ts: "2026-06-02T15:16:29.770Z"
cwd: "H:\\PRISM"
messages: 2
user_msgs: 1
assistant_msgs: 1
raw_file: "H:/.claude/projects/H--prism/321c1d3f-573b-4b70-b640-f87f9336e18a/subagents/workflows/wf_0b33138a-b21/agent-ad526f57d249f02b0.jsonl"
tags:
  - "chat-archive"
  - "claude-code-cli"
...
# You are the CIMCO integration planner for slot WHISKEY. Use the capability brief

> **claude-code-cli** | 2026-06-02 | 2 msgs (1 user / 1 assistant) | cwd: H:\PRISM
> Raw: `H:/.claude/projects/H--prism/321c1d3f-573b-4b70-b640-f87f9336e18a/subagents/workflows/wf_0b33138a-b21/agent-ad526f57d249f02b0.jsonl`

## Transcript

### User | 2026-06-02T15:16:03.917Z

You are the CIMCO integration planner for slot WHISKEY. Use the capability brief below + your galaxy context to (a) plot what this galaxy builds/does to fully utilize CIMCO, and (b) DRAFT wiki + tribal knowledge establishing that CIMCO checks programs/posts + simulates.

FRAMING: MACHINING - LATHE: verify lathe + mill-turn (C+Y) programs via CIMCO turning backplot + machine sim; chuck-jaw/tailstock collision; build Okuma/Haas lathe machine defs. Lathe Wizard prove-out.

First read your galaxy memory if present: mcp-server/src/engines/lathe/MEMORY.md (and skim the galaxy CLAUDE.md in the same dir). Read relevant CIMCO local files under H:/prism/resources/cimco-2026/CIMCOEdit/ as needed.
