...
type: "chat-session"
source: "codex"
session_id: "019df8cf-e2ef-7f43-bdf6-c9d7ec58579c"
title: "# AGENTS.md instructions for H:\\prism-iooms0\\mcp-server <!-- AUTO-MIRRORED FROM "
date: "2026-05-05"
first_ts: "2026-05-05T15:44:28.388Z"
last_ts: "2026-05-05T15:44:36.715Z"
cwd: "H:\\prism-iooms0\\mcp-server"
messages: 5
user_msgs: 3
assistant_msgs: 2
raw_file: "C:/Users/wompu/.codex/sessions/2026/05/05/rollout-2026-05-05T10-44-26-019df8cf-e2ef-7f43-bdf6-c9d7ec58579c.jsonl"
tags:
  - "chat-archive"
  - "codex"
...
> Raw: `C:/Users/wompu/.codex/sessions/2026/05/05/rollout-2026-05-05T10-44-26-019df8cf-e2ef-7f43-bdf6-c9d7ec58579c.jsonl`

## Transcript

### User | 2026-05-05T15:44:28.390Z
...
### Assistant | 2026-05-05T15:44:36.644Z

It depends on the access pattern.

Use a **hashmap** when you need:
- Fast average-case lookup/insert/delete by exact key: usually `O(1)`
- No ordering requirement
- Keys are hashable and equality-based
- Most common default for caches, ID lookups, grouping, memoization

Use a **btree** when you need:
- Sorted iteration by key
- Range queries: `a..b`, prefix-like scans, nearest lower/upper key
- Deterministic key order
- Better locality for large ordered maps
- Stable worst-case `O(log n)` behavior

Rule of thumb: if the code only does `get(key)`, `set(key)`, `has(key)`, use a hashmap. If it ever asks “what comes next?”, “give me everything between X and Y”, or “iterate in sorted order”, use a btree.

Paste the code and I can give the exact choice.
