...
3. **Not redundant with already-wired hooks** — if 3 Stop cleanup hooks already exist (fleet-reaper-stop + bash-orphan-cleaner + cleanup-orchestrator), a 4th general-cleanup hook is overhead.
