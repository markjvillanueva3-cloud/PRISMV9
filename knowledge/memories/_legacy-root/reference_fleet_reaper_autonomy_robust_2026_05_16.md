...
source: prism-memory
synced: 2026-05-18T01:02:09.300Z
aliases: reference_fleet_reaper_autonomy_robust_2026_05_16
---


# FLEET-REAPER autonomy + enumeration-robustness hardening
...
H:/prism/.claude/helpers/install-fleet-reaper-task.ps1 -RunNow`.
...
## Related
[[skills/while|/while]] • [[skills/prism|/prism]] • [[skills/helpers|/helpers]] • [[skills/install-fleet-reaper-task|/install-fleet-reaper-task]]