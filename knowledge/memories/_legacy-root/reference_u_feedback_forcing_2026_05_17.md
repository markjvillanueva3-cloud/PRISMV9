...
**Recovery context:** old lima chat crashed leaving no in-flight handoff, no slot-task-claim, no chat-bus mentions. Lima's last documented work was RGS-TOOL-AUTOINVOKE-MS1 P0 close-out (`b287c1614`/`f32c4678a`). "Where it left off" = next unit in the MS1 punch-list documented order. P1 backlog remaining after this: U-RIE-ADAPTER, U-CALIBRATION, U-TRANSFER.


## Related
[[skills/pick-unit|/pick-unit]] • [[skills/checkin|/checkin]] • [[skills/loop|/loop]] • [[skills/shared|/shared]] • [[skills/helpers|/helpers]] • [[skills/stable-session-id|/stable-session-id]]