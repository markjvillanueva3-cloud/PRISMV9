...
metadata:  
source: prism-memory
synced: 2026-05-18T01:02:09.214Z
...
**Composition:** Sister to fleet-reaper-stop (cross-session slot reaping) + node-process-janitor (broad orphan reap) + cleanup-orchestrator. bash-orphan-cleaner fills the per-session bash.exe leaf-cleanup niche that the others don't cover.
...
## Related
[[skills/loop|/loop]] • [[skills/wompu|/wompu]] • [[skills/settings|/settings]] • [[skills/high-value-additions-rank|/high-value-additions-rank]] • [[skills/prism|/prism]]