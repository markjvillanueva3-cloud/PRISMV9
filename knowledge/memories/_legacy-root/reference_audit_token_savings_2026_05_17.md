...
metadata:  
source: prism-memory
synced: 2026-05-18T01:02:09.197Z
...
- **P0 F3** — Ollama offload 9.6% vs 30% target. fleet-reaper-coordinator fires 440× with 0 conversions. Fix: drop INJECT_THRESHOLD 0.90→0.80, remove `/`-prefix skip at ollama-auto-router.mjs:166.
...
## Related
[[skills/prism|/prism]] • [[skills/scripts|/scripts]] • [[skills/token-savings-rank|/token-savings-rank]] • [[skills/shared|/shared]] • [[skills/token-savings-history|/token-savings-history]] • [[skills/specs|/specs]] • [[skills/wiki|/wiki]] • [[skills/architecture|/architecture]] • [[skills/audit-token-savings-|/audit-token-savings-]] • [[skills/loop|/loop]]