...
metadata:  
source: prism-memory
synced: 2026-05-18T01:02:07.970Z
aliases: feedback_auto_close_out
---


# Always close out completed units — automated detection + manual verification
...
## Related
[[skills/handoff|/handoff]] • [[skills/pick-unit|/pick-unit]] • [[skills/loop|/loop]] • [[skills/checkin|/checkin]] • [[skills/prism|/prism]] • [[skills/scripts|/scripts]] • [[skills/audit-close-out-candidates|/audit-close-out-candidates]] • [[skills/close-out-audit|/close-out-audit]] • [[skills/shared|/shared]] • [[skills/commands|/commands]]