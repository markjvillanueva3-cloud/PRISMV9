...
metadata:  
source: prism-memory
synced: 2026-05-18T01:02:10.042Z
...
- **recommend** — surface SlashCommandRecommenderEngine. Shell placeholder; U-CK15+ feedback loop.
...
**Deferred follow-ups** (logged for U-CK02 / U-CK03 / U-CK15+):
...
- **U-CK15+** — closed feedback loop (record → AdaptiveThresholds).
...
## Related
[[engines/SlashCommandRecommenderEngine|SlashCommandRecommenderEngine]] • [[dispatchers/prism_session|prism_session]] • [[skills/loop|/loop]] • [[skills/kernel|/kernel]] • [[skills/psk|/psk]] • [[skills/src|/src]] • [[skills/slot|/slot]] • [[skills/branch|/branch]] • [[skills/repo|/repo]] • [[skills/topic|/topic]]