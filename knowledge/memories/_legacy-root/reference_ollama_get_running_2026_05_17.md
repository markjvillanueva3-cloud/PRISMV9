...
metadata:  
source: prism-memory
synced: 2026-05-18T01:02:09.639Z
...
- nomic-embed-text load times out under contention from fleet hook fires (~1300 ollama-task-offloader fires + 747 fleet-reaper-coordinator + 2 engine-api-extractor in last 24h).
...
## Related
[[skills/api|/api]] • [[skills/generate|/generate]] • [[skills/pull|/pull]]