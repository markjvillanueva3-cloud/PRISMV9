...
source: prism-memory
synced: 2026-05-18T01:02:09.205Z
...
| `PRISM_AUTO_RESUME_MAX_AGE_MIN` | `240` | Drop handoffs older than this |
...
## Related
[[skills/checkin|/checkin]] • [[skills/hook|/hook]] • [[skills/settings|/settings]] • [[skills/compact|/compact]] • [[skills/precompact|/precompact]] • [[skills/prism|/prism]] • [[skills/helpers|/helpers]] • [[skills/per-agent-handoff|/per-agent-handoff]] • [[skills/hooks|/hooks]] • [[skills/session-start-auto-resume|/session-start-auto-resume]]