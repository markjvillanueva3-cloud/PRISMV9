...
source: prism-memory
synced: 2026-05-18T01:02:09.428Z
...
- [[reference_fleet_reaper_ms1]] — sibling action-classification pattern (4-bucket WIRE/ARCHIVE/REVIEW/KEEP echoes the fleet-reaper's confirm-after-N-ticks)


## Related
[[engines/CrossProcessEpisodicMemoryEngine|CrossProcessEpisodicMemoryEngine]] • [[engines/ChainOfThoughtEngine|ChainOfThoughtEngine]] • [[dispatchers/prism_session|prism_session]] • [[dispatchers/prism_agent|prism_agent]] • [[dispatchers/prism_dev|prism_dev]] • [[skills/audit-hook-wiring|/audit-hook-wiring]] • [[skills/shared|/shared]] • [[skills/schema|/schema]] • [[skills/system-viz-node-dispatch|/system-viz-node-dispatch]] • [[skills/web|/web]]