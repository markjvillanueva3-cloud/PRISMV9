...
metadata:  
source: prism-memory
synced: 2026-05-18T01:02:09.296Z
...
chats active. fleet-reaper isn't enough since it drops during alpha's
compaction."*

## Why fleet-reaper alone wasn't enough
...
## Related
[[skills/compact|/compact]] • [[skills/fleet-memory-monitor|/fleet-memory-monitor]] • [[skills/helpers|/helpers]] • [[skills/install-fleet-memory-monitor-task|/install-fleet-memory-monitor-task]] • [[skills/register-fleet-memory-task-unelevated|/register-fleet-memory-task-unelevated]] • [[skills/shared|/shared]] • [[skills/fleet-memory-history|/fleet-memory-history]] • [[skills/fleet-memory-monitor-state|/fleet-memory-monitor-state]] • [[skills/wiki|/wiki]] • [[skills/architecture|/architecture]]