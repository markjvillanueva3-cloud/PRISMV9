...
metadata:  
source: prism-memory
synced: 2026-05-18T01:02:09.270Z
...
- **Fleet Reaper** (`/fleet-reaper`, golf owns it per [[feedback_golf_owns_reaper]]):
  slot-aware orphan reaper, scheduled task every 5min, confirm-after-10min gate.
- **Fleet Memory Monitor** ([[reference_fleet_memory_monitor_2026_05_16]]):
...
## Related
[[engines/OllamaHookBridgeEngine|OllamaHookBridgeEngine]] • [[skills/system-viz|/system-viz]] • [[skills/shared|/shared]] • [[skills/system-graph|/system-graph]] • [[skills/system-viz-query|/system-viz-query]] • [[skills/wired|/wired]] • [[skills/orphan|/orphan]] • [[skills/dispatcher|/dispatcher]] • [[skills/action|/action]] • [[skills/master-index|/master-index]]