...
source: prism-memory
synced: 2026-05-18T01:02:09.997Z
...
3. `chatIdFromInput(input)` + `getDomainTokens({chatId})` — reuse wiki-domain-bias helper (no fallback to peer slot)
...
## Related
[[skills/hooks|/hooks]] • [[skills/tribal-by-domain-inject|/tribal-by-domain-inject]] • [[skills/settings|/settings]] • [[skills/grinder|/grinder]] • [[skills/sinker|/sinker]] • [[skills/pcd|/pcd]] • [[skills/blueprint-ocr|/blueprint-ocr]] • [[skills/catia|/catia]] • [[skills/solidcam|/solidcam]] • [[skills/powermill|/powermill]]