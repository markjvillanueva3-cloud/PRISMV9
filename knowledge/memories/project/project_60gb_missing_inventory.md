---
name: 60GB Missing Inventory — Re-Audit Pending
description: Major engines/skills/scripts/schemas/folders missing from current PRISM checkout (60GB+); blocks gap-fix work until other chat finishes audit
type: project
