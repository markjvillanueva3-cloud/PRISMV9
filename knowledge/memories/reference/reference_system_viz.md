...
description: Live 3D system map (10 layers, 334 nodes, 627 edges) showing every part of PRISM — frontend, dispatchers, engines, registries, filesystem. Use for roadmap planning, refactor blast-radius, conflict avoidance, and onboarding.
type: reference
