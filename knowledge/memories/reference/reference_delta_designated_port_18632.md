...
> **⚠️ SUPERSEDED 2026-06-18 (slot:delta, verified live):** The CAD-drawing bridge (`PRISMBridgeCAD`) binds **18362**; **18632 is dead** (HTTP 000, nothing bound). The "possible typo" flagged below is now CONFIRMED — `18632` is a digit-transposition of `18362`. Canonical: [[reference_delta_cad_drawing_port_18362]]. Text below retained for history.
