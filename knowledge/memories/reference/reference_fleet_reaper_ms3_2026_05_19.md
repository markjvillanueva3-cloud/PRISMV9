...
description: FLEET-REAPER-MS3 — 4-unit chat-capacity upgrade shipped 2026-05-19, slot charlie. Reframes the reaper from "kill more orphans" → "keep live chats at full capacity." Solves 13-live-chat memory squeeze where reaper has nothing to reap.
aliases: [fleet-reaper-ms3, Fleet Reaper MS3]
metadata:
  type: reference
---
