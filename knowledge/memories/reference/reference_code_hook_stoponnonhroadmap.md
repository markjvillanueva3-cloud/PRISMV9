---
name: reference_code_hook_stoponnonhroadmap
description: "tier: T4"
metadata:
  type: reference
  kind: code-hook
  galaxy: unassigned
  sourcePath: .claude/hooks/stop_on_non_h_roadmap.mjs
  sourceHash: 8b0f8456
  loc: 11
aliases: stop_on_non_h_roadmap.mjs
---

# stop_on_non_h_roadmap.mjs -- Hook SUMMARY

> Auto-generated by `scripts/code-to-vault.mjs` (CODE-VAULT-BRIDGE, slot:sierra). Re-run to refresh.
> generatedAt: 2026-07-03T03:00:00Z  |  source: `.claude/hooks/stop_on_non_h_roadmap.mjs` (11 LOC)
