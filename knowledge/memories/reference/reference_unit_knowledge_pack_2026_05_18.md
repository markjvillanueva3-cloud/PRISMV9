...
description: U-UKP01 — per-unit knowledge-pack composer that gives a chat slot all Obsidian+wiki+graph+tribal+git knowledge dedicated to the unit it is working on
metadata:
  type: reference
---
