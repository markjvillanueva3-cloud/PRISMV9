...
The only remaining work is the feature-engineering itself (wire `graph_heterophily_aggregate` into
the train pipeline). Hardware doctrine: [[feedback_build_for_blackwell_hardware]].
