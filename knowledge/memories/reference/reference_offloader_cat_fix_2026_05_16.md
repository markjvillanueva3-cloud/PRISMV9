...
- **Gap #2** [[reference_scrutiny_verdict_persist_2026_05_16|scrutiny-verdict-persist]].mjs Stop hook — capture the 3-of-3 ledger + per-file verdicts (which contain the actual Unicode-bypass findings) into Obsidian as a second permanent memory bank. Without this, 6 detailed scrutiny reports from THIS commit just evaporate.
