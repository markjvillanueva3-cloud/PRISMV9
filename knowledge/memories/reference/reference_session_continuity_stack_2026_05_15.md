...
type: reference
source: prism-memory
synced: 2026-06-09T14:54:10.925Z
---
...
- Validates handoff age via `written_at:` frontmatter — handoffs older than 720 min / 12h (knob: `PRISM_AUTO_RESUME_MAX_AGE_MIN`; was 240/4h until F5 2026-06-08 — new-PC GPU/OCR bakes routinely exceed 4h) emit a "stale, treat as fresh" hint instead of resuming.
...
- `PRISM_AUTO_RESUME_MAX_AGE_MIN=N` — staleness threshold (default 720 = 12h; was 240/4h until F5 2026-06-08)
