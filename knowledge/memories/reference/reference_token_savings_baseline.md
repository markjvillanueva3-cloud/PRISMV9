...
description: Snapshot of Ollama offload telemetry — 69.2% offload rate, ~41K tokens saved over 10 days. Per-hook breakdown shows ollama-obsidian-rag advisory-only.
type: reference
