...
description: SUPERSEDED 2026-06-18 — the live CAD-drawing bridge binds 18362, NOT 18632 (digit-transposition, verified). Canonical: [[reference_delta_cad_drawing_port_18362]].
type: reference
source: prism-memory
...
> **⚠️ SUPERSEDED 2026-06-18 (slot:delta, verified live):** The CAD-drawing bridge (`PRISMBridgeCAD`) binds **18362** (HTTP 404 listener up); **18632 is dead** (HTTP 000). `18632` is a digit-transposition of `18362`. Canonical: [[reference_delta_cad_drawing_port_18362]]. The line below ("18632 ≠ 18365, not a transposition") is true vs. 18365 but misses that 18632 IS a transposition of 18362. Text retained for history.
