...
description: Silent memory-compact crash. acquireLock dereferenced holder.ts without null-guard; 0-byte stale lockfile fail-soft-degraded every Stop-hook auto-compact for ~6h; MEMORY.md hit 99.19% truncation ceiling fleet-wide.
metadata:
  type: reference
---
