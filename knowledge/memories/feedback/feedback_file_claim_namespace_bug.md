...
description: file-claim-guard.mjs is supposed to block edits to files claimed by peer chats, but identity strings differ between chat schemes (Agent@MARKV/pid-XXX vs MarkV-XXXXX), so a chat using one scheme can edit a file claimed under the other. Real race observed 2026-04-27.
type: feedback
