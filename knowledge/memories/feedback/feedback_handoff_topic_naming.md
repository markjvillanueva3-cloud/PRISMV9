...
description: Per-chat handoff filenames in state/shared/handoffs/ must always end with -<topic>.md so concurrent chats never produce ambiguous topicless duplicates that overwrite each other on /compact
type: feedback
originSessionId: ce425dcc-47be-43b5-9f72-d92263f1385d
---
