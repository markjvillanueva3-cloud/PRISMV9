...
description: Standing rule for "pick a unit" — always pick from the 2 master roadmaps via /pick-unit, devtools FIRST priority, revenue second. Never from arbitrary milestones, never via Glob/Grep on milestone JSONs.
aliases: [pick-unit-routing, PICK UNIT Routing, feedback-pick-unit-routing]
type: feedback
source: prism-memory
synced: 2026-05-19T21:07:37.423Z
aliases: feedback_pick_unit_routing
---
