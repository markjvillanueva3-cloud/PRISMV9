...
type: feedback
source: prism-memory
synced: 2026-05-24T07:17:25.331Z
...
| 5 | **Tribal knowledge** | `H:/prism/knowledge/tribal/` + tribal-by-domain-inject hook | inject hook auto-fires by slot domain | tribal-density per domain |
...
- CLAUDE.md §MASTER INDEX + AWARENESS STACK (PSN leg #6 wired into the awareness pipeline)
- CLAUDE.md §AI SYSTEM ROUTING (PSN leg #11 routing rules)


## Related
[[dispatchers/prism_operating_system|prism_operating_system]] • [[dispatchers/prism_session|prism_session]] • [[dispatchers/prism_ai|prism_ai]] • [[dispatchers/prism_intelligence|prism_intelligence]] • [[skills/wompu|/wompu]] • [[skills/projects|/projects]] • [[skills/memory|/memory]] • [[skills/prism|/prism]] • [[skills/knowledge|/knowledge]] • [[skills/memories|/memories]]