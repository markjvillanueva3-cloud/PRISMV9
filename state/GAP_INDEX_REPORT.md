...
| Path | Status | Impact |
|------|--------|--------|
| `H:\prism\extracted\materials\core` | MISSING | Material layer hierarchy not created |
| `H:\prism\extracted\materials\enhanced` | MISSING | Material layer hierarchy not created |
| `H:\prism\extracted\materials\user` | MISSING | Material layer hierarchy not created |
| `H:\prism\extracted\materials\learned` | MISSING | Material layer hierarchy not created |
| `H:\prism\mcp-server\cache` | MISSING | Cache dir never created |
...
| PATH_CONFIG.json | v10, skills→`H:\prism\skills` | Should be v11, skills→`skills-consolidated` | Stale path + counts |
