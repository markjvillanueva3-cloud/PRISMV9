...
> Generated: 2026-06-26T19:55:09.114Z
...
## Silent Close-Out Debt (0 milestones · 0 hidden-shipped units)
...
_No silent close-out drift detected._


---

## Partial-Milestone Drift (46 candidates · 493 open milestones scanned)
...
|-----------|------|--------|-----:|-------|
| AI-STACK-PER-DOMAIN-MS0 | AS-charlie-L7 | WEDMProgramSafetyGateEngine | 16125 B | charlie L7 — WEDMProgramSafetyGateEngine.evaluateWithCoV (queued U-COV-WEDM, cha |
...
| AI-STACK-PER-DOMAIN-MS0 | AS-foxtrot-L7 | ChatterStabilityLobeEngine | 40086 B | foxtrot L7 — ChatterStabilityLobeEngine.predictWithCoV (queued U-COV-MILL) |
...
| AI-TRAINING-FIRST-MS0 | U-AITRAIN-CAM-CAM-DEEP-LEARNING | CAMDeepLearningEngine | 48474 B | Train CAMDeepLearningEngine on full pre-revenue corpus (JM-DIE 76K + MIT-OCW + v |
...
| AI-TRAINING-FIRST-MS0 | U-AITRAIN-MILL-FIVE-AXIS-DEEP-LEARNING | FiveAxisDeepLearningEngine | 93283 B | Train FiveAxisDeepLearningEngine on full pre-revenue corpus (JM-DIE 76K + MIT-OC |
| AI-TRAINING-FIRST-MS0 | U-AITRAIN-MILL-MILL-DEEP-LEARNING | MillDeepLearningEngine | 39516 B | Train MillDeepLearningEngine on full pre-revenue corpus (JM-DIE 76K + MIT-OCW +  |
...
| AI-TRAINING-FIRST-MS0 | U-AITRAIN-POST-CNC-CONTROLLER-DEEP-LEARNING | CNCControllerDeepLearningEngine | 40883 B | Train CNCControllerDeepLearningEngine on full pre-revenue corpus (JM-DIE 76K + M |
...
| AI-TRAINING-FIRST-MS0 | U-AITRAIN-POST-POST-PROCESSOR-META-LEARNING | PostProcessorMetaLearningEngine | 34101 B | Train PostProcessorMetaLearningEngine on full pre-revenue corpus (JM-DIE 76K + M |
...
| CROSS-DOMAIN-RAG-FEDERATION-MS0 | CDRF-01 | QdrantFederatedRetrieverEngine | 16650 B | QdrantFederatedRetrieverEngine — fans query to N collections in parallel |
...
| K2-CLOUD-MS0 | U-K2-TIER-REGISTER | AISystemRouterEngine | 14923 B | K2 — Register kimi-k2.6:cloud tier in AISystemRouterEngine (AIBackend union, KIM |
| KNOWLEDGE-WIKI-MS0 | U-WIKI02 | WikiIndexMaintainerEngine | 12901 B | WikiIndexMaintainerEngine + WikiLogAppenderEngine |
| KNOWLEDGE-WIKI-MS0 | U-WIKI03 | WikiLintEngine | 17411 B | WikiLintEngine — Safety-Aware Health Check |
| KNOWLEDGE-WIKI-MS0 | U-WIKI04 | WikiIngestRouterEngine | 16523 B | WikiIngestRouterEngine — Staged Ollama→Claude Pipeline |
