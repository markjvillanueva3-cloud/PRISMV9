# system-viz dead-pixel sweep — 2026-06-16T03:31:06.464Z

Nodes: 346349
Edges: 798101
Dead edges: 3902 (0.49%)
  ├─ advisory (intentional gap-surfacing bridges to not-yet-built nodes): 3678
  └─ DEFECT (structural edges that should connect real nodes): 224  ← triage these
...
## Dead-edge count by edge type (advisory vs defect)
    ...
    1461  enriches-engine  [advisory]
     105  synergy  [defect]
      57  contains  [defect]
      50  ghost-wire-validation  [defect]
     ...
     414  engine.PrismTrainingModuleEngine
      ...
      10  domain:work
       ...
       3  engine.ShopSafetyValidationEngine
         e.g. from: college.course.1_basic_training_day_1, college.course.2_basic_training_day_2, college.course.3_basic_training_day_3
       2  disp.prism_edm
         e.g. from: ghost.vault-wired.SinkerEDMElectrodeInspectionEngine
