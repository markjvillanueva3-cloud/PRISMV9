...
**Auto-generated:** 2026-06-27T19:50:59.359Z  ·  Regenerated each SessionStart by `generate-claude-brief.mjs`.
...
- Engines: 3850  ·  Dispatchers: 112  ·  Actions: ?  ·  Hooks: 54
...
_(system-graph.json missing — run `/system-viz` or `node scripts/generate-system-viz.mjs`)_

## Wiki brain (live · auto-generated from the system-viz graph)

**71738 architecture wiki entries** under `knowledge/wiki/architecture/` — one per engine, action, dispatcher, registry, layer, domain, skill, hook, formula, algorithm, milestone, monolith category, frontend, JM-Die customer, combo, design-spec. (The graph's `meta.headline.wikiEntries` ≈776 only counts `index.md` lines — **71738** is the real number; source of truth: `knowledge/wiki/architecture/_stats.md`.)

**Breakdown:** memory-reference:20322 · action:10481 · architecture:9576 · code-tribal:8468 · formula:7316 · engine:4750 · tribal-tip:4247 · test:1719 · skill:1556
**Orphan rate:** 8714 orphans / 46617 files (18.7%)  (rescue hub: `_orphans-rescue.md` — every orphan gets an inbound link there, so effective orphan rate ≈ 0)  ·  **Last regen:** 2026-06-27T17:43:18.608Z
**Semantic index:** 60948 int8 vectors (nomic-embed-text, 768-d) → `_embeddings.jsonl` — powers the recall hook's paraphrase fallback.
...
**Memory vault:** 21429 atomic notes total · **6893** modified in last 24h.
...
**Generation:** 2026-06-27T19:50:59.359Z  ·  Last regenerated 24.4h ago.
