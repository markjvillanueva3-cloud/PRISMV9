...
**Auto-generated:** 2026-05-12T17:46:45.979Z  ·  Regenerated each SessionStart by `generate-claude-brief.mjs`.
...
- Engines: 3192  ·  Dispatchers: 97  ·  Actions: ?  ·  Hooks: 54
...
**Total:** 19,950 nodes · 75,511 edges · graph generated 2026-05-12T15:19:43.097Z

**Headline:** 2302 engines wired · 883 unwired · 4 envelope drift · 2 frontend merges pending · 23585 wiki entries

**Layers:** L0=5 · L1=19 · L10=19,557 · L2=8 · L3=13 · L4=97 · L5=41 · L6=10 · L7=27 · L8=87 · L9=86
...
**23585 architecture wiki entries** under `knowledge/wiki/architecture/` — one per engine, action, dispatcher, registry, layer, domain, skill, hook, formula, algorithm, milestone, monolith category, frontend, JM-Die customer, combo, design-spec. (The graph's `meta.headline.wikiEntries` ≈776 only counts `index.md` lines — **23585** is the real number; source of truth: `knowledge/wiki/architecture/_stats.md`.)

**Breakdown:** action:9242 · architecture:6961 · tribal-tip:4245 · engine:1701 · skill:639 · hook:483 · code-tribal:181 · formula:80 · algorithm:53
**Orphan rate:** 179 orphans / 15912 files (1.1%)  (rescue hub: `_orphans-rescue.md` — every orphan gets an inbound link there, so effective orphan rate ≈ 0)  ·  **Last regen:** 2026-05-11T18:34:00.984Z
**Semantic index:** 14343 int8 vectors (nomic-embed-text, 768-d) → `_embeddings.jsonl` — powers the recall hook's paraphrase fallback.
...
**Memory vault:** 134 atomic notes total · **7** modified in last 24h.
...
**Generation:** 2026-05-12T17:46:45.979Z  ·  Last regenerated 0.4h ago.
