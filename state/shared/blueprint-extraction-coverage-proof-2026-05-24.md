# Blueprint Extraction Coverage Proof — 2026-05-24

Generated by `scripts/blueprint-extraction-proof-of-coverage.mjs`.
Per-page proof log: `blueprint-extraction-coverage-proof-2026-05-24.jsonl`.
...
| Total rows | 43,321 |
| Unique docs | 13,278 |
| Rows flagged drawing-likely | 13,259 |
| Rows with part numbers | 43,321 |
| Total part numbers | 251,101 |
...
1. Grep the per-page JSONL log for the `(doc_id, page_index)` of interest:
   ```bash
   grep '<doc_id>' state/shared/blueprint-extraction-coverage-proof-2026-05-24.jsonl
   ```
...
- Per-row proof JSONL: `blueprint-extraction-coverage-proof-2026-05-24.jsonl`