# AUTOGEN EXTRACT SPEC — SOLIDWORKS/SOLIDWORKS Corp/SOLIDWORKS Composer Player/Doc/swcomposerreleasenotes.pdf

Generated 2026-05-24T20:50:03.934Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `SOLIDWORKS/SOLIDWORKS Corp/SOLIDWORKS Composer Player/Doc/swcomposerreleasenotes.pdf` |
| Slug | `solidworks_solidworks_corp_solidworks_composer_player_doc_swcomposerreleasenotes_pdf` |
| Kind | `other-pdf` |
| Source path | `H:\PRISM\resources\SOLIDWORKS\SOLIDWORKS Corp\SOLIDWORKS Composer Player\Doc\swcomposerreleasenotes.pdf` |
| Size | 0.6 MB |
