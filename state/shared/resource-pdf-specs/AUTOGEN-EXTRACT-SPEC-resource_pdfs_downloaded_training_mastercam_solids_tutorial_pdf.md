# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/DOWNLOADED_TRAINING/Mastercam_Solids_Tutorial.pdf
...
| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/DOWNLOADED_TRAINING/Mastercam_Solids_Tutorial.pdf` |
| Slug | `resource_pdfs_downloaded_training_mastercam_solids_tutorial_pdf` |
| Kind | `other-pdf` |
