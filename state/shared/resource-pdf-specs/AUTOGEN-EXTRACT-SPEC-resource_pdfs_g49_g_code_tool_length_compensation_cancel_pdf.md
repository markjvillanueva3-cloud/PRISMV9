# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/G49 G-Code [Tool Length Compensation Cancel].pdf

Generated 2026-05-24T20:49:57.608Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/G49 G-Code [Tool Length Compensation Cancel].pdf` |
| Slug | `resource_pdfs_g49_g_code_tool_length_compensation_cancel_pdf` |
| Kind | `other-pdf` |
