# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/WinMax-Mill-Intro-Class-Workbook.pdf

Generated 2026-05-24T20:50:03.375Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/WinMax-Mill-Intro-Class-Workbook.pdf` |
| Slug | `resource_pdfs_winmax_mill_intro_class_workbook_pdf` |
| Kind | `other-pdf` |
