# AUTOGEN EXTRACT SPEC — PRISM CAD-CAM TRAINING/BASIC SINGLE HOLE CASING/BSHC 2C.pdf
...
| Field | Value |
|---|---|
| PDF id | `PRISM CAD-CAM TRAINING/BASIC SINGLE HOLE CASING/BSHC 2C.pdf` |
| Slug | `prism_cad_cam_training_basic_single_hole_casing_bshc_2c_pdf` |
| Kind | `other-pdf` |
