# AUTOGEN EXTRACT SPEC — SOLIDWORKS/SOLIDWORKS Corp/SOLIDWORKS Composer Player/Doc/swcomposerreleasenotesjpn.pdf
...
| Field | Value |
|---|---|
| PDF id | `SOLIDWORKS/SOLIDWORKS Corp/SOLIDWORKS Composer Player/Doc/swcomposerreleasenotesjpn.pdf` |
| Slug | `solidworks_solidworks_corp_solidworks_composer_player_doc_swcomposerreleasenotesjpn_pdf` |
| Kind | `other-pdf` |
| Source path | `H:\PRISM\resources\SOLIDWORKS\SOLIDWORKS Corp\SOLIDWORKS Composer Player\Doc\swcomposerreleasenotesjpn.pdf` |
| Size | 1 MB |
