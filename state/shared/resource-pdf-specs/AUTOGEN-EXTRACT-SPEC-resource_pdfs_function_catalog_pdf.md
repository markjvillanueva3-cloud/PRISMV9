# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/function-catalog.pdf

Generated 2026-05-24T20:49:56.757Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/function-catalog.pdf` |
| Slug | `resource_pdfs_function_catalog_pdf` |
