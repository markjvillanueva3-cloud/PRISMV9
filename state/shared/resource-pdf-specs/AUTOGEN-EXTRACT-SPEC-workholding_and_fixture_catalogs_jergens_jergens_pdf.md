# AUTOGEN EXTRACT SPEC — WORKHOLDING AND FIXTURE CATALOGS/JERGENS/JERGENS.pdf
...
| Field | Value |
|---|---|
| PDF id | `WORKHOLDING AND FIXTURE CATALOGS/JERGENS/JERGENS.pdf` |
| Slug | `workholding_and_fixture_catalogs_jergens_jergens_pdf` |
