# AUTOGEN EXTRACT SPEC — MasterCam/MASTERCAM/mcamX8/documentation/Installation_Guide.pdf
...
| Field | Value |
|---|---|
| PDF id | `MasterCam/MASTERCAM/mcamX8/documentation/Installation_Guide.pdf` |
| Slug | `mastercam_mastercam_mcamx8_documentation_installation_guide_pdf` |
| Kind | `manual-pdf` |
