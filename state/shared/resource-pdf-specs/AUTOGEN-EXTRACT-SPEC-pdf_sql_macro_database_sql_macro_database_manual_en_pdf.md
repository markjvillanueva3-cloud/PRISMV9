# AUTOGEN EXTRACT SPEC — PDF/SQL Macro Database/SQL_Macro_Database_Manual-en.pdf

Generated 2026-05-24T20:49:04.597Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `PDF/SQL Macro Database/SQL_Macro_Database_Manual-en.pdf` |
| Slug | `pdf_sql_macro_database_sql_macro_database_manual_en_pdf` |
| Kind | `manual-pdf` |
