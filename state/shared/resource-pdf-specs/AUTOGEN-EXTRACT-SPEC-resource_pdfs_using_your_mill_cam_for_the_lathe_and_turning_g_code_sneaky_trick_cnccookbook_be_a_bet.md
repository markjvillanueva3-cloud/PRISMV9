# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Using Your Mill CAM For the Lathe and Turning G-Code [ Sneaky Trick ] - CNCCookbook_ Be A Better CNC'er.pdf

Generated 2026-05-24T20:50:03.215Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Using Your Mill CAM For the Lathe and Turning G-Code [ Sneaky Trick ] - CNCCookbook_ Be A Better CNC'er.pdf` |
| Slug | `resource_pdfs_using_your_mill_cam_for_the_lathe_and_turning_g_code_sneaky_trick_cnccookbook_be_a_bet` |
| Kind | `other-pdf` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Using Your Mill CAM For the Lathe and Turning G-Code [ Sneaky Trick ] - CNCCookbook_ Be A Better CNC'er.pdf` |
| Size | 5.5 MB |
