# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Dynamic_Milling.pdf

Generated 2026-05-24T20:49:56.434Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Dynamic_Milling.pdf` |
| Slug | `resource_pdfs_dynamic_milling_pdf` |
| Kind | `other-pdf` |
