# AUTOGEN EXTRACT SPEC — PDF/Synchronization Tool Database/Synchronization_Tool_Database_Manual-en.pdf
...
| Field | Value |
|---|---|
| PDF id | `PDF/Synchronization Tool Database/Synchronization_Tool_Database_Manual-en.pdf` |
| Slug | `pdf_synchronization_tool_database_synchronization_tool_database_manual_en_pdf` |
| Kind | `manual-pdf` |
