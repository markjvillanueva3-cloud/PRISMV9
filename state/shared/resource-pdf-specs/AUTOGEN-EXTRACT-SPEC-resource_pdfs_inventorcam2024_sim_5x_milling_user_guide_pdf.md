# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/InventorCAM2024_Sim_5X_Milling_User_Guide.pdf

Generated 2026-05-24T20:50:00.075Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/InventorCAM2024_Sim_5X_Milling_User_Guide.pdf` |
| Slug | `resource_pdfs_inventorcam2024_sim_5x_milling_user_guide_pdf` |
| Kind | `manual-pdf` |
