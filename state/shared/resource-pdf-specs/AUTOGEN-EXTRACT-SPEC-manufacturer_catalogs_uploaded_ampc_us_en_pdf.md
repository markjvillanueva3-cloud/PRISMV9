# AUTOGEN EXTRACT SPEC — MANUFACTURER_CATALOGS/uploaded/AMPC_US-EN.pdf
...
| Field | Value |
|---|---|
| PDF id | `MANUFACTURER_CATALOGS/uploaded/AMPC_US-EN.pdf` |
| Slug | `manufacturer_catalogs_uploaded_ampc_us_en_pdf` |
