# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/bro-cam-strategies-en.pdf

Generated 2026-05-24T20:49:55.013Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/bro-cam-strategies-en.pdf` |
| Slug | `resource_pdfs_bro_cam_strategies_en_pdf` |
| Kind | `other-pdf` |
