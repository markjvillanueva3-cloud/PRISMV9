# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Mazak EIA - Programming Manula for Mazatrol Matrix.pdf

Generated 2026-05-24T20:50:00.803Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Mazak EIA - Programming Manula for Mazatrol Matrix.pdf` |
| Slug | `resource_pdfs_mazak_eia_programming_manula_for_mazatrol_matrix_pdf` |
| Kind | `manual-pdf` |
