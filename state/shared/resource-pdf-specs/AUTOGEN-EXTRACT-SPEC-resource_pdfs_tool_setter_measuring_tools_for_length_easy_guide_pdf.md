# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Tool Setter_ Measuring Tools for Length [Easy Guide].pdf

Generated 2026-05-24T20:50:02.847Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Tool Setter_ Measuring Tools for Length [Easy Guide].pdf` |
| Slug | `resource_pdfs_tool_setter_measuring_tools_for_length_easy_guide_pdf` |
| Kind | `manual-pdf` |
