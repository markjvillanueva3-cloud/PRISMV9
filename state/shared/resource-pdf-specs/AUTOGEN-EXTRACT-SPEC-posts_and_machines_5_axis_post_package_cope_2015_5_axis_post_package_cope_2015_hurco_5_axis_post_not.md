# AUTOGEN EXTRACT SPEC — POSTS AND MACHINES/5-Axis-Post-Package_Cope_2015/5-Axis Post Package_Cope 2015/Hurco 5-Axis Post Notes_Cope 2014.pdf
...
| Field | Value |
|---|---|
| PDF id | `POSTS AND MACHINES/5-Axis-Post-Package_Cope_2015/5-Axis Post Package_Cope 2015/Hurco 5-Axis Post Notes_Cope 2014.pdf` |
| Slug | `posts_and_machines_5_axis_post_package_cope_2015_5_axis_post_package_cope_2015_hurco_5_axis_post_not` |
| Kind | `other-pdf` |
| Source path | `H:\PRISM\resources\POSTS AND MACHINES\5-Axis-Post-Package_Cope_2015\5-Axis Post Package_Cope 2015\Hurco 5-Axis Post Notes_Cope 2014.pdf` |
| Size | 0.6 MB |
