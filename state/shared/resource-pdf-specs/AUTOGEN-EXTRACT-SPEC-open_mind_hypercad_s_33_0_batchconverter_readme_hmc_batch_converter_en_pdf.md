# AUTOGEN EXTRACT SPEC — OPEN MIND/hyperCAD-S/33.0/BatchConverter/Readme_HMC_Batch_Converter-en.pdf

Generated 2026-06-26T13:35:06.321Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `OPEN MIND/hyperCAD-S/33.0/BatchConverter/Readme_HMC_Batch_Converter-en.pdf` |
| Slug | `open_mind_hypercad_s_33_0_batchconverter_readme_hmc_batch_converter_en_pdf` |
| Kind | `other-pdf` |
