# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Why Doesn't My CNC Machine Move the Cutter Where I Told It To_!__ - CNCCookbook_ Be A Better CNC'er.pdf

Generated 2026-05-24T20:50:03.305Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Why Doesn't My CNC Machine Move the Cutter Where I Told It To_!__ - CNCCookbook_ Be A Better CNC'er.pdf` |
| Slug | `resource_pdfs_why_doesn_t_my_cnc_machine_move_the_cutter_where_i_told_it_to_cnccookbook_be_a_better_` |
| Kind | `other-pdf` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Why Doesn't My CNC Machine Move the Cutter Where I Told It To_!__ - CNCCookbook_ Be A Better CNC'er.pdf` |
| Size | 1.3 MB |
