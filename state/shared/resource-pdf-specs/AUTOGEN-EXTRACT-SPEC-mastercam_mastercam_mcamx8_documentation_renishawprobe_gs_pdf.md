# AUTOGEN EXTRACT SPEC — MasterCam/MASTERCAM/mcamX8/documentation/RenishawProbe-GS.pdf

Generated 2026-05-24T20:48:39.395Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `MasterCam/MASTERCAM/mcamX8/documentation/RenishawProbe-GS.pdf` |
| Slug | `mastercam_mastercam_mcamx8_documentation_renishawprobe_gs_pdf` |
| Kind | `other-pdf` |
