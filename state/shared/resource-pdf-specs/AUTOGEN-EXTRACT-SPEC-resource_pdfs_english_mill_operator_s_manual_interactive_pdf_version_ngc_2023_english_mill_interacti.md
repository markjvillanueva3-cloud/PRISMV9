# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/English - Mill Operator’s Manual -Interactive PDF Version - NGC - 2023 - english_mill_interactive_manual_print_version_2023.pdf

Generated 2026-05-24T20:49:56.494Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/English - Mill Operator’s Manual -Interactive PDF Version - NGC - 2023 - english_mill_interactive_manual_print_version_2023.pdf` |
| Slug | `resource_pdfs_english_mill_operator_s_manual_interactive_pdf_version_ngc_2023_english_mill_interacti` |
| Kind | `manual-pdf` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\English - Mill Operator’s Manual -Interactive PDF Version - NGC - 2023 - english_mill_interactive_manual_print_version_2023.pdf` |
| Size | 16.4 MB |
