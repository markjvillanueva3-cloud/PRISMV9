# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/CNC 501 .indd.pdf

Generated 2026-05-24T20:49:55.060Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/CNC 501 .indd.pdf` |
| Slug | `resource_pdfs_cnc_501_indd_pdf` |
| Kind | `other-pdf` |
