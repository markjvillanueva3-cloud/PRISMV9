# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/InventorCAM2024_Multiaxis_Roughing_Pt1.pdf

Generated 2026-05-24T20:49:59.576Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/InventorCAM2024_Multiaxis_Roughing_Pt1.pdf` |
| Slug | `resource_pdfs_inventorcam2024_multiaxis_roughing_pt1_pdf` |
| Kind | `other-pdf` |
