# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Quick G-Code Arc Tutorial_ Make G02 & G03 Easy, Avoid Mistakes.pdf

Generated 2026-05-24T20:50:02.379Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Quick G-Code Arc Tutorial_ Make G02 & G03 Easy, Avoid Mistakes.pdf` |
| Slug | `resource_pdfs_quick_g_code_arc_tutorial_make_g02_g03_easy_avoid_mistakes_pdf` |
| Kind | `other-pdf` |
