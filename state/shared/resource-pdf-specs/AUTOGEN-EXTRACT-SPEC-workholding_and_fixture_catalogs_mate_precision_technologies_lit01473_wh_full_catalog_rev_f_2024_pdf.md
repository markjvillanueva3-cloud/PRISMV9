# AUTOGEN EXTRACT SPEC — WORKHOLDING AND FIXTURE CATALOGS/MATE PRECISION TECHNOLOGIES/LIT01473_WH_Full_Catalog_Rev_F_2024.pdf

Generated 2026-06-26T13:35:06.369Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `WORKHOLDING AND FIXTURE CATALOGS/MATE PRECISION TECHNOLOGIES/LIT01473_WH_Full_Catalog_Rev_F_2024.pdf` |
| Slug | `workholding_and_fixture_catalogs_mate_precision_technologies_lit01473_wh_full_catalog_rev_f_2024_pdf` |
| Kind | `resource-catalog` |
| Source path | `H:\PRISM\resources\WORKHOLDING AND FIXTURE CATALOGS\MATE PRECISION TECHNOLOGIES\LIT01473_WH_Full_Catalog_Rev_F_2024.pdf` |
| Size | 17.1 MB |
