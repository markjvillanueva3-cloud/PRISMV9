# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/CNC Lathe Programming - cnc_lathe_programming-uploaded.pdf

Generated 2026-05-24T20:49:55.153Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/CNC Lathe Programming - cnc_lathe_programming-uploaded.pdf` |
| Slug | `resource_pdfs_cnc_lathe_programming_cnc_lathe_programming_uploaded_pdf` |
| Kind | `manual-pdf` |
