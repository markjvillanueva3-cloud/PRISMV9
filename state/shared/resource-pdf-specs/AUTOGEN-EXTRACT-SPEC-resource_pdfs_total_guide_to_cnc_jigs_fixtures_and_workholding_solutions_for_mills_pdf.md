# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Total Guide to CNC Jigs, Fixtures, and Workholding Solutions for Mills.pdf

Generated 2026-05-24T20:50:02.918Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Total Guide to CNC Jigs, Fixtures, and Workholding Solutions for Mills.pdf` |
| Slug | `resource_pdfs_total_guide_to_cnc_jigs_fixtures_and_workholding_solutions_for_mills_pdf` |
| Kind | `manual-pdf` |
