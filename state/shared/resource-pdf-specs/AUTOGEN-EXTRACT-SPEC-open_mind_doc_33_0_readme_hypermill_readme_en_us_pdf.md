# AUTOGEN EXTRACT SPEC — OPEN MIND/doc/33.0/Readme/hyperMILL_Readme-en-US.pdf
...
| Field | Value |
|---|---|
| PDF id | `OPEN MIND/doc/33.0/Readme/hyperMILL_Readme-en-US.pdf` |
| Slug | `open_mind_doc_33_0_readme_hypermill_readme_en_us_pdf` |
| Kind | `other-pdf` |
