# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/One Shot G-Codes and Modal G-Codes.pdf

Generated 2026-05-24T20:50:01.540Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/One Shot G-Codes and Modal G-Codes.pdf` |
| Slug | `resource_pdfs_one_shot_g_codes_and_modal_g_codes_pdf` |
| Kind | `other-pdf` |
