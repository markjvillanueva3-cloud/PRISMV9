# AUTOGEN EXTRACT SPEC — MasterCam/MASTERCAM/mcamX8/documentation/Quick_Ref_Card.pdf
...
| Field | Value |
|---|---|
| PDF id | `MasterCam/MASTERCAM/mcamX8/documentation/Quick_Ref_Card.pdf` |
| Slug | `mastercam_mastercam_mcamx8_documentation_quick_ref_card_pdf` |
| Kind | `other-pdf` |
