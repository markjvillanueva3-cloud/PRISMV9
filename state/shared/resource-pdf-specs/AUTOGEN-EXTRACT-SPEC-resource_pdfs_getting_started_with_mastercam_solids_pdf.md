# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Getting Started with Mastercam Solids.pdf

Generated 2026-05-24T20:49:57.847Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Getting Started with Mastercam Solids.pdf` |
| Slug | `resource_pdfs_getting_started_with_mastercam_solids_pdf` |
| Kind | `other-pdf` |
