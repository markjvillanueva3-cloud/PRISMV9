# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/InventorCAM2024_HSS_User_Guide.pdf

Generated 2026-05-24T20:49:59.364Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/InventorCAM2024_HSS_User_Guide.pdf` |
| Slug | `resource_pdfs_inventorcam2024_hss_user_guide_pdf` |
| Kind | `manual-pdf` |
