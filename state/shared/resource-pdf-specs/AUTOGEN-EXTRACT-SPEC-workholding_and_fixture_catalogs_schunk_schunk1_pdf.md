# AUTOGEN EXTRACT SPEC — WORKHOLDING AND FIXTURE CATALOGS/SCHUNK/SCHUNK1.pdf
...
| Field | Value |
|---|---|
| PDF id | `WORKHOLDING AND FIXTURE CATALOGS/SCHUNK/SCHUNK1.pdf` |
| Slug | `workholding_and_fixture_catalogs_schunk_schunk1_pdf` |
