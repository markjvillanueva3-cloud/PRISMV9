# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Mastercam-Wire-Tutorial.pdf

Generated 2026-05-24T20:50:00.607Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Mastercam-Wire-Tutorial.pdf` |
| Slug | `resource_pdfs_mastercam_wire_tutorial_pdf` |
| Kind | `other-pdf` |
