# AUTOGEN EXTRACT SPEC — PDF/CAM-Training-Downloaded/Fusion360-CAM-Programming-Guide.pdf

Generated 2026-05-24T20:49:03.999Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `PDF/CAM-Training-Downloaded/Fusion360-CAM-Programming-Guide.pdf` |
| Slug | `pdf_cam_training_downloaded_fusion360_cam_programming_guide_pdf` |
| Kind | `manual-pdf` |
