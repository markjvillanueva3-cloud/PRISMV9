# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Program Stop and End G-Codes [M00, M01, M02, and M30] - CNCCookbook_ Be A Better CNC'er.pdf

Generated 2026-05-24T20:50:02.027Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Program Stop and End G-Codes [M00, M01, M02, and M30] - CNCCookbook_ Be A Better CNC'er.pdf` |
| Slug | `resource_pdfs_program_stop_and_end_g_codes_m00_m01_m02_and_m30_cnccookbook_be_a_better_cnc_er_pdf` |
| Kind | `other-pdf` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Program Stop and End G-Codes [M00, M01, M02, and M30] - CNCCookbook_ Be A Better CNC'er.pdf` |
| Size | 7.3 MB |
