# AUTOGEN EXTRACT SPEC — POSTS AND MACHINES/5-Axis-Post-Package_Cope_2015/5-Axis Post Package_Cope 2015/Programming the sample part.pdf
...
| Field | Value |
|---|---|
| PDF id | `POSTS AND MACHINES/5-Axis-Post-Package_Cope_2015/5-Axis Post Package_Cope 2015/Programming the sample part.pdf` |
| Slug | `posts_and_machines_5_axis_post_package_cope_2015_5_axis_post_package_cope_2015_programming_the_sampl` |
| Kind | `manual-pdf` |
| Source path | `H:\PRISM\resources\POSTS AND MACHINES\5-Axis-Post-Package_Cope_2015\5-Axis Post Package_Cope 2015\Programming the sample part.pdf` |
| Size | 0.2 MB |
