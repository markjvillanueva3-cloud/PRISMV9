# AUTOGEN EXTRACT SPEC — PDF/CAM-Training-Downloaded/InventorHSM-Getting-Started.pdf
...
| Field | Value |
|---|---|
| PDF id | `PDF/CAM-Training-Downloaded/InventorHSM-Getting-Started.pdf` |
| Slug | `pdf_cam_training_downloaded_inventorhsm_getting_started_pdf` |
| Kind | `other-pdf` |
