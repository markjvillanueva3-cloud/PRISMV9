# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Software documentation - hyperMILL_2D_3D.pdf

Generated 2026-05-24T20:50:02.607Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Software documentation - hyperMILL_2D_3D.pdf` |
| Slug | `resource_pdfs_software_documentation_hypermill_2d_3d_pdf` |
| Kind | `other-pdf` |
