# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/RC2024-PPG-Reference.pdf

Generated 2026-05-24T20:50:02.468Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/RC2024-PPG-Reference.pdf` |
| Slug | `resource_pdfs_rc2024_ppg_reference_pdf` |
| Kind | `other-pdf` |
