# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/G-Code Coordinate Rotation, Offsets, and Scaling - CNCCookbook_ Be A Better CNC'er.pdf

Generated 2026-05-24T20:49:57.327Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/G-Code Coordinate Rotation, Offsets, and Scaling - CNCCookbook_ Be A Better CNC'er.pdf` |
| Slug | `resource_pdfs_g_code_coordinate_rotation_offsets_and_scaling_cnccookbook_be_a_better_cnc_er_pdf` |
| Kind | `other-pdf` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\G-Code Coordinate Rotation, Offsets, and Scaling - CNCCookbook_ Be A Better CNC'er.pdf` |
| Size | 7.6 MB |
