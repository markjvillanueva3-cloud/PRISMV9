# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/DOWNLOADED_TRAINING/Mastercam_Basics_Tutorial.pdf
...
| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/DOWNLOADED_TRAINING/Mastercam_Basics_Tutorial.pdf` |
| Slug | `resource_pdfs_downloaded_training_mastercam_basics_tutorial_pdf` |
| Kind | `other-pdf` |
