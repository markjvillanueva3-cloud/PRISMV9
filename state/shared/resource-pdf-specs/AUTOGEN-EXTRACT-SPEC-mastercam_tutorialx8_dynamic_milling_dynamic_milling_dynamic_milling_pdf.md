# AUTOGEN EXTRACT SPEC — MasterCam/tutorialx8-dynamic-milling/Dynamic Milling/Dynamic_Milling.pdf

Generated 2026-05-24T20:48:39.629Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `MasterCam/tutorialx8-dynamic-milling/Dynamic Milling/Dynamic_Milling.pdf` |
| Slug | `mastercam_tutorialx8_dynamic_milling_dynamic_milling_dynamic_milling_pdf` |
| Kind | `other-pdf` |
