# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/MECHANICAL ENGINEERS HANDBOOK BY BAN B. MANRGHITU.pdf

Generated 2026-05-24T20:50:01.387Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/MECHANICAL ENGINEERS HANDBOOK BY BAN B. MANRGHITU.pdf` |
| Slug | `resource_pdfs_mechanical_engineers_handbook_by_ban_b_manrghitu_pdf` |
| Kind | `other-pdf` |
