# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/CNC Lathe Programming for Turning.pdf

Generated 2026-05-24T20:49:55.218Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/CNC Lathe Programming for Turning.pdf` |
| Slug | `resource_pdfs_cnc_lathe_programming_for_turning_pdf` |
| Kind | `manual-pdf` |
