# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/FUSION CAD.pdf

Generated 2026-05-24T20:49:57.067Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/FUSION CAD.pdf` |
| Slug | `resource_pdfs_fusion_cad_pdf` |
| Kind | `other-pdf` |
