# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/G00 and G01 G-Codes_ CNC Linear Motion.pdf

Generated 2026-05-24T20:49:57.408Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/G00 and G01 G-Codes_ CNC Linear Motion.pdf` |
| Slug | `resource_pdfs_g00_and_g01_g_codes_cnc_linear_motion_pdf` |
| Kind | `other-pdf` |
