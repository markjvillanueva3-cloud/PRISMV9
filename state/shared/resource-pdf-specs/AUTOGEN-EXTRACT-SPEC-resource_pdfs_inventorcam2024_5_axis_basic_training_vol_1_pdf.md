# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/InventorCAM2024_5-Axis_Basic_Training_Vol-1.pdf

Generated 2026-05-24T20:49:58.909Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/InventorCAM2024_5-Axis_Basic_Training_Vol-1.pdf` |
| Slug | `resource_pdfs_inventorcam2024_5_axis_basic_training_vol_1_pdf` |
| Kind | `other-pdf` |
