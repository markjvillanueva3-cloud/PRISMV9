# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Post Processor Training Guide.pdf

Generated 2026-05-24T20:50:01.723Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Post Processor Training Guide.pdf` |
| Slug | `resource_pdfs_post_processor_training_guide_pdf` |
| Kind | `manual-pdf` |
