# AUTOGEN EXTRACT SPEC — WORKHOLDING AND FIXTURE CATALOGS/SCHUNK/FULLCATALOG.pdf
...
| Field | Value |
|---|---|
| PDF id | `WORKHOLDING AND FIXTURE CATALOGS/SCHUNK/FULLCATALOG.pdf` |
| Slug | `workholding_and_fixture_catalogs_schunk_fullcatalog_pdf` |
