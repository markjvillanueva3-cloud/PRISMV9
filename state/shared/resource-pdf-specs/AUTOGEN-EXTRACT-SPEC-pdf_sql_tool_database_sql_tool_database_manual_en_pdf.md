# AUTOGEN EXTRACT SPEC — PDF/SQL Tool Database/SQL_Tool_Database_Manual-en.pdf

Generated 2026-05-24T20:49:05.065Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `PDF/SQL Tool Database/SQL_Tool_Database_Manual-en.pdf` |
| Slug | `pdf_sql_tool_database_sql_tool_database_manual_en_pdf` |
| Kind | `manual-pdf` |
