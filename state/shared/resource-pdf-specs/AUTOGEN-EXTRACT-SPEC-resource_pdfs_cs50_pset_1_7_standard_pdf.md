# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/CS50 Pset 1-7 Standard.pdf

Generated 2026-05-24T20:49:55.431Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/CS50 Pset 1-7 Standard.pdf` |
| Slug | `resource_pdfs_cs50_pset_1_7_standard_pdf` |
| Kind | `other-pdf` |
