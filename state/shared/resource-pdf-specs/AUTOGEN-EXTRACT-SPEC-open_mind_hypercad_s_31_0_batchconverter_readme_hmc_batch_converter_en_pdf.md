# AUTOGEN EXTRACT SPEC — OPEN MIND/hyperCAD-S/31.0/BatchConverter/Readme_HMC_Batch_Converter-en.pdf

Generated 2026-05-24T20:49:03.432Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `OPEN MIND/hyperCAD-S/31.0/BatchConverter/Readme_HMC_Batch_Converter-en.pdf` |
| Slug | `open_mind_hypercad_s_31_0_batchconverter_readme_hmc_batch_converter_en_pdf` |
| Kind | `other-pdf` |
