# AUTOGEN EXTRACT SPEC — PDF/TOOL Builder/TOOL_Builder_Manual-en.pdf

Generated 2026-05-24T20:49:05.216Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `PDF/TOOL Builder/TOOL_Builder_Manual-en.pdf` |
| Slug | `pdf_tool_builder_tool_builder_manual_en_pdf` |
| Kind | `manual-pdf` |
