# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Okuma-OSP-P200L-Programming.pdf

Generated 2026-05-24T20:50:01.463Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Okuma-OSP-P200L-Programming.pdf` |
| Slug | `resource_pdfs_okuma_osp_p200l_programming_pdf` |
| Kind | `manual-pdf` |
