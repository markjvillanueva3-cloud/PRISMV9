# AUTOGEN EXTRACT SPEC — WORKHOLDING AND FIXTURE CATALOGS/SCHUNK/FULLCATALOG-compressed.pdf

Generated 2026-05-24T20:50:06.619Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `WORKHOLDING AND FIXTURE CATALOGS/SCHUNK/FULLCATALOG-compressed.pdf` |
| Slug | `workholding_and_fixture_catalogs_schunk_fullcatalog_compressed_pdf` |
