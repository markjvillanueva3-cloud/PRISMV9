# AUTOGEN EXTRACT SPEC — SOLIDWORKS/SOLIDWORKS Corp/SOLIDWORKS Composer Player/Doc/swcomposerreleasenoteskor.pdf

Generated 2026-06-26T13:35:06.367Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `SOLIDWORKS/SOLIDWORKS Corp/SOLIDWORKS Composer Player/Doc/swcomposerreleasenoteskor.pdf` |
| Slug | `solidworks_solidworks_corp_solidworks_composer_player_doc_swcomposerreleasenoteskor_pdf` |
| Kind | `other-pdf` |
| Source path | `H:\PRISM\resources\SOLIDWORKS\SOLIDWORKS Corp\SOLIDWORKS Composer Player\Doc\swcomposerreleasenoteskor.pdf` |
| Size | 1 MB |
