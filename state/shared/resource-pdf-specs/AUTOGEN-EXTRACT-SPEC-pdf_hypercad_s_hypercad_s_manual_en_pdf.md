# AUTOGEN EXTRACT SPEC — PDF/hyperCAD-S/hyperCAD-S_Manual-en.pdf

Generated 2026-05-24T20:49:04.341Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `PDF/hyperCAD-S/hyperCAD-S_Manual-en.pdf` |
| Slug | `pdf_hypercad_s_hypercad_s_manual_en_pdf` |
| Kind | `manual-pdf` |
