# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/DOWNLOADED_TRAINING/Mastercam_Basic_2D_Design.pdf
...
| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/DOWNLOADED_TRAINING/Mastercam_Basic_2D_Design.pdf` |
| Slug | `resource_pdfs_downloaded_training_mastercam_basic_2d_design_pdf` |
| Kind | `other-pdf` |
