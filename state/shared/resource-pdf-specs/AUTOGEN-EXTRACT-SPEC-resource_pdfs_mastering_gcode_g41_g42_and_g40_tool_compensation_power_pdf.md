# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Mastering GCode G41, G42, and G40_ Tool Compensation Power.pdf

Generated 2026-05-24T20:50:00.720Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Mastering GCode G41, G42, and G40_ Tool Compensation Power.pdf` |
| Slug | `resource_pdfs_mastering_gcode_g41_g42_and_g40_tool_compensation_power_pdf` |
| Kind | `other-pdf` |
