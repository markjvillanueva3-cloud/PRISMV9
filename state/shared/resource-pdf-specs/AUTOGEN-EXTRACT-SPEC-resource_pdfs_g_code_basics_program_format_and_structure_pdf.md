# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/G-Code Basics_ Program Format and Structure.pdf

Generated 2026-05-24T20:49:57.234Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/G-Code Basics_ Program Format and Structure.pdf` |
| Slug | `resource_pdfs_g_code_basics_program_format_and_structure_pdf` |
| Kind | `other-pdf` |
