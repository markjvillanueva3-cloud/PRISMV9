# AUTOGEN EXTRACT SPEC — PDF/CAM-Training-Downloaded/Mastercam-Basics-Tutorial.pdf
...
| Field | Value |
|---|---|
| PDF id | `PDF/CAM-Training-Downloaded/Mastercam-Basics-Tutorial.pdf` |
| Slug | `pdf_cam_training_downloaded_mastercam_basics_tutorial_pdf` |
| Kind | `other-pdf` |
