# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Feeds and Speeds [The Ultimate Guide, Updated for 2024].pdf

Generated 2026-05-24T20:49:56.705Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Feeds and Speeds [The Ultimate Guide, Updated for 2024].pdf` |
| Slug | `resource_pdfs_feeds_and_speeds_the_ultimate_guide_updated_for_2024_pdf` |
| Kind | `manual-pdf` |
