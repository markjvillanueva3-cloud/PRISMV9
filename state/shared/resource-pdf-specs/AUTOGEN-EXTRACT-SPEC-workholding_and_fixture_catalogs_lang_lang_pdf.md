# AUTOGEN EXTRACT SPEC — WORKHOLDING AND FIXTURE CATALOGS/LANG/LANG.pdf
...
| Field | Value |
|---|---|
| PDF id | `WORKHOLDING AND FIXTURE CATALOGS/LANG/LANG.pdf` |
| Slug | `workholding_and_fixture_catalogs_lang_lang_pdf` |
