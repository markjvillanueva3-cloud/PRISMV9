# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Fundamentals3DDesign-SIM-ENG-SV.pdf

Generated 2026-05-24T20:49:56.828Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Fundamentals3DDesign-SIM-ENG-SV.pdf` |
| Slug | `resource_pdfs_fundamentals3ddesign_sim_eng_sv_pdf` |
| Kind | `other-pdf` |
