# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/G-Code and M-Code List [ Easy Examples & Tutorials ].pdf
...
| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/G-Code and M-Code List [ Easy Examples & Tutorials ].pdf` |
| Slug | `resource_pdfs_g_code_and_m_code_list_easy_examples_tutorials_pdf` |
| Kind | `other-pdf` |
