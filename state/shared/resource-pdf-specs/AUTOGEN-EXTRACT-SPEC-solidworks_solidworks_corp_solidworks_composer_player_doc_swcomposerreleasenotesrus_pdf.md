# AUTOGEN EXTRACT SPEC — SOLIDWORKS/SOLIDWORKS Corp/SOLIDWORKS Composer Player/Doc/swcomposerreleasenotesrus.pdf
...
| Field | Value |
|---|---|
| PDF id | `SOLIDWORKS/SOLIDWORKS Corp/SOLIDWORKS Composer Player/Doc/swcomposerreleasenotesrus.pdf` |
| Slug | `solidworks_solidworks_corp_solidworks_composer_player_doc_swcomposerreleasenotesrus_pdf` |
| Kind | `other-pdf` |
| Source path | `H:\PRISM\resources\SOLIDWORKS\SOLIDWORKS Corp\SOLIDWORKS Composer Player\Doc\swcomposerreleasenotesrus.pdf` |
| Size | 1 MB |
