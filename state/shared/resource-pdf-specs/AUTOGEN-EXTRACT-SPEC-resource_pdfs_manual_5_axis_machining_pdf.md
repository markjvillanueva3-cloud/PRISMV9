# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Manual 5-axis machining.pdf

Generated 2026-05-24T20:50:00.512Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Manual 5-axis machining.pdf` |
| Slug | `resource_pdfs_manual_5_axis_machining_pdf` |
