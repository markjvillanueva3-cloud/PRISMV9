# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Siemens 5 axis.pdf

Generated 2026-05-24T20:50:02.536Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Siemens 5 axis.pdf` |
| Slug | `resource_pdfs_siemens_5_axis_pdf` |
| Kind | `other-pdf` |
