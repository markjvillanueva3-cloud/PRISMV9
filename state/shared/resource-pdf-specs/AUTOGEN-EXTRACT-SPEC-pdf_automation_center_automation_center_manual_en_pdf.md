# AUTOGEN EXTRACT SPEC — PDF/AUTOMATION Center/AUTOMATION_Center_Manual-en.pdf

Generated 2026-05-24T20:49:03.882Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `PDF/AUTOMATION Center/AUTOMATION_Center_Manual-en.pdf` |
| Slug | `pdf_automation_center_automation_center_manual_en_pdf` |
| Kind | `manual-pdf` |
