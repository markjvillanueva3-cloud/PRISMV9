# AUTOGEN EXTRACT SPEC — MANUFACTURER_CATALOGS/uploaded/BIG DAISHOWA High Performance Tooling Solutions Vol 5.pdf

Generated 2026-05-24T20:48:35.156Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `MANUFACTURER_CATALOGS/uploaded/BIG DAISHOWA High Performance Tooling Solutions Vol 5.pdf` |
| Slug | `manufacturer_catalogs_uploaded_big_daishowa_high_performance_tooling_solutions_vol_5_pdf` |
