# AUTOGEN EXTRACT SPEC — MasterCam/tutorialx8-tool-manager/Tool_Manager_GSG.pdf

Generated 2026-05-24T20:48:39.960Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `MasterCam/tutorialx8-tool-manager/Tool_Manager_GSG.pdf` |
| Slug | `mastercam_tutorialx8_tool_manager_tool_manager_gsg_pdf` |
| Kind | `other-pdf` |
