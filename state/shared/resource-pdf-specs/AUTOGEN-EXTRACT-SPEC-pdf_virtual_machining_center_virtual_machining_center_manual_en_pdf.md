# AUTOGEN EXTRACT SPEC — PDF/VIRTUAL Machining Center/VIRTUAL_Machining_Center_Manual-en.pdf

Generated 2026-05-24T20:49:05.299Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `PDF/VIRTUAL Machining Center/VIRTUAL_Machining_Center_Manual-en.pdf` |
| Slug | `pdf_virtual_machining_center_virtual_machining_center_manual_en_pdf` |
