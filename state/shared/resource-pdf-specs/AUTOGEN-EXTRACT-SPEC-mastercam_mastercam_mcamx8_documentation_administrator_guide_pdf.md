# AUTOGEN EXTRACT SPEC — MasterCam/MASTERCAM/mcamX8/documentation/Administrator_Guide.pdf
...
| Field | Value |
|---|---|
| PDF id | `MasterCam/MASTERCAM/mcamX8/documentation/Administrator_Guide.pdf` |
| Slug | `mastercam_mastercam_mcamx8_documentation_administrator_guide_pdf` |
| Kind | `manual-pdf` |
