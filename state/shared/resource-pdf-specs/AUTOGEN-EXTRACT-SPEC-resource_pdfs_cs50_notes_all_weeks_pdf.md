# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/CS50 Notes All Weeks.pdf

Generated 2026-05-24T20:49:55.366Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/CS50 Notes All Weeks.pdf` |
| Slug | `resource_pdfs_cs50_notes_all_weeks_pdf` |
| Kind | `other-pdf` |
