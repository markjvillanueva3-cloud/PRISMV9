# AUTOGEN EXTRACT SPEC — POSTS AND MACHINES/5-Axis-Post-Package_Cope_2015/5-Axis Post Package_Cope 2015/Tool Vector Drill cycle and New G08 2 ASR Command.pdf

Generated 2026-06-26T13:35:06.322Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `POSTS AND MACHINES/5-Axis-Post-Package_Cope_2015/5-Axis Post Package_Cope 2015/Tool Vector Drill cycle and New G08 2 ASR Command.pdf` |
| Slug | `posts_and_machines_5_axis_post_package_cope_2015_5_axis_post_package_cope_2015_tool_vector_drill_cyc` |
| Kind | `resource-catalog` |
| Source path | `H:\PRISM\resources\POSTS AND MACHINES\5-Axis-Post-Package_Cope_2015\5-Axis Post Package_Cope 2015\Tool Vector Drill cycle and New G08 2 ASR Command.pdf` |
| Size | 0.4 MB |
