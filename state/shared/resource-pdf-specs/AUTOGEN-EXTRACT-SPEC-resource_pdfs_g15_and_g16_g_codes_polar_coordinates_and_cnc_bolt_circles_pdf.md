# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/G15 and G16 G-Codes [Polar Coordinates and CNC Bolt Circles].pdf
...
| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/G15 and G16 G-Codes [Polar Coordinates and CNC Bolt Circles].pdf` |
| Slug | `resource_pdfs_g15_and_g16_g_codes_polar_coordinates_and_cnc_bolt_circles_pdf` |
| Kind | `other-pdf` |
