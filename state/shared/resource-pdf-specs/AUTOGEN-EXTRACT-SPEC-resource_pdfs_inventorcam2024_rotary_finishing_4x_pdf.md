# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/InventorCAM2024_Rotary_Finishing_4X.pdf

Generated 2026-05-24T20:49:59.880Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/InventorCAM2024_Rotary_Finishing_4X.pdf` |
| Slug | `resource_pdfs_inventorcam2024_rotary_finishing_4x_pdf` |
| Kind | `other-pdf` |
