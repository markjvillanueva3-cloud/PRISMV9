# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/G76 Threading Cycle for CNC Lathes (Fanuc).pdf

Generated 2026-05-24T20:49:57.682Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/G76 Threading Cycle for CNC Lathes (Fanuc).pdf` |
| Slug | `resource_pdfs_g76_threading_cycle_for_cnc_lathes_fanuc_pdf` |
| Kind | `other-pdf` |
