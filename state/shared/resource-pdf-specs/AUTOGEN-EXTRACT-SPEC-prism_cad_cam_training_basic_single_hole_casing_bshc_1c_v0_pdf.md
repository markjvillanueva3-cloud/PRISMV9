# AUTOGEN EXTRACT SPEC — PRISM CAD-CAM TRAINING/BASIC SINGLE HOLE CASING/BSHC 1C v0.pdf
...
| Field | Value |
|---|---|
| PDF id | `PRISM CAD-CAM TRAINING/BASIC SINGLE HOLE CASING/BSHC 1C v0.pdf` |
| Slug | `prism_cad_cam_training_basic_single_hole_casing_bshc_1c_v0_pdf` |
| Kind | `other-pdf` |
