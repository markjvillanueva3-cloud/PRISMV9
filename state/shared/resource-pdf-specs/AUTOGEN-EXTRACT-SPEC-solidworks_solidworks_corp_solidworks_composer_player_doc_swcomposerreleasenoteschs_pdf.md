# AUTOGEN EXTRACT SPEC — SOLIDWORKS/SOLIDWORKS Corp/SOLIDWORKS Composer Player/Doc/swcomposerreleasenoteschs.pdf

Generated 2026-05-24T20:50:04.010Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `SOLIDWORKS/SOLIDWORKS Corp/SOLIDWORKS Composer Player/Doc/swcomposerreleasenoteschs.pdf` |
| Slug | `solidworks_solidworks_corp_solidworks_composer_player_doc_swcomposerreleasenoteschs_pdf` |
| Kind | `other-pdf` |
| Source path | `H:\PRISM\resources\SOLIDWORKS\SOLIDWORKS Corp\SOLIDWORKS Composer Player\Doc\swcomposerreleasenoteschs.pdf` |
| Size | 1 MB |
