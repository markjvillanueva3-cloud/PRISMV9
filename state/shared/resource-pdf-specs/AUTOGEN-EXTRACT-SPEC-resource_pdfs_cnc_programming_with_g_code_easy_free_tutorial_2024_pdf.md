# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/CNC Programming with G Code_ Easy Free Tutorial [ 2024 ].pdf

Generated 2026-05-24T20:49:55.264Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/CNC Programming with G Code_ Easy Free Tutorial [ 2024 ].pdf` |
| Slug | `resource_pdfs_cnc_programming_with_g_code_easy_free_tutorial_2024_pdf` |
| Kind | `manual-pdf` |
