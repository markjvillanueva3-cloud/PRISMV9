# AUTOGEN EXTRACT SPEC — OPEN MIND/doc/31.0/Readme/hyperMILL_hyperCAD-S_readme-en.pdf
...
| Field | Value |
|---|---|
| PDF id | `OPEN MIND/doc/31.0/Readme/hyperMILL_hyperCAD-S_readme-en.pdf` |
| Slug | `open_mind_doc_31_0_readme_hypermill_hypercad_s_readme_en_pdf` |
| Kind | `other-pdf` |
