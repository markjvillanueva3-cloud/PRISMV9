# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/javascript.pdf

Generated 2026-05-24T20:50:00.364Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/javascript.pdf` |
| Slug | `resource_pdfs_javascript_pdf` |
| Kind | `other-pdf` |
