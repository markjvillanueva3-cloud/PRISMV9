# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Programming Manual Fundamentals.pdf

Generated 2026-05-24T20:50:02.296Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Programming Manual Fundamentals.pdf` |
| Slug | `resource_pdfs_programming_manual_fundamentals_pdf` |
| Kind | `manual-pdf` |
