# AUTOGEN EXTRACT SPEC — WORKHOLDING AND FIXTURE CATALOGS/SYSTEM 3R/SYSTEM 3R.pdf
...
| Field | Value |
|---|---|
| PDF id | `WORKHOLDING AND FIXTURE CATALOGS/SYSTEM 3R/SYSTEM 3R.pdf` |
| Slug | `workholding_and_fixture_catalogs_system_3r_system_3r_pdf` |
