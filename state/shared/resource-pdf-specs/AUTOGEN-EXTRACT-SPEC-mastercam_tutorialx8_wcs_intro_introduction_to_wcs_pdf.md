# AUTOGEN EXTRACT SPEC — MasterCam/tutorialx8-wcs-intro/Introduction_to_WCS.pdf

Generated 2026-05-24T20:48:40.145Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `MasterCam/tutorialx8-wcs-intro/Introduction_to_WCS.pdf` |
| Slug | `mastercam_tutorialx8_wcs_intro_introduction_to_wcs_pdf` |
| Kind | `other-pdf` |
