# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Fundamentals_of_CNC_Machining-uploaded.pdf

Generated 2026-05-24T20:49:56.896Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Fundamentals_of_CNC_Machining-uploaded.pdf` |
| Slug | `resource_pdfs_fundamentals_of_cnc_machining_uploaded_pdf` |
