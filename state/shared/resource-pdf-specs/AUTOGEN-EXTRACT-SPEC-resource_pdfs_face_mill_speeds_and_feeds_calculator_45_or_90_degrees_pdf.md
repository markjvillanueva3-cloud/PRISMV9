# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Face Mill Speeds and Feeds [Calculator, 45 or 90 Degrees_].pdf

Generated 2026-05-24T20:49:56.608Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Face Mill Speeds and Feeds [Calculator, 45 or 90 Degrees_].pdf` |
| Slug | `resource_pdfs_face_mill_speeds_and_feeds_calculator_45_or_90_degrees_pdf` |
| Kind | `other-pdf` |
