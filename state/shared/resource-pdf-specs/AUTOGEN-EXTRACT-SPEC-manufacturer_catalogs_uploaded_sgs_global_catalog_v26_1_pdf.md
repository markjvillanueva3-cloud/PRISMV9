# AUTOGEN EXTRACT SPEC — MANUFACTURER_CATALOGS/uploaded/SGS_Global_Catalog_v26.1.pdf
...
| Field | Value |
|---|---|
| PDF id | `MANUFACTURER_CATALOGS/uploaded/SGS_Global_Catalog_v26.1.pdf` |
| Slug | `manufacturer_catalogs_uploaded_sgs_global_catalog_v26_1_pdf` |
