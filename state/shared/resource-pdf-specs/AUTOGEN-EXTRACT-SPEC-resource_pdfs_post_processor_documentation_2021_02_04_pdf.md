# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Post+Processor+Documentation+-+2021-02-04.pdf

Generated 2026-05-24T20:50:01.928Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Post+Processor+Documentation+-+2021-02-04.pdf` |
| Slug | `resource_pdfs_post_processor_documentation_2021_02_04_pdf` |
| Kind | `other-pdf` |
