# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Introduction_to_Multiaxis_Toolpaths.pdf

Generated 2026-05-24T20:49:58.662Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Introduction_to_Multiaxis_Toolpaths.pdf` |
| Slug | `resource_pdfs_introduction_to_multiaxis_toolpaths_pdf` |
| Kind | `other-pdf` |
