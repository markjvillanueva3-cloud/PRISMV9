# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Deep Hole Drilling_ Easy Guide [Tips, CNC Programming, & Video].pdf

Generated 2026-05-24T20:49:55.592Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Deep Hole Drilling_ Easy Guide [Tips, CNC Programming, & Video].pdf` |
| Slug | `resource_pdfs_deep_hole_drilling_easy_guide_tips_cnc_programming_video_pdf` |
