# AUTOGEN EXTRACT SPEC — 1- Basic Training Day 1/2D_Drawing.pdf

Generated 2026-06-26T13:35:06.261Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `1- Basic Training Day 1/2D_Drawing.pdf` |
| Slug | `1_basic_training_day_1_2d_drawing_pdf` |
| Kind | `blueprint-pdf` |
