# AUTOGEN EXTRACT SPEC — MANUFACTURER_CATALOGS/uploaded/Solid End Mills.pdf
...
| Field | Value |
|---|---|
| PDF id | `MANUFACTURER_CATALOGS/uploaded/Solid End Mills.pdf` |
| Slug | `manufacturer_catalogs_uploaded_solid_end_mills_pdf` |
