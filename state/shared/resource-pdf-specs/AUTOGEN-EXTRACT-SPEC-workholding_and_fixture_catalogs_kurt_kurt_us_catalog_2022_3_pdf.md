# AUTOGEN EXTRACT SPEC — WORKHOLDING AND FIXTURE CATALOGS/KURT/Kurt_US_Catalog_2022-3.pdf

Generated 2026-05-24T20:50:05.984Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `WORKHOLDING AND FIXTURE CATALOGS/KURT/Kurt_US_Catalog_2022-3.pdf` |
| Slug | `workholding_and_fixture_catalogs_kurt_kurt_us_catalog_2022_3_pdf` |
