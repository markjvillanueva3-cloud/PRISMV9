# AUTOGEN EXTRACT SPEC — MANUFACTURER_CATALOGS/uploaded/Tooling Systems.pdf
...
| Field | Value |
|---|---|
| PDF id | `MANUFACTURER_CATALOGS/uploaded/Tooling Systems.pdf` |
| Slug | `manufacturer_catalogs_uploaded_tooling_systems_pdf` |
