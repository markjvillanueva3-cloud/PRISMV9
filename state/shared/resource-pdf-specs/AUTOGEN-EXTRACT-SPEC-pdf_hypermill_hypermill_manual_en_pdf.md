# AUTOGEN EXTRACT SPEC — PDF/hyperMILL/hyperMILL_Manual-en.pdf

Generated 2026-05-24T20:49:04.408Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `PDF/hyperMILL/hyperMILL_Manual-en.pdf` |
| Slug | `pdf_hypermill_hypermill_manual_en_pdf` |
| Kind | `manual-pdf` |
