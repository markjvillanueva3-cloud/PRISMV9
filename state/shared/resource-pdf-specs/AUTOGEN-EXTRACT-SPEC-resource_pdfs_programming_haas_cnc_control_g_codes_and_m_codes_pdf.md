# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Programming Haas CNC Control G-Codes and M-Codes.pdf

Generated 2026-05-24T20:50:02.118Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Programming Haas CNC Control G-Codes and M-Codes.pdf` |
| Slug | `resource_pdfs_programming_haas_cnc_control_g_codes_and_m_codes_pdf` |
| Kind | `manual-pdf` |
