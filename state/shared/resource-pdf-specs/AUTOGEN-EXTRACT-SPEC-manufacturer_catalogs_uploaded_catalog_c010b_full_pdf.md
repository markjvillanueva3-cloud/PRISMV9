# AUTOGEN EXTRACT SPEC — MANUFACTURER_CATALOGS/uploaded/catalog_c010b_full.pdf

Generated 2026-05-24T20:48:35.443Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `MANUFACTURER_CATALOGS/uploaded/catalog_c010b_full.pdf` |
| Slug | `manufacturer_catalogs_uploaded_catalog_c010b_full_pdf` |
