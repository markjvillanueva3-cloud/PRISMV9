# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/Helical Interpolation for Thread Milling, Holes, and Spiral Ramps.pdf

Generated 2026-05-24T20:49:58.303Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/Helical Interpolation for Thread Milling, Holes, and Spiral Ramps.pdf` |
| Slug | `resource_pdfs_helical_interpolation_for_thread_milling_holes_and_spiral_ramps_pdf` |
| Kind | `other-pdf` |
