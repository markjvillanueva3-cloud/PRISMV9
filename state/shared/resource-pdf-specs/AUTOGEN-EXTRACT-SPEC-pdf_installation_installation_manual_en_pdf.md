# AUTOGEN EXTRACT SPEC — PDF/Installation/Installation_Manual-en.pdf

Generated 2026-05-24T20:49:04.475Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `PDF/Installation/Installation_Manual-en.pdf` |
| Slug | `pdf_installation_installation_manual_en_pdf` |
| Kind | `manual-pdf` |
