# AUTOGEN EXTRACT SPEC — PDF/CAM-Training-Downloaded/Mastercam-Basic-3D-Machining.pdf
...
| Field | Value |
|---|---|
| PDF id | `PDF/CAM-Training-Downloaded/Mastercam-Basic-3D-Machining.pdf` |
| Slug | `pdf_cam_training_downloaded_mastercam_basic_3d_machining_pdf` |
