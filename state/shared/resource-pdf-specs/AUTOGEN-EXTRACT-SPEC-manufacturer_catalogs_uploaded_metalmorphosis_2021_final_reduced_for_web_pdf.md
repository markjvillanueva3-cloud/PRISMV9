# AUTOGEN EXTRACT SPEC — MANUFACTURER_CATALOGS/uploaded/Metalmorphosis-2021-FINAL-reduced-for-Web.pdf

Generated 2026-05-24T20:48:37.175Z by scripts/auto-resource-pdf-spec-emit.mjs (slot:india).
Advisory + must_human_verify. /pdf-learn executes this spec to deliver the actual extracted assets.

| Field | Value |
|---|---|
| PDF id | `MANUFACTURER_CATALOGS/uploaded/Metalmorphosis-2021-FINAL-reduced-for-Web.pdf` |
| Slug | `manufacturer_catalogs_uploaded_metalmorphosis_2021_final_reduced_for_web_pdf` |
