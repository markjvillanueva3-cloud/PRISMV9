# AUTOGEN EXTRACT SPEC — RESOURCE PDFS/DOWNLOADED_TRAINING/Inventor_iLogic_Beyond_Basics.pdf
...
| Field | Value |
|---|---|
| PDF id | `RESOURCE PDFS/DOWNLOADED_TRAINING/Inventor_iLogic_Beyond_Basics.pdf` |
| Slug | `resource_pdfs_downloaded_training_inventor_ilogic_beyond_basics_pdf` |
| Kind | `other-pdf` |
