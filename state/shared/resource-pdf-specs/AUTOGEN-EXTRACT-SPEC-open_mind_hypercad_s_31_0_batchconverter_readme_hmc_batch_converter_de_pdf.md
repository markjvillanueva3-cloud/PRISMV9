# AUTOGEN EXTRACT SPEC — OPEN MIND/hyperCAD-S/31.0/BatchConverter/Readme_HMC_Batch_Converter-de.pdf
...
| Field | Value |
|---|---|
| PDF id | `OPEN MIND/hyperCAD-S/31.0/BatchConverter/Readme_HMC_Batch_Converter-de.pdf` |
| Slug | `open_mind_hypercad_s_31_0_batchconverter_readme_hmc_batch_converter_de_pdf` |
| Kind | `other-pdf` |
