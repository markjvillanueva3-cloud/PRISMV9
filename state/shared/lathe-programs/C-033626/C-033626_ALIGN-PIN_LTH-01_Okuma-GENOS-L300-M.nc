...
( MACH : LTH-01  Okuma GENOS L300-M )
( CTRL : OSP-P300L-R    SPINDLE-MAX CLAMP G50 S4000 )
( HOLD : 8in 3-jaw / 1.625 collet )
...
( NOTE : M-axis live tooling (unused here) )
...
G20                ( INCH )
G40                ( CANCEL TNR COMP )
G50 S4000      ( SPINDLE SPEED MAX CLAMP )
