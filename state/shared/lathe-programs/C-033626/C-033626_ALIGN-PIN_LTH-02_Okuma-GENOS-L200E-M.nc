...
( MACH : LTH-02  Okuma GENOS L200E-M )
( CTRL : OSP-P200LA-R    SPINDLE-MAX CLAMP G50 S5000 )
( HOLD : 6in 3-jaw / .625 collet )
...
( NOTE : Best for the PIN (collet+bar). Bushing bar 1.625 EXCEEDS 1.65in bar cap -> run bushing from a chucked sawed blank. )
...
G20                ( INCH )
G40                ( CANCEL TNR COMP )
G50 S5000      ( SPINDLE SPEED MAX CLAMP )
