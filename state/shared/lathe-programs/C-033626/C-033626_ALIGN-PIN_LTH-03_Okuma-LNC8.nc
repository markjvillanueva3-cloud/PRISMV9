...
( MACH : LTH-03  Okuma LNC8 )
( CTRL : OSP-U10L    SPINDLE-MAX CLAMP G50 S4500 )
( HOLD : 8in 3-jaw / collet )
( WOFF : ZSET   Z0 = FRONT (TIP) FACE   X0 = SPINDLE CENTERLINE  (DIAMETER PROGRAMMING) )
...
( NOTE : Older OSP-U10 control: verify G15/work-shift + feed-mode codes on prove-out. )
...
G20                ( INCH )
G40                ( CANCEL TNR COMP )
G50 S4500      ( SPINDLE SPEED MAX CLAMP )
