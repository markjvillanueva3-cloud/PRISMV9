---
schemaVersion: 1.0.0
id: skc-fz9sgx-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-fz9sgx-2026-06-26`

Observed 17 times across slots [alpha=4, golf=2, bravo=2, sierra=2, xray=2, mike=1, delta=1, india=1, oscar=1, echo=1]; dominant kind: **build-heavy** (build-heavy=17); median call count: 5.

## Tool-call signature

```
Bash|Bash|Edit|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, golf, mike, bravo, sierra, delta, xray, india, oscar, echo)
...
- First seen: 2026-05-24T00:49:12.143Z
- Last seen: 2026-06-26T01:51:48.658Z
...
3. Append `{ "id": "skc-fz9sgx-2026-06-26", "promotedTo": "<chosen-name>" }` to
