---
schemaVersion: 1.0.0
id: skc-j97auq-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-j97auq-2026-06-25`

Observed 54 times across slots [sierra=6, alpha=5, oscar=5, delta=4, india=4, hotel=3, romeo=3, papa=3, zulu=3, mike=2, bravo=2, juliett=2, golf=2, xray=2, november=1, whiskey=1, echo=1, foxtrot=1, tango=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=54); median call count: 6.
...
- Last seen: 2026-06-25T03:19:28.710Z
...
3. Append `{ "id": "skc-j97auq-2026-06-25", "promotedTo": "<chosen-name>" }` to
