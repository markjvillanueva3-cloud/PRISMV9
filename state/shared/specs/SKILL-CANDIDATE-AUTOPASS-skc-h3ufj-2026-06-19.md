---
schemaVersion: 1.0.0
id: skc-h3ufj-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-h3ufj-2026-06-19`

Observed 13 times across slots [golf=2, papa=2, hotel=1, india=1, november=1, foxtrot=1, alpha=1, delta=1, bravo=1, charlie=1]; dominant kind: **build-heavy** (build-heavy=13); median call count: 7.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, india, november, golf, foxtrot, alpha, delta, bravo, charlie, papa)
...
- Last seen: 2026-06-19T13:37:38.789Z
...
3. Append `{ "id": "skc-h3ufj-2026-06-19", "promotedTo": "<chosen-name>" }` to
