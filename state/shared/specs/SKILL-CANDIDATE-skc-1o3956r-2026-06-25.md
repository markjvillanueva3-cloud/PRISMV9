---
schemaVersion: 1.0.0
id: skc-1o3956r-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1o3956r-2026-06-25`

Observed 5 times across slots [india=1, oscar=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 5.

## Tool-call signature

```
Bash|Bash|Read|Write|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: india, oscar, alpha)
...
- First seen: 2026-05-22T00:53:10.894Z
- Last seen: 2026-06-25T02:44:01.818Z
...
3. Append `{ "id": "skc-1o3956r-2026-06-25", "promotedTo": "<chosen-name>" }` to
