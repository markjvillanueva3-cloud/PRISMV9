---
schemaVersion: 1.0.0
id: skc-c0wxn2-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-c0wxn2-2026-06-25`

Observed 6 times across slots [alpha=2, bravo=1, foxtrot=1, charlie=1]; dominant kind: **edit-heavy** (edit-heavy=6); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, foxtrot, alpha, charlie)
...
- Last seen: 2026-06-25T01:35:29.680Z
...
3. Append `{ "id": "skc-c0wxn2-2026-06-25", "promotedTo": "<chosen-name>" }` to
