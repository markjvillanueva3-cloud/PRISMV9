---
schemaVersion: 1.0.0
id: skc-1qno1z8-2026-06-15
generated: 2026-06-15T08:17:01.126Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1qno1z8-2026-06-15`

Observed 14 times across slots [golf=3, echo=2, delta=2, alpha=2, zulu=2, charlie=1, india=1, romeo=1]; dominant kind: **build-heavy** (build-heavy=14); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, charlie, golf, delta, alpha, zulu, india, romeo)
...
- Last seen: 2026-06-15T02:13:25.120Z
...
3. Append `{ "id": "skc-1qno1z8-2026-06-15", "promotedTo": "<chosen-name>" }` to
