---
schemaVersion: 1.0.0
id: skc-1deubsx-2026-06-17
generated: 2026-06-17T08:17:01.436Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1deubsx-2026-06-17`

Observed 14 times across slots [bravo=3, foxtrot=3, charlie=3, hotel=1, india=1, alpha=1, delta=1]; dominant kind: **build-heavy** (build-heavy=14); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, hotel, foxtrot, india, charlie, alpha, delta)
...
- Last seen: 2026-06-17T03:58:56.458Z
...
3. Append `{ "id": "skc-1deubsx-2026-06-17", "promotedTo": "<chosen-name>" }` to
