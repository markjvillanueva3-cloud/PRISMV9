---
schemaVersion: 1.0.0
id: skc-13xwzq3-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-13xwzq3-2026-06-19`

Observed 6 times across slots [hotel=1, bravo=1, delta=1, sierra=1, tango=1, oscar=1]; dominant kind: **edit-heavy** (edit-heavy=6); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, bravo, delta, sierra, tango, oscar)
...
- Last seen: 2026-06-19T15:19:24.161Z
...
3. Append `{ "id": "skc-13xwzq3-2026-06-19", "promotedTo": "<chosen-name>" }` to
