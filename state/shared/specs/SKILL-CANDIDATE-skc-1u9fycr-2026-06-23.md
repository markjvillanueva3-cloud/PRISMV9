---
schemaVersion: 1.0.0
id: skc-1u9fycr-2026-06-23
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1u9fycr-2026-06-23`

Observed 18 times across slots [november=17, india=1]; dominant kind: **build-heavy** (build-heavy=18); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: november, india)
...
- Last seen: 2026-06-23T13:47:54.730Z
...
3. Append `{ "id": "skc-1u9fycr-2026-06-23", "promotedTo": "<chosen-name>" }` to
