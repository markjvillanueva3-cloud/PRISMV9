---
schemaVersion: 1.0.0
id: skc-1c8tayn-2026-05-27
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1c8tayn-2026-05-27`

Observed 12 times across slots [echo=2, kilo=2, hotel=1, november=1, foxtrot=1, bravo=1, charlie=1, delta=1, india=1, lima=1]; dominant kind: **edit-heavy** (edit-heavy=12); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, november, foxtrot, bravo, echo, kilo, charlie, delta, india, lima)
...
- Last seen: 2026-05-27T19:30:20.566Z
...
3. Append `{ "id": "skc-1c8tayn-2026-05-27", "promotedTo": "<chosen-name>" }` to
