...
| 9 | **HERMES-CAPABILITY-EXPANSION-MS0** (research) | C | open envelope | research-gated | continue the /goal directive: find more high-level Hermes capabilities to wire | `reference_hermes_capability_expansion_ms0_2026_05_24` |
