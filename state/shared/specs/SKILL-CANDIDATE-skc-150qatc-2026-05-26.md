---
schemaVersion: 1.0.0
id: skc-150qatc-2026-05-26
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-150qatc-2026-05-26`

Observed 8 times across slots [charlie=8]; dominant kind: **build-heavy** (build-heavy=8); median call count: 5.

## Tool-call signature

```
TaskCreate|PowerShell|Bash|TaskUpdate|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie)
...
- First seen: 2026-05-26T07:59:54.173Z
- Last seen: 2026-05-26T09:37:21.484Z
...
3. Append `{ "id": "skc-150qatc-2026-05-26", "promotedTo": "<chosen-name>" }` to
