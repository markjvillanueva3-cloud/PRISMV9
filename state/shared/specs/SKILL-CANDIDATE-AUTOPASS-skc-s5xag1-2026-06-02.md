---
schemaVersion: 1.0.0
id: skc-s5xag1-2026-06-02
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-s5xag1-2026-06-02`

Observed 7 times across slots [echo=1, hotel=1, mike=1, lima=1, delta=1]; dominant kind: **build-heavy** (build-heavy=7); median call count: 8.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, hotel, mike, lima, delta)
...
- Last seen: 2026-06-02T03:34:30.519Z
...
3. Append `{ "id": "skc-s5xag1-2026-06-02", "promotedTo": "<chosen-name>" }` to
