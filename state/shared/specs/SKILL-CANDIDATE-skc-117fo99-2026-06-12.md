---
schemaVersion: 1.0.0
id: skc-117fo99-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-117fo99-2026-06-12`

Observed 12 times across slots [sierra=2, bravo=2, papa=1, juliett=1, quebec=1, delta=1, oscar=1, charlie=1, alpha=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=12); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: papa, juliett, sierra, quebec, delta, oscar, charlie, bravo, alpha, zulu)
...
- Last seen: 2026-06-12T20:05:54.717Z
...
3. Append `{ "id": "skc-117fo99-2026-06-12", "promotedTo": "<chosen-name>" }` to
