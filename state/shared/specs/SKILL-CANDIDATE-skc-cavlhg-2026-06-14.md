---
schemaVersion: 1.0.0
id: skc-cavlhg-2026-06-14
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-cavlhg-2026-06-14`

Observed 10 times across slots [romeo=3, hotel=2, alpha=2, charlie=1, sierra=1, bravo=1]; dominant kind: **build-heavy** (build-heavy=10); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, alpha, charlie, romeo, sierra, bravo)
...
- Last seen: 2026-06-14T05:57:41.783Z
...
3. Append `{ "id": "skc-cavlhg-2026-06-14", "promotedTo": "<chosen-name>" }` to
