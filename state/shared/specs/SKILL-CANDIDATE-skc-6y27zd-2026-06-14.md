---
schemaVersion: 1.0.0
id: skc-6y27zd-2026-06-14
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-6y27zd-2026-06-14`

Observed 25 times across slots [alpha=4, hotel=3, bravo=3, juliett=2, echo=2, romeo=2, charlie=2, oscar=1, golf=1, delta=1, india=1]; dominant kind: **build-heavy** (build-heavy=25); median call count: 4.
...
- Last seen: 2026-06-14T07:58:25.427Z
...
3. Append `{ "id": "skc-6y27zd-2026-06-14", "promotedTo": "<chosen-name>" }` to
