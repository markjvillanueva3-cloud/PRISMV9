---
schemaVersion: 1.0.0
id: skc-1f9d2pr-2026-06-10
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1f9d2pr-2026-06-10`

Observed 9 times across slots [golf=8, alpha=1]; dominant kind: **build-heavy** (build-heavy=9); median call count: 4.

## Tool-call signature

```
Bash|PowerShell|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: golf, alpha)
...
- First seen: 2026-05-22T17:37:54.729Z
- Last seen: 2026-06-10T15:03:23.098Z
...
3. Append `{ "id": "skc-1f9d2pr-2026-06-10", "promotedTo": "<chosen-name>" }` to
