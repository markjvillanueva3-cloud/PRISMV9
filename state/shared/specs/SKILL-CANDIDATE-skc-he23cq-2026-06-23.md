---
schemaVersion: 1.0.0
id: skc-he23cq-2026-06-23
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-he23cq-2026-06-23`

Observed 6 times across slots [delta=2, kilo=1, bravo=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: kilo, delta, bravo, quebec)
...
- Last seen: 2026-06-23T14:59:14.922Z
...
3. Append `{ "id": "skc-he23cq-2026-06-23", "promotedTo": "<chosen-name>" }` to
