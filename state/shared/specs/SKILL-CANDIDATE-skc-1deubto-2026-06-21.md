---
schemaVersion: 1.0.0
id: skc-1deubto-2026-06-21
generated: 2026-06-21T08:17:01.515Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1deubto-2026-06-21`

Observed 22 times across slots [bravo=4, india=4, foxtrot=3, charlie=3, delta=2, hotel=1, alpha=1, golf=1, papa=1, xray=1]; dominant kind: **build-heavy** (build-heavy=22); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, hotel, foxtrot, india, charlie, alpha, delta, golf, papa, xray)
...
- Last seen: 2026-06-21T00:21:39.656Z
...
3. Append `{ "id": "skc-1deubto-2026-06-21", "promotedTo": "<chosen-name>" }` to
