---
schemaVersion: 1.0.0
id: skc-14c8qya-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-14c8qya-2026-06-12`

Observed 5 times across slots [delta=1, india=1, bravo=1, golf=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 4.

## Tool-call signature

```
TaskUpdate|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: delta, india, bravo, golf)
...
- First seen: 2026-05-27T23:27:02.533Z
- Last seen: 2026-06-12T16:55:53.584Z
...
3. Append `{ "id": "skc-14c8qya-2026-06-12", "promotedTo": "<chosen-name>" }` to
