---
schemaVersion: 1.0.0
id: skc-kax1hp-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-kax1hp-2026-06-25`

Observed 5 times across slots [india=2, golf=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: india, golf, alpha)
...
- Last seen: 2026-06-25T03:53:48.517Z
...
3. Append `{ "id": "skc-kax1hp-2026-06-25", "promotedTo": "<chosen-name>" }` to
