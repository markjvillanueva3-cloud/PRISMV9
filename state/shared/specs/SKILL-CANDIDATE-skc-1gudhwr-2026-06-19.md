---
schemaVersion: 1.0.0
id: skc-1gudhwr-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1gudhwr-2026-06-19`

Observed 7 times across slots [papa=2, charlie=1, echo=1, golf=1, bravo=1, india=1]; dominant kind: **build-heavy** (build-heavy=7); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, echo, golf, papa, bravo, india)
...
- Last seen: 2026-06-19T15:08:16.067Z
...
3. Append `{ "id": "skc-1gudhwr-2026-06-19", "promotedTo": "<chosen-name>" }` to
