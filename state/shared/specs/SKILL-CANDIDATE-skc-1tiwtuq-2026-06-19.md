---
schemaVersion: 1.0.0
id: skc-1tiwtuq-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1tiwtuq-2026-06-19`

Observed 5 times across slots [juliett=1, golf=1, papa=1, india=1, sierra=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.

## Tool-call signature

```
Bash|Bash|Write|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: juliett, golf, papa, india, sierra)
...
- First seen: 2026-05-26T16:00:05.106Z
- Last seen: 2026-06-19T15:21:13.410Z
...
3. Append `{ "id": "skc-1tiwtuq-2026-06-19", "promotedTo": "<chosen-name>" }` to
