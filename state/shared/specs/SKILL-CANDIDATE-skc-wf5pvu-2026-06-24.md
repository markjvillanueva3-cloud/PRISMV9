---
schemaVersion: 1.0.0
id: skc-wf5pvu-2026-06-24
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-wf5pvu-2026-06-24`

Observed 26 times across slots [alpha=4, zulu=4, sierra=3, charlie=2, india=2, echo=2, golf=2, november=1, lima=1, juliett=1, bravo=1, xray=1]; dominant kind: **build-heavy** (build-heavy=26); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, sierra, november, india, lima, alpha, echo, golf, juliett, zulu, bravo, xray)
...
- Last seen: 2026-06-24T01:34:31.974Z
...
3. Append `{ "id": "skc-wf5pvu-2026-06-24", "promotedTo": "<chosen-name>" }` to
