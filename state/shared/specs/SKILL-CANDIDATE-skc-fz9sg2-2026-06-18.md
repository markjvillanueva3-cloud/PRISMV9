---
schemaVersion: 1.0.0
id: skc-fz9sg2-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-fz9sg2-2026-06-18`

Observed 8 times across slots [alpha=2, golf=2, mike=1, bravo=1, sierra=1, delta=1]; dominant kind: **build-heavy** (build-heavy=8); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, golf, mike, bravo, sierra, delta)
...
- Last seen: 2026-06-18T20:12:49.142Z
...
3. Append `{ "id": "skc-fz9sg2-2026-06-18", "promotedTo": "<chosen-name>" }` to
