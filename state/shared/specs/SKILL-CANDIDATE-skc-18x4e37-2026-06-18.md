---
schemaVersion: 1.0.0
id: skc-18x4e37-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-18x4e37-2026-06-18`

Observed 5 times across slots [charlie=1, foxtrot=1, xray=1, sierra=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, foxtrot, xray, sierra, oscar)
...
- First seen: 2026-05-22T21:19:00.697Z
- Last seen: 2026-06-18T18:33:37.955Z
...
3. Append `{ "id": "skc-18x4e37-2026-06-18", "promotedTo": "<chosen-name>" }` to
