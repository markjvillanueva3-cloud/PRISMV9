---
schemaVersion: 1.0.0
id: skc-of0xnz-2026-06-23
generated: 2026-06-23T08:17:01.355Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-of0xnz-2026-06-23`

Observed 39 times across slots [alpha=8, golf=5, charlie=4, echo=4, hotel=3, foxtrot=3, bravo=3, whiskey=2, kilo=1, romeo=1, juliett=1, zulu=1, india=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=39); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, foxtrot, alpha, charlie, kilo, romeo, golf, juliett, echo, bravo, whiskey, zulu, india, quebec)
...
- Last seen: 2026-06-23T02:34:19.631Z
...
3. Append `{ "id": "skc-of0xnz-2026-06-23", "promotedTo": "<chosen-name>" }` to
