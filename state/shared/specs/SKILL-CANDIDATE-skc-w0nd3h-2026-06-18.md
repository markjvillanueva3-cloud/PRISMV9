---
schemaVersion: 1.0.0
id: skc-w0nd3h-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-w0nd3h-2026-06-18`

Observed 24 times across slots [charlie=4, hotel=3, delta=2, bravo=2, echo=2, kilo=2, romeo=1, whiskey=1, india=1, papa=1, oscar=1, sierra=1]; dominant kind: **build-heavy** (build-heavy=24); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, charlie, delta, bravo, romeo, echo, whiskey, kilo, india, papa, oscar, sierra)
...
- Last seen: 2026-06-18T19:56:15.880Z
...
3. Append `{ "id": "skc-w0nd3h-2026-06-18", "promotedTo": "<chosen-name>" }` to
