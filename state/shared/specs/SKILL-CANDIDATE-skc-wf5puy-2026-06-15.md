---
schemaVersion: 1.0.0
id: skc-wf5puy-2026-06-15
generated: 2026-06-16T17:16:14.428Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-wf5puy-2026-06-15`

Observed 21 times across slots [alpha=4, sierra=3, zulu=3, charlie=2, golf=2, november=1, india=1, lima=1, echo=1, juliett=1, bravo=1]; dominant kind: **build-heavy** (build-heavy=21); median call count: 4.

## Tool-call signature

```
Bash|Bash|Write|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, sierra, november, india, lima, alpha, echo, golf, juliett, zulu, bravo)
...
- First seen: 2026-05-23T02:16:36.893Z
- Last seen: 2026-06-15T14:16:29.548Z
...
3. Append `{ "id": "skc-wf5puy-2026-06-15", "promotedTo": "<chosen-name>" }` to
