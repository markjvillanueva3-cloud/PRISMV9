---
schemaVersion: 1.0.0
id: skc-1a8fob5-2026-06-22
generated: 2026-06-23T08:17:01.355Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1a8fob5-2026-06-22`

Observed 11 times across slots [whiskey=3, foxtrot=1, kilo=1, sierra=1, alpha=1, xray=1, oscar=1]; dominant kind: **edit-heavy** (edit-heavy=11); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: foxtrot, whiskey, kilo, sierra, alpha, xray, oscar)
...
- Last seen: 2026-06-22T14:05:30.169Z
...
3. Append `{ "id": "skc-1a8fob5-2026-06-22", "promotedTo": "<chosen-name>" }` to
