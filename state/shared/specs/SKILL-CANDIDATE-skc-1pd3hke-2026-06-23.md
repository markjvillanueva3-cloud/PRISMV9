---
schemaVersion: 1.0.0
id: skc-1pd3hke-2026-06-23
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1pd3hke-2026-06-23`

Observed 6 times across slots [charlie=2, india=2, alpha=1]; dominant kind: **edit-heavy** (edit-heavy=6); median call count: 5.

## Tool-call signature

```
Edit|Edit|Bash|Edit|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, india, alpha)
...
- First seen: 2026-05-29T17:36:54.370Z
- Last seen: 2026-06-23T15:12:13.320Z
...
3. Append `{ "id": "skc-1pd3hke-2026-06-23", "promotedTo": "<chosen-name>" }` to
