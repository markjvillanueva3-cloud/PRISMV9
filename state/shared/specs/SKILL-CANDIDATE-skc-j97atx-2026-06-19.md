---
schemaVersion: 1.0.0
id: skc-j97atx-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-j97atx-2026-06-19`

Observed 33 times across slots [delta=4, hotel=3, alpha=3, sierra=3, mike=2, romeo=2, juliett=2, golf=2, papa=2, zulu=2, november=1, bravo=1, whiskey=1, echo=1, foxtrot=1, tango=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=33); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: mike, hotel, delta, romeo, november, alpha, bravo, juliett, whiskey, golf, echo, papa, sierra, foxtrot, tango, zulu, oscar)
...
- Last seen: 2026-06-19T13:42:31.234Z
...
3. Append `{ "id": "skc-j97atx-2026-06-19", "promotedTo": "<chosen-name>" }` to
