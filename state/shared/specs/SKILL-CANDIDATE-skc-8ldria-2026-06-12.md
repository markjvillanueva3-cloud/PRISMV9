---
schemaVersion: 1.0.0
id: skc-8ldria-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-8ldria-2026-06-12`

Observed 9 times across slots [alpha=2, papa=1, golf=1, echo=1, whiskey=1, delta=1]; dominant kind: **build-heavy** (build-heavy=9); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: papa, alpha, golf, echo, whiskey, delta)
...
- Last seen: 2026-06-12T03:45:15.886Z
...
3. Append `{ "id": "skc-8ldria-2026-06-12", "promotedTo": "<chosen-name>" }` to
