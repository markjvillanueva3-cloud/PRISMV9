---
schemaVersion: 1.0.0
id: skc-1ttvon6-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1ttvon6-2026-06-12`

Observed 12 times across slots [bravo=2, romeo=2, sierra=2, whiskey=1, oscar=1, golf=1, delta=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=12); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, whiskey, romeo, oscar, golf, sierra, delta, zulu)
...
- Last seen: 2026-06-12T20:04:48.210Z
...
3. Append `{ "id": "skc-1ttvon6-2026-06-12", "promotedTo": "<chosen-name>" }` to
