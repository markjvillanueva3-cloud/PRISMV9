---
schemaVersion: 1.0.0
id: skc-172v62t-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-172v62t-2026-06-26`

Observed 196 times across slots [india=19, alpha=19, bravo=16, delta=14, sierra=14, zulu=13, golf=12, echo=10, papa=10, charlie=9, whiskey=8, kilo=8, juliett=6, xray=6, romeo=5, hotel=4, mike=2, tango=2, oscar=2, quebec=2, lima=1, foxtrot=1]; dominant kind: **build-heavy** (build-heavy=196); median call count: 3.
...
- Last seen: 2026-06-26T01:59:27.036Z
...
3. Append `{ "id": "skc-172v62t-2026-06-26", "promotedTo": "<chosen-name>" }` to
