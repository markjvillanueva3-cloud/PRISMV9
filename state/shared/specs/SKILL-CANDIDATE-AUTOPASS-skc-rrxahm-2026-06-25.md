---
schemaVersion: 1.0.0
id: skc-rrxahm-2026-06-25
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-rrxahm-2026-06-25`

Observed 5 times across slots [india=2, oscar=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.

## Tool-call signature

```
Bash|Bash|Edit|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: oscar, india, alpha)
...
- First seen: 2026-05-24T07:09:58.893Z
- Last seen: 2026-06-25T23:48:41.534Z
...
3. Append `{ "id": "skc-rrxahm-2026-06-25", "promotedTo": "<chosen-name>" }` to
