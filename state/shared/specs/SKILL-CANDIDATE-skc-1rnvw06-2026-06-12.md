---
schemaVersion: 1.0.0
id: skc-1rnvw06-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1rnvw06-2026-06-12`

Observed 7 times across slots [whiskey=2, hotel=1, foxtrot=1, lima=1, bravo=1]; dominant kind: **mixed** (mixed=7); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, whiskey, foxtrot, lima, bravo)
...
- Last seen: 2026-06-12T03:51:30.452Z
...
3. Append `{ "id": "skc-1rnvw06-2026-06-12", "promotedTo": "<chosen-name>" }` to
