---
schemaVersion: 1.0.0
id: skc-1wxqzak-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1wxqzak-2026-06-18`

Observed 7 times across slots [alpha=2, bravo=2, lima=1, november=1, india=1]; dominant kind: **build-heavy** (build-heavy=7); median call count: 6.

## Tool-call signature

```
Bash|Bash|Bash|Bash|TaskUpdate|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: lima, november, alpha, india, bravo)
...
- First seen: 2026-05-22T20:18:17.626Z
- Last seen: 2026-06-18T17:22:18.290Z
...
3. Append `{ "id": "skc-1wxqzak-2026-06-18", "promotedTo": "<chosen-name>" }` to
