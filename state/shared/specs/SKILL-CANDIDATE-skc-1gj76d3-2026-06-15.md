---
schemaVersion: 1.0.0
id: skc-1gj76d3-2026-06-15
generated: 2026-06-16T17:16:14.428Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1gj76d3-2026-06-15`

Observed 5 times across slots [golf=1, foxtrot=1, sierra=1, zulu=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.

## Tool-call signature

```
Read|Edit|Bash|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: golf, foxtrot, sierra, zulu, oscar)
...
- First seen: 2026-06-01T13:41:53.345Z
- Last seen: 2026-06-15T16:19:14.347Z
...
3. Append `{ "id": "skc-1gj76d3-2026-06-15", "promotedTo": "<chosen-name>" }` to
