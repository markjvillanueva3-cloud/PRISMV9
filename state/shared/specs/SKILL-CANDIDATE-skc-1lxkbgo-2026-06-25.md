---
schemaVersion: 1.0.0
id: skc-1lxkbgo-2026-06-25
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1lxkbgo-2026-06-25`

Observed 29 times across slots [alpha=4, bravo=3, zulu=3, sierra=3, delta=2, foxtrot=2, tango=2, india=2, golf=2, charlie=2, oscar=2, lima=1, echo=1]; dominant kind: **build-heavy** (build-heavy=29); median call count: 5.
...
- Last seen: 2026-06-25T08:33:48.072Z
...
3. Append `{ "id": "skc-1lxkbgo-2026-06-25", "promotedTo": "<chosen-name>" }` to
