---
schemaVersion: 1.0.0
id: skc-1gudhxg-2026-06-21
generated: 2026-06-22T08:17:01.977Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1gudhxg-2026-06-21`

Observed 8 times across slots [papa=2, charlie=1, echo=1, golf=1, bravo=1, india=1, romeo=1]; dominant kind: **build-heavy** (build-heavy=8); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, echo, golf, papa, bravo, india, romeo)
...
- Last seen: 2026-06-21T23:14:26.146Z
...
3. Append `{ "id": "skc-1gudhxg-2026-06-21", "promotedTo": "<chosen-name>" }` to
