---
schemaVersion: 1.0.0
id: skc-8ldrif-2026-06-17
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-8ldrif-2026-06-17`

Observed 10 times across slots [alpha=2, papa=1, golf=1, echo=1, whiskey=1, delta=1, india=1]; dominant kind: **build-heavy** (build-heavy=10); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: papa, alpha, golf, echo, whiskey, delta, india)
...
- First seen: 2026-05-22T16:22:40.691Z
- Last seen: 2026-06-17T16:42:33.197Z
...
3. Append `{ "id": "skc-8ldrif-2026-06-17", "promotedTo": "<chosen-name>" }` to
