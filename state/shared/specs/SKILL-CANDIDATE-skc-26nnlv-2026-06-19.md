---
schemaVersion: 1.0.0
id: skc-26nnlv-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-26nnlv-2026-06-19`

Observed 10 times across slots [india=2, romeo=2, sierra=1, tango=1, alpha=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=10); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: sierra, tango, alpha, india, zulu, romeo)
...
- Last seen: 2026-06-19T18:31:03.728Z
...
3. Append `{ "id": "skc-26nnlv-2026-06-19", "promotedTo": "<chosen-name>" }` to
