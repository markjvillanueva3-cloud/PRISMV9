---
schemaVersion: 1.0.0
id: skc-9td8n1-2026-06-17
generated: 2026-06-17T08:17:01.436Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-9td8n1-2026-06-17`

Observed 6 times across slots [kilo=2, echo=1, alpha=1, delta=1, xray=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, alpha, kilo, delta, xray)
...
- Last seen: 2026-06-17T03:29:11.027Z
...
3. Append `{ "id": "skc-9td8n1-2026-06-17", "promotedTo": "<chosen-name>" }` to
