---
schemaVersion: 1.0.0
id: skc-kpfe97-2026-06-23
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-kpfe97-2026-06-23`

Observed 5 times across slots [bravo=1, alpha=1, romeo=1, india=1, xray=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, alpha, romeo, india, xray)
...
- Last seen: 2026-06-23T09:10:11.304Z
...
3. Append `{ "id": "skc-kpfe97-2026-06-23", "promotedTo": "<chosen-name>" }` to
