---
schemaVersion: 1.0.0
id: skc-moqgyj-2026-06-26
generated: 2026-06-27T08:17:02.046Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-moqgyj-2026-06-26`

Observed 6 times across slots [delta=1, echo=1, sierra=1, alpha=1, whiskey=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: delta, echo, sierra, alpha, whiskey)
...
- Last seen: 2026-06-26T16:41:19.671Z
...
3. Append `{ "id": "skc-moqgyj-2026-06-26", "promotedTo": "<chosen-name>" }` to
