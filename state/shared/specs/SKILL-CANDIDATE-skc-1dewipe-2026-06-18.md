---
schemaVersion: 1.0.0
id: skc-1dewipe-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1dewipe-2026-06-18`

Observed 8 times across slots [bravo=2, charlie=2, alpha=2, november=1, juliett=1]; dominant kind: **build-heavy** (build-heavy=8); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, november, juliett, charlie, alpha)
...
- Last seen: 2026-06-18T18:25:43.620Z
...
3. Append `{ "id": "skc-1dewipe-2026-06-18", "promotedTo": "<chosen-name>" }` to
