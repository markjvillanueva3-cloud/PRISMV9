---
schemaVersion: 1.0.0
id: skc-26nnmo-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-26nnmo-2026-06-25`

Observed 15 times across slots [alpha=2, india=2, romeo=2, oscar=2, sierra=1, tango=1, zulu=1, bravo=1, xray=1]; dominant kind: **build-heavy** (build-heavy=15); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: sierra, tango, alpha, india, zulu, romeo, bravo, oscar, xray)
...
- Last seen: 2026-06-25T03:33:55.827Z
...
3. Append `{ "id": "skc-26nnmo-2026-06-25", "promotedTo": "<chosen-name>" }` to
