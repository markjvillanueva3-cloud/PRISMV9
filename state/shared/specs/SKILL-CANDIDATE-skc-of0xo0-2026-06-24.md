---
schemaVersion: 1.0.0
id: skc-of0xo0-2026-06-24
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-of0xo0-2026-06-24`

Observed 40 times across slots [alpha=8, golf=5, charlie=4, echo=4, hotel=3, foxtrot=3, bravo=3, whiskey=2, kilo=1, romeo=1, juliett=1, zulu=1, india=1, quebec=1, xray=1]; dominant kind: **build-heavy** (build-heavy=40); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, foxtrot, alpha, charlie, kilo, romeo, golf, juliett, echo, bravo, whiskey, zulu, india, quebec, xray)
...
- First seen: 2026-05-21T14:26:45.888Z
- Last seen: 2026-06-24T02:27:21.199Z
...
3. Append `{ "id": "skc-of0xo0-2026-06-24", "promotedTo": "<chosen-name>" }` to
