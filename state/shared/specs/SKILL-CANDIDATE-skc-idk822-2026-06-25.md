---
schemaVersion: 1.0.0
id: skc-idk822-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-idk822-2026-06-25`

Observed 8 times across slots [oscar=1, charlie=1, india=1, alpha=1, xray=1, echo=1]; dominant kind: **build-heavy** (build-heavy=8); median call count: 6.

## Tool-call signature

```
Bash|Bash|Bash|Bash|Bash|TaskUpdate
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: oscar, charlie, india, alpha, xray, echo)
...
- First seen: 2026-05-29T16:24:29.233Z
- Last seen: 2026-06-25T02:13:32.041Z
...
3. Append `{ "id": "skc-idk822-2026-06-25", "promotedTo": "<chosen-name>" }` to
