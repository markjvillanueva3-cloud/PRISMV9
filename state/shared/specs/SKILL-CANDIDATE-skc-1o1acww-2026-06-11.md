---
schemaVersion: 1.0.0
id: skc-1o1acww-2026-06-11
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1o1acww-2026-06-11`

Observed 5 times across slots [india=2, golf=1, tango=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 4.

## Tool-call signature

```
PowerShell|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: india, golf, tango)
...
- First seen: 2026-05-25T21:17:30.967Z
- Last seen: 2026-06-11T13:46:39.807Z
...
3. Append `{ "id": "skc-1o1acww-2026-06-11", "promotedTo": "<chosen-name>" }` to
