---
schemaVersion: 1.0.0
id: skc-of0xo1-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-of0xo1-2026-06-25`

Observed 42 times across slots [alpha=8, golf=5, charlie=4, echo=4, hotel=3, foxtrot=3, bravo=3, whiskey=2, zulu=2, kilo=1, romeo=1, juliett=1, india=1, quebec=1, xray=1]; dominant kind: **build-heavy** (build-heavy=42); median call count: 3.
...
- Last seen: 2026-06-25T03:05:04.453Z
...
3. Append `{ "id": "skc-of0xo1-2026-06-25", "promotedTo": "<chosen-name>" }` to
