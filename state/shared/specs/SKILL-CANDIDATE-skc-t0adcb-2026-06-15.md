---
schemaVersion: 1.0.0
id: skc-t0adcb-2026-06-15
generated: 2026-06-15T08:17:01.126Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-t0adcb-2026-06-15`

Observed 21 times across slots [bravo=4, whiskey=3, charlie=3, alpha=2, echo=1, romeo=1, india=1, kilo=1, sierra=1, delta=1, golf=1, papa=1]; dominant kind: **build-heavy** (build-heavy=21); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: whiskey, echo, romeo, india, charlie, kilo, alpha, bravo, sierra, delta, golf, papa)
...
- First seen: 2026-05-27T09:46:35.990Z
- Last seen: 2026-06-15T00:27:38.070Z
...
3. Append `{ "id": "skc-t0adcb-2026-06-15", "promotedTo": "<chosen-name>" }` to
