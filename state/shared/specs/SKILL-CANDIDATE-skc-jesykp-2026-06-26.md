---
schemaVersion: 1.0.0
id: skc-jesykp-2026-06-26
generated: 2026-06-27T08:17:02.046Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-jesykp-2026-06-26`

Observed 8 times across slots [whiskey=2, bravo=2, juliett=1, zulu=1, delta=1]; dominant kind: **build-heavy** (build-heavy=8); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: juliett, whiskey, bravo, zulu, delta)
...
- Last seen: 2026-06-26T16:32:25.572Z
...
3. Append `{ "id": "skc-jesykp-2026-06-26", "promotedTo": "<chosen-name>" }` to
