---
schemaVersion: 1.0.0
id: skc-8vcfdt-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-8vcfdt-2026-06-19`

Observed 179 times across slots [alpha=18, golf=14, charlie=13, romeo=13, hotel=12, foxtrot=12, whiskey=12, echo=11, bravo=10, delta=9, sierra=9, papa=7, oscar=5, juliett=4, india=4, zulu=4, lima=2, november=2, victor=2, kilo=1, mike=1, tango=1]; dominant kind: **build-heavy** (build-heavy=179); median call count: 4.
...
- Last seen: 2026-06-19T17:58:25.892Z
...
3. Append `{ "id": "skc-8vcfdt-2026-06-19", "promotedTo": "<chosen-name>" }` to
