---
schemaVersion: 1.0.0
id: skc-t0adc9-2026-06-13
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-t0adc9-2026-06-13`

Observed 20 times across slots [bravo=4, whiskey=3, charlie=3, alpha=2, echo=1, romeo=1, india=1, kilo=1, sierra=1, delta=1, golf=1]; dominant kind: **build-heavy** (build-heavy=20); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: whiskey, echo, romeo, india, charlie, kilo, alpha, bravo, sierra, delta, golf)
...
- Last seen: 2026-06-13T20:56:26.501Z
...
3. Append `{ "id": "skc-t0adc9-2026-06-13", "promotedTo": "<chosen-name>" }` to
