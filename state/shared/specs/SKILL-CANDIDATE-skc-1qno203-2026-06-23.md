---
schemaVersion: 1.0.0
id: skc-1qno203-2026-06-23
generated: 2026-06-23T08:17:01.355Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1qno203-2026-06-23`

Observed 21 times across slots [golf=4, echo=2, delta=2, alpha=2, zulu=2, india=2, quebec=2, charlie=1, romeo=1, tango=1, papa=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=21); median call count: 5.
...
- Last seen: 2026-06-23T03:49:48.440Z
...
3. Append `{ "id": "skc-1qno203-2026-06-23", "promotedTo": "<chosen-name>" }` to
