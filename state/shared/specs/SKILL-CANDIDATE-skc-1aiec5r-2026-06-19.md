---
schemaVersion: 1.0.0
id: skc-1aiec5r-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1aiec5r-2026-06-19`

Observed 18 times across slots [echo=3, charlie=2, alpha=2, papa=2, zulu=2, bravo=2, whiskey=1, india=1, sierra=1, golf=1]; dominant kind: **build-heavy** (build-heavy=18); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, whiskey, charlie, alpha, papa, india, zulu, sierra, bravo, golf)
...
- Last seen: 2026-06-19T20:32:31.102Z
...
3. Append `{ "id": "skc-1aiec5r-2026-06-19", "promotedTo": "<chosen-name>" }` to
