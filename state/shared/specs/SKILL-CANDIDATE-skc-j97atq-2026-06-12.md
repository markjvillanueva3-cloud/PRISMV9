---
schemaVersion: 1.0.0
id: skc-j97atq-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-j97atq-2026-06-12`

Observed 29 times across slots [delta=4, hotel=3, alpha=3, sierra=3, mike=2, juliett=2, papa=2, romeo=1, november=1, bravo=1, whiskey=1, golf=1, echo=1, foxtrot=1, tango=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=29); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: mike, hotel, delta, romeo, november, alpha, bravo, juliett, whiskey, golf, echo, papa, sierra, foxtrot, tango, zulu)
...
- Last seen: 2026-06-12T16:57:13.837Z
...
3. Append `{ "id": "skc-j97atq-2026-06-12", "promotedTo": "<chosen-name>" }` to
