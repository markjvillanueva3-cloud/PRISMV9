---
schemaVersion: 1.0.0
id: skc-1qno205-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1qno205-2026-06-25`

Observed 28 times across slots [india=7, golf=4, echo=2, delta=2, alpha=2, zulu=2, quebec=2, oscar=2, charlie=1, romeo=1, tango=1, papa=1, sierra=1]; dominant kind: **build-heavy** (build-heavy=28); median call count: 5.
...
- Last seen: 2026-06-25T03:58:01.802Z
...
3. Append `{ "id": "skc-1qno205-2026-06-25", "promotedTo": "<chosen-name>" }` to
