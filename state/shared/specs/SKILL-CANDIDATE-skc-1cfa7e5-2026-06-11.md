---
schemaVersion: 1.0.0
id: skc-1cfa7e5-2026-06-11
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1cfa7e5-2026-06-11`

Observed 5 times across slots [alpha=2, tango=2, oscar=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, oscar, tango)
...
- Last seen: 2026-06-11T12:58:16.462Z
...
3. Append `{ "id": "skc-1cfa7e5-2026-06-11", "promotedTo": "<chosen-name>" }` to
