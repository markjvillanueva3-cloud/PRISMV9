---
schemaVersion: 1.0.0
id: skc-1qno1zb-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1qno1zb-2026-06-18`

Observed 17 times across slots [golf=4, echo=2, delta=2, alpha=2, zulu=2, charlie=1, india=1, romeo=1, tango=1, papa=1]; dominant kind: **build-heavy** (build-heavy=17); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, charlie, golf, delta, alpha, zulu, india, romeo, tango, papa)
...
- Last seen: 2026-06-18T19:05:30.006Z
...
3. Append `{ "id": "skc-1qno1zb-2026-06-18", "promotedTo": "<chosen-name>" }` to
