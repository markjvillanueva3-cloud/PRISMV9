---
schemaVersion: 1.0.0
id: skc-h3uem-2026-06-09
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-h3uem-2026-06-09`

Observed 11 times across slots [golf=2, hotel=1, india=1, november=1, foxtrot=1, alpha=1, delta=1, bravo=1, charlie=1]; dominant kind: **build-heavy** (build-heavy=11); median call count: 7.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, india, november, golf, foxtrot, alpha, delta, bravo, charlie)
...
- Last seen: 2026-06-09T04:19:24.889Z
...
3. Append `{ "id": "skc-h3uem-2026-06-09", "promotedTo": "<chosen-name>" }` to
