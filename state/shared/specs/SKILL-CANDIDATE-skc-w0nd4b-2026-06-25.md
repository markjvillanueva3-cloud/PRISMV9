---
schemaVersion: 1.0.0
id: skc-w0nd4b-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-w0nd4b-2026-06-25`

Observed 29 times across slots [echo=5, charlie=4, hotel=3, delta=2, bravo=2, kilo=2, sierra=2, romeo=1, whiskey=1, india=1, papa=1, oscar=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=29); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, charlie, delta, bravo, romeo, echo, whiskey, kilo, india, papa, oscar, sierra, alpha)
...
- Last seen: 2026-06-25T02:28:19.448Z
...
3. Append `{ "id": "skc-w0nd4b-2026-06-25", "promotedTo": "<chosen-name>" }` to
