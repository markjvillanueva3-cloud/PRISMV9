---
schemaVersion: 1.0.0
id: skc-h43r5c-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-h43r5c-2026-06-18`

Observed 19 times across slots [alpha=5, bravo=3, zulu=3, delta=2, charlie=2, whiskey=1, golf=1, india=1]; dominant kind: **edit-heavy** (edit-heavy=19); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, bravo, whiskey, delta, charlie, golf, zulu, india)
...
- Last seen: 2026-06-18T15:22:47.195Z
...
3. Append `{ "id": "skc-h43r5c-2026-06-18", "promotedTo": "<chosen-name>" }` to
