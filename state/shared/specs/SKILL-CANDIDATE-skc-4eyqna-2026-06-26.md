---
schemaVersion: 1.0.0
id: skc-4eyqna-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-4eyqna-2026-06-26`

Observed 10 times across slots [alpha=3, whiskey=1, papa=1, delta=1, tango=1, zulu=1, oscar=1, bravo=1]; dominant kind: **build-heavy** (build-heavy=10); median call count: 5.

## Tool-call signature

```
Bash|Bash|Bash|Bash|Write
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: whiskey, alpha, papa, delta, tango, zulu, oscar, bravo)
...
- First seen: 2026-06-01T20:27:23.543Z
- Last seen: 2026-06-26T00:35:51.803Z
...
3. Append `{ "id": "skc-4eyqna-2026-06-26", "promotedTo": "<chosen-name>" }` to
