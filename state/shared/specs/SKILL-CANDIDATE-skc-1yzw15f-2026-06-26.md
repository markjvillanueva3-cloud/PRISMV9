---
schemaVersion: 1.0.0
id: skc-1yzw15f-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1yzw15f-2026-06-26`

Observed 5 times across slots [alpha=3, india=2]; dominant kind: **build-heavy** (build-heavy=5); median call count: 5.

## Tool-call signature

```
Write|Write|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, india)
...
- First seen: 2026-05-30T04:51:42.037Z
- Last seen: 2026-06-26T00:50:54.795Z
...
3. Append `{ "id": "skc-1yzw15f-2026-06-26", "promotedTo": "<chosen-name>" }` to
