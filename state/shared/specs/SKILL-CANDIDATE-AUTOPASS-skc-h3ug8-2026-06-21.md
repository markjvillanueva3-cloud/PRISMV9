---
schemaVersion: 1.0.0
id: skc-h3ug8-2026-06-21
generated: 2026-06-21T08:17:01.515Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-h3ug8-2026-06-21`

Observed 14 times across slots [golf=2, papa=2, hotel=1, india=1, november=1, foxtrot=1, alpha=1, delta=1, bravo=1, charlie=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=14); median call count: 7.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, india, november, golf, foxtrot, alpha, delta, bravo, charlie, papa, zulu)
...
- First seen: 2026-05-21T02:51:07.989Z
- Last seen: 2026-06-21T01:55:11.951Z
...
3. Append `{ "id": "skc-h3ug8-2026-06-21", "promotedTo": "<chosen-name>" }` to
