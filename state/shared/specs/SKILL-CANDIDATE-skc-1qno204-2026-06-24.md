---
schemaVersion: 1.0.0
id: skc-1qno204-2026-06-24
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1qno204-2026-06-24`

Observed 24 times across slots [india=5, golf=4, echo=2, delta=2, alpha=2, zulu=2, quebec=2, charlie=1, romeo=1, tango=1, papa=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=24); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, charlie, golf, delta, alpha, zulu, india, romeo, tango, papa, quebec, oscar)
...
- Last seen: 2026-06-24T02:49:30.513Z
...
3. Append `{ "id": "skc-1qno204-2026-06-24", "promotedTo": "<chosen-name>" }` to
