---
schemaVersion: 1.0.0
id: skc-ohzs2y-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-ohzs2y-2026-06-18`

Observed 11 times across slots [papa=3, charlie=2, alpha=2, bravo=1, sierra=1, delta=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=11); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, bravo, alpha, sierra, papa, delta, zulu)
...
- Last seen: 2026-06-18T20:40:05.173Z
...
3. Append `{ "id": "skc-ohzs2y-2026-06-18", "promotedTo": "<chosen-name>" }` to
