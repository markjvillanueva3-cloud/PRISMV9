---
schemaVersion: 1.0.0
id: skc-oryfz5-2026-06-26
generated: 2026-06-26T04:05:32.381Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-oryfz5-2026-06-26`

Observed 17 times across slots [sierra=3, charlie=2, alpha=2, echo=2, bravo=2, november=1, india=1, oscar=1, romeo=1, whiskey=1]; dominant kind: **build-heavy** (build-heavy=17); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, alpha, november, echo, bravo, india, sierra, oscar, romeo, whiskey)
...
- Last seen: 2026-06-26T03:36:42.474Z
...
3. Append `{ "id": "skc-oryfz5-2026-06-26", "promotedTo": "<chosen-name>" }` to
