---
schemaVersion: 1.0.0
id: skc-5ems85-2026-06-02
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-5ems85-2026-06-02`

Observed 7 times across slots [alpha=2, lima=1, whiskey=1]; dominant kind: **edit-heavy** (edit-heavy=7); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: lima, alpha, whiskey)
...
- Last seen: 2026-06-02T00:41:48.623Z
...
3. Append `{ "id": "skc-5ems85-2026-06-02", "promotedTo": "<chosen-name>" }` to
