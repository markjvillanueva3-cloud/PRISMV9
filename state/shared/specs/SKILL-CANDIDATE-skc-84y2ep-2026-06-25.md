---
schemaVersion: 1.0.0
id: skc-84y2ep-2026-06-25
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-84y2ep-2026-06-25`

Observed 5 times across slots [quebec=2, india=1, alpha=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 5.

## Tool-call signature

```
Bash|Agent|Bash|Edit|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: india, alpha, quebec, oscar)
...
- First seen: 2026-06-09T13:41:26.105Z
- Last seen: 2026-06-25T22:16:18.654Z
...
3. Append `{ "id": "skc-84y2ep-2026-06-25", "promotedTo": "<chosen-name>" }` to
