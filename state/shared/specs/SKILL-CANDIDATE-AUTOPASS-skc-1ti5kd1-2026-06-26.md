---
schemaVersion: 1.0.0
id: skc-1ti5kd1-2026-06-26
generated: 2026-06-26T08:17:02.038Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1ti5kd1-2026-06-26`

Observed 5 times across slots [oscar=3, delta=2]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.

## Tool-call signature

```
Bash|Agent|Agent|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: oscar, delta)
...
- First seen: 2026-06-09T15:00:46.075Z
- Last seen: 2026-06-26T05:02:32.802Z
...
3. Append `{ "id": "skc-1ti5kd1-2026-06-26", "promotedTo": "<chosen-name>" }` to
