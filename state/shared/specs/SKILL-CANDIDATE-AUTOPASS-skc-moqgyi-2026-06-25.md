---
schemaVersion: 1.0.0
id: skc-moqgyi-2026-06-25
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-moqgyi-2026-06-25`

Observed 5 times across slots [delta=1, echo=1, sierra=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.

## Tool-call signature

```
Bash|Bash|Bash|Bash|Edit|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: delta, echo, sierra, alpha)
...
- First seen: 2026-05-31T19:18:45.077Z
- Last seen: 2026-06-25T15:23:07.646Z
...
3. Append `{ "id": "skc-moqgyi-2026-06-25", "promotedTo": "<chosen-name>" }` to
