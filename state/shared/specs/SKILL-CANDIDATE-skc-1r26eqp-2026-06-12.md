---
schemaVersion: 1.0.0
id: skc-1r26eqp-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1r26eqp-2026-06-12`

Observed 11 times across slots [alpha=4, india=2, mike=1, oscar=1, delta=1, foxtrot=1, golf=1]; dominant kind: **build-heavy** (build-heavy=11); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: mike, oscar, delta, foxtrot, golf, alpha, india)
...
- Last seen: 2026-06-12T04:48:35.828Z
...
3. Append `{ "id": "skc-1r26eqp-2026-06-12", "promotedTo": "<chosen-name>" }` to
