---
schemaVersion: 1.0.0
id: skc-jesyjq-2026-06-14
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-jesyjq-2026-06-14`

Observed 5 times across slots [whiskey=2, juliett=1, bravo=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: juliett, whiskey, bravo)
...
- Last seen: 2026-06-14T07:07:01.164Z
...
3. Append `{ "id": "skc-jesyjq-2026-06-14", "promotedTo": "<chosen-name>" }` to
