---
schemaVersion: 1.0.0
id: skc-u6m2mg-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-u6m2mg-2026-06-19`

Observed 13 times across slots [hotel=4, juliett=1, november=1, charlie=1, delta=1, romeo=1, zulu=1, lima=1, sierra=1]; dominant kind: **build-heavy** (build-heavy=13); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, juliett, november, charlie, delta, romeo, zulu, lima, sierra)
...
- Last seen: 2026-06-19T14:39:51.272Z
...
3. Append `{ "id": "skc-u6m2mg-2026-06-19", "promotedTo": "<chosen-name>" }` to
