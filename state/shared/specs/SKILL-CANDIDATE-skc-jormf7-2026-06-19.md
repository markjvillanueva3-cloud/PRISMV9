---
schemaVersion: 1.0.0
id: skc-jormf7-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-jormf7-2026-06-19`

Observed 12 times across slots [sierra=2, papa=2, bravo=2, echo=1, charlie=1, oscar=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=12); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, charlie, oscar, sierra, papa, bravo, zulu)
...
- Last seen: 2026-06-19T14:05:18.653Z
...
3. Append `{ "id": "skc-jormf7-2026-06-19", "promotedTo": "<chosen-name>" }` to
