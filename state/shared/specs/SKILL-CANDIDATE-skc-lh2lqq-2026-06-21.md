---
schemaVersion: 1.0.0
id: skc-lh2lqq-2026-06-21
generated: 2026-06-21T08:17:01.515Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-lh2lqq-2026-06-21`

Observed 12 times across slots [charlie=3, alpha=2, november=1, juliett=1, romeo=1, oscar=1, hotel=1, bravo=1, india=1]; dominant kind: **build-heavy** (build-heavy=12); median call count: 4.

## Tool-call signature

```
Bash|Bash|TaskUpdate|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: november, juliett, charlie, romeo, alpha, oscar, hotel, bravo, india)
...
- First seen: 2026-05-22T21:54:22.808Z
- Last seen: 2026-06-21T00:10:11.094Z
...
3. Append `{ "id": "skc-lh2lqq-2026-06-21", "promotedTo": "<chosen-name>" }` to
