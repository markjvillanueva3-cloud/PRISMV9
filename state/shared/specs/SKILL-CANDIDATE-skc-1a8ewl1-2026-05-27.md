---
schemaVersion: 1.0.0
id: skc-1a8ewl1-2026-05-27
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1a8ewl1-2026-05-27`

Observed 7 times across slots [whiskey=3, foxtrot=1, kilo=1]; dominant kind: **edit-heavy** (edit-heavy=7); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: foxtrot, whiskey, kilo)
...
- Last seen: 2026-05-27T20:12:31.582Z
...
3. Append `{ "id": "skc-1a8ewl1-2026-05-27", "promotedTo": "<chosen-name>" }` to
