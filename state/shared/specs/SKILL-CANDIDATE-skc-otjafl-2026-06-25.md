---
schemaVersion: 1.0.0
id: skc-otjafl-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-otjafl-2026-06-25`

Observed 48 times across slots [sierra=6, india=6, alpha=4, charlie=3, bravo=3, papa=3, golf=2, delta=2, oscar=2, mike=1, hotel=1, foxtrot=1, juliett=1, xray=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=48); median call count: 3.
...
- Last seen: 2026-06-25T04:07:49.480Z
...
3. Append `{ "id": "skc-otjafl-2026-06-25", "promotedTo": "<chosen-name>" }` to
