---
schemaVersion: 1.0.0
id: skc-1lnlnkb-2026-06-11
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1lnlnkb-2026-06-11`

Observed 6 times across slots [foxtrot=1, hotel=1, sierra=1, charlie=1, tango=1, golf=1]; dominant kind: **edit-heavy** (edit-heavy=6); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: foxtrot, hotel, sierra, charlie, tango, golf)
...
- Last seen: 2026-06-11T20:08:13.873Z
...
3. Append `{ "id": "skc-1lnlnkb-2026-06-11", "promotedTo": "<chosen-name>" }` to
