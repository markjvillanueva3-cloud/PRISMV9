---
schemaVersion: 1.0.0
id: skc-yjdl34-2026-06-22
generated: 2026-06-23T08:17:01.355Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-yjdl34-2026-06-22`

Observed 6 times across slots [charlie=1, juliett=1, tango=1, alpha=1, romeo=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 4.

## Tool-call signature

```
Bash|Bash|TaskUpdate|Write
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, juliett, tango, alpha, romeo)
...
- First seen: 2026-05-24T17:38:08.934Z
- Last seen: 2026-06-22T14:36:58.836Z
...
3. Append `{ "id": "skc-yjdl34-2026-06-22", "promotedTo": "<chosen-name>" }` to
