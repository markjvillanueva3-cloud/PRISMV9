---
schemaVersion: 1.0.0
id: skc-1lnlnlc-2026-06-25
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1lnlnlc-2026-06-25`

Observed 11 times across slots [golf=2, foxtrot=1, hotel=1, sierra=1, charlie=1, tango=1, zulu=1, romeo=1, xray=1, alpha=1]; dominant kind: **edit-heavy** (edit-heavy=11); median call count: 5.

## Tool-call signature

```
Edit|Edit|Edit|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: foxtrot, hotel, sierra, charlie, tango, golf, zulu, romeo, xray, alpha)
...
- First seen: 2026-05-25T04:10:41.679Z
- Last seen: 2026-06-25T22:05:01.642Z
...
3. Append `{ "id": "skc-1lnlnlc-2026-06-25", "promotedTo": "<chosen-name>" }` to
