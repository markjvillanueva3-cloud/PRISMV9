---
schemaVersion: 1.0.0
id: skc-6y27zh-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-6y27zh-2026-06-18`

Observed 27 times across slots [alpha=5, bravo=4, hotel=3, juliett=2, echo=2, romeo=2, charlie=2, oscar=1, golf=1, delta=1, india=1]; dominant kind: **build-heavy** (build-heavy=27); median call count: 4.
...
- Last seen: 2026-06-18T02:06:53.361Z
...
3. Append `{ "id": "skc-6y27zh-2026-06-18", "promotedTo": "<chosen-name>" }` to
