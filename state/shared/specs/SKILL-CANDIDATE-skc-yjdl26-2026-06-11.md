---
schemaVersion: 1.0.0
id: skc-yjdl26-2026-06-11
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-yjdl26-2026-06-11`

Observed 5 times across slots [charlie=1, juliett=1, tango=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, juliett, tango, alpha)
...
- Last seen: 2026-06-11T15:03:58.005Z
...
3. Append `{ "id": "skc-yjdl26-2026-06-11", "promotedTo": "<chosen-name>" }` to
