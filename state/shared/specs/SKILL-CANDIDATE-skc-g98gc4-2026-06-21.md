---
schemaVersion: 1.0.0
id: skc-g98gc4-2026-06-21
generated: 2026-06-21T08:17:01.515Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-g98gc4-2026-06-21`

Observed 74 times across slots [bravo=12, alpha=11, delta=6, papa=5, charlie=4, golf=4, hotel=3, india=3, oscar=3, zulu=3, foxtrot=2, juliett=2, xray=2, sierra=2, tango=2, romeo=2, lima=1, whiskey=1, echo=1]; dominant kind: **build-heavy** (build-heavy=74); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: lima, hotel, foxtrot, delta, charlie, alpha, golf, whiskey, bravo, india, juliett, oscar, papa, echo, xray, zulu, sierra, tango, romeo)
...
- First seen: 2026-05-20T22:45:57.529Z
- Last seen: 2026-06-21T03:39:29.872Z
...
3. Append `{ "id": "skc-g98gc4-2026-06-21", "promotedTo": "<chosen-name>" }` to
