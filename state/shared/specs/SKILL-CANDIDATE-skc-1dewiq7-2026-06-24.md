---
schemaVersion: 1.0.0
id: skc-1dewiq7-2026-06-24
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1dewiq7-2026-06-24`

Observed 9 times across slots [bravo=2, charlie=2, alpha=2, november=1, juliett=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=9); median call count: 5.

## Tool-call signature

```
Bash|Bash|Bash|TaskUpdate|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, november, juliett, charlie, alpha, oscar)
...
- First seen: 2026-05-21T17:39:17.437Z
- Last seen: 2026-06-24T20:34:01.187Z
...
3. Append `{ "id": "skc-1dewiq7-2026-06-24", "promotedTo": "<chosen-name>" }` to
