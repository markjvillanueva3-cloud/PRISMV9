---
schemaVersion: 1.0.0
id: skc-fz9sgu-2026-06-23
generated: 2026-06-23T08:17:01.355Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-fz9sgu-2026-06-23`

Observed 11 times across slots [alpha=2, golf=2, sierra=2, xray=2, mike=1, bravo=1, delta=1]; dominant kind: **build-heavy** (build-heavy=11); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, golf, mike, bravo, sierra, delta, xray)
...
- Last seen: 2026-06-23T00:32:58.072Z
...
3. Append `{ "id": "skc-fz9sgu-2026-06-23", "promotedTo": "<chosen-name>" }` to
