---
schemaVersion: 1.0.0
id: skc-u6m2n6-2026-06-22
generated: 2026-06-23T08:17:01.355Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-u6m2n6-2026-06-22`

Observed 15 times across slots [hotel=4, juliett=1, november=1, charlie=1, delta=1, romeo=1, zulu=1, lima=1, sierra=1, india=1, xray=1]; dominant kind: **build-heavy** (build-heavy=15); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, juliett, november, charlie, delta, romeo, zulu, lima, sierra, india, xray)
...
- Last seen: 2026-06-22T18:01:11.777Z
...
3. Append `{ "id": "skc-u6m2n6-2026-06-22", "promotedTo": "<chosen-name>" }` to
