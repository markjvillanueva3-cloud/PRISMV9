---
schemaVersion: 1.0.0
id: skc-baz7jr-2026-06-11
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-baz7jr-2026-06-11`

Observed 12 times across slots [alpha=3, bravo=1, juliett=1, sierra=1, india=1, tango=1, delta=1, kilo=1, golf=1]; dominant kind: **build-heavy** (build-heavy=12); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, juliett, sierra, alpha, india, tango, delta, kilo, golf)
...
- Last seen: 2026-06-11T23:33:44.712Z
...
3. Append `{ "id": "skc-baz7jr-2026-06-11", "promotedTo": "<chosen-name>" }` to
