---
schemaVersion: 1.0.0
id: skc-1lxkbfv-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1lxkbfv-2026-06-19`

Observed 25 times across slots [alpha=4, bravo=3, zulu=3, delta=2, foxtrot=2, tango=2, india=2, golf=2, charlie=2, sierra=2, lima=1]; dominant kind: **build-heavy** (build-heavy=25); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: delta, lima, bravo, foxtrot, tango, india, alpha, golf, charlie, zulu, sierra)
...
- Last seen: 2026-06-19T18:10:11.074Z
...
3. Append `{ "id": "skc-1lxkbfv-2026-06-19", "promotedTo": "<chosen-name>" }` to
