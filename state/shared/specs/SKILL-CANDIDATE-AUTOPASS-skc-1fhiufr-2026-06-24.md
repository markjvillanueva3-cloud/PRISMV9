---
schemaVersion: 1.0.0
id: skc-1fhiufr-2026-06-24
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1fhiufr-2026-06-24`

Observed 5 times across slots [golf=1, papa=1, echo=1, sierra=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.

## Tool-call signature

```
Bash|Bash|Read|Edit|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: golf, papa, echo, sierra)
...
- First seen: 2026-05-27T03:25:12.070Z
- Last seen: 2026-06-24T17:39:34.644Z
...
3. Append `{ "id": "skc-1fhiufr-2026-06-24", "promotedTo": "<chosen-name>" }` to
