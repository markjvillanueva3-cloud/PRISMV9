---
schemaVersion: 1.0.0
id: skc-1jg1o2r-2026-06-14
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1jg1o2r-2026-06-14`

Observed 9 times across slots [bravo=2, mike=2, alpha=2, juliett=1, xray=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=9); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, mike, alpha, juliett, xray, zulu)
...
- First seen: 2026-05-21T01:05:47.825Z
- Last seen: 2026-06-14T05:50:44.628Z
...
3. Append `{ "id": "skc-1jg1o2r-2026-06-14", "promotedTo": "<chosen-name>" }` to
