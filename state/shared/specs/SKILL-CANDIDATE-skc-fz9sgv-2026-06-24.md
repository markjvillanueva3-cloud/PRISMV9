---
schemaVersion: 1.0.0
id: skc-fz9sgv-2026-06-24
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-fz9sgv-2026-06-24`

Observed 12 times across slots [alpha=2, golf=2, sierra=2, xray=2, mike=1, bravo=1, delta=1, india=1]; dominant kind: **build-heavy** (build-heavy=12); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, golf, mike, bravo, sierra, delta, xray, india)
...
- Last seen: 2026-06-24T03:28:18.097Z
...
3. Append `{ "id": "skc-fz9sgv-2026-06-24", "promotedTo": "<chosen-name>" }` to
