---
schemaVersion: 1.0.0
id: skc-w0nd3c-2026-06-13
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-w0nd3c-2026-06-13`

Observed 21 times across slots [charlie=4, hotel=3, delta=2, bravo=2, echo=2, kilo=2, romeo=1, whiskey=1, india=1]; dominant kind: **build-heavy** (build-heavy=21); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, charlie, delta, bravo, romeo, echo, whiskey, kilo, india)
...
- Last seen: 2026-06-13T19:31:59.300Z
...
3. Append `{ "id": "skc-w0nd3c-2026-06-13", "promotedTo": "<chosen-name>" }` to
