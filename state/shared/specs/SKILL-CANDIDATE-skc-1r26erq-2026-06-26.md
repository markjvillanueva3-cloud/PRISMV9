---
schemaVersion: 1.0.0
id: skc-1r26erq-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1r26erq-2026-06-26`

Observed 19 times across slots [alpha=6, india=3, oscar=2, bravo=2, mike=1, delta=1, foxtrot=1, golf=1, xray=1, charlie=1]; dominant kind: **build-heavy** (build-heavy=19); median call count: 5.

## Tool-call signature

```
Bash|Bash|Bash|Write|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: mike, oscar, delta, foxtrot, golf, alpha, india, bravo, xray, charlie)
...
- First seen: 2026-05-21T18:11:56.458Z
- Last seen: 2026-06-26T01:57:07.547Z
...
3. Append `{ "id": "skc-1r26erq-2026-06-26", "promotedTo": "<chosen-name>" }` to
