---
schemaVersion: 1.0.0
id: skc-1aiec6l-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1aiec6l-2026-06-26`

Observed 22 times across slots [echo=3, alpha=3, charlie=2, papa=2, india=2, zulu=2, sierra=2, bravo=2, whiskey=1, golf=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=22); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, whiskey, charlie, alpha, papa, india, zulu, sierra, bravo, golf, quebec)
...
- First seen: 2026-05-27T08:01:42.215Z
- Last seen: 2026-06-26T02:33:09.730Z
...
3. Append `{ "id": "skc-1aiec6l-2026-06-26", "promotedTo": "<chosen-name>" }` to
