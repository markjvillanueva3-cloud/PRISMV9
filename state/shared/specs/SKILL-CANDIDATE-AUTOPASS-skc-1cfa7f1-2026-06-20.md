---
schemaVersion: 1.0.0
id: skc-1cfa7f1-2026-06-20
generated: 2026-06-21T08:17:01.515Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1cfa7f1-2026-06-20`

Observed 8 times across slots [alpha=4, tango=2, oscar=1, bravo=1]; dominant kind: **build-heavy** (build-heavy=8); median call count: 6.

## Tool-call signature

```
Agent|Agent|Agent|Bash|Write|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, oscar, tango, bravo)
...
- First seen: 2026-06-09T10:51:24.506Z
- Last seen: 2026-06-20T15:43:03.721Z
...
3. Append `{ "id": "skc-1cfa7f1-2026-06-20", "promotedTo": "<chosen-name>" }` to
