---
schemaVersion: 1.0.0
id: skc-1xvttg1-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1xvttg1-2026-06-26`

Observed 14 times across slots [delta=2, sierra=2, juliett=1, golf=1, alpha=1, bravo=1, india=1, echo=1, tango=1]; dominant kind: **build-heavy** (build-heavy=14); median call count: 5.

## Tool-call signature

```
Bash|Bash|Bash|Bash|TaskUpdate
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: juliett, golf, alpha, bravo, delta, india, sierra, echo, tango)
...
- First seen: 2026-05-22T19:43:07.085Z
- Last seen: 2026-06-26T02:58:53.272Z
...
3. Append `{ "id": "skc-1xvttg1-2026-06-26", "promotedTo": "<chosen-name>" }` to
