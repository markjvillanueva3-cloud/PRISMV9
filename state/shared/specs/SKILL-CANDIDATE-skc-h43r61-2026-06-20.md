---
schemaVersion: 1.0.0
id: skc-h43r61-2026-06-20
generated: 2026-06-20T08:17:01.625Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-h43r61-2026-06-20`

Observed 20 times across slots [alpha=5, bravo=3, zulu=3, delta=2, charlie=2, whiskey=1, golf=1, india=1, oscar=1]; dominant kind: **edit-heavy** (edit-heavy=20); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, bravo, whiskey, delta, charlie, golf, zulu, india, oscar)
...
- First seen: 2026-05-22T23:50:17.631Z
- Last seen: 2026-06-20T04:00:09.675Z
...
3. Append `{ "id": "skc-h43r61-2026-06-20", "promotedTo": "<chosen-name>" }` to
