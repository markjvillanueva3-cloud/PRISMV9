---
schemaVersion: 1.0.0
id: skc-kpfe9a-2026-06-26
generated: 2026-06-26T08:17:02.038Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-kpfe9a-2026-06-26`

Observed 7 times across slots [india=2, bravo=1, alpha=1, romeo=1, xray=1, delta=1]; dominant kind: **build-heavy** (build-heavy=7); median call count: 5.

## Tool-call signature

```
Edit|Bash|Bash|Write|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, alpha, romeo, india, xray, delta)
...
- First seen: 2026-05-28T02:21:02.478Z
- Last seen: 2026-06-26T04:23:59.771Z
...
3. Append `{ "id": "skc-kpfe9a-2026-06-26", "promotedTo": "<chosen-name>" }` to
