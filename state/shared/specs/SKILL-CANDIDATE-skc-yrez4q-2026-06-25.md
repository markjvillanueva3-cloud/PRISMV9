---
schemaVersion: 1.0.0
id: skc-yrez4q-2026-06-25
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-yrez4q-2026-06-25`

Observed 10 times across slots [india=1, papa=1, echo=1, alpha=1, delta=1, oscar=1, zulu=1, sierra=1]; dominant kind: **build-heavy** (build-heavy=10); median call count: 6.

## Tool-call signature

```
Edit|Bash|Bash|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: india, papa, echo, alpha, delta, oscar, zulu, sierra)
...
- First seen: 2026-05-29T15:56:12.129Z
- Last seen: 2026-06-25T14:20:21.970Z
...
3. Append `{ "id": "skc-yrez4q-2026-06-25", "promotedTo": "<chosen-name>" }` to
