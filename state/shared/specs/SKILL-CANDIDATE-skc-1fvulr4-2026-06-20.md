---
schemaVersion: 1.0.0
id: skc-1fvulr4-2026-06-20
generated: 2026-06-20T08:17:01.625Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1fvulr4-2026-06-20`

Observed 5 times across slots [bravo=2, oscar=1, kilo=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.

## Tool-call signature

```
Bash|Bash|Agent|Agent|Agent|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: oscar, kilo, bravo, alpha)
...
- First seen: 2026-06-04T17:49:33.465Z
- Last seen: 2026-06-20T04:11:19.174Z
...
3. Append `{ "id": "skc-1fvulr4-2026-06-20", "promotedTo": "<chosen-name>" }` to
