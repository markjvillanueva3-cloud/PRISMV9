---
schemaVersion: 1.0.0
id: skc-otjaep-2026-06-16
generated: 2026-06-17T08:17:01.436Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-otjaep-2026-06-16`

Observed 39 times across slots [alpha=4, sierra=4, charlie=3, bravo=3, delta=2, india=2, oscar=2, mike=1, golf=1, hotel=1, foxtrot=1, juliett=1, papa=1, xray=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=39); median call count: 3.
...
- Last seen: 2026-06-16T18:48:13.560Z
...
3. Append `{ "id": "skc-otjaep-2026-06-16", "promotedTo": "<chosen-name>" }` to
