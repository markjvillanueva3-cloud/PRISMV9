---
schemaVersion: 1.0.0
id: skc-1qno201-2026-06-21
generated: 2026-06-21T08:17:01.515Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1qno201-2026-06-21`

Observed 18 times across slots [golf=4, echo=2, delta=2, alpha=2, zulu=2, charlie=1, india=1, romeo=1, tango=1, papa=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=18); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, charlie, golf, delta, alpha, zulu, india, romeo, tango, papa, quebec)
...
- Last seen: 2026-06-21T02:49:01.511Z
...
3. Append `{ "id": "skc-1qno201-2026-06-21", "promotedTo": "<chosen-name>" }` to
