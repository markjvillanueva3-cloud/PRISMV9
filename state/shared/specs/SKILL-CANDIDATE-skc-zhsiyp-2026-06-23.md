---
schemaVersion: 1.0.0
id: skc-zhsiyp-2026-06-23
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-zhsiyp-2026-06-23`

Observed 5 times across slots [charlie=2, lima=1, sierra=1, xray=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 4.

## Tool-call signature

```
Bash|Write|Bash|TaskUpdate
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, lima, sierra, xray)
...
- First seen: 2026-05-22T22:28:11.758Z
- Last seen: 2026-06-23T17:49:14.724Z
...
3. Append `{ "id": "skc-zhsiyp-2026-06-23", "promotedTo": "<chosen-name>" }` to
