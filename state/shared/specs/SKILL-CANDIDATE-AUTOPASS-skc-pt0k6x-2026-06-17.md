---
schemaVersion: 1.0.0
id: skc-pt0k6x-2026-06-17
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-pt0k6x-2026-06-17`

Observed 5 times across slots [hotel=1, golf=1, delta=1, papa=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.

## Tool-call signature

```
Bash|Read|Edit|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, golf, delta, papa, alpha)
...
- First seen: 2026-05-23T22:20:12.425Z
- Last seen: 2026-06-17T16:55:39.602Z
...
3. Append `{ "id": "skc-pt0k6x-2026-06-17", "promotedTo": "<chosen-name>" }` to
