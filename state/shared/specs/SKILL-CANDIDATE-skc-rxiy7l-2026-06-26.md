---
schemaVersion: 1.0.0
id: skc-rxiy7l-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-rxiy7l-2026-06-26`

Observed 8 times across slots [foxtrot=4, hotel=3, sierra=1]; dominant kind: **edit-heavy** (edit-heavy=8); median call count: 5.

## Tool-call signature

```
Bash|Edit|Edit|Edit|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: foxtrot, hotel, sierra)
...
- First seen: 2026-05-24T21:39:21.648Z
- Last seen: 2026-06-26T00:43:42.915Z
...
3. Append `{ "id": "skc-rxiy7l-2026-06-26", "promotedTo": "<chosen-name>" }` to
