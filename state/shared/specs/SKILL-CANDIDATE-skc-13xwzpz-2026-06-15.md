---
schemaVersion: 1.0.0
id: skc-13xwzpz-2026-06-15
generated: 2026-06-16T17:16:14.428Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-13xwzpz-2026-06-15`

Observed 5 times across slots [hotel=1, bravo=1, delta=1, sierra=1, tango=1]; dominant kind: **edit-heavy** (edit-heavy=5); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, bravo, delta, sierra, tango)
...
- Last seen: 2026-06-15T15:40:21.011Z
...
3. Append `{ "id": "skc-13xwzpz-2026-06-15", "promotedTo": "<chosen-name>" }` to
