---
schemaVersion: 1.0.0
id: skc-otjaen-2026-06-14
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-otjaen-2026-06-14`

Observed 36 times across slots [alpha=4, charlie=3, sierra=3, bravo=2, delta=2, india=2, oscar=2, mike=1, golf=1, hotel=1, foxtrot=1, juliett=1, papa=1, xray=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=36); median call count: 3.
...
- Last seen: 2026-06-14T07:10:10.739Z
...
3. Append `{ "id": "skc-otjaen-2026-06-14", "promotedTo": "<chosen-name>" }` to
