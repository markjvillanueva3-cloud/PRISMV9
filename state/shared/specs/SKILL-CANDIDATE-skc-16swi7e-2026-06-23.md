---
schemaVersion: 1.0.0
id: skc-16swi7e-2026-06-23
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-16swi7e-2026-06-23`

Observed 36 times across slots [whiskey=6, delta=6, charlie=5, alpha=4, india=3, sierra=3, foxtrot=2, kilo=1, golf=1, juliett=1, papa=1, tango=1, echo=1, romeo=1]; dominant kind: **build-heavy** (build-heavy=36); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, foxtrot, charlie, kilo, whiskey, delta, golf, india, juliett, sierra, papa, tango, echo, romeo)
...
- Last seen: 2026-06-23T19:23:37.323Z
...
3. Append `{ "id": "skc-16swi7e-2026-06-23", "promotedTo": "<chosen-name>" }` to
