---
schemaVersion: 1.0.0
id: skc-h3uga-2026-06-23
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-h3uga-2026-06-23`

Observed 16 times across slots [india=2, golf=2, papa=2, hotel=1, november=1, foxtrot=1, alpha=1, delta=1, bravo=1, charlie=1, zulu=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=16); median call count: 7.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, india, november, golf, foxtrot, alpha, delta, bravo, charlie, papa, zulu, quebec)
...
- Last seen: 2026-06-23T17:57:52.182Z
...
3. Append `{ "id": "skc-h3uga-2026-06-23", "promotedTo": "<chosen-name>" }` to
