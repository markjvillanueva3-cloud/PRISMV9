---
schemaVersion: 1.0.0
id: skc-4boypq-2026-06-11
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-4boypq-2026-06-11`

Observed 5 times across slots [alpha=2, lima=1, whiskey=1, golf=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 4.

## Tool-call signature

```
Write|Bash|Bash|TaskUpdate
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, lima, whiskey, golf)
...
- First seen: 2026-05-27T00:02:55.618Z
- Last seen: 2026-06-11T03:59:23.783Z
...
3. Append `{ "id": "skc-4boypq-2026-06-11", "promotedTo": "<chosen-name>" }` to
