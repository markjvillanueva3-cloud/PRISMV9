---
schemaVersion: 1.0.0
id: skc-of0xn0-2026-06-11
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-of0xn0-2026-06-11`

Observed 36 times across slots [alpha=8, golf=5, charlie=4, echo=4, hotel=3, foxtrot=3, bravo=3, whiskey=2, kilo=1, romeo=1, juliett=1]; dominant kind: **build-heavy** (build-heavy=36); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, foxtrot, alpha, charlie, kilo, romeo, golf, juliett, echo, bravo, whiskey)
...
- Last seen: 2026-06-11T23:01:19.460Z
...
3. Append `{ "id": "skc-of0xn0-2026-06-11", "promotedTo": "<chosen-name>" }` to
