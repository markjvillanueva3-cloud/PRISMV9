---
schemaVersion: 1.0.0
id: skc-t0add4-2026-06-21
generated: 2026-06-22T08:17:01.977Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-t0add4-2026-06-21`

Observed 25 times across slots [bravo=5, whiskey=3, india=3, charlie=3, alpha=3, echo=1, romeo=1, kilo=1, sierra=1, delta=1, golf=1, papa=1]; dominant kind: **build-heavy** (build-heavy=25); median call count: 3.
...
- Last seen: 2026-06-21T10:52:35.249Z
...
3. Append `{ "id": "skc-t0add4-2026-06-21", "promotedTo": "<chosen-name>" }` to
