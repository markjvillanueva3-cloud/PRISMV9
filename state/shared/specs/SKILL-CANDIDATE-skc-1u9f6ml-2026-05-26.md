---
schemaVersion: 1.0.0
id: skc-1u9f6ml-2026-05-26
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1u9f6ml-2026-05-26`

Observed 17 times across slots [november=17]; dominant kind: **build-heavy** (build-heavy=17); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: november)
...
- Last seen: 2026-05-26T10:54:50.780Z
...
3. Append `{ "id": "skc-1u9f6ml-2026-05-26", "promotedTo": "<chosen-name>" }` to
