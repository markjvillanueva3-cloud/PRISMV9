---
schemaVersion: 1.0.0
id: skc-172v62o-2026-06-21
generated: 2026-06-21T08:17:01.515Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-172v62o-2026-06-21`

Observed 153 times across slots [alpha=15, bravo=14, delta=14, golf=11, sierra=10, charlie=9, india=8, whiskey=8, kilo=8, papa=8, echo=7, juliett=6, romeo=5, hotel=4, zulu=4, xray=3, mike=2, tango=2, lima=1, foxtrot=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=153); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, india, echo, golf, whiskey, charlie, alpha, mike, kilo, delta, lima, papa, hotel, juliett, sierra, foxtrot, romeo, xray, zulu, tango, oscar)
...
- Last seen: 2026-06-21T03:01:15.026Z
...
3. Append `{ "id": "skc-172v62o-2026-06-21", "promotedTo": "<chosen-name>" }` to
