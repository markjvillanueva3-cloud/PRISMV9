---
schemaVersion: 1.0.0
id: skc-u6m2m8-2026-06-11
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-u6m2m8-2026-06-11`

Observed 12 times across slots [hotel=4, juliett=1, november=1, charlie=1, delta=1, romeo=1, zulu=1, lima=1]; dominant kind: **build-heavy** (build-heavy=12); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, juliett, november, charlie, delta, romeo, zulu, lima)
...
- Last seen: 2026-06-11T22:11:04.402Z
...
3. Append `{ "id": "skc-u6m2m8-2026-06-11", "promotedTo": "<chosen-name>" }` to
