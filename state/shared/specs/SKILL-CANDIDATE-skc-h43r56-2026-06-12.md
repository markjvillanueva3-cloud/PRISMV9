---
schemaVersion: 1.0.0
id: skc-h43r56-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-h43r56-2026-06-12`

Observed 17 times across slots [alpha=5, bravo=3, delta=2, charlie=2, zulu=2, whiskey=1, golf=1]; dominant kind: **edit-heavy** (edit-heavy=17); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, bravo, whiskey, delta, charlie, golf, zulu)
...
- Last seen: 2026-06-12T16:05:22.654Z
...
3. Append `{ "id": "skc-h43r56-2026-06-12", "promotedTo": "<chosen-name>" }` to
