---
schemaVersion: 1.0.0
id: skc-kax1hq-2026-06-26
generated: 2026-06-26T08:17:02.038Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-kax1hq-2026-06-26`

Observed 6 times across slots [india=2, golf=1, alpha=1, delta=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 5.

## Tool-call signature

```
Edit|Bash|Write|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: india, golf, alpha, delta)
...
- First seen: 2026-05-24T03:30:26.972Z
- Last seen: 2026-06-26T04:19:44.499Z
...
3. Append `{ "id": "skc-kax1hq-2026-06-26", "promotedTo": "<chosen-name>" }` to
