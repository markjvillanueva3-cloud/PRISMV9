---
schemaVersion: 1.0.0
id: skc-1qno1z5-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1qno1z5-2026-06-12`

Observed 13 times across slots [golf=3, echo=2, delta=2, alpha=2, zulu=2, charlie=1, india=1]; dominant kind: **build-heavy** (build-heavy=13); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, charlie, golf, delta, alpha, zulu, india)
...
- Last seen: 2026-06-12T04:32:28.238Z
...
3. Append `{ "id": "skc-1qno1z5-2026-06-12", "promotedTo": "<chosen-name>" }` to
