---
schemaVersion: 1.0.0
id: skc-j97aup-2026-06-24
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-j97aup-2026-06-24`

Observed 46 times across slots [sierra=6, oscar=5, delta=4, hotel=3, romeo=3, alpha=3, mike=2, bravo=2, juliett=2, golf=2, papa=2, zulu=2, november=1, whiskey=1, echo=1, foxtrot=1, tango=1, quebec=1, india=1, xray=1]; dominant kind: **build-heavy** (build-heavy=46); median call count: 6.
...
- Last seen: 2026-06-24T02:57:25.490Z
...
3. Append `{ "id": "skc-j97aup-2026-06-24", "promotedTo": "<chosen-name>" }` to
