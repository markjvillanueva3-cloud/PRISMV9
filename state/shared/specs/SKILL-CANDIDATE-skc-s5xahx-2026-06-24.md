---
schemaVersion: 1.0.0
id: skc-s5xahx-2026-06-24
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-s5xahx-2026-06-24`

Observed 8 times across slots [echo=1, hotel=1, mike=1, lima=1, delta=1, charlie=1]; dominant kind: **build-heavy** (build-heavy=8); median call count: 8.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, hotel, mike, lima, delta, charlie)
...
- First seen: 2026-05-21T00:27:07.637Z
- Last seen: 2026-06-24T15:22:19.830Z
...
3. Append `{ "id": "skc-s5xahx-2026-06-24", "promotedTo": "<chosen-name>" }` to
