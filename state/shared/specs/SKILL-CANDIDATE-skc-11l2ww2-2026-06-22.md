---
schemaVersion: 1.0.0
id: skc-11l2ww2-2026-06-22
generated: 2026-06-22T08:17:01.977Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-11l2ww2-2026-06-22`

Observed 6 times across slots [sierra=3, bravo=1, zulu=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: sierra, bravo, zulu, alpha)
...
- Last seen: 2026-06-22T01:46:41.573Z
...
3. Append `{ "id": "skc-11l2ww2-2026-06-22", "promotedTo": "<chosen-name>" }` to
