---
schemaVersion: 1.0.0
id: skc-1r26erl-2026-06-21
generated: 2026-06-21T08:17:01.515Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1r26erl-2026-06-21`

Observed 16 times across slots [alpha=5, india=3, oscar=2, mike=1, delta=1, foxtrot=1, golf=1, bravo=1, xray=1]; dominant kind: **build-heavy** (build-heavy=16); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: mike, oscar, delta, foxtrot, golf, alpha, india, bravo, xray)
...
- Last seen: 2026-06-21T05:05:08.840Z
...
3. Append `{ "id": "skc-1r26erl-2026-06-21", "promotedTo": "<chosen-name>" }` to
