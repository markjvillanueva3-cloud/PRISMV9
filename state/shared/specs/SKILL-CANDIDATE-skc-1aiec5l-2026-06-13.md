---
schemaVersion: 1.0.0
id: skc-1aiec5l-2026-06-13
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1aiec5l-2026-06-13`

Observed 14 times across slots [echo=3, charlie=2, zulu=2, whiskey=1, alpha=1, papa=1, india=1, sierra=1, bravo=1]; dominant kind: **build-heavy** (build-heavy=14); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, whiskey, charlie, alpha, papa, india, zulu, sierra, bravo)
...
- Last seen: 2026-06-13T18:30:23.377Z
...
3. Append `{ "id": "skc-1aiec5l-2026-06-13", "promotedTo": "<chosen-name>" }` to
