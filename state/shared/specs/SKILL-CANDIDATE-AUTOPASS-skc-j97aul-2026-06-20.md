---
schemaVersion: 1.0.0
id: skc-j97aul-2026-06-20
generated: 2026-06-20T08:17:01.625Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-j97aul-2026-06-20`

Observed 34 times across slots [delta=4, hotel=3, alpha=3, sierra=3, mike=2, romeo=2, juliett=2, golf=2, papa=2, zulu=2, november=1, bravo=1, whiskey=1, echo=1, foxtrot=1, tango=1, oscar=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=34); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: mike, hotel, delta, romeo, november, alpha, bravo, juliett, whiskey, golf, echo, papa, sierra, foxtrot, tango, zulu, oscar, quebec)
...
- Last seen: 2026-06-20T03:19:53.419Z
...
3. Append `{ "id": "skc-j97aul-2026-06-20", "promotedTo": "<chosen-name>" }` to
