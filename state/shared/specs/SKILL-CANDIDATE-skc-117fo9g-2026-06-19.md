---
schemaVersion: 1.0.0
id: skc-117fo9g-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-117fo9g-2026-06-19`

Observed 14 times across slots [sierra=2, delta=2, bravo=2, papa=1, juliett=1, quebec=1, oscar=1, charlie=1, alpha=1, zulu=1, romeo=1]; dominant kind: **build-heavy** (build-heavy=14); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: papa, juliett, sierra, quebec, delta, oscar, charlie, bravo, alpha, zulu, romeo)
...
- Last seen: 2026-06-19T19:28:04.804Z
...
3. Append `{ "id": "skc-117fo9g-2026-06-19", "promotedTo": "<chosen-name>" }` to
