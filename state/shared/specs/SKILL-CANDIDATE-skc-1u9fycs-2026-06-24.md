---
schemaVersion: 1.0.0
id: skc-1u9fycs-2026-06-24
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1u9fycs-2026-06-24`

Observed 19 times across slots [november=17, india=1, xray=1]; dominant kind: **build-heavy** (build-heavy=19); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: november, india, xray)
...
- Last seen: 2026-06-24T19:41:56.221Z
...
3. Append `{ "id": "skc-1u9fycs-2026-06-24", "promotedTo": "<chosen-name>" }` to
