---
schemaVersion: 1.0.0
id: skc-1gj76dz-2026-06-24
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1gj76dz-2026-06-24`

Observed 6 times across slots [golf=1, foxtrot=1, sierra=1, zulu=1, oscar=1, papa=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: golf, foxtrot, sierra, zulu, oscar, papa)
...
- Last seen: 2026-06-24T14:56:01.513Z
...
3. Append `{ "id": "skc-1gj76dz-2026-06-24", "promotedTo": "<chosen-name>" }` to
