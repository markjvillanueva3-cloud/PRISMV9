---
schemaVersion: 1.0.0
id: skc-5emsa1-2026-06-24
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-5emsa1-2026-06-24`

Observed 8 times across slots [alpha=2, lima=1, whiskey=1, zulu=1]; dominant kind: **edit-heavy** (edit-heavy=8); median call count: 6.

## Tool-call signature

```
Edit|Edit|Edit|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: lima, alpha, whiskey, zulu)
...
- First seen: 2026-05-24T19:48:32.014Z
- Last seen: 2026-06-24T03:02:01.782Z
...
3. Append `{ "id": "skc-5emsa1-2026-06-24", "promotedTo": "<chosen-name>" }` to
