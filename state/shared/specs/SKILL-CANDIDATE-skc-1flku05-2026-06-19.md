---
schemaVersion: 1.0.0
id: skc-1flku05-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1flku05-2026-06-19`

Observed 6 times across slots [zulu=2, alpha=1, oscar=1, charlie=1, sierra=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, oscar, zulu, charlie, sierra)
...
- First seen: 2026-05-25T05:17:07.614Z
- Last seen: 2026-06-19T14:34:42.219Z
...
3. Append `{ "id": "skc-1flku05-2026-06-19", "promotedTo": "<chosen-name>" }` to
