---
schemaVersion: 1.0.0
id: skc-ohzs3q-2026-06-23
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-ohzs3q-2026-06-23`

Observed 12 times across slots [papa=3, charlie=2, alpha=2, bravo=1, sierra=1, delta=1, zulu=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=12); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, bravo, alpha, sierra, papa, delta, zulu, quebec)
...
- Last seen: 2026-06-23T14:49:02.942Z
...
3. Append `{ "id": "skc-ohzs3q-2026-06-23", "promotedTo": "<chosen-name>" }` to
