---
schemaVersion: 1.0.0
id: skc-1deubtq-2026-06-23
generated: 2026-06-23T08:17:01.355Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1deubtq-2026-06-23`

Observed 24 times across slots [bravo=4, india=4, charlie=4, foxtrot=3, delta=2, hotel=1, alpha=1, golf=1, papa=1, xray=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=24); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, hotel, foxtrot, india, charlie, alpha, delta, golf, papa, xray, quebec)
...
- Last seen: 2026-06-23T01:47:41.663Z
...
3. Append `{ "id": "skc-1deubtq-2026-06-23", "promotedTo": "<chosen-name>" }` to
