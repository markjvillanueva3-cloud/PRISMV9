---
schemaVersion: 1.0.0
id: skc-13xwzqv-2026-06-24
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-13xwzqv-2026-06-24`

Observed 7 times across slots [hotel=1, bravo=1, delta=1, sierra=1, tango=1, oscar=1, zulu=1]; dominant kind: **edit-heavy** (edit-heavy=7); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, bravo, delta, sierra, tango, oscar, zulu)
...
- Last seen: 2026-06-24T01:45:51.617Z
...
3. Append `{ "id": "skc-13xwzqv-2026-06-24", "promotedTo": "<chosen-name>" }` to
