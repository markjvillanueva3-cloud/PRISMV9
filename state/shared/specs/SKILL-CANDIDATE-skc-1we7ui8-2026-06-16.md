---
schemaVersion: 1.0.0
id: skc-1we7ui8-2026-06-16
generated: 2026-06-16T17:16:14.428Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1we7ui8-2026-06-16`

Observed 7 times across slots [oscar=2, hotel=1, papa=1, india=1, golf=1, kilo=1]; dominant kind: **build-heavy** (build-heavy=7); median call count: 5.

## Tool-call signature

```
Bash|Bash|TaskUpdate|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, oscar, papa, india, golf, kilo)
...
- First seen: 2026-05-23T01:10:17.571Z
- Last seen: 2026-06-16T00:49:43.012Z
...
3. Append `{ "id": "skc-1we7ui8-2026-06-16", "promotedTo": "<chosen-name>" }` to
