---
schemaVersion: 1.0.0
id: skc-75dm8w-2026-06-17
generated: 2026-06-17T08:17:01.436Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-75dm8w-2026-06-17`

Observed 5 times across slots [charlie=2, juliett=1, golf=1, romeo=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, juliett, golf, romeo)
...
- Last seen: 2026-06-17T04:12:15.323Z
...
3. Append `{ "id": "skc-75dm8w-2026-06-17", "promotedTo": "<chosen-name>" }` to
