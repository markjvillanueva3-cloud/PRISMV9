---
schemaVersion: 1.0.0
id: skc-13xwzqx-2026-06-26
generated: 2026-06-26T13:37:35.094Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-13xwzqx-2026-06-26`

Observed 8 times across slots [hotel=1, bravo=1, delta=1, sierra=1, tango=1, oscar=1, zulu=1, whiskey=1]; dominant kind: **edit-heavy** (edit-heavy=8); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, bravo, delta, sierra, tango, oscar, zulu, whiskey)
...
- First seen: 2026-05-26T03:23:59.147Z
- Last seen: 2026-06-26T09:43:01.170Z
...
3. Append `{ "id": "skc-13xwzqx-2026-06-26", "promotedTo": "<chosen-name>" }` to
