---
schemaVersion: 1.0.0
id: skc-1a8foad-2026-06-17
generated: 2026-06-17T08:17:01.436Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1a8foad-2026-06-17`

Observed 9 times across slots [whiskey=3, foxtrot=1, kilo=1, sierra=1, alpha=1]; dominant kind: **edit-heavy** (edit-heavy=9); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: foxtrot, whiskey, kilo, sierra, alpha)
...
- Last seen: 2026-06-17T03:47:20.187Z
...
3. Append `{ "id": "skc-1a8foad-2026-06-17", "promotedTo": "<chosen-name>" }` to
