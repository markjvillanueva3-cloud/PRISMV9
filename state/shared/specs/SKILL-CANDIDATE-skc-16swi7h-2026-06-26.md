---
schemaVersion: 1.0.0
id: skc-16swi7h-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-16swi7h-2026-06-26`

Observed 37 times across slots [whiskey=6, delta=6, charlie=5, alpha=4, india=3, sierra=3, foxtrot=2, kilo=1, golf=1, juliett=1, papa=1, tango=1, echo=1, romeo=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=37); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, foxtrot, charlie, kilo, whiskey, delta, golf, india, juliett, sierra, papa, tango, echo, romeo, quebec)
...
- First seen: 2026-05-23T00:18:56.776Z
- Last seen: 2026-06-26T01:50:22.983Z
...
3. Append `{ "id": "skc-16swi7h-2026-06-26", "promotedTo": "<chosen-name>" }` to
