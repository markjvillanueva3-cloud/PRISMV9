---
schemaVersion: 1.0.0
id: skc-idk818-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-idk818-2026-06-18`

Observed 6 times across slots [oscar=1, charlie=1, india=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: oscar, charlie, india, alpha)
...
- Last seen: 2026-06-18T18:43:27.852Z
...
3. Append `{ "id": "skc-idk818-2026-06-18", "promotedTo": "<chosen-name>" }` to
