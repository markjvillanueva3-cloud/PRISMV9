---
schemaVersion: 1.0.0
id: skc-ktl9gl-2026-06-26
generated: 2026-06-26T13:37:35.094Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-ktl9gl-2026-06-26`

Observed 5 times across slots [alpha=1, sierra=1, oscar=1, zulu=1, whiskey=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, sierra, oscar, zulu, whiskey)
...
- First seen: 2026-05-27T02:05:25.148Z
- Last seen: 2026-06-26T10:48:48.233Z
...
3. Append `{ "id": "skc-ktl9gl-2026-06-26", "promotedTo": "<chosen-name>" }` to
