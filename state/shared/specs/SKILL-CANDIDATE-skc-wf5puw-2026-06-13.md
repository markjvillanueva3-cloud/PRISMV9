---
schemaVersion: 1.0.0
id: skc-wf5puw-2026-06-13
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-wf5puw-2026-06-13`

Observed 20 times across slots [alpha=4, sierra=3, charlie=2, golf=2, zulu=2, november=1, india=1, lima=1, echo=1, juliett=1, bravo=1]; dominant kind: **build-heavy** (build-heavy=20); median call count: 4.
...
- Last seen: 2026-06-13T21:55:43.971Z
...
3. Append `{ "id": "skc-wf5puw-2026-06-13", "promotedTo": "<chosen-name>" }` to
