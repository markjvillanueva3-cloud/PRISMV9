---
schemaVersion: 1.0.0
id: skc-of0xn7-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-of0xn7-2026-06-18`

Observed 37 times across slots [alpha=8, golf=5, charlie=4, echo=4, hotel=3, foxtrot=3, bravo=3, whiskey=2, kilo=1, romeo=1, juliett=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=37); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, foxtrot, alpha, charlie, kilo, romeo, golf, juliett, echo, bravo, whiskey, zulu)
...
- Last seen: 2026-06-18T19:51:20.526Z
...
3. Append `{ "id": "skc-of0xn7-2026-06-18", "promotedTo": "<chosen-name>" }` to
