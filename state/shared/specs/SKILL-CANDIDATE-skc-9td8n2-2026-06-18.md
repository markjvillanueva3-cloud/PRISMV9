---
schemaVersion: 1.0.0
id: skc-9td8n2-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-9td8n2-2026-06-18`

Observed 7 times across slots [kilo=2, echo=1, alpha=1, delta=1, xray=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=7); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, alpha, kilo, delta, xray, zulu)
...
- Last seen: 2026-06-18T14:04:41.752Z
...
3. Append `{ "id": "skc-9td8n2-2026-06-18", "promotedTo": "<chosen-name>" }` to
