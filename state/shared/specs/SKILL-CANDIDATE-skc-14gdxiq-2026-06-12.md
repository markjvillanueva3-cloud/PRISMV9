---
schemaVersion: 1.0.0
id: skc-14gdxiq-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-14gdxiq-2026-06-12`

Observed 10 times across slots [delta=2, charlie=2, kilo=1, sierra=1, alpha=1, india=1, hotel=1, papa=1]; dominant kind: **build-heavy** (build-heavy=10); median call count: 4.

## Tool-call signature

```
Bash|TaskUpdate|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: kilo, delta, sierra, alpha, charlie, india, hotel, papa)
...
- First seen: 2026-05-21T21:12:03.776Z
- Last seen: 2026-06-12T02:33:06.772Z
...
3. Append `{ "id": "skc-14gdxiq-2026-06-12", "promotedTo": "<chosen-name>" }` to
