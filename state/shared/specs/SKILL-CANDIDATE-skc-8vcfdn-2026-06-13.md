---
schemaVersion: 1.0.0
id: skc-8vcfdn-2026-06-13
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-8vcfdn-2026-06-13`

Observed 166 times across slots [alpha=17, charlie=13, golf=13, hotel=12, foxtrot=12, whiskey=12, romeo=12, echo=11, delta=9, bravo=9, sierra=8, papa=6, juliett=4, india=4, zulu=3, lima=2, november=2, victor=2, oscar=2, kilo=1, mike=1]; dominant kind: **build-heavy** (build-heavy=166); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: lima, delta, juliett, hotel, november, charlie, golf, alpha, foxtrot, bravo, kilo, whiskey, romeo, india, papa, echo, sierra, mike, victor, oscar, zulu)
...
- Last seen: 2026-06-13T07:29:12.433Z
...
3. Append `{ "id": "skc-8vcfdn-2026-06-13", "promotedTo": "<chosen-name>" }` to
