---
schemaVersion: 1.0.0
id: skc-jesyjr-2026-06-15
generated: 2026-06-16T17:16:14.428Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-jesyjr-2026-06-15`

Observed 6 times across slots [whiskey=2, juliett=1, bravo=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 5.

## Tool-call signature

```
Bash|Bash|Edit|Edit|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: juliett, whiskey, bravo, zulu)
...
- First seen: 2026-05-31T03:54:52.090Z
- Last seen: 2026-06-15T22:01:02.263Z
...
3. Append `{ "id": "skc-jesyjr-2026-06-15", "promotedTo": "<chosen-name>" }` to
