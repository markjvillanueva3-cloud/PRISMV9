# U-PSN-R3-PREF-01 — DPO training pipeline on JM-DIE outcomes
...
2. **Engine target:**
   ...
   - Candidate name: `R3PREF01Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3PREF01Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.575Z_