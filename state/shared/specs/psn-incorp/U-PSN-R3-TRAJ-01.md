# U-PSN-R3-TRAJ-01 — Tree-of-Thought beam search
...
2. **Engine target:**
   ...
   - Candidate name: `R3TRAJ01Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3TRAJ01Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.766Z_