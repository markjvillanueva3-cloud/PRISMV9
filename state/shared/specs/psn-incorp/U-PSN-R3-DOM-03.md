# U-PSN-R3-DOM-03 — Marco-o1 / LLaMA-Berry / OpenR reference study
...
Open-source o1 implementations
...
2. **Engine target:**
   ...
   - Candidate name: `R3DOM03Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3DOM03Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.805Z_