# U-PSN-R3-PEFT-02 — DoRA weight-decomposed LoRA
...
2. **Engine target:**
   ...
   - Candidate name: `R3PEFT02Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3PEFT02Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.680Z_