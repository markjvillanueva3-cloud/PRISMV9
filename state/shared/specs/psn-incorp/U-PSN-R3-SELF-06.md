# U-PSN-R3-SELF-06 — Self-Reward (Meta) — model rewards own outputs
...
Octopus 3-of-3 is the cousin pattern
...
2. **Engine target:**
   ...
   - Candidate name: `R3SELF06Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3SELF06Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.673Z_