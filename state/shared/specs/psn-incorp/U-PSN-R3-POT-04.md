# U-PSN-R3-POT-04 — Z3/cvc5 SMT for physics constraints
...
WEDM multi-constraint optimization
...
2. **Engine target:**
   ...
   - Candidate name: `R3POT04Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3POT04Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.779Z_