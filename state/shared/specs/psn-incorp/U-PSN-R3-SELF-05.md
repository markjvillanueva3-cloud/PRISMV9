# U-PSN-R3-SELF-05 — REST-EM iterative self-training
...
PRISM /loop is structurally REST-EM
...
2. **Engine target:**
   ...
   - Candidate name: `R3SELF05Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3SELF05Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.672Z_