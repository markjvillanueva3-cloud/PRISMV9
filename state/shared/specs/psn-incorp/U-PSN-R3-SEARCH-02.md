# U-PSN-R3-SEARCH-02 — PRM (Process Reward Model) training
...
Score reasoning steps for tree pruning
...
2. **Engine target:**
   ...
   - Candidate name: `R3SEARCH02Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3SEARCH02Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.760Z_