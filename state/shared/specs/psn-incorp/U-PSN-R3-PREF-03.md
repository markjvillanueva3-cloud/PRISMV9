# U-PSN-R3-PREF-03 — IPO noise-robust preference optimization
...
2. **Engine target:**
   ...
   - Candidate name: `R3PREF03Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3PREF03Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.578Z_