# U-PSN-R3-CONT-02 — Replay buffer over slot session logs
...
2. **Engine target:**
   ...
   - Candidate name: `R3CONT02Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3CONT02Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.724Z_