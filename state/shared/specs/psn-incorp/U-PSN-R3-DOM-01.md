# U-PSN-R3-DOM-01 — Claude extended-thinking flag enabled per-engine
...
2. **Engine target:**
   ...
   - Candidate name: `R3DOM01Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3DOM01Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.796Z_