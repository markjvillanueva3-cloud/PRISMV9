# U-PSN-R3-OPT-04 — GEPA prompt optimizer (Stanford 2025)
...
Beats DSPy MIPRO on benchmarks
...
2. **Engine target:**
   ...
   - Candidate name: `R3OPT04Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3OPT04Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.755Z_