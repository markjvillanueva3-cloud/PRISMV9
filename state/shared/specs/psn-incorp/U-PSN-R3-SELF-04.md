# U-PSN-R3-SELF-04 — SPIN self-play fine-tuning cold-start
...
2. **Engine target:**
   ...
   - Candidate name: `R3SELF04Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3SELF04Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.670Z_