# U-PSN-R3-TRAJ-04 — Least-to-Most decomposition pattern
...
2. **Engine target:**
   ...
   - Candidate name: `R3TRAJ04Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3TRAJ04Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.769Z_