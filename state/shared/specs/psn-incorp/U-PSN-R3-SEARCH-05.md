# U-PSN-R3-SEARCH-05 — AlphaProof / AlphaGeometry formal-proof study
...
Reference for formal safety verification
...
2. **Engine target:**
   ...
   - Candidate name: `R3SEARCH05Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3SEARCH05Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.764Z_