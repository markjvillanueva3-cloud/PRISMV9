# U-PSN-R1-NN-04 — Magentic-One orchestrator pattern study
...
Reference architecture for slot system
...
2. **Engine target:**
   ...
   - Candidate name: `R1NN04Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R1NN04Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.568Z_