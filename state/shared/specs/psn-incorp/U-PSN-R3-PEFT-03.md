# U-PSN-R3-PEFT-03 — LongLoRA context-extension training
...
2. **Engine target:**
   ...
   - Candidate name: `R3PEFT03Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3PEFT03Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.681Z_