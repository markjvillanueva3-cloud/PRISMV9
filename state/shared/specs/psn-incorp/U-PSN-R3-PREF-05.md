# U-PSN-R3-PREF-05 — GRPO (DeepSeek R1 algorithm) for reasoning RL
...
R1's breakthrough enabling cheap reasoning
...
2. **Engine target:**
   ...
   - Candidate name: `R3PREF05Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3PREF05Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.624Z_