# U-PSN-R3-PREF-02 — KTO binary-label training (shipped/aborted)
...
100x cheaper labeling than DPO pairs
...
2. **Engine target:**
   ...
   - Candidate name: `R3PREF02Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3PREF02Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.576Z_