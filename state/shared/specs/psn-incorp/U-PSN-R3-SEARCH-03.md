# U-PSN-R3-SEARCH-03 — ORM (Outcome Reward Model) for shop-floor outputs
...
2. **Engine target:**
   ...
   - Candidate name: `R3SEARCH03Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3SEARCH03Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.761Z_