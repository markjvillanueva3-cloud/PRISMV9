# U-PSN-R3-PEFT-05 — MoLE mixture-of-LoRA-experts per slot domain
...
2. **Engine target:**
   ...
   - Candidate name: `R3PEFT05Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3PEFT05Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.692Z_