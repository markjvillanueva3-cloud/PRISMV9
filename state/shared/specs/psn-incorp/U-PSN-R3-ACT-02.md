# U-PSN-R3-ACT-02 — Curriculum learning ordering for JM-DIE
...
2. **Engine target:**
   ...
   - Candidate name: `R3ACT02Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3ACT02Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.705Z_