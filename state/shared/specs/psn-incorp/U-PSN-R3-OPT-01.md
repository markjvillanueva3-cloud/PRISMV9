# U-PSN-R3-OPT-01 — DSPy auto-optimizers for octopus prompts
...
R3 TOP-10; BootstrapFewShot + MIPRO
...
2. **Engine target:**
   ...
   - Candidate name: `R3OPT01Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3OPT01Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.750Z_