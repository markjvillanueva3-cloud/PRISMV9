# U-PSN-R3-ACT-03 — Confidence-aware sample skipping
...
Pairs with AtomicValue<T>.confidence
...
2. **Engine target:**
   ...
   - Candidate name: `R3ACT03Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3ACT03Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.706Z_