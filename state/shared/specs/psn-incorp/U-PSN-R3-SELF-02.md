# U-PSN-R3-SELF-02 — Quiet-STaR implicit thinking tokens
...
+10% GSM8K-equivalent without labels
...
2. **Engine target:**
   ...
   - Candidate name: `R3SELF02Engine` (verify via dedup before committing).
...
3. **Test target:**
   ...
   - File: `mcp-server/src/__tests__/R3SELF02Engine.test.ts` (per [[feedback_engine_tests_in_tests_dir]]).
...
_Generated: 2026-05-24T02:35:23.641Z_