---
schemaVersion: 1.0.0
id: skc-1xvttea-2026-06-09
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1xvttea-2026-06-09`

Observed 11 times across slots [juliett=1, golf=1, alpha=1, bravo=1, delta=1, india=1, sierra=1, echo=1]; dominant kind: **build-heavy** (build-heavy=11); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: juliett, golf, alpha, bravo, delta, india, sierra, echo)
...
- Last seen: 2026-06-09T19:10:24.501Z
...
3. Append `{ "id": "skc-1xvttea-2026-06-09", "promotedTo": "<chosen-name>" }` to
