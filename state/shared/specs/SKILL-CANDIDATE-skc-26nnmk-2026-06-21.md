---
schemaVersion: 1.0.0
id: skc-26nnmk-2026-06-21
generated: 2026-06-21T08:17:01.515Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-26nnmk-2026-06-21`

Observed 12 times across slots [alpha=2, india=2, romeo=2, sierra=1, tango=1, zulu=1, bravo=1]; dominant kind: **build-heavy** (build-heavy=12); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: sierra, tango, alpha, india, zulu, romeo, bravo)
...
- Last seen: 2026-06-21T06:13:38.554Z
...
3. Append `{ "id": "skc-26nnmk-2026-06-21", "promotedTo": "<chosen-name>" }` to
