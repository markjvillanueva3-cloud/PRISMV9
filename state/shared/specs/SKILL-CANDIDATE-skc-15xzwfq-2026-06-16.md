---
schemaVersion: 1.0.0
id: skc-15xzwfq-2026-06-16
generated: 2026-06-17T08:17:01.436Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-15xzwfq-2026-06-16`

Observed 23 times across slots [sierra=4, echo=3, romeo=2, hotel=2, delta=1, juliett=1, mike=1, charlie=1, victor=1, alpha=1, golf=1, tango=1]; dominant kind: **build-heavy** (build-heavy=23); median call count: 4.

## Tool-call signature

```
Bash|Bash|Bash|TaskUpdate
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: delta, juliett, echo, romeo, hotel, mike, charlie, victor, sierra, alpha, golf, tango)
...
- First seen: 2026-05-22T20:59:00.333Z
- Last seen: 2026-06-16T18:19:44.622Z
...
3. Append `{ "id": "skc-15xzwfq-2026-06-16", "promotedTo": "<chosen-name>" }` to
