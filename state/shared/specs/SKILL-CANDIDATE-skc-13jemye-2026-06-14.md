---
schemaVersion: 1.0.0
id: skc-13jemye-2026-06-14
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-13jemye-2026-06-14`

Observed 7 times across slots [alpha=2, echo=1, sierra=1, zulu=1, charlie=1]; dominant kind: **edit-heavy** (edit-heavy=7); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, sierra, alpha, zulu, charlie)
...
- Last seen: 2026-06-14T05:54:35.067Z
...
3. Append `{ "id": "skc-13jemye-2026-06-14", "promotedTo": "<chosen-name>" }` to
