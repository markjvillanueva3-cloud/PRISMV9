---
schemaVersion: 1.0.0
id: skc-a5skn4-2026-06-15
generated: 2026-06-15T08:17:01.126Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-a5skn4-2026-06-15`

Observed 6 times across slots [alpha=2, hotel=1, papa=1, oscar=1, echo=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, alpha, papa, oscar, echo)
...
- First seen: 2026-05-30T05:03:30.099Z
- Last seen: 2026-06-15T00:48:35.356Z
...
3. Append `{ "id": "skc-a5skn4-2026-06-15", "promotedTo": "<chosen-name>" }` to
