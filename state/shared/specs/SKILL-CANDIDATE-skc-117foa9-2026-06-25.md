---
schemaVersion: 1.0.0
id: skc-117foa9-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-117foa9-2026-06-25`

Observed 16 times across slots [sierra=2, delta=2, bravo=2, papa=1, juliett=1, quebec=1, oscar=1, charlie=1, alpha=1, zulu=1, romeo=1, golf=1]; dominant kind: **build-heavy** (build-heavy=16); median call count: 3.
...
- Last seen: 2026-06-25T02:54:05.017Z
...
3. Append `{ "id": "skc-117foa9-2026-06-25", "promotedTo": "<chosen-name>" }` to
