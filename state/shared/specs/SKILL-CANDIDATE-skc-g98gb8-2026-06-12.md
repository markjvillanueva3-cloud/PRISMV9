---
schemaVersion: 1.0.0
id: skc-g98gb8-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-g98gb8-2026-06-12`

Observed 61 times across slots [alpha=11, bravo=7, delta=4, charlie=4, papa=4, hotel=3, golf=3, india=3, oscar=3, zulu=3, foxtrot=2, juliett=2, xray=2, lima=1, whiskey=1, echo=1, sierra=1, tango=1]; dominant kind: **build-heavy** (build-heavy=61); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: lima, hotel, foxtrot, delta, charlie, alpha, golf, whiskey, bravo, india, juliett, oscar, papa, echo, xray, zulu, sierra, tango)
...
- Last seen: 2026-06-12T19:59:16.626Z
...
3. Append `{ "id": "skc-g98gb8-2026-06-12", "promotedTo": "<chosen-name>" }` to
