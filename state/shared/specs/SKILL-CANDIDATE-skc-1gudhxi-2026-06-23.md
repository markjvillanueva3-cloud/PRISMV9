---
schemaVersion: 1.0.0
id: skc-1gudhxi-2026-06-23
generated: 2026-06-23T08:17:01.355Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1gudhxi-2026-06-23`

Observed 10 times across slots [charlie=2, papa=2, echo=1, golf=1, bravo=1, india=1, romeo=1, xray=1]; dominant kind: **build-heavy** (build-heavy=10); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, echo, golf, papa, bravo, india, romeo, xray)
...
- Last seen: 2026-06-23T06:30:14.772Z
...
3. Append `{ "id": "skc-1gudhxi-2026-06-23", "promotedTo": "<chosen-name>" }` to
