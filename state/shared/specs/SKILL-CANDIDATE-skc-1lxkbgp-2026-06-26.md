---
schemaVersion: 1.0.0
id: skc-1lxkbgp-2026-06-26
generated: 2026-06-26T13:37:35.094Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1lxkbgp-2026-06-26`

Observed 31 times across slots [delta=4, alpha=4, bravo=3, zulu=3, sierra=3, foxtrot=2, tango=2, india=2, golf=2, charlie=2, oscar=2, lima=1, echo=1]; dominant kind: **build-heavy** (build-heavy=31); median call count: 5.
...
- Last seen: 2026-06-26T09:58:49.256Z
...
3. Append `{ "id": "skc-1lxkbgp-2026-06-26", "promotedTo": "<chosen-name>" }` to
