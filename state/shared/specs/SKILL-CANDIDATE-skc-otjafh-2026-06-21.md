---
schemaVersion: 1.0.0
id: skc-otjafh-2026-06-21
generated: 2026-06-22T08:17:01.977Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-otjafh-2026-06-21`

Observed 43 times across slots [alpha=4, sierra=4, india=4, charlie=3, bravo=3, golf=2, delta=2, oscar=2, papa=2, mike=1, hotel=1, foxtrot=1, juliett=1, xray=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=43); median call count: 3.
...
- Last seen: 2026-06-21T22:59:06.648Z
...
3. Append `{ "id": "skc-otjafh-2026-06-21", "promotedTo": "<chosen-name>" }` to
