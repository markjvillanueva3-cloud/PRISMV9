---
schemaVersion: 1.0.0
id: skc-1lxkbgm-2026-06-23
generated: 2026-06-23T08:17:01.355Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1lxkbgm-2026-06-23`

Observed 26 times across slots [alpha=4, bravo=3, zulu=3, delta=2, foxtrot=2, tango=2, india=2, golf=2, charlie=2, sierra=2, lima=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=26); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: delta, lima, bravo, foxtrot, tango, india, alpha, golf, charlie, zulu, sierra, oscar)
...
- Last seen: 2026-06-23T03:21:40.626Z
...
3. Append `{ "id": "skc-1lxkbgm-2026-06-23", "promotedTo": "<chosen-name>" }` to
