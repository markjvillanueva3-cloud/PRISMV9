---
schemaVersion: 1.0.0
id: skc-1deubtt-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1deubtt-2026-06-26`

Observed 29 times across slots [bravo=4, india=4, charlie=4, foxtrot=3, delta=2, quebec=2, oscar=2, sierra=2, hotel=1, alpha=1, golf=1, papa=1, xray=1]; dominant kind: **build-heavy** (build-heavy=29); median call count: 5.

## Tool-call signature

```
Edit|Bash|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, hotel, foxtrot, india, charlie, alpha, delta, golf, papa, xray, quebec, oscar, sierra)
...
- First seen: 2026-05-24T17:53:26.804Z
- Last seen: 2026-06-26T01:42:46.992Z
...
3. Append `{ "id": "skc-1deubtt-2026-06-26", "promotedTo": "<chosen-name>" }` to
