---
schemaVersion: 1.0.0
id: skc-9td8nv-2026-06-24
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-9td8nv-2026-06-24`

Observed 8 times across slots [kilo=2, echo=1, alpha=1, delta=1, xray=1, zulu=1, charlie=1]; dominant kind: **build-heavy** (build-heavy=8); median call count: 3.

## Tool-call signature

```
TaskUpdate|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, alpha, kilo, delta, xray, zulu, charlie)
...
- First seen: 2026-05-23T02:19:19.676Z
- Last seen: 2026-06-24T02:11:00.761Z
...
3. Append `{ "id": "skc-9td8nv-2026-06-24", "promotedTo": "<chosen-name>" }` to
