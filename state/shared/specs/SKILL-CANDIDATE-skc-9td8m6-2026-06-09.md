---
schemaVersion: 1.0.0
id: skc-9td8m6-2026-06-09
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-9td8m6-2026-06-09`

Observed 5 times across slots [kilo=2, echo=1, alpha=1, delta=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, alpha, kilo, delta)
...
- Last seen: 2026-06-09T17:30:56.464Z
...
3. Append `{ "id": "skc-9td8m6-2026-06-09", "promotedTo": "<chosen-name>" }` to
