---
schemaVersion: 1.0.0
id: skc-11l2ww6-2026-06-26
generated: 2026-06-26T08:17:02.038Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-11l2ww6-2026-06-26`

Observed 9 times across slots [sierra=3, bravo=1, zulu=1, alpha=1, quebec=1, india=1, delta=1]; dominant kind: **build-heavy** (build-heavy=9); median call count: 5.

## Tool-call signature

```
Bash|Write|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: sierra, bravo, zulu, alpha, quebec, india, delta)
...
- First seen: 2026-05-25T04:17:43.146Z
- Last seen: 2026-06-26T04:28:08.333Z
...
3. Append `{ "id": "skc-11l2ww6-2026-06-26", "promotedTo": "<chosen-name>" }` to
