---
schemaVersion: 1.0.0
id: skc-oryfz0-2026-06-21
generated: 2026-06-21T08:17:01.515Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-oryfz0-2026-06-21`

Observed 16 times across slots [sierra=3, charlie=2, alpha=2, echo=2, bravo=2, november=1, india=1, oscar=1, romeo=1]; dominant kind: **build-heavy** (build-heavy=16); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, alpha, november, echo, bravo, india, sierra, oscar, romeo)
...
- Last seen: 2026-06-21T06:11:26.890Z
...
3. Append `{ "id": "skc-oryfz0-2026-06-21", "promotedTo": "<chosen-name>" }` to
