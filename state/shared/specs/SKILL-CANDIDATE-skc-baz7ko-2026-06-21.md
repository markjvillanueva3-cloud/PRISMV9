---
schemaVersion: 1.0.0
id: skc-baz7ko-2026-06-21
generated: 2026-06-22T08:17:01.977Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-baz7ko-2026-06-21`

Observed 13 times across slots [alpha=3, bravo=1, juliett=1, sierra=1, india=1, tango=1, delta=1, kilo=1, golf=1, romeo=1]; dominant kind: **build-heavy** (build-heavy=13); median call count: 3.

## Tool-call signature

```
Bash|Bash|TaskUpdate
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: bravo, juliett, sierra, alpha, india, tango, delta, kilo, golf, romeo)
...
- First seen: 2026-05-22T20:32:52.750Z
- Last seen: 2026-06-21T18:17:00.013Z
...
3. Append `{ "id": "skc-baz7ko-2026-06-21", "promotedTo": "<chosen-name>" }` to
