---
schemaVersion: 1.0.0
id: skc-u6m2n8-2026-06-24
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-u6m2n8-2026-06-24`

Observed 18 times across slots [hotel=4, india=3, juliett=1, november=1, charlie=1, delta=1, romeo=1, zulu=1, lima=1, sierra=1, xray=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=18); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, juliett, november, charlie, delta, romeo, zulu, lima, sierra, india, xray, alpha)
...
- Last seen: 2026-06-24T22:33:13.476Z
...
3. Append `{ "id": "skc-u6m2n8-2026-06-24", "promotedTo": "<chosen-name>" }` to
