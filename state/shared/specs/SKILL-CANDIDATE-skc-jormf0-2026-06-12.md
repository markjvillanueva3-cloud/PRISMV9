---
schemaVersion: 1.0.0
id: skc-jormf0-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-jormf0-2026-06-12`

Observed 11 times across slots [sierra=2, papa=2, bravo=2, echo=1, charlie=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=11); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: echo, charlie, oscar, sierra, papa, bravo)
...
- Last seen: 2026-06-12T18:31:59.788Z
...
3. Append `{ "id": "skc-jormf0-2026-06-12", "promotedTo": "<chosen-name>" }` to
