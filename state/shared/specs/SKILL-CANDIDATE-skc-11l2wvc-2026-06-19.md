---
schemaVersion: 1.0.0
id: skc-11l2wvc-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-11l2wvc-2026-06-19`

Observed 5 times across slots [sierra=3, bravo=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: sierra, bravo, zulu)
...
- Last seen: 2026-06-19T17:01:09.213Z
...
3. Append `{ "id": "skc-11l2wvc-2026-06-19", "promotedTo": "<chosen-name>" }` to
