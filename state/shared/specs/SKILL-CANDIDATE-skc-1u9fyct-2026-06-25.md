---
schemaVersion: 1.0.0
id: skc-1u9fyct-2026-06-25
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1u9fyct-2026-06-25`

Observed 20 times across slots [november=17, india=1, xray=1, alpha=1]; dominant kind: **build-heavy** (build-heavy=20); median call count: 5.

## Tool-call signature

```
Edit|Write|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: november, india, xray, alpha)
...
- First seen: 2026-05-26T07:45:21.556Z
- Last seen: 2026-06-25T20:45:51.979Z
...
3. Append `{ "id": "skc-1u9fyct-2026-06-25", "promotedTo": "<chosen-name>" }` to
