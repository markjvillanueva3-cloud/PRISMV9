---
schemaVersion: 1.0.0
id: skc-1aiec6k-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1aiec6k-2026-06-25`

Observed 21 times across slots [echo=3, alpha=3, charlie=2, papa=2, india=2, zulu=2, bravo=2, whiskey=1, sierra=1, golf=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=21); median call count: 3.
...
- Last seen: 2026-06-25T04:04:52.133Z
...
3. Append `{ "id": "skc-1aiec6k-2026-06-25", "promotedTo": "<chosen-name>" }` to
