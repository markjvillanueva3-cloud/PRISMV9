---
schemaVersion: 1.0.0
id: skc-4eyqm9-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-4eyqm9-2026-06-12`

Observed 8 times across slots [alpha=3, whiskey=1, papa=1, delta=1, tango=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=8); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: whiskey, alpha, papa, delta, tango, zulu)
...
- Last seen: 2026-06-12T17:56:00.919Z
...
3. Append `{ "id": "skc-4eyqm9-2026-06-12", "promotedTo": "<chosen-name>" }` to
