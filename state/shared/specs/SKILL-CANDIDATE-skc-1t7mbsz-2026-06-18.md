---
schemaVersion: 1.0.0
id: skc-1t7mbsz-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1t7mbsz-2026-06-18`

Observed 5 times across slots [alpha=5]; dominant kind: **build-heavy** (build-heavy=5); median call count: 8.

## Tool-call signature

```
Edit|Bash|Bash|Bash|Bash|Agent|Agent|Agent
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha)
...
- First seen: 2026-06-18T20:09:08.498Z
- Last seen: 2026-06-18T20:16:16.526Z
...
3. Append `{ "id": "skc-1t7mbsz-2026-06-18", "promotedTo": "<chosen-name>" }` to
