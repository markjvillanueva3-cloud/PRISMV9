---
schemaVersion: 1.0.0
id: skc-8vcfdr-2026-06-17
generated: 2026-06-17T08:17:01.436Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-8vcfdr-2026-06-17`

Observed 171 times across slots [alpha=17, charlie=13, golf=13, romeo=13, hotel=12, foxtrot=12, whiskey=12, echo=11, delta=9, bravo=9, sierra=8, papa=6, juliett=4, india=4, oscar=4, zulu=4, lima=2, november=2, victor=2, kilo=1, mike=1, tango=1]; dominant kind: **build-heavy** (build-heavy=171); median call count: 4.
...
- Last seen: 2026-06-17T02:54:40.473Z
...
3. Append `{ "id": "skc-8vcfdr-2026-06-17", "promotedTo": "<chosen-name>" }` to
