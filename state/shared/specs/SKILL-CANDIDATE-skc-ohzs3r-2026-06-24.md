---
schemaVersion: 1.0.0
id: skc-ohzs3r-2026-06-24
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-ohzs3r-2026-06-24`

Observed 13 times across slots [papa=3, charlie=2, alpha=2, bravo=1, sierra=1, delta=1, zulu=1, quebec=1, india=1]; dominant kind: **build-heavy** (build-heavy=13); median call count: 5.

## Tool-call signature

```
Bash|Edit|Edit|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, bravo, alpha, sierra, papa, delta, zulu, quebec, india)
...
- First seen: 2026-05-24T19:00:07.776Z
- Last seen: 2026-06-24T17:28:16.393Z
...
3. Append `{ "id": "skc-ohzs3r-2026-06-24", "promotedTo": "<chosen-name>" }` to
