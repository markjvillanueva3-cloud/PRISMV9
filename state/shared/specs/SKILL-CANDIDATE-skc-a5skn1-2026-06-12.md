---
schemaVersion: 1.0.0
id: skc-a5skn1-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-a5skn1-2026-06-12`

Observed 5 times across slots [alpha=2, hotel=1, papa=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, alpha, papa, oscar)
...
- Last seen: 2026-06-12T17:04:22.793Z
...
3. Append `{ "id": "skc-a5skn1-2026-06-12", "promotedTo": "<chosen-name>" }` to
