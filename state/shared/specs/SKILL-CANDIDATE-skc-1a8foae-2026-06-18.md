---
schemaVersion: 1.0.0
id: skc-1a8foae-2026-06-18
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1a8foae-2026-06-18`

Observed 10 times across slots [whiskey=3, foxtrot=1, kilo=1, sierra=1, alpha=1, xray=1]; dominant kind: **edit-heavy** (edit-heavy=10); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: foxtrot, whiskey, kilo, sierra, alpha, xray)
...
- Last seen: 2026-06-18T03:52:06.989Z
...
3. Append `{ "id": "skc-1a8foae-2026-06-18", "promotedTo": "<chosen-name>" }` to
