---
schemaVersion: 1.0.0
id: skc-26nnmp-2026-06-26
generated: 2026-06-27T08:17:02.046Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-26nnmp-2026-06-26`

Observed 16 times across slots [alpha=2, india=2, romeo=2, oscar=2, sierra=1, tango=1, zulu=1, bravo=1, xray=1, whiskey=1]; dominant kind: **build-heavy** (build-heavy=16); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: sierra, tango, alpha, india, zulu, romeo, bravo, oscar, xray, whiskey)
...
- Last seen: 2026-06-26T19:35:11.374Z
...
3. Append `{ "id": "skc-26nnmp-2026-06-26", "promotedTo": "<chosen-name>" }` to
