---
schemaVersion: 1.0.0
id: skc-1aiec6h-2026-06-22
generated: 2026-06-22T08:17:01.977Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1aiec6h-2026-06-22`

Observed 19 times across slots [echo=3, charlie=2, alpha=2, papa=2, zulu=2, bravo=2, whiskey=1, india=1, sierra=1, golf=1, quebec=1]; dominant kind: **build-heavy** (build-heavy=19); median call count: 3.
...
- Last seen: 2026-06-22T03:22:35.587Z
...
3. Append `{ "id": "skc-1aiec6h-2026-06-22", "promotedTo": "<chosen-name>" }` to
