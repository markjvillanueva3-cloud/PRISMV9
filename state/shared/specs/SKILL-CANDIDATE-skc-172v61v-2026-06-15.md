---
schemaVersion: 1.0.0
id: skc-172v61v-2026-06-15
generated: 2026-06-15T08:17:01.126Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-172v61v-2026-06-15`

Observed 128 times across slots [delta=14, bravo=13, alpha=12, charlie=9, whiskey=8, kilo=8, echo=7, sierra=7, golf=6, juliett=6, india=5, papa=5, hotel=4, romeo=4, mike=2, zulu=2, lima=1, foxtrot=1, xray=1, tango=1]; dominant kind: **build-heavy** (build-heavy=128); median call count: 3.
...
- Last seen: 2026-06-15T06:45:05.630Z
...
3. Append `{ "id": "skc-172v61v-2026-06-15", "promotedTo": "<chosen-name>" }` to
