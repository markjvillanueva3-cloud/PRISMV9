---
schemaVersion: 1.0.0
id: skc-w0nd3f-2026-06-16
generated: 2026-06-16T17:16:14.428Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-w0nd3f-2026-06-16`

Observed 23 times across slots [charlie=4, hotel=3, delta=2, bravo=2, echo=2, kilo=2, romeo=1, whiskey=1, india=1, papa=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=23); median call count: 4.

## Tool-call signature

```
Bash|Write|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, charlie, delta, bravo, romeo, echo, whiskey, kilo, india, papa, oscar)
...
- First seen: 2026-05-21T05:53:18.413Z
- Last seen: 2026-06-16T00:06:06.122Z
...
3. Append `{ "id": "skc-w0nd3f-2026-06-16", "promotedTo": "<chosen-name>" }` to
