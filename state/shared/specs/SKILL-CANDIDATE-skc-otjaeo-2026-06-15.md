---
schemaVersion: 1.0.0
id: skc-otjaeo-2026-06-15
generated: 2026-06-15T08:17:01.126Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-otjaeo-2026-06-15`

Observed 37 times across slots [alpha=4, charlie=3, bravo=3, sierra=3, delta=2, india=2, oscar=2, mike=1, golf=1, hotel=1, foxtrot=1, juliett=1, papa=1, xray=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=37); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: mike, charlie, alpha, bravo, golf, sierra, hotel, delta, india, foxtrot, oscar, juliett, papa, xray, zulu)
...
- First seen: 2026-05-21T18:28:40.185Z
- Last seen: 2026-06-15T01:28:05.074Z
...
3. Append `{ "id": "skc-otjaeo-2026-06-15", "promotedTo": "<chosen-name>" }` to
