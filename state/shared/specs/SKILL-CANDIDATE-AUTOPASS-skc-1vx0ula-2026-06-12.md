---
schemaVersion: 1.0.0
id: skc-1vx0ula-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1vx0ula-2026-06-12`

Observed 5 times across slots [charlie=2, delta=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: delta, zulu, charlie)
...
- Last seen: 2026-06-12T16:39:54.529Z
...
3. Append `{ "id": "skc-1vx0ula-2026-06-12", "promotedTo": "<chosen-name>" }` to
