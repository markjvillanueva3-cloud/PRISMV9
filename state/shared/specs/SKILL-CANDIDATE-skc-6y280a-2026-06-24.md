---
schemaVersion: 1.0.0
id: skc-6y280a-2026-06-24
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-6y280a-2026-06-24`

Observed 30 times across slots [alpha=5, bravo=4, hotel=3, echo=3, juliett=2, oscar=2, romeo=2, charlie=2, india=2, golf=1, delta=1]; dominant kind: **build-heavy** (build-heavy=30); median call count: 4.
...
- Last seen: 2026-06-24T03:37:49.090Z
...
3. Append `{ "id": "skc-6y280a-2026-06-24", "promotedTo": "<chosen-name>" }` to
