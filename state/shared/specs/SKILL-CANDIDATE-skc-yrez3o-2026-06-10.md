---
schemaVersion: 1.0.0
id: skc-yrez3o-2026-06-10
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-yrez3o-2026-06-10`

Observed 7 times across slots [india=1, papa=1, echo=1, alpha=1, delta=1]; dominant kind: **build-heavy** (build-heavy=7); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: india, papa, echo, alpha, delta)
...
- Last seen: 2026-06-10T20:27:30.185Z
...
3. Append `{ "id": "skc-yrez3o-2026-06-10", "promotedTo": "<chosen-name>" }` to
