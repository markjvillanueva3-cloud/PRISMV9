---
schemaVersion: 1.0.0
id: skc-1gudhwi-2026-06-10
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1gudhwi-2026-06-10`

Observed 6 times across slots [papa=2, charlie=1, echo=1, golf=1, bravo=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, echo, golf, papa, bravo)
...
- Last seen: 2026-06-10T20:15:33.965Z
...
3. Append `{ "id": "skc-1gudhwi-2026-06-10", "promotedTo": "<chosen-name>" }` to
