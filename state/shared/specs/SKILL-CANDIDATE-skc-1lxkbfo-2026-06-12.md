---
schemaVersion: 1.0.0
id: skc-1lxkbfo-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1lxkbfo-2026-06-12`

Observed 19 times across slots [alpha=3, delta=2, bravo=2, foxtrot=2, tango=2, india=2, golf=2, charlie=2, lima=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=19); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: delta, lima, bravo, foxtrot, tango, india, alpha, golf, charlie, zulu)
...
- Last seen: 2026-06-12T14:09:44.316Z
...
3. Append `{ "id": "skc-1lxkbfo-2026-06-12", "promotedTo": "<chosen-name>" }` to
