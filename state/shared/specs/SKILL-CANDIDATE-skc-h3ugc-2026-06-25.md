---
schemaVersion: 1.0.0
id: skc-h3ugc-2026-06-25
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-h3ugc-2026-06-25`

Observed 17 times across slots [india=2, golf=2, papa=2, hotel=1, november=1, foxtrot=1, alpha=1, delta=1, bravo=1, charlie=1, zulu=1, quebec=1, xray=1]; dominant kind: **build-heavy** (build-heavy=17); median call count: 7.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, india, november, golf, foxtrot, alpha, delta, bravo, charlie, papa, zulu, quebec, xray)
...
- Last seen: 2026-06-25T01:13:32.520Z
...
3. Append `{ "id": "skc-h3ugc-2026-06-25", "promotedTo": "<chosen-name>" }` to
