---
schemaVersion: 1.0.0
id: skc-1lnlnkj-2026-06-19
generated: 2026-06-19T23:08:37.181Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1lnlnkj-2026-06-19`

Observed 10 times across slots [golf=2, foxtrot=1, hotel=1, sierra=1, charlie=1, tango=1, zulu=1, romeo=1, xray=1]; dominant kind: **edit-heavy** (edit-heavy=10); median call count: 5.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: foxtrot, hotel, sierra, charlie, tango, golf, zulu, romeo, xray)
...
- Last seen: 2026-06-19T20:00:45.394Z
...
3. Append `{ "id": "skc-1lnlnkj-2026-06-19", "promotedTo": "<chosen-name>" }` to
