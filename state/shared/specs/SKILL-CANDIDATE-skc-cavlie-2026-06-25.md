---
schemaVersion: 1.0.0
id: skc-cavlie-2026-06-25
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-cavlie-2026-06-25`

Observed 12 times across slots [alpha=3, romeo=3, hotel=2, charlie=1, sierra=1, bravo=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=12); median call count: 4.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: hotel, alpha, charlie, romeo, sierra, bravo, oscar)
...
- First seen: 2026-05-21T16:52:45.188Z
- Last seen: 2026-06-25T23:58:38.348Z
...
3. Append `{ "id": "skc-cavlie-2026-06-25", "promotedTo": "<chosen-name>" }` to
