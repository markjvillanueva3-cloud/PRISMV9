---
schemaVersion: 1.0.0
id: skc-75dm9p-2026-06-23
generated: 2026-06-24T08:17:01.691Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-75dm9p-2026-06-23`

Observed 6 times across slots [charlie=2, juliett=1, golf=1, romeo=1, zulu=1]; dominant kind: **build-heavy** (build-heavy=6); median call count: 6.

## Tool-call signature

```
Write|Bash|Bash|Bash|Bash|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, juliett, golf, romeo, zulu)
...
- First seen: 2026-05-25T20:09:59.462Z
- Last seen: 2026-06-23T16:29:41.111Z
...
3. Append `{ "id": "skc-75dm9p-2026-06-23", "promotedTo": "<chosen-name>" }` to
