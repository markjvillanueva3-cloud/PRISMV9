---
schemaVersion: 1.0.0
id: skc-yrez4p-2026-06-24
generated: 2026-06-25T08:17:01.780Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-yrez4p-2026-06-24`

Observed 8 times across slots [india=1, papa=1, echo=1, alpha=1, delta=1, oscar=1]; dominant kind: **build-heavy** (build-heavy=8); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: india, papa, echo, alpha, delta, oscar)
...
- Last seen: 2026-06-24T14:37:02.859Z
...
3. Append `{ "id": "skc-yrez4p-2026-06-24", "promotedTo": "<chosen-name>" }` to
