---
schemaVersion: 1.0.0
id: skc-1gudhxl-2026-06-26
generated: 2026-06-26T03:13:26.608Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1gudhxl-2026-06-26`

Observed 14 times across slots [sierra=4, charlie=2, papa=2, echo=1, golf=1, bravo=1, india=1, romeo=1, xray=1]; dominant kind: **build-heavy** (build-heavy=14); median call count: 5.

## Tool-call signature

```
Edit|Bash|Bash|Edit|Bash
```

## Proposed trigger keywords

(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: charlie, echo, golf, papa, bravo, india, romeo, xray, sierra)
...
- First seen: 2026-05-29T16:00:37.340Z
- Last seen: 2026-06-26T01:22:59.826Z
...
3. Append `{ "id": "skc-1gudhxl-2026-06-26", "promotedTo": "<chosen-name>" }` to
