---
schemaVersion: 1.0.0
id: skc-yrez4r-2026-06-26
generated: 2026-06-27T08:17:02.046Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-yrez4r-2026-06-26`

Observed 11 times across slots [india=1, papa=1, echo=1, alpha=1, delta=1, oscar=1, zulu=1, sierra=1, whiskey=1]; dominant kind: **build-heavy** (build-heavy=11); median call count: 6.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: india, papa, echo, alpha, delta, oscar, zulu, sierra, whiskey)
...
- Last seen: 2026-06-26T17:01:44.573Z
...
3. Append `{ "id": "skc-yrez4r-2026-06-26", "promotedTo": "<chosen-name>" }` to
