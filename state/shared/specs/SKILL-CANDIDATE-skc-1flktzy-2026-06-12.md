---
schemaVersion: 1.0.0
id: skc-1flktzy-2026-06-12
generated: 2026-06-14T08:17:00.692Z
status: candidate
source: HERMES-MS1 / U-HERMES05
---

# SKILL CANDIDATE — `skc-1flktzy-2026-06-12`

Observed 5 times across slots [zulu=2, alpha=1, oscar=1, charlie=1]; dominant kind: **build-heavy** (build-heavy=5); median call count: 3.
...
(operator/reviewer fills in — derive from dominant-kind tools + typical slot domains: alpha, oscar, zulu, charlie)
...
- Last seen: 2026-06-12T01:30:03.083Z
...
3. Append `{ "id": "skc-1flktzy-2026-06-12", "promotedTo": "<chosen-name>" }` to
