# AUTOGEN SPEC — PDF/AUTOMATION Center/AUTOMATION_Center_Manual-en.pdf

Generated 2026-05-24T08:00:44.091Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `PDF/AUTOMATION Center/AUTOMATION_Center_Manual-en.pdf` |
| Slug | `pdf-resources-pdf_automation_center_automation_center_manual_en_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\PDF\AUTOMATION Center\AUTOMATION_Center_Manual-en.pdf` |
