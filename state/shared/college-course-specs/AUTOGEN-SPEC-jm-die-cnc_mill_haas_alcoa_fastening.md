# AUTOGEN SPEC — JM DIE/CNC MILL HAAS/ALCOA FASTENING

Generated 2026-05-24T08:06:38.489Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC MILL HAAS/ALCOA FASTENING` |
| Slug | `jm-die-cnc_mill_haas_alcoa_fastening` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC MILL HAAS\ALCOA FASTENING` |
