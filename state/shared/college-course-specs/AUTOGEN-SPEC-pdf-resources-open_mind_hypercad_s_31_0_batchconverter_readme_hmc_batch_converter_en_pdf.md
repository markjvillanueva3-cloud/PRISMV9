# AUTOGEN SPEC — OPEN MIND/hyperCAD-S/31.0/BatchConverter/Readme_HMC_Batch_Converter-en.pdf

Generated 2026-05-24T07:54:22.929Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `OPEN MIND/hyperCAD-S/31.0/BatchConverter/Readme_HMC_Batch_Converter-en.pdf` |
| Slug | `pdf-resources-open_mind_hypercad_s_31_0_batchconverter_readme_hmc_batch_converter_en_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\OPEN MIND\hyperCAD-S\31.0\BatchConverter\Readme_HMC_Batch_Converter-en.pdf` |
