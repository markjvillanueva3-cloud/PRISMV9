# AUTOGEN SPEC — JM DIE/QUEUE

Generated 2026-05-24T08:02:37.166Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/QUEUE` |
| Slug | `jm-die-queue` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\QUEUE` |
