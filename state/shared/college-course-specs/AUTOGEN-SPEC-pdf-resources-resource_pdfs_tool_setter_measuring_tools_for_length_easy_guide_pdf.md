# AUTOGEN SPEC — RESOURCE PDFS/Tool Setter_ Measuring Tools for Length [Easy Guide].pdf

Generated 2026-05-24T08:03:32.725Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Tool Setter_ Measuring Tools for Length [Easy Guide].pdf` |
| Slug | `pdf-resources-resource_pdfs_tool_setter_measuring_tools_for_length_easy_guide_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Tool Setter_ Measuring Tools for Length [Easy Guide].pdf` |
