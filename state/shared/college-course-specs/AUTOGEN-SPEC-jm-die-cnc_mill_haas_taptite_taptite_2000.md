# AUTOGEN SPEC — JM DIE/CNC MILL HAAS/TAPTITE/Taptite 2000

Generated 2026-05-24T08:07:20.727Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC MILL HAAS/TAPTITE/Taptite 2000` |
| Slug | `jm-die-cnc_mill_haas_taptite_taptite_2000` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC MILL HAAS\TAPTITE\Taptite 2000` |
