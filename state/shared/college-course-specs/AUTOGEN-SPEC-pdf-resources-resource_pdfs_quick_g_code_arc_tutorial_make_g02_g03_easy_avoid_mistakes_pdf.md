# AUTOGEN SPEC — RESOURCE PDFS/Quick G-Code Arc Tutorial_ Make G02 & G03 Easy, Avoid Mistakes.pdf

Generated 2026-05-24T08:03:30.363Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Quick G-Code Arc Tutorial_ Make G02 & G03 Easy, Avoid Mistakes.pdf` |
| Slug | `pdf-resources-resource_pdfs_quick_g_code_arc_tutorial_make_g02_g03_easy_avoid_mistakes_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Quick G-Code Arc Tutorial_ Make G02 & G03 Easy, Avoid Mistakes.pdf` |
