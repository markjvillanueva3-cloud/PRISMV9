# AUTOGEN SPEC — JM DIE/CNC LATHE/HOLO-KROME

Generated 2026-05-24T08:05:14.955Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/HOLO-KROME` |
| Slug | `jm-die-cnc_lathe_holo_krome` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\HOLO-KROME` |
