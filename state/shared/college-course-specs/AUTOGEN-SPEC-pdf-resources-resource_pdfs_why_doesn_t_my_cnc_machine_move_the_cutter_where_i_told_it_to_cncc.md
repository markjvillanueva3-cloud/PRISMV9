# AUTOGEN SPEC — RESOURCE PDFS/Why Doesn't My CNC Machine Move the Cutter Where I Told It To_!__ - CNCCookbook_ Be A Better CNC'er.pdf

Generated 2026-05-24T08:03:34.832Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Why Doesn't My CNC Machine Move the Cutter Where I Told It To_!__ - CNCCookbook_ Be A Better CNC'er.pdf` |
| Slug | `pdf-resources-resource_pdfs_why_doesn_t_my_cnc_machine_move_the_cutter_where_i_told_it_to_cncc` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
