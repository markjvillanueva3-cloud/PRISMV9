# AUTOGEN SPEC — JM DIE/CNC LATHE/GRANDEUR FASTENER UPDATE 10.22.2022/PRISM_UPGRADED

Generated 2026-05-24T08:05:04.067Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/GRANDEUR FASTENER UPDATE 10.22.2022/PRISM_UPGRADED` |
| Slug | `jm-die-cnc_lathe_grandeur_fastener_update_10_22_2022_prism_upgraded` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\GRANDEUR FASTENER UPDATE 10.22.2022\PRISM_UPGRADED` |
