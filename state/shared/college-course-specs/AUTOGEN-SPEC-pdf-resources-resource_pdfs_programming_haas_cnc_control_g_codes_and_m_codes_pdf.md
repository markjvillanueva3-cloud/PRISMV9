# AUTOGEN SPEC — RESOURCE PDFS/Programming Haas CNC Control G-Codes and M-Codes.pdf

Generated 2026-05-24T08:03:29.613Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Programming Haas CNC Control G-Codes and M-Codes.pdf` |
| Slug | `pdf-resources-resource_pdfs_programming_haas_cnc_control_g_codes_and_m_codes_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Programming Haas CNC Control G-Codes and M-Codes.pdf` |
