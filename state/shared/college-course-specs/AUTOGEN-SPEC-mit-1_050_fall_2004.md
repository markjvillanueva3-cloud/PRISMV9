...
| Field | Value |
|---|---|
| Course id | `1.050-fall-2004` |
| Slug | `mit-1_050_fall_2004` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\UPLOADED\1.050-fall-2004.zip` |
