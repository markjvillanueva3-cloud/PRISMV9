# AUTOGEN SPEC — RESOURCE PDFS/G15 and G16 G-Codes [Polar Coordinates and CNC Bolt Circles].pdf

Generated 2026-05-24T08:03:07.327Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/G15 and G16 G-Codes [Polar Coordinates and CNC Bolt Circles].pdf` |
| Slug | `pdf-resources-resource_pdfs_g15_and_g16_g_codes_polar_coordinates_and_cnc_bolt_circles_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\G15 and G16 G-Codes [Polar Coordinates and CNC Bolt Circles].pdf` |
