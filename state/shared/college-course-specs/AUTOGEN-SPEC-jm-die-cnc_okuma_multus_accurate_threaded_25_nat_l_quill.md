# AUTOGEN SPEC — JM DIE/CNC OKUMA MULTUS/ACCURATE THREADED/.25 NAT'L QUILL

Generated 2026-05-24T08:07:28.525Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC OKUMA MULTUS/ACCURATE THREADED/.25 NAT'L QUILL` |
| Slug | `jm-die-cnc_okuma_multus_accurate_threaded_25_nat_l_quill` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC OKUMA MULTUS\ACCURATE THREADED\.25 NAT'L QUILL` |
