# AUTOGEN SPEC — RESOURCE PDFS/Using IF and GOTO For a Poor Man's G71 Lathe Roughing Cycle - CNCCookbook_ Be A Better CNC'er.pdf

Generated 2026-05-24T08:03:33.954Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Using IF and GOTO For a Poor Man's G71 Lathe Roughing Cycle - CNCCookbook_ Be A Better CNC'er.pdf` |
| Slug | `pdf-resources-resource_pdfs_using_if_and_goto_for_a_poor_man_s_g71_lathe_roughing_cycle_cnccoo` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
