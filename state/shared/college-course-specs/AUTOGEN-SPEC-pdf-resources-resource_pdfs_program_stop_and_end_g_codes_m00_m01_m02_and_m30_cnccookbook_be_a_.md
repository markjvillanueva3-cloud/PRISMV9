# AUTOGEN SPEC — RESOURCE PDFS/Program Stop and End G-Codes [M00, M01, M02, and M30] - CNCCookbook_ Be A Better CNC'er.pdf

Generated 2026-05-24T08:03:29.519Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Program Stop and End G-Codes [M00, M01, M02, and M30] - CNCCookbook_ Be A Better CNC'er.pdf` |
| Slug | `pdf-resources-resource_pdfs_program_stop_and_end_g_codes_m00_m01_m02_and_m30_cnccookbook_be_a_` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
