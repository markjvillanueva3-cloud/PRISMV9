# AUTOGEN SPEC — JM DIE/CNC MILL HAAS/SFS GROUP USA/Guided back stops

Generated 2026-05-24T08:07:16.142Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC MILL HAAS/SFS GROUP USA/Guided back stops` |
| Slug | `jm-die-cnc_mill_haas_sfs_group_usa_guided_back_stops` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC MILL HAAS\SFS GROUP USA\Guided back stops` |
