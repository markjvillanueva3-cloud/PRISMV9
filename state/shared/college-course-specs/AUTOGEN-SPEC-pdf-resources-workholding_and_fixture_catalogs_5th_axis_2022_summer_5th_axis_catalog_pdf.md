# AUTOGEN SPEC — WORKHOLDING AND FIXTURE CATALOGS/5th AXIS/2022-Summer-5th-Axis-Catalog.pdf

Generated 2026-05-24T08:03:36.858Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `WORKHOLDING AND FIXTURE CATALOGS/5th AXIS/2022-Summer-5th-Axis-Catalog.pdf` |
| Slug | `pdf-resources-workholding_and_fixture_catalogs_5th_axis_2022_summer_5th_axis_catalog_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\WORKHOLDING AND FIXTURE CATALOGS\5th AXIS\2022-Summer-5th-Axis-Catalog.pdf` |
