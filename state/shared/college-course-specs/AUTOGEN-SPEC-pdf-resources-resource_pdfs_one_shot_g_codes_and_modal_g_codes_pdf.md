# AUTOGEN SPEC — RESOURCE PDFS/One Shot G-Codes and Modal G-Codes.pdf

Generated 2026-05-24T08:03:27.977Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/One Shot G-Codes and Modal G-Codes.pdf` |
| Slug | `pdf-resources-resource_pdfs_one_shot_g_codes_and_modal_g_codes_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\One Shot G-Codes and Modal G-Codes.pdf` |
