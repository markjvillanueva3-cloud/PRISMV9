# AUTOGEN SPEC — RESOURCE PDFS/function-catalog.pdf

Generated 2026-05-24T08:03:04.987Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/function-catalog.pdf` |
| Slug | `pdf-resources-resource_pdfs_function_catalog_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\function-catalog.pdf` |
