# AUTOGEN SPEC — POSTS AND MACHINES/5-Axis-Post-Package_Cope_2015/5-Axis Post Package_Cope 2015/Hurco 5-Axis Post Notes_Cope 2014.pdf

Generated 2026-05-24T07:56:43.834Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `POSTS AND MACHINES/5-Axis-Post-Package_Cope_2015/5-Axis Post Package_Cope 2015/Hurco 5-Axis Post Notes_Cope 2014.pdf` |
| Slug | `pdf-resources-posts_and_machines_5_axis_post_package_cope_2015_5_axis_post_package_cope_2015_h` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
