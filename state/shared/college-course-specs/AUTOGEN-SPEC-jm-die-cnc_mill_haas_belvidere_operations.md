# AUTOGEN SPEC — JM DIE/CNC MILL HAAS/BELVIDERE OPERATIONS

Generated 2026-05-24T08:06:44.476Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC MILL HAAS/BELVIDERE OPERATIONS` |
| Slug | `jm-die-cnc_mill_haas_belvidere_operations` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC MILL HAAS\BELVIDERE OPERATIONS` |
