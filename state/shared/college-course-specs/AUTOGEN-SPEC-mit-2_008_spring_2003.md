# AUTOGEN SPEC — 2.008-spring-2003
...
| Field | Value |
|---|---|
| Course id | `2.008-spring-2003` |
| Slug | `mit-2_008_spring_2003` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\MIT COURSES 2\UPLOADED\2.008-spring-2003.zip` |
