# AUTOGEN SPEC — RESOURCE PDFS/CS50 Pset 1-7 Standard.pdf

Generated 2026-05-24T08:02:57.588Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/CS50 Pset 1-7 Standard.pdf` |
| Slug | `pdf-resources-resource_pdfs_cs50_pset_1_7_standard_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\CS50 Pset 1-7 Standard.pdf` |
