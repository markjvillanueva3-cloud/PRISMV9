# AUTOGEN SPEC — esd.342-spring-2006

Generated 2026-05-24T07:59:08.626Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `esd.342-spring-2006` |
| Slug | `mit-esd_342_spring_2006` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\esd.342-spring-2006.zip` |
