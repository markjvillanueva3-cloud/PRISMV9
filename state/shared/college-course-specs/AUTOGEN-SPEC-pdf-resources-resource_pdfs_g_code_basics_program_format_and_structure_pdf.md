# AUTOGEN SPEC — RESOURCE PDFS/G-Code Basics_ Program Format and Structure.pdf

Generated 2026-05-24T08:03:06.662Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/G-Code Basics_ Program Format and Structure.pdf` |
| Slug | `pdf-resources-resource_pdfs_g_code_basics_program_format_and_structure_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\G-Code Basics_ Program Format and Structure.pdf` |
