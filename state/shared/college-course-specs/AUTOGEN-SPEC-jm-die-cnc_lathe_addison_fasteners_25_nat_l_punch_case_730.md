# AUTOGEN SPEC — JM DIE/CNC LATHE/ADDISON FASTENERS/.25 NAT'L PUNCH CASE 730

Generated 2026-05-24T08:03:54.203Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/ADDISON FASTENERS/.25 NAT'L PUNCH CASE 730` |
| Slug | `jm-die-cnc_lathe_addison_fasteners_25_nat_l_punch_case_730` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\ADDISON FASTENERS\.25 NAT'L PUNCH CASE 730` |
