...
| Field | Value |
|---|---|
| Course id | `15.872-fall-2013` |
| Slug | `mit-15_872_fall_2013` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\UPLOADED\15.872-fall-2013.zip` |
