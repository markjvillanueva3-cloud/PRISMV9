# AUTOGEN SPEC — RESOURCE PDFS/Helical Interpolation for Thread Milling, Holes, and Spiral Ramps.pdf

Generated 2026-05-24T08:03:09.440Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Helical Interpolation for Thread Milling, Holes, and Spiral Ramps.pdf` |
| Slug | `pdf-resources-resource_pdfs_helical_interpolation_for_thread_milling_holes_and_spiral_ramps_pd` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Helical Interpolation for Thread Milling, Holes, and Spiral Ramps.pdf` |
