# AUTOGEN SPEC — JM DIE/JM DIE COMPANY

Generated 2026-05-24T08:02:30.706Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/JM DIE COMPANY` |
| Slug | `jm-die-jm_die_company` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\JM DIE COMPANY` |
