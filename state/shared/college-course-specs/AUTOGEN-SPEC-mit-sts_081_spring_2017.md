# AUTOGEN SPEC — sts.081-spring-2017
...
| Field | Value |
|---|---|
| Course id | `sts.081-spring-2017` |
| Slug | `mit-sts_081_spring_2017` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\sts.081-spring-2017.zip` |
