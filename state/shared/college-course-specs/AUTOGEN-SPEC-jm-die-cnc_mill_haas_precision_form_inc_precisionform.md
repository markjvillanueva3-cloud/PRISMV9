# AUTOGEN SPEC — JM DIE/CNC MILL HAAS/PRECISION FORM INC/PRECISIONFORM

Generated 2026-05-24T08:07:11.156Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC MILL HAAS/PRECISION FORM INC/PRECISIONFORM` |
| Slug | `jm-die-cnc_mill_haas_precision_form_inc_precisionform` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC MILL HAAS\PRECISION FORM INC\PRECISIONFORM` |
