# AUTOGEN SPEC — JM DIE/CNC LATHE/OMG

Generated 2026-05-24T08:05:50.118Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/OMG` |
| Slug | `jm-die-cnc_lathe_omg` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
