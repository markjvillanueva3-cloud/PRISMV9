# AUTOGEN SPEC — JM DIE/CNC LATHE/Form/FORMNET

Generated 2026-05-24T08:04:59.213Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/Form/FORMNET` |
| Slug | `jm-die-cnc_lathe_form_formnet` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\Form\FORMNET` |
