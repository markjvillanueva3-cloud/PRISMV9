# AUTOGEN SPEC — JM DIE/CNC LATHE/ELECTRODE/SIMPSON ELECT

Generated 2026-05-24T08:04:44.162Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/ELECTRODE/SIMPSON ELECT` |
| Slug | `jm-die-cnc_lathe_electrode_simpson_elect` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\ELECTRODE\SIMPSON ELECT` |
