# AUTOGEN SPEC — JM DIE/CNC LATHE/HOLBROOK/PRISM_UPGRADED

Generated 2026-05-24T08:05:13.506Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/HOLBROOK/PRISM_UPGRADED` |
| Slug | `jm-die-cnc_lathe_holbrook_prism_upgraded` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\HOLBROOK\PRISM_UPGRADED` |
