# AUTOGEN SPEC — RESOURCE PDFS/Fundamentals3DDesign-SIM-ENG-SV.pdf

Generated 2026-05-24T08:03:06.022Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Fundamentals3DDesign-SIM-ENG-SV.pdf` |
| Slug | `pdf-resources-resource_pdfs_fundamentals3ddesign_sim_eng_sv_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Fundamentals3DDesign-SIM-ENG-SV.pdf` |
