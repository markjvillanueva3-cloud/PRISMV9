# AUTOGEN SPEC — PRISM CAD-CAM TRAINING/BASIC SINGLE HOLE CASING/BSHC 2C.pdf

Generated 2026-05-24T08:00:54.519Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `PRISM CAD-CAM TRAINING/BASIC SINGLE HOLE CASING/BSHC 2C.pdf` |
| Slug | `pdf-resources-prism_cad_cam_training_basic_single_hole_casing_bshc_2c_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\PRISM CAD-CAM TRAINING\BASIC SINGLE HOLE CASING\BSHC 2C.pdf` |
