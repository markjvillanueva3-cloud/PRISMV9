# AUTOGEN SPEC — JM DIE/PRISM MODIFIED POST PROCESSORS
...
| Field | Value |
|---|---|
| Course id | `JM DIE/PRISM MODIFIED POST PROCESSORS` |
| Slug | `jm-die-prism_modified_post_processors` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\PRISM MODIFIED POST PROCESSORS` |
