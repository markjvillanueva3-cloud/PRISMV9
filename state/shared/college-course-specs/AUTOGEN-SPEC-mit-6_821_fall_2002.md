...
| Field | Value |
|---|---|
| Course id | `6.821-fall-2002` |
| Slug | `mit-6_821_fall_2002` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\UPLOADED\6.821-fall-2002.zip` |
