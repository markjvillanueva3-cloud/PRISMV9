# AUTOGEN SPEC — RESOURCE PDFS/Using Your Mill CAM For the Lathe and Turning G-Code [ Sneaky Trick ] - CNCCookbook_ Be A Better CNC'er.pdf

Generated 2026-05-24T08:03:34.497Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Using Your Mill CAM For the Lathe and Turning G-Code [ Sneaky Trick ] - CNCCookbook_ Be A Better CNC'er.pdf` |
| Slug | `pdf-resources-resource_pdfs_using_your_mill_cam_for_the_lathe_and_turning_g_code_sneaky_trick_` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
