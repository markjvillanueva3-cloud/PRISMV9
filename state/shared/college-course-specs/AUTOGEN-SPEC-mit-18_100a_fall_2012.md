# AUTOGEN SPEC — 18.100a-fall-2012

Generated 2026-05-24T07:59:24.200Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `18.100a-fall-2012` |
| Slug | `mit-18_100a_fall_2012` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\MIT COURSES 3\UPLOADED\18.100a-fall-2012.zip` |
