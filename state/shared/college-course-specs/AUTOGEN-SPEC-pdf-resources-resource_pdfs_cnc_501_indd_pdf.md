# AUTOGEN SPEC — RESOURCE PDFS/CNC 501 .indd.pdf

Generated 2026-05-24T08:02:53.068Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/CNC 501 .indd.pdf` |
| Slug | `pdf-resources-resource_pdfs_cnc_501_indd_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\CNC 501 .indd.pdf` |
