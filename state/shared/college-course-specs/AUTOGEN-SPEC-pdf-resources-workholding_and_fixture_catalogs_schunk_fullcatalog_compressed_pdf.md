# AUTOGEN SPEC — WORKHOLDING AND FIXTURE CATALOGS/SCHUNK/FULLCATALOG-compressed.pdf

Generated 2026-05-24T08:03:44.262Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `WORKHOLDING AND FIXTURE CATALOGS/SCHUNK/FULLCATALOG-compressed.pdf` |
| Slug | `pdf-resources-workholding_and_fixture_catalogs_schunk_fullcatalog_compressed_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\WORKHOLDING AND FIXTURE CATALOGS\SCHUNK\FULLCATALOG-compressed.pdf` |
