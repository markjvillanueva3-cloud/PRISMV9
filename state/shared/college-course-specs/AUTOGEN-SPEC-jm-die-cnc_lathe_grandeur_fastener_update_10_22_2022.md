# AUTOGEN SPEC — JM DIE/CNC LATHE/GRANDEUR FASTENER UPDATE 10.22.2022

Generated 2026-05-24T08:05:03.634Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/GRANDEUR FASTENER UPDATE 10.22.2022` |
| Slug | `jm-die-cnc_lathe_grandeur_fastener_update_10_22_2022` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\GRANDEUR FASTENER UPDATE 10.22.2022` |
