# AUTOGEN SPEC — PDF/Synchronization Tool Database/Synchronization_Tool_Database_Manual-en.pdf
...
| Field | Value |
|---|---|
| Course id | `PDF/Synchronization Tool Database/Synchronization_Tool_Database_Manual-en.pdf` |
| Slug | `pdf-resources-pdf_synchronization_tool_database_synchronization_tool_database_manual_en_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\PDF\Synchronization Tool Database\Synchronization_Tool_Database_Manual-en.pdf` |
