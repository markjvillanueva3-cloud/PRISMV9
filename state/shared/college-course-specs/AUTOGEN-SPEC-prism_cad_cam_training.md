# AUTOGEN SPEC — PRISM CAD-CAM TRAINING

Generated 2026-05-24T08:00:14.658Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `PRISM CAD-CAM TRAINING` |
| Slug | `prism_cad_cam_training` |
| Kind | `prism-training` |
| Domain | `cad-cam` |
| Source path | `H:\PRISM\resources\PRISM CAD-CAM TRAINING` |
