# AUTOGEN SPEC — RESOURCE PDFS/Face Mill Speeds and Feeds [Calculator, 45 or 90 Degrees_].pdf

Generated 2026-05-24T08:03:04.678Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Face Mill Speeds and Feeds [Calculator, 45 or 90 Degrees_].pdf` |
| Slug | `pdf-resources-resource_pdfs_face_mill_speeds_and_feeds_calculator_45_or_90_degrees_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Face Mill Speeds and Feeds [Calculator, 45 or 90 Degrees_].pdf` |
