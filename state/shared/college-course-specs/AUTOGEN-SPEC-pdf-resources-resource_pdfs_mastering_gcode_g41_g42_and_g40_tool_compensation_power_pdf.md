# AUTOGEN SPEC — RESOURCE PDFS/Mastering GCode G41, G42, and G40_ Tool Compensation Power.pdf

Generated 2026-05-24T08:03:24.662Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Mastering GCode G41, G42, and G40_ Tool Compensation Power.pdf` |
| Slug | `pdf-resources-resource_pdfs_mastering_gcode_g41_g42_and_g40_tool_compensation_power_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Mastering GCode G41, G42, and G40_ Tool Compensation Power.pdf` |
