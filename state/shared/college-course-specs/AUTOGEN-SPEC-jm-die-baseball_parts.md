# AUTOGEN SPEC — JM DIE/BASEBALL PARTS

Generated 2026-05-24T08:03:47.175Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/BASEBALL PARTS` |
| Slug | `jm-die-baseball_parts` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\BASEBALL PARTS` |
