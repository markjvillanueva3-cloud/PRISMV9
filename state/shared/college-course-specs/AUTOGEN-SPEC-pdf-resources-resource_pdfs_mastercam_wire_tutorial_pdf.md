# AUTOGEN SPEC — RESOURCE PDFS/Mastercam-Wire-Tutorial.pdf

Generated 2026-05-24T08:03:24.295Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Mastercam-Wire-Tutorial.pdf` |
| Slug | `pdf-resources-resource_pdfs_mastercam_wire_tutorial_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Mastercam-Wire-Tutorial.pdf` |
