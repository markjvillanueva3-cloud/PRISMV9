# AUTOGEN SPEC — RESOURCE PDFS/WinMax-Mill-Intro-Class-Workbook.pdf

Generated 2026-05-24T08:03:35.175Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/WinMax-Mill-Intro-Class-Workbook.pdf` |
| Slug | `pdf-resources-resource_pdfs_winmax_mill_intro_class_workbook_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\WinMax-Mill-Intro-Class-Workbook.pdf` |
