# AUTOGEN SPEC — POSTS AND MACHINES/5-Axis-Post-Package_Cope_2015/5-Axis Post Package_Cope 2015/Tool Vector Drill cycle and New G08 2 ASR Command.pdf

Generated 2026-05-24T07:56:45.544Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `POSTS AND MACHINES/5-Axis-Post-Package_Cope_2015/5-Axis Post Package_Cope 2015/Tool Vector Drill cycle and New G08 2 ASR Command.pdf` |
| Slug | `pdf-resources-posts_and_machines_5_axis_post_package_cope_2015_5_axis_post_package_cope_2015_t` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
