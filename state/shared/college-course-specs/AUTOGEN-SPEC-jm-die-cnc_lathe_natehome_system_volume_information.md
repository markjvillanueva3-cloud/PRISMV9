# AUTOGEN SPEC — JM DIE/CNC LATHE/NATEHOME/System Volume Information

Generated 2026-05-24T08:05:42.167Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/NATEHOME/System Volume Information` |
| Slug | `jm-die-cnc_lathe_natehome_system_volume_information` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\NATEHOME\System Volume Information` |
