# AUTOGEN SPEC — JM DIE/CNC LATHE/CSM/.1875 HI-PRO PUNCH CASE WITH PIN HOLE .563ID

Generated 2026-05-24T08:04:26.251Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/CSM/.1875 HI-PRO PUNCH CASE WITH PIN HOLE .563ID` |
| Slug | `jm-die-cnc_lathe_csm_1875_hi_pro_punch_case_with_pin_hole_563id` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\CSM\.1875 HI-PRO PUNCH CASE WITH PIN HOLE .563ID` |
