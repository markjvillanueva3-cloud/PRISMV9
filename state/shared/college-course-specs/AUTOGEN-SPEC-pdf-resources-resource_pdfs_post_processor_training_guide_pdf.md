# AUTOGEN SPEC — RESOURCE PDFS/Post Processor Training Guide.pdf

Generated 2026-05-24T08:03:28.954Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Post Processor Training Guide.pdf` |
| Slug | `pdf-resources-resource_pdfs_post_processor_training_guide_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Post Processor Training Guide.pdf` |
