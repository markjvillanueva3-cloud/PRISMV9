# AUTOGEN SPEC — PDF/CAM-Training-Downloaded/Fusion360-CAM-Programming-Guide.pdf

Generated 2026-05-24T08:00:45.745Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `PDF/CAM-Training-Downloaded/Fusion360-CAM-Programming-Guide.pdf` |
| Slug | `pdf-resources-pdf_cam_training_downloaded_fusion360_cam_programming_guide_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\PDF\CAM-Training-Downloaded\Fusion360-CAM-Programming-Guide.pdf` |
