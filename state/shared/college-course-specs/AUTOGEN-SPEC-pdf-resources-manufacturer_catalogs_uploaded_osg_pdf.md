# AUTOGEN SPEC — MANUFACTURER_CATALOGS/uploaded/OSG.pdf
...
| Field | Value |
|---|---|
| Course id | `MANUFACTURER_CATALOGS/uploaded/OSG.pdf` |
| Slug | `pdf-resources-manufacturer_catalogs_uploaded_osg_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\MANUFACTURER_CATALOGS\uploaded\OSG.pdf` |
