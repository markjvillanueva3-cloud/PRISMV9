# AUTOGEN SPEC — JM DIE/REVERSE ENGINEERING

Generated 2026-05-24T08:02:37.250Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/REVERSE ENGINEERING` |
| Slug | `jm-die-reverse_engineering` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\REVERSE ENGINEERING` |
