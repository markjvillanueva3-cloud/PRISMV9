# AUTOGEN SPEC — JM DIE/CNC OKUMA MULTUS/AIR-INDUSTRIES

Generated 2026-05-24T08:07:29.020Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC OKUMA MULTUS/AIR-INDUSTRIES` |
| Slug | `jm-die-cnc_okuma_multus_air_industries` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC OKUMA MULTUS\AIR-INDUSTRIES` |
