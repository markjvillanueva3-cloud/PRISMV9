# AUTOGEN SPEC — JM DIE/CNC MILL HAAS

Generated 2026-05-24T08:06:35.886Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC MILL HAAS` |
| Slug | `jm-die-cnc_mill_haas` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC MILL HAAS` |
