# AUTOGEN SPEC — RESOURCE PDFS/Deep Hole Drilling_ Easy Guide [Tips, CNC Programming, & Video].pdf

Generated 2026-05-24T08:02:58.939Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Deep Hole Drilling_ Easy Guide [Tips, CNC Programming, & Video].pdf` |
| Slug | `pdf-resources-resource_pdfs_deep_hole_drilling_easy_guide_tips_cnc_programming_video_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Deep Hole Drilling_ Easy Guide [Tips, CNC Programming, & Video].pdf` |
