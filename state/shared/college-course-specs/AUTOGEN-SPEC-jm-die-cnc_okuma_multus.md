# AUTOGEN SPEC — JM DIE/CNC OKUMA MULTUS

Generated 2026-05-24T08:07:25.811Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC OKUMA MULTUS` |
| Slug | `jm-die-cnc_okuma_multus` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC OKUMA MULTUS` |
