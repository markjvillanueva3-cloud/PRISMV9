# AUTOGEN SPEC — JM DIE/GENERAL BANDAGES

Generated 2026-05-24T08:02:28.489Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/GENERAL BANDAGES` |
| Slug | `jm-die-general_bandages` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\GENERAL BANDAGES` |
