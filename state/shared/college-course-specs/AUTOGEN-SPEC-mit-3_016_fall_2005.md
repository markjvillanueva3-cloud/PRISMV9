...
| Field | Value |
|---|---|
| Course id | `3.016-fall-2005` |
| Slug | `mit-3_016_fall_2005` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `H:\PRISM\resources\MIT COURSES\MIT COURSES 4\uploaded\3.016-fall-2005` |
