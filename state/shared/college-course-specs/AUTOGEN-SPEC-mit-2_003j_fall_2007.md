...
| Field | Value |
|---|---|
| Course id | `2.003j-fall-2007` |
| Slug | `mit-2_003j_fall_2007` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\MIT COURSES 2\UPLOADED\2.003j-fall-2007.zip` |
