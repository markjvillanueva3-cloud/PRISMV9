# AUTOGEN SPEC — WORKHOLDING AND FIXTURE CATALOGS/MATE PRECISION TECHNOLOGIES/LIT01473_WH_Full_Catalog_Rev_F_2024.pdf

Generated 2026-05-24T08:03:43.499Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `WORKHOLDING AND FIXTURE CATALOGS/MATE PRECISION TECHNOLOGIES/LIT01473_WH_Full_Catalog_Rev_F_2024.pdf` |
| Slug | `pdf-resources-workholding_and_fixture_catalogs_mate_precision_technologies_lit01473_wh_full_ca` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
