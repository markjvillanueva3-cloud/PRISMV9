# AUTOGEN SPEC — JM DIE/CNC LATHE/ALLFAST/10-011-103

Generated 2026-05-24T08:04:06.635Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/ALLFAST/10-011-103` |
| Slug | `jm-die-cnc_lathe_allfast_10_011_103` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\ALLFAST\10-011-103` |
