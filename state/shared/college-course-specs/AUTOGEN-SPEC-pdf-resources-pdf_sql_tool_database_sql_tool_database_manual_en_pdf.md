# AUTOGEN SPEC — PDF/SQL Tool Database/SQL_Tool_Database_Manual-en.pdf
...
| Field | Value |
|---|---|
| Course id | `PDF/SQL Tool Database/SQL_Tool_Database_Manual-en.pdf` |
| Slug | `pdf-resources-pdf_sql_tool_database_sql_tool_database_manual_en_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\PDF\SQL Tool Database\SQL_Tool_Database_Manual-en.pdf` |
