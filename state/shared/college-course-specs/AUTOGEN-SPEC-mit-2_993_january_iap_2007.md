# AUTOGEN SPEC — 2.993-january-iap-2007
...
| Field | Value |
|---|---|
| Course id | `2.993-january-iap-2007` |
| Slug | `mit-2_993_january_iap_2007` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\UPLOADED\2.993-january-iap-2007.zip` |
