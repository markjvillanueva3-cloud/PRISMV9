# AUTOGEN SPEC — RESOURCE PDFS/Programming Manual Fundamentals.pdf

Generated 2026-05-24T08:03:29.969Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Programming Manual Fundamentals.pdf` |
| Slug | `pdf-resources-resource_pdfs_programming_manual_fundamentals_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Programming Manual Fundamentals.pdf` |
