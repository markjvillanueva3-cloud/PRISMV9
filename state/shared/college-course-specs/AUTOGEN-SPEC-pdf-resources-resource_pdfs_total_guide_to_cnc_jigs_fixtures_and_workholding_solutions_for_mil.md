# AUTOGEN SPEC — RESOURCE PDFS/Total Guide to CNC Jigs, Fixtures, and Workholding Solutions for Mills.pdf

Generated 2026-05-24T08:03:33.050Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Total Guide to CNC Jigs, Fixtures, and Workholding Solutions for Mills.pdf` |
| Slug | `pdf-resources-resource_pdfs_total_guide_to_cnc_jigs_fixtures_and_workholding_solutions_for_mil` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Total Guide to CNC Jigs, Fixtures, and Workholding Solutions for Mills.pdf` |
