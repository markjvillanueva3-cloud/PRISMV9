# AUTOGEN SPEC — 6.005-spring-2016
...
| Field | Value |
|---|---|
| Course id | `6.005-spring-2016` |
| Slug | `mit-6_005_spring_2016` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `H:\PRISM\resources\MIT COURSES\MIT COURSES 5\FULL FILES\6.005-spring-2016` |
