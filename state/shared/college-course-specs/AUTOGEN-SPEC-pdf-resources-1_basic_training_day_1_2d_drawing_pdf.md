# AUTOGEN SPEC — 1- Basic Training Day 1/2D_Drawing.pdf
...
| Field | Value |
|---|---|
| Course id | `1- Basic Training Day 1/2D_Drawing.pdf` |
| Slug | `pdf-resources-1_basic_training_day_1_2d_drawing_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\1- Basic Training Day 1\2D_Drawing.pdf` |
