# AUTOGEN SPEC — JM DIE/MACRO PROGRAMS

Generated 2026-05-24T08:02:31.672Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/MACRO PROGRAMS` |
| Slug | `jm-die-macro_programs` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\MACRO PROGRAMS` |
