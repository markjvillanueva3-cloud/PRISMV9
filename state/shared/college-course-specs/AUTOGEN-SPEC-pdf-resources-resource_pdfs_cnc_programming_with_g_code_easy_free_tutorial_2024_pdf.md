# AUTOGEN SPEC — RESOURCE PDFS/CNC Programming with G Code_ Easy Free Tutorial [ 2024 ].pdf

Generated 2026-05-24T08:02:55.543Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/CNC Programming with G Code_ Easy Free Tutorial [ 2024 ].pdf` |
| Slug | `pdf-resources-resource_pdfs_cnc_programming_with_g_code_easy_free_tutorial_2024_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\CNC Programming with G Code_ Easy Free Tutorial [ 2024 ].pdf` |
