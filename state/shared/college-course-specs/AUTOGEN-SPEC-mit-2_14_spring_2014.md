...
| Field | Value |
|---|---|
| Course id | `2.14-spring-2014` |
| Slug | `mit-2_14_spring_2014` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\2.14-spring-2014.zip` |
