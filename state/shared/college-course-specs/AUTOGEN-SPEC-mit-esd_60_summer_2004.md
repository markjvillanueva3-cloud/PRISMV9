# AUTOGEN SPEC — esd.60-summer-2004

Generated 2026-05-24T08:00:08.684Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `esd.60-summer-2004` |
| Slug | `mit-esd_60_summer_2004` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\UPLOADED\esd.60-summer-2004.zip` |
