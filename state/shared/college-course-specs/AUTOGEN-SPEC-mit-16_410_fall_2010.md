...
| Field | Value |
|---|---|
| Course id | `16.410-fall-2010` |
| Slug | `mit-16_410_fall_2010` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\16.410-fall-2010.zip` |
