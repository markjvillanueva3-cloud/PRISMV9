# AUTOGEN SPEC — PDF/SQL Macro Database/SQL_Macro_Database_Manual-en.pdf

Generated 2026-05-24T08:00:51.136Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `PDF/SQL Macro Database/SQL_Macro_Database_Manual-en.pdf` |
| Slug | `pdf-resources-pdf_sql_macro_database_sql_macro_database_manual_en_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\PDF\SQL Macro Database\SQL_Macro_Database_Manual-en.pdf` |
