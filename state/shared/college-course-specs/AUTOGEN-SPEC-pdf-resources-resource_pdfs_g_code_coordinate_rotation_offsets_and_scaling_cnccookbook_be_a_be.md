# AUTOGEN SPEC — RESOURCE PDFS/G-Code Coordinate Rotation, Offsets, and Scaling - CNCCookbook_ Be A Better CNC'er.pdf

Generated 2026-05-24T08:03:06.976Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/G-Code Coordinate Rotation, Offsets, and Scaling - CNCCookbook_ Be A Better CNC'er.pdf` |
| Slug | `pdf-resources-resource_pdfs_g_code_coordinate_rotation_offsets_and_scaling_cnccookbook_be_a_be` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
