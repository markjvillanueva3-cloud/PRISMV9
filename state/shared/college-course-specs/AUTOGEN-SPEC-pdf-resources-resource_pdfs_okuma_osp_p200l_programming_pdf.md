# AUTOGEN SPEC — RESOURCE PDFS/Okuma-OSP-P200L-Programming.pdf

Generated 2026-05-24T08:03:27.204Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Okuma-OSP-P200L-Programming.pdf` |
| Slug | `pdf-resources-resource_pdfs_okuma_osp_p200l_programming_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Okuma-OSP-P200L-Programming.pdf` |
