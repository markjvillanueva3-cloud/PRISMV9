# AUTOGEN SPEC — RESOURCE PDFS/Fundamentals_of_CNC_Machining-uploaded.pdf

Generated 2026-05-24T08:03:06.180Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Fundamentals_of_CNC_Machining-uploaded.pdf` |
| Slug | `pdf-resources-resource_pdfs_fundamentals_of_cnc_machining_uploaded_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Fundamentals_of_CNC_Machining-uploaded.pdf` |
