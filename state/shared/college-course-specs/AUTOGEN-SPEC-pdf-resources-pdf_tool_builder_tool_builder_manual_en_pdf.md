# AUTOGEN SPEC — PDF/TOOL Builder/TOOL_Builder_Manual-en.pdf

Generated 2026-05-24T08:00:53.584Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `PDF/TOOL Builder/TOOL_Builder_Manual-en.pdf` |
| Slug | `pdf-resources-pdf_tool_builder_tool_builder_manual_en_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\PDF\TOOL Builder\TOOL_Builder_Manual-en.pdf` |
