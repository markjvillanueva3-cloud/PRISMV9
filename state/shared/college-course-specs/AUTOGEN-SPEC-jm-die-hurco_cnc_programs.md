# AUTOGEN SPEC — JM DIE/HURCO CNC PROGRAMS

Generated 2026-05-24T08:02:30.509Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/HURCO CNC PROGRAMS` |
| Slug | `jm-die-hurco_cnc_programs` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\HURCO CNC PROGRAMS` |
