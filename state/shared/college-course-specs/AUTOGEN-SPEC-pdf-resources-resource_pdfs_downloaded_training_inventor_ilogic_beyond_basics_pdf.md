# AUTOGEN SPEC — RESOURCE PDFS/DOWNLOADED_TRAINING/Inventor_iLogic_Beyond_Basics.pdf

Generated 2026-05-24T08:03:00.092Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/DOWNLOADED_TRAINING/Inventor_iLogic_Beyond_Basics.pdf` |
| Slug | `pdf-resources-resource_pdfs_downloaded_training_inventor_ilogic_beyond_basics_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\DOWNLOADED_TRAINING\Inventor_iLogic_Beyond_Basics.pdf` |
