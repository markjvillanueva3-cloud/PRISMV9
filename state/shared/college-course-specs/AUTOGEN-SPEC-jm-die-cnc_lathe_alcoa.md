# AUTOGEN SPEC — JM DIE/CNC LATHE/ALCOA

Generated 2026-05-24T08:04:03.754Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/ALCOA` |
| Slug | `jm-die-cnc_lathe_alcoa` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\ALCOA` |
