# AUTOGEN SPEC — PDF/hyperCAD-S/hyperCAD-S_Manual-en.pdf

Generated 2026-05-24T08:00:48.634Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `PDF/hyperCAD-S/hyperCAD-S_Manual-en.pdf` |
| Slug | `pdf-resources-pdf_hypercad_s_hypercad_s_manual_en_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\PDF\hyperCAD-S\hyperCAD-S_Manual-en.pdf` |
