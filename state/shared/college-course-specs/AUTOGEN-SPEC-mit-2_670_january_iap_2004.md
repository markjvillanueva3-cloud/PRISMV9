# AUTOGEN SPEC — 2.670-january-iap-2004
...
| Field | Value |
|---|---|
| Course id | `2.670-january-iap-2004` |
| Slug | `mit-2_670_january_iap_2004` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\MIT COURSES 2\UPLOADED\2.670-january-iap-2004.zip` |
