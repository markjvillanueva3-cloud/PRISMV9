# AUTOGEN SPEC — JM DIE/CNC LATHE/ELECTRODE/CONTINENTAL MID. ELECTR

Generated 2026-05-24T08:04:35.301Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/ELECTRODE/CONTINENTAL MID. ELECTR` |
| Slug | `jm-die-cnc_lathe_electrode_continental_mid_electr` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\ELECTRODE\CONTINENTAL MID. ELECTR` |
