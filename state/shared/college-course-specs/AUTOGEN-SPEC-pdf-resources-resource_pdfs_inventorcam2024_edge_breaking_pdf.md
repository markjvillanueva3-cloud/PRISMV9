# AUTOGEN SPEC — RESOURCE PDFS/InventorCAM2024_Edge_Breaking.pdf

Generated 2026-05-24T08:03:16.147Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/InventorCAM2024_Edge_Breaking.pdf` |
| Slug | `pdf-resources-resource_pdfs_inventorcam2024_edge_breaking_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\InventorCAM2024_Edge_Breaking.pdf` |
