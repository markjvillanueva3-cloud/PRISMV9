# AUTOGEN SPEC — RESOURCE PDFS/CNC Lathe Programming - cnc_lathe_programming-uploaded.pdf

Generated 2026-05-24T08:02:54.648Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/CNC Lathe Programming - cnc_lathe_programming-uploaded.pdf` |
| Slug | `pdf-resources-resource_pdfs_cnc_lathe_programming_cnc_lathe_programming_uploaded_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\CNC Lathe Programming - cnc_lathe_programming-uploaded.pdf` |
