...
| Field | Value |
|---|---|
| Course id | `15.060-fall-2014` |
| Slug | `mit-15_060_fall_2014` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\UPLOADED\15.060-fall-2014.zip` |
