# AUTOGEN SPEC — RESOURCE PDFS/G76 Threading Cycle for CNC Lathes (Fanuc).pdf

Generated 2026-05-24T08:03:08.170Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/G76 Threading Cycle for CNC Lathes (Fanuc).pdf` |
| Slug | `pdf-resources-resource_pdfs_g76_threading_cycle_for_cnc_lathes_fanuc_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\G76 Threading Cycle for CNC Lathes (Fanuc).pdf` |
