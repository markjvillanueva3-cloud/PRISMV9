# AUTOGEN SPEC — RESOURCE PDFS/G-Code and M-Code List [ Easy Examples & Tutorials ].pdf

Generated 2026-05-24T08:03:06.524Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/G-Code and M-Code List [ Easy Examples & Tutorials ].pdf` |
| Slug | `pdf-resources-resource_pdfs_g_code_and_m_code_list_easy_examples_tutorials_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\G-Code and M-Code List [ Easy Examples & Tutorials ].pdf` |
