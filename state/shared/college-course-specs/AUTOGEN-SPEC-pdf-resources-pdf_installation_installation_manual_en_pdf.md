# AUTOGEN SPEC — PDF/Installation/Installation_Manual-en.pdf
...
| Field | Value |
|---|---|
| Course id | `PDF/Installation/Installation_Manual-en.pdf` |
| Slug | `pdf-resources-pdf_installation_installation_manual_en_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\PDF\Installation\Installation_Manual-en.pdf` |
