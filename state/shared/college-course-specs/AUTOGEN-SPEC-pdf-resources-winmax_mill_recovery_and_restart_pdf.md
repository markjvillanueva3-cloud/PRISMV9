# AUTOGEN SPEC — WinMax Mill RECOVERY AND RESTART.pdf

Generated 2026-05-24T08:03:36.468Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `WinMax Mill RECOVERY AND RESTART.pdf` |
| Slug | `pdf-resources-winmax_mill_recovery_and_restart_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\WinMax Mill RECOVERY AND RESTART.pdf` |
