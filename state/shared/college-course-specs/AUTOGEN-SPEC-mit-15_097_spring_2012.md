# AUTOGEN SPEC — 15.097-spring-2012
...
| Field | Value |
|---|---|
| Course id | `15.097-spring-2012` |
| Slug | `mit-15_097_spring_2012` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `C:\PRISM REBUILD (UPLOAD TO BOX OCCASSIONALLY)\MIT COURSES\UPLOADED\15.097-spring-2012.zip` |
