# AUTOGEN SPEC — JM DIE/CNC LATHE/PILGRIM

Generated 2026-05-24T08:05:58.937Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/PILGRIM` |
| Slug | `jm-die-cnc_lathe_pilgrim` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\PILGRIM` |
