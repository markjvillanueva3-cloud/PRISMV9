# AUTOGEN SPEC — MasterCam/tutorialx8-tool-manager/Tool_Manager_GSG.pdf

Generated 2026-05-24T08:00:42.381Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `MasterCam/tutorialx8-tool-manager/Tool_Manager_GSG.pdf` |
| Slug | `pdf-resources-mastercam_tutorialx8_tool_manager_tool_manager_gsg_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\MasterCam\tutorialx8-tool-manager\Tool_Manager_GSG.pdf` |
