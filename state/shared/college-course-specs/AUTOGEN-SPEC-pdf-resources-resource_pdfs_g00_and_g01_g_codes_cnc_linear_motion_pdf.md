# AUTOGEN SPEC — RESOURCE PDFS/G00 and G01 G-Codes_ CNC Linear Motion.pdf

Generated 2026-05-24T08:03:07.130Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/G00 and G01 G-Codes_ CNC Linear Motion.pdf` |
| Slug | `pdf-resources-resource_pdfs_g00_and_g01_g_codes_cnc_linear_motion_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\G00 and G01 G-Codes_ CNC Linear Motion.pdf` |
