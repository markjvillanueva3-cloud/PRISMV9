# AUTOGEN SPEC — RESOURCE PDFS/G49 G-Code [Tool Length Compensation Cancel].pdf

Generated 2026-05-24T08:03:07.657Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/G49 G-Code [Tool Length Compensation Cancel].pdf` |
| Slug | `pdf-resources-resource_pdfs_g49_g_code_tool_length_compensation_cancel_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\G49 G-Code [Tool Length Compensation Cancel].pdf` |
