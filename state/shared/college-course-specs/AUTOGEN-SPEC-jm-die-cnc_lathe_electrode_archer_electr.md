# AUTOGEN SPEC — JM DIE/CNC LATHE/ELECTRODE/ARCHER ELECTR

Generated 2026-05-24T08:04:32.598Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/ELECTRODE/ARCHER ELECTR` |
| Slug | `jm-die-cnc_lathe_electrode_archer_electr` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\ELECTRODE\ARCHER ELECTR` |
