# AUTOGEN SPEC — JM DIE/CNC MILL HAAS/SPS TECHNOLOGIES

Generated 2026-05-24T08:07:17.421Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC MILL HAAS/SPS TECHNOLOGIES` |
| Slug | `jm-die-cnc_mill_haas_sps_technologies` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC MILL HAAS\SPS TECHNOLOGIES` |
