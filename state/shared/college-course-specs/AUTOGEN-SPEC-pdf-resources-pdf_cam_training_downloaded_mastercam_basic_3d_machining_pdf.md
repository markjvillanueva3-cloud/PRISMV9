# AUTOGEN SPEC — PDF/CAM-Training-Downloaded/Mastercam-Basic-3D-Machining.pdf
...
| Field | Value |
|---|---|
| Course id | `PDF/CAM-Training-Downloaded/Mastercam-Basic-3D-Machining.pdf` |
| Slug | `pdf-resources-pdf_cam_training_downloaded_mastercam_basic_3d_machining_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\PDF\CAM-Training-Downloaded\Mastercam-Basic-3D-Machining.pdf` |
