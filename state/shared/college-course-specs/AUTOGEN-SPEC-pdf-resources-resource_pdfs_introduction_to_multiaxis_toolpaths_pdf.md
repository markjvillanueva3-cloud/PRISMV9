# AUTOGEN SPEC — RESOURCE PDFS/Introduction_to_Multiaxis_Toolpaths.pdf

Generated 2026-05-24T08:03:12.510Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/Introduction_to_Multiaxis_Toolpaths.pdf` |
| Slug | `pdf-resources-resource_pdfs_introduction_to_multiaxis_toolpaths_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\RESOURCE PDFS\Introduction_to_Multiaxis_Toolpaths.pdf` |
