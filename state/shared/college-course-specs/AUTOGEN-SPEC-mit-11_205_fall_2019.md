# AUTOGEN SPEC — 11.205-fall-2019

Generated 2026-05-24T08:00:10.823Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `11.205-fall-2019` |
| Slug | `mit-11_205_fall_2019` |
| Kind | `mit-ocw` |
| Domain | `academic` |
| Source path | `H:\PRISM\resources\MIT COURSES\MIT COURSES 4\uploaded\11.205-fall-2019` |
