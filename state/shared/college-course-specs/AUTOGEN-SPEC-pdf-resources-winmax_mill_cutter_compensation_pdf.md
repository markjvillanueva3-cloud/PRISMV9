# AUTOGEN SPEC — WinMax Mill CUTTER COMPENSATION.pdf

Generated 2026-05-24T08:03:36.128Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `WinMax Mill CUTTER COMPENSATION.pdf` |
| Slug | `pdf-resources-winmax_mill_cutter_compensation_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\WinMax Mill CUTTER COMPENSATION.pdf` |
