# AUTOGEN SPEC — RESOURCE PDFS/English - Mill Operator’s Manual -Interactive PDF Version - NGC - 2023 - english_mill_interactive_manual_print_version_2023.pdf

Generated 2026-05-24T08:03:04.482Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `RESOURCE PDFS/English - Mill Operator’s Manual -Interactive PDF Version - NGC - 2023 - english_mill_interactive_manual_print_version_2023.pdf` |
| Slug | `pdf-resources-resource_pdfs_english_mill_operator_s_manual_interactive_pdf_version_ngc_2023_en` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
