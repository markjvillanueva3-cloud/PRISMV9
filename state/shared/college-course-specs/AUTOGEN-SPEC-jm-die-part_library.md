# AUTOGEN SPEC — JM DIE/_PART LIBRARY

Generated 2026-05-24T08:02:39.138Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/_PART LIBRARY` |
| Slug | `jm-die-part_library` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\_PART LIBRARY` |
