# AUTOGEN SPEC — JM DIE/CNC LATHE/QUALITY FORM

Generated 2026-05-24T08:06:03.672Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/QUALITY FORM` |
| Slug | `jm-die-cnc_lathe_quality_form` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\QUALITY FORM` |
