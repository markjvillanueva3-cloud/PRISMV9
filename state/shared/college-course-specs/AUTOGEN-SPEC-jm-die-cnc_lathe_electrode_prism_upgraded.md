# AUTOGEN SPEC — JM DIE/CNC LATHE/ELECTRODE/PRISM_UPGRADED

Generated 2026-05-24T08:04:42.762Z by scripts/auto-college-course-spec-emit.mjs (slot:india).
Advisory + must_human_verify. Lima slot executes this spec to deliver the actual assets.

| Field | Value |
|---|---|
| Course id | `JM DIE/CNC LATHE/ELECTRODE/PRISM_UPGRADED` |
| Slug | `jm-die-cnc_lathe_electrode_prism_upgraded` |
| Kind | `prism-training` |
| Domain | `shop-floor` |
| Source path | `H:\PRISM\JM DIE\CNC LATHE\ELECTRODE\PRISM_UPGRADED` |
