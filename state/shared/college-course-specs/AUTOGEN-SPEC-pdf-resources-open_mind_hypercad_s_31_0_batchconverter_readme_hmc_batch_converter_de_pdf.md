# AUTOGEN SPEC — OPEN MIND/hyperCAD-S/31.0/BatchConverter/Readme_HMC_Batch_Converter-de.pdf
...
| Field | Value |
|---|---|
| Course id | `OPEN MIND/hyperCAD-S/31.0/BatchConverter/Readme_HMC_Batch_Converter-de.pdf` |
| Slug | `pdf-resources-open_mind_hypercad_s_31_0_batchconverter_readme_hmc_batch_converter_de_pdf` |
| Kind | `handbook-pdfs` |
| Domain | `reference` |
| Source path | `H:\PRISM\resources\OPEN MIND\hyperCAD-S\31.0\BatchConverter\Readme_HMC_Batch_Converter-de.pdf` |
