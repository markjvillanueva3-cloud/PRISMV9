# system-viz dead-pixel sweep — 2026-06-22T23:27:34.709Z

Nodes: 353505
Edges: 820951
Dead edges: 3902 (0.48%)
  ├─ advisory (intentional gap-surfacing bridges to not-yet-built nodes): 3684
  └─ DEFECT (structural edges that should connect real nodes): 218  ← triage these
...
## Dead-edge count by edge type (advisory vs defect)
    ...
    1461  enriches-engine  [advisory]
     105  synergy  [defect]
      57  contains  [defect]
      56  ghost-wire-validation  [defect]
      23  ghost-wire  [advisory]
...
## Top 50 orphan targets (referenced-but-missing, ranked by inbound count)
     ...
     414  engine.PrismTrainingModuleEngine
      ...
      10  domain:work
       ...
       4  disp.prism_edm
         e.g. from: ghost.vault-wired.SinkerEDMElectrodeInspectionEngine, ghost.vault-wired.SinkerElectrodeCostEngine
