...
**Updated:** 2026-04-19 | **Version:** 1.1.0
...
|----------|-------|--------------|
| Engines | 2,495+ | SpeedFeedOrchestratorEngine, KienzleEngine, WireEDMDeepAIHardeningEngine |
| Dispatchers | 90 | speedFeed, calculator, milling, lathe, edm, material, tooling |
| Actions | 5,426+ | All calculation, routing, analysis actions |
| Formulas | 499 | Kienzle, Taylor, Johnson-Cook, NURBS, PID, Kalman |
| Algorithms | 53 | Genetic, PSO, A*, Voronoi, K-means, CNN |
