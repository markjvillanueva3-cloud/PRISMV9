...
description: Roadmap phases 0-A (print reading), 0-B (bug fixes), 0-C (test infrastructure) completed 2026-03-24
type: project
---
...
## What's Next
- Fix 4 remaining negative test failures (minor: try/catch + loosen ISO checks)
- Phase 0-D: Registry + Algorithm + Orphan Wiring (roadmap line 1864) — 20 units in 7 sessions
- Phase 0-B-SAFETY and 0-B-SECURITY still deferred

**Why:** These phases are the foundation — print reading, bug fixes, and test infrastructure MUST be solid before building new capabilities in Phase 0-D+.

**How to apply:** Don't re-audit or re-fix anything in 0-A/0-B/0-C. Trust the tests. Move forward to 0-D.
