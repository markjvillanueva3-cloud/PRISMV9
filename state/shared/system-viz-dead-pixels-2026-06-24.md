# system-viz dead-pixel sweep — 2026-06-24T15:04:36.886Z

Nodes: 356978
Edges: 839167
Dead edges: 3907 (0.47%)
  ├─ advisory (intentional gap-surfacing bridges to not-yet-built nodes): 3684
  └─ DEFECT (structural edges that should connect real nodes): 223  ← triage these
...
## Dead-edge count by edge type (advisory vs defect)
    ...
    1461  enriches-engine  [advisory]
     105  synergy  [defect]
      61  ghost-wire-validation  [defect]
      57  contains  [defect]
