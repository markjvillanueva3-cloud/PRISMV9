...
source: prism-memory
synced: 2026-05-18T01:02:10.230Z
...
Uses plain `node:test` because the vitest harness for `.claude/helpers/` has a pre-existing transform bug (same pattern as fleet-reaper.test.mjs).
...
## Related
[[skills/wiki|/wiki]] • [[skills/index|/index]] • [[skills/helpers|/helpers]] • [[skills/wiki-domain-bias|/wiki-domain-bias]] • [[skills/hooks|/hooks]] • [[skills/wiki-precheck-inject|/wiki-precheck-inject]] • [[skills/shared|/shared]] • [[skills/chat-slots|/chat-slots]]