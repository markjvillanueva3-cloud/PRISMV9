...
**Location:** H:\prism\scripts\integration\
...
**Status:** 58 files exist in H:\prism\knowledge\ but never maintained or synced
...
**Source:** H:\prism\docs\APPEND_ONLY_STATE_PROTOCOL.md (395 lines, 9KB)
...
**Status:** 116 PDF catalogs exist in H:\prism\MANUFACTURER_CATALOGS\ (Sandvik, Kennametal, Iscar, etc.)
...
**Status:** H:\prism\diagrams\ — EMPTY. Draw.io integration planned, never happened.
