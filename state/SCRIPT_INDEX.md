...
---
## 🔥 TOP PRIORITY SCRIPTS (Session Management)
...
### Session Start
```bash
py -3 H:\prism\scripts\gsd_startup.py "task description"
```
...
### Full Audit
```bash
py -3 H:\prism\scripts\comprehensive_audit.py
py -3 H:\prism\scripts\mcp_resource_audit.py
```

### Session Checkpoint
```bash
py -3 H:\prism\scripts\session_memory_manager.py checkpoint --completed 25 --next "item 26"
```
