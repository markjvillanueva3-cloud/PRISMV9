...
**State Directory:** `H:\prism\state\telemetry\` (config.json, metrics_snapshot.json)
...
**State Directory:** `H:\prism\state\pfp\` (history.jsonl, patterns.json, config.json)
...
**State Directory:** `H:\prism\state\memory_graph\` (nodes.jsonl, edges.jsonl, index.json, wal.jsonl)
...
**State Directory:** `H:\prism\state\certificates\` (certs/, keys/, cert_index.json)
