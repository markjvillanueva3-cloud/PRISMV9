...
These files exist and are ACTIVE but bypass `constants.ts PATHS`, using hardcoded `"H:\\prism"` strings. They need rewiring, not removal.
...
3. **WIRE 33 files** — replace hardcoded "H:\prism" with PATHS constant imports
