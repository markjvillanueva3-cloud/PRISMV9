...
1. **Master Index**: H:\prism\mcp-server\data\docs\MASTER_INDEX.md
2. **Audit Report**: H:\prism\state\COMPREHENSIVE_WIRING_AUDIT.md
3. **Position**: H:\prism\mcp-server\data\docs\roadmap\CURRENT_POSITION.md
4. **GSD**: H:\prism\mcp-server\data\docs\gsd\GSD_QUICK.md (v22.0)
5. **State**: H:\prism\state\CURRENT_STATE.json (v24.0)
6. **Memory**: H:\prism\state\SESSION_MEMORY.json
