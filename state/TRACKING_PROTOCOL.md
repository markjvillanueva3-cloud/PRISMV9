...
```
1. Read H:\prism\state\ACTION_TRACKER.md
2. Read latest chat summary: H:\prism\mcp-server\data\chats\summaries\
...
### End of Session
```
1. Update session file: H:\prism\mcp-server\data\chats\sessions\session-N.md
2. Update summary: H:\prism\mcp-server\data\chats\summaries\session-N-summary.md
3. Update index: H:\prism\mcp-server\data\chats\index.json
```
...
- Read roadmaps from H:\prism\docs\ (OUTDATED)
