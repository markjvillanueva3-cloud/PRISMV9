...
| Root-level files (H:\prism\) | 207 | Not MCP-managed | Audit/fix scripts | INFO |
...
### 9C. Root-Level Files (H:\prism\ -- 207 items)
...
**Recommendation:** Move accumulated .ps1/.py scripts to `H:\prism\archives\root-scripts\`.
...
### 9E. State Directory (H:\prism\state\ -- 447 items)
