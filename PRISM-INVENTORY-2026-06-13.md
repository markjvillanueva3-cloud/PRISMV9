...
**Updated:** 2026-06-13T15:00:57.357Z
...
| **Actions** | 10067 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4782 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 976 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2615 | live: `scripts/` + `mcp-server/scripts/` |
