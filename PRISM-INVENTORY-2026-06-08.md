...
**Updated:** 2026-06-08T20:59:20.156Z
...
|----------|-------|--------|
| **Engines** | 3784 | live: `src/engines/*.ts` |
| **Dispatchers** | 107 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 10001 | live: `z.enum` count across dispatchers |
| **Algorithms** | 123 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4699 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 891 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 2237 | live: `scripts/` + `mcp-server/scripts/` |
