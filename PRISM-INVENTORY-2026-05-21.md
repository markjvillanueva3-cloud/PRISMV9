...
**Updated:** 2026-05-21T22:36:05.481Z
**Source:** live scan (5538ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3319 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 8490 | live: `z.enum` count across dispatchers |
| **Algorithms** | 61 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4005 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 701 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1217 | live: `scripts/` + `mcp-server/scripts/` |
