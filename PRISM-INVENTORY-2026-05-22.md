...
**Updated:** 2026-05-22T22:51:27.836Z
**Source:** live scan (71ms) — via scripts/update-prism-inventory.mjs
...
|----------|-------|--------|
| **Engines** | 3338 | live: `src/engines/*.ts` |
| **Dispatchers** | 97 | live: `src/tools/dispatchers/*.ts` |
| **Actions** | 8585 | live: `z.enum` count across dispatchers |
| **Algorithms** | 61 | live: `src/algorithms/*.ts` |
| **Registries** | 27 | live: `src/registries/*.ts` |
| **Tests** | 4051 | live: `src/__tests__/**/*.test.ts` |
| **Source Hooks** | 54 | live: `src/hooks/**/*.ts` |
| **Claude Hooks** | 714 | live: `.claude/hooks/**/*.mjs` |
| **Scripts** | 1243 | live: `scripts/` + `mcp-server/scripts/` |
